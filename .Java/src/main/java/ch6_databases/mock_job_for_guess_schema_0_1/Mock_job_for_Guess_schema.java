...
package ch6_databases.mock_job_for_guess_schema_0_1;
...
public class Mock_job_for_Guess_schema implements TalendJob {
	...
	public void tLibraryLoad_3_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tLibraryLoad_3_onSubJobError(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String url = "jdbc:hsqldb:file:/Users/ninh/Documents/0Workspace/data-intergration-ETL-with-talend-open-studio/CH_6/Lesson_2/DB/memory_HSQL;";
				java.sql.Connection conn = java.sql.DriverManager
						.getConnection(url, "sa", "sa");
				...
				java.sql.ResultSet rs = stm
						.executeQuery("SELECT TEST_TABLE.TEST  FROM	 TEST_TABLE");
				java.sql.ResultSetMetaData rsmd = rs.getMetaData();
				int numbOfColumn = rsmd.getColumnCount();

				String fileName = (new java.io.File(
						"/Users/ninh/Documents/0Workspace/TOS_ESB-20150702_1326-V6.0.0/Studio/TOS_ESB-macosx-cocoa.app/Contents/MacOS/temp/TempGuessSchemaDelimitedFile.csv"))
		...
		try {
			...
			java.io.InputStream inContext = Mock_job_for_Guess_schema.class
					.getClassLoader().getResourceAsStream(
							"ch6_databases/mock_job_for_guess_schema_0_1/contexts/"
...
/************************************************************************************************
 * 31165 characters generated by Talend Open Studio for ESB on the August 2,
 * 2015 11:02:45 PM PDT
 ************************************************************************************************/
