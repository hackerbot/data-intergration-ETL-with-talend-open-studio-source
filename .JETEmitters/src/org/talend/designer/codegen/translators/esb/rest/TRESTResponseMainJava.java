...
public class TRESTResponseMainJava
{
  ...
  protected final String TEXT_31 = NL + NL + "\t\tif (null == outputStream_";
  protected final String TEXT_32 = ") {" + NL + "\t\t\tjava.util.Map<String, Object> restResponse_";
  protected final String TEXT_33 = " = new java.util.HashMap<String, Object>();" + NL + "\t\t\trestResponse_";
  protected final String TEXT_34 = ".put(\"BODY\", restProviderResponse_";
  protected final String TEXT_35 = ");" + NL + "\t\t\trestResponse_";
  protected final String TEXT_36 = ".put(\"STATUS\", restProviderStatusCode_";
  protected final String TEXT_37 = ");" + NL + "\t\t\trestResponse_";
  protected final String TEXT_38 = ".put(\"HEADERS\", restProviderResponseHeaders_";
  protected final String TEXT_39 = ");" + NL + "\t\t\trestResponse_";
  protected final String TEXT_40 = ".put(\"drop.json.root.element\", Boolean.valueOf(";
  protected final String TEXT_41 = "));" + NL + "\t\t\tglobalMap.put(\"restResponse\", restResponse_";
  protected final String TEXT_42 = ");" + NL + "\t\t} else {" + NL + "\t\t\tif (!responseAlreadySent_";
  protected final String TEXT_43 = ") {" + NL + "\t\t\t\tjava.util.Map<String, Object> restRequest_";
  protected final String TEXT_44 = " = (java.util.Map<String, Object>) globalMap.get(\"restRequest\");" + NL + "\t\t\t\torg.apache.cxf.jaxrs.ext.MessageContext messageContext_";
  protected final String TEXT_45 = " = (org.apache.cxf.jaxrs.ext.MessageContext) restRequest_";
  protected final String TEXT_46 = ".get(\"MESSAGE_CONTEXT\");" + NL + "\t\t\t\tmessageContext_";
  protected final String TEXT_47 = ".put(org.apache.cxf.message.Message.RESPONSE_CODE, restProviderStatusCode_";
  protected final String TEXT_48 = ");" + NL + "\t\t\t\tjavax.ws.rs.core.MultivaluedMap<String, String> headersMultivaluedMap_";
  protected final String TEXT_49 = " = new org.apache.cxf.jaxrs.impl.MetadataMap<String, String>();" + NL + "\t\t\t\tfor (java.util.Map.Entry<String, String> multivaluedHeader : restProviderResponseHeaders_";
  protected final String TEXT_50 = ".entrySet()) {" + NL + "\t\t\t\t\theadersMultivaluedMap_";
  protected final String TEXT_51 = ".putSingle(multivaluedHeader.getKey(), multivaluedHeader.getValue());" + NL + "\t\t\t\t}" + NL + "\t\t\t\tmessageContext_";
  protected final String TEXT_52 = ".put(org.apache.cxf.message.Message.PROTOCOL_HEADERS, headersMultivaluedMap_";
  protected final String TEXT_53 = ");" + NL + "\t\t\t\tglobalMap.put(\"restResponse\", true);" + NL + "\t\t\t}" + NL + "\t\t\toutputStream_";
  protected final String TEXT_54 = ".write(String.valueOf(restProviderResponse_";
  protected final String TEXT_55 = ").getBytes());" + NL + "\t\t\toutputStream_";
  protected final String TEXT_56 = ".flush();" + NL + "\t\t}" + NL + "\t}";
