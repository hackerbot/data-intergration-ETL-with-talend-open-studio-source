...
public class CMessageFilterMainJava
{
  protected static String nl;
  public static synchronized CMessageFilterMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    CMessageFilterMainJava result = new CMessageFilterMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_5 = NL + "\t\t\t.filter().";
  protected final String TEXT_6 = "(";
  protected final String TEXT_7 = ")";
  protected final String TEXT_8 = NL + "\t\t\t.filter().";
