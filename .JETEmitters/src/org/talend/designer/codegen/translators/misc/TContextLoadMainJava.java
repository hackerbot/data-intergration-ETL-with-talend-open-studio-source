...
public class TContextLoadMainJava
{
  ...
  protected final String TEXT_94 = ");" + NL + "    }catch(java.lang.Exception e){    \t" + NL + "    \t";
  protected final String TEXT_95 = NL + "    \t\tlog.error(\"";
  protected final String TEXT_96 = " - Setting a value for the key \\\"\" + key_";
  protected final String TEXT_97 = " + \"\\\" has failed. Error message: \" + e.getMessage());" + NL + "    \t";
  protected final String TEXT_98 = NL + "    \tSystem.err.println(\"Setting a value for the key \\\"\" + key_";
  protected final String TEXT_99 = " + \"\\\" has failed. Error message: \" + e.getMessage());" + NL + "    }" + NL + "    \tnb_line_";
