...
public class TMDMWriteConfBeginJava
{
  ...
  protected final String TEXT_50 = NL + "\tjava.util.Queue<String> queue_";
  protected final String TEXT_51 = " = new java.util.concurrent.ConcurrentLinkedQueue<String>();" + NL + "\t";
  protected final String TEXT_52 = NL + "\t\tjava.util.List<java.util.Map<String,String>> xmlFlowList_";
  protected final String TEXT_53 = " = java.util.Collections.synchronizedList(new java.util.ArrayList<java.util.Map<String,String>>());" + NL + "\t\tint flowNum_";
  protected final String TEXT_54 = " = 0;" + NL + "\t";
  protected final String TEXT_55 = NL + "\tclass ThreadXMLField_";
  protected final String TEXT_56 = " extends Thread {" + NL + "\t\tjava.util.Queue<String> queue;" + NL + "\t\tjava.util.List<java.util.Map<String,String>> flows;" + NL + "\t\tjava.lang.Exception lastException;" + NL + "\t\tString currentComponent;" + NL + "\t\t" + NL + "\t\tThreadXMLField_";
  protected final String TEXT_57 = "(java.util.Queue q) {" + NL + "\t\t\tthis.queue = q;" + NL + "\t\t\tglobalMap.put(\"queue_";
  protected final String TEXT_58 = "\", queue);" + NL + "\t\t\tlastException = null;" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tThreadXMLField_";
  protected final String TEXT_59 = "(java.util.Queue q, java.util.List<java.util.Map<String,String>> l) {" + NL + "\t\t\tthis.queue = q;" + NL + "\t\t\tthis.flows = l;" + NL + "\t\t\tlastException = null;" + NL + "\t\t\tglobalMap.put(\"queue_";
  protected final String TEXT_60 = "\", queue);" + NL + "\t\t\tglobalMap.put(\"flows_";
  protected final String TEXT_61 = "\", flows);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tpublic java.lang.Exception getLastException() {" + NL + "\t\t\treturn this.lastException;" + NL + "\t\t}" + NL + "\t\tpublic String getCurrentComponent() {" + NL + "\t\t\treturn this.currentComponent;" + NL + "\t\t}" + NL + "\t" + NL + "\t\t@Override" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\t";
  protected final String TEXT_62 = "Process(globalMap);" + NL + "\t\t\t} catch (TalendException te) {" + NL + "\t\t\t\tthis.lastException = te.getException();" + NL + "\t\t\t\tthis.currentComponent = te.getCurrentComponent();" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_63 = "_FINISH\" + (this.queue==null?\"\":this.queue.hashCode()), \"true\");" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "\t";
  protected final String TEXT_64 = NL + "\t\tThreadXMLField_";
  protected final String TEXT_65 = " txf_";
  protected final String TEXT_66 = " = new ThreadXMLField_";
  protected final String TEXT_67 = "(queue_";
  protected final String TEXT_68 = ", xmlFlowList_";
  ...
  protected final String TEXT_75 = NL + "\ttxf_";
  protected final String TEXT_76 = ".start();";
  protected final String TEXT_77 = NL + "\t\tjava.util.List<java.util.Map<String,String>> xmlFlowList_";
  protected final String TEXT_78 = " = (java.util.List<java.util.Map<String,String>>)globalMap.get(\"flows_";
  protected final String TEXT_79 = "\");" + NL + "\t\tint flowNum_";
  protected final String TEXT_80 = " = 0;" + NL + "\t";
  protected final String TEXT_81 = NL + "\tjava.util.Queue<String> queue_";
  protected final String TEXT_82 = " = (java.util.Queue<String>) globalMap.get(\"queue_";
  protected final String TEXT_83 = "\"); ";
  protected final String TEXT_84 = NL + "\tString readFinishMarkWithPipeId_";
  protected final String TEXT_85 = " = \"";
  protected final String TEXT_86 = "_FINISH\"+(queue_";
  protected final String TEXT_87 = "==null?\"\":queue_";
  protected final String TEXT_88 = ".hashCode());" + NL + "\twhile(!globalMap.containsKey(readFinishMarkWithPipeId_";
  protected final String TEXT_89 = ") || !queue_";
  protected final String TEXT_90 = ".isEmpty()) { " + NL + "\t\tif (!queue_";
