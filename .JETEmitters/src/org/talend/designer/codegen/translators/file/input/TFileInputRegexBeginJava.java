...
public class TFileInputRegexBeginJava
{
  ...
  protected final String TEXT_136 = "].length() > 0) {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_137 = ".";
  protected final String TEXT_138 = " = value";
  protected final String TEXT_139 = "[";
  protected final String TEXT_140 = "];";
  protected final String TEXT_141 = ".";
  protected final String TEXT_142 = " = ParserUtils.parseTo_Date(value";
  protected final String TEXT_143 = "[";
  protected final String TEXT_144 = "], ";
  protected final String TEXT_145 = ");";
  protected final String TEXT_146 = ".";
  protected final String TEXT_147 = " = value";
  protected final String TEXT_148 = "[";
  protected final String TEXT_149 = "].getBytes(";
  protected final String TEXT_150 = ");";
  protected final String TEXT_151 = ".";
  protected final String TEXT_152 = " = ParserUtils.parseTo_";
  protected final String TEXT_153 = "(value";
  protected final String TEXT_154 = "[";
  protected final String TEXT_155 = "]);";
  protected final String TEXT_156 = "\t\t\t\t\t" + NL + "\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_157 = "throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_158 = "' in '";
  protected final String TEXT_159 = "' connection, value is invalid or this column should be nullable or have a default value.\");";
  ...
  protected final String TEXT_167 = "\t\t\t\t\t" + NL + "\t\t\t\t\t" + NL + "    } catch (java.lang.Exception e) {" + NL + "        whetherReject_";
  protected final String TEXT_168 = " = true;";
  protected final String TEXT_169 = NL + "            if(isMatch";
  protected final String TEXT_170 = "){" + NL + "            \tthrow(e);" + NL + "            }else{" + NL + "\t    \t\t";
  protected final String TEXT_171 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_172 = " - \" +e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_173 = NL + "\t\t\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_174 = NL + "          \t\tcontinue;" + NL + "            }";
  ...
  protected final String TEXT_188 = NL + "        \t\tlog.error(\"";
  protected final String TEXT_189 = " - \" +e.getMessage());" + NL + "\t        \t";
  protected final String TEXT_190 = NL + "                    \tif(isMatch";
  protected final String TEXT_191 = "){" + NL + "                    \t\tSystem.err.println(e.getMessage());" + NL + "                    \t}";
  protected final String TEXT_192 = NL + "                    \tSystem.err.println(e.getMessage());";
  protected final String TEXT_193 = NL + "                ";
  protected final String TEXT_194 = " = null;";
  protected final String TEXT_195 = NL + "            \t";
  protected final String TEXT_196 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_197 = ";";
  protected final String TEXT_198 = NL + "    }\t\t\t\t\t" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_199 = NL + "\t\t";
  protected final String TEXT_200 = "if(!whetherReject_";
  ...
  protected final String TEXT_214 = NL + "\t\t\tnb_line_";
