...
public class TFileOutputMSXMLEndJava {
  ...
  protected final String TEXT_175 = NL + "\t\t" + NL + "\t\tjava.util.List<org.dom4j.Element> allElements_";
  protected final String TEXT_176 = "_";
  protected final String TEXT_177 = " = ";
  protected final String TEXT_178 = ".elements();" + NL + "\t\tjava.util.List<org.dom4j.Element> elements_";
  protected final String TEXT_179 = "_";
  protected final String TEXT_180 = " = ";
  protected final String TEXT_181 = ".elements(qname_";
  protected final String TEXT_182 = "_";
  protected final String TEXT_183 = ");" + NL + "\t\tint order_";
  protected final String TEXT_184 = "_";
  protected final String TEXT_185 = " = allElements_";
  protected final String TEXT_186 = "_";
  protected final String TEXT_187 = ".size();" + NL + "\t\tint app_size_";
  protected final String TEXT_188 = " = elements_";
  protected final String TEXT_189 = "_";
  protected final String TEXT_190 = ".size();" + NL + "\t\tif(app_size_";
  protected final String TEXT_191 = " > 0){" + NL + "\t\t\torder_";
  protected final String TEXT_192 = "_";
  protected final String TEXT_193 = " = 1 + allElements_";
  protected final String TEXT_194 = "_";
  protected final String TEXT_195 = ".indexOf(elements_";
  protected final String TEXT_196 = "_";
  protected final String TEXT_197 = ".get(app_size_";
  protected final String TEXT_198 = "-1));" + NL + "\t\t}else{";
  protected final String TEXT_199 = NL + "\t\t\torg.dom4j.QName qname_sibling_";
  protected final String TEXT_200 = "_";
  protected final String TEXT_201 = "_";
  protected final String TEXT_202 = " = org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_203 = "\",org.dom4j.DocumentHelper.createNamespace(\"";
  protected final String TEXT_204 = "\",\"";
  protected final String TEXT_205 = "\"));" + NL + "\t\t\torg.dom4j.Element sibling_";
  protected final String TEXT_206 = "_";
  protected final String TEXT_207 = "_";
  protected final String TEXT_208 = " = ";
  protected final String TEXT_209 = ".element(qname_sibling_";
  protected final String TEXT_210 = "_";
  protected final String TEXT_211 = "_";
  protected final String TEXT_212 = ");" + NL + "\t\t\tint index_sibling_";
  protected final String TEXT_213 = "_";
  protected final String TEXT_214 = "_";
  protected final String TEXT_215 = " = allElements_";
  protected final String TEXT_216 = "_";
  protected final String TEXT_217 = ".indexOf(sibling_";
  protected final String TEXT_218 = "_";
  protected final String TEXT_219 = "_";
  protected final String TEXT_220 = ");" + NL + "\t\t\tif(index_sibling_";
  protected final String TEXT_221 = "_";
  protected final String TEXT_222 = "_";
  protected final String TEXT_223 = " > -1) {" + NL + "\t\t\t\torder_";
  protected final String TEXT_224 = "_";
  protected final String TEXT_225 = " = index_sibling_";
  ...
  protected final String TEXT_231 = ".elements().add(order_";
  protected final String TEXT_232 = "_";
  protected final String TEXT_233 = ",";
  protected final String TEXT_234 = ");";
  protected final String TEXT_235 = NL + "\t\tif (";
  protected final String TEXT_236 = ".getNamespaceForPrefix(\"";
  ...
  protected final String TEXT_243 = "!=null){" + NL + "\t\t\tnestXMLTool_";
  protected final String TEXT_244 = " .parseAndAdd(";
  protected final String TEXT_245 = ",";
  protected final String TEXT_246 = ");" + NL + "\t\t}";
  protected final String TEXT_247 = NL + "\t\telse{" + NL + "\t\t\tnestXMLTool_";
  protected final String TEXT_248 = " .parseAndAdd(";
  protected final String TEXT_249 = ",\"\");" + NL + "\t\t\t";
  protected final String TEXT_250 = ".addAttribute(\"xsi:nil\",\"true\");" + NL + "\t\t}";
  protected final String TEXT_251 = NL + "\t\tif(";
  protected final String TEXT_252 = "!=null){" + NL + "\t\t\tnestXMLTool_";
  protected final String TEXT_253 = " .setText(";
  protected final String TEXT_254 = ",";
  protected final String TEXT_255 = ");" + NL + "\t\t}";
  protected final String TEXT_256 = NL + "\t\telse{" + NL + "\t\t\t";
  protected final String TEXT_257 = ".setText(\"\");" + NL + "\t\t\t";
  protected final String TEXT_258 = ".addAttribute(\"xsi:nil\",\"true\");" + NL + "\t\t}";
  protected final String TEXT_259 = NL + "\t\tnestXMLTool_";
  protected final String TEXT_260 = ".parseAndAdd(";
  ...
  protected final String TEXT_270 = ".addAttribute(org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_271 = "\",org.dom4j.DocumentHelper.createNamespace(\"";
  protected final String TEXT_272 = "\",\"";
  protected final String TEXT_273 = "\")),";
  protected final String TEXT_274 = ");";
  protected final String TEXT_275 = NL + "\t\t}";
  protected final String TEXT_276 = NL + "\t\t\t";
  protected final String TEXT_277 = ".addAttribute(\"";
  protected final String TEXT_278 = "\", \"";
  protected final String TEXT_279 = "\");";
  protected final String TEXT_280 = NL + "\t\t\t";
  protected final String TEXT_281 = ".addAttribute(org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_282 = "\",org.dom4j.DocumentHelper.createNamespace(\"";
  protected final String TEXT_283 = "\",\"";
  protected final String TEXT_284 = "\")),\"";
  protected final String TEXT_285 = "\");";
  protected final String TEXT_286 = NL + "\t\tif(";
  protected final String TEXT_287 = "!=null){" + NL + "\t\t\t";
  protected final String TEXT_288 = ".addNamespace(\"";
  protected final String TEXT_289 = "\",TalendString.replaceSpecialCharForXML(";
  protected final String TEXT_290 = "));";
  protected final String TEXT_291 = NL + "        \t";
  protected final String TEXT_292 = ".setQName(org.dom4j.DocumentHelper.createQName(";
  protected final String TEXT_293 = ".getName()," + NL + "        \torg.dom4j.DocumentHelper.createNamespace(\"\",TalendString.replaceSpecialCharForXML(";
  protected final String TEXT_294 = "))));";
  protected final String TEXT_295 = NL + "\t\t}";
  protected final String TEXT_296 = NL + "\t\t\t";
  protected final String TEXT_297 = ".addNamespace(\"";
  protected final String TEXT_298 = "\",TalendString.replaceSpecialCharForXML(\"";
  protected final String TEXT_299 = "\"));";
  protected final String TEXT_300 = NL + "        \t";
  protected final String TEXT_301 = ".setQName(org.dom4j.DocumentHelper.createQName(";
  protected final String TEXT_302 = ".getName()," + NL + "        \torg.dom4j.DocumentHelper.createNamespace(\"\",TalendString.replaceSpecialCharForXML(\"";
  protected final String TEXT_303 = "\"))));";
  protected final String TEXT_304 = "true";
  protected final String TEXT_305 = " && (";
  protected final String TEXT_306 = "(";
  protected final String TEXT_307 = "==null && ";
  protected final String TEXT_308 = " == null) || (true &&";
  ...
  protected final String TEXT_318 = ".getText()!=null" + NL + " && ";
  protected final String TEXT_319 = ".getText().equals(\"";
  protected final String TEXT_320 = "\")" + NL + " )";
  protected final String TEXT_321 = " && (";
  protected final String TEXT_322 = "(";
  protected final String TEXT_323 = "==null && ";
  protected final String TEXT_324 = ".attribute(";
  protected final String TEXT_325 = ") == null) || (true && ";
  protected final String TEXT_326 = ".attribute(";
  protected final String TEXT_327 = ")!=null" + NL + "&& ";
  protected final String TEXT_328 = ".attribute(";
  protected final String TEXT_329 = ").getText()!=null" + NL + "&&";
  protected final String TEXT_330 = ".attribute(";
  protected final String TEXT_331 = ").getText().equals(";
  ...
  protected final String TEXT_338 = ".attribute(";
  protected final String TEXT_339 = ").getText()!=null" + NL + "&&";
  protected final String TEXT_340 = ".attribute(";
  protected final String TEXT_341 = ").getText().equals(\"";
  protected final String TEXT_342 = "\")" + NL + " )";
  protected final String TEXT_343 = NL;
  protected final String TEXT_344 = ".element(org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_345 = "\",org.dom4j.DocumentHelper.createNamespace(\"";
  protected final String TEXT_346 = "\",\"";
  protected final String TEXT_347 = "\")))";
  protected final String TEXT_348 = ".element(\"";
  protected final String TEXT_349 = "\")";
  protected final String TEXT_350 = NL + "TalendWrapTool_";
  protected final String TEXT_351 = " talendWrapTool_";
  protected final String TEXT_352 = " = new TalendWrapTool_";
  protected final String TEXT_353 = "();";
  protected final String TEXT_354 = NL + "class TalendWrapTool_";
  protected final String TEXT_355 = " {";
  protected final String TEXT_356 = NL + "}";
  protected final String TEXT_357 = NL + "nb_line_";
  protected final String TEXT_358 = "++;";
  protected final String TEXT_359 = NL + "public void create";
  protected final String TEXT_360 = "Doc(";
  protected final String TEXT_361 = "Struct ";
  protected final String TEXT_362 = ") throws java.lang.Exception {";
  protected final String TEXT_363 = NL + "talendWrapTool_";
  protected final String TEXT_364 = ".create";
  protected final String TEXT_365 = "Doc(";
  protected final String TEXT_366 = ");";
  protected final String TEXT_367 = NL + "java.util.List<java.util.List<String>> groupbyList_";
  protected final String TEXT_368 = " = new java.util.ArrayList<java.util.List<String>>();" + NL + "final java.util.Map<String,String> valueMap_";
  protected final String TEXT_369 = " = new java.util.HashMap<String,String>();" + NL + "boolean isXML10Char_";
  protected final String TEXT_370 = " = true;" + NL + "" + NL + "// sort group root element for judgement of group" + NL + "java.util.List<org.dom4j.Element> groupElementList_";
  protected final String TEXT_371 = " = new java.util.ArrayList<org.dom4j.Element>();" + NL + "org.dom4j.Element root4Group_";
  protected final String TEXT_372 = " = null;";
  protected final String TEXT_373 = NL + "org.dom4j.Element root_";
  protected final String TEXT_374 = "_";
  protected final String TEXT_375 = " = null;" + NL + "//used to judge branch root tags" + NL + "boolean needRoot_";
  protected final String TEXT_376 = "_";
  protected final String TEXT_377 = "  = true;" + NL + "//namespace support" + NL + "java.util.Map<String,String> uriToPrefixForDefaultNamespace_";
  protected final String TEXT_378 = "_";
  protected final String TEXT_379 = " = new java.util.HashMap<String,String>();" + NL + "java.util.Map<String,String> prefixToUriForNamespace_";
  protected final String TEXT_380 = "_";
  protected final String TEXT_381 = " = new java.util.HashMap<String,String>();";
  protected final String TEXT_382 = NL + "\tvoid putValue_";
  protected final String TEXT_383 = "_";
  protected final String TEXT_384 = "(final ";
  protected final String TEXT_385 = "Struct ";
  protected final String TEXT_386 = "){";
  protected final String TEXT_387 = NL + "\t\tvalueMap_";
  protected final String TEXT_388 = ".put(\"";
  protected final String TEXT_389 = "\", ";
  protected final String TEXT_390 = ");" + NL + "\t\tif(isXML10Char_";
  protected final String TEXT_391 = ") {" + NL + "\t\t\tisXML10Char_";
  protected final String TEXT_392 = " = org.talend.util.xml.XMLText.isValid(";
  protected final String TEXT_393 = ");" + NL + "\t\t}";
  protected final String TEXT_394 = NL + "\t}";
  protected final String TEXT_395 = NL + "\t}";
  protected final String TEXT_396 = NL + "\t" + NL + "\tvalueMap_";
  protected final String TEXT_397 = ".clear();" + NL + "\t";
  protected final String TEXT_398 = NL + "\t";
  protected final String TEXT_399 = NL + "\tputValue_";
  protected final String TEXT_400 = "_";
  protected final String TEXT_401 = "(";
  protected final String TEXT_402 = ");";
  protected final String TEXT_403 = NL + "\t\t\tvalueMap_";
  protected final String TEXT_404 = ".put(\"";
  protected final String TEXT_405 = "\", ";
  protected final String TEXT_406 = ");" + NL + "\t\t\tif(isXML10Char_";
  protected final String TEXT_407 = ") {" + NL + "\t\t\t\tisXML10Char_";
  protected final String TEXT_408 = " = org.talend.util.xml.XMLText.isValid(";
  protected final String TEXT_409 = ");" + NL + "\t\t\t}";
  protected final String TEXT_410 = NL + "\t";
  protected final String TEXT_411 = NL + "\t";
  protected final String TEXT_412 = NL + "\t// build root xml tree " + NL + "\tif (needRoot_";
  protected final String TEXT_413 = "_";
  protected final String TEXT_414 = ") {" + NL + "\t\tneedRoot_";
  ...
  protected final String TEXT_422 = NL + "\t// build root xml tree " + NL + "\tif (needRoot_";
  protected final String TEXT_423 = "_";
  protected final String TEXT_424 = ") {" + NL + "\t\tneedRoot_";
  protected final String TEXT_425 = "_";
  protected final String TEXT_426 = " = false;" + NL + "\t\torg.dom4j.XPath xpath_";
  protected final String TEXT_427 = "_";
  protected final String TEXT_428 = " = doc_";
  protected final String TEXT_429 = ".createXPath(\"";
  protected final String TEXT_430 = "\");" + NL + "\t\txpath_";
  protected final String TEXT_431 = "_";
  protected final String TEXT_432 = ".setNamespaceURIs(prefixToUriForNamespace_";
  protected final String TEXT_433 = "_";
  protected final String TEXT_434 = ");" + NL + "\t\troot_";
  protected final String TEXT_435 = "_";
  protected final String TEXT_436 = " = " + NL + "\t\t\t(org.dom4j.Element)xpath_";
  protected final String TEXT_437 = "_";
  protected final String TEXT_438 = ".selectSingleNode(doc_";
  protected final String TEXT_439 = ");" + NL + "\t\tif(!DocumentHelper.isMatchAtRoot(root_";
  protected final String TEXT_440 = "_";
  protected final String TEXT_441 = ",prefixToUriForNamespace_";
  protected final String TEXT_442 = "_";
  protected final String TEXT_443 = ")) {" + NL + "\t\t\tSystem.err.println(\"warn:::the pre input source content is empty!\");" + NL + "\t\t\t";
  protected final String TEXT_444 = NL + "\t\t\t";
  protected final String TEXT_445 = NL + "\t\t\troot_";
  protected final String TEXT_446 = "_";
  protected final String TEXT_447 = " = (org.dom4j.Element)xpath_";
  protected final String TEXT_448 = "_";
  protected final String TEXT_449 = ".selectSingleNode(doc_";
  protected final String TEXT_450 = ");" + NL + "\t\t}" + NL + "\t}" + NL + "\t";
  protected final String TEXT_451 = NL + "\t// build root xml tree " + NL + "\tif (needRoot_";
  protected final String TEXT_452 = "_";
  protected final String TEXT_453 = ") {" + NL + "\t\tneedRoot_";
  protected final String TEXT_454 = "_";
  protected final String TEXT_455 = " = false;" + NL + "\t\torg.dom4j.XPath xpath_";
  protected final String TEXT_456 = "_";
  protected final String TEXT_457 = " = doc_";
  protected final String TEXT_458 = ".createXPath(\"";
  protected final String TEXT_459 = "\");" + NL + "\t\txpath_";
  protected final String TEXT_460 = "_";
  protected final String TEXT_461 = ".setNamespaceURIs(prefixToUriForNamespace_";
  protected final String TEXT_462 = "_";
  protected final String TEXT_463 = ");" + NL + "\t\troot_";
  protected final String TEXT_464 = "_";
  protected final String TEXT_465 = " = " + NL + "\t\t\t(org.dom4j.Element)xpath_";
  protected final String TEXT_466 = "_";
  protected final String TEXT_467 = ".selectSingleNode(doc_";
  protected final String TEXT_468 = ");" + NL + "\t\t";
  protected final String TEXT_469 = NL + "\t\t";
  protected final String TEXT_470 = NL + "\t\troot_";
  protected final String TEXT_471 = "_";
  protected final String TEXT_472 = " = ";
  protected final String TEXT_473 = ";" + NL + "\t}else{" + NL + "\t\t";
  protected final String TEXT_474 = NL + "\t}";
  protected final String TEXT_475 = NL + "\t" + NL + "\t// build group xml tree ";
  protected final String TEXT_476 = "\t\t" + NL + "\t\tboolean bl_";
  protected final String TEXT_477 = "= false;//true:find the insert node;false:not";
  protected final String TEXT_478 = NL + "\t\tif(bl_";
  protected final String TEXT_479 = "==false){" + NL + "\t\t\tjava.util.List<org.dom4j.Element> listNodes= ";
  protected final String TEXT_480 = ".elements();" + NL + "\t\t\tif(listNodes!=null && listNodes.size()>0){" + NL + "\t\t\t\tint j=0;" + NL + "\t\t\t\tfor(j=0;j<listNodes.size();j++){" + NL + "\t\t\t\t\torg.dom4j.Element tempElem =listNodes.get(j);" + NL + "\t\t\t\t\tjava.util.Map<String,String> currentDeclaredNamespacesMapping = null;" + NL + "\t\t\t\t\t";
  protected final String TEXT_481 = NL + "\t\t\t\t\tif(DocumentHelper.compareNodes(\"";
  protected final String TEXT_482 = "\",tempElem,uriToPrefixForDefaultNamespace_";
  protected final String TEXT_483 = "_";
  protected final String TEXT_484 = ",currentDeclaredNamespacesMapping,";
  protected final String TEXT_485 = "false";
  protected final String TEXT_486 = "true";
  protected final String TEXT_487 = ")){" + NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_488 = "){" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_489 = NL + "\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\tif(j>=listNodes.size()){" + NL + "\t\t\t\t\tbl_";
  protected final String TEXT_490 = "=true;" + NL + "\t\t\t\t}" + NL + "\t\t\t}else{" + NL + "\t\t\t\tbl_";
  protected final String TEXT_491 = "=true;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tif(bl_";
  protected final String TEXT_492 = "==true){";
  protected final String TEXT_493 = NL + "\t\t}";
  protected final String TEXT_494 = NL + "\t// build loop xml tree";
  protected final String TEXT_495 = NL;
  protected final String TEXT_496 = NL + "\tjava.io.FileOutputStream stream_";
  protected final String TEXT_497 = " = new java.io.FileOutputStream(fileName_";
  protected final String TEXT_498 = ");" + NL + " \t" + NL + "\torg.dom4j.io.XMLWriter output_";
  protected final String TEXT_499 = " = null;";
  protected final String TEXT_500 = NL + "\tif(talendWrapTool_";
  protected final String TEXT_501 = ".isXML10Char_";
  protected final String TEXT_502 = ") {";
  protected final String TEXT_503 = NL + "\tif(isXML10Char_";
  protected final String TEXT_504 = ") {";
  protected final String TEXT_505 = NL + "\t\toutput_";
  protected final String TEXT_506 = " = new org.dom4j.io.XMLWriter(stream_";
  protected final String TEXT_507 = ", format_";
  protected final String TEXT_508 = ");" + NL + "\t} else {" + NL + "\t\toutput_";
  protected final String TEXT_509 = " = new org.dom4j.io.XMLWriter(" + NL + "\t\t\t\t\t\t\tstream_";
  protected final String TEXT_510 = ", format_";
  protected final String TEXT_511 = ") {" + NL + "\t\t\t\t\t\t" + NL + "\t\t\tprivate org.dom4j.io.OutputFormat format = null;" + NL + "\t\t\t" + NL + "\t\t\t{" + NL + "\t\t\t\tformat = format_";
  protected final String TEXT_512 = ";" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tpublic void writeDeclaration() throws IOException {" + NL + "\t\t        String encoding = format.getEncoding();" + NL + "" + NL + "\t\t        // Only print of declaration is not suppressed" + NL + "\t\t        if (!format.isSuppressDeclaration()) {" + NL + "\t\t            // Assume 1.0 version" + NL + "\t\t            if (encoding.equals(\"UTF8\")) {" + NL + "\t\t                writer.write(\"<?xml version=\\\"1.1\\\"\");" + NL + "" + NL + "\t\t                if (!format.isOmitEncoding()) {" + NL + "\t\t                    writer.write(\" encoding=\\\"UTF-8\\\"\");" + NL + "\t\t                }" + NL + "" + NL + "\t\t                writer.write(\"?>\");" + NL + "\t\t            } else {" + NL + "\t\t                writer.write(\"<?xml version=\\\"1.1\\\"\");" + NL + "" + NL + "\t\t                if (!format.isOmitEncoding()) {" + NL + "\t\t                    writer.write(\" encoding=\\\"\" + encoding + \"\\\"\");" + NL + "\t\t                }" + NL + "" + NL + "\t\t                writer.write(\"?>\");" + NL + "\t\t            }" + NL + "" + NL + "\t\t            if (format.isNewLineAfterDeclaration()) {" + NL + "\t\t                println();" + NL + "\t\t            }" + NL + "\t\t        }" + NL + "\t\t    }" + NL + "\t\t};" + NL + "\t}" + NL + "\t" + NL + "    nestXMLTool_";
  protected final String TEXT_513 = ".replaceDefaultNameSpace(doc_";
  protected final String TEXT_514 = ".getRootElement());";
  protected final String TEXT_515 = NL + "    nestXMLTool_";
  protected final String TEXT_516 = ".removeEmptyElement(doc_";
  protected final String TEXT_517 = ".getRootElement());";
  protected final String TEXT_518 = NL + "\toutput_";
  protected final String TEXT_519 = ".setEscapeText(";
  protected final String TEXT_520 = ");" + NL + "    output_";
  protected final String TEXT_521 = ".write(doc_";
  protected final String TEXT_522 = ");" + NL + "    output_";
  protected final String TEXT_523 = ".close();" + NL + "    " + NL + "\tnameToElement_";
  protected final String TEXT_524 = ".clear();" + NL + "\t" + NL + "    globalMap.put(\"";
  protected final String TEXT_525 = "_NB_LINE\",nb_line_";
  protected final String TEXT_526 = ");" + NL;
  protected final String TEXT_527 = NL + "\tif(nb_line_";
  protected final String TEXT_528 = " == 0){" + NL + "\t\tcreateFile";
  protected final String TEXT_529 = ".delete();" + NL + "\t}";
