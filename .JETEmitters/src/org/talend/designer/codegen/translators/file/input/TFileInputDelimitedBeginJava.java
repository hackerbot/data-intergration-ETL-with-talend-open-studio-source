...
public class TFileInputDelimitedBeginJava
{
  ...
  protected final String TEXT_523 = NL + "\t\t\t\t\t\t\t\t\t\tthrow new RuntimeException(\"Value is empty for column : '";
  ...
  protected final String TEXT_532 = NL + "\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_538 = NL + " \t\t\t\t\tint filedsum = ";
  protected final String TEXT_539 = ".length;" + NL + " \t\t\t\t\tif(filedsum < (";
  protected final String TEXT_540 = " ";
  protected final String TEXT_541 = "+ dynamic_column_count_";
  protected final String TEXT_542 = "-1";
  protected final String TEXT_543 = ")){" + NL + " \t\t\t\t\t\tthrow new java.lang.Exception(\"Column(s) missing\");" + NL + " \t\t\t\t\t} else if(filedsum > (";
  protected final String TEXT_544 = " ";
  protected final String TEXT_545 = "+ dynamic_column_count_";
  protected final String TEXT_546 = " -1";
  protected final String TEXT_547 = ")) {" + NL + " \t\t\t\t\t\tthrow new RuntimeException(\"Too many columns\");" + NL + " \t\t\t\t\t}     " + NL + "\t\t\t\t";
  ...
  protected final String TEXT_554 = NL + "\t\t\t\t\t\t\tboolean isFirstCheckDyn_";
  protected final String TEXT_555 = " = true;" + NL + "\t\t\t\t\t\t\troutines.system.Dynamic dynamic_";
  protected final String TEXT_556 = " = new routines.system.Dynamic();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_557 = NL + "\t\t\t\tint nb_line_";
  protected final String TEXT_558 = " = 0;" + NL + "\t\t\t\tint footer_";
  protected final String TEXT_559 = " = ";
  protected final String TEXT_560 = ";" + NL + "\t\t\t\tint totalLine";
  protected final String TEXT_561 = " = 0;" + NL + "\t\t\t\tint limit";
  protected final String TEXT_562 = " = ";
  protected final String TEXT_563 = ";" + NL + "\t\t\t\tint lastLine";
  protected final String TEXT_564 = " = -1;\t" + NL + "\t\t\t\t" + NL + "\t\t\t\tchar fieldSeparator_";
  protected final String TEXT_565 = "[] = null;" + NL + "\t\t\t\t" + NL + "\t\t\t\t//support passing value (property: Field Separator) by 'context.fs' or 'globalMap.get(\"fs\")'. " + NL + "\t\t\t\tif ( ((String)";
  protected final String TEXT_566 = ").length() > 0 ){" + NL + "\t\t\t\t\tfieldSeparator_";
  protected final String TEXT_567 = " = ((String)";
  protected final String TEXT_568 = ").toCharArray();" + NL + "\t\t\t\t}else {\t\t\t" + NL + "\t\t\t\t\tthrow new IllegalArgumentException(\"Field Separator must be assigned a char.\"); " + NL + "\t\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\t\tchar rowSeparator_";
  protected final String TEXT_569 = "[] = null;" + NL + "\t\t\t" + NL + "\t\t\t\t//support passing value (property: Row Separator) by 'context.rs' or 'globalMap.get(\"rs\")'. " + NL + "\t\t\t\tif ( ((String)";
  protected final String TEXT_570 = ").length() > 0 ){" + NL + "\t\t\t\t\trowSeparator_";
  protected final String TEXT_571 = " = ((String)";
  protected final String TEXT_572 = ").toCharArray();" + NL + "\t\t\t\t}else {" + NL + "\t\t\t\t\tthrow new IllegalArgumentException(\"Row Separator must be assigned a char.\"); " + NL + "\t\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\t\tObject filename_";
  protected final String TEXT_573 = " = ";
  protected final String TEXT_574 = ";\t\t" + NL + "\t\t\t\tcom.talend.csv.CSVReader csvReader";
  protected final String TEXT_575 = " = null;" + NL + "\t" + NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\t";
  protected final String TEXT_576 = NL + "\t        \t\t\tjava.util.zip.ZipInputStream zis_";
  protected final String TEXT_577 = " = null;" + NL + "\t        \t\t\ttry {" + NL + "\t\t        \t\t\tif(filename_";
  protected final String TEXT_578 = " instanceof java.io.InputStream){" + NL + "\t\t        \t\t\t\tzis_";
  protected final String TEXT_579 = " = new java.util.zip.ZipInputStream(new java.io.BufferedInputStream((java.io.InputStream)filename_";
  protected final String TEXT_580 = "));" + NL + "\t\t        \t\t\t}else{" + NL + "\t\t        \t\t\t\tzis_";
  protected final String TEXT_581 = " = new java.util.zip.ZipInputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(String.valueOf(filename_";
  protected final String TEXT_582 = "))));" + NL + "\t\t        \t\t\t}" + NL + "\t        \t\t\t} catch(java.lang.Exception e) {" + NL + "\t        \t\t\t\t";
  protected final String TEXT_583 = NL + "\t\t\t\t\t\t\t\tthrow e;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_584 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_585 = NL + "\t\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_586 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_587 = NL + "\t\t\t\t\t\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_588 = NL + "\t        \t\t\t}" + NL + "\t        \t\t\tjava.util.zip.ZipEntry entry_";
  protected final String TEXT_589 = " = null;" + NL + "\t\t        " + NL + "\t\t\t\t        while (true) {" + NL + "\t\t\t        \t\ttry {" + NL + "\t        \t\t\t\t\tentry_";
  protected final String TEXT_590 = " = zis_";
  protected final String TEXT_591 = ".getNextEntry();" + NL + "\t        \t\t\t\t} catch(java.lang.Exception e) {" + NL + "\t        \t\t\t\t\t";
  protected final String TEXT_592 = NL + "\t\t\t\t\t\t\t\t\tthrow e;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_593 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_594 = NL + "\t\t\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_595 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_596 = NL + "\t\t\t\t\t\t\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_597 = NL + "\t        \t\t\t\t}" + NL + "\t        \t\t\t\tif(entry_";
  protected final String TEXT_598 = " == null) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t        \t\t\t\tif(entry_";
  protected final String TEXT_599 = ".isDirectory()){ //directory" + NL + "\t        \t\t\t\t\tcontinue;" + NL + "\t        \t\t\t\t}" + NL + "\t        \t\t\t\tString[] row";
  protected final String TEXT_600 = "=null;" + NL + "\t        \t\t\t\tint currentLine";
  protected final String TEXT_601 = " = 0;" + NL + "\t        \t\t\t\tint outputLine";
  protected final String TEXT_602 = " = 0;" + NL + "\t        \t\t\t\ttry {//TD110 begin" + NL + "\t        \t\t\t\t\tcsvReader";
  protected final String TEXT_603 = "=new com.talend.csv.CSVReader(zis_";
  protected final String TEXT_604 = ", fieldSeparator_";
  protected final String TEXT_605 = "[0], ";
  protected final String TEXT_606 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_607 = NL + "\t\t\t\t\t\tString[] row";
  protected final String TEXT_608 = "=null;" + NL + "\t\t\t\t\t\tint currentLine";
  protected final String TEXT_609 = " = 0;" + NL + "\t        \t\t\tint outputLine";
  protected final String TEXT_610 = " = 0;" + NL + "\t\t\t\t\t\ttry {//TD110 begin" + NL + "\t\t\t\t\t\t\tif(filename_";
  protected final String TEXT_611 = " instanceof java.io.InputStream){" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_612 = NL + "\t\t\t\t\t\t\t\tcsvReader";
  protected final String TEXT_613 = "=new com.talend.csv.CSVReader((java.io.InputStream)filename_";
  protected final String TEXT_614 = ", fieldSeparator_";
  protected final String TEXT_615 = "[0], ";
  protected final String TEXT_616 = ");" + NL + "\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\tcsvReader";
  protected final String TEXT_617 = "=new com.talend.csv.CSVReader(new java.io.BufferedReader(new java.io.InputStreamReader(" + NL + "\t\t                \t\tnew java.io.FileInputStream(String.valueOf(filename_";
  protected final String TEXT_618 = ")),";
  protected final String TEXT_619 = ")), fieldSeparator_";
  protected final String TEXT_620 = "[0]);" + NL + "\t\t        \t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_621 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tcsvReader";
  protected final String TEXT_622 = ".setTrimWhitespace(false);" + NL + "\t\t\t\t\tif ( (rowSeparator_";
  protected final String TEXT_623 = "[0] != '\\n') && (rowSeparator_";
  protected final String TEXT_624 = "[0] != '\\r') )" + NL + "\t        \t\t\tcsvReader";
  protected final String TEXT_625 = ".setLineEnd(\"\"+rowSeparator_";
  protected final String TEXT_626 = "[0]);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_627 = NL + "\t        \t\t\t\tcsvReader";
  protected final String TEXT_628 = ".setQuoteChar('";
  protected final String TEXT_629 = "');" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_630 = NL + "\t\t\t\t\t\t\tString textEnclosure1_";
  protected final String TEXT_631 = " = ";
  protected final String TEXT_632 = "; " + NL + "\t\t\t\t\t\t\tchar textEnclosure_";
  protected final String TEXT_633 = "[] = null;" + NL + "\t\t\t        " + NL + "\t    \t\t\t\t    if(((String)textEnclosure1_";
  protected final String TEXT_634 = ").length() > 0 ){ " + NL + "\t  \t\t\t\t\t\t\ttextEnclosure_";
  protected final String TEXT_635 = " = ((String)textEnclosure1_";
  protected final String TEXT_636 = ").toCharArray(); " + NL + "\t\t\t\t\t\t\t}else { " + NL + "\t            \t\t\t\tthrow new IllegalArgumentException(\"Text Enclosure must be assigned a char.\"); " + NL + "\t        \t\t\t\t}" + NL + "\t\t\t\t\t\t\tcsvReader";
  protected final String TEXT_637 = ".setQuoteChar(textEnclosure_";
  protected final String TEXT_638 = "[0]); " + NL + "\t\t\t\t\t\t";
  protected final String TEXT_639 = NL + "\t            \t\t\t\tcsvReader";
  protected final String TEXT_640 = ".setEscapeChar('\\\\');" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_641 = NL + "\t            \t\t\t\tcsvReader";
  protected final String TEXT_642 = ".setEscapeChar(csvReader";
  protected final String TEXT_643 = ".getQuoteChar());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_644 = NL + "\t            \t\t\t\t//?????doesn't work for other escapeChar" + NL + "\t            \t\t\t\t//the default escape mode is double escape" + NL + "\t            \t\t\t\tcsvReader";
  protected final String TEXT_645 = ".setEscapeChar(csvReader";
  protected final String TEXT_646 = ".getQuoteChar());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_647 = " " + NL + "\t\t        \t\t\tString escapeChar1_";
  protected final String TEXT_648 = " = ";
  protected final String TEXT_649 = ";          " + NL + "\t\t        \t\t\tchar escapeChar_";
  protected final String TEXT_650 = "[] = null;" + NL + "\t\t\t        " + NL + "\t\t\t\t\t        if(((String)escapeChar1_";
  protected final String TEXT_651 = ").length() > 0 ){ " + NL + "\t\t\t\t\t        \tescapeChar_";
  protected final String TEXT_652 = " = ((String)escapeChar1_";
  protected final String TEXT_653 = ").toCharArray(); " + NL + "\t\t\t\t\t  \t\t}else { " + NL + "\t\t        \t\t\t    throw new IllegalArgumentException(\"Escape Char must be assigned a char.\"); " + NL + "\t\t        \t\t\t}" + NL + "\t\t       \t\t\t\tif(escapeChar_";
  protected final String TEXT_654 = "[0] == '\\\\'){" + NL + "\t\t       \t\t\t\t\tcsvReader";
  protected final String TEXT_655 = ".setEscapeChar('\\\\');" + NL + "\t\t       \t\t\t\t}else if(escapeChar_";
  protected final String TEXT_656 = "[0] ==";
  protected final String TEXT_657 = "'";
  protected final String TEXT_658 = "'";
  protected final String TEXT_659 = "textEnclosure_";
  protected final String TEXT_660 = "[0]";
  protected final String TEXT_661 = "){" + NL + "\t\t       \t\t\t\t\tcsvReader";
  protected final String TEXT_662 = ".setEscapeChar(csvReader";
  protected final String TEXT_663 = ".getQuoteChar());" + NL + "\t\t       \t\t\t\t} else {" + NL + "\t\t       \t\t\t\t\t//the default escape mode is double escape" + NL + "\t\t       \t\t\t\t\tcsvReader";
  protected final String TEXT_664 = ".setEscapeChar(csvReader";
  protected final String TEXT_665 = ".getQuoteChar());" + NL + "\t\t       \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_666 = "      " + NL + "\t\t" + NL + "\t\t\t" + NL + "\t\t\t\t\t\tif(footer_";
  protected final String TEXT_667 = " > 0){" + NL + "\t\t\t\t\t\tfor(totalLine";
  protected final String TEXT_668 = "=0;totalLine";
  protected final String TEXT_669 = " < ";
  protected final String TEXT_670 = "; totalLine";
  protected final String TEXT_671 = "++){" + NL + "\t\t\t\t\t\t\tcsvReader";
  protected final String TEXT_672 = ".readNext();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tcsvReader";
  protected final String TEXT_673 = ".setSkipEmptyRecords(";
  protected final String TEXT_674 = ");" + NL + "\t\t\t            while (csvReader";
  protected final String TEXT_675 = ".readNext()) {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_676 = NL + "\t\t\t\t\t\t\t\trow";
  protected final String TEXT_677 = "=csvReader";
  protected final String TEXT_678 = ".getValues();" + NL + "\t\t\t\t\t\t\t\tif(!(row";
  protected final String TEXT_679 = ".length == 1 && (\"\\015\").equals(row";
  protected final String TEXT_680 = "[0]))){//empty line when row separator is '\\n'" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_681 = NL + "\t                " + NL + "\t                \t\ttotalLine";
  protected final String TEXT_682 = "++;" + NL + "\t                " + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_683 = NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_684 = NL + "\t                " + NL + "\t\t\t            }" + NL + "\t            \t\tint lastLineTemp";
  protected final String TEXT_685 = " = totalLine";
  protected final String TEXT_686 = " - footer_";
  protected final String TEXT_687 = "   < 0? 0 : totalLine";
  protected final String TEXT_688 = " - footer_";
  protected final String TEXT_689 = " ;" + NL + "\t            \t\tif(lastLine";
  protected final String TEXT_690 = " > 0){" + NL + "\t                \t\tlastLine";
  protected final String TEXT_691 = " = lastLine";
  protected final String TEXT_692 = " < lastLineTemp";
  protected final String TEXT_693 = " ? lastLine";
  protected final String TEXT_694 = " : lastLineTemp";
  protected final String TEXT_695 = "; " + NL + "\t            \t\t}else {" + NL + "\t                \t\tlastLine";
  protected final String TEXT_696 = " = lastLineTemp";
  protected final String TEXT_697 = ";" + NL + "\t            \t\t}" + NL + "\t         " + NL + "\t\t\t          \tcsvReader";
  protected final String TEXT_698 = ".close();" + NL + "\t\t\t\t        if(filename_";
  protected final String TEXT_699 = " instanceof java.io.InputStream){" + NL + "\t\t\t\t \t\t\tcsvReader";
  protected final String TEXT_700 = "=new com.talend.csv.CSVReader((java.io.InputStream)filename_";
  protected final String TEXT_701 = ", fieldSeparator_";
  protected final String TEXT_702 = "[0], ";
  protected final String TEXT_703 = ");" + NL + "\t\t        \t\t}else{" + NL + "\t\t\t\t \t\t\tcsvReader";
  protected final String TEXT_704 = "=new com.talend.csv.CSVReader(new java.io.BufferedReader(new java.io.InputStreamReader(" + NL + "\t\t\t\t          \tnew java.io.FileInputStream(String.valueOf(filename_";
  protected final String TEXT_705 = ")),";
  protected final String TEXT_706 = ")), fieldSeparator_";
  protected final String TEXT_707 = "[0]);" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tcsvReader";
  protected final String TEXT_708 = ".setTrimWhitespace(false);" + NL + "\t\t\t\t\t\tif ( (rowSeparator_";
  protected final String TEXT_709 = "[0] != '\\n') && (rowSeparator_";
  protected final String TEXT_710 = "[0] != '\\r') )\t" + NL + "\t        \t\t\t\tcsvReader";
  protected final String TEXT_711 = ".setLineEnd(\"\"+rowSeparator_";
  protected final String TEXT_712 = "[0]);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_713 = NL + "\t\t\t\t\t\t\tcsvReader";
  protected final String TEXT_714 = ".setQuoteChar('";
  protected final String TEXT_715 = "');" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_716 = NL + "\t\t\t\t\t\t\tcsvReader";
  protected final String TEXT_717 = ".setQuoteChar(textEnclosure_";
  protected final String TEXT_718 = "[0]);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_719 = NL + "\t        \t\t\t\tcsvReader";
  protected final String TEXT_720 = ".setEscapeChar('\\\\');" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_721 = NL + "\t        \t\t\t\tcsvReader";
  protected final String TEXT_722 = ".setEscapeChar(csvReader";
  protected final String TEXT_723 = ".getQuoteChar());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_724 = NL + "\t        \t\t\t\t//?????doesn't work for other escapeChar" + NL + "\t        \t\t\t\t//the default escape mode is double escape" + NL + "\t        \t\t\t\tcsvReader";
  protected final String TEXT_725 = ".setEscapeChar(csvReader";
  protected final String TEXT_726 = ".getQuoteChar());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_727 = " " + NL + "\t       \t\t\t\t\tif(escapeChar_";
  protected final String TEXT_728 = "[0] == '\\\\'){" + NL + "\t       \t\t\t\t\t\tcsvReader";
  protected final String TEXT_729 = ".setEscapeChar('\\\\');" + NL + "\t       \t\t\t\t\t}else if(escapeChar_";
  protected final String TEXT_730 = "[0] == ";
  protected final String TEXT_731 = "'";
  protected final String TEXT_732 = "'";
  protected final String TEXT_733 = "textEnclosure_";
  protected final String TEXT_734 = "[0]";
  protected final String TEXT_735 = "){" + NL + "\t       \t\t\t\t\t\tcsvReader";
  protected final String TEXT_736 = ".setEscapeChar(csvReader";
  protected final String TEXT_737 = ".getQuoteChar());" + NL + "\t       \t\t\t\t\t} else {" + NL + "\t       \t\t\t\t\t\t//the default escape mode is double escape" + NL + "\t        \t\t\t\t\tcsvReader";
  protected final String TEXT_738 = ".setEscapeChar(csvReader";
  protected final String TEXT_739 = ".getQuoteChar());" + NL + "\t       \t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_740 = "  " + NL + "\t        \t\t}" + NL + "\t        " + NL + "\t\t\t        if(limit";
  protected final String TEXT_741 = " != 0){" + NL + "\t\t\t        \tfor(currentLine";
  protected final String TEXT_742 = "=0;currentLine";
  protected final String TEXT_743 = " < ";
  protected final String TEXT_744 = ";currentLine";
  protected final String TEXT_745 = "++){" + NL + "\t\t\t        \t\tcsvReader";
  protected final String TEXT_746 = ".readNext();" + NL + "\t\t\t        \t}" + NL + "\t\t\t        }" + NL + "\t\t\t        csvReader";
  protected final String TEXT_747 = ".setSkipEmptyRecords(";
  protected final String TEXT_748 = ");" + NL + "\t        " + NL + "\t    \t\t} catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_749 = NL + "\t\t\t\t\t\tthrow e;" + NL + "\t\t\t\t\t";
  protected final String TEXT_750 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_751 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_752 = " - \" +e.getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_753 = NL + "\t\t\t\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_754 = NL + "\t    \t\t}//TD110 end" + NL + "\t        " + NL + "\t\t\t    ";
  protected final String TEXT_755 = NL + "\t\t\t    \tlog.info(\"";
  protected final String TEXT_756 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t    ";
  protected final String TEXT_757 = NL + "\t        \twhile ( limit";
  protected final String TEXT_758 = " != 0 && csvReader";
  protected final String TEXT_759 = "!=null && csvReader";
  protected final String TEXT_760 = ".readNext() ) { " + NL + "\t        " + NL + "\t\t        \trow";
  protected final String TEXT_761 = "=csvReader";
  protected final String TEXT_762 = ".getValues();" + NL + "\t        \t" + NL + "\t\t\t\t\t";
  protected final String TEXT_763 = NL + "\t        \t\t\tif(row";
  protected final String TEXT_764 = ".length == 1 && (\"\\015\").equals(row";
  protected final String TEXT_765 = "[0])){//empty line when row separator is '\\n'" + NL + "\t        \t\t\t\tcontinue;" + NL + "\t        \t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_766 = NL + "\t        \t" + NL + "\t        \t" + NL + "\t        \t\tcurrentLine";
  protected final String TEXT_767 = "++;" + NL + "\t            " + NL + "\t\t            if(lastLine";
  protected final String TEXT_768 = " > -1 && currentLine";
  protected final String TEXT_769 = " > lastLine";
  protected final String TEXT_770 = ") {" + NL + "\t\t                break;" + NL + "\t    \t        }" + NL + "\t        \t    outputLine";
  protected final String TEXT_771 = "++;" + NL + "\t            \tif (limit";
  protected final String TEXT_772 = " > 0 && outputLine";
  protected final String TEXT_773 = " > limit";
  protected final String TEXT_774 = ") {" + NL + "\t                \tbreak;" + NL + "\t            \t}  " + NL + "\t                                                                      " + NL + "\t\t\t\t\t";
  protected final String TEXT_775 = NL + "\t    \t\t\t\t\t\t\t";
  protected final String TEXT_776 = " = null;\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_777 = NL + "\t\t\t\t\t\t\t\tboolean whetherReject_";
  protected final String TEXT_778 = " = false;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_779 = " = new ";
  protected final String TEXT_780 = "Struct();" + NL + "\t\t\t\t\t\t\t\ttry {\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_781 = " " + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_782 = " = null; " + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_783 = NL + "\t    \t\t\t\t\t\t} catch (java.lang.Exception e) {" + NL + "\t\t\t\t\t\t\t        whetherReject_";
  protected final String TEXT_784 = " = true;" + NL + "        \t\t\t\t\t\t\t";
  protected final String TEXT_785 = NL + "            \t\t\t\t\t\t\tthrow(e);" + NL + "            \t\t\t\t\t\t";
  protected final String TEXT_786 = NL + "\t\t\t\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_787 = " - \" +e.getMessage());" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_788 = NL + "\t\t\t\t\t\t                    ";
  protected final String TEXT_789 = " = new ";
  protected final String TEXT_790 = "Struct();" + NL + "                \t\t\t\t\t\t\t";
  ...
  protected final String TEXT_794 = " = null;" + NL + "                \t\t\t\t\t\t";
  protected final String TEXT_795 = NL + "                \t\t\t\t\t\t\tSystem.err.println(e.getMessage());" + NL + "                \t\t\t\t\t\t\t";
  protected final String TEXT_796 = " = null;" + NL + "                \t\t\t\t\t\t";
  protected final String TEXT_797 = NL + "            \t\t\t\t\t\t\t\t";
  protected final String TEXT_798 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_799 = ";" + NL + "            \t\t\t\t\t\t\t";
  protected final String TEXT_800 = NL + "\t    \t\t\t\t\t\t}" + NL + "\t" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_801 = NL + "\t\t\t\t\t\t\t\t\t\tif(!whetherReject_";
  ...
  protected final String TEXT_806 = "Struct();" + NL + "\t             \t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_807 = " " + NL + "\t\t\t\t\t\t\t\t} " + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_808 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_809 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_810 = "+1) + \".\");" + NL + "\t\t";
