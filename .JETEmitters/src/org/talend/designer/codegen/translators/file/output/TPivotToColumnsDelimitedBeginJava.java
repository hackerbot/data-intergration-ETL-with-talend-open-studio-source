...
public class TPivotToColumnsDelimitedBeginJava {
  protected static String nl;
  public static synchronized TPivotToColumnsDelimitedBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPivotToColumnsDelimitedBeginJava result = new TPivotToColumnsDelimitedBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_3 = " = 0;" + NL + "resourceMap.put(\"nb_line_";
  protected final String TEXT_4 = "\", nb_line_";
  protected final String TEXT_5 = "); " + NL + "int nb_line_out_";
  protected final String TEXT_6 = " = 0;" + NL + "" + NL + "String fileName_";
  protected final String TEXT_7 = " = (new java.io.File(";
  protected final String TEXT_8 = ")).getAbsolutePath().replace(\"\\\\\",\"/\");" + NL + "resourceMap.put(\"fileName_";
  protected final String TEXT_9 = "\", fileName_";
  protected final String TEXT_10 = "); " + NL + "String fullName_";
  protected final String TEXT_11 = " = null;" + NL + "String extension_";
  protected final String TEXT_12 = " = null;" + NL + "String directory_";
  protected final String TEXT_13 = " = null;" + NL + "if((fileName_";
  protected final String TEXT_14 = ".indexOf(\"/\") != -1)) {" + NL + "    if(fileName_";
  protected final String TEXT_15 = ".lastIndexOf(\".\") < fileName_";
  protected final String TEXT_16 = ".lastIndexOf(\"/\")) {" + NL + "        fullName_";
  protected final String TEXT_17 = " = fileName_";
  protected final String TEXT_18 = ";" + NL + "        extension_";
  protected final String TEXT_19 = " = \"\";" + NL + "    } else {" + NL + "        fullName_";
  protected final String TEXT_20 = " = fileName_";
  protected final String TEXT_21 = ".substring(0, fileName_";
  protected final String TEXT_22 = ".lastIndexOf(\".\"));" + NL + "        extension_";
  protected final String TEXT_23 = " = fileName_";
  protected final String TEXT_24 = ".substring(fileName_";
  protected final String TEXT_25 = ".lastIndexOf(\".\"));" + NL + "    }           " + NL + "    directory_";
  protected final String TEXT_26 = " = fileName_";
  protected final String TEXT_27 = ".substring(0, fileName_";
  protected final String TEXT_28 = ".lastIndexOf(\"/\"));            " + NL + "} else {" + NL + "    if(fileName_";
  protected final String TEXT_29 = ".lastIndexOf(\".\") != -1) {" + NL + "        fullName_";
  protected final String TEXT_30 = " = fileName_";
  protected final String TEXT_31 = ".substring(0, fileName_";
  protected final String TEXT_32 = ".lastIndexOf(\".\"));" + NL + "        extension_";
  protected final String TEXT_33 = " = fileName_";
  protected final String TEXT_34 = ".substring(fileName_";
  protected final String TEXT_35 = ".lastIndexOf(\".\"));" + NL + "    } else {" + NL + "        fullName_";
  protected final String TEXT_36 = " = fileName_";
  protected final String TEXT_37 = ";" + NL + "        extension_";
  protected final String TEXT_38 = " = \"\";" + NL + "    }" + NL + "    directory_";
  protected final String TEXT_39 = " = \"\";" + NL + "}";
  protected final String TEXT_40 = NL + "\t //create directory only if not exists" + NL + "\tif(directory_";
  protected final String TEXT_41 = " != null && directory_";
  protected final String TEXT_42 = ".trim().length() != 0) {" + NL + "\t    java.io.File dir_";
  protected final String TEXT_43 = " = new java.io.File(directory_";
  protected final String TEXT_44 = ");" + NL + "\t    if(!dir_";
  protected final String TEXT_45 = ".exists()) {" + NL + "\t\tdir_";
  protected final String TEXT_46 = ".mkdirs();" + NL + "\t    }" + NL + "\t}";
  protected final String TEXT_47 = NL + "\tjava.io.FileOutputStream fos_";
  protected final String TEXT_48 = " = null;" + NL + "    java.io.OutputStreamWriter osw_";
  protected final String TEXT_49 = " = null;" + NL + "    java.io.BufferedWriter out";
  protected final String TEXT_50 = " = null;";
  protected final String TEXT_51 = NL + "    com.talend.csv.CSVWriter CsvWriter";
  protected final String TEXT_52 = " =null;";
  protected final String TEXT_53 = NL + "\tout";
  protected final String TEXT_54 = " = new java.io.BufferedWriter(new java.io.OutputStreamWriter(new java.io.FileOutputStream(fileName_";
  protected final String TEXT_55 = ", false),";
  protected final String TEXT_56 = "));" + NL + "\tresourceMap.put(\"out";
  protected final String TEXT_57 = "\", out";
  protected final String TEXT_58 = ");";
  protected final String TEXT_59 = NL + "    CsvWriter";
  protected final String TEXT_60 = " = new com.talend.csv.CSVWriter(out";
  protected final String TEXT_61 = ");" + NL + "    resourceMap.put(\"CsvWriter";
  protected final String TEXT_62 = "\", CsvWriter";
  protected final String TEXT_63 = ");" + NL + "    CsvWriter";
  protected final String TEXT_64 = ".setSeparator('";
  protected final String TEXT_65 = "');  " + NL + "    ";
  protected final String TEXT_66 = NL + "    CsvWriter";
  protected final String TEXT_67 = ".setLineEnd(\"";
  protected final String TEXT_68 = "\");";
  protected final String TEXT_69 = NL + "    CsvWriter";
  protected final String TEXT_70 = ".setQuoteChar('";
  protected final String TEXT_71 = "');                " + NL;
  protected final String TEXT_72 = NL + "    CsvWriter";
  protected final String TEXT_73 = ".setEscapeChar('\\\\');";
  protected final String TEXT_74 = NL + "    CsvWriter";
  protected final String TEXT_75 = ".setEscapeChar('";
  protected final String TEXT_76 = "');";
  protected final String TEXT_77 = NL + "\tCsvWriter";
  protected final String TEXT_78 = ".setEscapeChar('";
  protected final String TEXT_79 = "');";
  protected final String TEXT_80 = "    " + NL + "\tCsvWriter";
  protected final String TEXT_81 = ".setQuoteStatus(com.talend.csv.CSVWriter.QuoteStatus.FORCE);   " + NL + NL;
  protected final String TEXT_82 = NL + NL + NL + "java.io.File file";
  protected final String TEXT_83 = " = new java.io.File(fileName_";
  protected final String TEXT_84 = ");" + NL + "" + NL + "boolean pivot_Exists";
  protected final String TEXT_85 = " = false;" + NL + "" + NL + "StringBuilder pivot_Key";
  protected final String TEXT_86 = " = new StringBuilder();" + NL + "" + NL + "java.util.List<String> pivot_Keys";
  protected final String TEXT_87 = " = new java.util.ArrayList<String>();" + NL + "" + NL + "boolean group_Exists";
  protected final String TEXT_88 = " = false;" + NL + "" + NL + "StringBuilder group_Key";
  protected final String TEXT_89 = " = new StringBuilder();" + NL + "" + NL + "java.util.List<java.util.List<String>> group_Keys";
  protected final String TEXT_90 = " = new java.util.ArrayList<java.util.List<String>>();" + NL + "" + NL + "java.util.List<String> gKvalue";
  protected final String TEXT_91 = " = null;" + NL + "" + NL + "java.util.List<String> aggValues";
  protected final String TEXT_92 = " = null;" + NL + "" + NL + "java.util.Map<java.util.List<String>,java.util.List<String>> aggregation";
  protected final String TEXT_93 = " = new java.util.HashMap<java.util.List<String>,java.util.List<String>>();" + NL;
...
if ((metadatas!=null)&&(metadatas.size()>0)) {
  ...
  if(csvOption) { 
    ...
    stringBuffer.append(rowSeparator.substring(1,rowSeparator.length()-1)  );
