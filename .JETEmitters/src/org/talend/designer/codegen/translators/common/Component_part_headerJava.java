...
public class Component_part_headerJava
{
  ...
  protected final String TEXT_43 = " ] start" + NL + "\t */" + NL + "" + NL + "\t";
  protected final String TEXT_44 = NL + "\t\t\t\tTalendThreadPool mtp_";
  protected final String TEXT_45 = " = new TalendThreadPool(";
  protected final String TEXT_46 = ");" + NL + "" + NL + "\t\t\t\tglobalMap.put(\"lockWrite_";
  protected final String TEXT_47 = "\", new Object[0]);" + NL + "\t\t\t\tint threadIdCounter_";
  protected final String TEXT_48 = " =0;" + NL + "\t\t\t";
  protected final String TEXT_49 = "\t\t\t" + NL + "\t\t\tint NB_ITERATE_";
  protected final String TEXT_50 = " = 0; //for statistics" + NL + "\t\t\t";
  protected final String TEXT_51 = NL + NL + "\t";
  protected final String TEXT_52 = NL + "\t\t";
  protected final String TEXT_53 = NL + "\t\t\tglobalMap.put(\"ENABLE_TRACES_CONNECTION_";
  protected final String TEXT_54 = "\",Boolean.FALSE);" + NL + "\t\t";
  protected final String TEXT_55 = NL + "\t\tok_Hash.put(\"";
  protected final String TEXT_56 = "\", false);" + NL + "\t\tstart_Hash.put(\"";
  protected final String TEXT_57 = "\", System.currentTimeMillis());" + NL + "\t\t";
  protected final String TEXT_58 = NL + "\t\t\t\t";
  protected final String TEXT_59 = ".addMessage(\"begin\",\"";
  protected final String TEXT_60 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_61 = "Process(globalMap);" + NL + "\t\t\t";
  protected final String TEXT_62 = NL + "    \t\t\t\t";
  protected final String TEXT_63 = NL + "    \t\t\t\t\t\t";
  protected final String TEXT_64 = ".addLineToRow(\"";
  protected final String TEXT_65 = "_count\");" + NL + "    \t\t\t\t\t";
  protected final String TEXT_66 = NL + "    \t\t\t\t\t\t";
  protected final String TEXT_67 = ".addLineToRow(\"";
  protected final String TEXT_68 = "_count\");" + NL + "    \t\t\t\t\t";
  protected final String TEXT_69 = NL + "\t";
  protected final String TEXT_70 = NL + "\t\tcurrentVirtualComponent = \"";
  protected final String TEXT_71 = "\";" + NL + "\t";
  protected final String TEXT_72 = NL + "\tcurrentComponent=\"";
  protected final String TEXT_73 = "\";" + NL + "" + NL + "\t";
  protected final String TEXT_74 = NL + "\t\t\tif (execStat) {" + NL + "\t\t\t\tif(resourceMap.get(\"inIterateVComp\") == null){" + NL + "\t\t\t\t\t";
  protected final String TEXT_75 = NL + "\t\t\t\t\t    java.util.concurrent.ConcurrentHashMap<Object, Object> concurrentHashMap_";
  protected final String TEXT_76 = " = (java.util.concurrent.ConcurrentHashMap) globalMap.get(\"concurrentHashMap\");" + NL + "\t\t\t\t\t\tconcurrentHashMap_";
  protected final String TEXT_77 = ".putIfAbsent(\"";
  protected final String TEXT_78 = "\" + iterateLoop,new java.util.concurrent.atomic.AtomicInteger(0));" + NL + "\t\t\t\t\t\tjava.util.concurrent.atomic.AtomicInteger stats_";
  protected final String TEXT_79 = " = (java.util.concurrent.atomic.AtomicInteger) concurrentHashMap_";
  protected final String TEXT_80 = ".get(\"";
  protected final String TEXT_81 = "\" + iterateLoop);" + NL + "\t\t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_82 = "\" + iterateId, stats_";
  protected final String TEXT_83 = ".incrementAndGet()<=1?0:1, 0);" + NL + "\t\t\t\t\t";
  protected final String TEXT_84 = NL + "\t\t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_85 = "\" + iterateId, 0, 0);" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_93 = "\"+iterateId,1, 1);" + NL + "\t\t\t\t} " + NL + "\t\t\t";
  protected final String TEXT_94 = NL + NL + "\t\t";
  protected final String TEXT_95 = NL + "    \t\t\tif(log.isTraceEnabled()){" + NL + "    \t\t\t\tlog.trace(\"";
  protected final String TEXT_96 = " - \" + (";
  protected final String TEXT_97 = "==null? \"\": ";
  protected final String TEXT_98 = ".toLogString()));" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_99 = NL + "\t\tint tos_count_";
  protected final String TEXT_100 = " = 0;" + NL + "\t\t";
  protected final String TEXT_101 = NL + "\t\t\t\tif(execStat){" + NL + "\t\t\t\t\t";
  protected final String TEXT_102 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_103 = NL + "\t\t\t\t\t\t\tjava.util.concurrent.ConcurrentHashMap<Object, Object> concurrentHashMap_";
  protected final String TEXT_104 = " = (java.util.concurrent.ConcurrentHashMap) globalMap.get(\"concurrentHashMap\");" + NL + "\t\t\t\t\t\t\tconcurrentHashMap_";
  protected final String TEXT_105 = ".putIfAbsent(\"";
  protected final String TEXT_106 = "\" + iterateLoop,new java.util.concurrent.atomic.AtomicInteger(0));" + NL + "\t\t\t\t\t\t\tjava.util.concurrent.atomic.AtomicInteger stats_";
  protected final String TEXT_107 = " = (java.util.concurrent.atomic.AtomicInteger) concurrentHashMap_";
  protected final String TEXT_108 = ".get(\"";
  protected final String TEXT_109 = "\" + iterateLoop);" + NL + "\t\t\t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_110 = "\" + iterateId, stats_";
  protected final String TEXT_111 = ".incrementAndGet()<=1?0:1, 0);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_112 = NL + "\t\t\t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_113 = "\" + iterateId, 0, 0);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_114 = NL + "\t\t\t\t\t";
  protected final String TEXT_115 = NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_116 = NL + "\t\t\t\tresourceMap.put(\"inIterateVComp\", true);" + NL + "\t\t\t";
  protected final String TEXT_117 = NL + "\t\t\t\tresourceMap.remove(\"inIterateVComp\");" + NL + "\t\t\t";
  protected final String TEXT_118 = NL + "\t\t\t\t\t\tresourceMap.remove(\"inIterateVComp\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_119 = NL + "\t\t\t\t\t\tresourceMap.put(\"inIterateVComp\", true);" + NL + "\t\t\t\t\t";
