...
public class Header_additional_talendesb_restJava
{
  ...
  protected final String TEXT_7 = "_LoopProcess(globalMap);" + NL + "\t\t\t\t} catch (Throwable ex) {" + NL + "\t\t\t\t\tex.printStackTrace();" + NL + "\t\t\t\t\tthrow new javax.ws.rs.WebApplicationException(ex, 500);" + NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\t// close DB connections" + NL + "\t\t\t\t\tclosePassedDataSourceConnections(globalMap);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t};" + NL + "" + NL + "\t\treturn javax.ws.rs.core.Response.ok().entity(streamingOutput).build();" + NL + "\t}" + NL;
  protected final String TEXT_8 = NL + "\t@javax.ws.rs.";
  protected final String TEXT_9 = "()";
  protected final String TEXT_10 = NL + "\t@javax.ws.rs.Path(";
  protected final String TEXT_11 = ")";
  protected final String TEXT_12 = "\t@javax.ws.rs.Consumes(";
  protected final String TEXT_13 = ")";
  protected final String TEXT_14 = "\t@javax.ws.rs.Produces(";
  protected final String TEXT_15 = ")";
  protected final String TEXT_16 = "\t@org.apache.cxf.jaxrs.ext.Oneway()";
  protected final String TEXT_17 = NL + "\tpublic javax.ws.rs.core.Response ";
  protected final String TEXT_18 = "(" + NL + "\t\t";
  protected final String TEXT_19 = ", ";
  protected final String TEXT_20 = NL + "\t\t\t\t\t\t@javax.ws.rs.DefaultValue(";
  protected final String TEXT_21 = ") ";
  protected final String TEXT_22 = NL + "\t\t\t\t\t\t@javax.ws.rs.DefaultValue(\"";
  ...
  protected final String TEXT_31 = " body" + NL + "\t\t";
  protected final String TEXT_32 = NL + "\t\t\t) {";
  protected final String TEXT_33 = NL + "\t\t\t\tjava.util.Date ";
  ...
  protected final String TEXT_39 = ".trim().length()) {" + NL + "\t\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_40 = " = new java.text.SimpleDateFormat(";
  protected final String TEXT_41 = ").parse(";
  protected final String TEXT_42 = "_";
  protected final String TEXT_43 = ");" + NL + "\t\t\t\t\t\t} catch (Exception e) {" + NL + "\t\t\t\t\t\t\t// try to parse date by usual way later" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_44 = NL + "\t\t\t\tif (null == ";
