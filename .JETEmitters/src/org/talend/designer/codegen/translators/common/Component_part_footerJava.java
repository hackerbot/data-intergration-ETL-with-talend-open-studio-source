...
public class Component_part_footerJava
{
  ...
  protected final String TEXT_41 = NL + "\t\tif(execStat){" + NL + "\t\t\t";
  protected final String TEXT_42 = NL + "\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_43 = "\"+iterateId,2, 0); " + NL + "\t\t\t";
  protected final String TEXT_44 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_45 = NL + "\t\t\tif(execStat){" + NL + "\t\t\t\tif(resourceMap.get(\"inIterateVComp\") == null || !((Boolean)resourceMap.get(\"inIterateVComp\"))){" + NL + "\t\t\t \t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_46 = "\"+iterateId,2, 0); " + NL + "\t\t\t \t}" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_47 = NL + " ";
  protected final String TEXT_48 = NL + "     ";
  protected final String TEXT_49 = " = ";
  protected final String TEXT_50 = ";";
  protected final String TEXT_51 = NL + "    globalMap.put(\"USE_CONDITION\",Boolean.TRUE);" + NL + "    globalMap.put(\"TRACE_CONDITION\", Boolean.FALSE);";
  protected final String TEXT_52 = NL + "  " + NL + "  if (";
  protected final String TEXT_53 = " !=null) {" + NL + "  globalMap.put(\"ENABLE_TRACES_CONNECTION_";
  protected final String TEXT_54 = "\",Boolean.TRUE);" + NL + "  if (runTrace.isPause()) {" + NL + "   while (runTrace.isPause()) {" + NL + "   \tThread.sleep(100);" + NL + "   }" + NL + "  }\t else {" + NL + "  \t" + NL + "   \t// here we dump the line content for trace purpose" + NL + "   \tjava.util.LinkedHashMap<String, String> runTraceData = new java.util.LinkedHashMap<String,String>();" + NL + "\t";
  protected final String TEXT_55 = NL + "\t\trunTraceData.put(\"";
  protected final String TEXT_56 = "\", String.valueOf(";
  protected final String TEXT_57 = ".";
  protected final String TEXT_58 = "));" + NL + "\t";
  protected final String TEXT_59 = NL + "   \trunTrace.sendTrace(\"";
  protected final String TEXT_60 = "\",\"";
  protected final String TEXT_61 = "\", runTraceData);" + NL + "\t}" + NL + "\t";
  ...
  protected final String TEXT_73 = NL + "        true";
  protected final String TEXT_74 = "      " + NL + "    ){" + NL + "    \tglobalMap.put(\"TRACE_CONDITION\", Boolean.TRUE);" + NL + "    }";
  protected final String TEXT_75 = NL + "  }";
  protected final String TEXT_76 = NL + NL + "ok_Hash.put(\"";
  protected final String TEXT_77 = "\", true);" + NL + "end_Hash.put(\"";
  protected final String TEXT_78 = "\", System.currentTimeMillis());" + NL;
  protected final String TEXT_79 = NL;
  protected final String TEXT_80 = ".addMessage(\"end\",\"";
  protected final String TEXT_81 = "\", end_Hash.get(\"";
  protected final String TEXT_82 = "\")-start_Hash.get(\"";
  protected final String TEXT_83 = "\"));";
  protected final String TEXT_84 = NL;
  protected final String TEXT_85 = "Process(globalMap);";
  protected final String TEXT_86 = NL + "\t\t\t\tif(execStat){   " + NL + "   \t \t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_87 = "\", 0, \"ok\");" + NL + "\t\t\t\t}";
  protected final String TEXT_88 = NL + "\t\t\t\t";
  protected final String TEXT_89 = "Process(globalMap);";
  protected final String TEXT_90 = NL + "   \t\t\tif (";
  protected final String TEXT_91 = ") {" + NL + "   \t\t\t\t";
  protected final String TEXT_92 = NL + "\t\t\t\t\tif(execStat){   " + NL + "   \t \t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_93 = "\", 0, \"true\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_94 = NL + "    \t\t\t";
  protected final String TEXT_95 = "Process(globalMap);" + NL + "   \t\t\t}" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_96 = "   " + NL + "   \t\t\t\telse{" + NL + "\t\t\t\t\tif(execStat){   " + NL + "   \t \t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_97 = "\", 0, \"false\");" + NL + "\t\t\t\t\t}   \t " + NL + "   \t\t\t\t}";
  protected final String TEXT_98 = NL;
  protected final String TEXT_99 = NL + "\t\t\tmtp_";
  protected final String TEXT_100 = ".waitForEndOfQueue();" + NL + "\t\t\t" + NL + "\t\t\tTalendThread errorThread_";
  protected final String TEXT_101 = " = mtp_";
  protected final String TEXT_102 = ".getErrorThread();" + NL;
  protected final String TEXT_103 = NL + "\tif(errorThread_";
  protected final String TEXT_104 = " != null) {" + NL + "\t\tif (errorThread_";
  protected final String TEXT_105 = ".errorCode != null) {" + NL + "\t\t\tif (errorCode == null" + NL + "\t\t\t\t\t|| errorThread_";
  protected final String TEXT_106 = ".errorCode.compareTo(errorCode) > 0) {" + NL + "\t\t\t\terrorCode = errorThread_";
  protected final String TEXT_107 = ".errorCode;" + NL + "\t\t\t}" + NL + "\t\t} " + NL + "\t\tif (!status.equals(\"failure\")) {" + NL + "\t\t\tstatus = errorThread_";
  protected final String TEXT_108 = ".status;" + NL + "\t\t}" + NL + "\t\tif(errorThread_";
  protected final String TEXT_109 = ".exception!=null){" + NL + "\t\t\tthrow errorThread_";
  protected final String TEXT_110 = ".exception;" + NL + "\t\t}" + NL + "\t\tif(errorThread_";
  protected final String TEXT_111 = ".error!=null){" + NL + "\t\t\tthrow errorThread_";
  protected final String TEXT_112 = ".error;" + NL + "\t\t}" + NL + "\t}else{\t\t\t\t" + NL + "\t\tInteger threadErrorCode = mtp_";
  protected final String TEXT_113 = ".getTalendThreadResult().getErrorCode();" + NL + "\t\tString threadStatus = mtp_";
  protected final String TEXT_114 = ".getTalendThreadResult().getStatus();" + NL + "\t\t" + NL + "\t\tif (threadErrorCode != null) {" + NL + "\t\t\tif (errorCode == null" + NL + "\t\t\t\t\t|| threadErrorCode.compareTo(errorCode) > 0) {" + NL + "\t\t\t\terrorCode = threadErrorCode;" + NL + "\t\t\t}" + NL + "\t\t} " + NL + "\t\tif (!status.equals(\"failure\")) {" + NL + "\t\t\tstatus = threadStatus;" + NL + "\t\t}" + NL + "\t }\t\t\t";
  protected final String TEXT_115 = NL + "\tif(errorThread_";
  protected final String TEXT_116 = " != null) {" + NL + "\t\tInteger localErrorCode = (Integer) (((java.util.Map) threadLocal.get()).get(\"errorCode\"));" + NL + "\t\tString localStatus = (String) (((java.util.Map) threadLocal.get()).get(\"status\"));" + NL + "\t\t" + NL + "\t\tif (errorThread_";
  protected final String TEXT_117 = ".errorCode != null) {" + NL + "\t\t\tif (localErrorCode == null || errorThread_";
  protected final String TEXT_118 = ".errorCode.compareTo(localErrorCode) > 0) {" + NL + "\t\t\t\t((java.util.Map) threadLocal.get()).put(\"errorCode\", errorThread_";
  protected final String TEXT_119 = ".errorCode);" + NL + "\t\t\t}" + NL + "\t\t} " + NL + "\t\tif (!localStatus.equals(\"failure\")) {" + NL + "\t\t\t((java.util.Map) threadLocal.get()).put(\"status\", errorThread_";
  protected final String TEXT_120 = ".status);" + NL + "\t\t}" + NL + "\t\tif(errorThread_";
  protected final String TEXT_121 = ".exception!=null){" + NL + "\t\t\tthrow errorThread_";
  protected final String TEXT_122 = ".exception;" + NL + "\t\t}\t\t" + NL + "\t}else{" + NL + "\t\tInteger threadErrorCode = mtp_";
  protected final String TEXT_123 = ".getTalendThreadResult().getErrorCode();" + NL + "\t\tString threadStatus = mtp_";
  protected final String TEXT_124 = ".getTalendThreadResult().getStatus();" + NL + "\t\t" + NL + "\t\tInteger localErrorCode = (Integer) (((java.util.Map) threadLocal" + NL + "\t\t\t\t.get()).get(\"errorCode\"));" + NL + "\t\tString localStatus = (String) (((java.util.Map) threadLocal" + NL + "\t\t\t\t.get()).get(\"status\"));" + NL + "" + NL + "\t\tif (threadErrorCode != null) {" + NL + "\t\t\tif (localErrorCode == null" + NL + "\t\t\t\t\t|| threadErrorCode.compareTo(localErrorCode) > 0) {" + NL + "\t\t\t\t((java.util.Map) threadLocal.get()).put(\"errorCode\"," + NL + "\t\t\t\t\t\tthreadErrorCode);" + NL + "\t\t\t}" + NL + "\t\t} " + NL + "\t\tif (!localStatus.equals(\"failure\")) {" + NL + "\t\t\t((java.util.Map) threadLocal.get()).put(\"status\"," + NL + "\t\t\t\t\tthreadStatus);" + NL + "\t\t}" + NL + "\t}";
