...
public class TSalesforceOutputEndJava
{
  ...
  protected final String TEXT_41 = " " + NL + " \t" + NL + " \tsforceManagement_";
  protected final String TEXT_42 = ".logout(); " + NL + " \t" + NL + " \tglobalMap.put(\"";
  protected final String TEXT_43 = "_NB_LINE\",nb_line_";
  protected final String TEXT_44 = ");" + NL + " \tglobalMap.put(\"";
  protected final String TEXT_45 = "_NB_SUCCESS\",nb_success_";
  protected final String TEXT_46 = ");" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_47 = "_NB_REJECT\",nb_reject_";
