...
public class TMarketoBulkQueryBeginJava
{
  protected static String nl;
  public static synchronized TMarketoBulkQueryBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMarketoBulkQueryBeginJava result = new TMarketoBulkQueryBeginJava();
    nl = null;
    return result;
  }
