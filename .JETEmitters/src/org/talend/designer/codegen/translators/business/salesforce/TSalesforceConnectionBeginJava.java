...
public class TSalesforceConnectionBeginJava
{
  ...
  protected final String TEXT_115 = NL + "    \t\t\tString decryptedPwd_";
  ...
  protected final String TEXT_121 = NL + "\t\t    java.util.Properties props_";
  protected final String TEXT_122 = " = System.getProperties();" + NL + "\t\t    props_";
  protected final String TEXT_123 = ".put(\"socksProxyHost\",";
  protected final String TEXT_124 = ");  " + NL + "\t\t    props_";
  protected final String TEXT_125 = ".put(\"socksProxyPort\",";
  protected final String TEXT_126 = ");" + NL + "\t\t    props_";
  protected final String TEXT_127 = ".put(\"java.net.socks.username\", ";
  protected final String TEXT_128 = ");" + NL + "\t\t    props_";
  protected final String TEXT_129 = ".put(\"java.net.socks.password\", decryptedPwd_";
  ...
  protected final String TEXT_139 = NL + "\t\t" + NL + "\t\torg.talend.salesforce.SforceConnection sforceConn_";
  protected final String TEXT_140 = " " + NL + "\t\t\t= new org.talend.salesforce.SforceBasicConnection.Builder(";
  protected final String TEXT_141 = ", ";
  protected final String TEXT_142 = ", decryptedPassword_";
  protected final String TEXT_143 = ")" + NL + "\t\t\t\t.setTimeout(";
  protected final String TEXT_144 = ").needCompression(";
  protected final String TEXT_145 = ")" + NL + "            \t";
  protected final String TEXT_146 = NL + "            \t\t.setClientID(";
  protected final String TEXT_147 = ");" + NL + "            \t";
  protected final String TEXT_148 = NL + "            \t.build();" + NL + "\t";
  protected final String TEXT_149 = "\t\t\t";
  protected final String TEXT_150 = NL + "globalMap.put(\"conn_";
  protected final String TEXT_151 = "\", sforceConn_";
