...
public class TMicrosoftCrmOutputBeginJava
{
  ...
  protected final String TEXT_41 = NL + "\t\t\torg.apache.commons.httpclient.auth.AuthPolicy.registerAuthScheme(org.apache.commons.httpclient.auth.AuthPolicy.NTLM, org.talend.mscrm.login.ntlm.JCIFS_NTLMScheme.class);" + NL + "" + NL + "\t\t\tcom.microsoft.crm4.webserviceTest.CrmServiceStub service_";
  protected final String TEXT_42 = " = new com.microsoft.crm4.webserviceTest.CrmServiceStub(";
  protected final String TEXT_43 = ");" + NL + "\t\t\torg.apache.axis2.client.Options options_";
  protected final String TEXT_44 = " = service_";
  protected final String TEXT_45 = "._getServiceClient().getOptions();" + NL + "\t\t\torg.apache.axis2.transport.http.HttpTransportProperties.Authenticator auth_";
  protected final String TEXT_46 = " = new org.apache.axis2.transport.http.HttpTransportProperties.Authenticator();" + NL + "" + NL + "\t\t\tList<String> authSchemes_";
  protected final String TEXT_47 = " = new java.util.ArrayList<String>();" + NL + "\t\t\tauthSchemes_";
  protected final String TEXT_48 = ".add(org.apache.axis2.transport.http.HttpTransportProperties.Authenticator.NTLM);" + NL + "\t\t\tauth_";
  protected final String TEXT_49 = " .setAuthSchemes(authSchemes_";
  protected final String TEXT_50 = ");" + NL + "" + NL + "            auth_";
  protected final String TEXT_51 = " .setUsername(";
  protected final String TEXT_52 = ");" + NL + "            auth_";
  protected final String TEXT_53 = " .setPassword(decryptedPassword_";
  protected final String TEXT_54 = ");" + NL + "            auth_";
  protected final String TEXT_55 = " .setHost(";
  protected final String TEXT_56 = ");" + NL + "            auth_";
  protected final String TEXT_57 = " .setPort(";
  protected final String TEXT_58 = ");" + NL + "            auth_";
  protected final String TEXT_59 = " .setDomain(";
  protected final String TEXT_60 = ");" + NL + "            auth_";
  protected final String TEXT_61 = " .setPreemptiveAuthentication(false);" + NL + "" + NL + "            options_";
  protected final String TEXT_62 = " .setProperty(org.apache.axis2.transport.http.HTTPConstants.AUTHENTICATE, auth_";
  protected final String TEXT_63 = ");" + NL + "            options_";
  protected final String TEXT_64 = " .setProperty(org.apache.axis2.transport.http.HTTPConstants.REUSE_HTTP_CLIENT, \"";
  protected final String TEXT_65 = "\");" + NL + "" + NL + "            options_";
  protected final String TEXT_66 = " .setUserName(";
  protected final String TEXT_67 = ");" + NL + "            options_";
  protected final String TEXT_68 = " .setPassword(decryptedPassword_";
  ...
  protected final String TEXT_78 = ".setAuthenticationType(0);" + NL + "            token_";
  protected final String TEXT_79 = ".setOrganizationName(";
  protected final String TEXT_80 = ");" + NL + "            catd_";
  protected final String TEXT_81 = ".setCrmAuthenticationToken(token_";
  protected final String TEXT_82 = ");";
  protected final String TEXT_83 = NL + "        \tcom.microsoft.crm4.webserviceTest.CrmServiceStub service_";
  protected final String TEXT_84 = " = new com.microsoft.crm4.webserviceTest.CrmServiceStub(\"https://\" + ";
  protected final String TEXT_85 = " + \"/MSCrmServices/2007/CrmService.asmx\");" + NL + "\t\t\torg.apache.axis2.client.Options options_";
  protected final String TEXT_86 = " = service_";
  protected final String TEXT_87 = "._getServiceClient().getOptions();" + NL + "        \torg.talend.mscrm.login.passport.MsDynamicsWrapper msDynamicsWrapper_";
  protected final String TEXT_88 = " = new org.talend.mscrm.login.passport.MsDynamicsWrapper(";
  protected final String TEXT_89 = ",";
  protected final String TEXT_90 = ",";
  protected final String TEXT_91 = ",decryptedPassword_";
  protected final String TEXT_92 = ");" + NL + "\t\t\tmsDynamicsWrapper_";
  protected final String TEXT_93 = ".connect();" + NL + "\t\t\tString crmTicket_";
  protected final String TEXT_94 = " = msDynamicsWrapper_";
  protected final String TEXT_95 = ".getCrmTicket();" + NL + "" + NL + "        \toptions_";
  protected final String TEXT_96 = " .setProperty(org.apache.axis2.transport.http.HTTPConstants.REUSE_HTTP_CLIENT, \"";
  protected final String TEXT_97 = "\");" + NL + "        \toptions_";
  protected final String TEXT_98 = " .setTimeOutInMilliSeconds(Long.valueOf(";
  protected final String TEXT_99 = "));" + NL + "" + NL + "            options_";
  protected final String TEXT_100 = " .setProperty(org.apache.axis2.transport.http.HTTPConstants.SO_TIMEOUT,new Integer(";
  protected final String TEXT_101 = "));" + NL + "            options_";
  protected final String TEXT_102 = " .setProperty(org.apache.axis2.transport.http.HTTPConstants.CONNECTION_TIMEOUT, new Integer(";
  protected final String TEXT_103 = "));" + NL + "" + NL + "        \tcom.microsoft.schemas.crm._2007.webservices.CrmAuthenticationTokenDocument catd_";
  protected final String TEXT_104 = " = com.microsoft.schemas.crm._2007.webservices.CrmAuthenticationTokenDocument.Factory.newInstance();" + NL + "            com.microsoft.schemas.crm._2007.coretypes.CrmAuthenticationToken token_";
  protected final String TEXT_105 = " = com.microsoft.schemas.crm._2007.coretypes.CrmAuthenticationToken.Factory.newInstance();" + NL + "            token_";
  protected final String TEXT_106 = ".setAuthenticationType(1);" + NL + "            token_";
  protected final String TEXT_107 = ".setOrganizationName(";
  protected final String TEXT_108 = ");" + NL + "            token_";
  protected final String TEXT_109 = ".setCrmTicket(crmTicket_";
  protected final String TEXT_110 = ");" + NL + "            catd_";
  protected final String TEXT_111 = ".setCrmAuthenticationToken(token_";
  protected final String TEXT_112 = ");" + NL + "    \t";
  protected final String TEXT_113 = NL + "    \torg.talend.ms.crm.MSCRMClient client_";
  protected final String TEXT_114 = " = new org.talend.ms.crm.MSCRMClient(";
  protected final String TEXT_115 = ", decryptedPassword_";
  protected final String TEXT_116 = ", ";
  protected final String TEXT_117 = ");" + NL + "\t\tclient_";
  protected final String TEXT_118 = ".setTimeout(";
  protected final String TEXT_119 = ");" + NL + "\t\tclient_";
  protected final String TEXT_120 = ".setReuseHttpClient(";
  protected final String TEXT_121 = ");" + NL + "\t\tcom.microsoft.schemas.xrm._2011.contracts.OrganizationServiceStub serviceStub_";
  protected final String TEXT_122 = " = client_";
  protected final String TEXT_123 = ".getOnlineConnection(";
