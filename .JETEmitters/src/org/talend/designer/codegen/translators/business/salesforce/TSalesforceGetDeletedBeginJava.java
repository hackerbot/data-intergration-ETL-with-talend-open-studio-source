...
public class TSalesforceGetDeletedBeginJava
{
  ...
  protected final String TEXT_122 = NL + "                        \t.build();" + NL + "\t        \t";
  protected final String TEXT_123 = NL + "    \t\torg.talend.salesforce.SforceManagement sfMgr_";
  protected final String TEXT_124 = " = new org.talend.salesforce.SforceManagementImpl(sforceConn_";
  protected final String TEXT_125 = ");" + NL + "\t\t\t";
  protected final String TEXT_126 = NL + "\t\t\t\tjava.util.List<String> dynamicColsName_";
  protected final String TEXT_127 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\tclass SFDynamicUtil_";
  protected final String TEXT_128 = "{" + NL + "\t\t\t\t\tpublic void genDynamicColumn(org.talend.salesforce.SforceManagement sfMgr, routines.system.Dynamic dynamic, java.util.List<String> dynamicColsName, java.util.List<String> unDynamicCols){" + NL + "\t\t\t\t\t\ttry {" + NL + "\t\t\t\t            com.salesforce.soap.partner.DescribeSObjectResult objInfo = sfMgr.describeSObject(";
  protected final String TEXT_129 = ");" + NL + "\t\t\t\t            com.salesforce.soap.partner.Field[] fields = objInfo.getFields();" + NL + "\t\t\t\t            for (com.salesforce.soap.partner.Field field:fields) {" + NL + "\t\t\t\t\t\t\t\tif(!unDynamicCols.contains(field.getName())){" + NL + "\t\t\t\t\t\t\t\t\tString sfType = field.getType().toString();" + NL + "\t\t\t\t\t\t\t\t\tString talendType = \"String\"; " + NL + "\t\t\t\t\t\t\t        if (sfType.equals(\"boolean\")) { " + NL + "\t\t\t\t\t\t\t            talendType = \"Boolean\"; " + NL + "\t\t\t\t\t\t\t        } else if (sfType.equals(\"int\")) { " + NL + "\t\t\t\t\t\t\t            talendType = \"Integer\"; " + NL + "\t\t\t\t\t\t\t        } else if (sfType.equals(\"date\") || sfType.equals(\"datetime\")) {  " + NL + "\t\t\t\t\t\t\t            talendType = \"Date\"; " + NL + "\t\t\t\t\t\t\t        } else if (sfType.equals(\"double\") || sfType.equals(\"currency\")) {  " + NL + "\t\t\t\t\t\t\t            talendType = \"Double\"; " + NL + "\t\t\t\t\t\t\t        } else {" + NL + "\t\t\t\t\t\t\t            talendType = \"String\"; " + NL + "\t\t\t\t\t\t\t        }" + NL + "\t\t\t\t\t\t\t    \troutines.system.DynamicMetadata dynamicMetadata = new routines.system.DynamicMetadata();" + NL + "\t\t\t\t\t\t\t    \tdynamicColsName.add(field.getName());" + NL + "\t\t\t\t\t\t\t    \tdynamicMetadata.setName(field.getName());" + NL + "\t\t\t\t\t\t\t    \tdynamicMetadata.setDbName(dynamicMetadata.getName());" + NL + "\t\t\t\t\t\t\t    \tdynamicMetadata.setType(\"id_\" + talendType);" + NL + "\t\t\t\t\t\t\t    \t if (sfType.equals(\"date\")) { " + NL + "\t\t\t\t\t\t\t            dynamicMetadata.setFormat(\"yyyy-MM-dd\"); " + NL + "\t\t\t\t\t\t\t        } else if (sfType.equals(\"datetime\")) { " + NL + "\t\t\t\t\t\t\t            dynamicMetadata.setFormat(\"yyyy-MM-dd'T'HH:mm:ss.'000Z'\"); " + NL + "\t\t\t\t\t\t\t        } else {" + NL + "\t\t\t\t\t\t\t            dynamicMetadata.setFormat(null);" + NL + "\t\t\t\t\t\t\t        }" + NL + "\t\t\t\t\t\t\t        if (\"String\".equals(talendType)) { " + NL + "\t\t\t\t\t\t\t            dynamicMetadata.setLength(field.getLength());" + NL + "\t\t\t\t\t\t\t            dynamicMetadata.setPrecision(field.getPrecision());" + NL + "\t\t\t\t\t\t\t        } else {" + NL + "\t\t\t\t\t\t\t            dynamicMetadata.setLength(field.getPrecision());" + NL + "\t\t\t\t\t\t\t            dynamicMetadata.setPrecision(field.getScale());" + NL + "\t\t\t\t\t\t\t        }" + NL + "\t\t\t\t\t\t\t    \tdynamicMetadata.setDbType(\"VARCHAR\");" + NL + "\t\t\t\t\t\t\t    \tdynamicMetadata.setNullable(field.getNillable());" + NL + "\t\t\t\t\t\t\t    \tdynamicMetadata.setKey(false);" + NL + "\t\t\t\t\t\t\t    \tif(field.getReferenceTo()!=null && field.getReferenceTo().length > 0){" + NL + "\t\t\t\t\t\t\t    \t\tdynamicMetadata.setRefFieldName(field.getRelationshipName());" + NL + "\t\t\t\t\t\t\t    \t\tdynamicMetadata.setRefModuleName(field.getReferenceTo()[0]);" + NL + "\t\t\t\t\t\t\t    \t}" + NL + "\t\t\t\t\t\t\t    \tdynamicMetadata.setSourceType(routines.system.DynamicMetadata.sourceTypes.salesforce);" + NL + "\t\t\t\t\t\t\t    \t//dynamicMetadata.setColumnPosition(i);" + NL + "\t\t\t\t\t\t\t    \tdynamic.metadatas.add(dynamicMetadata);" + NL + "\t\t\t\t\t\t\t    }" + NL + "\t\t\t\t\t\t    }" + NL + "\t\t\t\t        } catch (Exception e) {" + NL + "\t\t\t\t            e.printStackTrace();" + NL + "\t\t\t\t        }" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\tSFDynamicUtil_";
  protected final String TEXT_130 = " sfDynamicUtil_";
  protected final String TEXT_131 = " =new SFDynamicUtil_";
  protected final String TEXT_132 = "();   " + NL + "\t\t\t\tsfDynamicUtil_";
  protected final String TEXT_133 = ".genDynamicColumn(sfMgr_";
  protected final String TEXT_134 = ", dynamic_";
  protected final String TEXT_135 = ", dynamicColsName_";
  protected final String TEXT_136 = ", unDynamicCols_";
  protected final String TEXT_137 = " ); " + NL + "\t\t\t";
  protected final String TEXT_138 = NL + "\t\t\tStringBuilder fieldsName_";
  protected final String TEXT_139 = " = new StringBuilder();" + NL + "\t\t\t";
  protected final String TEXT_140 = NL + "\t\t\t\tfieldsName_";
  protected final String TEXT_141 = ".append(\"";
  protected final String TEXT_142 = "\");" + NL + "\t\t\t";
  protected final String TEXT_143 = NL + "\t\t\t\tif(dynamicColsName_";
  protected final String TEXT_144 = ".size()>0){" + NL + "\t\t\t\t\tfieldsName_";
  protected final String TEXT_145 = ".append(\"";
  protected final String TEXT_146 = "\"+routines.system.StringUtils.list(dynamicColsName_";
  protected final String TEXT_147 = ".toArray(new String[0]),\",\"));" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_148 = "\t\t" + NL + "\t\t\t";
  protected final String TEXT_149 = "\t" + NL + "\t\t\tcom.salesforce.soap.partner.GetDeletedResult gdr_";
  protected final String TEXT_150 = " = sfMgr_";
  protected final String TEXT_151 = ".getDeleted(";
  protected final String TEXT_152 = ", startCal_";
  protected final String TEXT_153 = ", endCal_";
  protected final String TEXT_154 = ");" + NL + "    \t\tcom.salesforce.soap.partner.QueryResult qr_";
  protected final String TEXT_155 = " = null;" + NL + "    \t\tcom.salesforce.soap.partner.DeletedRecord[] drs_";
  protected final String TEXT_156 = " = gdr_";
  protected final String TEXT_157 = ".getDeletedRecords();" + NL + "    \t\t" + NL + "    \t\tif (drs_";
  protected final String TEXT_158 = " != null && drs_";
  protected final String TEXT_159 = ".length > 0) {" + NL + "    \t\t\tint batchSize_";
  protected final String TEXT_160 = " = 500;" + NL + "    \t\t\tint count_";
  protected final String TEXT_161 = " = 0;" + NL + "    \t\t\tStringBuilder soql_";
  protected final String TEXT_162 = " = new StringBuilder();" + NL + "    \t\t\tString soqlBase_";
  protected final String TEXT_163 = " = \"SELECT \" + fieldsName_";
  protected final String TEXT_164 = ".toString() + \" FROM \" + ";
  protected final String TEXT_165 = " + \" WHERE \";" + NL + "\t\t\t\tfor(com.salesforce.soap.partner.DeletedRecord dr_";
  protected final String TEXT_166 = " : drs_";
  protected final String TEXT_167 = "){" + NL + "\t\t\t\t\tcount_";
  protected final String TEXT_168 = "++;" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tsoql_";
  protected final String TEXT_169 = ".append(\"Id='\"+dr_";
  protected final String TEXT_170 = ".getId().getID()+\"'\");" + NL + "\t\t\t\t\tsoql_";
  protected final String TEXT_171 = ".append(\" or \");" + NL + "\t\t\t\t\t";
  protected final String TEXT_172 = NL + "\t\t\t\t\tif((soql_";
  protected final String TEXT_173 = ".length() > (10000 - 23 - soqlBase_";
  protected final String TEXT_174 = ".length())) || count_";
  protected final String TEXT_175 = " == drs_";
  protected final String TEXT_176 = ".length){" + NL + "\t\t\t\t\t\tsoql_";
  protected final String TEXT_177 = ".delete(soql_";
  protected final String TEXT_178 = ".length() - 4, soql_";
  protected final String TEXT_179 = ".length());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_180 = NL + "\t\t\t\t\t\t\tSystem.out.println(soqlBase_";
  protected final String TEXT_181 = " + soql_";
  protected final String TEXT_182 = ".toString());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_183 = NL + "\t\t\t\t\t\tqr_";
  protected final String TEXT_184 = " = sfMgr_";
  protected final String TEXT_185 = ".queryAll(soqlBase_";
  protected final String TEXT_186 = " + soql_";
  protected final String TEXT_187 = ".toString(),batchSize_";
  protected final String TEXT_188 = ");" + NL + "" + NL + "\t\t\t\t\t\tboolean bContinue_";
  protected final String TEXT_189 = " = true;" + NL + "\t\t\t\t\t\twhile (bContinue_";
  protected final String TEXT_190 = " && qr_";
  protected final String TEXT_191 = " != null && qr_";
  protected final String TEXT_192 = ".getRecords() != null) {" + NL + "\t\t\t\t\t\t\tnb_line_";
  protected final String TEXT_193 = "++;" + NL + "\t\t        \t\t    for(int i_";
  protected final String TEXT_194 = " = 0; i_";
  protected final String TEXT_195 = " < qr_";
  protected final String TEXT_196 = ".getRecords().length; i_";
  protected final String TEXT_197 = "++){" + NL + "\t\t\t        \t\t\torg.apache.axiom.om.OMElement[] fields_";
  protected final String TEXT_198 = " = qr_";
  protected final String TEXT_199 = ".getRecords()[i_";
  protected final String TEXT_200 = "].getExtraElement();" + NL + "\t\t\t" + NL + "\t\t\t\t\t\t\t\tint len_";
  protected final String TEXT_201 = " = fields_";
  protected final String TEXT_202 = ".length;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_203 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\tif (";
  protected final String TEXT_204 = " < len_";
  protected final String TEXT_205 = " && fields_";
  protected final String TEXT_206 = "[";
  protected final String TEXT_207 = "].getText() != null && !\"\".equals(fields_";
  protected final String TEXT_208 = "[";
  protected final String TEXT_209 = "].getText())){" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_210 = NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_211 = ".";
  protected final String TEXT_212 = " = fields_";
  protected final String TEXT_213 = "[";
  protected final String TEXT_214 = "].getText();" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_215 = NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_216 = ".";
  protected final String TEXT_217 = " = ParserUtils.parseTo_Date(fields_";
  protected final String TEXT_218 = "[";
  protected final String TEXT_219 = "].getText(), ";
  protected final String TEXT_220 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_221 = NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_222 = ".";
  protected final String TEXT_223 = " = fields_";
  protected final String TEXT_224 = "[";
  protected final String TEXT_225 = "].getText().getBytes();" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_226 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_227 = ".";
  protected final String TEXT_228 = " = ParserUtils.parseTo_";
  protected final String TEXT_229 = "(fields_";
  protected final String TEXT_230 = "[";
  protected final String TEXT_231 = "].getText());" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_232 = "\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_233 = ".";
  protected final String TEXT_234 = " = ";
  protected final String TEXT_235 = ";" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_236 = NL + "\t\t\t\t\t\t\t    \tdynamic_";
  protected final String TEXT_237 = ".clearColumnValues();" + NL + "\t\t\t\t\t\t\t    \tfor(int j_";
  protected final String TEXT_238 = " = 0; j_";
  protected final String TEXT_239 = " < dynamic_";
  protected final String TEXT_240 = ".getColumnCount(); j_";
  protected final String TEXT_241 = "++){" + NL + "\t\t\t\t\t\t\t    \t\tint columnIndex_";
  protected final String TEXT_242 = " = j_";
  protected final String TEXT_243 = "+";
  protected final String TEXT_244 = ";" + NL + "\t\t\t\t\t\t\t\t\t\tString valueObj_";
  protected final String TEXT_245 = " = fields_";
  protected final String TEXT_246 = "[columnIndex_";
  protected final String TEXT_247 = "].getText();" + NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicMetadata dynamicMetadata_";
  protected final String TEXT_248 = " = dynamic_";
  protected final String TEXT_249 = ".getColumnMetadata(j_";
  protected final String TEXT_250 = ");" + NL + "\t\t\t\t\t\t\t\t\t\tif (columnIndex_";
  protected final String TEXT_251 = " < len_";
  protected final String TEXT_252 = " && fields_";
  protected final String TEXT_253 = "[columnIndex_";
  protected final String TEXT_254 = "].getText() != null && !\"\".equals(fields_";
  protected final String TEXT_255 = "[columnIndex_";
  protected final String TEXT_256 = "].getText())){" + NL + "\t\t\t\t\t\t\t\t\t\t\tif(\"id_Date\".equals(dynamicMetadata_";
  protected final String TEXT_257 = ".getType())){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tdynamic_";
  protected final String TEXT_258 = ".addColumnValue(ParserUtils.parseTo_Date(valueObj_";
  protected final String TEXT_259 = ", dynamicMetadata_";
  protected final String TEXT_260 = ".getFormat()));" + NL + "\t\t\t\t\t\t\t\t\t\t\t}else if(\"id_Double\".equals(dynamicMetadata_";
  protected final String TEXT_261 = ".getType())){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tdynamic_";
  protected final String TEXT_262 = ".addColumnValue(ParserUtils.parseTo_Double(valueObj_";
  protected final String TEXT_263 = "));" + NL + "\t\t\t\t\t\t\t\t\t\t\t}else if(\"id_Integer\".equals(dynamicMetadata_";
  protected final String TEXT_264 = ".getType())){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tdynamic_";
  protected final String TEXT_265 = ".addColumnValue(ParserUtils.parseTo_Integer(valueObj_";
  protected final String TEXT_266 = "));" + NL + "\t\t\t\t\t\t\t\t\t\t\t}else if(\"id_Boolean\".equals(dynamicMetadata_";
  protected final String TEXT_267 = ".getType())){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tdynamic_";
  protected final String TEXT_268 = ".addColumnValue(ParserUtils.parseTo_Boolean(valueObj_";
  protected final String TEXT_269 = "));" + NL + "\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tdynamic_";
  protected final String TEXT_270 = ".addColumnValue(valueObj_";
  protected final String TEXT_271 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\tdynamic_";
  protected final String TEXT_272 = ".addColumnValue(null);" + NL + "\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_273 = ".";
  protected final String TEXT_274 = " = dynamic_";
