...
public class TSalesforceGetUpdatedBeginJava
{
  ...
  protected final String TEXT_87 = NL + "                        \t.build();" + NL + "\t\t\t\t";
  protected final String TEXT_88 = NL + "                \t\t\tString decryptedPwd_";
  protected final String TEXT_89 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_90 = ");" + NL + "                \t\t";
  protected final String TEXT_91 = NL + "                \t\t\tString decryptedPwd_";
  protected final String TEXT_92 = " = ";
  protected final String TEXT_93 = ";" + NL + "                \t\t";
  protected final String TEXT_94 = NL + "\t\t\t\t\t    java.util.Properties props_";
  protected final String TEXT_95 = " = System.getProperties();" + NL + "\t\t\t\t\t    props_";
  protected final String TEXT_96 = ".put(\"socksProxyHost\",";
  protected final String TEXT_97 = ");  " + NL + "\t\t\t\t\t    props_";
  protected final String TEXT_98 = ".put(\"socksProxyPort\",";
  protected final String TEXT_99 = ");" + NL + "\t\t\t\t\t    props_";
  protected final String TEXT_100 = ".put(\"java.net.socks.username\", ";
  protected final String TEXT_101 = ");" + NL + "\t\t\t\t\t    props_";
  protected final String TEXT_102 = ".put(\"java.net.socks.password\", decryptedPwd_";
  ...
  protected final String TEXT_112 = NL + "\t\t\t" + NL + "\t\t\t\t\tsforceConn_";
  protected final String TEXT_113 = " = " + NL + "            \t\t\tnew org.talend.salesforce.SforceBasicConnection.Builder(";
  protected final String TEXT_114 = ", ";
  protected final String TEXT_115 = ", decryptedPassword_";
  protected final String TEXT_116 = ")" + NL + "            \t\t\t\t.setTimeout(";
  protected final String TEXT_117 = ").needCompression(";
  protected final String TEXT_118 = ")" + NL + "                        \t";
  protected final String TEXT_119 = NL + "                        \t\t.setClientID(";
  protected final String TEXT_120 = ");" + NL + "                        \t";
  protected final String TEXT_121 = NL + "                        \t.build();" + NL + "\t\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\torg.talend.salesforce.SforceManagement sfMgr_";
  protected final String TEXT_123 = " = new org.talend.salesforce.SforceManagementImpl(sforceConn_";
  protected final String TEXT_124 = ");" + NL + "\t\t\t";
  protected final String TEXT_125 = NL + "\t\t\t\tjava.util.List<String> dynamicColsName_";
  protected final String TEXT_126 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\tclass SFDynamicUtil_";
  protected final String TEXT_127 = "{" + NL + "\t\t\t\t\tpublic void genDynamicColumn(org.talend.salesforce.SforceManagement sfMgr, routines.system.Dynamic dynamic, java.util.List<String> dynamicColsName, java.util.List<String> unDynamicCols){" + NL + "\t\t\t\t\t\ttry {" + NL + "\t\t\t\t            com.salesforce.soap.partner.DescribeSObjectResult objInfo = sfMgr.describeSObject(";
  protected final String TEXT_128 = ");" + NL + "\t\t\t\t            com.salesforce.soap.partner.Field[] fields = objInfo.getFields();" + NL + "\t\t\t\t            for (com.salesforce.soap.partner.Field field:fields) {" + NL + "\t\t\t\t\t\t\t\tif(!unDynamicCols.contains(field.getName())){" + NL + "\t\t\t\t\t\t\t\t\tString sfType = field.getType().toString();" + NL + "\t\t\t\t\t\t\t\t\tString talendType = \"String\"; " + NL + "\t\t\t\t\t\t\t        if (sfType.equals(\"boolean\")) { " + NL + "\t\t\t\t\t\t\t            talendType = \"Boolean\"; " + NL + "\t\t\t\t\t\t\t        } else if (sfType.equals(\"int\")) { " + NL + "\t\t\t\t\t\t\t            talendType = \"Integer\"; " + NL + "\t\t\t\t\t\t\t        } else if (sfType.equals(\"date\") || sfType.equals(\"datetime\")) {  " + NL + "\t\t\t\t\t\t\t            talendType = \"Date\"; " + NL + "\t\t\t\t\t\t\t        } else if (sfType.equals(\"double\") || sfType.equals(\"currency\")) {  " + NL + "\t\t\t\t\t\t\t            talendType = \"Double\"; " + NL + "\t\t\t\t\t\t\t        } else {" + NL + "\t\t\t\t\t\t\t            talendType = \"String\"; " + NL + "\t\t\t\t\t\t\t        }" + NL + "\t\t\t\t\t\t\t    \troutines.system.DynamicMetadata dynamicMetadata = new routines.system.DynamicMetadata();" + NL + "\t\t\t\t\t\t\t    \tdynamicColsName.add(field.getName());" + NL + "\t\t\t\t\t\t\t    \tdynamicMetadata.setName(field.getName());" + NL + "\t\t\t\t\t\t\t    \tdynamicMetadata.setDbName(dynamicMetadata.getName());" + NL + "\t\t\t\t\t\t\t    \tdynamicMetadata.setType(\"id_\" + talendType);" + NL + "\t\t\t\t\t\t\t    \t if (sfType.equals(\"date\")) { " + NL + "\t\t\t\t\t\t\t            dynamicMetadata.setFormat(\"yyyy-MM-dd\"); " + NL + "\t\t\t\t\t\t\t        } else if (sfType.equals(\"datetime\")) { " + NL + "\t\t\t\t\t\t\t            dynamicMetadata.setFormat(\"yyyy-MM-dd'T'HH:mm:ss.'000Z'\"); " + NL + "\t\t\t\t\t\t\t        } else {" + NL + "\t\t\t\t\t\t\t            dynamicMetadata.setFormat(null);" + NL + "\t\t\t\t\t\t\t        }" + NL + "\t\t\t\t\t\t\t        if (\"String\".equals(talendType)) { " + NL + "\t\t\t\t\t\t\t            dynamicMetadata.setLength(field.getLength());" + NL + "\t\t\t\t\t\t\t            dynamicMetadata.setPrecision(field.getPrecision());" + NL + "\t\t\t\t\t\t\t        } else {" + NL + "\t\t\t\t\t\t\t            dynamicMetadata.setLength(field.getPrecision());" + NL + "\t\t\t\t\t\t\t            dynamicMetadata.setPrecision(field.getScale());" + NL + "\t\t\t\t\t\t\t        }" + NL + "\t\t\t\t\t\t\t    \tdynamicMetadata.setDbType(\"VARCHAR\");" + NL + "\t\t\t\t\t\t\t    \tdynamicMetadata.setNullable(field.getNillable());" + NL + "\t\t\t\t\t\t\t    \tdynamicMetadata.setKey(false);" + NL + "\t\t\t\t\t\t\t    \tif(field.getReferenceTo()!=null && field.getReferenceTo().length > 0){" + NL + "\t\t\t\t\t\t\t    \t\tdynamicMetadata.setRefFieldName(field.getRelationshipName());" + NL + "\t\t\t\t\t\t\t    \t\tdynamicMetadata.setRefModuleName(field.getReferenceTo()[0]);" + NL + "\t\t\t\t\t\t\t    \t}" + NL + "\t\t\t\t\t\t\t    \tdynamicMetadata.setSourceType(routines.system.DynamicMetadata.sourceTypes.salesforce);" + NL + "\t\t\t\t\t\t\t    \t//dynamicMetadata.setColumnPosition(i);" + NL + "\t\t\t\t\t\t\t    \tdynamic.metadatas.add(dynamicMetadata);" + NL + "\t\t\t\t\t\t\t    }" + NL + "\t\t\t\t\t\t    }" + NL + "\t\t\t\t        } catch (Exception e) {" + NL + "\t\t\t\t            e.printStackTrace();" + NL + "\t\t\t\t        }" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\tSFDynamicUtil_";
  protected final String TEXT_129 = " sfDynamicUtil_";
  protected final String TEXT_130 = " =new SFDynamicUtil_";
  protected final String TEXT_131 = "();   " + NL + "\t\t\t\tsfDynamicUtil_";
  protected final String TEXT_132 = ".genDynamicColumn(sfMgr_";
  protected final String TEXT_133 = ", dynamic_";
  protected final String TEXT_134 = ", dynamicColsName_";
  protected final String TEXT_135 = ", unDynamicCols_";
  protected final String TEXT_136 = " ); " + NL + "\t\t\t";
  protected final String TEXT_137 = NL + "\t\t\tStringBuilder fieldsName_";
  protected final String TEXT_138 = " = new StringBuilder();" + NL + "\t\t\t";
  protected final String TEXT_139 = NL + "\t\t\t\tfieldsName_";
  protected final String TEXT_140 = ".append(\"";
  protected final String TEXT_141 = "\");" + NL + "\t\t\t";
  protected final String TEXT_142 = NL + "\t\t\t\tif(dynamicColsName_";
  protected final String TEXT_143 = ".size()>0){" + NL + "\t\t\t\t\tfieldsName_";
  protected final String TEXT_144 = ".append(\"";
  protected final String TEXT_145 = "\"+routines.system.StringUtils.list(dynamicColsName_";
  protected final String TEXT_146 = ".toArray(new String[0]),\",\"));" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_147 = "\t\t\t\t" + NL + "" + NL + "\tcom.salesforce.soap.partner.sobject.SObject[] so_";
  protected final String TEXT_148 = " = null;" + NL + "\tcom.salesforce.soap.partner.ID[] ids_";
  protected final String TEXT_149 = " = sfMgr_";
  protected final String TEXT_150 = ".getUpdated(";
  protected final String TEXT_151 = ", startCal_";
  protected final String TEXT_152 = ", endCal_";
  protected final String TEXT_153 = ");" + NL + "\t" + NL + "\tif(ids_";
  protected final String TEXT_154 = " !=null && ids_";
  protected final String TEXT_155 = ".length > 0){" + NL + "\t\t\t\t\t\t" + NL + "\t\tint newMax_";
  protected final String TEXT_156 = " = 0;" + NL + "\t\tint newBase_";
  protected final String TEXT_157 = " = 0;" + NL + "\t\t" + NL + "\t\twhile (newMax_";
  protected final String TEXT_158 = " < ids_";
  protected final String TEXT_159 = ".length){" + NL + "\t\t" + NL + "\t\t\tnewBase_";
  protected final String TEXT_160 = " = newMax_";
  protected final String TEXT_161 = ";" + NL + "\t\t\tnewMax_";
  protected final String TEXT_162 = " += 2000;" + NL + "\t\t\t" + NL + "\t\t\tif (newMax_";
  protected final String TEXT_163 = " > ids_";
  protected final String TEXT_164 = ".length){" + NL + "\t\t\t\tnewMax_";
  protected final String TEXT_165 = " = ids_";
  protected final String TEXT_166 = ".length;" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tcom.salesforce.soap.partner.ID[] localIds_";
  protected final String TEXT_167 = " = new com.salesforce.soap.partner.ID[newMax_";
  protected final String TEXT_168 = "-newBase_";
  protected final String TEXT_169 = "];" + NL + "" + NL + "\t\t\tfor (int i_";
  protected final String TEXT_170 = "=newBase_";
  protected final String TEXT_171 = ";i_";
  protected final String TEXT_172 = " < newMax_";
  protected final String TEXT_173 = ";i_";
  protected final String TEXT_174 = "++){" + NL + "\t\t\t\tlocalIds_";
  protected final String TEXT_175 = "[i_";
  protected final String TEXT_176 = "-newBase_";
  protected final String TEXT_177 = "] = ids_";
  protected final String TEXT_178 = "[i_";
  protected final String TEXT_179 = "];" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tso_";
  protected final String TEXT_180 = " = sfMgr_";
  protected final String TEXT_181 = ".retrieve(localIds_";
  protected final String TEXT_182 = ",";
  protected final String TEXT_183 = ",fieldsName_";
  protected final String TEXT_184 = ".toString());" + NL + "    \t\t" + NL + "    \t\tif(so_";
  protected final String TEXT_185 = " != null){" + NL + "    \t\t" + NL + "\t\t\tfor (int i_";
  protected final String TEXT_186 = "=0;i_";
  protected final String TEXT_187 = "<so_";
  protected final String TEXT_188 = ".length;i_";
  protected final String TEXT_189 = "++){" + NL + "\t\t\t\tnb_line_";
  protected final String TEXT_190 = " ++;" + NL + "\t\t\t\t" + NL + "\t\t\t  if(so_";
  protected final String TEXT_191 = "[i_";
  protected final String TEXT_192 = "]!=null){" + NL + "\t\t\t\torg.apache.axiom.om.OMElement[] fields_";
  protected final String TEXT_193 = " = so_";
  protected final String TEXT_194 = "[i_";
  protected final String TEXT_195 = "].getExtraElement();" + NL + "\t\t\t\tint len_";
  protected final String TEXT_196 = " = fields_";
  protected final String TEXT_197 = ".length;";
  protected final String TEXT_198 = "\t\t\t\t\t\t" + NL + "\t\t\t\t    \t\tif (";
  protected final String TEXT_199 = " < len_";
  protected final String TEXT_200 = " &&  fields_";
  protected final String TEXT_201 = "[";
  protected final String TEXT_202 = "]!=null && fields_";
  protected final String TEXT_203 = "[";
  protected final String TEXT_204 = "].getText() != null && !\"\".equals(fields_";
  protected final String TEXT_205 = "[";
  protected final String TEXT_206 = "].getText())){" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_214 = " = ParserUtils.parseTo_Date(fields_";
  protected final String TEXT_215 = "[";
  protected final String TEXT_216 = "].getText(), ";
  protected final String TEXT_217 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_218 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_219 = ".";
  protected final String TEXT_220 = " = fields_";
  protected final String TEXT_221 = "[";
  protected final String TEXT_222 = "].getText().getBytes();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_223 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_224 = ".";
  protected final String TEXT_225 = " = ParserUtils.parseTo_";
  protected final String TEXT_226 = "(fields_";
  protected final String TEXT_227 = "[";
  protected final String TEXT_228 = "].getText());" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_229 = "\t\t\t" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_230 = ".";
  protected final String TEXT_231 = " = ";
  protected final String TEXT_232 = ";" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_233 = NL + "\t\t\t\t\t    \tdynamic_";
  protected final String TEXT_234 = ".clearColumnValues();" + NL + "\t\t\t\t\t    \tfor(int j_";
  protected final String TEXT_235 = " = 0; j_";
  protected final String TEXT_236 = " < dynamic_";
  protected final String TEXT_237 = ".getColumnCount(); j_";
  protected final String TEXT_238 = "++){" + NL + "\t\t\t\t\t    \t\tint columnIndex_";
  protected final String TEXT_239 = " = j_";
  protected final String TEXT_240 = "+";
  protected final String TEXT_241 = ";" + NL + "\t\t\t\t\t\t\t\tString valueObj_";
  protected final String TEXT_242 = " = fields_";
  protected final String TEXT_243 = "[columnIndex_";
  protected final String TEXT_244 = "].getText();" + NL + "\t\t\t\t\t\t\t\troutines.system.DynamicMetadata dynamicMetadata_";
  protected final String TEXT_245 = " = dynamic_";
  protected final String TEXT_246 = ".getColumnMetadata(j_";
  protected final String TEXT_247 = ");" + NL + "\t\t\t\t\t\t\t\tif (columnIndex_";
  protected final String TEXT_248 = " < len_";
  protected final String TEXT_249 = " && fields_";
  protected final String TEXT_250 = "[columnIndex_";
  protected final String TEXT_251 = "].getText() != null && !\"\".equals(fields_";
  protected final String TEXT_252 = "[columnIndex_";
  protected final String TEXT_253 = "].getText())){" + NL + "\t\t\t\t\t\t\t\t\tif(\"id_Date\".equals(dynamicMetadata_";
  protected final String TEXT_254 = ".getType())){" + NL + "\t\t\t\t\t\t\t\t\t\tdynamic_";
  protected final String TEXT_255 = ".addColumnValue(ParserUtils.parseTo_Date(valueObj_";
  protected final String TEXT_256 = ", dynamicMetadata_";
  protected final String TEXT_257 = ".getFormat()));" + NL + "\t\t\t\t\t\t\t\t\t}else if(\"id_Double\".equals(dynamicMetadata_";
  protected final String TEXT_258 = ".getType())){" + NL + "\t\t\t\t\t\t\t\t\t\tdynamic_";
  protected final String TEXT_259 = ".addColumnValue(ParserUtils.parseTo_Double(valueObj_";
  protected final String TEXT_260 = "));" + NL + "\t\t\t\t\t\t\t\t\t}else if(\"id_Integer\".equals(dynamicMetadata_";
  protected final String TEXT_261 = ".getType())){" + NL + "\t\t\t\t\t\t\t\t\t\tdynamic_";
  protected final String TEXT_262 = ".addColumnValue(ParserUtils.parseTo_Integer(valueObj_";
  protected final String TEXT_263 = "));" + NL + "\t\t\t\t\t\t\t\t\t}else if(\"id_Boolean\".equals(dynamicMetadata_";
  protected final String TEXT_264 = ".getType())){" + NL + "\t\t\t\t\t\t\t\t\t\tdynamic_";
  protected final String TEXT_265 = ".addColumnValue(ParserUtils.parseTo_Boolean(valueObj_";
  protected final String TEXT_266 = "));" + NL + "\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\tdynamic_";
  protected final String TEXT_267 = ".addColumnValue(valueObj_";
  protected final String TEXT_268 = ");" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\tdynamic_";
  protected final String TEXT_269 = ".addColumnValue(null);" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
