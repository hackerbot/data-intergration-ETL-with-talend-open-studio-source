...
public class TXMLMapOutBeginJava {
  ...
  protected final String TEXT_108 = ".getName()," + NL + "        \torg.dom4j.DocumentHelper.createNamespace(\"\",TalendString.replaceSpecialCharForXML(FormatterUtils.format(";
  protected final String TEXT_109 = ",";
  protected final String TEXT_110 = ")))));" + NL + "}//close if 8080";
  protected final String TEXT_111 = NL + "        \t";
  protected final String TEXT_112 = ".setQName(org.dom4j.DocumentHelper.createQName(";
  ...
  protected final String TEXT_116 = ".setQName(org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_117 = "\"," + NL + "        \torg.dom4j.DocumentHelper.createNamespace(\"";
  protected final String TEXT_118 = "\",TalendString.replaceSpecialCharForXML(FormatterUtils.format(";
  protected final String TEXT_119 = ",";
  protected final String TEXT_120 = ")))));" + NL + "}//close if 8080";
  protected final String TEXT_121 = NL + "        \t";
  protected final String TEXT_122 = ".setQName(org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_123 = "\"," + NL + "        \torg.dom4j.DocumentHelper.createNamespace(\"";
  protected final String TEXT_124 = "\",TalendString.replaceSpecialCharForXML(\"";
  protected final String TEXT_125 = "\"))));";
  protected final String TEXT_126 = NL + "\t\t\t";
  protected final String TEXT_127 = "_";
  protected final String TEXT_128 = " = ";
  protected final String TEXT_129 = ".elements(\"";
  protected final String TEXT_130 = "\");";
  protected final String TEXT_131 = NL + "\t\t\t";
  protected final String TEXT_132 = "_";
  protected final String TEXT_133 = " = ";
  protected final String TEXT_134 = ".elements(" + NL + "\t\t\t\torg.dom4j.DocumentHelper.createQName(" + NL + "\t\t\t\t\t\"";
  protected final String TEXT_135 = "\"," + NL + "\t        \t\torg.dom4j.DocumentHelper.createNamespace(" + NL + "\t        \t\t\t\"";
  protected final String TEXT_136 = "\",TalendString.replaceSpecialCharForXML(\"";
  protected final String TEXT_137 = "\")" + NL + "\t        \t\t)" + NL + "\t        \t)" + NL + "        \t);";
  protected final String TEXT_138 = NL + "\t\t\tnamespace_";
  protected final String TEXT_139 = " = ";
  protected final String TEXT_140 = ".getNamespaceForPrefix(\"";
  protected final String TEXT_141 = "\");" + NL + "\t\t\t";
  protected final String TEXT_142 = "_";
  protected final String TEXT_143 = " = namespace_";
  protected final String TEXT_144 = "!=null ? ";
  protected final String TEXT_145 = ".elements(org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_146 = "\",namespace_";
  protected final String TEXT_147 = ")) : ";
  protected final String TEXT_148 = ".elements(\"";
  protected final String TEXT_149 = "\"); ";
  protected final String TEXT_150 = NL + "\t\torg.dom4j.Element ";
  ...
  protected final String TEXT_155 = " = org.dom4j.DocumentHelper.createElement(\"";
  protected final String TEXT_156 = "\");" + NL + "\t\t        } else {" + NL + "\t\t        \t";
  protected final String TEXT_157 = " = org.dom4j.DocumentHelper.createElement(\"";
  ...
  protected final String TEXT_222 = "!=null){" + NL + "\t\t\tvalueMap.put(\"";
  protected final String TEXT_223 = "\",";
  protected final String TEXT_224 = ");" + NL + "\t\t\tif(valueMap.get(\"";
  protected final String TEXT_225 = "\")!=null) {" + NL + "\t\t\t\t";
  protected final String TEXT_226 = ".addAttribute(\"";
  protected final String TEXT_227 = "\",FormatterUtils.format(";
  protected final String TEXT_228 = ",";
  protected final String TEXT_229 = "));" + NL + "\t\t\t}";
  protected final String TEXT_230 = "else {" + NL + "\t\t\t\t";
  protected final String TEXT_231 = ".addAttribute(\"";
  protected final String TEXT_232 = "\",\"\");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_233 = NL + "//\t\t}";
  protected final String TEXT_234 = NL + "\t\t\t";
  protected final String TEXT_235 = ".addAttribute(\"";
