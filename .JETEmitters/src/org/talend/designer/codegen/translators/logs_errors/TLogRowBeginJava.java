...
public class TLogRowBeginJava
{
  ...
  protected final String TEXT_76 = ");" + NL + "                    }" + NL + "                    " + NL + "                    consoleOut_";
  protected final String TEXT_77 = ".println(sbHeader_";
  protected final String TEXT_78 = ".toString());" + NL + "                    consoleOut_";
  protected final String TEXT_79 = ".flush();" + NL + "                    ";
  protected final String TEXT_80 = "\t" + NL;
  protected final String TEXT_81 = NL + " \t\tStringBuilder strBuffer_";
  protected final String TEXT_82 = " = null;" + NL + "\t\tint nb_line_";
  protected final String TEXT_83 = " = 0;" + NL + "///////////////////////    \t\t\t" + NL;
  protected final String TEXT_84 = NL + "\t\t\t\tclass LogRowUtil_";
  protected final String TEXT_85 = "{";
  protected final String TEXT_86 = NL + "\t\t\t\t\t\tpublic void putBasicVerticalValue_";
  protected final String TEXT_87 = "(final ";
  protected final String TEXT_88 = "Struct ";
  protected final String TEXT_89 = ",StringBuilder strBuffer_";
  protected final String TEXT_90 = "){";
  protected final String TEXT_91 = NL + "\t\t\t\t\t\t\tjava.util.Formatter formatter_";
  protected final String TEXT_92 = "_";
  protected final String TEXT_93 = " = new java.util.Formatter(new StringBuilder());";
  protected final String TEXT_94 = NL + "\t\t\t\t\t\t\tstrBuffer_";
  protected final String TEXT_95 = ".append(\"";
  protected final String TEXT_96 = ": \");";
  protected final String TEXT_97 = "   \t\t\t\t" + NL + "\t    \t\t\t\t\tif(";
  protected final String TEXT_98 = ".";
  protected final String TEXT_99 = " != null) { //";
  protected final String TEXT_100 = NL + "\t\t\t\t\t\t\tstrBuffer_";
  protected final String TEXT_101 = ".append(formatter_";
  protected final String TEXT_102 = "_";
  protected final String TEXT_103 = ".format(\"%1$";
  protected final String TEXT_104 = "s\", ";
  protected final String TEXT_105 = NL + "\t\t\t\t\t\t\tFormatterUtils.format_Date(";
  protected final String TEXT_106 = ".";
  protected final String TEXT_107 = ", ";
  protected final String TEXT_108 = ")";
  protected final String TEXT_109 = NL + "\t\t\t\t\t\t\tjava.nio.charset.Charset.defaultCharset().decode(java.nio.ByteBuffer.wrap(";
  protected final String TEXT_110 = ".";
  protected final String TEXT_111 = ")).toString()";
  protected final String TEXT_112 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_113 = ".toPlainString()";
  protected final String TEXT_114 = NL + "\t\t\t\t\t\t\tFormatterUtils.formatUnwithE(";
  protected final String TEXT_115 = ".";
  protected final String TEXT_116 = ")";
  protected final String TEXT_117 = NL + "\t\t\t\t           \tString.valueOf(";
  protected final String TEXT_118 = ".";
  protected final String TEXT_119 = ")\t\t\t";
  protected final String TEXT_120 = NL + "\t\t\t\t\t\t\t).toString());";
  protected final String TEXT_121 = "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\tstrBuffer_";
  protected final String TEXT_122 = ".append(";
  protected final String TEXT_123 = NL + "\t\t\t\t\t\t\tFormatterUtils.format_Date(";
  protected final String TEXT_124 = ".";
  protected final String TEXT_125 = ", ";
  protected final String TEXT_126 = ")";
  protected final String TEXT_127 = NL + "\t\t\t\t\t\t\tjava.nio.charset.Charset.defaultCharset().decode(java.nio.ByteBuffer.wrap(";
  protected final String TEXT_128 = ".";
  protected final String TEXT_129 = ")).toString()";
  protected final String TEXT_130 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_131 = ".toPlainString()";
  protected final String TEXT_132 = NL + "\t\t\t\t\t\t\tFormatterUtils.formatUnwithE(";
  protected final String TEXT_133 = ".";
  protected final String TEXT_134 = ")";
  protected final String TEXT_135 = NL + "\t\t\t\t            String.valueOf(";
  protected final String TEXT_136 = ".";
  protected final String TEXT_137 = ")\t\t\t";
  protected final String TEXT_138 = "\t\t\t\t" + NL + "\t\t\t\t\t\t\t);";
  protected final String TEXT_139 = NL + "\t    \t\t\t\t} //";
  protected final String TEXT_140 = NL + "\t\t\t\t\t\t}";
  protected final String TEXT_141 = NL + "    \t\t\t\t\t\tstrBuffer_";
  protected final String TEXT_142 = ".append(";
  protected final String TEXT_143 = ");";
  protected final String TEXT_144 = NL + "\t\t\t\t\t\t}";
  protected final String TEXT_145 = NL + "\t\t\t\t\t\t}";
  protected final String TEXT_146 = NL + "\t\t\t\t\t\tpublic void putTableVerticalValue_";
  protected final String TEXT_147 = "(final ";
  protected final String TEXT_148 = "Struct ";
  protected final String TEXT_149 = ",String[] row_";
  protected final String TEXT_150 = "){";
  protected final String TEXT_151 = "   \t\t\t\t" + NL + "\t    \t\t\t\t\tif(";
  protected final String TEXT_152 = ".";
  protected final String TEXT_153 = " != null) { //";
  protected final String TEXT_154 = "              " + NL + "                 \t\t\t\trow_";
  protected final String TEXT_155 = "[";
  protected final String TEXT_156 = "]=    \t\t\t\t\t\t";
  protected final String TEXT_157 = NL + "\t\t\t\t\t\t\t\tFormatterUtils.format_Date(";
  protected final String TEXT_158 = ".";
  protected final String TEXT_159 = ", ";
  protected final String TEXT_160 = ")";
  protected final String TEXT_161 = NL + "\t\t\t\t\t\t\t\tjava.nio.charset.Charset.defaultCharset().decode(java.nio.ByteBuffer.wrap(";
  protected final String TEXT_162 = ".";
  protected final String TEXT_163 = ")).toString()";
  protected final String TEXT_164 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_165 = ".toPlainString()";
  protected final String TEXT_166 = NL + "\t\t\t\t\t\t\t\tFormatterUtils.formatUnwithE(";
  protected final String TEXT_167 = ".";
  protected final String TEXT_168 = ")";
  protected final String TEXT_169 = "    " + NL + "\t\t\t\t                String.valueOf(";
  ...
  protected final String TEXT_176 = NL + "\t\t\t}" + NL + "\t\t\tLogRowUtil_";
  protected final String TEXT_177 = " logRowUtil_";
  protected final String TEXT_178 = "=new LogRowUtil_";
