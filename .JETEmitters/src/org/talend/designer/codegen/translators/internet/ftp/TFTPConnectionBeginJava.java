...
public class TFTPConnectionBeginJava
{
  ...
  protected final String TEXT_174 = NL + "              String decryptedKeyStorePassword_";
  protected final String TEXT_175 = " = ";
  protected final String TEXT_176 = "; ";
  protected final String TEXT_177 = NL + "\t        " + NL + "     \t\tks.load(new java.io.FileInputStream(";
  protected final String TEXT_178 = "), decryptedKeyStorePassword_";
  protected final String TEXT_179 = ".toCharArray());" + NL + "      \t\tjavax.net.ssl.TrustManagerFactory tmf = javax.net.ssl.TrustManagerFactory.getInstance(javax.net.ssl.KeyManagerFactory.getDefaultAlgorithm());" + NL + "      \t\ttmf.init(ks);" + NL + "      \t\treturn tmf.getTrustManagers();" + NL + "    \t}" + NL + "\t}" + NL + "\tjavax.net.ssl.SSLContext sslContext = null;" + NL + "\tjavax.net.ssl.TrustManager[] trustManager = null;" + NL + "\tjavax.net.ssl.SSLSocketFactory sslSocketFactory = null;" + NL + "\tit.sauronsoftware.ftp4j.FTPClient ftp_";
  protected final String TEXT_180 = " =null;" + NL + "\tMyTrust_";
  protected final String TEXT_181 = " myTrust_";
  protected final String TEXT_182 = " = null;" + NL + "" + NL + "\ttry {" + NL + "\t\tsslContext = javax.net.ssl.SSLContext.getInstance(\"SSL\");" + NL + "\t\tmyTrust_";
  protected final String TEXT_183 = " = new MyTrust_";
  protected final String TEXT_184 = "();" + NL + "\t\ttrustManager = myTrust_";
  protected final String TEXT_185 = ".getTrustManagers();" + NL + "\t\tsslContext.init(null, trustManager, new java.security.SecureRandom());" + NL + "\t\tsslSocketFactory = sslContext.getSocketFactory();" + NL + "\t\tftp_";
  protected final String TEXT_186 = " = new it.sauronsoftware.ftp4j.FTPClient();" + NL + "\t\tftp_";
  protected final String TEXT_187 = ".setSSLSocketFactory(sslSocketFactory);";
  protected final String TEXT_188 = NL + "\t\t\tftp_";
  protected final String TEXT_189 = ".setSecurity(it.sauronsoftware.ftp4j.FTPClient.SECURITY_FTPS);";
  protected final String TEXT_190 = NL + "\t\t\tftp_";
  protected final String TEXT_191 = ".setSecurity(it.sauronsoftware.ftp4j.FTPClient.SECURITY_FTPES);";
  protected final String TEXT_192 = NL + "\t\t";
  protected final String TEXT_193 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_194 = " -FTPS security Mode is ";
  ...
  protected final String TEXT_200 = ".connect(";
  protected final String TEXT_201 = ",";
  protected final String TEXT_202 = ");" + NL + "  \t\t";
  protected final String TEXT_203 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_204 = " - Connect to '\" + ";
  protected final String TEXT_205 = " + \"' has succeeded.\");" + NL + "\t\t";
  ...
  protected final String TEXT_214 = NL + "\t   \t" + NL + "    \tftp_";
  protected final String TEXT_215 = ".login(";
  protected final String TEXT_216 = ", decryptedPassword_";
  protected final String TEXT_217 = ");" + NL + "  \t} catch (java.lang.IllegalStateException e) {" + NL + "\t\t";
  protected final String TEXT_218 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_219 = " - \" + e.getMessage());" + NL + "\t\t";
  protected final String TEXT_220 = NL + "    \te.printStackTrace();" + NL + "\t} catch (java.io.IOException e) {" + NL + "\t\t";
  protected final String TEXT_221 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_222 = " - \" + e.getMessage());" + NL + "\t\t";
  protected final String TEXT_223 = NL + "\t\te.printStackTrace();" + NL + "\t} catch (it.sauronsoftware.ftp4j.FTPIllegalReplyException e) {" + NL + "\t\t";
  protected final String TEXT_224 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_225 = " - \" + e.getMessage());" + NL + "\t\t";
  protected final String TEXT_226 = NL + "\t\te.printStackTrace();" + NL + "\t} catch (it.sauronsoftware.ftp4j.FTPException e) {" + NL + "\t\t";
  protected final String TEXT_227 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_228 = " - \" + e.getMessage());" + NL + "\t\t";
  protected final String TEXT_229 = NL + "\t\te.printStackTrace();" + NL + "\t}" + NL + "\tglobalMap.put(\"conn_";
