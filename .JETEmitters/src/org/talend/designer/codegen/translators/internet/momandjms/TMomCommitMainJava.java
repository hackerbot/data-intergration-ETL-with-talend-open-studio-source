...
public class TMomCommitMainJava
{
  ...
  protected final String TEXT_41 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_42 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_43 = " - Commit successfully.\");" + NL + "\t\t\t";
  protected final String TEXT_44 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_45 = " - Closing connection...\");" + NL + "\t\t\t\t";
  protected final String TEXT_46 = NL + "\t\t\t    qMgr_";
  protected final String TEXT_47 = ".disconnect();" + NL + "\t\t\t\t";
  protected final String TEXT_48 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_49 = " - Closed successfully.\");" + NL + "\t\t\t\t";
