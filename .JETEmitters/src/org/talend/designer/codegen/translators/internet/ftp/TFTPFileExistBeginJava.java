...
public class TFTPFileExistBeginJava
{
  ...
  protected final String TEXT_82 = NL + "    \tcom.jcraft.jsch.Session session_";
  ...
  protected final String TEXT_90 = " - SFTP authentication using a password.\");" + NL + "\t  \t\t";
  ...
  protected final String TEXT_99 = NL + "\t  \t\t" + NL + "      \t\tsession_";
  protected final String TEXT_100 = ".setPassword(decryptedPassword_";
  protected final String TEXT_101 = "); " + NL + "    \t";
  protected final String TEXT_102 = NL + "    \tsession_";
  protected final String TEXT_103 = ".setUserInfo(defaultUserInfo_";
  protected final String TEXT_104 = "); " + NL + "\t\t";
  protected final String TEXT_105 = NL + "\t  \t\tif((\"true\").equals(System.getProperty(\"http.proxySet\")) ){" + NL + "\t\t  \t\tcom.jcraft.jsch.ProxyHTTP proxy_";
  protected final String TEXT_106 = " = new com.jcraft.jsch.ProxyHTTP(System.getProperty(\"http.proxyHost\"),Integer.parseInt(System.getProperty(\"http.proxyPort\")));" + NL + "  \t\t\t\tif(!\"\".equals(System.getProperty(\"http.proxyUser\"))){" + NL + "  \t\t\t\t\tproxy_";
  protected final String TEXT_107 = ".setUserPasswd(System.getProperty(\"http.proxyUser\"),System.getProperty(\"http.proxyPassword\"));" + NL + "  \t\t\t\t}" + NL + "  \t\t\t\tsession_";
  protected final String TEXT_108 = ".setProxy(proxy_";
  protected final String TEXT_109 = ");" + NL + "  \t\t\t}" + NL + "\t\t";
  protected final String TEXT_110 = NL + "\t\t";
  protected final String TEXT_111 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_112 = " - Attempt to connect to '\" + ";
  protected final String TEXT_113 = " + \"' with username '\" + ";
  protected final String TEXT_114 = " + \"'.\");" + NL + "\t\t";
  protected final String TEXT_115 = NL + "    \tsession_";
  protected final String TEXT_116 = ".connect();" + NL + "\t\tcom.jcraft.jsch. Channel channel_";
  protected final String TEXT_117 = "=session_";
  protected final String TEXT_118 = ".openChannel(\"sftp\");" + NL + "    \tchannel_";
  protected final String TEXT_119 = ".connect();" + NL + "\t\t";
  protected final String TEXT_120 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_121 = " - Connect to '\" + ";
  protected final String TEXT_122 = " + \"' has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_123 = NL + "    \tcom.jcraft.jsch.ChannelSftp c_";
  protected final String TEXT_124 = "=(com.jcraft.jsch.ChannelSftp)channel_";
  protected final String TEXT_125 = ";" + NL + "    \t" + NL + "    \t";
  protected final String TEXT_126 = NL + "    \t\tc_";
  protected final String TEXT_127 = ".setFilenameEncoding(";
  protected final String TEXT_128 = ");" + NL + "    \t";
  protected final String TEXT_129 = "    " + NL + "\t    com.jcraft.jsch.ChannelSftp c_";
  protected final String TEXT_130 = " = (com.jcraft.jsch.ChannelSftp)globalMap.get(\"";
  protected final String TEXT_131 = "\");" + NL + "\t\t";
  protected final String TEXT_132 = NL + "\t\t\tif(c_";
  protected final String TEXT_133 = "!=null && c_";
  protected final String TEXT_134 = ".getSession()!=null) {" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_135 = " - Use an existing connection.  Connection username: \" + c_";
  protected final String TEXT_136 = ".getSession().getUserName() + \", Connection hostname: \" + c_";
  protected final String TEXT_137 = ".getSession().getHost() + \", Connection port: \" + c_";
  protected final String TEXT_138 = ".getSession().getPort() + \".\"); " + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_139 = NL + "\t    if(c_";
  protected final String TEXT_140 = ".getHome()!=null && !c_";
  protected final String TEXT_141 = ".getHome().equals(c_";
  protected final String TEXT_142 = ".pwd())){" + NL + "\t  \t\tc_";
  protected final String TEXT_143 = ".cd(c_";
  protected final String TEXT_144 = ".getHome());" + NL + "\t  \t}";
  protected final String TEXT_145 = NL + "\tcom.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_146 = " = null;" + NL + "" + NL + "\t";
  protected final String TEXT_147 = NL + "\t\tftp_";
  protected final String TEXT_148 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_149 = "\");" + NL + "\t\t";
  protected final String TEXT_150 = NL + "\t\t\tif(ftp_";
  protected final String TEXT_151 = "!=null) {" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_152 = " - Use an existing connection. Connection hostname: \" + ftp_";
  protected final String TEXT_153 = ".getRemoteHost() + \", Connection port: \" + ftp_";
  protected final String TEXT_154 = ".getRemotePort() + \".\"); " + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_155 = NL + "  \t";
  protected final String TEXT_156 = "    " + NL + "\t   \tftp_";
  protected final String TEXT_157 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "\t   \tftp_";
  protected final String TEXT_158 = ".setRemoteHost(";
  protected final String TEXT_159 = ");" + NL + "\t   \tftp_";
  protected final String TEXT_160 = ".setRemotePort(";
  ...
  protected final String TEXT_167 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);" + NL + "\t    ";
  protected final String TEXT_168 = NL + "\t      ftp_";
  protected final String TEXT_169 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);" + NL + "\t    ";
  protected final String TEXT_170 = NL + "\t    ftp_";
  protected final String TEXT_171 = ".setControlEncoding(";
  protected final String TEXT_172 = ");" + NL + "\t\t";
  protected final String TEXT_173 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_174 = " - Attempt to connect to '\" + ";
  protected final String TEXT_175 = " + \"' with username: '\" +";
  protected final String TEXT_176 = "+ \"'.\");" + NL + "\t\t";
  protected final String TEXT_177 = NL + "\t    ftp_";
  protected final String TEXT_178 = ".connect();  " + NL + "\t    " + NL + "\t\t";
  protected final String TEXT_179 = " " + NL + "\t" + NL + "\t\t";
  protected final String TEXT_180 = " " + NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_181 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  ...
  protected final String TEXT_187 = ".login(";
  protected final String TEXT_188 = ", decryptedPassword_";
  protected final String TEXT_189 = ");" + NL + "\t\t";
  protected final String TEXT_190 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_191 = " - Connect to '\" + ";
