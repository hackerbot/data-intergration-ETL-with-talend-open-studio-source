...
public class TFTPGetBeginJava
{
  ...
  protected final String TEXT_163 = NL + "\t\t\t    \tc_";
  protected final String TEXT_164 = ".setFilenameEncoding(";
  protected final String TEXT_165 = ");" + NL + "\t\t\t    ";
  protected final String TEXT_166 = NL + "\t\t\tcom.jcraft.jsch.SftpProgressMonitor monitor_";
  protected final String TEXT_167 = " = new MyProgressMonitor_";
  protected final String TEXT_168 = "();" + NL + "\t\t\tSFTPGetter_";
  protected final String TEXT_169 = " getter_";
  protected final String TEXT_170 = " = new SFTPGetter_";
  protected final String TEXT_171 = "();" + NL + "\t\t\tgetter_";
  protected final String TEXT_172 = ".cnlSFTP = c_";
  protected final String TEXT_173 = ";" + NL + "\t\t\tgetter_";
  protected final String TEXT_174 = ".monitor = monitor_";
  protected final String TEXT_175 = ";" + NL + "\t\t\tString remotedir_";
  protected final String TEXT_176 = " = ";
  protected final String TEXT_177 = ";" + NL + "\t\t\tc_";
  protected final String TEXT_178 = ".cd(remotedir_";
  protected final String TEXT_179 = ");";
  protected final String TEXT_180 = "  " + NL + "\tfinal com.enterprisedt.net.ftp.TransferCompleteStrings msg_";
  protected final String TEXT_181 = " = new com.enterprisedt.net.ftp.TransferCompleteStrings();" + NL + "" + NL + "\tclass FTPGetter_";
  ...
  protected final String TEXT_183 = NL + "\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_184 = " - \" + e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_185 = NL + "        \t\tftpFileNames = null;" + NL + "\t\t        ftpFiles = ftpClient.dirDetails(\".\");" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\t//if dirDetails(...) doesn't work, then use dir(...), distinguish file type by FTPException" + NL + "" + NL + "\t\t\tif ((ftpFiles == null) && (ftpFileNames != null)){" + NL + "\t        \t//if the file is folder, catch the FTPException and recur" + NL + "    \t    \tfor (String ftpFileName : ftpFileNames){" + NL + "        \t\t\ttry {" + NL + "            \t\t\tdownloadFile(localDirectory + \"/\" + ftpFileName,ftpFileName);" + NL + "          \t\t\t} catch (com.enterprisedt.net.ftp.FTPException e) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_186 = NL + "\t\t\t\t\t\t\tlog.warn(\"";
  protected final String TEXT_187 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_188 = NL + "      \t\t      \t\tjava.io.File localFile = new java.io.File(localDirectory + \"/\" + ftpFileName);" + NL + "            " + NL + "        \t    \t\tif (!localFile.exists()) {" + NL + "        \t      \t\t\tlocalFile.mkdir();" + NL + "        \t    \t\t}" + NL + "\t\t\t            getAllFiles(path + \"/\" + ftpFileName, localDirectory + \"/\" + ftpFileName);" + NL + "      \t\t  \t\t    ftpClient.chdir(path);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tfor (com.enterprisedt.net.ftp.FTPFile ftpFile : ftpFiles) {" + NL + "" + NL + "\t\t\t\t\tif (ftpFile.isDir()) {" + NL + "\t\t\t\t\t\tif ((!(\".\").equals(ftpFile.getName())) && (!(\"..\").equals(ftpFile.getName()))) {" + NL + "\t\t\t\t\t\t\tjava.io.File localFile = new java.io.File(localDirectory + \"/\" + ftpFile.getName());" + NL + "" + NL + "\t\t\t\t\t\t\tif (!localFile.exists()) {" + NL + "\t\t\t\t                localFile.mkdir();" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tgetAllFiles(path + \"/\" + ftpFile.getName(), localDirectory + \"/\" + ftpFile.getName());" + NL + "\t\t\t\t\t\t\tftpClient.chdir(path);" + NL + "\t\t\t            }" + NL + "\t\t\t\t\t} else if (!ftpFile.isLink()) {" + NL + "\t\t\t            downloadFile(localDirectory + \"/\" + ftpFile.getName(),ftpFile.getName());" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "" + NL + "\t\tpublic void getFiles(String remoteDirectory, String localDirectory, String maskStr) throws java.io.IOException," + NL + "\t\tcom.enterprisedt.net.ftp.FTPException, java.text.ParseException {" + NL + "\t\t\tftpClient.chdir(remoteDirectory);" + NL + "\t\t\tString[] ftpFileNames = null;" + NL + "\t\t\tcom.enterprisedt.net.ftp.FTPFile[] ftpFiles = null;" + NL + "" + NL + "\t\t\ttry {" + NL + "\t\t\t\t//use dir() for Bug9562 with FTP server in AS400 (the same way as getAllFiles())" + NL + "\t\t        ftpFileNames = ftpClient.dir(null, false);" + NL + "        \t\t//Bug 13272, if dir() throw exception, use dirDetails()." + NL + "\t\t\t} catch (com.enterprisedt.net.ftp.FTPException e){" + NL + "\t\t\t";
  protected final String TEXT_189 = NL + "\t\t\t\tlog.warn(\"";
  protected final String TEXT_190 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_191 = NL + "\t        ftpFileNames = null;" + NL + "    \t    ftpFiles = ftpClient.dirDetails(\".\");" + NL + "      \t\t}" + NL + "\t\t\t//if dirDetails(...) doesn't work, then use dir(...), but can not distinguish file type" + NL + "" + NL + "\t\t\tif ((ftpFiles == null) && (ftpFileNames != null)){" + NL + "\t\t\t\tfor (String ftpFileName : ftpFileNames) {" + NL + "\t\t\t\t\tif (ftpFileName.matches(maskStr)) {" + NL + "\t\t\t\t\t\tdownloadFile(localDirectory + \"/\" + ftpFileName,ftpFileName);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t} else{" + NL + "" + NL + "\t\t        for (com.enterprisedt.net.ftp.FTPFile ftpFile : ftpFiles) {" + NL + "" + NL + "\t\t\t\t\tif (!ftpFile.isDir() && !ftpFile.isLink()) {" + NL + "\t\t\t\t\t\tString fileName = ftpFile.getName();" + NL + "" + NL + "\t\t\t            if (fileName.matches(maskStr)) {" + NL + "            \t\t\t\tdownloadFile(localDirectory + \"/\" + fileName,fileName);" + NL + "\t\t\t            }" + NL + "          \t\t\t}" + NL + "        \t\t}" + NL + "      \t\t}" + NL + "\t\t}" + NL + "" + NL + "\t    public void chdir(String path) throws java.io.IOException,  com.enterprisedt.net.ftp.FTPException{" + NL + "    \t\tftpClient.chdir(path);" + NL + "\t\t}" + NL + "" + NL + "\t\tpublic String pwd() throws java.io.IOException,  com.enterprisedt.net.ftp.FTPException{" + NL + "\t\t\treturn ftpClient.pwd();" + NL + "\t\t}" + NL + "" + NL + "\t\tprivate void downloadFile(String localFileName, String remoteFileName) throws java.io.IOException, com.enterprisedt.net.ftp.FTPException {" + NL + "\t\t\tjava.io.File localFile = new java.io.File(localFileName);" + NL + "" + NL + "\t\t\ttry {" + NL + "\t\t\t\t";
  protected final String TEXT_192 = NL + "\t\t\t\t\tjava.io.FileOutputStream fout = new java.io.FileOutputStream(localFile, true);" + NL + "\t\t\t        ftpClient.get(fout, remoteFileName);" + NL + "\t\t\t\t\t";
  protected final String TEXT_193 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_194 = " - Downloaded file \" + (count +1) +  \" : '\" + remoteFileName + \"' successfully.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_195 = NL + "          \t\t\tmsg_";
  protected final String TEXT_196 = ".add(\"file [\" + remoteFileName + \"] downloaded successfully.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_197 = NL + "\t\t\t            System.out.println(\"file [\" + remoteFileName + \"] downloaded successfully.\");" + NL + "          \t\t\t";
  protected final String TEXT_198 = NL + "\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_199 = "_CURRENT_STATUS\", \"File transfer OK.\");";
  protected final String TEXT_200 = NL + "        \t\t\tif (!localFile.exists()) {" + NL + "\t\t\t\t\t\tftpClient.get(localFileName, remoteFileName);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_201 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_202 = " - Downloaded file \" + (count +1) +  \" : '\" + remoteFileName + \"' successfully.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_203 = NL + "\t\t\t            msg_";
  protected final String TEXT_204 = ".add(\"file [\" + remoteFileName + \"] downloaded successfully.\");" + NL + "            \t\t\t";
  protected final String TEXT_205 = NL + "\t\t\t\t\t\t\tSystem.out.println(\"file [\" + remoteFileName + \"] downloaded successfully.\");" + NL + "\t\t\t            ";
  protected final String TEXT_206 = NL + "            \t\t\tglobalMap.put(\"";
  protected final String TEXT_207 = "_CURRENT_STATUS\", \"File transfer OK.\");" + NL + "\t\t\t\t\t} else { ";
  protected final String TEXT_208 = NL + "                               log.info(\"";
  protected final String TEXT_209 = " - file [\"+ remoteFileName +\"] exit transmission.\");";
  protected final String TEXT_210 = NL + "\t\t\t\t\t\tmsg_";
  protected final String TEXT_211 = ".add(\"file [\"+ remoteFileName +\"] exit transmission.\");" + NL + "\t\t\t            globalMap.put(\"";
  protected final String TEXT_212 = "_CURRENT_STATUS\", \"No file transfered.\");" + NL + "\t\t\t\t\t}";
  protected final String TEXT_213 = NL + "\t\t\t\t\tftpClient.get(localFileName, remoteFileName);" + NL + "\t\t\t\t\t";
  protected final String TEXT_214 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_215 = " - Downloaded file \" + (count +1) +  \" : '\" + remoteFileName + \"' successfully.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_216 = NL + "\t\t\t\t\tmsg_";
  protected final String TEXT_217 = ".add(\"file [\" + remoteFileName + \"] downloaded successfully.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_218 = NL + "\t\t\t\t\t\tSystem.out.println(\"file [\" + remoteFileName + \"] downloaded successfully.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_219 = NL + "\t\t\t\t\tif (localFile.exists()) {" + NL + "\t\t\t\t\t\tlong ftpSize = ftpClient.size(remoteFileName);" + NL + "\t\t\t            long localSize = localFile.length();" + NL + "" + NL + "\t\t\t            if (ftpSize != localSize) {" + NL + "\t\t\t\t\t\t\tftpClient.get(localFileName, remoteFileName);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_220 = NL + "\t\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_221 = " - Downloaded file \" + (count +1) +  \" : '\" + remoteFileName + \"' successfully.\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_222 = NL + "            \t\t\t\tmsg_";
  protected final String TEXT_223 = ".add(\"file [\" + remoteFileName + \"] downloaded successfully.\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_224 = NL + "\t\t\t\t\t\t\t\tSystem.out.println(\"file [\" + remoteFileName + \"] downloaded successfully.\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_225 = NL + "\t\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_226 = "_CURRENT_STATUS\", \"File transfer OK.\");" + NL + "\t\t\t            } else {" + NL + "\t\t\t                 ";
  protected final String TEXT_227 = NL + "                                    log.info(\"";
  protected final String TEXT_228 = " - file [\"+ remoteFileName +\"] exit transmission.\");";
  protected final String TEXT_229 = NL + "            \t\t\t\tmsg_";
  protected final String TEXT_230 = ".add(\"file [\"+ remoteFileName +\"] exit transmission.\");" + NL + "\t\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_231 = "_CURRENT_STATUS\", \"No file transfered.\");" + NL + "\t\t\t            }" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\tftpClient.get(localFileName, remoteFileName);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_232 = NL + "\t\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_233 = " - Downloaded file \" + (count +1) +  \" : '\" + remoteFileName + \"' successfully.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_234 = NL + "\t\t\t\t \t\tmsg_";
  protected final String TEXT_235 = ".add(\"file [\" + remoteFileName + \"] downloaded successfully.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_236 = NL + "\t\t\t\t\t\t\tSystem.out.println(\"file [\" + remoteFileName + \"] downloaded successfully.\");" + NL + "\t\t\t            ";
  protected final String TEXT_237 = NL + "            \t\t\tglobalMap.put(\"";
  protected final String TEXT_238 = "_CURRENT_STATUS\", \"File transfer OK.\");" + NL + "\t\t\t\t\t}";
  protected final String TEXT_239 = NL + "\t\t\t} catch (com.enterprisedt.net.ftp.FTPException e) {" + NL + "\t\t        msg_";
  protected final String TEXT_240 = ".add(\"file [\" + remoteFileName + \"] downloaded unsuccessfully.\");" + NL + "        \t\tglobalMap.put(\"";
  protected final String TEXT_241 = "_CURRENT_STATUS\", \"File transfer fail.\");" + NL + "        \t\tthrow e;" + NL + "      \t\t}" + NL + "\t\t      count++;" + NL + "    \t}" + NL + "\t}" + NL + "\tcom.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_242 = " = null;" + NL;
  protected final String TEXT_243 = NL + "\t    ftp_";
  protected final String TEXT_244 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_245 = "\");" + NL + "  \t\t";
  protected final String TEXT_246 = NL + "  \t\t\tString rootDir_";
  protected final String TEXT_247 = " = ftp_";
  protected final String TEXT_248 = ".pwd();" + NL + "\t  \t";
  protected final String TEXT_249 = NL + "\t\t";
  protected final String TEXT_250 = NL + "\t\t\tif(ftp_";
  protected final String TEXT_251 = "!=null) {" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_252 = " - Uses an existing connection. Connection hostname: \" + ftp_";
  protected final String TEXT_253 = ".getRemoteHost() + \", Connection port: \" + ftp_";
  protected final String TEXT_254 = ".getRemotePort() + \".\"); " + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_255 = NL + "\t";
  protected final String TEXT_256 = "    " + NL + "    \tftp_";
  protected final String TEXT_257 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "\t    ftp_";
  protected final String TEXT_258 = ".setRemoteHost(";
  protected final String TEXT_259 = ");" + NL + "    \tftp_";
  protected final String TEXT_260 = ".setRemotePort(";
  ...
  protected final String TEXT_266 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);";
  protected final String TEXT_267 = NL + "    \t\tftp_";
  protected final String TEXT_268 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);";
  protected final String TEXT_269 = NL + "\t    ftp_";
  protected final String TEXT_270 = ".setControlEncoding(";
  protected final String TEXT_271 = ");" + NL + "\t\t";
  protected final String TEXT_272 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_273 = " - Attempt to connect to '\" + ";
  protected final String TEXT_274 = " + \"' with username '\" +";
  protected final String TEXT_275 = "+ \"'.\");" + NL + "\t\t";
  protected final String TEXT_276 = NL + "\t    ftp_";
  protected final String TEXT_277 = ".connect();" + NL + "\t    " + NL + "\t\t";
  protected final String TEXT_278 = " " + NL + "    \t" + NL + "    \t";
  protected final String TEXT_279 = " " + NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_280 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_281 = ");";
  protected final String TEXT_282 = NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_283 = " = ";
  protected final String TEXT_284 = "; ";
  protected final String TEXT_285 = NL + "\t    " + NL + "    \tftp_";
  protected final String TEXT_286 = ".login(";
  protected final String TEXT_287 = ", decryptedPassword_";
  protected final String TEXT_288 = ");  " + NL + "\t\t";
  protected final String TEXT_289 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_290 = " - Connect to '\" + ";
  protected final String TEXT_291 = " + \"' has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_292 = "  " + NL + "\t";
  protected final String TEXT_293 = NL + "\tmsg_";
  protected final String TEXT_294 = ".clearAll();" + NL + "\tFTPGetter_";
  protected final String TEXT_295 = " getter_";
  protected final String TEXT_296 = " = new FTPGetter_";
  protected final String TEXT_297 = "();" + NL + "\tgetter_";
  protected final String TEXT_298 = ".ftpClient = ftp_";
  protected final String TEXT_299 = ";" + NL + "\tString remotedir_";
  protected final String TEXT_300 = " = ";
  protected final String TEXT_301 = ";" + NL + "\tftp_";
  protected final String TEXT_302 = ".chdir(remotedir_";
  protected final String TEXT_303 = ");";
  protected final String TEXT_304 = NL + "\tclass FTPSGetter_";
  protected final String TEXT_305 = " {" + NL + "    \tprivate it.sauronsoftware.ftp4j.FTPClient ftpClient = null;" + NL + "    \tprivate int count = 0;" + NL + "" + NL + "    \tpublic void getAllFiles(String remoteDirectory, String localDirectory)" + NL + "\t\tthrows IllegalStateException, IOException, java.io.FileNotFoundException," + NL + "\t\t\tit.sauronsoftware.ftp4j.FTPIllegalReplyException, it.sauronsoftware.ftp4j.FTPException, " + NL + "\t\t\tit.sauronsoftware.ftp4j.FTPDataTransferException, it.sauronsoftware.ftp4j.FTPAbortedException, " + NL + "\t\t\tit.sauronsoftware.ftp4j.FTPListParseException {" + NL + "" + NL + "\t\t\tftpClient.changeDirectory(remoteDirectory);" + NL + "\t\t\tString path = ftpClient.currentDirectory();" + NL + "      \t\tit.sauronsoftware.ftp4j.FTPFile[] ftpFiles = null;" + NL + "\t\t\tftpFiles = ftpClient.list();" + NL + "" + NL + "\t\t\tfor (it.sauronsoftware.ftp4j.FTPFile ftpFile : ftpFiles) {" + NL + "" + NL + "\t\t\t\tif (ftpFile.getType() == it.sauronsoftware.ftp4j.FTPFile.TYPE_DIRECTORY) {" + NL + "" + NL + "\t\t\t\t\tif ((!(\".\").equals(ftpFile.getName())) && (!(\"..\").equals(ftpFile.getName()))) {" + NL + "\t\t\t\t\t\tjava.io.File localFile = new java.io.File(localDirectory + \"/\" + ftpFile.getName());" + NL + "" + NL + "\t\t\t            if (!localFile.exists()) {" + NL + "            \t\t\t\tlocalFile.mkdir();" + NL + "\t\t\t            }" + NL + "            \t\t\tgetAllFiles(path + \"/\" + ftpFile.getName(), localDirectory + \"/\" + ftpFile.getName());" + NL + "\t\t\t            ftpClient.changeDirectory(path);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} else if (ftpFile.getType() != it.sauronsoftware.ftp4j.FTPFile.TYPE_LINK) {" + NL + "\t\t\t\t\tdownloadFile(localDirectory + \"/\" + ftpFile.getName(),ftpFile.getName());" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "" + NL + "\t\tpublic void getFiles(String remoteDirectory, String localDirectory, String maskStr) " + NL + "\t\tthrows IllegalStateException, IOException, java.io.FileNotFoundException," + NL + "\t\t\tit.sauronsoftware.ftp4j.FTPIllegalReplyException, it.sauronsoftware.ftp4j.FTPException, " + NL + "\t\t\tit.sauronsoftware.ftp4j.FTPDataTransferException, it.sauronsoftware.ftp4j.FTPAbortedException, " + NL + "\t\t\tit.sauronsoftware.ftp4j.FTPListParseException {" + NL + "" + NL + "\t\t\tftpClient.changeDirectory(remoteDirectory);" + NL + "\t\t\tit.sauronsoftware.ftp4j.FTPFile[] ftpFiles = null;" + NL + "\t\t\tftpFiles = ftpClient.list(\".\");" + NL + "" + NL + "\t\t\tfor(it.sauronsoftware.ftp4j.FTPFile ftpFile : ftpFiles) {" + NL + "" + NL + "\t\t\t\tif ((ftpFile.getType() != it.sauronsoftware.ftp4j.FTPFile.TYPE_DIRECTORY) && (ftpFile.getType() != it.sauronsoftware.ftp4j.FTPFile.TYPE_LINK)) {" + NL + "\t\t\t\t\tString fileName = ftpFile.getName();" + NL + "" + NL + "\t\t\t\t\tif (fileName.matches(maskStr)) {" + NL + "\t\t\t\t\t\tdownloadFile(localDirectory + \"/\" + fileName,fileName);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "" + NL + "\t\tpublic void chdir(String path) " + NL + "\t\tthrows IllegalStateException, IOException, " + NL + "\t\t\tit.sauronsoftware.ftp4j.FTPIllegalReplyException, it.sauronsoftware.ftp4j.FTPException {" + NL + "\t\t\tftpClient.changeDirectory(path);" + NL + "\t\t}" + NL + "" + NL + "\t\tpublic String pwd() " + NL + "\t\tthrows IllegalStateException, IOException, " + NL + "\t\t\tit.sauronsoftware.ftp4j.FTPIllegalReplyException, it.sauronsoftware.ftp4j.FTPException {" + NL + "\t\t\treturn ftpClient.currentDirectory();" + NL + "\t\t}" + NL + "" + NL + "\t\tprivate void downloadFile(String localFileName, String remoteFileName) " + NL + "\t\tthrows IllegalStateException, java.io.FileNotFoundException, IOException, " + NL + "\t\t\tit.sauronsoftware.ftp4j.FTPIllegalReplyException, it.sauronsoftware.ftp4j.FTPException, " + NL + "\t\t\tit.sauronsoftware.ftp4j.FTPDataTransferException, it.sauronsoftware.ftp4j.FTPAbortedException {" + NL + "      " + NL + "\t\t\tjava.io.File localFile = new java.io.File(localFileName);" + NL + "\t\t\tftpClient.download(remoteFileName, localFile);" + NL + "\t\t\t";
  protected final String TEXT_306 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_307 = " - Downloaded file \" + (count +1) +  \" : '\" + remoteFileName + \"' successfully.\");" + NL + "\t\t\t";
  protected final String TEXT_308 = NL + "\t      count++;" + NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_309 = NL + NL + "\t\tclass MyTrust_";
  protected final String TEXT_310 = "{" + NL + "\t\t\tprivate javax.net.ssl.TrustManager[] getTrustManagers() " + NL + "\t\t\tthrows java.security.KeyStoreException, java.security.NoSuchAlgorithmException, " + NL + "\t\t\tjava.security.cert.CertificateException, java.security.UnrecoverableKeyException," + NL + "\t\t\tjava.io.FileNotFoundException, java.io.IOException {" + NL + "" + NL + "\t\t\t\tjava.security.KeyStore ks = java.security.KeyStore.getInstance(\"JKS\");" + NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_311 = " " + NL + "              \tString decryptedKeyStorePassword_";
  protected final String TEXT_312 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_313 = ");";
  protected final String TEXT_314 = NL + "              \tString decryptedKeyStorePassword_";
  protected final String TEXT_315 = " = ";
  protected final String TEXT_316 = "; ";
  protected final String TEXT_317 = NL + "            " + NL + "\t\t\t\tks.load(new java.io.FileInputStream(";
  protected final String TEXT_318 = "), decryptedKeyStorePassword_";
  protected final String TEXT_319 = ".toCharArray());" + NL + "\t\t\t\tjavax.net.ssl.TrustManagerFactory tmf = javax.net.ssl.TrustManagerFactory.getInstance(javax.net.ssl.KeyManagerFactory.getDefaultAlgorithm());" + NL + "\t\t\t\ttmf.init(ks);" + NL + "\t\t\t\treturn tmf.getTrustManagers();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tMyTrust_";
  protected final String TEXT_320 = " myTrust_";
  protected final String TEXT_321 = "= null;";
  protected final String TEXT_322 = NL + "\t\tjavax.net.ssl.SSLContext sslContext_";
  protected final String TEXT_323 = " = null;" + NL + "\t\tjavax.net.ssl.TrustManager[] trustManager_";
  protected final String TEXT_324 = " = null;" + NL + "\t\tjavax.net.ssl.SSLSocketFactory sslSocketFactory_";
  protected final String TEXT_325 = " = null;" + NL + "\t\tit.sauronsoftware.ftp4j.FTPClient ftp_";
  protected final String TEXT_326 = " =null;" + NL + "\t\tFTPSGetter_";
  protected final String TEXT_327 = " getter_";
  protected final String TEXT_328 = " = null;" + NL + "\t\tString remotedir_";
  protected final String TEXT_329 = " = null;" + NL + "\t\tString rootDir_";
  protected final String TEXT_330 = " = null;" + NL + "" + NL + "\t\ttry {";
  protected final String TEXT_331 = NL + "\t\t\t\tsslContext_";
  protected final String TEXT_332 = " = javax.net.ssl.SSLContext.getInstance(\"SSL\");" + NL + "\t\t\t\tmyTrust_";
  protected final String TEXT_333 = " = new MyTrust_";
  protected final String TEXT_334 = "();" + NL + "\t\t\t\ttrustManager_";
  protected final String TEXT_335 = " = myTrust_";
  protected final String TEXT_336 = ".getTrustManagers();" + NL + "\t\t\t\tsslContext_";
  protected final String TEXT_337 = ".init(null, trustManager_";
  protected final String TEXT_338 = ", new java.security.SecureRandom());" + NL + "\t\t\t\tsslSocketFactory_";
  protected final String TEXT_339 = " = sslContext_";
  protected final String TEXT_340 = ".getSocketFactory();" + NL + "\t\t\t\tftp_";
  protected final String TEXT_341 = " = new it.sauronsoftware.ftp4j.FTPClient();" + NL + "\t\t\t\tftp_";
  protected final String TEXT_342 = ".setSSLSocketFactory(sslSocketFactory_";
  protected final String TEXT_343 = ");";
  protected final String TEXT_344 = NL + "\t\t\t\t\tftp_";
  protected final String TEXT_345 = ".setSecurity(it.sauronsoftware.ftp4j.FTPClient.SECURITY_FTPS);";
  protected final String TEXT_346 = NL + "\t\t    \t\tftp_";
  protected final String TEXT_347 = ".setSecurity(it.sauronsoftware.ftp4j.FTPClient.SECURITY_FTPES);";
  protected final String TEXT_348 = NL + "\t\t\t\t";
  protected final String TEXT_349 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_350 = " - FTPS security Mode is (";
  protected final String TEXT_351 = ").\");" + NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_352 = " - Attempt to connect to '\" + ";
  protected final String TEXT_353 = " + \"' with username: '\" + ";
  protected final String TEXT_354 = "+ \"'.\");" + NL + "\t\t\t\t";
  protected final String TEXT_355 = NL + "\t\t\t\tftp_";
  protected final String TEXT_356 = ".connect(";
  protected final String TEXT_357 = ",";
  protected final String TEXT_358 = ");" + NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_359 = " " + NL + "            \t" + NL + "            \t";
  protected final String TEXT_360 = " " + NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_361 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_362 = ");";
  protected final String TEXT_363 = NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_364 = " = ";
  protected final String TEXT_365 = "; ";
  protected final String TEXT_366 = NL + "            \t" + NL + "\t\t\t\tftp_";
  protected final String TEXT_367 = ".login(";
  protected final String TEXT_368 = ", decryptedPassword_";
  protected final String TEXT_369 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_370 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_371 = " - Connect to '\" + ";
  protected final String TEXT_372 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_373 = NL + "\t\t\t\tftp_";
  protected final String TEXT_374 = " = (it.sauronsoftware.ftp4j.FTPClient)globalMap.get(\"";
  protected final String TEXT_375 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_376 = NL + "\t\t\t\t\trootDir_";
  protected final String TEXT_377 = " = ftp_";
  protected final String TEXT_378 = ".currentDirectory();" + NL + "\t\t\t\t";
  protected final String TEXT_379 = NL + "\t\t\t\t";
  protected final String TEXT_380 = NL + "\t\t\t\t\tif(ftp_";
  protected final String TEXT_381 = "!=null) {" + NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_382 = " - Use an existing connection.Connection username: \" + ftp_";
  protected final String TEXT_383 = ".getUsername() + \", Connection hostname: \" + ftp_";
  protected final String TEXT_384 = ".getHost() + \", Connection port: \" + ftp_";
  protected final String TEXT_385 = ".getPort() + \".\"); " + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_386 = NL + "\t\t\tgetter_";
  protected final String TEXT_387 = " = new FTPSGetter_";
  protected final String TEXT_388 = "();" + NL + "\t\t\tgetter_";
  protected final String TEXT_389 = ".ftpClient = ftp_";
  protected final String TEXT_390 = ";" + NL + "\t\t\tremotedir_";
  protected final String TEXT_391 = " = ";
  protected final String TEXT_392 = ";" + NL + "\t\t\tftp_";
  protected final String TEXT_393 = ".changeDirectory(remotedir_";
  protected final String TEXT_394 = ");" + NL + "\t\t} catch (java.lang.IllegalStateException e) {" + NL + "\t\t\t";
  protected final String TEXT_395 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_396 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_397 = NL + "\t\t    e.printStackTrace();" + NL + "\t\t} catch (java.io.IOException e) {" + NL + "\t\t\t";
  protected final String TEXT_398 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_399 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_400 = NL + "\t\t    e.printStackTrace();" + NL + "\t\t} catch (it.sauronsoftware.ftp4j.FTPIllegalReplyException e) {" + NL + "\t\t\t";
  protected final String TEXT_401 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_402 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_403 = NL + "\t\t    e.printStackTrace();" + NL + "\t\t} catch (it.sauronsoftware.ftp4j.FTPException e) {" + NL + "\t\t\t";
  protected final String TEXT_404 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_405 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_406 = NL + "\t\t    e.printStackTrace();" + NL + "  \t\t}";
  protected final String TEXT_407 = NL + "java.util.List<String> maskList_";
  protected final String TEXT_408 = " = new java.util.ArrayList<String>();" + NL;
  protected final String TEXT_409 = "    " + NL + "  maskList_";
  protected final String TEXT_410 = ".add(";
  protected final String TEXT_411 = ");       ";
  protected final String TEXT_412 = "  " + NL + "    ftp_";
  protected final String TEXT_413 = ".setType(com.enterprisedt.net.ftp.FTPTransferType.BINARY);";
  protected final String TEXT_414 = "  " + NL + "    ftp_";
  protected final String TEXT_415 = ".setType(com.enterprisedt.net.ftp.FTPTransferType.ASCII);";
  protected final String TEXT_416 = NL + "String localdir_";
  protected final String TEXT_417 = "  = ";
  protected final String TEXT_418 = ";  " + NL + "//create folder if local direcotry (assigned by property) not exists" + NL + "java.io.File dirHandle_";
  protected final String TEXT_419 = " = new java.io.File(localdir_";
  protected final String TEXT_420 = ");" + NL + "" + NL + "if (!dirHandle_";
  protected final String TEXT_421 = ".exists()) {" + NL + "  dirHandle_";
  protected final String TEXT_422 = ".mkdirs();" + NL + "}" + NL + "String root_";
  protected final String TEXT_423 = " = getter_";
  protected final String TEXT_424 = ".pwd();" + NL;
  protected final String TEXT_425 = NL + "\tlog.info(\"";
  protected final String TEXT_426 = " - Downloading files from the server.\");";
  protected final String TEXT_427 = NL + "for (String maskStr_";
  protected final String TEXT_428 = " : maskList_";
