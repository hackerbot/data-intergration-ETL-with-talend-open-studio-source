...
public class TFTPRenameBeginJava
{
  ...
  protected final String TEXT_159 = " - Renaming file from server.\");";
  ...
  protected final String TEXT_222 = ");" + NL + "\t\tlist";
  protected final String TEXT_223 = ".add(map";
  protected final String TEXT_224 = ");       " + NL + "\t";
  protected final String TEXT_225 = "  " + NL + "\tString remotedir";
  protected final String TEXT_226 = " = ";
  protected final String TEXT_227 = ";" + NL + "\tftp_";
  protected final String TEXT_228 = ".chdir(remotedir";
  protected final String TEXT_229 = ");" + NL + "" + NL + "\t";
  protected final String TEXT_230 = NL + "\t\tlog.info(\"";
  protected final String TEXT_231 = " - Renaming file from server.\");" + NL + "\t";
