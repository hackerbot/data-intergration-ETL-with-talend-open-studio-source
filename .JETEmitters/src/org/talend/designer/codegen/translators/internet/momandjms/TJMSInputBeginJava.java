...
public class TJMSInputBeginJava
{
  ...
  protected final String TEXT_41 = NL + NL + "\tjava.util.Hashtable props_";
  protected final String TEXT_42 = " = new java.util.Hashtable();" + NL + "\tprops_";
  protected final String TEXT_43 = ".put(javax.naming.Context.INITIAL_CONTEXT_FACTORY, ";
  protected final String TEXT_44 = ");" + NL + "\tprops_";
  ...
  protected final String TEXT_51 = NL + "\t" + NL + "\tjavax.naming.Context context_";
  protected final String TEXT_52 = " = new javax.naming.InitialContext(props_";
  protected final String TEXT_53 = ");" + NL + "\tjavax.jms.ConnectionFactory factory_";
  protected final String TEXT_54 = " = (javax.jms.ConnectionFactory) context_";
  protected final String TEXT_55 = ".lookup(";
  ...
  protected final String TEXT_64 = NL + NL + "\tjavax.jms.Connection connection_";
  protected final String TEXT_65 = " = factory_";
  protected final String TEXT_66 = ".createConnection(";
  protected final String TEXT_67 = ", decryptedPassword_";
  protected final String TEXT_68 = ");" + NL + "\tjavax.jms.Session session_";
  protected final String TEXT_69 = " = connection_";
  protected final String TEXT_70 = ".createSession(false, javax.jms.Session.CLIENT_ACKNOWLEDGE);" + NL + "\tjavax.jms.Destination dest_";
  protected final String TEXT_71 = " = session_";
  protected final String TEXT_72 = ".create";
  protected final String TEXT_73 = "(";
  protected final String TEXT_74 = ");" + NL + "\tjavax.jms.MessageConsumer consumer_";
  protected final String TEXT_75 = "\t= session_";
  protected final String TEXT_76 = ".createConsumer(dest_";
  protected final String TEXT_77 = ", ";
  protected final String TEXT_78 = ");" + NL + "" + NL + "\tconnection_";
  protected final String TEXT_79 = ".start();" + NL + "" + NL + "\tSystem.out.println(\"Ready to receive message\");" + NL + "\tSystem.out.println(\"Waiting...\");" + NL + "\t";
  protected final String TEXT_80 = NL + "\t";
  protected final String TEXT_81 = NL + NL + "\tjavax.jms.Message message_";
  protected final String TEXT_82 = ";" + NL + "" + NL + "\tint nbline_";
  protected final String TEXT_83 = " = 0;" + NL + "" + NL + "\twhile ((message_";
  ...
  protected final String TEXT_88 = ".message=message_";
  protected final String TEXT_89 = ";\t";
  protected final String TEXT_90 = NL + "\t\t";
  protected final String TEXT_91 = ".messageContent=ParserUtils.parseTo_Document(((javax.jms.ObjectMessage) message_";
  protected final String TEXT_92 = ").getObject().toString());";
  protected final String TEXT_93 = NL + "\t\t";
  protected final String TEXT_94 = ".messageContent=((javax.jms.TextMessage) message_";
  protected final String TEXT_95 = ").getText();";
