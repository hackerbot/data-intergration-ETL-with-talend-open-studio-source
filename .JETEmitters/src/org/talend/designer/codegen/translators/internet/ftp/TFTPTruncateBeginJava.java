...
public class TFTPTruncateBeginJava
{
  ...
  protected final String TEXT_158 = " - Truncating file from the server.\");";
  protected final String TEXT_159 = NL + "\tfor (java.util.Map<String, String> map";
  protected final String TEXT_160 = " : list";
  protected final String TEXT_161 = ") {" + NL;
  protected final String TEXT_162 = NL + "\tcom.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_163 = " = null;" + NL + "" + NL + "\t";
  protected final String TEXT_164 = NL + "\t\tftp_";
  protected final String TEXT_165 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_166 = "\");" + NL + "\t\t";
  protected final String TEXT_167 = NL + "\t\t\tif(ftp_";
  protected final String TEXT_168 = "!=null) {" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_169 = " - Use an existing connection. Connection hostname: \" + ftp_";
  protected final String TEXT_170 = ".getRemoteHost() + \", Connection port: \" + ftp_";
  protected final String TEXT_171 = ".getRemotePort() + \".\"); " + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_172 = NL + "\t\t";
  protected final String TEXT_173 = NL + "\t\t  String rootDir_";
  protected final String TEXT_174 = " = ftp_";
  protected final String TEXT_175 = ".pwd();" + NL + "\t\t";
  protected final String TEXT_176 = NL + "\t";
  protected final String TEXT_177 = "    " + NL + "\t    ftp_";
  protected final String TEXT_178 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "\t    ftp_";
  protected final String TEXT_179 = ".setRemoteHost(";
  protected final String TEXT_180 = ");" + NL + "\t    ftp_";
  protected final String TEXT_181 = ".setRemotePort(";
  protected final String TEXT_182 = ");" + NL + "" + NL + "\t    ";
  protected final String TEXT_183 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_184 = " - \" + ";
  protected final String TEXT_185 = ");" + NL + "\t\t";
  protected final String TEXT_186 = NL + "\t    ";
  protected final String TEXT_187 = NL + "\t      ftp_";
  protected final String TEXT_188 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);" + NL + "\t    ";
  protected final String TEXT_189 = NL + "\t      ftp_";
  protected final String TEXT_190 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);" + NL + "\t    ";
  protected final String TEXT_191 = NL + "    \tftp_";
  protected final String TEXT_192 = ".setControlEncoding(";
  protected final String TEXT_193 = ");" + NL + "\t\t";
  protected final String TEXT_194 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_195 = " - Attempt to connect to '\" + ";
  protected final String TEXT_196 = " + \"' with username '\" +";
  protected final String TEXT_197 = "+ \"'.\");" + NL + "\t\t";
  protected final String TEXT_198 = NL + "\t    ftp_";
  protected final String TEXT_199 = ".connect();" + NL + "\t    " + NL + "\t    ";
  ...
  protected final String TEXT_207 = NL + "\t\t\t" + NL + "\t    ftp_";
  protected final String TEXT_208 = ".login(";
  protected final String TEXT_209 = ", decryptedPassword_";
  protected final String TEXT_210 = ");" + NL + "\t\t";
  protected final String TEXT_211 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_212 = " - Connect to '\" + ";
  protected final String TEXT_213 = " + \"' has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_214 = "   " + NL + "  \t";
  protected final String TEXT_215 = " " + NL + "\tjava.util.List<java.util.Map<String,String>> list";
  protected final String TEXT_216 = " = new java.util.ArrayList<java.util.Map<String,String>>();" + NL + "" + NL + "\t";
  protected final String TEXT_217 = "    " + NL + "\t\tjava.util.Map<String,String> map";
  protected final String TEXT_218 = " = new java.util.HashMap<String,String>();" + NL + "\t\tmap";
  protected final String TEXT_219 = ".put(";
  protected final String TEXT_220 = ",\"\");" + NL + "\t\tlist";
  protected final String TEXT_221 = ".add(map";
  protected final String TEXT_222 = ");       " + NL + "\t";
  protected final String TEXT_223 = NL + "\tString remotedir";
  protected final String TEXT_224 = " = ";
  protected final String TEXT_225 = ";" + NL + "\tftp_";
  protected final String TEXT_226 = ".chdir(remotedir";
  protected final String TEXT_227 = ");" + NL + "\tString root";
  protected final String TEXT_228 = " = ftp_";
  protected final String TEXT_229 = ".pwd();" + NL + "" + NL + "\t";
  protected final String TEXT_230 = NL + "\t\tlog.info(\"";
  protected final String TEXT_231 = " - Truncating file from the server.\");" + NL + "\t";
  protected final String TEXT_232 = NL + "\tfor (java.util.Map<String, String> map";
