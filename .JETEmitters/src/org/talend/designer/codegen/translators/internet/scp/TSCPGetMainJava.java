...
public class TSCPGetMainJava
{
  ...
  protected final String TEXT_13 = " + \"\\\"\";" + NL + "\t\t\t\t\tsourceFile_";
  protected final String TEXT_14 = "=sourceFile_";
  protected final String TEXT_15 = ".replaceAll(\"\\\\\\\\\",\"/\"); " + NL + "\t\t\t\t\tint index_";
  ...
  protected final String TEXT_24 = ".length()-1);" + NL + "\t\t\t\t\t\tjava.io.File file_";
  ...
  protected final String TEXT_66 = "_STATUS\", \"No file transfered.\");" + NL + "\t\t\t}" + NL + "\t\t";
  ...
  protected final String TEXT_83 = ".toArray(new String[0]);" + NL + "\t\t";
  ...
  protected final String TEXT_90 = ".length() != 0) {" + NL + "\t\t\t\t\t\tsourceFile_";
  protected final String TEXT_91 = " = \"\\\"\" + sourceFile_";
  protected final String TEXT_92 = " + \"\\\"\";" + NL + "\t\t\t\t\t\tsourceFile_";
  protected final String TEXT_93 = "=sourceFile_";
  protected final String TEXT_94 = ".replaceAll(\"\\\\\\\\\",\"/\"); " + NL + "\t\t\t\t\t    int index_";
  ...
  protected final String TEXT_103 = ".length()-1);" + NL + "\t\t\t\t\t\t\tjava.io.File file_";
  ...
  protected final String TEXT_150 = "_STATUS\", \"No file transfered.\");" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t";
