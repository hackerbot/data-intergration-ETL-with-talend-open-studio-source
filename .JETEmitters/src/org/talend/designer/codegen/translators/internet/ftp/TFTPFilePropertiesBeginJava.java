...
public class TFTPFilePropertiesBeginJava
{
  ...
  protected final String TEXT_145 = ".getHome());" + NL + "  \t\t}" + NL + "  \t";
  protected final String TEXT_146 = " " + NL + "\tString remoteDir_";
  protected final String TEXT_147 = " = ";
  protected final String TEXT_148 = ".replaceAll(\"\\\\\\\\\", \"/\");" + NL + "\t";
  protected final String TEXT_149 = " = new ";
  protected final String TEXT_150 = "Struct();" + NL + "\tString remoteFile_";
  protected final String TEXT_151 = " = ";
  protected final String TEXT_152 = " + \"/\" + ";
  protected final String TEXT_153 = ";" + NL + "\tcom.jcraft.jsch.SftpATTRS lstat_";
  protected final String TEXT_154 = " = c_";
  protected final String TEXT_155 = ".lstat(remoteFile_";
  protected final String TEXT_156 = ");" + NL + "" + NL + "\tif (lstat_";
  protected final String TEXT_157 = " != null) {" + NL + "\t    ";
  protected final String TEXT_158 = ".abs_path = (remoteFile_";
  protected final String TEXT_159 = ").replaceAll(\"//\", \"/\");" + NL + "\t    ";
  protected final String TEXT_160 = ".dirname = ";
  protected final String TEXT_161 = ";" + NL + "\t    ";
  protected final String TEXT_162 = ".basename = ";
  protected final String TEXT_163 = ";" + NL + "\t    ";
  protected final String TEXT_164 = ".size = lstat_";
  protected final String TEXT_165 = ".getSize();" + NL + "\t    ";
  protected final String TEXT_166 = ".mtime = (long)lstat_";
  protected final String TEXT_167 = ".getMTime();" + NL + "\t    ";
  protected final String TEXT_168 = ".mtime_string = lstat_";
  protected final String TEXT_169 = ".getMtimeString();" + NL + "" + NL + "\t    ";
  protected final String TEXT_170 = NL + "\t      // Calculation of the Message Digest MD5" + NL + "\t      java.io.InputStream is_";
  protected final String TEXT_171 = " = c_";
  protected final String TEXT_172 = ".get(remoteFile_";
  protected final String TEXT_173 = ");" + NL + "\t      byte[] buffer_";
  protected final String TEXT_174 = " = new byte[8192];" + NL + "\t      int read_";
  protected final String TEXT_175 = " = 0;" + NL + "\t      java.security.MessageDigest dgs_";
  protected final String TEXT_176 = " = java.security.MessageDigest.getInstance(\"MD5\");" + NL + "\t" + NL + "\t      while ( (read_";
  protected final String TEXT_177 = " = is_";
  protected final String TEXT_178 = ".read(buffer_";
  protected final String TEXT_179 = ")) > 0) {" + NL + "\t        dgs_";
  protected final String TEXT_180 = ".update(buffer_";
  protected final String TEXT_181 = ", 0, read_";
  protected final String TEXT_182 = ");" + NL + "\t      }" + NL + "\t      ";
  protected final String TEXT_183 = ".md5 =String.format(\"%032x\", new java.math.BigInteger(1, dgs_";
  protected final String TEXT_184 = ".digest()));" + NL + "\t      ";
  protected final String TEXT_185 = NL + "\t\t\t\tlog4jSb_";
  protected final String TEXT_186 = ".append();" + NL + "\t\t\t\tlog.info(\"";
