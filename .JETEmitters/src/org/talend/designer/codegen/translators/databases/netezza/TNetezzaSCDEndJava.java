...
public class TNetezzaSCDEndJava {
  protected static String nl;
  public static synchronized TNetezzaSCDEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNetezzaSCDEndJava result = new TNetezzaSCDEndJava();
    nl = null;
    return result;
  }
