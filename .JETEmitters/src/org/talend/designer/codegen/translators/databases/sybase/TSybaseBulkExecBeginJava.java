...
public class TSybaseBulkExecBeginJava {
  ...
  protected final String TEXT_71 = "=0;" + NL + "String dbschema_";
  protected final String TEXT_72 = "= ";
  protected final String TEXT_73 = "; " + NL + "String tableName_";
  protected final String TEXT_74 = " = ";
  protected final String TEXT_75 = ";";
  protected final String TEXT_76 = NL + "        int keyCount_";
  protected final String TEXT_77 = " = ";
  protected final String TEXT_78 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_79 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }";
  protected final String TEXT_80 = NL + "    String host_";
  protected final String TEXT_81 = " = (String)globalMap.get(\"host_";
  protected final String TEXT_82 = "\");" + NL + "    String port_";
  protected final String TEXT_83 = " = (String)globalMap.get(\"port_";
  protected final String TEXT_84 = "\");" + NL + "    String db_";
  protected final String TEXT_85 = " = (String)globalMap.get(\"db_";
  protected final String TEXT_86 = "\");" + NL + "    String dbUser_";
  protected final String TEXT_87 = " = (String)globalMap.get(\"user_";
  protected final String TEXT_88 = "\");" + NL + "    String dbPwd_";
  protected final String TEXT_89 = " = (String)globalMap.get(\"pass_";
  protected final String TEXT_90 = "\");" + NL + "    dbschema_";
  protected final String TEXT_91 = "= (String)globalMap.get(\"";
  protected final String TEXT_92 = "\");\t\t" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_93 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_94 = "\");" + NL + "\t";
  protected final String TEXT_95 = NL + "    String db_";
  ...
  protected final String TEXT_109 = ";" + NL + "    String host_";
  protected final String TEXT_110 = " = ";
  protected final String TEXT_111 = ";";
  protected final String TEXT_112 = NL + "    \tString port_";
  protected final String TEXT_113 = " = ";
  protected final String TEXT_114 = ";";
  protected final String TEXT_115 = NL + "\t\t\tString url_";
  protected final String TEXT_116 = " = \"jdbc:sybase:Tds:\" + host_";
  protected final String TEXT_117 = " + \":\" + port_";
  protected final String TEXT_118 = " + \"/\" + db_";
  protected final String TEXT_119 = ";";
  protected final String TEXT_120 = NL + "\t\t\tString url_";
  protected final String TEXT_121 = " = \"jdbc:sybase:Tds:\" + host_";
  protected final String TEXT_122 = " + \":\" + port_";
  protected final String TEXT_123 = " + \"/\" + db_";
  protected final String TEXT_124 = " + \"?\" + ";
  protected final String TEXT_125 = ";";
  protected final String TEXT_126 = NL + "   \t \tString driverClass_";
  protected final String TEXT_127 = " = \"com.sybase.jdbc3.jdbc.SybDriver\";" + NL + "   \t \tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_128 = ");" + NL + "    \tjava.sql.Connection conn_";
  protected final String TEXT_129 = " = null;" + NL + "    \t" + NL + "\t\t";
  protected final String TEXT_130 = NL + "if(dbschema_";
  protected final String TEXT_131 = " != null && dbschema_";
  protected final String TEXT_132 = ".trim().length() != 0) {" + NL + "\ttableName_";
  ...
  protected final String TEXT_138 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_139 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_140 = " - Droping table ";
  ...
  protected final String TEXT_148 = " - Drop table ";
  protected final String TEXT_149 = "\" + tableName_";
  protected final String TEXT_150 = " + \"";
  protected final String TEXT_151 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_152 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_153 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_154 = " = conn_";
  protected final String TEXT_155 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_156 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_157 = " - Creating table ";
  protected final String TEXT_158 = "\" + tableName_";
  ...
  protected final String TEXT_165 = " - Create table ";
  protected final String TEXT_166 = "\" + tableName_";
  protected final String TEXT_167 = " + \"";
  protected final String TEXT_168 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_175 = " - Creating table ";
  protected final String TEXT_176 = "\" + tableName_";
  ...
  protected final String TEXT_183 = " - Create table ";
  protected final String TEXT_184 = "\" + tableName_";
  ...
  protected final String TEXT_192 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_193 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_194 = " = tableNameForSearch_";
  protected final String TEXT_195 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_196 = " = tableNameForSearch_";
  protected final String TEXT_197 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_198 = " = dbMetaData_";
  protected final String TEXT_199 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_200 = ", tableNameForSearch_";
  protected final String TEXT_201 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_202 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_203 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_204 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_205 = ".close();" + NL + "\t\t\t";
  ...
  protected final String TEXT_211 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_219 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_223 = ".close();" + NL + "\t\t\t";
  ...
  protected final String TEXT_232 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_236 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_237 = ".equals(schema_";
  protected final String TEXT_238 = ") || (schema_";
  protected final String TEXT_239 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_240 = ".equalsIgnoreCase(bkSchema_";
  protected final String TEXT_241 = ")))) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_242 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_243 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_244 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_248 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_249 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_250 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_251 = " == null || dbschema_";
  protected final String TEXT_252 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_253 = " = conn_";
  protected final String TEXT_254 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_255 = " = stmtSchema_";
  protected final String TEXT_256 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_257 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_258 = " = rsSchema_";
  protected final String TEXT_259 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_260 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_261 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_262 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_263 = " = rsTable_";
  protected final String TEXT_264 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_265 = " = rsTable_";
  protected final String TEXT_266 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_267 = ".equals";
  protected final String TEXT_268 = "IgnoreCase";
  protected final String TEXT_269 = "(";
  protected final String TEXT_270 = ") " + NL + "\t\t\t\t\t\t&& (schema_";
  ...
  protected final String TEXT_274 = ") || ((dbschema_";
  protected final String TEXT_275 = " ==null || dbschema_";
  protected final String TEXT_276 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_277 = ".equals";
  protected final String TEXT_278 = "IgnoreCase";
  protected final String TEXT_279 = "(schema_";
  ...
  protected final String TEXT_291 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_292 = ".equals";
  protected final String TEXT_293 = "IgnoreCase";
  ...
  protected final String TEXT_298 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_299 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_303 = " - Creating table ";
  protected final String TEXT_304 = "\" + tableName_";
  ...
  protected final String TEXT_311 = " - Create table ";
  protected final String TEXT_312 = "\" + tableName_";
  protected final String TEXT_313 = " + \"";
  protected final String TEXT_314 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_315 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_316 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_317 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_318 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_319 = " = conn_";
  protected final String TEXT_320 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_321 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_322 = " - Droping table ";
  ...
  protected final String TEXT_330 = " - Drop table ";
  protected final String TEXT_331 = "\" + tableName_";
  protected final String TEXT_332 = " + \"";
  protected final String TEXT_333 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_334 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_335 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_336 = " = conn_";
  protected final String TEXT_337 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_338 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_339 = " - Creating table ";
  ...
  protected final String TEXT_347 = " - Create table ";
  ...
  protected final String TEXT_353 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_357 = " - Clearing table ";
  protected final String TEXT_358 = "\" + tableName_";
  protected final String TEXT_359 = " + \"";
  protected final String TEXT_360 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_361 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_362 = ".executeUpdate(\"";
  protected final String TEXT_363 = "\");" + NL + "\t\t\t";
  protected final String TEXT_364 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_365 = "- Clear table ";
  protected final String TEXT_366 = "\" + tableName_";
  protected final String TEXT_367 = " + \"";
  protected final String TEXT_368 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_369 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_370 = ".close();" + NL + "\t\t";
  protected final String TEXT_371 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_372 = " = conn_";
  protected final String TEXT_373 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_374 = " = stmtTruncCount_";
  protected final String TEXT_375 = ".executeQuery(\"";
  protected final String TEXT_376 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_380 = " - Trancating table ";
  protected final String TEXT_381 = "\" + tableName_";
  protected final String TEXT_382 = " + \"";
  protected final String TEXT_383 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_384 = NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_385 = ".executeUpdate(\"";
  protected final String TEXT_386 = "\");" + NL + "   \t    \t";
  protected final String TEXT_387 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_388 = " - Truncate table ";
  protected final String TEXT_389 = "\" + tableName_";
  protected final String TEXT_390 = " + \"";
  protected final String TEXT_391 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_399 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_400 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_401 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_402 = NL + "\t";
  protected final String TEXT_403 = NL + NL + "StringBuilder command_";
  protected final String TEXT_404 = " =  new StringBuilder();" + NL + "command_";
  protected final String TEXT_405 = ".append(";
  protected final String TEXT_406 = " + \" \");";
  protected final String TEXT_407 = NL + "    String tmpTableName_";
  protected final String TEXT_408 = " = tableName_";
  protected final String TEXT_409 = ";" + NL + "    tableName_";
  protected final String TEXT_410 = " = \"tmp_";
  protected final String TEXT_411 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    if(dbschema_";
  protected final String TEXT_412 = " != null && dbschema_";
  protected final String TEXT_413 = ".trim().length() != 0) {" + NL + "    \ttableName_";
  protected final String TEXT_414 = "=dbschema_";
  protected final String TEXT_415 = " + \".\" + tableName_";
  protected final String TEXT_416 = ";" + NL + "    }";
  protected final String TEXT_417 = NL + "if(dbschema_";
  protected final String TEXT_418 = " != null && dbschema_";
  protected final String TEXT_419 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_420 = ".append(db_";
  protected final String TEXT_421 = " + \".\" + tableName_";
  protected final String TEXT_422 = ");" + NL + "} else {" + NL + "    command_";
  protected final String TEXT_423 = ".append(db_";
  protected final String TEXT_424 = " + \"..\" + tableName_";
  protected final String TEXT_425 = ");" + NL + "}" + NL + "command_";
  protected final String TEXT_426 = ".append(\" in \" + ";
  protected final String TEXT_427 = ");" + NL + "String headRow_";
  protected final String TEXT_428 = " = ";
  protected final String TEXT_429 = ";" + NL + "if(headRow_";
  protected final String TEXT_430 = " != null && headRow_";
  protected final String TEXT_431 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_432 = ".append(\" -F \" + headRow_";
  protected final String TEXT_433 = ");" + NL + "}" + NL;
  protected final String TEXT_434 = NL + "\tcommand_";
  protected final String TEXT_435 = ".append(\" -b \" + ";
  protected final String TEXT_436 = ");";
  protected final String TEXT_437 = NL + NL + "command_";
  protected final String TEXT_438 = ".append(\" -t \" + ";
  protected final String TEXT_439 = ");" + NL + "command_";
  protected final String TEXT_440 = ".append(\" -r \" + ";
  protected final String TEXT_441 = ");" + NL + "command_";
  protected final String TEXT_442 = ".append(\" -c -U \" + dbUser_";
  protected final String TEXT_443 = " + \" -P \" + dbPwd_";
  protected final String TEXT_444 = ");";
  protected final String TEXT_445 = NL + "command_";
  protected final String TEXT_446 = ".append(\" -I \" + ";
  protected final String TEXT_447 = ");";
  protected final String TEXT_448 = NL + "    command_";
  protected final String TEXT_449 = ".append(\" -S \" + ";
  protected final String TEXT_450 = ");";
  protected final String TEXT_451 = NL + "\tcommand_";
  protected final String TEXT_452 = ".append(\" -S \" + host_";
  protected final String TEXT_453 = ");";
  protected final String TEXT_454 = NL + "String encoding_";
  protected final String TEXT_455 = " = ";
  protected final String TEXT_456 = ";" + NL + "if(encoding_";
  protected final String TEXT_457 = " != null && encoding_";
  protected final String TEXT_458 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_459 = ".append(\" -J \" + encoding_";
  protected final String TEXT_460 = ");" + NL + "}" + NL;
  protected final String TEXT_461 = NL + "\tlog.info(\"";
  protected final String TEXT_462 = " - Executing command:'\" + command_";
  protected final String TEXT_463 = " + \"'.\");";
  protected final String TEXT_464 = NL + "    Runtime runtime_";
  protected final String TEXT_465 = " = Runtime.getRuntime();" + NL + "    final Process ps_";
  protected final String TEXT_466 = " = runtime_";
  protected final String TEXT_467 = ".exec(command_";
  protected final String TEXT_468 = ".toString());";
  protected final String TEXT_469 = NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_470 = " = conn_";
  protected final String TEXT_471 = ".createStatement();";
  protected final String TEXT_472 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_473 = " - Creating temp table ";
  protected final String TEXT_474 = "\" + tableName_";
  protected final String TEXT_475 = " + \"";
  protected final String TEXT_476 = ".\" );" + NL + "\t\t";
  protected final String TEXT_477 = NL + "        stmtCreateTmp_";
  protected final String TEXT_478 = ".execute(\"";
  protected final String TEXT_479 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_480 = ".close();            ";
  protected final String TEXT_481 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_482 = " - Create temp table ";
  protected final String TEXT_483 = "\" + tableName_";
  protected final String TEXT_484 = " + \"";
  protected final String TEXT_485 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_486 = NL + "        Runtime runtime_";
  protected final String TEXT_487 = " = Runtime.getRuntime();" + NL + "        final Process ps_";
  protected final String TEXT_488 = " = runtime_";
  protected final String TEXT_489 = ".exec(command_";
  protected final String TEXT_490 = ".toString());       ";
  protected final String TEXT_491 = NL + NL + "Thread normal_";
  protected final String TEXT_492 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_493 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_494 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_495 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_496 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_497 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_498 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_499 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "normal_";
  protected final String TEXT_500 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_501 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_502 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_503 = NL + "\t\t\t\t        System.err.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_504 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_505 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_506 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_507 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_508 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_509 = ".start();" + NL + "" + NL + "ps_";
  protected final String TEXT_510 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_511 = ".interrupt();" + NL + "error_";
  protected final String TEXT_512 = ".interrupt();";
  protected final String TEXT_513 = NL + "\tlog.info(\"";
  protected final String TEXT_514 = " - Excute command: '\" + command_";
  protected final String TEXT_515 = " + \"' has finished.\");";
...
if(("UPDATE").equals(dataAction)) {
    ...
    stringBuffer.append(interfacefilename);
