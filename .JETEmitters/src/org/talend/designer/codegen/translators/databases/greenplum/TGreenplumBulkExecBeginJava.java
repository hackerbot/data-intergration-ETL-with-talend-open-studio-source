...
public class TGreenplumBulkExecBeginJava {
  protected static String nl;
  public static synchronized TGreenplumBulkExecBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGreenplumBulkExecBeginJava result = new TGreenplumBulkExecBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_74 = " = (String)globalMap.get(\"schema_\" + \"";
  protected final String TEXT_75 = "\");";
  protected final String TEXT_76 = NL + "\tdbschema_";
  ...
  protected final String TEXT_84 = " = dbschema_";
  protected final String TEXT_85 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_86 = ";" + NL + "}";
  protected final String TEXT_87 = NL + "    String tmpTableName_";
  protected final String TEXT_88 = " = \"tmp_";
  protected final String TEXT_89 = "_\" + pid + Thread.currentThread().getId();";
  protected final String TEXT_90 = NL + "String bulkSQL_";
  protected final String TEXT_91 = " = \"COPY \\\"\" + ";
  protected final String TEXT_92 = "tmpTableName_";
  protected final String TEXT_93 = "tableName_";
  protected final String TEXT_94 = " ";
  protected final String TEXT_95 = " + \"\\\" ";
  protected final String TEXT_96 = "FROM '\" + ";
  protected final String TEXT_97 = " + \"' WITH \";";
  protected final String TEXT_98 = NL + "    bulkSQL_";
  protected final String TEXT_99 = " += \"BINARY ";
  protected final String TEXT_100 = "\";";
  protected final String TEXT_101 = NL + "    Character field_separator_";
  protected final String TEXT_102 = " = (";
  protected final String TEXT_103 = ").charAt(0);" + NL + "    bulkSQL_";
  protected final String TEXT_104 = " += \"";
  protected final String TEXT_105 = " \" + \"DELIMITER AS '\" + field_separator_";
  protected final String TEXT_106 = " + \"' \";" + NL + "    bulkSQL_";
  protected final String TEXT_107 = " += \"NULL AS '\" + ";
  protected final String TEXT_108 = " + \"' \";";
  protected final String TEXT_109 = NL + "        Character text_enclosure_";
  protected final String TEXT_110 = " = (";
  protected final String TEXT_111 = ").charAt(0);" + NL + "        bulkSQL_";
  protected final String TEXT_112 = " += \"CSV ";
  protected final String TEXT_113 = " QUOTE AS '\" + text_enclosure_";
  protected final String TEXT_114 = ".toString().replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "        bulkSQL_";
  protected final String TEXT_115 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_116 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "        bulkSQL_";
  protected final String TEXT_117 = " += \"";
  protected final String TEXT_118 = "\";";
  protected final String TEXT_119 = " " + NL + "java.sql.Connection conn_";
  protected final String TEXT_120 = " = null;";
  protected final String TEXT_121 = NL + "\tconn_";
  protected final String TEXT_122 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_123 = "\");";
  protected final String TEXT_124 = NL + "\tString driverClass_";
  protected final String TEXT_125 = " = \"org.postgresql.Driver\";" + NL + "\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_126 = ").newInstance();" + NL + "\tString url_";
  protected final String TEXT_127 = " = \"jdbc:postgresql://\" + ";
  ...
  protected final String TEXT_140 = NL + NL + "\tString dbPwd_";
  ...
  protected final String TEXT_148 = " - Droping table ";
  ...
  protected final String TEXT_156 = " - Drop table ";
  protected final String TEXT_157 = "\" + tableName_";
  protected final String TEXT_158 = " + \"";
  protected final String TEXT_159 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_160 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_161 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_162 = " = conn_";
  protected final String TEXT_163 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_164 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_165 = " - Creating table ";
  ...
  protected final String TEXT_173 = " - Create table ";
  ...
  protected final String TEXT_179 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_180 = " = conn_";
  protected final String TEXT_181 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_182 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_183 = " - Creating table ";
  ...
  protected final String TEXT_191 = " - Create table ";
  protected final String TEXT_192 = "\" + tableName_";
  protected final String TEXT_193 = " + \"";
  protected final String TEXT_194 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_205 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_209 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_210 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_211 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_212 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_218 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_219 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_225 = ".equalsIgnoreCase(";
  protected final String TEXT_226 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_227 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_228 = ") || dbschema_";
  protected final String TEXT_229 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_240 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_244 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_245 = ".equals(schema_";
  protected final String TEXT_246 = ") || (schema_";
  protected final String TEXT_247 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_248 = ".equalsIgnoreCase(bkSchema_";
  protected final String TEXT_249 = ")))) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_250 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_254 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_255 = " = dbMetaData_";
  protected final String TEXT_256 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_257 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_258 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_259 = " == null || dbschema_";
  protected final String TEXT_260 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_261 = " = conn_";
  protected final String TEXT_262 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_263 = " = stmtSchema_";
  protected final String TEXT_264 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_265 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_266 = " = rsSchema_";
  protected final String TEXT_267 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_268 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_269 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_270 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_271 = " = rsTable_";
  protected final String TEXT_272 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_273 = " = rsTable_";
  protected final String TEXT_274 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_275 = ".equals";
  protected final String TEXT_276 = "IgnoreCase";
  protected final String TEXT_277 = "(";
  protected final String TEXT_278 = ") " + NL + "\t\t\t\t\t\t&& (schema_";
  ...
  protected final String TEXT_284 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_285 = ".equals";
  protected final String TEXT_286 = "IgnoreCase";
  protected final String TEXT_287 = "(schema_";
  ...
  protected final String TEXT_293 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_294 = " = dbMetaData_";
  protected final String TEXT_295 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_296 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_297 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_298 = " = rsTable_";
  protected final String TEXT_299 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_300 = ".equals";
  protected final String TEXT_301 = "IgnoreCase";
  protected final String TEXT_302 = "(";
  protected final String TEXT_303 = ")) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_304 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_305 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_306 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_307 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_308 = " = conn_";
  protected final String TEXT_309 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_310 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_311 = " - Creating table ";
  ...
  protected final String TEXT_319 = " - Create table ";
  protected final String TEXT_320 = "\" + tableName_";
  protected final String TEXT_321 = " + \"";
  protected final String TEXT_322 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_323 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_324 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_330 = " - Droping table ";
  ...
  protected final String TEXT_338 = " - Drop table ";
  protected final String TEXT_339 = "\" + tableName_";
  protected final String TEXT_340 = " + \"";
  protected final String TEXT_341 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_342 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_343 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_361 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_365 = " - Clearing table ";
  ...
  protected final String TEXT_373 = "- Clear table ";
  protected final String TEXT_374 = "\" + tableName_";
  protected final String TEXT_375 = " + \"";
  protected final String TEXT_376 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_377 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_378 = ".close();" + NL + "\t\t";
  ...
  protected final String TEXT_388 = " - Trancating table ";
  ...
  protected final String TEXT_396 = " - Truncate table ";
  protected final String TEXT_397 = "\" + tableName_";
  ...
  protected final String TEXT_406 = ".close();" + NL + "\t\t";
  protected final String TEXT_407 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_408 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_409 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_410 = NL + "\t";
  protected final String TEXT_411 = NL + "\t        int keyCount_";
  protected final String TEXT_412 = " = ";
  protected final String TEXT_413 = ";" + NL + "\t        if(keyCount_";
  protected final String TEXT_414 = " == 0) {" + NL + "\t            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "\t        }" + NL + "\t        tmpTableName_";
  protected final String TEXT_415 = " = tableName_";
  protected final String TEXT_416 = ";" + NL + "\t        tableName_";
  protected final String TEXT_417 = " = \"tmp_";
  protected final String TEXT_418 = "_\" + pid + Thread.currentThread().getId();" + NL + "\t        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_419 = " = conn_";
  protected final String TEXT_420 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_421 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_422 = " - Creating temp table ";
  protected final String TEXT_423 = "\" + tableName_";
  protected final String TEXT_424 = " + \"";
  protected final String TEXT_425 = ".\" );" + NL + "\t\t\t";
  protected final String TEXT_426 = NL + "\t        stmtCreateTmp_";
  protected final String TEXT_427 = ".execute(\"";
  protected final String TEXT_428 = ")\");" + NL + "\t\t\t";
  protected final String TEXT_429 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_430 = " - Create temp table ";
  protected final String TEXT_431 = "\" + tableName_";
  protected final String TEXT_432 = " + \"";
  protected final String TEXT_433 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_434 = NL + "\t        stmtCreateTmp_";
  protected final String TEXT_435 = ".close();" + NL + "\t\t\t";
  ...
  protected final String TEXT_442 = NL + "\t        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_443 = " = conn_";
  protected final String TEXT_444 = ".createStatement();" + NL + "\t        stmtTmpBulk_";
  protected final String TEXT_445 = ".execute(bulkSQL_";
  protected final String TEXT_446 = ");" + NL + "\t        stmtTmpBulk_";
  protected final String TEXT_447 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_448 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_449 = " - Bulk insert data into ";
  protected final String TEXT_450 = "\" + tableName_";
  protected final String TEXT_451 = " + \"";
  protected final String TEXT_452 = " has finished.\");" + NL + "\t\t\t";
  protected final String TEXT_453 = NL + "\t        tableName_";
  protected final String TEXT_454 = " = tmpTableName_";
  protected final String TEXT_455 = ";" + NL + "\t        tmpTableName_";
  protected final String TEXT_456 = " = \"tmp_";
  protected final String TEXT_457 = "_\" + pid + Thread.currentThread().getId();" + NL + "\t        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_458 = " = conn_";
  protected final String TEXT_459 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_460 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_461 = " - Updating ";
  protected final String TEXT_462 = "\" + tableName_";
  protected final String TEXT_463 = " + \"";
  protected final String TEXT_464 = " from ";
  protected final String TEXT_465 = "\"+tmpTableName_";
  protected final String TEXT_466 = "+\"";
  protected final String TEXT_467 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_468 = NL + "\t        stmtUpdateBulk_";
  protected final String TEXT_469 = ".executeUpdate(\"";
  protected final String TEXT_470 = "\");" + NL + "\t\t\t";
  protected final String TEXT_471 = NL + "\t        stmtUpdateBulk_";
  protected final String TEXT_472 = ".close();" + NL + "\t        tableName_";
  protected final String TEXT_473 = " = tmpTableName_";
  protected final String TEXT_474 = ";" + NL + "\t        java.sql.Statement stmtTmpDrop_";
  ...
  protected final String TEXT_478 = " - Droping temp table ";
  protected final String TEXT_479 = "\" + tableName_";
  protected final String TEXT_480 = " + \"";
  protected final String TEXT_481 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_482 = NL + "\t        stmtTmpDrop_";
  protected final String TEXT_483 = ".execute(\"";
  protected final String TEXT_484 = "\");" + NL + "\t\t\t";
  protected final String TEXT_485 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_486 = " - Drop temp table ";
  protected final String TEXT_487 = "\" + tableName_";
  protected final String TEXT_488 = "+ \"";
  protected final String TEXT_489 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_490 = NL + "\t        stmtTmpDrop_";
  protected final String TEXT_491 = ".close();" + NL + "\t        ";
  protected final String TEXT_492 = NL + "\t    \tlog.debug(\"";
  protected final String TEXT_493 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_494 = "+\".\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_495 = " - Bulk inserting data into ";
  protected final String TEXT_496 = "\" + tableName_";
  protected final String TEXT_497 = " + \"";
  protected final String TEXT_498 = ".\" );" + NL + "\t\t";
  protected final String TEXT_499 = NL + "\t    java.sql.Statement stmtBulk_";
  protected final String TEXT_500 = " = conn_";
  protected final String TEXT_501 = ".createStatement();" + NL + "\t    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "\t    stmtBulk_";
  protected final String TEXT_502 = ".execute(bulkSQL_";
  protected final String TEXT_503 = ");" + NL + "\t    stmtBulk_";
  protected final String TEXT_504 = ".close();" + NL + "\t\t";
  protected final String TEXT_505 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_506 = " - Bulk insert data into ";
  protected final String TEXT_507 = "\" + tableName_";
