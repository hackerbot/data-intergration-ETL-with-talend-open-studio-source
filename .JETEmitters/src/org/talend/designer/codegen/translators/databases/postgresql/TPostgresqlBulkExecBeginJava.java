...
public class TPostgresqlBulkExecBeginJava {
  ...
  protected final String TEXT_70 = NL + "int deletedCount_";
  protected final String TEXT_71 = "=0;" + NL + "String tableName_";
  protected final String TEXT_72 = " = null;" + NL + "String dbschema_";
  protected final String TEXT_73 = " = null;";
  protected final String TEXT_74 = NL + "\tdbschema_";
  protected final String TEXT_75 = " = (String)globalMap.get(\"schema_\" + \"";
  protected final String TEXT_76 = "\");" + NL + "\t";
  protected final String TEXT_77 = NL + "\tdbschema_";
  ...
  protected final String TEXT_85 = " = dbschema_";
  protected final String TEXT_86 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_87 = ";" + NL + "}";
  protected final String TEXT_88 = NL + "     String tmpTableName_";
  protected final String TEXT_89 = " = \"tmp_";
  protected final String TEXT_90 = "_\" + pid + Thread.currentThread().getId(); //tableName not end. will add pid + Thread.currentThread().getId() when create a temp table for update.";
  protected final String TEXT_91 = NL + "String bulkSQL_";
  protected final String TEXT_92 = " = \"COPY \\\"\" + ";
  protected final String TEXT_93 = "tmpTableName_";
  protected final String TEXT_94 = "tableName_";
  protected final String TEXT_95 = " ";
  protected final String TEXT_96 = NL + "+ \"\\\"";
  protected final String TEXT_97 = "FROM '\" + ";
  protected final String TEXT_98 = " + \"' WITH \";";
  protected final String TEXT_99 = NL + "    bulkSQL_";
  protected final String TEXT_100 = " += \"BINARY ";
  protected final String TEXT_101 = "\";";
  protected final String TEXT_102 = NL + "    Character field_separator_";
  protected final String TEXT_103 = " = (";
  protected final String TEXT_104 = ").charAt(0);" + NL + "    bulkSQL_";
  protected final String TEXT_105 = " += \"";
  protected final String TEXT_106 = " \" + \"DELIMITER AS '\" + field_separator_";
  protected final String TEXT_107 = " + \"' \";" + NL + "\t";
  protected final String TEXT_108 = NL + "\t\tbulkSQL_";
  protected final String TEXT_109 = " += \"NULL AS '\" + ";
  protected final String TEXT_110 = " + \"' \";" + NL + "\t";
  protected final String TEXT_111 = NL + "\t\tbulkSQL_";
  protected final String TEXT_112 = " += \"NULL AS '\" + ";
  protected final String TEXT_113 = ".replaceAll(\"\\\\\\\\\",\"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "\t";
  protected final String TEXT_114 = NL + "        Character text_enclosure_";
  protected final String TEXT_115 = " = (";
  protected final String TEXT_116 = ").charAt(0);";
  protected final String TEXT_117 = NL + "            \tbulkSQL_";
  protected final String TEXT_118 = " += \"CSV ";
  protected final String TEXT_119 = " QUOTE AS '\" + ";
  protected final String TEXT_120 = "+ \"' \";" + NL + "\t\t";
  protected final String TEXT_121 = NL + "\t\t        bulkSQL_";
  protected final String TEXT_122 = " += \"CSV ";
  protected final String TEXT_123 = " QUOTE AS \" + (\"'\".equals(text_enclosure_";
  protected final String TEXT_124 = ".toString())?\"E\":\"\") + \"'\" +(\"'\".equals(text_enclosure_";
  protected final String TEXT_125 = ")?\"\\\\\":\"\") + text_enclosure_";
  protected final String TEXT_126 = " + \"' \";" + NL + "\t\t";
  protected final String TEXT_127 = NL + "\t\t\t\tbulkSQL_";
  protected final String TEXT_128 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_129 = " + \"' \";" + NL + "\t\t";
  protected final String TEXT_130 = NL + "\t        \tbulkSQL_";
  protected final String TEXT_131 = " += \"ESCAPE AS \" + (\"'\".equals(";
  protected final String TEXT_132 = ")?\"E\":\"\")  + \"'\" +(\"'\".equals(";
  protected final String TEXT_133 = ")?\"\\\\\":\"\") + ";
  protected final String TEXT_134 = " + \"' \"; ";
  protected final String TEXT_135 = NL + NL + "       \t\t\tbulkSQL_";
  protected final String TEXT_136 = " += \"CSV ";
  protected final String TEXT_137 = " QUOTE AS '\" +  ";
  protected final String TEXT_138 = ".replace(\"\\\\\", \"\\\\\\\\\") + \"' \";" + NL + "\t\t";
  protected final String TEXT_139 = NL + "\t\t        bulkSQL_";
  protected final String TEXT_140 = " += \"CSV ";
  protected final String TEXT_141 = " QUOTE AS '\" + (\"'\".equals(text_enclosure_";
  protected final String TEXT_142 = ".toString())?\"\\\\\":\"\") + text_enclosure_";
  protected final String TEXT_143 = ".toString().replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "\t\t";
  protected final String TEXT_144 = NL + "\t\t        bulkSQL_";
  protected final String TEXT_145 = " += \"ESCAPE AS '\"+ ";
  protected final String TEXT_146 = ".replace(\"\\\\\", \"\\\\\\\\\") + \"' \";" + NL + "\t\t";
  protected final String TEXT_147 = NL + "\t\t        bulkSQL_";
  protected final String TEXT_148 = " += \"ESCAPE AS '\"+ (\"'\".equals(";
  protected final String TEXT_149 = ")?\"\\\\\":\"\") + ";
  protected final String TEXT_150 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "\t\t";
  protected final String TEXT_151 = "        " + NL + "        bulkSQL_";
  protected final String TEXT_152 = " += \"";
  protected final String TEXT_153 = "\";";
  protected final String TEXT_154 = " " + NL + "java.sql.Connection conn_";
  protected final String TEXT_155 = " = null;" + NL + "\t";
  protected final String TEXT_156 = NL + "\t \tconn_";
  protected final String TEXT_157 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_158 = "\");" + NL + "\t ";
  protected final String TEXT_159 = NL + "\t \tString driverClass_";
  protected final String TEXT_160 = " = \"org.postgresql.Driver\";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_161 = ").newInstance();" + NL + "\t\tString url_";
  protected final String TEXT_162 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_163 = " + \":\" + ";
  protected final String TEXT_164 = " + \"/\" + ";
  protected final String TEXT_165 = ";" + NL + "\t\tString dbUser_";
  ...
  protected final String TEXT_184 = " - Droping table ";
  protected final String TEXT_185 = "\" + tableName_";
  protected final String TEXT_186 = " + \"";
  protected final String TEXT_187 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_188 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_189 = ".execute(\"";
  protected final String TEXT_190 = "\");" + NL + "\t\t\t";
  protected final String TEXT_191 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_192 = " - Drop table ";
  protected final String TEXT_193 = "\" + tableName_";
  protected final String TEXT_194 = " + \"";
  protected final String TEXT_195 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_196 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_197 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_198 = " = conn_";
  protected final String TEXT_199 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_200 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_201 = " - Creating table ";
  protected final String TEXT_202 = "\" + tableName_";
  ...
  protected final String TEXT_209 = " - Create table ";
  protected final String TEXT_210 = "\" + tableName_";
  protected final String TEXT_211 = " + \"";
  protected final String TEXT_212 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_219 = " - Creating table ";
  ...
  protected final String TEXT_227 = " - Create table ";
  protected final String TEXT_228 = "\" + tableName_";
  protected final String TEXT_229 = " + \"";
  protected final String TEXT_230 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_261 = ".equalsIgnoreCase(";
  protected final String TEXT_262 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_263 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_264 = ") || dbschema_";
  protected final String TEXT_265 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_266 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_267 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_268 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_269 = " = conn_";
  protected final String TEXT_270 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_271 = " = dbMetaData_";
  protected final String TEXT_272 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  ...
  protected final String TEXT_276 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_280 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_281 = ".equals(schema_";
  protected final String TEXT_282 = ") || (schema_";
  protected final String TEXT_283 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_284 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_293 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_294 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_295 = " == null || dbschema_";
  protected final String TEXT_296 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_297 = " = conn_";
  protected final String TEXT_298 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_299 = " = stmtSchema_";
  protected final String TEXT_300 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_301 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_302 = " = rsSchema_";
  protected final String TEXT_303 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_304 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_305 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_306 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_307 = " = rsTable_";
  protected final String TEXT_308 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_309 = " = rsTable_";
  protected final String TEXT_310 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_311 = ".equals";
  protected final String TEXT_312 = "IgnoreCase";
  protected final String TEXT_313 = "(";
  protected final String TEXT_314 = ") " + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_315 = ".equals";
  protected final String TEXT_316 = "IgnoreCase";
  protected final String TEXT_317 = "(dbschema_";
  protected final String TEXT_318 = ") || ((dbschema_";
  protected final String TEXT_319 = " ==null || dbschema_";
  protected final String TEXT_320 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_321 = ".equals";
  protected final String TEXT_322 = "IgnoreCase";
  protected final String TEXT_323 = "(schema_";
  protected final String TEXT_324 = ")))) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_325 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_326 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_327 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_328 = " = conn_";
  protected final String TEXT_329 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_330 = " = dbMetaData_";
  protected final String TEXT_331 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_332 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_333 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_334 = " = rsTable_";
  protected final String TEXT_335 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_336 = ".equals";
  protected final String TEXT_337 = "IgnoreCase";
  protected final String TEXT_338 = "(";
  protected final String TEXT_339 = ")) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_340 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_341 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_342 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_343 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_347 = " - Creating table ";
  protected final String TEXT_348 = "\" + tableName_";
  ...
  protected final String TEXT_355 = " - Create table ";
  protected final String TEXT_356 = "\" + tableName_";
  protected final String TEXT_357 = " + \"";
  protected final String TEXT_358 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_359 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_360 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_361 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_362 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_383 = " - Creating table ";
  protected final String TEXT_384 = "\" + tableName_";
  protected final String TEXT_385 = " + \"";
  protected final String TEXT_386 = ".\" );" + NL + "\t\t\t\t";
  protected final String TEXT_387 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_388 = ".execute(\"";
  protected final String TEXT_389 = ")\");" + NL + "\t\t\t\t";
  protected final String TEXT_390 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_391 = " - Create table ";
  protected final String TEXT_392 = "\" + tableName_";
  protected final String TEXT_393 = " + \"";
  protected final String TEXT_394 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_395 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_396 = ".close();" + NL + "\t\t\t";
  ...
  protected final String TEXT_401 = " - Clearing table ";
  ...
  protected final String TEXT_409 = "- Clear table ";
  protected final String TEXT_410 = "\" + tableName_";
  protected final String TEXT_411 = " + \"";
  protected final String TEXT_412 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_413 = NL + "\t\t\tstmtClear_";
  ...
  protected final String TEXT_424 = " - Trancating table ";
  protected final String TEXT_425 = "\" + tableName_";
  ...
  protected final String TEXT_432 = " - Truncate table ";
  protected final String TEXT_433 = "\" + tableName_";
  protected final String TEXT_434 = " + \"";
  protected final String TEXT_435 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_436 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_437 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_438 = " += rsTruncCount_";
  protected final String TEXT_439 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_440 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_441 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_442 = ".close();" + NL + "\t\t";
  protected final String TEXT_443 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_444 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_445 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_446 = NL + "\t";
  protected final String TEXT_447 = NL + "        int keyCount_";
  protected final String TEXT_448 = " = ";
  protected final String TEXT_449 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_450 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        " + NL + "        tmpTableName_";
  protected final String TEXT_451 = " = tableName_";
  protected final String TEXT_452 = ";" + NL + "        tableName_";
  protected final String TEXT_453 = " = \"tmp_";
  protected final String TEXT_454 = "\" + \"_\" + pid + Thread.currentThread().getId() ;        " + NL + "        java.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_458 = " - Creating temp table ";
  protected final String TEXT_459 = "\" + tableName_";
  protected final String TEXT_460 = " + \"";
  protected final String TEXT_461 = ".\" );" + NL + "\t\t";
  protected final String TEXT_462 = NL + NL + "        stmtCreateTmp_";
  protected final String TEXT_463 = ".execute(\"";
  protected final String TEXT_464 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_465 = ".close();";
  protected final String TEXT_466 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_467 = " - Create temp table ";
  protected final String TEXT_468 = "\" + tableName_";
  protected final String TEXT_469 = " + \"";
  protected final String TEXT_470 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_471 = NL + "        ";
  protected final String TEXT_472 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_473 = " =conn_";
  protected final String TEXT_474 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_475 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_476 = ".close();" + NL + "   \t\t";
  protected final String TEXT_477 = "        " + NL + "        " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_478 = " = conn_";
  protected final String TEXT_479 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_480 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_481 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_482 = "+\".\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_483 = " - Bulk inserting data into ";
  protected final String TEXT_484 = "\" + tableName_";
  protected final String TEXT_485 = " + \"";
  protected final String TEXT_486 = ".\" );" + NL + "\t\t";
  protected final String TEXT_487 = NL + "        stmtTmpBulk_";
  protected final String TEXT_488 = ".execute(bulkSQL_";
  protected final String TEXT_489 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_490 = ".close();" + NL + "        " + NL + "\t\t";
  protected final String TEXT_491 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_492 = " - Bulk insert data into ";
  protected final String TEXT_493 = "\" + tableName_";
  protected final String TEXT_494 = " + \"";
  protected final String TEXT_495 = " has finished.\");" + NL + "\t\t";
  protected final String TEXT_496 = NL + "        tableName_";
  protected final String TEXT_497 = " = tmpTableName_";
  protected final String TEXT_498 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_499 = " = \"tmp_";
  protected final String TEXT_500 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        " + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_501 = " = conn_";
  protected final String TEXT_502 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_503 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_504 = " - Updating ";
  protected final String TEXT_505 = "\" + tableName_";
  protected final String TEXT_506 = " + \"";
  protected final String TEXT_507 = " from ";
  protected final String TEXT_508 = "\"+tmpTableName_";
  protected final String TEXT_509 = "+\"";
  protected final String TEXT_510 = ".\");" + NL + "\t\t";
  protected final String TEXT_511 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_512 = ".executeUpdate(\"";
  protected final String TEXT_513 = "\");" + NL + "\t\t";
  protected final String TEXT_514 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_515 = ".close();" + NL + "        tableName_";
  protected final String TEXT_516 = " = tmpTableName_";
  protected final String TEXT_517 = ";" + NL + "        " + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_518 = " = conn_";
  protected final String TEXT_519 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_520 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_521 = " - Droping temp table ";
  protected final String TEXT_522 = "\" + tableName_";
  protected final String TEXT_523 = " + \"";
  protected final String TEXT_524 = ".\");" + NL + "\t\t";
  protected final String TEXT_525 = NL + "        stmtTmpDrop_";
  protected final String TEXT_526 = ".execute(\"";
  protected final String TEXT_527 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_528 = ".close();" + NL + "\t\t";
  protected final String TEXT_529 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_530 = " - Drop temp table ";
  protected final String TEXT_531 = "\" + tableName_";
  protected final String TEXT_532 = "+ \"";
  protected final String TEXT_533 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_534 = NL + "   \tjava.sql.CallableStatement cs_";
  protected final String TEXT_535 = " =conn_";
  protected final String TEXT_536 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \tcs_";
  protected final String TEXT_537 = ".execute();" + NL + "   \tcs_";
  protected final String TEXT_538 = ".close();";
  protected final String TEXT_539 = NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_540 = " = conn_";
  protected final String TEXT_541 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "\t";
  protected final String TEXT_542 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_543 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_544 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_545 = " - Inserting records in table ";
  protected final String TEXT_546 = "\" + tableName_";
  protected final String TEXT_547 = " + \"";
  protected final String TEXT_548 = ".\");" + NL + "\t";
  protected final String TEXT_549 = NL + "    stmtBulk_";
  protected final String TEXT_550 = ".execute(bulkSQL_";
  protected final String TEXT_551 = ");" + NL + "    stmtBulk_";
  protected final String TEXT_552 = ".close();    " + NL + "\t";
  protected final String TEXT_553 = NL + "\t\tlog.info(\"";
  protected final String TEXT_554 = " - Insert records in table ";
  protected final String TEXT_555 = "\" + tableName_";
  protected final String TEXT_556 = " + \"";
  protected final String TEXT_557 = " has finished.\");" + NL + "\t";
...
if(notNullCols != null && notNullCols.size() > 0) {
    ...
    stringBuffer.append(copyColumns.toString());
...
if(("BINARYFILE").equals(fileType)) {
    ...
    stringBuffer.append(notNullColumns.toString().substring(0, notNullColumns.toString().length() - 1));
