...
public class TSasOutputBeginJava {
  protected static String nl;
  public static synchronized TSasOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSasOutputBeginJava result = new TSasOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_43 = NL + "        int updateKeyCount_";
  protected final String TEXT_44 = " = ";
  protected final String TEXT_45 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_46 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_47 = NL + "        int deleteKeyCount_";
  protected final String TEXT_48 = " = ";
  protected final String TEXT_49 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_50 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_51 = NL + NL + "int nb_line_";
  protected final String TEXT_52 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_53 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_54 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_55 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_56 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_57 = " = 0;" + NL + "int updatedCount_";
  protected final String TEXT_58 = " = 0;" + NL + "int insertedCount_";
  protected final String TEXT_59 = " = 0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_60 = " = false;" + NL;
  protected final String TEXT_61 = NL + "\tjava.sql.Connection connection_";
  protected final String TEXT_62 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_63 = "\");" + NL + "\t";
  protected final String TEXT_64 = NL + "\t";
  protected final String TEXT_65 = NL + "    java.lang.Class.forName(";
  protected final String TEXT_66 = ");";
  protected final String TEXT_67 = NL + "    String connectionString_";
  protected final String TEXT_68 = " = ";
  protected final String TEXT_69 = ";" + NL + "    String dbUser_";
  ...
  protected final String TEXT_81 = ";" + NL + "\tjava.util.Properties property_";
  protected final String TEXT_82 = " = new java.util.Properties();" + NL + "\t" + NL + "\t";
  protected final String TEXT_83 = NL + "\t\tString librefs_";
  protected final String TEXT_84 = " = ";
  protected final String TEXT_85 = ";" + NL + "\t\tproperty_";
  protected final String TEXT_86 = ".setProperty(\"librefs\", librefs_";
  protected final String TEXT_87 = ");" + NL + "\t";
  protected final String TEXT_88 = NL + "\tproperty_";
  protected final String TEXT_89 = ".setProperty(\"username\", dbUser_";
  protected final String TEXT_90 = ");" + NL + "\tproperty_";
  protected final String TEXT_91 = ".setProperty(\"password\", dbPwd_";
  protected final String TEXT_92 = ");" + NL + "\t";
  protected final String TEXT_93 = NL + "\t\t\tproperty_";
  protected final String TEXT_94 = ".setProperty(String.valueOf(";
  protected final String TEXT_95 = "), String.valueOf(";
  protected final String TEXT_96 = "));" + NL + "\t\t";
  protected final String TEXT_97 = "\t" + NL + "    java.sql.Connection connection_";
  protected final String TEXT_98 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_99 = ", property_";
  protected final String TEXT_100 = ");" + NL + "\t";
  protected final String TEXT_101 = "    " + NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_102 = "\", connection_";
  protected final String TEXT_103 = ");";
  protected final String TEXT_104 = NL + "//        connection_";
  protected final String TEXT_105 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_106 = " = ";
  protected final String TEXT_107 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_108 = " = 0;         ";
  protected final String TEXT_109 = NL + "\tjava.sql.Statement statementClear_";
  protected final String TEXT_110 = " = connection_";
  protected final String TEXT_111 = ".createStatement();" + NL + "\tdeletedCount_";
  protected final String TEXT_112 = " = deletedCount_";
  protected final String TEXT_113 = " + statementClear_";
  protected final String TEXT_114 = ".executeUpdate(\"delete from \" + ";
  protected final String TEXT_115 = ");" + NL + "\t";
  protected final String TEXT_116 = NL + "\t\tString insert_";
  protected final String TEXT_117 = " = \"INSERT INTO \" + ";
  protected final String TEXT_118 = " + \" (";
  protected final String TEXT_119 = ") VALUES (";
  protected final String TEXT_120 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_121 = " = connection_";
  protected final String TEXT_122 = ".prepareStatement(insert_";
  protected final String TEXT_123 = ");" + NL + "\t\t";
  protected final String TEXT_124 = NL + "\t\tString update_";
  protected final String TEXT_125 = " = \"UPDATE \" + ";
  protected final String TEXT_126 = " + \" SET ";
  protected final String TEXT_127 = " WHERE ";
  protected final String TEXT_128 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_129 = " = connection_";
  protected final String TEXT_130 = ".prepareStatement(update_";
  protected final String TEXT_131 = ");" + NL + "\t\t";
  protected final String TEXT_132 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_133 = " = connection_";
  protected final String TEXT_134 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_135 = " + \" WHERE ";
  protected final String TEXT_136 = "\");" + NL + "\t\tString insert_";
  protected final String TEXT_137 = " = \"INSERT INTO \" + ";
  protected final String TEXT_138 = " + \" (";
  protected final String TEXT_139 = ") VALUES (";
  protected final String TEXT_140 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_141 = " = connection_";
  protected final String TEXT_142 = ".prepareStatement(insert_";
  protected final String TEXT_143 = ");" + NL + "\t\tString update_";
  protected final String TEXT_144 = " = \"UPDATE \" + ";
  protected final String TEXT_145 = " + \" SET ";
  protected final String TEXT_146 = " WHERE ";
  protected final String TEXT_147 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_148 = " = connection_";
  protected final String TEXT_149 = ".prepareStatement(update_";
  protected final String TEXT_150 = ");" + NL + "\t\t";
  protected final String TEXT_151 = NL + "\t\tString update_";
  protected final String TEXT_152 = " = \"UPDATE \" + ";
  protected final String TEXT_153 = " + \" SET ";
  protected final String TEXT_154 = " WHERE ";
  protected final String TEXT_155 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_156 = " = connection_";
  protected final String TEXT_157 = ".prepareStatement(update_";
  protected final String TEXT_158 = ");" + NL + "\t\tString insert_";
  protected final String TEXT_159 = " = \"INSERT INTO \" + ";
  protected final String TEXT_160 = " + \" (";
  protected final String TEXT_161 = ") VALUES (";
  protected final String TEXT_162 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_163 = " = connection_";
  protected final String TEXT_164 = ".prepareStatement(insert_";
  protected final String TEXT_165 = ");" + NL + "\t\t";
  protected final String TEXT_166 = NL + "\t\tString delete_";
  protected final String TEXT_167 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_168 = " + \" WHERE ";
  protected final String TEXT_169 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_170 = " = connection_";
  protected final String TEXT_171 = ".prepareStatement(delete_";
  protected final String TEXT_172 = ");" + NL + "\t\t";
  protected final String TEXT_173 = NL + "        StringBuffer query_";
  protected final String TEXT_174 = " = null;" + NL + "       \t";
  protected final String TEXT_175 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_176 = " = insert_";
  protected final String TEXT_177 = ".split(\"\\\\?\");";
  protected final String TEXT_178 = NL + "\t\t\tupdate_";
  protected final String TEXT_179 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_180 = " = update_";
  protected final String TEXT_181 = ".split(\"\\\\?\");";
  protected final String TEXT_182 = NL + "\t\t\tupdate_";
  protected final String TEXT_183 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_184 = " = update_";
  protected final String TEXT_185 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_186 = " = insert_";
  protected final String TEXT_187 = ".split(\"\\\\?\");";
  protected final String TEXT_188 = NL + "\t\t\tdelete_";
  protected final String TEXT_189 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_190 = " = delete_";
  protected final String TEXT_191 = ".split(\"\\\\?\");";
  protected final String TEXT_192 = NL + "\t\t\treplace_";
  protected final String TEXT_193 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_194 = " = replace_";
  protected final String TEXT_195 = ".split(\"\\\\?\");";
  protected final String TEXT_196 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_197 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_198 = " = insertIgnore_";
  protected final String TEXT_199 = ".split(\"\\\\?\");";
  protected final String TEXT_200 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_201 = " = insert_";
  protected final String TEXT_202 = ".split(\"\\\\?\");";
