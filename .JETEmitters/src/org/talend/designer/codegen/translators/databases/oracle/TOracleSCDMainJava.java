...
public class TOracleSCDMainJava {
  ...
  protected final String TEXT_35 = NL + "                      \tif(((oracle.jdbc.OracleResultSet) searchingResult_";
  protected final String TEXT_36 = ").getTIMESTAMPTZ(";
  protected final String TEXT_37 = ") != null){" + NL + "                      \t\tlookUpValue_";
  protected final String TEXT_38 = ".";
  protected final String TEXT_39 = " = org.talend.oracle.OracleTSTZUtil.toTalendTSTZ(((oracle.jdbc.OracleResultSet) searchingResult_";
  protected final String TEXT_40 = ").getTIMESTAMPTZ(";
  protected final String TEXT_41 = ").toBytes());" + NL + "\t\t                }else{" + NL + "\t\t                \tlookUpValue_";
  protected final String TEXT_42 = ".";
  protected final String TEXT_43 = " = null;" + NL + "\t\t                }" + NL + "\t                ";
  protected final String TEXT_44 = NL + "\t                    timestamp_";
  protected final String TEXT_45 = " = searchingResult_";
  protected final String TEXT_46 = ".getTimestamp(";
  protected final String TEXT_47 = ");" + NL + "\t                    if(timestamp_";
  protected final String TEXT_48 = " != null) {" + NL + "\t                        lookUpValue_";
  protected final String TEXT_49 = ".";
  protected final String TEXT_50 = " = new java.util.Date(timestamp_";
  protected final String TEXT_51 = ".getTime());" + NL + "\t                    } else {" + NL + "\t                        lookUpValue_";
  protected final String TEXT_52 = ".";
  protected final String TEXT_53 = " = null;" + NL + "\t                    }";
  protected final String TEXT_54 = NL + "                    if(searchingResult_";
  protected final String TEXT_55 = ".getObject(";
  protected final String TEXT_56 = ") != null) {" + NL + "                        lookUpValue_";
  protected final String TEXT_57 = ".";
  protected final String TEXT_58 = " = searchingResult_";
  protected final String TEXT_59 = ".get";
  protected final String TEXT_60 = "(";
  protected final String TEXT_61 = ");" + NL + "                    }";
  protected final String TEXT_62 = NL + "        }" + NL + "        searchingResult_";
  protected final String TEXT_63 = ".close();";
  protected final String TEXT_64 = NL + "\ttry {" + NL + "        lookUpKey_";
  protected final String TEXT_65 = " = new SCDSK_";
  protected final String TEXT_66 = "();";
  protected final String TEXT_67 = NL + "            lookUpKey_";
  protected final String TEXT_68 = ".";
  protected final String TEXT_69 = " = ";
  protected final String TEXT_70 = ".";
  protected final String TEXT_71 = ";";
  protected final String TEXT_72 = NL + "        lookUpKey_";
  protected final String TEXT_73 = ".hashCodeDirty = true;" + NL + "        lookUpValue_";
  protected final String TEXT_74 = " = cache_";
  protected final String TEXT_75 = ".get(lookUpKey_";
  protected final String TEXT_76 = ");";
  protected final String TEXT_77 = "    " + NL + "    if(lookUpValue_";
  protected final String TEXT_78 = " == null) {";
  protected final String TEXT_79 = NL + "            lookUpValue_";
  protected final String TEXT_80 = " = new SCDStruct_";
  ...
  protected final String TEXT_88 = " skRoutine_";
  protected final String TEXT_89 = " = ";
  protected final String TEXT_90 = ";";
  protected final String TEXT_91 = NL + "                    ";
  protected final String TEXT_92 = "                    ";
  protected final String TEXT_93 = NL + "                    ";
  protected final String TEXT_94 = NL + "                    nextSurrogateKey_";
  protected final String TEXT_95 = "++;";
  protected final String TEXT_96 = NL + "                    ";
  protected final String TEXT_97 = NL + "                ";
  protected final String TEXT_98 = " version_";
  protected final String TEXT_99 = " = 1;";
  protected final String TEXT_100 = NL + "                ";
  protected final String TEXT_101 = NL + "                    ";
  protected final String TEXT_102 = NL + "        nb_line_inserted_";
  protected final String TEXT_103 = " += insertionStatement_";
  protected final String TEXT_104 = ".executeUpdate();";
  protected final String TEXT_105 = NL + "            System.out.println(\"[";
  protected final String TEXT_106 = "] new source id inserted\");";
  protected final String TEXT_107 = NL + "    } else {";
  protected final String TEXT_108 = NL + "            if(";
  protected final String TEXT_109 = ") {";
  protected final String TEXT_110 = NL + "                    ";
  protected final String TEXT_111 = NL + "                    ";
  protected final String TEXT_112 = NL + "                nb_line_update_";
  protected final String TEXT_113 = " += updateForType1_";
  protected final String TEXT_114 = ".executeUpdate();";
  protected final String TEXT_115 = NL + "                    System.out.println(\"[";
  protected final String TEXT_116 = "] l1 update done\");";
  protected final String TEXT_117 = NL + "            }";
  protected final String TEXT_118 = NL + "            if(";
  protected final String TEXT_119 = ") {";
  protected final String TEXT_120 = NL + "                    ";
  protected final String TEXT_121 = NL + "                    ";
  protected final String TEXT_122 = NL + "                nb_line_update_";
  protected final String TEXT_123 = " += updateForType2_";
  protected final String TEXT_124 = ".executeUpdate();";
  protected final String TEXT_125 = NL + "                            ";
  protected final String TEXT_126 = NL + "                            ";
  protected final String TEXT_127 = " skRoutine_";
  protected final String TEXT_128 = " = ";
  protected final String TEXT_129 = ";";
  protected final String TEXT_130 = NL + "                            ";
  protected final String TEXT_131 = "                    ";
  protected final String TEXT_132 = NL + "                            ";
  protected final String TEXT_133 = NL + "                            nextSurrogateKey_";
  protected final String TEXT_134 = "++;";
  protected final String TEXT_135 = NL + "                            ";
  protected final String TEXT_136 = NL + "                        ";
  protected final String TEXT_137 = " maxVersion_";
  protected final String TEXT_138 = " = lookUpValue_";
  protected final String TEXT_139 = ".";
  protected final String TEXT_140 = " + 1;";
  protected final String TEXT_141 = NL + "                            lookUpValue_";
  protected final String TEXT_142 = ".";
  protected final String TEXT_143 = " = lookUpValue_";
  protected final String TEXT_144 = ".";
  protected final String TEXT_145 = " + 1;                            ";
  protected final String TEXT_146 = NL + "                        ";
  protected final String TEXT_147 = NL + "                            ";
  protected final String TEXT_148 = NL + "                nb_line_inserted_";
  protected final String TEXT_149 = " += insertionStatement_";
  protected final String TEXT_150 = ".executeUpdate();";
  protected final String TEXT_151 = NL + "                    System.out.println(\"[";
  protected final String TEXT_152 = "] new history line\");";
  ...
  protected final String TEXT_165 = NL + "                nb_line_update_";
  protected final String TEXT_166 = " += updateForType3_";
  protected final String TEXT_167 = ".executeUpdate();";
  protected final String TEXT_168 = NL + "                    System.out.println(\"[";
  protected final String TEXT_169 = "] l3 update done\");";
  protected final String TEXT_170 = NL + "            }";
  protected final String TEXT_171 = NL + "    }" + NL + "\t} catch (java.lang.Exception e) {//catch" + NL + "  \t\t";
  protected final String TEXT_172 = NL + "            throw(e);";
  ...
  protected final String TEXT_184 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_185 = NL + "                ";
  protected final String TEXT_186 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_187 = ";";
  protected final String TEXT_188 = NL + "                System.err.print(e.getMessage());";
  protected final String TEXT_189 = NL + "\t}//end catch" + NL + "    ";
  protected final String TEXT_190 = NL + "                lookUpValue_";
  protected final String TEXT_191 = ".";
  protected final String TEXT_192 = " = ";
  protected final String TEXT_193 = ".";
  protected final String TEXT_194 = ";";
  protected final String TEXT_195 = NL + "                lookUpValue_";
  protected final String TEXT_196 = ".";
  protected final String TEXT_197 = " = ";
  protected final String TEXT_198 = ".";
  protected final String TEXT_199 = ";";
  protected final String TEXT_200 = NL + "                lookUpValue_";
  protected final String TEXT_201 = ".";
  protected final String TEXT_202 = " = ";
  protected final String TEXT_203 = ".";
  protected final String TEXT_204 = ";";
  protected final String TEXT_205 = NL + "        cache_";
  protected final String TEXT_206 = ".put(lookUpKey_";
...
if(inputSchema != null && inputSchema.size() > 0 && outputSchema != null && outputSchema.size() > 0) {
    ...
    stringBuffer.append(scdManager.genSetStatement("searchingStmt_" + cid, inConnectionName + "." + sourceKey.getLabelName(), paramIndex, sourceKey.getJavaType(),isSourceKeyIncNull, sourceKey.getDbType()));
    ...
    stringBuffer.append(scdManager.genSetStatement("insertionStatement_" + cid, inConnectionName + "." + scdConfiger.getSurrogateKeyInputField(), paramIndex, insertionColumn.getJavaType(), insertionColumn.getDbType()));
    ...
    stringBuffer.append(scdManager.genSetStatement("insertionStatement_" + cid, "skRoutine_" + cid, paramIndex, insertionColumn.getJavaType(), insertionColumn.getDbType()));
    
                } else if(("TABLE_MAX").equals(scdConfiger.getSurrogateKeyValueType())) {
                    
    stringBuffer.append(TEXT_92);
    stringBuffer.append(TEXT_93);
    stringBuffer.append(scdManager.genSetStatement("insertionStatement_" + cid, "nextSurrogateKey_" + cid, paramIndex, insertionColumn.getJavaType(), insertionColumn.getDbType()));
    ...
    stringBuffer.append(scdManager.genSetStatement("insertionStatement_" + cid, inConnectionName + "." + scdConfiger.getDimensionType2Configer().getStartDateValue(), paramIndex, insertionColumn.getJavaType(), insertionColumn.getDbType()));
    ...
    stringBuffer.append(scdManager.genSetStatement("insertionStatement_" + cid, inConnectionName + "." + insertionColumn.getLabelName(), paramIndex, insertionColumn.getJavaType(), insertionColumn.getDbType()));
    ...
    stringBuffer.append(scdManager.genSetStatement("updateForType1_" + cid, inConnectionName + "." + dimensionAttrbite.getLabelName(), index, dimensionAttrbite.getJavaType(), dimensionAttrbite.getDbType()));
    ...
    stringBuffer.append(scdManager.genSetStatement("updateForType1_" + cid, inConnectionName + "." + sourceKey.getLabelName(), index, sourceKey.getJavaType(),isSourceKeyIncNull , sourceKey.getDbType()));
    ...
    stringBuffer.append(scdManager.genSetStatement("updateForType2_" + cid, inConnectionName + "." + sourceKey.getLabelName(), index, sourceKey.getJavaType(),isSourceKeyIncNull, sourceKey.getDbType()));
    ...
    stringBuffer.append(scdManager.genSetStatement("updateForType3_" + cid, inConnectionName + "." + dimensionAttrbite.getCurrentColumn().getLabelName(), index, dimensionAttrbite.getCurrentColumn().getJavaType(), dimensionAttrbite.getCurrentColumn().getDbType()));
    ...
    stringBuffer.append(scdManager.genSetStatement("updateForType3_" + cid,  "lookUpValue_" + cid + "." + dimensionAttrbite.getCurrentColumn().getColumnName(), index, dimensionAttrbite.getPrevColumn().getJavaType(), dimensionAttrbite.getPrevColumn().getDbType()));
    stringBuffer.append(TEXT_160);
    stringBuffer.append(scdManager.genSetStatement("updateForType3_" + cid,  "lookUpValue_" + cid + "." + dimensionAttrbite.getPrevColumn().getColumnName(), index, dimensionAttrbite.getPrevColumn().getJavaType(), dimensionAttrbite.getPrevColumn().getDbType()));
    ...
    stringBuffer.append(scdManager.genSetStatement("updateForType3_" + cid,  inConnectionName + "." + sourceKey.getLabelName(), index, sourceKey.getJavaType(),isSourceKeyIncNull, sourceKey.getDbType()));
