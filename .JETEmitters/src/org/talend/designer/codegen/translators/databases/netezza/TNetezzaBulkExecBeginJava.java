...
public class TNetezzaBulkExecBeginJava {
  protected static String nl;
  public static synchronized TNetezzaBulkExecBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNetezzaBulkExecBeginJava result = new TNetezzaBulkExecBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_70 = NL + "\tString bulkSQL_";
  protected final String TEXT_71 = "=\"\";";
  protected final String TEXT_72 = NL + "\tCharacter OUT_DELIM_";
  protected final String TEXT_73 = " = (";
  protected final String TEXT_74 = ").charAt(0); " + NL + "\tbulkSQL_";
  protected final String TEXT_75 = " += \"INSERT INTO \" + ";
  protected final String TEXT_76 = " + \" \"  " + NL + "            + \" SELECT * FROM EXTERNAL '\"+ ";
  protected final String TEXT_77 = " + \"'\"" + NL + "            + \" USING (DELIM '\"+OUT_DELIM_";
  protected final String TEXT_78 = "+\"' REMOTESOURCE 'JDBC' \"" + NL + "\t\t\t+ \" DATESTYLE '\"+";
  protected final String TEXT_79 = "+\"' DATEDELIM '\"+";
  protected final String TEXT_80 = "+\"' \"" + NL + "\t\t\t+ \" TIMESTYLE '";
  protected final String TEXT_81 = "' TIMEDELIM '\"+";
  protected final String TEXT_82 = "+\"' \"" + NL + "\t\t\t";
  protected final String TEXT_83 = NL + "\t\t\t+ \" ESCAPECHAR '\"+";
  protected final String TEXT_84 = "+\"' \"" + NL + "\t\t\t";
  protected final String TEXT_85 = NL + "\t\t\t+ \"\tMAXERRORS ";
  protected final String TEXT_86 = " SKIPROWS ";
  protected final String TEXT_87 = " LOGDIR '' ";
  ...
  protected final String TEXT_94 = ").newInstance();" + NL + "\t\tString url_";
  protected final String TEXT_95 = " = \"jdbc:netezza://\" + ";
  ...
  protected final String TEXT_110 = ";" + NL + "\t\tjava.sql.Connection conn_";
  protected final String TEXT_111 = " = null;";
  protected final String TEXT_112 = NL + "\t";
  protected final String TEXT_113 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_114 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_115 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_116 = " - Bulk inserting data into \" + ";
  protected final String TEXT_117 = " + \".\" );" + NL + "\t";
  protected final String TEXT_118 = NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_119 = " = conn_";
  protected final String TEXT_120 = ".createStatement();" + NL + "    stmtBulk_";
  protected final String TEXT_121 = ".execute(bulkSQL_";
  protected final String TEXT_122 = ");" + NL + "    stmtBulk_";
  protected final String TEXT_123 = ".close();";
  protected final String TEXT_124 = NL + "\t\tlog.info(\"";
  protected final String TEXT_125 = " - Bulk insert data into \" + ";
  protected final String TEXT_126 = " + \" has finished.\");" + NL + "\t";
...
String skiprows = ElementParameterParser.getValue(node, "__SKIPROWS__");
    ...
    stringBuffer.append( dateDelim );
    stringBuffer.append(TEXT_80);
    stringBuffer.append( timeFormat );
    stringBuffer.append(TEXT_81);
    stringBuffer.append( timeDelim );
    ...
    stringBuffer.append(skiprows);
    stringBuffer.append(TEXT_87);
    stringBuffer.append(setEncoding? "encoding '" + encoding +"'":"");
