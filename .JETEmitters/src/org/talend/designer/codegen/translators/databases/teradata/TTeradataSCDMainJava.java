...
public class TTeradataSCDMainJava {
  protected static String nl;
  public static synchronized TTeradataSCDMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataSCDMainJava result = new TTeradataSCDMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_3 = " = null; // reinitialize the reject connection for branch system (option HAS_CONDITIONAL_OUTPUTS)" + NL;
  protected final String TEXT_4 = NL + NL + "\ttry {" + NL + "        lookUpValue_";
  protected final String TEXT_5 = " = null;" + NL;
  protected final String TEXT_6 = NL + "            ";
  protected final String TEXT_7 = NL;
  protected final String TEXT_8 = NL + NL + "        searchingResult_";
  protected final String TEXT_9 = " = searchingStmt_";
  protected final String TEXT_10 = ".executeQuery();" + NL + "        while(searchingResult_";
  protected final String TEXT_11 = ".next()) {" + NL + "            lookUpValue_";
  protected final String TEXT_12 = " = new SCDStruct_";
  protected final String TEXT_13 = "();" + NL;
  protected final String TEXT_14 = NL + NL + "                    tmpValue_";
  protected final String TEXT_15 = " = searchingResult_";
  protected final String TEXT_16 = ".getString(";
  protected final String TEXT_17 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_18 = " != null && tmpValue_";
  protected final String TEXT_19 = ".length() > 0) {" + NL + "                        lookUpValue_";
  protected final String TEXT_20 = ".";
  protected final String TEXT_21 = " = tmpValue_";
  protected final String TEXT_22 = ".charAt(0);" + NL + "                    } else {" + NL;
  protected final String TEXT_23 = NL + NL + "                            if(tmpValue_";
  protected final String TEXT_24 = " == null) {" + NL + "                                lookUpValue_";
  protected final String TEXT_25 = ".";
  protected final String TEXT_26 = " = null;" + NL + "                            } else {" + NL + "                                lookUpValue_";
  protected final String TEXT_27 = ".";
  protected final String TEXT_28 = " = '\\0';" + NL + "                            }" + NL;
  protected final String TEXT_29 = NL + NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_30 = ")) {" + NL + "                                lookUpValue_";
  protected final String TEXT_31 = ".";
  protected final String TEXT_32 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_33 = "' in '";
  protected final String TEXT_34 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }" + NL;
  protected final String TEXT_35 = NL + "                    }" + NL;
  protected final String TEXT_36 = NL + NL + "                    dateStr_";
  protected final String TEXT_37 = " = searchingResult_";
  protected final String TEXT_38 = ".getString(";
  protected final String TEXT_39 = ");" + NL + "                    if(dateStr_";
  protected final String TEXT_40 = " != null) {" + NL + "                        if(!(\"0000-00-00\").equals(dateStr_";
  protected final String TEXT_41 = ") && !(\"0000-00-00 00:00:00\").equals(dateStr_";
  protected final String TEXT_42 = ")) {" + NL + "                            lookUpValue_";
  protected final String TEXT_43 = ".";
  protected final String TEXT_44 = " = new java.util.Date(searchingResult_";
  protected final String TEXT_45 = ".getTimestamp(";
  protected final String TEXT_46 = ").getTime());" + NL + "                        } else {" + NL + "                            lookUpValue_";
  protected final String TEXT_47 = ".";
  protected final String TEXT_48 = " = (java.util.Date) dateYear0_";
  protected final String TEXT_49 = ".clone();" + NL + "                        }" + NL + "                    } else {" + NL + "                        lookUpValue_";
  protected final String TEXT_50 = ".";
  protected final String TEXT_51 = " = null;" + NL + "                    }" + NL;
  protected final String TEXT_52 = NL + NL + "                    if(searchingResult_";
  protected final String TEXT_53 = ".getObject(";
  protected final String TEXT_54 = ") != null) {" + NL + "                        lookUpValue_";
  protected final String TEXT_55 = ".";
  protected final String TEXT_56 = " = searchingResult_";
  protected final String TEXT_57 = ".get";
  protected final String TEXT_58 = "(";
  protected final String TEXT_59 = ");" + NL + "                    }";
  protected final String TEXT_60 = NL + "        }" + NL + "        " + NL + "        searchingResult_";
  protected final String TEXT_61 = ".close();" + NL;
  protected final String TEXT_62 = NL + NL + "\ttry {" + NL + "        lookUpKey_";
  protected final String TEXT_63 = " = new SCDSK_";
  protected final String TEXT_64 = "();";
  protected final String TEXT_65 = NL + NL + "            lookUpKey_";
  protected final String TEXT_66 = ".";
  protected final String TEXT_67 = " = ";
  protected final String TEXT_68 = ".";
  protected final String TEXT_69 = ";" + NL;
  protected final String TEXT_70 = NL + NL + "        lookUpKey_";
  protected final String TEXT_71 = ".hashCodeDirty = true;" + NL + "        lookUpValue_";
  protected final String TEXT_72 = " = cache_";
  protected final String TEXT_73 = ".get(lookUpKey_";
  protected final String TEXT_74 = ");" + NL;
  protected final String TEXT_75 = " " + NL + "   " + NL + "    if(lookUpValue_";
  protected final String TEXT_76 = " == null) {" + NL;
  protected final String TEXT_77 = NL + NL + "            lookUpValue_";
  protected final String TEXT_78 = " = new SCDStruct_";
  protected final String TEXT_79 = "();" + NL;
  protected final String TEXT_80 = NL + NL + "                lookUpValue_";
  protected final String TEXT_81 = ".";
  protected final String TEXT_82 = " = 1;" + NL;
  ...
  protected final String TEXT_95 = NL + "                    nextSurrogateKey_";
  ...
  protected final String TEXT_102 = " version_";
  protected final String TEXT_103 = " = 1;";
  protected final String TEXT_104 = NL + "                ";
  protected final String TEXT_105 = NL;
  protected final String TEXT_106 = NL + "                    ";
  protected final String TEXT_107 = NL;
  protected final String TEXT_108 = NL + NL + "        nb_line_inserted_";
  protected final String TEXT_109 = " += insertionStatement_";
  protected final String TEXT_110 = ".executeUpdate();" + NL;
  protected final String TEXT_111 = NL + NL + "            System.out.println(\"[";
  protected final String TEXT_112 = "] new source id inserted\");" + NL;
  protected final String TEXT_113 = NL + NL + "    } else {" + NL;
  protected final String TEXT_114 = NL + NL + "            if(";
  ...
  protected final String TEXT_122 = NL + NL + "                nb_line_update_";
  protected final String TEXT_123 = " += updateForType1_";
  protected final String TEXT_124 = ".executeUpdate();" + NL;
  protected final String TEXT_125 = NL + NL + "                    System.out.println(\"[";
  protected final String TEXT_126 = "] l1 update done\");" + NL;
  protected final String TEXT_127 = NL + NL + "            }" + NL;
  protected final String TEXT_128 = NL + NL + "            if(";
  ...
  protected final String TEXT_136 = NL + NL + "                nb_line_update_";
  protected final String TEXT_137 = " += updateForType2_";
  protected final String TEXT_138 = ".executeUpdate();" + NL;
  protected final String TEXT_139 = NL;
  protected final String TEXT_140 = NL + "                            ";
  protected final String TEXT_141 = NL;
  protected final String TEXT_142 = NL;
  protected final String TEXT_143 = NL + "                            ";
  protected final String TEXT_144 = " skRoutine_";
  ...
  protected final String TEXT_151 = NL + "                            nextSurrogateKey_";
  protected final String TEXT_152 = "++;" + NL;
  protected final String TEXT_153 = NL + "                            ";
  protected final String TEXT_154 = NL;
  protected final String TEXT_155 = NL;
  protected final String TEXT_156 = NL + "                        ";
  protected final String TEXT_157 = " maxVersion_";
  protected final String TEXT_158 = " = lookUpValue_";
  protected final String TEXT_159 = ".";
  protected final String TEXT_160 = " + 1;" + NL;
  protected final String TEXT_161 = NL + NL + "                            lookUpValue_";
  protected final String TEXT_162 = ".";
  protected final String TEXT_163 = " = lookUpValue_";
  protected final String TEXT_164 = ".";
  protected final String TEXT_165 = " + 1;                            " + NL;
  protected final String TEXT_166 = NL;
  protected final String TEXT_167 = NL + "                        ";
  protected final String TEXT_168 = NL;
  protected final String TEXT_169 = NL + "                            ";
  protected final String TEXT_170 = NL;
  protected final String TEXT_171 = NL + NL + "                nb_line_inserted_";
  protected final String TEXT_172 = " += insertionStatement_";
  protected final String TEXT_173 = ".executeUpdate();";
  protected final String TEXT_174 = NL + NL + "                    System.out.println(\"[";
  protected final String TEXT_175 = "] new history line\");";
  protected final String TEXT_176 = NL + NL + "            }" + NL;
  protected final String TEXT_177 = NL + NL + "            if(";
  protected final String TEXT_178 = ") {" + NL;
  protected final String TEXT_179 = NL;
  protected final String TEXT_180 = NL + "                    ";
  protected final String TEXT_181 = NL;
  protected final String TEXT_182 = NL + NL;
  protected final String TEXT_183 = NL + NL + "                    if (";
  ...
  protected final String TEXT_193 = NL + NL + "                nb_line_update_";
  protected final String TEXT_194 = " += updateForType3_";
  protected final String TEXT_195 = ".executeUpdate();" + NL;
  protected final String TEXT_196 = NL + NL + "                    System.out.println(\"[";
  protected final String TEXT_197 = "] l3 update done\");" + NL;
  protected final String TEXT_198 = NL + NL + "            }" + NL;
  protected final String TEXT_199 = NL + NL + "    }" + NL + "    " + NL + "\t} catch (java.lang.Exception e) {//catch";
  protected final String TEXT_200 = NL + NL + "            throw(e);" + NL;
  ...
  protected final String TEXT_217 = NL + NL + "                System.err.print(e.getMessage());";
  protected final String TEXT_218 = NL + NL + "\t}//end catch" + NL;
  protected final String TEXT_219 = NL + NL + "                lookUpValue_";
  protected final String TEXT_220 = ".";
  protected final String TEXT_221 = " = ";
  protected final String TEXT_222 = ".";
  protected final String TEXT_223 = ";";
  protected final String TEXT_224 = NL + NL + "                lookUpValue_";
  protected final String TEXT_225 = ".";
  protected final String TEXT_226 = " = ";
  protected final String TEXT_227 = ".";
  protected final String TEXT_228 = ";" + NL;
  protected final String TEXT_229 = NL + NL + "                lookUpValue_";
  protected final String TEXT_230 = ".";
  protected final String TEXT_231 = " = ";
  protected final String TEXT_232 = ".";
  protected final String TEXT_233 = ";";
  protected final String TEXT_234 = NL + "        cache_";
  protected final String TEXT_235 = ".put(lookUpKey_";
  protected final String TEXT_236 = ", lookUpValue_";
    ...
    stringBuffer.append(TEXT_182);
	                ...
	                if (("java.util.Date").equals(generatedType)) {
                    	...
                    	condition.append("(lookUpValue_" + cid + "." + dimensionAttrbite.getCurrentColumn().getColumnName() + " != null && lookUpValue_" + cid + "." + dimensionAttrbite.getCurrentColumn().getColumnName() + ".compareTo(" + inConnectionName + "." + dimensionAttrbite.getCurrentColumn().getLabelName() + ")!= 0)");
	                			...
	                			|| ("BigDecimal").equals(generatedType) || dimensionAttrbite.getCurrentColumn().isNullable()) {
	                    condition.append("(lookUpValue_" + cid + "." + dimensionAttrbite.getCurrentColumn().getColumnName() + " == null && " + inConnectionName + "." + dimensionAttrbite.getCurrentColumn().getLabelName() + "!= null) || ");
	                    condition.append("(lookUpValue_" + cid + "." + dimensionAttrbite.getCurrentColumn().getColumnName() + " != null && !lookUpValue_" + cid + "." + dimensionAttrbite.getCurrentColumn().getColumnName() + ".equals(" + inConnectionName + "." + dimensionAttrbite.getCurrentColumn().getLabelName() + "))");
	                } else {
	                    condition.append("lookUpValue_" + cid + "." + dimensionAttrbite.getCurrentColumn().getColumnName() + " != " + inConnectionName + "." + dimensionAttrbite.getCurrentColumn().getLabelName());
