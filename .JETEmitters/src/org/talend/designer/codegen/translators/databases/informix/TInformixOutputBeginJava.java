...
public class TInformixOutputBeginJava {
  ...
  protected final String TEXT_52 = "=0;" + NL + "" + NL + "String dbschema_";
  ...
  protected final String TEXT_56 = NL + "   int batchSize_";
  protected final String TEXT_57 = " = ";
  protected final String TEXT_58 = ";" + NL + "   int batchSizeCounter_";
  ...
  protected final String TEXT_70 = " = (String)globalMap.get(\"dbschema_";
  ...
  protected final String TEXT_75 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_76 = " + \":\" + ";
  protected final String TEXT_77 = " + \"/\" + ";
  protected final String TEXT_78 = " + \":informixserver=\" + ";
  ...
  protected final String TEXT_88 = " +=\";IFX_USEPUT=1\";";
  protected final String TEXT_89 = NL + "\tjava.lang.Class.forName(\"com.informix.jdbc.IfxDriver\");" + NL + "\t";
  ...
  protected final String TEXT_110 = NL + "\tresourceMap.put(\"conn_";
  ...
  protected final String TEXT_116 = ".setAutoCommit(false);" + NL + "\t}";
  protected final String TEXT_117 = NL + "\tif(!conn_";
  protected final String TEXT_118 = ".getAutoCommit()) {" + NL + "\t    conn_";
  protected final String TEXT_119 = ".setAutoCommit(true);" + NL + "\t}" + NL + "\t";
  protected final String TEXT_120 = NL + "if(dbschema_";
  protected final String TEXT_121 = " == null || dbschema_";
  protected final String TEXT_122 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_123 = " = ";
  protected final String TEXT_124 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_125 = " = dbschema_";
  protected final String TEXT_126 = " + \".\" + ";
  protected final String TEXT_127 = ";" + NL + "}" + NL;
  protected final String TEXT_128 = NL + "\tint count_";
  protected final String TEXT_129 = "=0;";
  protected final String TEXT_130 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_131 = " = conn_";
  protected final String TEXT_132 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_133 = NL + "            stmtDrop_";
  ...
  protected final String TEXT_157 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_158 = " = conn_";
  protected final String TEXT_159 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_160 = NL + "\t\t\t";
  protected final String TEXT_161 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_162 = ".execute(((\"";
  protected final String TEXT_163 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_164 = ".";
  protected final String TEXT_165 = ", \"";
  protected final String TEXT_166 = "\")";
  protected final String TEXT_167 = ".toUpperCase()";
  protected final String TEXT_168 = ")+\")";
  protected final String TEXT_169 = "\"));" + NL + "\t\t\t\t";
  protected final String TEXT_170 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_171 = ".execute(\"";
  protected final String TEXT_172 = ")\");" + NL + "\t\t\t";
  protected final String TEXT_173 = NL + "\t\t\t";
  protected final String TEXT_174 = NL + "            stmtCreate_";
  protected final String TEXT_175 = ".close();" + NL + "\t\t";
  protected final String TEXT_176 = NL + "\t\t\t";
  protected final String TEXT_177 = "\t         " + NL + "\t\t    " + NL + "    \t\t    ";
  protected final String TEXT_178 = NL + "\t\t    \t\tString keyCheckTable_";
  protected final String TEXT_179 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_190 = NL + "\t\t    " + NL + "\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_191 = ")== null){//}" + NL + "\t\t\t" + NL + "\t\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_192 = ")) {//}" + NL + "\t\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_193 = ")== null){//}" + NL + "\t\t\t";
  protected final String TEXT_194 = "              " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_195 = NL + "    \t\t\t\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_196 = " = conn_";
  protected final String TEXT_197 = ".createStatement();" + NL + "                \t\t\t\tboolean whetherExist_";
  protected final String TEXT_198 = " = false;" + NL + "                \t\t\t\ttry {" + NL + "                \t\t\t\t\tisExistStmt_";
  protected final String TEXT_199 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_200 = " + \"]\" );" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_201 = " = true;" + NL + "                \t\t\t\t} catch (java.lang.Exception e){" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_202 = " = false;" + NL + "                \t\t\t\t}" + NL + "                \t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_207 = ".getMetaData();" + NL + "                \t            if(tableNameForSearch_";
  protected final String TEXT_208 = ".indexOf(\"\\\"\")==-1){" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_209 = " = tableNameForSearch_";
  protected final String TEXT_210 = ".toUpperCase();" + NL + "                            \t}else{" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_211 = " = tableNameForSearch_";
  protected final String TEXT_212 = ".replaceAll(\"\\\"\",\"\");" + NL + "                            \t}" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_213 = " = dbMetaData_";
  protected final String TEXT_214 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_215 = ", tableNameForSearch_";
  protected final String TEXT_216 = ", new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_217 = " = false;" + NL + "                \t            if(rsTable_";
  protected final String TEXT_218 = ".next()) {" + NL + "                \t            \twhetherExist_";
  protected final String TEXT_219 = " = true;" + NL + "                \t            }" + NL + "    \t            \t\t\trsTable_";
  protected final String TEXT_220 = ".close();" + NL + "    \t            " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_240 = ".trim().length() ==0)) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_241 = " = true;" + NL + "                \t                    break;" + NL + "        \t            \t    \t}" + NL + "                        \t\t}" + NL + "            \t            \trsTable_";
  protected final String TEXT_242 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_243 = NL + "                \t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_247 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_248 = " = false;" + NL + "                \t            while(rsTable_";
  protected final String TEXT_249 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_250 = " = rsTable_";
  protected final String TEXT_251 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_252 = " = rsTable_";
  protected final String TEXT_253 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_254 = ".equals";
  protected final String TEXT_255 = "IgnoreCase";
  protected final String TEXT_256 = "((";
  protected final String TEXT_257 = ")";
  protected final String TEXT_258 = ".toUpperCase()";
  ...
  protected final String TEXT_264 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_265 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_274 = " = false;" + NL + "                \t            String defaultSchema_";
  protected final String TEXT_275 = " = \"public\";" + NL + "                \t            if(dbschema_";
  protected final String TEXT_276 = " == null || dbschema_";
  protected final String TEXT_277 = ".trim().length() == 0) {" + NL + "                \t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_278 = " = conn_";
  protected final String TEXT_279 = ".createStatement();" + NL + "                \t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_280 = " = stmtSchema_";
  protected final String TEXT_281 = ".executeQuery(\"select current_schema() \");" + NL + "                \t            \twhile(rsSchema_";
  protected final String TEXT_282 = ".next()){" + NL + "                \t            \t\tdefaultSchema_";
  protected final String TEXT_283 = " = rsSchema_";
  protected final String TEXT_284 = ".getString(\"current_schema\");" + NL + "                \t            \t}" + NL + "                \t            \trsSchema_";
  protected final String TEXT_285 = ".close();" + NL + "                \t            \tstmtSchema_";
  protected final String TEXT_286 = ".close();" + NL + "                \t            }" + NL + "                \t            while(rsTable_";
  protected final String TEXT_287 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_288 = " = rsTable_";
  protected final String TEXT_289 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_290 = " = rsTable_";
  protected final String TEXT_291 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_292 = ".equals";
  protected final String TEXT_293 = "IgnoreCase";
  protected final String TEXT_294 = "(";
  protected final String TEXT_295 = ") " + NL + "                \t                \t&& (schema_";
  protected final String TEXT_296 = ".equals";
  protected final String TEXT_297 = "IgnoreCase";
  protected final String TEXT_298 = "(dbschema_";
  protected final String TEXT_299 = ") || ((dbschema_";
  protected final String TEXT_300 = " ==null || dbschema_";
  protected final String TEXT_301 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_302 = ".equals";
  protected final String TEXT_303 = "IgnoreCase";
  protected final String TEXT_304 = "(schema_";
  ...
  protected final String TEXT_308 = "      " + NL + "                \t            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_309 = " = conn_";
  protected final String TEXT_310 = ".getMetaData();" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_311 = " = dbMetaData_";
  protected final String TEXT_312 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_313 = " = false;" + NL + "                \t            while(rsTable_";
  protected final String TEXT_314 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_315 = " = rsTable_";
  protected final String TEXT_316 = ".getString(\"TABLE_NAME\");" + NL + "                \t                if(table_";
  protected final String TEXT_317 = ".equalsIgnoreCase(";
  protected final String TEXT_318 = ")) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_319 = " = true;" + NL + "                \t                    break;" + NL + "                \t                }" + NL + "                \t            }" + NL + "                \t            rsTable_";
  protected final String TEXT_320 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_321 = NL + "                    \t\t\tif(!whetherExist_";
  protected final String TEXT_322 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_342 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_343 = " = conn_";
  protected final String TEXT_344 = ".createStatement();" + NL + "                \t    \t    \t";
  protected final String TEXT_345 = NL + "                                    stmtDrop_";
  protected final String TEXT_346 = ".execute(\"";
  protected final String TEXT_347 = "\" ";
  protected final String TEXT_348 = ");" + NL + "                \t    \t    \t";
  protected final String TEXT_349 = NL + "                                    stmtDrop_";
  protected final String TEXT_350 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_355 = ".execute(((\"";
  protected final String TEXT_356 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_367 = NL + "                        \t\tstmtCreate_";
  protected final String TEXT_368 = ".close();" + NL + "        \t\t\t\t\t";
  protected final String TEXT_369 = NL + "\t\t\t";
  protected final String TEXT_370 = NL + "    \t\t\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_371 = ", true);" + NL + "    \t\t//{{{" + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_372 = "            ";
  protected final String TEXT_373 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_374 = " = conn_";
  protected final String TEXT_375 = ".createStatement();" + NL + "    \t   \t";
  ...
  protected final String TEXT_381 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_382 = " = conn_";
  protected final String TEXT_383 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_384 = " = stmtTruncCount_";
  protected final String TEXT_385 = ".executeQuery(\"";
  protected final String TEXT_386 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_387 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_388 = ".next()) {" + NL + "\t\t\t\trsTruncCountNumber_";
  ...
  protected final String TEXT_392 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_393 = " = conn_";
  protected final String TEXT_394 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_395 = NL + "\t\t\t";
  protected final String TEXT_396 = NL + "\t\t\t\tconn_";
  protected final String TEXT_397 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_398 = NL + "            stmtTrunc_";
  protected final String TEXT_399 = ".executeUpdate(\"";
  protected final String TEXT_400 = "\");";
  protected final String TEXT_401 = NL + "                if(!conn_";
  protected final String TEXT_402 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_403 = ".commit();" + NL + "                }";
  protected final String TEXT_404 = NL + "   \t    \t";
  protected final String TEXT_405 = NL + "   \t    \tdeletedCount_";
  protected final String TEXT_406 = " += rsTruncCountNumber_";
  protected final String TEXT_407 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_408 = ".close();            " + NL + "\t\t";
  protected final String TEXT_409 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_410 = " = conn_";
  protected final String TEXT_411 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_412 = " = stmtTruncCount_";
  protected final String TEXT_413 = ".executeQuery(\"";
  protected final String TEXT_414 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_415 = " = conn_";
  protected final String TEXT_416 = ".createStatement();" + NL + "  \t    \t";
  ...
  protected final String TEXT_423 = NL + "            while(rsTruncCount_";
  protected final String TEXT_424 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_425 = " += rsTruncCount_";
  protected final String TEXT_426 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_427 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_428 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_429 = ".close();" + NL + "\t\t";
  ...
  protected final String TEXT_438 = NL + "\t    String update_";
  protected final String TEXT_439 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_440 = " + \" SET ";
  ...
  protected final String TEXT_444 = ".prepareStatement(update_";
  protected final String TEXT_445 = ");" + NL + "\t    ";
  protected final String TEXT_446 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_447 = " = conn_";
  protected final String TEXT_448 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_454 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_455 = " = conn_";
  protected final String TEXT_456 = ".prepareStatement(insert_";
  protected final String TEXT_457 = ");" + NL + "\t    String update_";
  protected final String TEXT_458 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_459 = " + \" SET ";
  protected final String TEXT_460 = " WHERE ";
  protected final String TEXT_461 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_462 = " = conn_";
  protected final String TEXT_463 = ".prepareStatement(update_";
  ...
  protected final String TEXT_468 = " WHERE ";
  protected final String TEXT_469 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_470 = " = conn_";
  protected final String TEXT_471 = ".prepareStatement(update_";
  ...
  protected final String TEXT_480 = NL + "\t    String delete_";
  protected final String TEXT_481 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_485 = ".prepareStatement(delete_";
  protected final String TEXT_486 = ");" + NL + "\t    ";
  protected final String TEXT_487 = NL + "        StringBuffer query_";
  protected final String TEXT_488 = " = null;" + NL + "       \t";
  protected final String TEXT_489 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_490 = " = insert_";
  protected final String TEXT_491 = ".split(\"\\\\?\");";
  protected final String TEXT_492 = NL + "\t\t\tupdate_";
  protected final String TEXT_493 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_494 = " = update_";
  protected final String TEXT_495 = ".split(\"\\\\?\");";
  protected final String TEXT_496 = NL + "\t\t\tupdate_";
  protected final String TEXT_497 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_498 = " = update_";
  protected final String TEXT_499 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_500 = " = insert_";
  protected final String TEXT_501 = ".split(\"\\\\?\");";
  protected final String TEXT_502 = NL + "\t\t\tdelete_";
  protected final String TEXT_503 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_504 = " = delete_";
  protected final String TEXT_505 = ".split(\"\\\\?\");";
  protected final String TEXT_506 = NL + "\t\t\treplace_";
  protected final String TEXT_507 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_508 = " = replace_";
  protected final String TEXT_509 = ".split(\"\\\\?\");";
  protected final String TEXT_510 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_511 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_512 = " = insertIgnore_";
  protected final String TEXT_513 = ".split(\"\\\\?\");";
  protected final String TEXT_514 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_515 = " = insert_";
  protected final String TEXT_516 = ".split(\"\\\\?\");";
  protected final String TEXT_517 = NL + NL + "        int commitEvery_";
  protected final String TEXT_518 = " = ";
  protected final String TEXT_519 = ";" + NL + "" + NL + "        int commitCounter_";
  protected final String TEXT_520 = " = 0;" + NL;
  protected final String TEXT_521 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_522 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_523 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_524 = " =null;" + NL + "\t";
  protected final String TEXT_525 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_526 = " = null;" + NL + "\t\t";
  protected final String TEXT_527 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_531 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_532 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_536 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_537 = " = null;";
  protected final String TEXT_538 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_539 = " = null;";
  protected final String TEXT_540 = NL + "\t\t \tString[] insertSQLSplits_";
