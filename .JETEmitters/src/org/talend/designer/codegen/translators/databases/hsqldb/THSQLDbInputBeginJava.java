...
public class THSQLDbInputBeginJava
{
  ...
  protected final String TEXT_186 = " = \"jdbc:hsqldb:hsqls://\" + ";
  protected final String TEXT_187 = " + \":\" + ";
  protected final String TEXT_188 = " + \"/\" + ";
  protected final String TEXT_189 = ";";
  protected final String TEXT_190 = NL + "\t\t            url_";
  protected final String TEXT_191 = " = \"jdbc:hsqldb:hsql://\" + ";
  protected final String TEXT_192 = " + \":\" + ";
  protected final String TEXT_193 = " + \"/\" + ";
  protected final String TEXT_194 = ";";
  protected final String TEXT_195 = NL + "\t\t            url_";
  protected final String TEXT_196 = " = \"jdbc:hsqldb:https://\" + ";
  protected final String TEXT_197 = " + \":\" + ";
  protected final String TEXT_198 = " + \"/\" + ";
  protected final String TEXT_199 = ";";
  protected final String TEXT_200 = NL + "\t\t            url_";
  protected final String TEXT_201 = " = \"jdbc:hsqldb:http://\" + ";
  protected final String TEXT_202 = " + \":\" + ";
  protected final String TEXT_203 = " + \"/\" + ";
  protected final String TEXT_204 = ";";
  protected final String TEXT_205 = NL + "\t\t        url_";
  protected final String TEXT_206 = " = \"jdbc:hsqldb:file:\" + ";
  protected final String TEXT_207 = " + \"/\" + ";
  protected final String TEXT_208 = ";";
  protected final String TEXT_209 = NL + "\t\t\t\turl_";
  protected final String TEXT_210 = " = \"jdbc:hsqldb:mem:\" + ";
  protected final String TEXT_211 = " ;";
  protected final String TEXT_212 = NL + "\t\t\t\turl_";
  protected final String TEXT_213 = " += \";\" + ";
  protected final String TEXT_214 = ";";
  protected final String TEXT_215 = NL + "    " + NL + "\t";
  protected final String TEXT_216 = NL + "\t\t    int nb_line_";
  protected final String TEXT_217 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_218 = " = null;";
  protected final String TEXT_219 = NL + "\t\t        conn_";
  protected final String TEXT_220 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_221 = "\");";
  protected final String TEXT_222 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_223 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_224 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_225 = " = dataSources_";
  protected final String TEXT_226 = ".get(";
  protected final String TEXT_227 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_228 = "\", conn_";
  protected final String TEXT_229 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_230 = NL + "\t\t\t\t";
  protected final String TEXT_231 = NL + "\t\t\t\t";
  protected final String TEXT_232 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_233 = " =  conn_";
  protected final String TEXT_234 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_235 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_236 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_237 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_238 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_239 = NL + "                 conn_";
  protected final String TEXT_240 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_241 = NL + "               ";
  protected final String TEXT_242 = " + \"=\" + ";
  protected final String TEXT_243 = " + \";\" +";
  protected final String TEXT_244 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_245 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_246 = ");";
  protected final String TEXT_247 = NL + "\t\t    ";
  protected final String TEXT_248 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_249 = " = ";
  protected final String TEXT_250 = ";" + NL + "\t\t\t";
  protected final String TEXT_251 = NL + "                log.info(\"";
  protected final String TEXT_252 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_253 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_254 = NL;
  protected final String TEXT_255 = NL + "                       globalMap.put(\"";
  protected final String TEXT_256 = "_QUERY\",dbquery_";
  protected final String TEXT_257 = ");";
  protected final String TEXT_258 = NL + "                       globalMap.put(\"";
  protected final String TEXT_259 = "_QUERY\",dbquery_";
  protected final String TEXT_260 = ");";
  protected final String TEXT_261 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_262 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_263 = " = stmt_";
  protected final String TEXT_264 = ".executeQuery(dbquery_";
  protected final String TEXT_265 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_266 = " = rs_";
  protected final String TEXT_267 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_268 = " = rsmd_";
  protected final String TEXT_269 = ".getColumnCount();" + NL;
  protected final String TEXT_270 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_271 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_272 = ".setDbmsId(\"";
  protected final String TEXT_273 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_274 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_275 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_276 = ".add(\"";
  protected final String TEXT_277 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_278 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_279 = " = ";
  protected final String TEXT_280 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_281 = "; i <= rsmd_";
  protected final String TEXT_282 = ".getColumnCount()-";
  protected final String TEXT_283 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_284 = ".contains(rsmd_";
  protected final String TEXT_285 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_286 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_287 = ".setName(rsmd_";
  protected final String TEXT_288 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_289 = ".setDbName(rsmd_";
  protected final String TEXT_290 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_291 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_292 = "\", rsmd_";
  protected final String TEXT_293 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_294 = ".getPrecision(i), rsmd_";
  protected final String TEXT_295 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_296 = ".setDbType(rsmd_";
  protected final String TEXT_297 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_298 = ".setDbTypeId(rsmd_";
  protected final String TEXT_299 = ".getColumnType(i));";
  protected final String TEXT_300 = NL + "                \tdcm_";
  protected final String TEXT_301 = ".setFormat(";
  protected final String TEXT_302 = ");";
  protected final String TEXT_303 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_304 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_305 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_306 = ".setLength(rsmd_";
  protected final String TEXT_307 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_308 = ".setLength(rsmd_";
  protected final String TEXT_309 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_310 = NL + "\t\t\tdcm_";
  protected final String TEXT_311 = ".setLength(rsmd_";
  protected final String TEXT_312 = ".getPrecision(i));";
  protected final String TEXT_313 = NL + "                \tdcm_";
  protected final String TEXT_314 = ".setPrecision(rsmd_";
  protected final String TEXT_315 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_316 = ".setNullable(rsmd_";
  protected final String TEXT_317 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_318 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_319 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_320 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_321 = ".metadatas.add(dcm_";
  protected final String TEXT_322 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_323 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_324 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_325 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_326 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_327 = NL + "\t\t    ";
  protected final String TEXT_328 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_329 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_330 = NL + "\t\t    while (rs_";
  protected final String TEXT_331 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_332 = "++;" + NL + "\t\t        ";
  protected final String TEXT_333 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_334 = " = ";
  protected final String TEXT_335 = " + dcg_";
  protected final String TEXT_336 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_337 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_338 = " = ";
  protected final String TEXT_339 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_340 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_341 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_342 = " < ";
  protected final String TEXT_343 = "column_index_";
  ...
  protected final String TEXT_353 = " = (List)rs_";
  protected final String TEXT_354 = ".getObject(";
  protected final String TEXT_355 = "column_index_";
  protected final String TEXT_356 = ");";
  protected final String TEXT_357 = NL + "\t\t                         ";
  protected final String TEXT_358 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_359 = ".getObject(";
  protected final String TEXT_360 = "column_index_";
  protected final String TEXT_361 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_362 = NL + "                                    ";
  protected final String TEXT_363 = ".";
  protected final String TEXT_364 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_373 = ".setEPSG(";
  protected final String TEXT_374 = ");" + NL + "                                        }";
  protected final String TEXT_375 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_376 = NL + "                                  ";
  protected final String TEXT_377 = ".";
  protected final String TEXT_378 = "=dcg_";
  protected final String TEXT_379 = ";";
  protected final String TEXT_380 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_381 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_382 = " = ";
  protected final String TEXT_383 = "; i_";
  protected final String TEXT_384 = "  <= rsmd_";
  protected final String TEXT_385 = ".getColumnCount(); i_";
  protected final String TEXT_386 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_387 = ".getColumnTypeName(i_";
  protected final String TEXT_388 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_389 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_390 = ".getClob(i_";
  protected final String TEXT_391 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_392 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_393 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_394 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_395 = ".add(tNTextImpl_";
  protected final String TEXT_396 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_397 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_398 = ".";
  protected final String TEXT_399 = ", rs_";
  protected final String TEXT_400 = ", fixedColumnCount_";
  protected final String TEXT_401 = ",list_";
  protected final String TEXT_402 = ",";
  protected final String TEXT_403 = ");";
  protected final String TEXT_404 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_405 = ".";
  protected final String TEXT_406 = ", rs_";
  protected final String TEXT_407 = ", fixedColumnCount_";
  protected final String TEXT_408 = ",";
  protected final String TEXT_409 = ");";
  protected final String TEXT_410 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_411 = ".";
  protected final String TEXT_412 = ", rs_";
  protected final String TEXT_413 = ", fixedColumnCount_";
  protected final String TEXT_414 = ",";
  protected final String TEXT_415 = ");";
  protected final String TEXT_416 = NL + "                                  Object geom = rs_";
  protected final String TEXT_417 = ".getObject(";
  protected final String TEXT_418 = "column_index_";
  protected final String TEXT_419 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_420 = ".";
  protected final String TEXT_421 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_428 = " - Retrieving the record \" + nb_line_";
