...
public class TSasInputBeginJava
{
  ...
  protected final String TEXT_184 = " = \"jdbc:sasiom://\"+";
  protected final String TEXT_185 = "+\":\"+";
  protected final String TEXT_186 = ";";
  protected final String TEXT_187 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_188 = " = \"";
  protected final String TEXT_189 = "\";" + NL + "\t\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_190 = ");" + NL + "\t\t\t" + NL + "\t\t\tString dbUser_";
  ...
  protected final String TEXT_202 = ";" + NL + "" + NL + "\t\t\tjava.util.Properties property_";
  protected final String TEXT_203 = " = new java.util.Properties();" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_204 = NL + "\t\t\t\tString librefs_";
  protected final String TEXT_205 = " = ";
  protected final String TEXT_206 = ";" + NL + "\t\t\t\tproperty_";
  protected final String TEXT_207 = ".setProperty(\"librefs\", librefs_";
  protected final String TEXT_208 = ");" + NL + "\t\t\t";
  protected final String TEXT_209 = NL + "\t\t\tproperty_";
  protected final String TEXT_210 = ".setProperty(\"username\", dbUser_";
  protected final String TEXT_211 = ");" + NL + "\t\t\tproperty_";
  protected final String TEXT_212 = ".setProperty(\"password\", dbPwd_";
  protected final String TEXT_213 = ");" + NL + "\t\t\t";
  protected final String TEXT_214 = NL + "\t\t\t\t\tproperty_";
  protected final String TEXT_215 = ".setProperty(String.valueOf(";
  protected final String TEXT_216 = "), String.valueOf(";
  ...
  protected final String TEXT_222 = ", property_";
  protected final String TEXT_223 = ");";
  protected final String TEXT_224 = NL + "\t\t\tif(rs_";
  protected final String TEXT_225 = ".getString(";
  protected final String TEXT_226 = "column_index_";
  protected final String TEXT_227 = ")!=null&&(rs_";
  protected final String TEXT_228 = ".getString(";
  protected final String TEXT_229 = "column_index_";
  ...
  protected final String TEXT_235 = ").charAt(0);" + NL + "\t\t\t}else{\t\t\t  \t";
  protected final String TEXT_236 = NL + "\t\t\t\t\tif((rs_";
  ...
  protected final String TEXT_241 = "=null;" + NL + "\t\t\t  \t\t}else{" + NL + "\t\t\t  \t\t\t";
  protected final String TEXT_242 = ".";
  protected final String TEXT_243 = "='\\0';" + NL + "\t\t\t  \t\t}";
  protected final String TEXT_244 = NL + "\t\t\t  \t\t" + NL + "\t\t\t  \t\tif((rs_";
  protected final String TEXT_245 = ".getString(";
  protected final String TEXT_246 = "column_index_";
  protected final String TEXT_247 = ")).equals(\"\")){" + NL + "\t\t\t  \t\t\t";
  protected final String TEXT_248 = ".";
  protected final String TEXT_249 = " = '\\0';" + NL + "\t\t\t  \t\t}else{" + NL + "\t\t\t  \t\t\tthrow new RuntimeException(" + NL + "\t\t\t\t\t\t\t\"Value is empty for column : '";
  protected final String TEXT_250 = "', value is invalid or this column should be nullable or have a default value.\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t  \t\t";
  ...
  protected final String TEXT_259 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_260 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_261 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_262 = " = dataSources_";
  protected final String TEXT_263 = ".get(";
  protected final String TEXT_264 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_265 = "\", conn_";
  protected final String TEXT_266 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_267 = NL + "\t\t\t\t";
  protected final String TEXT_268 = NL + "\t\t\t\t";
  protected final String TEXT_269 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_270 = " =  conn_";
  protected final String TEXT_271 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_272 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_273 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_274 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_275 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_276 = NL + "                 conn_";
  protected final String TEXT_277 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_278 = NL + "               ";
  protected final String TEXT_279 = " + \"=\" + ";
  protected final String TEXT_280 = " + \";\" +";
  protected final String TEXT_281 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_282 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_283 = ");";
  protected final String TEXT_284 = NL + "\t\t    ";
  protected final String TEXT_285 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_286 = " = ";
  protected final String TEXT_287 = ";" + NL + "\t\t\t";
  protected final String TEXT_288 = NL + "                log.info(\"";
  protected final String TEXT_289 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_290 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_291 = NL;
  protected final String TEXT_292 = NL + "                       globalMap.put(\"";
  protected final String TEXT_293 = "_QUERY\",dbquery_";
  protected final String TEXT_294 = ");";
  protected final String TEXT_295 = NL + "                       globalMap.put(\"";
  protected final String TEXT_296 = "_QUERY\",dbquery_";
  protected final String TEXT_297 = ");";
  protected final String TEXT_298 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_299 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_300 = " = stmt_";
  protected final String TEXT_301 = ".executeQuery(dbquery_";
  protected final String TEXT_302 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_303 = " = rs_";
  protected final String TEXT_304 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_305 = " = rsmd_";
  protected final String TEXT_306 = ".getColumnCount();" + NL;
  protected final String TEXT_307 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_308 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_309 = ".setDbmsId(\"";
  protected final String TEXT_310 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_311 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_312 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_313 = ".add(\"";
  protected final String TEXT_314 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_315 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_316 = " = ";
  protected final String TEXT_317 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_318 = "; i <= rsmd_";
  protected final String TEXT_319 = ".getColumnCount()-";
  protected final String TEXT_320 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_321 = ".contains(rsmd_";
  protected final String TEXT_322 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_323 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_324 = ".setName(rsmd_";
  protected final String TEXT_325 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_326 = ".setDbName(rsmd_";
  protected final String TEXT_327 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_328 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_329 = "\", rsmd_";
  protected final String TEXT_330 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_331 = ".getPrecision(i), rsmd_";
  protected final String TEXT_332 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_333 = ".setDbType(rsmd_";
  protected final String TEXT_334 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_335 = ".setDbTypeId(rsmd_";
  protected final String TEXT_336 = ".getColumnType(i));";
  protected final String TEXT_337 = NL + "                \tdcm_";
  protected final String TEXT_338 = ".setFormat(";
  protected final String TEXT_339 = ");";
  protected final String TEXT_340 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_341 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_342 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_343 = ".setLength(rsmd_";
  protected final String TEXT_344 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_345 = ".setLength(rsmd_";
  protected final String TEXT_346 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_347 = NL + "\t\t\tdcm_";
  protected final String TEXT_348 = ".setLength(rsmd_";
  protected final String TEXT_349 = ".getPrecision(i));";
  protected final String TEXT_350 = NL + "                \tdcm_";
  protected final String TEXT_351 = ".setPrecision(rsmd_";
  protected final String TEXT_352 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_353 = ".setNullable(rsmd_";
  protected final String TEXT_354 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_355 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_356 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_357 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_358 = ".metadatas.add(dcm_";
  protected final String TEXT_359 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_360 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_361 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_362 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_363 = " =1;" + NL + "\t\t    ";
  ...
  protected final String TEXT_374 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_375 = " = ";
  protected final String TEXT_376 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_377 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_378 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_390 = " = (List)rs_";
  protected final String TEXT_391 = ".getObject(";
  protected final String TEXT_392 = "column_index_";
  protected final String TEXT_393 = ");";
  protected final String TEXT_394 = NL + "\t\t                         ";
  protected final String TEXT_395 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_396 = ".getObject(";
  protected final String TEXT_397 = "column_index_";
  protected final String TEXT_398 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_399 = NL + "                                    ";
  protected final String TEXT_400 = ".";
  protected final String TEXT_401 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_410 = ".setEPSG(";
  protected final String TEXT_411 = ");" + NL + "                                        }";
  protected final String TEXT_412 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_413 = NL + "                                  ";
  protected final String TEXT_414 = ".";
  protected final String TEXT_415 = "=dcg_";
  protected final String TEXT_416 = ";";
  protected final String TEXT_417 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_418 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_419 = " = ";
  protected final String TEXT_420 = "; i_";
  protected final String TEXT_421 = "  <= rsmd_";
  protected final String TEXT_422 = ".getColumnCount(); i_";
  protected final String TEXT_423 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_424 = ".getColumnTypeName(i_";
  protected final String TEXT_425 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_426 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_427 = ".getClob(i_";
  protected final String TEXT_428 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_429 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_430 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_431 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_432 = ".add(tNTextImpl_";
  protected final String TEXT_433 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_434 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_435 = ".";
  protected final String TEXT_436 = ", rs_";
  protected final String TEXT_437 = ", fixedColumnCount_";
  protected final String TEXT_438 = ",list_";
  protected final String TEXT_439 = ",";
  protected final String TEXT_440 = ");";
  protected final String TEXT_441 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_442 = ".";
  protected final String TEXT_443 = ", rs_";
  protected final String TEXT_444 = ", fixedColumnCount_";
  protected final String TEXT_445 = ",";
  protected final String TEXT_446 = ");";
  protected final String TEXT_447 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_448 = ".";
  protected final String TEXT_449 = ", rs_";
  protected final String TEXT_450 = ", fixedColumnCount_";
  protected final String TEXT_451 = ",";
  protected final String TEXT_452 = ");";
  protected final String TEXT_453 = NL + "                                  Object geom = rs_";
  protected final String TEXT_454 = ".getObject(";
  protected final String TEXT_455 = "column_index_";
  protected final String TEXT_456 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_457 = ".";
  protected final String TEXT_458 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
