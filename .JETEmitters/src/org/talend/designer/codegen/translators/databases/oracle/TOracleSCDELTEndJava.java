...
public class TOracleSCDELTEndJava {
  protected static String nl;
  public static synchronized TOracleSCDELTEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TOracleSCDELTEndJava result = new TOracleSCDELTEndJava();
    nl = null;
    return result;
  }
