...
public class TJavaDBOutputMainJava {
  protected static String nl;
  public static synchronized TJavaDBOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJavaDBOutputMainJava result = new TJavaDBOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_86 = NL + "                        query_";
  ...
  protected final String TEXT_94 = "_QUERY\", query_";
  protected final String TEXT_95 = ".toString().trim());";
  ...
  protected final String TEXT_112 = NL + "                        nb_line_rejected_";
  protected final String TEXT_113 = "++;";
  protected final String TEXT_114 = NL + "                        ";
  protected final String TEXT_115 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_116 = NL + "                        ";
  protected final String TEXT_117 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_118 = ";";
  protected final String TEXT_119 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_120 = NL + "            }";
  protected final String TEXT_121 = NL + "                    ";
  protected final String TEXT_122 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_123 = " = pstmt_";
  protected final String TEXT_124 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_125 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_126 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_127 = " = rs_";
  protected final String TEXT_128 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_129 = " > 0) {";
  protected final String TEXT_130 = NL + "                        ";
  protected final String TEXT_131 = NL + "                            query_";
  protected final String TEXT_132 = " = ";
  protected final String TEXT_133 = ";";
  protected final String TEXT_134 = NL + "                        ";
  protected final String TEXT_135 = NL + "                            query_";
  protected final String TEXT_136 = " = ";
  protected final String TEXT_137 = ";";
  protected final String TEXT_138 = NL + "                    globalMap.put(\"";
  protected final String TEXT_139 = "_QUERY\", query_";
  protected final String TEXT_140 = ".toString().trim());";
  ...
  protected final String TEXT_146 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_159 = NL + "                            nb_line_rejected_";
  ...
  protected final String TEXT_169 = NL + "                            query_";
  protected final String TEXT_170 = " = ";
  protected final String TEXT_171 = ";";
  protected final String TEXT_172 = NL + "                    globalMap.put(\"";
  protected final String TEXT_173 = "_QUERY\", query_";
  protected final String TEXT_174 = ".toString().trim());";
  protected final String TEXT_175 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_176 = " = insertedCount_";
  protected final String TEXT_177 = " + pstmtInsert_";
  protected final String TEXT_178 = ".executeUpdate();" + NL + "                    nb_line_";
  ...
  protected final String TEXT_193 = NL + "                            nb_line_rejected_";
  protected final String TEXT_194 = "++;";
  protected final String TEXT_195 = NL + "                            ";
  protected final String TEXT_196 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_202 = NL + "            int updateFlag_";
  protected final String TEXT_203 = "=0;";
  protected final String TEXT_204 = NL + "                    ";
  protected final String TEXT_205 = NL + "                        query_";
  ...
  protected final String TEXT_213 = "_QUERY\", query_";
  protected final String TEXT_214 = ".toString().trim());";
  protected final String TEXT_215 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_216 = "=pstmtUpdate_";
  protected final String TEXT_217 = ".executeUpdate();" + NL + "                if(updateFlag_";
  protected final String TEXT_218 = " != 0){" + NL + "                \tnb_line_";
  protected final String TEXT_219 = "++;" + NL + "\t\t\t\t\t";
  protected final String TEXT_220 = NL + "                }" + NL + "                updatedCount_";
  protected final String TEXT_221 = " = updatedCount_";
  protected final String TEXT_222 = "+updateFlag_";
  protected final String TEXT_223 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_242 = NL + "            }" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_271 = NL + "                            nb_line_rejected_";
  protected final String TEXT_272 = "++;";
  protected final String TEXT_273 = NL + "                            ";
  protected final String TEXT_274 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_275 = NL + "                            ";
  protected final String TEXT_276 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_277 = ";";
  protected final String TEXT_278 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_285 = "_QUERY\", query_";
  protected final String TEXT_286 = ".toString().trim());";
  protected final String TEXT_287 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_288 = " = deletedCount_";
  protected final String TEXT_289 = " + pstmt_";
  protected final String TEXT_290 = ".executeUpdate();" + NL + "            \tnb_line_";
  protected final String TEXT_291 = "++;";
  protected final String TEXT_292 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_293 = " = true;";
  protected final String TEXT_294 = NL + "                    throw(e);";
  protected final String TEXT_295 = NL + "\t\t\t\t\tnb_line_";
  ...
  protected final String TEXT_305 = NL + "                        nb_line_rejected_";
  ...
  protected final String TEXT_325 = NL + "            commitCounter_";
  protected final String TEXT_326 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_327 = " <= commitCounter_";
  protected final String TEXT_328 = ") {" + NL + "            \t";
  protected final String TEXT_329 = NL + "                conn_";
  protected final String TEXT_330 = ".commit();" + NL + "            \t";
  protected final String TEXT_331 = NL + "                commitCounter_";
  protected final String TEXT_332 = "=0;" + NL + "            " + NL + "            }" + NL + "        ";
