...
public class TRedshiftOutputBeginJava {
  protected static String nl;
  public static synchronized TRedshiftOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRedshiftOutputBeginJava result = new TRedshiftOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_78 = "=0;" + NL + "" + NL + "java.util.Calendar calendar_";
  protected final String TEXT_79 = " = java.util.Calendar.getInstance();" + NL + "calendar_";
  protected final String TEXT_80 = ".set(1, 0, 1, 0, 0, 0);" + NL + "long year1_";
  protected final String TEXT_81 = " = calendar_";
  protected final String TEXT_82 = ".getTime().getTime();" + NL + "calendar_";
  protected final String TEXT_83 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "long year10000_";
  protected final String TEXT_84 = " = calendar_";
  protected final String TEXT_85 = ".getTime().getTime();" + NL + "long date_";
  protected final String TEXT_86 = ";" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_87 = " = false;" + NL;
  protected final String TEXT_88 = NL + "   int batchSize_";
  protected final String TEXT_89 = " = ";
  protected final String TEXT_90 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_91 = "=0;" + NL + "   int tmp_batchUpdateCount_";
  protected final String TEXT_92 = " = 0;";
  protected final String TEXT_93 = NL + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_99 = NL + NL + "    java.lang.Class.forName(\"org.postgresql.Driver\");";
  protected final String TEXT_100 = NL + "    String url_";
  protected final String TEXT_101 = " = \"jdbc:postgresql://\"+";
  ...
  protected final String TEXT_122 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_123 = "\", conn_";
  protected final String TEXT_124 = ");" + NL + "    conn_";
  protected final String TEXT_125 = ".setAutoCommit(false);" + NL + "\t";
  protected final String TEXT_126 = NL + "        int commitEvery_";
  protected final String TEXT_127 = " = ";
  protected final String TEXT_128 = ";" + NL + "        int commitCounter_";
  ...
  protected final String TEXT_433 = NL + "\t\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_434 = " = conn_";
  protected final String TEXT_435 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_436 = " + \"\\\" (";
  protected final String TEXT_437 = ") VALUES (";
  protected final String TEXT_438 = ")\");";
  protected final String TEXT_439 = NL + "\t\t\tint rowCount";
  protected final String TEXT_440 = " = 0;" + NL + "\t\t\tclass BufferLine_";
  protected final String TEXT_441 = " {";
  protected final String TEXT_442 = NL + "                            ";
  protected final String TEXT_443 = " ";
  protected final String TEXT_444 = ";";
  protected final String TEXT_445 = NL + NL + "\t            public BufferLine_";
  ...
  protected final String TEXT_454 = NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tjava.util.List<BufferLine_";
  protected final String TEXT_455 = "> exInsertColValueList";
  protected final String TEXT_456 = " = new java.util.ArrayList();" + NL + "\t\t\tBufferLine_";
  protected final String TEXT_457 = " exInsertColValue";
  protected final String TEXT_458 = " = null;" + NL + "" + NL + "" + NL + "\t\t\tStringBuilder extendInsertValueStmt_";
  protected final String TEXT_459 = " = new StringBuilder();" + NL + "\t\t\tfor(int i_";
  protected final String TEXT_460 = "=0;i_";
  protected final String TEXT_461 = " < ";
  protected final String TEXT_462 = ";i_";
  protected final String TEXT_463 = "++){" + NL + "\t\t\t\t extendInsertValueStmt_";
  protected final String TEXT_464 = ".append(\"(";
  protected final String TEXT_465 = ")\");" + NL + "\t\t\t\t if (i_";
  protected final String TEXT_466 = "!=";
  protected final String TEXT_467 = "-1) extendInsertValueStmt_";
  protected final String TEXT_468 = ".append(\",\");" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tString insert_";
  protected final String TEXT_469 = " = \"INSERT INTO \\\"\"+";
  protected final String TEXT_470 = "+\"\\\" (";
  protected final String TEXT_471 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_472 = ".toString();" + NL + "\t\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_473 = " =  conn_";
  protected final String TEXT_474 = ".prepareStatement(insert_";
  protected final String TEXT_475 = ");";
  protected final String TEXT_476 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_477 = " = conn_";
  protected final String TEXT_478 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_484 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_485 = " + \"\\\" WHERE ";
  protected final String TEXT_486 = "\");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_487 = " = conn_";
  protected final String TEXT_488 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_493 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_494 = " + \"\\\" SET ";
  protected final String TEXT_495 = " WHERE ";
  protected final String TEXT_496 = "\");" + NL + "\t    ";
  protected final String TEXT_497 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_498 = " = conn_";
  protected final String TEXT_499 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_500 = " + \"\\\" SET ";
  protected final String TEXT_501 = " WHERE ";
  protected final String TEXT_502 = "\");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_503 = " = conn_";
  protected final String TEXT_504 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_510 = ".prepareStatement(\"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_511 = " + \"\\\" WHERE ";
  protected final String TEXT_512 = "\");" + NL + "\t    ";
  protected final String TEXT_513 = NL + "\tclass BufferLine_";
  protected final String TEXT_514 = " {";
  protected final String TEXT_515 = NL + "            ";
  protected final String TEXT_516 = " ";
  protected final String TEXT_517 = ";";
  protected final String TEXT_518 = NL + "\t\t\troutines.system.Dynamic ";
  ...
  protected final String TEXT_528 = " routines.system.Dynamic ";
  ...
  protected final String TEXT_537 = NL + "        }" + NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_538 = "> exInsertColValueList";
  protected final String TEXT_539 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_540 = " exInsertColValue";
  protected final String TEXT_541 = " = null;" + NL + "    String insert_";
  protected final String TEXT_542 = " = \"\";" + NL + "    int rowCount";
  protected final String TEXT_543 = " = 0;";
  protected final String TEXT_544 = " " + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_545 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_546 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
