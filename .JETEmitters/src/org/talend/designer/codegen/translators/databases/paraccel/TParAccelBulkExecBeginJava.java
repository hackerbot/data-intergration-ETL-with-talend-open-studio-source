...
public class TParAccelBulkExecBeginJava {
  protected static String nl;
  public static synchronized TParAccelBulkExecBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TParAccelBulkExecBeginJava result = new TParAccelBulkExecBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_87 = NL + "\tString xpxSQL_";
  protected final String TEXT_88 = "=\"\";" + NL + "\tString bulkSQL_";
  protected final String TEXT_89 = "=\"\";";
  protected final String TEXT_90 = NL + "\txpxSQL_";
  protected final String TEXT_91 = " += \"xpx 'localize \\\"\" + tableName_";
  protected final String TEXT_92 = " +\"\\\"\" + ";
  protected final String TEXT_93 = " + \" ";
  protected final String TEXT_94 = "'\";" + NL + "\tbulkSQL_";
  protected final String TEXT_95 = " += \"COPY \\\"\" + tableName_";
  protected final String TEXT_96 = " + \"\\\"\" + " + NL + "\t\t\" FROM 'local' WITH PARALLEL ";
  protected final String TEXT_97 = " \";";
  protected final String TEXT_98 = NL + "\tbulkSQL_";
  protected final String TEXT_99 = " += \"COPY \\\"\" + tableName_";
  protected final String TEXT_100 = " + \"\\\"\" + \"";
  protected final String TEXT_101 = "FROM '\" +" + NL + "\t\t";
  protected final String TEXT_102 = " + \"' WITH ";
  protected final String TEXT_103 = " \";";
  protected final String TEXT_104 = NL + "\tbulkSQL_";
  protected final String TEXT_105 = " += \"DELIMITER '\" + (";
  protected final String TEXT_106 = ").charAt(0) + \"' \";";
  protected final String TEXT_107 = NL + "\t\t\tbulkSQL_";
  protected final String TEXT_108 = " += \"FIXEDWIDTH '\" + ";
  protected final String TEXT_109 = " + \"' \";" + NL + "\t\t";
  protected final String TEXT_110 = NL + "\t\tbulkSQL_";
  protected final String TEXT_111 = " += \"FIXEDWIDTH '\";" + NL + "\t\t";
  protected final String TEXT_112 = NL + "\t\t\t\t\tbulkSQL_";
  ...
  protected final String TEXT_120 = NL + "\t\tbulkSQL_";
  protected final String TEXT_121 = " += \"' \";";
  protected final String TEXT_122 = NL + "\tbulkSQL_";
  protected final String TEXT_123 = " += \"REMOVEQUOTES \";";
  protected final String TEXT_124 = NL + "\tbulkSQL_";
  protected final String TEXT_125 = " += \"EXPLICIT_IDS \";";
  protected final String TEXT_126 = NL + "\tbulkSQL_";
  protected final String TEXT_127 = " += \"MAXERROR \" + ";
  protected final String TEXT_128 = " + \" \";";
  protected final String TEXT_129 = NL + "\tbulkSQL_";
  protected final String TEXT_130 = " += \"DATEFORMAT '\" + ";
  protected final String TEXT_131 = " + \"' \";";
  protected final String TEXT_132 = NL + "\tbulkSQL_";
  protected final String TEXT_133 = " += \"TIMEFORMAT '\" + ";
  protected final String TEXT_134 = " + \"' \";";
  protected final String TEXT_135 = NL + "\tbulkSQL_";
  protected final String TEXT_136 = " += ";
  protected final String TEXT_137 = " + \" \";";
  protected final String TEXT_138 = " " + NL + "if (";
  protected final String TEXT_139 = " > 0) {" + NL + "\tjava.io.Writer output_";
  protected final String TEXT_140 = " = new java.io.FileWriter(";
  protected final String TEXT_141 = ", true);" + NL + "\tjava.sql.DriverManager.setLogWriter(new java.io.PrintWriter(output_";
  protected final String TEXT_142 = ",true));" + NL + "}\t" + NL + "com.paraccel.Driver.setLogLevel(";
  protected final String TEXT_143 = ");" + NL + "" + NL + "java.sql.Connection conn_";
  protected final String TEXT_144 = " = null;" + NL + "\t";
  protected final String TEXT_145 = NL + "\t \tconn_";
  protected final String TEXT_146 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_147 = "\");" + NL + "\t ";
  protected final String TEXT_148 = NL + "\t \tString driverClass_";
  protected final String TEXT_149 = " = \"com.paraccel.Driver\";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_150 = ").newInstance();" + NL + "\t\tString url_";
  protected final String TEXT_151 = " = \"jdbc:paraccel://\" + ";
  protected final String TEXT_152 = " + \":\" + ";
  protected final String TEXT_153 = " + \"/\" + ";
  protected final String TEXT_154 = "+\"?prepareThreshold=100&loglevel=\"+";
  protected final String TEXT_155 = "+\"&protocolVersion=3\";" + NL + "\t\tString dbUser_";
  ...
  protected final String TEXT_165 = NL + "\t   \t" + NL + "\t\tString dbPwd_";
  protected final String TEXT_166 = " = decryptedPassword_";
  protected final String TEXT_167 = ";" + NL + "\t";
  protected final String TEXT_168 = NL;
  protected final String TEXT_169 = NL + "\t";
  protected final String TEXT_170 = NL + "\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_171 = " = conn_";
  protected final String TEXT_172 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_173 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_174 = " - Droping table ";
  protected final String TEXT_175 = "\" + tableName_";
  ...
  protected final String TEXT_182 = " - Drop table ";
  protected final String TEXT_183 = "\" + tableName_";
  protected final String TEXT_184 = " + \"";
  protected final String TEXT_185 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_186 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_187 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_188 = " = conn_";
  protected final String TEXT_189 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_190 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_191 = " - Creating table ";
  ...
  protected final String TEXT_199 = " - Create table ";
  protected final String TEXT_200 = "\" + tableName_";
  ...
  protected final String TEXT_205 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_206 = " = conn_";
  protected final String TEXT_207 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_208 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_209 = " - Creating table ";
  ...
  protected final String TEXT_216 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_217 = " - Create table ";
  protected final String TEXT_218 = "\" + tableName_";
  protected final String TEXT_219 = " + \"";
  protected final String TEXT_220 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_221 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_222 = ".close();" + NL + "\t\t";
  protected final String TEXT_223 = "   " + NL + "\t\t\t\t";
  protected final String TEXT_224 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_225 = " = conn_";
  protected final String TEXT_226 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_227 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_228 = " = tableNameForSearch_";
  protected final String TEXT_229 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_230 = " = tableNameForSearch_";
  protected final String TEXT_231 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_232 = " = dbMetaData_";
  protected final String TEXT_233 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_234 = ", tableNameForSearch_";
  protected final String TEXT_235 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_236 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_237 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_238 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_253 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_254 = ") || dbschema_";
  protected final String TEXT_255 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_256 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_257 = ".close();" + NL + "\t\t\t";
  ...
  protected final String TEXT_262 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  ...
  protected final String TEXT_266 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  protected final String TEXT_267 = " = rsTable_";
  protected final String TEXT_268 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_269 = ".equals(";
  protected final String TEXT_270 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_271 = ".equals(schema_";
  protected final String TEXT_272 = ") || (schema_";
  protected final String TEXT_273 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_274 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_337 = " - Creating table ";
  protected final String TEXT_338 = "\" + tableName_";
  ...
  protected final String TEXT_345 = " - Create table ";
  protected final String TEXT_346 = "\" + tableName_";
  protected final String TEXT_347 = " + \"";
  protected final String TEXT_348 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_349 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_350 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_351 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_352 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_353 = " = conn_";
  protected final String TEXT_354 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_355 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_356 = " - Droping table ";
  ...
  protected final String TEXT_364 = " - Drop table ";
  protected final String TEXT_365 = "\" + tableName_";
  protected final String TEXT_366 = " + \"";
  protected final String TEXT_367 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_368 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_369 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_370 = " = conn_";
  protected final String TEXT_371 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_372 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_373 = " - Creating table ";
  ...
  protected final String TEXT_381 = " - Create table ";
  protected final String TEXT_382 = "\" + tableName_";
  protected final String TEXT_383 = " + \"";
  protected final String TEXT_384 = " has succeeded.\");" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_391 = " - Clearing table ";
  ...
  protected final String TEXT_399 = "- Clear table ";
  protected final String TEXT_400 = "\" + tableName_";
  protected final String TEXT_401 = " + \"";
  protected final String TEXT_402 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_433 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_434 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_435 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_436 = NL + "\t";
  protected final String TEXT_437 = NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_438 = " = conn_";
  protected final String TEXT_439 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");";
  protected final String TEXT_440 = NL + "\t";
  protected final String TEXT_441 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_442 = " - Paralle bulk SQL:\"+xpxSQL_";
  protected final String TEXT_443 = "+\".\");" + NL + "\t\tlog.debug(\"";
  protected final String TEXT_444 = " - Executing parallel bulk SQL.\");" + NL + "\t";
  protected final String TEXT_445 = NL + "    java.sql.Statement stmtXPX_";
  protected final String TEXT_446 = " = conn_";
  protected final String TEXT_447 = ".createStatement();" + NL + "    stmtXPX_";
  protected final String TEXT_448 = ".execute(xpxSQL_";
  protected final String TEXT_449 = ");";
  protected final String TEXT_450 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_451 = " - Execute parallel bulk SQL has finished.\");" + NL + "\t";
  protected final String TEXT_452 = NL + "    stmtXPX_";
  protected final String TEXT_453 = ".close();    ";
  protected final String TEXT_454 = NL + "\t";
  protected final String TEXT_455 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_456 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_457 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_458 = " - Bulk inserting data into ";
  protected final String TEXT_459 = "\" + tableName_";
  protected final String TEXT_460 = " + \"";
  protected final String TEXT_461 = ".\" );" + NL + "\t";
  protected final String TEXT_462 = NL + "    stmtBulk_";
  protected final String TEXT_463 = ".execute(bulkSQL_";
  protected final String TEXT_464 = ");" + NL + "\t";
  protected final String TEXT_465 = NL + "\t\tlog.info(\"";
  protected final String TEXT_466 = " - Bulk insert data into ";
  protected final String TEXT_467 = "\" + tableName_";
  protected final String TEXT_468 = " + \"";
  protected final String TEXT_469 = " has finished.\");" + NL + "\t";
  protected final String TEXT_470 = NL + "    stmtBulk_";
  protected final String TEXT_471 = ".close();    ";
...
if(notNullCols != null && notNullCols.size() > 0) {
    ...
    stringBuffer.append(fixedWidth);
...
*/
    ...
    stringBuffer.append(addlOptions);
