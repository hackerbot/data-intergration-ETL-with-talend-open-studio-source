...
public class TSybaseIQBulkExecBeginJava {
  ...
  protected final String TEXT_72 = "\");" + NL + "\tString dbschema_";
  ...
  protected final String TEXT_79 = "; " + NL + "\tString dbUser_";
  protected final String TEXT_80 = " = ";
  protected final String TEXT_81 = ";";
  protected final String TEXT_82 = NL;
  protected final String TEXT_83 = NL + "\t\t\tString url_";
  protected final String TEXT_84 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_85 = " + \":\" + ";
  protected final String TEXT_86 = " + \"/\" + ";
  protected final String TEXT_87 = ";";
  protected final String TEXT_88 = NL + "\t\t\tString url_";
  protected final String TEXT_89 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_90 = " + \":\" + ";
  protected final String TEXT_91 = " + \"/\" + ";
  protected final String TEXT_92 = " + \"?\" + ";
  protected final String TEXT_93 = ";";
  protected final String TEXT_94 = NL + "\t\t String driverClass_";
  protected final String TEXT_95 = " = \"com.sybase.jdbc3.jdbc.SybDriver\";";
  protected final String TEXT_96 = NL + "\t\t\tString url_";
  protected final String TEXT_97 = " = \"jdbc:odbc:dsn=\"+";
  protected final String TEXT_98 = ";";
  protected final String TEXT_99 = NL + "\t\t\tString url_";
  protected final String TEXT_100 = " = \"jdbc:odbc:FileDSN=\"+";
  protected final String TEXT_101 = ";";
  protected final String TEXT_102 = NL + "\t\t\turl_";
  protected final String TEXT_103 = " +=\";DatabaseName=\"+";
  protected final String TEXT_104 = ";";
  protected final String TEXT_105 = NL + "\t\tString driverClass_";
  protected final String TEXT_106 = " = \"ianywhere.ml.jdbcodbc.IDriver\";";
  protected final String TEXT_107 = NL + "   " + NL + "    java.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_116 = NL + "\tString dbPwd_";
  protected final String TEXT_117 = " = decryptedPassword_";
  protected final String TEXT_118 = ";" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_119 = " = null;" + NL + "    ";
  protected final String TEXT_120 = NL + NL + "\tString tableName_";
  protected final String TEXT_121 = " = dbUser_";
  protected final String TEXT_122 = " + \".\" + ";
  protected final String TEXT_123 = ";" + NL + "\tif(dbschema_";
  protected final String TEXT_124 = " != null && dbschema_";
  protected final String TEXT_125 = ".trim().length() != 0) {" + NL + "\t\ttableName_";
  protected final String TEXT_126 = " = dbschema_";
  protected final String TEXT_127 = " + \".\" + ";
  protected final String TEXT_128 = ";" + NL + "\t}";
  protected final String TEXT_129 = NL + "int deletedCount_";
  protected final String TEXT_130 = " = 0;";
  protected final String TEXT_131 = NL + "\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_132 = " = conn_";
  protected final String TEXT_133 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_134 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_135 = " - Droping table ";
  protected final String TEXT_136 = "\" + tableName_";
  protected final String TEXT_137 = " + \"";
  protected final String TEXT_138 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_139 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_140 = ".execute(\"";
  protected final String TEXT_141 = "\");" + NL + "\t\t\t";
  protected final String TEXT_142 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_143 = " - Drop table ";
  protected final String TEXT_144 = "\" + tableName_";
  protected final String TEXT_145 = " + \"";
  protected final String TEXT_146 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_152 = " - Creating table ";
  protected final String TEXT_153 = "\" + tableName_";
  ...
  protected final String TEXT_160 = " - Create table ";
  protected final String TEXT_161 = "\" + tableName_";
  ...
  protected final String TEXT_166 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_185 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_186 = " = conn_";
  protected final String TEXT_187 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_188 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_189 = " = tableNameForSearch_";
  protected final String TEXT_190 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_191 = " = tableNameForSearch_";
  protected final String TEXT_192 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_193 = " = dbMetaData_";
  protected final String TEXT_194 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_195 = ", tableNameForSearch_";
  protected final String TEXT_196 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_197 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_198 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_199 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_212 = ".equalsIgnoreCase(";
  protected final String TEXT_213 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_214 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_215 = ") || dbschema_";
  protected final String TEXT_216 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_217 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_227 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_231 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_232 = ".equals(schema_";
  protected final String TEXT_233 = ") || (schema_";
  protected final String TEXT_234 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_235 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_239 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_243 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_244 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_245 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_246 = " == null || dbschema_";
  protected final String TEXT_247 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_248 = " = conn_";
  protected final String TEXT_249 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_250 = " = stmtSchema_";
  protected final String TEXT_251 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_252 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_253 = " = rsSchema_";
  protected final String TEXT_254 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_255 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_256 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_265 = ") " + NL + "\t\t\t\t\t\t&& (schema_";
  ...
  protected final String TEXT_270 = " ==null || dbschema_";
  protected final String TEXT_271 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_272 = ".equals";
  protected final String TEXT_273 = "IgnoreCase";
  protected final String TEXT_274 = "(schema_";
  ...
  protected final String TEXT_293 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_294 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_298 = " - Creating table ";
  protected final String TEXT_299 = "\" + tableName_";
  ...
  protected final String TEXT_306 = " - Create table ";
  ...
  protected final String TEXT_311 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_317 = " - Droping table ";
  protected final String TEXT_318 = "\" + tableName_";
  protected final String TEXT_319 = " + \"";
  protected final String TEXT_320 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_321 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_322 = ".execute(\"";
  protected final String TEXT_323 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_324 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_325 = " - Drop table ";
  protected final String TEXT_326 = "\" + tableName_";
  protected final String TEXT_327 = " + \"";
  protected final String TEXT_328 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_329 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_330 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_334 = " - Creating table ";
  protected final String TEXT_335 = "\" + tableName_";
  ...
  protected final String TEXT_342 = " - Create table ";
  protected final String TEXT_343 = "\" + tableName_";
  protected final String TEXT_344 = " + \"";
  protected final String TEXT_345 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_346 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_347 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_348 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_352 = " - Clearing table ";
  protected final String TEXT_353 = "\" + tableName_";
  protected final String TEXT_354 = " + \"";
  protected final String TEXT_355 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_356 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_357 = ".executeUpdate(\"";
  protected final String TEXT_358 = "\");" + NL + "\t\t\t";
  protected final String TEXT_359 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_360 = "- Clear table ";
  protected final String TEXT_361 = "\" + tableName_";
  protected final String TEXT_362 = " + \"";
  protected final String TEXT_363 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_364 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_365 = ".close();" + NL + "\t\t";
  protected final String TEXT_366 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_367 = " = conn_";
  protected final String TEXT_368 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_369 = " = stmtTruncCount_";
  protected final String TEXT_370 = ".executeQuery(\"";
  protected final String TEXT_371 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  protected final String TEXT_372 = " = conn_";
  protected final String TEXT_373 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_374 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_375 = " - Trancating table ";
  protected final String TEXT_376 = "\" + tableName_";
  protected final String TEXT_377 = " + \"";
  protected final String TEXT_378 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_379 = NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_380 = ".executeUpdate(\"";
  protected final String TEXT_381 = "\");" + NL + "   \t    \t";
  protected final String TEXT_382 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_383 = " - Truncate table ";
  ...
  protected final String TEXT_393 = ".close();" + NL + "\t\t";
  protected final String TEXT_394 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_395 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_396 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_397 = NL + "\t";
  protected final String TEXT_398 = NL + NL + "\t\tStringBuilder loadingCols_";
  protected final String TEXT_399 = " = new StringBuilder();";
  protected final String TEXT_400 = NL + "    \tloadingCols_";
  protected final String TEXT_401 = ".append(\"(\");";
  protected final String TEXT_402 = NL + "        loadingCols_";
  protected final String TEXT_403 = ".append(\"";
  protected final String TEXT_404 = "\" + \" \");";
  protected final String TEXT_405 = NL + "\t\tloadingCols_";
  protected final String TEXT_406 = ".append(\"ASCII(\" + ";
  protected final String TEXT_407 = " + \"),\");";
  protected final String TEXT_408 = NL + "        loadingCols_";
  protected final String TEXT_409 = ".append(\"'\" + ";
  protected final String TEXT_410 = " + \"'\" + \",\");";
  protected final String TEXT_411 = NL + "\t\tloadingCols_";
  protected final String TEXT_412 = ".append(\"ASCII(\" + ";
  protected final String TEXT_413 = " + \")\");";
  protected final String TEXT_414 = NL + "        \tloadingCols_";
  protected final String TEXT_415 = ".append(\"'\" + ";
  protected final String TEXT_416 = " + \"'\");";
  protected final String TEXT_417 = NL + "    loadingCols_";
  protected final String TEXT_418 = ".append(\")\");";
  protected final String TEXT_419 = " " + NL + "" + NL + "    java.sql.Statement stmt_";
  protected final String TEXT_420 = "=conn_";
  protected final String TEXT_421 = ".createStatement();" + NL + "    stmt_";
  protected final String TEXT_422 = ".execute(\"SET TEMPORARY OPTION ESCAPE_CHARACTER='ON'\");" + NL + "    " + NL + "    //stmt_";
  protected final String TEXT_423 = ".execute(\"SET TEMPORARY OPTION ALLOW_READ_CLIENT_FILE='ON'\");//sybaseIQ 15 whether is set?" + NL + "        " + NL + "    String strSQL_";
  protected final String TEXT_424 = " = \"LOAD TABLE \" + tableName_";
  protected final String TEXT_425 = " + loadingCols_";
  protected final String TEXT_426 = ".toString() ;";
  protected final String TEXT_427 = NL + "\t\tstrSQL_";
  protected final String TEXT_428 = " +=\" from '\" + ";
  protected final String TEXT_429 = " + \"' \";";
  protected final String TEXT_430 = NL + "\t\tstrSQL_";
  protected final String TEXT_431 = " +=\" USING CLIENT FILE '\" + ";
  protected final String TEXT_432 = " + \"' \";";
  protected final String TEXT_433 = NL + "    ";
  protected final String TEXT_434 = NL + "     strSQL_";
  protected final String TEXT_435 = " = strSQL_";
  protected final String TEXT_436 = " + \" row delimited by '\" + ";
  protected final String TEXT_437 = " + \"'\";    " + NL + "\t strSQL_";
  protected final String TEXT_438 = "=strSQL_";
  protected final String TEXT_439 = " + \" quotes off\";";
  protected final String TEXT_440 = NL + "\tstrSQL_";
  protected final String TEXT_441 = "=strSQL_";
  protected final String TEXT_442 = " + \" quotes on \";";
  protected final String TEXT_443 = NL + "\tstrSQL_";
  protected final String TEXT_444 = "=strSQL_";
  protected final String TEXT_445 = " + \" quotes off \";";
  protected final String TEXT_446 = NL + "    strSQL_";
  protected final String TEXT_447 = " =strSQL_";
  protected final String TEXT_448 = " + \" escapes off \";" + NL + "    ";
  protected final String TEXT_449 = NL + "\tstrSQL_";
  protected final String TEXT_450 = " =strSQL_";
  protected final String TEXT_451 = " + \" skip 1 \";";
  protected final String TEXT_452 = NL + "\t\tlog.info(\"";
  protected final String TEXT_453 = " - Bulk load SQL:\"+strSQL_";
  protected final String TEXT_454 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_455 = " - Bulk loading data into ";
  protected final String TEXT_456 = "\" + tableName_";
  protected final String TEXT_457 = " + \"";
  protected final String TEXT_458 = ".\" );" + NL + "\t";
  protected final String TEXT_459 = NL + "    " + NL + "    stmt_";
  protected final String TEXT_460 = ".execute(strSQL_";
  protected final String TEXT_461 = ");" + NL;
  protected final String TEXT_462 = NL + "    if(conn_";
  protected final String TEXT_463 = " != null && !conn_";
  protected final String TEXT_464 = ".isClosed()) {";
