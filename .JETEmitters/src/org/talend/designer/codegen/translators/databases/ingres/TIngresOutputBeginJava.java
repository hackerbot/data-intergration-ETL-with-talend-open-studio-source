...
public class TIngresOutputBeginJava {
  protected static String nl;
  public static synchronized TIngresOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TIngresOutputBeginJava result = new TIngresOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_53 = " = 0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_54 = " = ";
  protected final String TEXT_55 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_56 = " = false;" + NL + "" + NL + "int tmp_batchUpdateCount_";
  protected final String TEXT_57 = " = 0;" + NL;
  protected final String TEXT_58 = NL + "       int batchSize_";
  protected final String TEXT_59 = " = ";
  protected final String TEXT_60 = ";" + NL + "       int batchSizeCounter_";
  protected final String TEXT_61 = "=0;";
  protected final String TEXT_62 = NL;
  protected final String TEXT_63 = NL;
  protected final String TEXT_64 = NL + "        int updateKeyCount_";
  protected final String TEXT_65 = " = ";
  protected final String TEXT_66 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_67 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_68 = NL + "        int deleteKeyCount_";
  protected final String TEXT_69 = " = ";
  protected final String TEXT_70 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_71 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  ...
  protected final String TEXT_77 = NL + "\tjava.lang.Class.forName(\"com.ingres.jdbc.IngresDriver\");" + NL + "\t";
  protected final String TEXT_78 = NL + "\tString url_";
  protected final String TEXT_79 = " = \"jdbc:ingres://\" + ";
  ...
  protected final String TEXT_100 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_101 = "\", conn_";
  protected final String TEXT_102 = ");" + NL + "\tconn_";
  protected final String TEXT_103 = ".setAutoCommit(false);" + NL + "\t";
  protected final String TEXT_104 = NL + "            java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_110 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_124 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_125 = " = dbMetaData_";
  protected final String TEXT_126 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_127 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_128 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_129 = " = rsTable_";
  protected final String TEXT_130 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_131 = ".equalsIgnoreCase(";
  protected final String TEXT_132 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_133 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  protected final String TEXT_134 = NL + "                if(!whetherExist_";
  protected final String TEXT_135 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_136 = " = conn_";
  protected final String TEXT_137 = ".createStatement();";
  protected final String TEXT_138 = NL + "                    stmtCreate_";
  protected final String TEXT_139 = ".execute(\"";
  protected final String TEXT_140 = ")\");";
  protected final String TEXT_141 = NL + "                }";
  protected final String TEXT_142 = NL + "                if(whetherExist_";
  protected final String TEXT_143 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_144 = " = conn_";
  protected final String TEXT_145 = ".createStatement();";
  protected final String TEXT_146 = NL + "                    stmtDrop_";
  protected final String TEXT_147 = ".execute(\"";
  protected final String TEXT_148 = "\");";
  protected final String TEXT_149 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_157 = ".createStatement();";
  ...
  protected final String TEXT_163 = NL + "\t    String insert_";
  protected final String TEXT_164 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_165 = " + \"\\\" (";
  protected final String TEXT_166 = ") VALUES (";
  protected final String TEXT_167 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_168 = " = conn_";
  protected final String TEXT_169 = ".prepareStatement(insert_";
  protected final String TEXT_170 = ");" + NL + "\t    ";
  protected final String TEXT_171 = NL + "\t    String update_";
  protected final String TEXT_172 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_173 = " + \"\\\" SET ";
  protected final String TEXT_174 = " WHERE ";
  protected final String TEXT_175 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_176 = " = conn_";
  protected final String TEXT_177 = ".prepareStatement(update_";
  protected final String TEXT_178 = ");" + NL + "\t    ";
  protected final String TEXT_179 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_180 = " = conn_";
  protected final String TEXT_181 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + ";
  protected final String TEXT_182 = " + \"\\\" WHERE ";
  ...
  protected final String TEXT_187 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_188 = " = conn_";
  protected final String TEXT_189 = ".prepareStatement(insert_";
  protected final String TEXT_190 = ");" + NL + "\t    String update_";
  protected final String TEXT_191 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_192 = " + \"\\\" SET ";
  protected final String TEXT_193 = " WHERE ";
  protected final String TEXT_194 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_195 = " = conn_";
  protected final String TEXT_196 = ".prepareStatement(update_";
  protected final String TEXT_197 = ");" + NL + "\t    ";
  protected final String TEXT_198 = NL + "\t    String update_";
  protected final String TEXT_199 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_200 = " + \"\\\" SET ";
  protected final String TEXT_201 = " WHERE ";
  protected final String TEXT_202 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_203 = " = conn_";
  protected final String TEXT_204 = ".prepareStatement(update_";
  ...
  protected final String TEXT_213 = NL + "\t    String delete_";
  protected final String TEXT_214 = " = \"DELETE  FROM \\\"\" + ";
  protected final String TEXT_215 = " + \"\\\" WHERE ";
  protected final String TEXT_216 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_217 = " = conn_";
  protected final String TEXT_218 = ".prepareStatement(delete_";
  protected final String TEXT_219 = ");" + NL + "\t    ";
  protected final String TEXT_220 = NL + "        StringBuffer query_";
  protected final String TEXT_221 = " = null;" + NL + "       \t";
  protected final String TEXT_222 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_223 = " = insert_";
  protected final String TEXT_224 = ".split(\"\\\\?\");";
  protected final String TEXT_225 = NL + "\t\t\tupdate_";
  protected final String TEXT_226 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_227 = " = update_";
  protected final String TEXT_228 = ".split(\"\\\\?\");";
  protected final String TEXT_229 = NL + "\t\t\tupdate_";
  protected final String TEXT_230 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_231 = " = update_";
  protected final String TEXT_232 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_233 = " = insert_";
  protected final String TEXT_234 = ".split(\"\\\\?\");";
  protected final String TEXT_235 = NL + "\t\t\tdelete_";
  protected final String TEXT_236 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_237 = " = delete_";
  protected final String TEXT_238 = ".split(\"\\\\?\");";
  protected final String TEXT_239 = NL + "\t\t\treplace_";
  protected final String TEXT_240 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_241 = " = replace_";
  protected final String TEXT_242 = ".split(\"\\\\?\");";
  protected final String TEXT_243 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_244 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_245 = " = insertIgnore_";
  protected final String TEXT_246 = ".split(\"\\\\?\");";
  protected final String TEXT_247 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_248 = " = insert_";
  protected final String TEXT_249 = ".split(\"\\\\?\");";
  protected final String TEXT_250 = NL + NL + "\t        int commitEvery_";
  protected final String TEXT_251 = " = ";
  protected final String TEXT_252 = ";" + NL + "" + NL + "\t        int commitCounter_";
  protected final String TEXT_253 = " = 0;" + NL + "" + NL + "\t    \t";
