...
public class TPostgresPlusOutputMainJava {
  protected static String nl;
  public static synchronized TPostgresPlusOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresPlusOutputMainJava result = new TPostgresPlusOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_109 = "_QUERY\", query_";
  protected final String TEXT_110 = ".toString().trim());";
  protected final String TEXT_111 = NL;
  protected final String TEXT_112 = NL + "                       pstmt_";
  protected final String TEXT_113 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_114 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_115 = "++;";
  protected final String TEXT_116 = NL + "                       try {" + NL + "                           updatedCount_";
  protected final String TEXT_117 = " = updatedCount_";
  protected final String TEXT_118 = " + pstmt_";
  protected final String TEXT_119 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_120 = "++;";
  protected final String TEXT_121 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  ...
  protected final String TEXT_132 = NL + "                                   rejectedCount_";
  protected final String TEXT_133 = " = rejectedCount_";
  ...
  protected final String TEXT_138 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_145 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_146 = " = pstmt_";
  protected final String TEXT_147 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_148 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_149 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_150 = " = rs_";
  protected final String TEXT_151 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_152 = " > 0) {";
  protected final String TEXT_153 = NL + "                        ";
  protected final String TEXT_154 = NL + "                            query_";
  protected final String TEXT_155 = " = ";
  protected final String TEXT_156 = ";";
  protected final String TEXT_157 = NL + "\t                    \t";
  protected final String TEXT_158 = NL + "\t                    ";
  protected final String TEXT_159 = NL + "\t                        query_";
  ...
  protected final String TEXT_196 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_233 = "=0;";
  ...
  protected final String TEXT_244 = NL + "                        query_";
  protected final String TEXT_245 = " = ";
  protected final String TEXT_246 = ";";
  protected final String TEXT_247 = NL + "                globalMap.put(\"";
  protected final String TEXT_248 = "_QUERY\", query_";
  protected final String TEXT_249 = ".toString().trim());";
  protected final String TEXT_250 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_251 = "=pstmtUpdate_";
  protected final String TEXT_252 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_253 = " = updatedCount_";
  protected final String TEXT_254 = "+updateFlag_";
  protected final String TEXT_255 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_256 = " == 0) {" + NL + "            \t";
  protected final String TEXT_257 = NL + "\t\t\t\tquery_";
  protected final String TEXT_258 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_259 = NL + "                        ";
  protected final String TEXT_260 = NL + "                            query_";
  protected final String TEXT_261 = " = ";
  protected final String TEXT_262 = ";";
  protected final String TEXT_263 = NL + "                    globalMap.put(\"";
  protected final String TEXT_264 = "_QUERY\", query_";
  protected final String TEXT_265 = ".toString().trim());";
  protected final String TEXT_266 = NL + "                    insertedCount_";
  protected final String TEXT_267 = " = insertedCount_";
  protected final String TEXT_268 = " + pstmtInsert_";
  protected final String TEXT_269 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_270 = "++;";
  protected final String TEXT_271 = NL + "             }else{" + NL + "             \t   nb_line_";
  protected final String TEXT_272 = "++;" + NL + "             \t   ";
  protected final String TEXT_273 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_280 = "Struct();";
  protected final String TEXT_281 = NL + "                                ";
  protected final String TEXT_282 = ".";
  protected final String TEXT_283 = " = ";
  protected final String TEXT_284 = ".";
  protected final String TEXT_285 = ";";
  protected final String TEXT_286 = NL + "                            rejectedCount_";
  protected final String TEXT_287 = " = rejectedCount_";
  protected final String TEXT_288 = " + 1;";
  protected final String TEXT_289 = NL + "                            ";
  protected final String TEXT_290 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_291 = NL + "                            ";
  protected final String TEXT_292 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_293 = ";";
  protected final String TEXT_294 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_295 = NL + "                }";
  protected final String TEXT_296 = NL + "\t\t\t\t\t";
  protected final String TEXT_297 = NL + "                    \t";
  protected final String TEXT_298 = NL + "\t                        query_";
  protected final String TEXT_299 = " = ";
  protected final String TEXT_300 = ";" + NL + "\t                        ";
  protected final String TEXT_301 = NL + "                    ";
  protected final String TEXT_302 = NL + "                        query_";
  protected final String TEXT_303 = " = ";
  protected final String TEXT_304 = ";";
  protected final String TEXT_305 = NL + "                globalMap.put(\"";
  protected final String TEXT_306 = "_QUERY\", query_";
  protected final String TEXT_307 = ".toString().trim());";
  protected final String TEXT_308 = NL + "                       pstmt_";
  protected final String TEXT_309 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_310 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_311 = "++;";
  protected final String TEXT_312 = NL + "                       try {" + NL + "                           deletedCount_";
  protected final String TEXT_313 = " = deletedCount_";
  protected final String TEXT_314 = " + pstmt_";
  protected final String TEXT_315 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_316 = "++;";
  protected final String TEXT_317 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  protected final String TEXT_318 = " = true;";
  protected final String TEXT_319 = NL + "                               throw(e);";
  protected final String TEXT_320 = NL + "                               nb_line_";
  protected final String TEXT_321 = "++;";
  protected final String TEXT_322 = NL + "                                   ";
  protected final String TEXT_323 = " = new ";
  protected final String TEXT_324 = "Struct();";
  protected final String TEXT_325 = NL + "                                       ";
  protected final String TEXT_326 = ".";
  protected final String TEXT_327 = " = ";
  protected final String TEXT_328 = ".";
  protected final String TEXT_329 = ";";
  protected final String TEXT_330 = NL + "                                   rejectedCount_";
  protected final String TEXT_331 = " = rejectedCount_";
  protected final String TEXT_332 = " + 1;";
  protected final String TEXT_333 = NL + "                                   ";
  protected final String TEXT_334 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_335 = NL + "                                   ";
  protected final String TEXT_336 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_337 = ";";
  protected final String TEXT_338 = NL + "                                   System.err.print(e.getMessage());";
  protected final String TEXT_339 = NL + "                       }";
  protected final String TEXT_340 = NL + "            if(!whetherReject_";
  protected final String TEXT_341 = ") {";
  protected final String TEXT_342 = NL + "                            ";
  protected final String TEXT_343 = " = new ";
  protected final String TEXT_344 = "Struct();";
  ...
  protected final String TEXT_351 = NL + "                if ((batchSize_";
  protected final String TEXT_352 = " > 0) && (batchSize_";
  protected final String TEXT_353 = " <= batchSizeCounter_";
  protected final String TEXT_354 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_355 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_356 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_357 = " = 0;";
  protected final String TEXT_358 = NL + "                        status_";
  protected final String TEXT_359 = " = pstmt_";
  protected final String TEXT_360 = ".executeBatch();";
  protected final String TEXT_361 = NL + "                        for(int countEach_";
  protected final String TEXT_362 = ": status_";
  protected final String TEXT_363 = ") {" + NL + "                            countSum_";
  protected final String TEXT_364 = " += (countEach_";
  protected final String TEXT_365 = " < 0 ? 0 : countEach_";
  protected final String TEXT_366 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_367 = NL + "                            throw(e);";
  protected final String TEXT_368 = NL + "                        for(int countEach_";
  protected final String TEXT_369 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_370 = " += (countEach_";
  protected final String TEXT_371 = " < 0 ? 0 : countEach_";
  protected final String TEXT_372 = ");" + NL + "                        }";
  protected final String TEXT_373 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_374 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_375 = " = pstmt_";
  protected final String TEXT_376 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_377 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_378 = " = tmp_batchUpdateCount_";
  protected final String TEXT_379 = " > countSum_";
  protected final String TEXT_380 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_381 = " : countSum_";
  ...
  protected final String TEXT_393 = NL + "                commitCounter_";
  protected final String TEXT_394 = "++;" + NL + "" + NL + "                if(commitEvery_";
  protected final String TEXT_395 = "<=commitCounter_";
  protected final String TEXT_396 = ") {";
  protected final String TEXT_397 = NL + "                              if(batchSize_";
  protected final String TEXT_398 = " > 0){";
  protected final String TEXT_399 = NL + "                                    conn_";
  protected final String TEXT_400 = ".commit();";
  protected final String TEXT_401 = NL + "                                    commitCounter_";
