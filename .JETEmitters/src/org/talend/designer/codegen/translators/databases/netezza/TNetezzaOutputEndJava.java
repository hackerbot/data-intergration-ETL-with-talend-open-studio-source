...
public class TNetezzaOutputEndJava {
  protected static String nl;
  public static synchronized TNetezzaOutputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNetezzaOutputEndJava result = new TNetezzaOutputEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_55 = NL + "\t    try {" + NL + "\t    \tif(pstmt_";
  ...
  protected final String TEXT_59 = ".executeBatch();" + NL + "\t\t\t\t";
  protected final String TEXT_60 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_61 = ".clearBatch();" + NL + "\t\t    \t";
  ...
  protected final String TEXT_65 = NL + "\t\t    \tupdatedCount_";
  protected final String TEXT_66 = " += pstmt_";
  protected final String TEXT_67 = ".getUpdateCount();" + NL + "\t\t    \t";
  protected final String TEXT_68 = NL + "\t\t    \tdeletedCount_";
  protected final String TEXT_69 = " += pstmt_";
  protected final String TEXT_70 = ".getUpdateCount();" + NL + "\t\t    \t";
  protected final String TEXT_71 = NL + "\t\t    }" + NL + "\t    }catch (java.sql.BatchUpdateException e){" + NL + "\t    \t";
  protected final String TEXT_72 = NL + "\t    \t\tthrow(e);" + NL + "\t    \t";
  protected final String TEXT_73 = NL + "\t    \tSystem.err.println(e.getMessage());" + NL + "\t    \t";
  protected final String TEXT_74 = NL + "\t\t}catch (java.sql.SQLException e){" + NL + "\t\t\t";
  protected final String TEXT_75 = NL + "\t\t\t\tthrow(e);" + NL + "\t\t\t";
  protected final String TEXT_76 = NL + "\t\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_77 = NL + "\t\t}" + NL + "\t    ";
  protected final String TEXT_78 = NL + NL + "\t        if(pstmt_";
  protected final String TEXT_79 = " != null) {" + NL + "\t            pstmt_";
  protected final String TEXT_80 = ".close();" + NL + "" + NL + "\t        }" + NL + "\t        ";
  protected final String TEXT_81 = NL;
  protected final String TEXT_82 = NL + "\t\t\tif(commitCounter_";
  protected final String TEXT_83 = " > 0){" + NL + "\t\t\t\t";
  protected final String TEXT_84 = NL + "\t\t\t\tconn_";
  protected final String TEXT_85 = ".commit();" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_93 = NL + "\tnb_line_deleted_";
  protected final String TEXT_94 = "=nb_line_deleted_";
  protected final String TEXT_95 = "+ deletedCount_";
  protected final String TEXT_96 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_97 = "=nb_line_update_";
  protected final String TEXT_98 = " + updatedCount_";
  protected final String TEXT_99 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_100 = "=nb_line_inserted_";
  protected final String TEXT_101 = " + insertedCount_";
  protected final String TEXT_102 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_103 = "=nb_line_rejected_";
  protected final String TEXT_104 = " + rejectedCount_";
  protected final String TEXT_105 = ";" + NL + "\t";
  protected final String TEXT_106 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_107 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_108 = "_NB_LINE\",nb_line_";
  protected final String TEXT_109 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_110 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_111 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_112 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_113 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_114 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_115 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_116 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_117 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_118 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_119 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_120 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_121 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_122 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_123 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_124 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_125 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_126 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_127 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_128 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_129 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_130 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_131 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_134 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_135 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  ...
  protected final String TEXT_146 = "_NB_LINE_REJECTED\", nb_line_rejected_";
