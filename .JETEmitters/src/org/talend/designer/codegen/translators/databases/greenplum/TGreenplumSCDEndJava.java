...
public class TGreenplumSCDEndJava {
  protected static String nl;
  public static synchronized TGreenplumSCDEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGreenplumSCDEndJava result = new TGreenplumSCDEndJava();
    nl = null;
    return result;
  }
