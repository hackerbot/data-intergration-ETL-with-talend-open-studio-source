...
public class TAccessOutputBeginJava {
  protected static String nl;
  public static synchronized TAccessOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAccessOutputBeginJava result = new TAccessOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_61 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_62 = " = ";
  protected final String TEXT_63 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_64 = " = false;" + NL + "java.sql.Connection conn_";
  protected final String TEXT_65 = " = null;";
  protected final String TEXT_66 = NL + "\tconn_";
  protected final String TEXT_67 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_68 = "\");" + NL + "\t";
  protected final String TEXT_69 = NL + "\t";
  protected final String TEXT_70 = NL + "java.lang.Class.forName(\"net.ucanaccess.jdbc.UcanaccessDriver\");";
  protected final String TEXT_71 = NL + "String url_";
  protected final String TEXT_72 = " = \"jdbc:ucanaccess://\" + ";
  protected final String TEXT_73 = ";" + NL + "" + NL + "String dbUser_";
  ...
  protected final String TEXT_89 = ", dbUser_";
  protected final String TEXT_90 = ", dbPwd_";
  protected final String TEXT_91 = ");";
  protected final String TEXT_92 = NL + "\tString atnParams_";
  protected final String TEXT_93 = " = ";
  protected final String TEXT_94 = ";" + NL + "\tatnParams_";
  protected final String TEXT_95 = " = atnParams_";
  protected final String TEXT_96 = ".replaceAll(\"&\", \"\\n\");" + NL + "\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_97 = " = new java.util.Properties();" + NL + "\tatnParamsPrope_";
  protected final String TEXT_98 = ".put(\"user\",dbUser_";
  protected final String TEXT_99 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_100 = ".put(\"password\",dbPwd_";
  protected final String TEXT_101 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_102 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_103 = ".getBytes()));" + NL + "  " + NL + "\tconn_";
  protected final String TEXT_104 = " =  java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_105 = ", atnParamsPrope_";
  protected final String TEXT_106 = ");";
  protected final String TEXT_107 = NL + "resourceMap.put(\"conn_";
  protected final String TEXT_108 = "\", conn_";
  protected final String TEXT_109 = ");";
  protected final String TEXT_110 = NL + "\t\tconn_";
  protected final String TEXT_111 = ".setAutoCommit(false);\t" + NL + "\t    int commitEvery_";
  protected final String TEXT_112 = " = ";
  protected final String TEXT_113 = ";" + NL + "" + NL + "\t    int commitCounter_";
  ...
  protected final String TEXT_117 = ".createStatement();";
  protected final String TEXT_118 = NL + "            stmtDrop_";
  protected final String TEXT_119 = ".execute(\"";
  protected final String TEXT_120 = "\");";
  protected final String TEXT_121 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_122 = " = conn_";
  protected final String TEXT_123 = ".createStatement();";
  ...
  protected final String TEXT_129 = ".createStatement();";
  protected final String TEXT_130 = NL + "            stmtCreate_";
  protected final String TEXT_131 = ".execute(\"";
  protected final String TEXT_132 = ")\");";
  protected final String TEXT_133 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_134 = " = conn_";
  protected final String TEXT_135 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_136 = " = dbMetaData_";
  protected final String TEXT_137 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_138 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_139 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_140 = " = rsTable_";
  protected final String TEXT_141 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_142 = ".equalsIgnoreCase(";
  protected final String TEXT_143 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_144 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  protected final String TEXT_145 = NL + "                if(!whetherExist_";
  protected final String TEXT_146 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_160 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_161 = " = conn_";
  protected final String TEXT_162 = ".createStatement();";
  protected final String TEXT_163 = NL + "                stmtCreate_";
  protected final String TEXT_164 = ".execute(\"";
  protected final String TEXT_165 = ")\");";
  protected final String TEXT_166 = "                ";
  protected final String TEXT_167 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_168 = " = conn_";
  protected final String TEXT_169 = ".createStatement();";
  protected final String TEXT_170 = NL + "            deletedCount_";
  protected final String TEXT_171 = " = deletedCount_";
  protected final String TEXT_172 = " + stmtClear_";
  protected final String TEXT_173 = ".executeUpdate(\"";
  protected final String TEXT_174 = "\");";
  protected final String TEXT_175 = "\t" + NL + "\t    String insert_";
  protected final String TEXT_176 = " = \"INSERT INTO [\" + ";
  protected final String TEXT_177 = " + \"] (";
  protected final String TEXT_178 = ") VALUES (";
  protected final String TEXT_179 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_180 = " = conn_";
  protected final String TEXT_181 = ".prepareStatement(insert_";
  protected final String TEXT_182 = ");" + NL + "\t    ";
  protected final String TEXT_183 = NL + "\t    String update_";
  protected final String TEXT_184 = " = \"UPDATE [\" + ";
  protected final String TEXT_185 = " + \"] SET ";
  protected final String TEXT_186 = " WHERE ";
  protected final String TEXT_187 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_188 = " = conn_";
  protected final String TEXT_189 = ".prepareStatement(update_";
  protected final String TEXT_190 = ");" + NL + "\t    ";
  protected final String TEXT_191 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_192 = " = conn_";
  protected final String TEXT_193 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + ";
  protected final String TEXT_194 = " + \"] WHERE ";
  protected final String TEXT_195 = "\");\t" + NL + "\t    String insert_";
  protected final String TEXT_196 = " = \"INSERT INTO [\" + ";
  protected final String TEXT_197 = "+\"] (";
  protected final String TEXT_198 = ") VALUES (";
  protected final String TEXT_199 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_200 = " = conn_";
  protected final String TEXT_201 = ".prepareStatement(insert_";
  protected final String TEXT_202 = ");" + NL + "\t    String update_";
  protected final String TEXT_203 = " = \"UPDATE [\" + ";
  protected final String TEXT_204 = " + \"] SET ";
  protected final String TEXT_205 = " WHERE ";
  protected final String TEXT_206 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_207 = " = conn_";
  protected final String TEXT_208 = ".prepareStatement(update_";
  ...
  protected final String TEXT_218 = " = \"INSERT INTO [\" + ";
  protected final String TEXT_219 = "+\"] (";
  protected final String TEXT_220 = ") VALUES (";
  protected final String TEXT_221 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_222 = " = conn_";
  protected final String TEXT_223 = ".prepareStatement(insert_";
  protected final String TEXT_224 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_225 = NL + "\t    String delete_";
  protected final String TEXT_226 = " = \"DELETE  FROM [\" + ";
  protected final String TEXT_227 = " + \"] WHERE ";
  protected final String TEXT_228 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_229 = " = conn_";
  protected final String TEXT_230 = ".prepareStatement(delete_";
  protected final String TEXT_231 = ");" + NL + "\t    ";
  protected final String TEXT_232 = NL + "        StringBuffer query_";
  protected final String TEXT_233 = " = null;" + NL + "       \t";
  protected final String TEXT_234 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_235 = " = insert_";
  protected final String TEXT_236 = ".split(\"\\\\?\");";
  protected final String TEXT_237 = NL + "\t\t\tupdate_";
  protected final String TEXT_238 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_239 = " = update_";
  protected final String TEXT_240 = ".split(\"\\\\?\");";
  protected final String TEXT_241 = NL + "\t\t\tupdate_";
  protected final String TEXT_242 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_243 = " = update_";
  protected final String TEXT_244 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_245 = " = insert_";
  protected final String TEXT_246 = ".split(\"\\\\?\");";
  protected final String TEXT_247 = NL + "\t\t\tdelete_";
  protected final String TEXT_248 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_249 = " = delete_";
  protected final String TEXT_250 = ".split(\"\\\\?\");";
  protected final String TEXT_251 = NL + "\t\t\treplace_";
  protected final String TEXT_252 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_253 = " = replace_";
  protected final String TEXT_254 = ".split(\"\\\\?\");";
  protected final String TEXT_255 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_256 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_257 = " = insertIgnore_";
  protected final String TEXT_258 = ".split(\"\\\\?\");";
  protected final String TEXT_259 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_260 = " = insert_";
  protected final String TEXT_261 = ".split(\"\\\\?\");";
