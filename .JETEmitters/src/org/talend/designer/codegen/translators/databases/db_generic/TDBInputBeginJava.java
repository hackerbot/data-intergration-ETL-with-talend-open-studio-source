...
public class TDBInputBeginJava
{
  ...
  protected final String TEXT_184 = " = \"jdbc:odbc:\"+";
  protected final String TEXT_185 = ";";
  protected final String TEXT_186 = NL + "\t\t        String url_";
  protected final String TEXT_187 = " = \"jdbc:odbc:\"+";
  ...
  protected final String TEXT_195 = " = \"jdbc:postgresql://\"+";
  protected final String TEXT_196 = "+\":\"+";
  protected final String TEXT_197 = "+\"/\"+";
  protected final String TEXT_198 = ";";
  protected final String TEXT_199 = NL + "\t\t        String url_";
  protected final String TEXT_200 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_201 = " + \":\" + ";
  protected final String TEXT_202 = " + \"/\" + ";
  protected final String TEXT_203 = ";";
  protected final String TEXT_204 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_205 = " = \"";
  protected final String TEXT_206 = "\";" + NL + "\t\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_207 = ");" + NL + "\t\t\t";
  protected final String TEXT_208 = NL + "\t        String dbUser_";
  ...
  protected final String TEXT_220 = ";" + NL + "" + NL + "\t\t\tString dbProperties_";
  protected final String TEXT_221 = " = ";
  protected final String TEXT_222 = ";" + NL + "\t\t\t";
  protected final String TEXT_223 = NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_224 = " == null || dbProperties_";
  protected final String TEXT_225 = ".trim().length() == 0) {" + NL + "\t\t\t\tconn_";
  protected final String TEXT_226 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_227 = ",dbUser_";
  protected final String TEXT_228 = ",dbPwd_";
  protected final String TEXT_229 = ");" + NL + "\t\t\t}else{" + NL + "\t\t\t\tdbProperties_";
  protected final String TEXT_230 = " = dbProperties_";
  ...
  protected final String TEXT_237 = ".load(new java.io.ByteArrayInputStream(dbProperties_";
  ...
  protected final String TEXT_242 = NL + "            java.sql.Timestamp timestamp_";
  ...
  protected final String TEXT_246 = ");" + NL + "            if(timestamp_";
  protected final String TEXT_247 = " != null) {";
  protected final String TEXT_248 = NL + "                ";
  protected final String TEXT_249 = ".";
  protected final String TEXT_250 = " = new java.util.Date(timestamp_";
  protected final String TEXT_251 = ".getTime());" + NL + "            } else {";
  protected final String TEXT_252 = NL + "                ";
  protected final String TEXT_253 = ".";
  protected final String TEXT_254 = " =  null;" + NL + "            }";
  protected final String TEXT_255 = NL + "\t\t\tObject value_";
  protected final String TEXT_256 = " = rs_";
  protected final String TEXT_257 = ".get";
  protected final String TEXT_258 = "(";
  protected final String TEXT_259 = "column_index_";
  protected final String TEXT_260 = ");" + NL + "\t\t\tif(value_";
  protected final String TEXT_261 = " != null) {";
  protected final String TEXT_262 = NL + "\t\t\t\t\tvalue_";
  protected final String TEXT_263 = " = new ";
  protected final String TEXT_264 = "(";
  protected final String TEXT_265 = ".parse";
  protected final String TEXT_266 = "(value_";
  protected final String TEXT_267 = ".toString()));";
  protected final String TEXT_268 = NL + "\t\t\t\t\tvalue_";
  protected final String TEXT_269 = " = new ";
  protected final String TEXT_270 = "(";
  protected final String TEXT_271 = ".parse";
  ...
  protected final String TEXT_282 = NL + "\t\t\t\t\tthrow new RuntimeException(\"Null value in non-Nullable column\");";
  protected final String TEXT_283 = NL + "\t\t\t}";
  protected final String TEXT_284 = NL + "\t\t\ttry {" + NL + "            \ttmpContent_";
  ...
  protected final String TEXT_288 = ");" + NL + "\t\t\t} catch (java.sql.SQLException e) {" + NL + "\t\t\t\tif (\"No data found\".equals(e.getMessage())) {" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_289 = " = \"\";" + NL + "\t\t\t\t}else {" + NL + "\t\t\t\t\tthrow e;" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "            if(tmpContent_";
  protected final String TEXT_290 = " != null) {";
  protected final String TEXT_291 = NL + "                ";
  protected final String TEXT_292 = ".";
  protected final String TEXT_293 = " = tmpContent_";
  protected final String TEXT_294 = ";" + NL + "            } else {";
  protected final String TEXT_295 = NL + "                ";
  protected final String TEXT_296 = ".";
  protected final String TEXT_297 = " = null;" + NL + "            }";
  protected final String TEXT_298 = NL + "    " + NL + "\t";
  protected final String TEXT_299 = NL + "\t\t    int nb_line_";
  protected final String TEXT_300 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_301 = " = null;";
  protected final String TEXT_302 = NL + "\t\t        conn_";
  protected final String TEXT_303 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_304 = "\");";
  protected final String TEXT_305 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_306 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_307 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_308 = " = dataSources_";
  protected final String TEXT_309 = ".get(";
  protected final String TEXT_310 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_311 = "\", conn_";
  protected final String TEXT_312 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_313 = NL + "\t\t\t\t";
  protected final String TEXT_314 = NL + "\t\t\t\t";
  protected final String TEXT_315 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_316 = " =  conn_";
  protected final String TEXT_317 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_318 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_319 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_320 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_321 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_322 = NL + "                 conn_";
  protected final String TEXT_323 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_324 = NL + "               ";
  protected final String TEXT_325 = " + \"=\" + ";
  protected final String TEXT_326 = " + \";\" +";
  protected final String TEXT_327 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_328 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_329 = ");";
  protected final String TEXT_330 = NL + "\t\t    ";
  protected final String TEXT_331 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_332 = " = ";
  protected final String TEXT_333 = ";" + NL + "\t\t\t";
  protected final String TEXT_334 = NL + "                log.info(\"";
  protected final String TEXT_335 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_336 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_337 = NL;
  protected final String TEXT_338 = NL + "                       globalMap.put(\"";
  protected final String TEXT_339 = "_QUERY\",dbquery_";
  protected final String TEXT_340 = ");";
  protected final String TEXT_341 = NL + "                       globalMap.put(\"";
  protected final String TEXT_342 = "_QUERY\",dbquery_";
  protected final String TEXT_343 = ");";
  protected final String TEXT_344 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_345 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_346 = " = stmt_";
  protected final String TEXT_347 = ".executeQuery(dbquery_";
  protected final String TEXT_348 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_349 = " = rs_";
  protected final String TEXT_350 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_351 = " = rsmd_";
  protected final String TEXT_352 = ".getColumnCount();" + NL;
  protected final String TEXT_353 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_354 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_355 = ".setDbmsId(\"";
  protected final String TEXT_356 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_357 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_358 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_359 = ".add(\"";
  protected final String TEXT_360 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_361 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_362 = " = ";
  protected final String TEXT_363 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_364 = "; i <= rsmd_";
  protected final String TEXT_365 = ".getColumnCount()-";
  protected final String TEXT_366 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_367 = ".contains(rsmd_";
  protected final String TEXT_368 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_369 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_370 = ".setName(rsmd_";
  protected final String TEXT_371 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_372 = ".setDbName(rsmd_";
  protected final String TEXT_373 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_374 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_375 = "\", rsmd_";
  protected final String TEXT_376 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_377 = ".getPrecision(i), rsmd_";
  protected final String TEXT_378 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_379 = ".setDbType(rsmd_";
  protected final String TEXT_380 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_381 = ".setDbTypeId(rsmd_";
  protected final String TEXT_382 = ".getColumnType(i));";
  protected final String TEXT_383 = NL + "                \tdcm_";
  protected final String TEXT_384 = ".setFormat(";
  protected final String TEXT_385 = ");";
  protected final String TEXT_386 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_387 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_388 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_389 = ".setLength(rsmd_";
  protected final String TEXT_390 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_391 = ".setLength(rsmd_";
  protected final String TEXT_392 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_393 = NL + "\t\t\tdcm_";
  protected final String TEXT_394 = ".setLength(rsmd_";
  protected final String TEXT_395 = ".getPrecision(i));";
  protected final String TEXT_396 = NL + "                \tdcm_";
  protected final String TEXT_397 = ".setPrecision(rsmd_";
  protected final String TEXT_398 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_399 = ".setNullable(rsmd_";
  protected final String TEXT_400 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_401 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_402 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_403 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_404 = ".metadatas.add(dcm_";
  protected final String TEXT_405 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_406 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_407 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_408 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_409 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_410 = NL + "\t\t    ";
  protected final String TEXT_411 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_412 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_413 = NL + "\t\t    while (rs_";
  protected final String TEXT_414 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_415 = "++;" + NL + "\t\t        ";
  protected final String TEXT_416 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_417 = " = ";
  protected final String TEXT_418 = " + dcg_";
  protected final String TEXT_419 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_420 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_421 = " = ";
  protected final String TEXT_422 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_423 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_424 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_425 = " < ";
  protected final String TEXT_426 = "column_index_";
  protected final String TEXT_427 = ") {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_428 = ".";
  protected final String TEXT_429 = " = ";
  protected final String TEXT_430 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  protected final String TEXT_431 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_432 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_433 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_434 = NL + "\t\t                            ";
  protected final String TEXT_435 = ".";
  protected final String TEXT_436 = " = (List)rs_";
  protected final String TEXT_437 = ".getObject(";
  protected final String TEXT_438 = "column_index_";
  protected final String TEXT_439 = ");";
  protected final String TEXT_440 = NL + "\t\t                         ";
  protected final String TEXT_441 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_442 = ".getObject(";
  protected final String TEXT_443 = "column_index_";
  protected final String TEXT_444 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_445 = NL + "                                    ";
  protected final String TEXT_446 = ".";
  protected final String TEXT_447 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  protected final String TEXT_448 = NL + "                                      ";
  protected final String TEXT_449 = ".";
  protected final String TEXT_450 = " = null;" + NL + "                                    }";
  protected final String TEXT_451 = NL + "                                        if (";
  protected final String TEXT_452 = ".";
  protected final String TEXT_453 = " != null) {";
  protected final String TEXT_454 = NL + "                                        ";
  protected final String TEXT_455 = ".";
  protected final String TEXT_456 = ".setEPSG(";
  protected final String TEXT_457 = ");" + NL + "                                        }";
  protected final String TEXT_458 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_459 = NL + "                                  ";
  protected final String TEXT_460 = ".";
  protected final String TEXT_461 = "=dcg_";
  protected final String TEXT_462 = ";";
  protected final String TEXT_463 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_464 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_465 = " = ";
  protected final String TEXT_466 = "; i_";
  protected final String TEXT_467 = "  <= rsmd_";
  protected final String TEXT_468 = ".getColumnCount(); i_";
  protected final String TEXT_469 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_470 = ".getColumnTypeName(i_";
  protected final String TEXT_471 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_472 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_473 = ".getClob(i_";
  protected final String TEXT_474 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_475 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_476 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_477 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_478 = ".add(tNTextImpl_";
  protected final String TEXT_479 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_480 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_481 = ".";
  protected final String TEXT_482 = ", rs_";
  protected final String TEXT_483 = ", fixedColumnCount_";
  protected final String TEXT_484 = ",list_";
  protected final String TEXT_485 = ",";
  protected final String TEXT_486 = ");";
  protected final String TEXT_487 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_488 = ".";
  protected final String TEXT_489 = ", rs_";
  protected final String TEXT_490 = ", fixedColumnCount_";
  protected final String TEXT_491 = ",";
  protected final String TEXT_492 = ");";
  protected final String TEXT_493 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_494 = ".";
  protected final String TEXT_495 = ", rs_";
  protected final String TEXT_496 = ", fixedColumnCount_";
  protected final String TEXT_497 = ",";
  protected final String TEXT_498 = ");";
  protected final String TEXT_499 = NL + "                                  Object geom = rs_";
  protected final String TEXT_500 = ".getObject(";
  protected final String TEXT_501 = "column_index_";
  protected final String TEXT_502 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_503 = ".";
  protected final String TEXT_504 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_510 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_511 = " - Retrieving the record \" + nb_line_";
