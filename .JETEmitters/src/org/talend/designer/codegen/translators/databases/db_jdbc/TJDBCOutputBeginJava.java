...
public class TJDBCOutputBeginJava {
  ...
  protected final String TEXT_56 = " = 0;" + NL + "" + NL + "int tmp_batchUpdateCount_";
  ...
  protected final String TEXT_60 = " = 0;" + NL + "int rejectedCount_";
  protected final String TEXT_61 = " = 0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_62 = " = false;" + NL;
  protected final String TEXT_63 = NL + "\tjava.sql.Connection connection_";
  protected final String TEXT_64 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_65 = "\");";
  protected final String TEXT_66 = NL + "\t\tif (null == connection_";
  protected final String TEXT_67 = ") {" + NL + "\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_68 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\tconnection_";
  protected final String TEXT_69 = " = dataSources_";
  protected final String TEXT_70 = ".get(";
  protected final String TEXT_71 = ").getConnection();" + NL + "\t\t\tif (connection_";
  protected final String TEXT_72 = " != null) {" + NL + "\t\t\t\tconnection_";
  protected final String TEXT_73 = ".setAutoCommit(";
  protected final String TEXT_74 = ");" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_75 = NL + NL + "\tjava.sql.Connection connection_";
  ...
  protected final String TEXT_79 = ") {" + NL + "\t\t\tconnection_";
  ...
  protected final String TEXT_85 = ");" + NL + "\t\t\tString connectionString_";
  ...
  protected final String TEXT_96 = NL + "\t\t\tconnection_";
  protected final String TEXT_97 = " = java.sql.DriverManager.getConnection(connectionString_";
  ...
  protected final String TEXT_104 = "\", connection_";
  protected final String TEXT_105 = ");";
  protected final String TEXT_106 = NL + "        connection_";
  protected final String TEXT_107 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_108 = " = ";
  protected final String TEXT_109 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_110 = " = 0;";
  protected final String TEXT_111 = NL + "   int batchSize_";
  protected final String TEXT_112 = " = ";
  protected final String TEXT_113 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_114 = "=0;";
  protected final String TEXT_115 = NL;
  protected final String TEXT_116 = NL + "\tjava.sql.Statement statementClear_";
  protected final String TEXT_117 = " = connection_";
  protected final String TEXT_118 = ".createStatement();" + NL + "\tdeletedCount_";
  protected final String TEXT_119 = " = deletedCount_";
  protected final String TEXT_120 = " + statementClear_";
  protected final String TEXT_121 = ".executeUpdate(\"delete from \" + ";
  protected final String TEXT_122 = ");" + NL + "\t";
  protected final String TEXT_123 = NL + "\t\tString insert_";
  protected final String TEXT_124 = " = \"INSERT INTO \" + ";
  protected final String TEXT_125 = " + \" (";
  protected final String TEXT_126 = ") VALUES (";
  protected final String TEXT_127 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_128 = " = connection_";
  protected final String TEXT_129 = ".prepareStatement(insert_";
  protected final String TEXT_130 = ");" + NL + "\t\t";
  protected final String TEXT_131 = NL + "\t\tString update_";
  protected final String TEXT_132 = " = \"UPDATE \" + ";
  protected final String TEXT_133 = " + \" SET ";
  protected final String TEXT_134 = " WHERE ";
  protected final String TEXT_135 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_136 = " = connection_";
  protected final String TEXT_137 = ".prepareStatement(update_";
  protected final String TEXT_138 = ");" + NL + "\t\t";
  protected final String TEXT_139 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_140 = " = connection_";
  protected final String TEXT_141 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_142 = " + \" WHERE ";
  protected final String TEXT_143 = "\");" + NL + "\t\tString insert_";
  protected final String TEXT_144 = " = \"INSERT INTO \" + ";
  protected final String TEXT_145 = " + \" (";
  protected final String TEXT_146 = ") VALUES (";
  protected final String TEXT_147 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_148 = " = connection_";
  protected final String TEXT_149 = ".prepareStatement(insert_";
  protected final String TEXT_150 = ");" + NL + "\t\tString update_";
  protected final String TEXT_151 = " = \"UPDATE \" + ";
  protected final String TEXT_152 = " + \" SET ";
  protected final String TEXT_153 = " WHERE ";
  protected final String TEXT_154 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_155 = " = connection_";
  protected final String TEXT_156 = ".prepareStatement(update_";
  protected final String TEXT_157 = ");" + NL + "\t\t";
  protected final String TEXT_158 = NL + "\t\tString update_";
  protected final String TEXT_159 = " = \"UPDATE \" + ";
  protected final String TEXT_160 = " + \" SET ";
  protected final String TEXT_161 = " WHERE ";
  protected final String TEXT_162 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_163 = " = connection_";
  protected final String TEXT_164 = ".prepareStatement(update_";
  protected final String TEXT_165 = ");" + NL + "\t\tString insert_";
  protected final String TEXT_166 = " = \"INSERT INTO \" + ";
  protected final String TEXT_167 = " + \" (";
  protected final String TEXT_168 = ") VALUES (";
  protected final String TEXT_169 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_170 = " = connection_";
  protected final String TEXT_171 = ".prepareStatement(insert_";
  protected final String TEXT_172 = ");" + NL + "\t\t";
  protected final String TEXT_173 = NL + "\t\tString delete_";
  protected final String TEXT_174 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_175 = " + \" WHERE ";
  protected final String TEXT_176 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_177 = " = connection_";
  protected final String TEXT_178 = ".prepareStatement(delete_";
  protected final String TEXT_179 = ");" + NL + "\t\t";
  protected final String TEXT_180 = NL + "        StringBuffer query_";
  protected final String TEXT_181 = " = null;" + NL + "       \t";
  protected final String TEXT_182 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_183 = " = insert_";
  protected final String TEXT_184 = ".split(\"\\\\?\");";
  protected final String TEXT_185 = NL + "\t\t\tupdate_";
  protected final String TEXT_186 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_187 = " = update_";
  protected final String TEXT_188 = ".split(\"\\\\?\");";
  protected final String TEXT_189 = NL + "\t\t\tupdate_";
  protected final String TEXT_190 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_191 = " = update_";
  protected final String TEXT_192 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_193 = " = insert_";
  protected final String TEXT_194 = ".split(\"\\\\?\");";
  protected final String TEXT_195 = NL + "\t\t\tdelete_";
  protected final String TEXT_196 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_197 = " = delete_";
  protected final String TEXT_198 = ".split(\"\\\\?\");";
  protected final String TEXT_199 = NL + "\t\t\treplace_";
  protected final String TEXT_200 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_201 = " = replace_";
  protected final String TEXT_202 = ".split(\"\\\\?\");";
  protected final String TEXT_203 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_204 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_205 = " = insertIgnore_";
  protected final String TEXT_206 = ".split(\"\\\\?\");";
  protected final String TEXT_207 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_208 = " = insert_";
