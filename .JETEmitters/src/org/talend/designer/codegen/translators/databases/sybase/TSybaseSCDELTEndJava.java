...
public class TSybaseSCDELTEndJava {
  protected static String nl;
  public static synchronized TSybaseSCDELTEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSybaseSCDELTEndJava result = new TSybaseSCDELTEndJava();
    nl = null;
    return result;
  }
