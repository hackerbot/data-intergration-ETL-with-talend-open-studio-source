...
public class TMysqlSCDBeginJava {
  protected static String nl;
  public static synchronized TMysqlSCDBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMysqlSCDBeginJava result = new TMysqlSCDBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_7 = " = 0;" + NL + "    String tableName_";
  ...
  protected final String TEXT_36 = NL + "\t   \t" + NL + "        java.sql.Connection connection_";
  ...
  protected final String TEXT_42 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_43 = " = connection_";
  protected final String TEXT_44 = ".createStatement();" + NL + "            stmtCreate_";
  protected final String TEXT_45 = ".execute(\"";
  protected final String TEXT_46 = "\");" + NL + "            stmtCreate_";
  protected final String TEXT_47 = ".close();";
  protected final String TEXT_48 = NL + "\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_49 = " = connection_";
  protected final String TEXT_50 = ".getMetaData();";
  protected final String TEXT_51 = "   " + NL + "\t\t\t\tString dbschemaForSearch_";
  protected final String TEXT_52 = " = null;" + NL + "\t\t\t\tif (schema_";
  protected final String TEXT_53 = " == null" + NL + "\t\t\t\t\t\t|| schema_";
  protected final String TEXT_54 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tdbschemaForSearch_";
  protected final String TEXT_55 = " = ((String)";
  protected final String TEXT_56 = ").toUpperCase();" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdbschemaForSearch_";
  protected final String TEXT_57 = " = schema_";
  protected final String TEXT_58 = ".toUpperCase();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tString tableName4Search_";
  protected final String TEXT_59 = " = ";
  protected final String TEXT_60 = ";" + NL + "            \tif(tableName4Search_";
  protected final String TEXT_61 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableName4Search_";
  protected final String TEXT_62 = " = tableName4Search_";
  protected final String TEXT_63 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableName4Search_";
  protected final String TEXT_64 = " = tableName4Search_";
  protected final String TEXT_65 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_66 = " = dbMetaData_";
  protected final String TEXT_67 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_68 = ", tableName4Search_";
  protected final String TEXT_69 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_70 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_71 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_72 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  protected final String TEXT_73 = ".close();" + NL + "\t            ";
  protected final String TEXT_74 = NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_75 = " = dbMetaData_";
  protected final String TEXT_76 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_77 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_78 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_79 = " = rsTable_";
  protected final String TEXT_80 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_81 = ".equalsIgnoreCase(";
  protected final String TEXT_82 = ")) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_83 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }";
  protected final String TEXT_84 = "            " + NL + "            if(!whetherExist_";
  protected final String TEXT_85 = ") {" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_86 = " = connection_";
  protected final String TEXT_87 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_91 = NL + "        " + NL + "    java.util.Calendar calendar_";
  protected final String TEXT_92 = " = java.util.Calendar.getInstance();" + NL + "    java.util.Calendar calendarYear0_";
  protected final String TEXT_93 = " = java.util.Calendar.getInstance();" + NL + "    " + NL + "    calendar_";
  protected final String TEXT_94 = ".set(1, 0, 1, 0, 0, 0);" + NL + "    calendarYear0_";
  protected final String TEXT_95 = ".set(0,0,0,0,0,0);" + NL + "    " + NL + "    final java.util.Date dateYear0_";
  protected final String TEXT_96 = " = calendarYear0_";
  protected final String TEXT_97 = ".getTime();" + NL + "    final long year1_";
  protected final String TEXT_98 = " = calendar_";
  protected final String TEXT_99 = ".getTime().getTime();" + NL + "    " + NL + "    " + NL + "    calendar_";
  protected final String TEXT_100 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "    final long year10000_";
  protected final String TEXT_101 = " = calendar_";
  protected final String TEXT_102 = ".getTime().getTime();" + NL + "    long date_";
  protected final String TEXT_103 = " = 0;    " + NL + "    String dateStr_";
  protected final String TEXT_104 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_105 = " = null;    ";
  protected final String TEXT_106 = NL + "        String searching_";
  protected final String TEXT_107 = " = \"";
  protected final String TEXT_108 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_109 = " = connection_";
  protected final String TEXT_110 = ".prepareStatement(searching_";
  protected final String TEXT_111 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_112 = " = null;";
  protected final String TEXT_113 = NL + "        String search_";
  protected final String TEXT_114 = " = \"";
  protected final String TEXT_115 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_116 = " = connection_";
  protected final String TEXT_117 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_118 = " = statement_";
  protected final String TEXT_119 = ".executeQuery(search_";
  protected final String TEXT_120 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_121 = ", SCDStruct_";
  protected final String TEXT_122 = "> cache_";
  protected final String TEXT_123 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_124 = ", SCDStruct_";
  protected final String TEXT_125 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_126 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_127 = " sk_";
  protected final String TEXT_128 = " = new SCDSK_";
  protected final String TEXT_129 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_130 = " row_";
  protected final String TEXT_131 = " = new SCDStruct_";
  protected final String TEXT_132 = "();";
  protected final String TEXT_133 = NL + "                    tmpValue_";
  protected final String TEXT_134 = " = resultSet_";
  protected final String TEXT_135 = ".getString(";
  protected final String TEXT_136 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_137 = " != null && tmpValue_";
  protected final String TEXT_138 = ".length() > 0) {";
  protected final String TEXT_139 = NL + "                        ";
  protected final String TEXT_140 = ".";
  protected final String TEXT_141 = " = tmpValue_";
  protected final String TEXT_142 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_143 = NL + "                            if(tmpValue_";
  protected final String TEXT_144 = " == null) {";
  protected final String TEXT_145 = NL + "                                ";
  protected final String TEXT_146 = ".";
  protected final String TEXT_147 = " = null;" + NL + "                            } else {";
  protected final String TEXT_148 = NL + "                                ";
  protected final String TEXT_149 = ".";
  protected final String TEXT_150 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_151 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_152 = ")) {";
  protected final String TEXT_153 = NL + "                                ";
  protected final String TEXT_154 = ".";
  protected final String TEXT_155 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_156 = "' in '";
  protected final String TEXT_157 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_158 = NL + "                    }";
  protected final String TEXT_159 = NL + "                    dateStr_";
  protected final String TEXT_160 = " = resultSet_";
  protected final String TEXT_161 = ".getString(";
  protected final String TEXT_162 = ");" + NL + "                    if(dateStr_";
  protected final String TEXT_163 = " != null) {" + NL + "                        if(!(\"0000-00-00\").equals(dateStr_";
  protected final String TEXT_164 = ") && !(\"0000-00-00 00:00:00\").equals(dateStr_";
  protected final String TEXT_165 = ")) {";
  protected final String TEXT_166 = NL + "                            ";
  protected final String TEXT_167 = ".";
  protected final String TEXT_168 = " = new java.util.Date(resultSet_";
  protected final String TEXT_169 = ".getTimestamp(";
  protected final String TEXT_170 = ").getTime());" + NL + "                        } else {";
  protected final String TEXT_171 = NL + "                            ";
  protected final String TEXT_172 = ".";
  protected final String TEXT_173 = " = (java.util.Date) dateYear0_";
  protected final String TEXT_174 = ".clone();" + NL + "                        }" + NL + "                    } else {";
  protected final String TEXT_175 = NL + "                        ";
  protected final String TEXT_176 = ".";
  protected final String TEXT_177 = " = null;" + NL + "                    }";
  protected final String TEXT_178 = NL + "                    if(resultSet_";
  protected final String TEXT_179 = ".getObject(";
  protected final String TEXT_180 = ") != null) {";
  protected final String TEXT_181 = NL + "                        ";
  protected final String TEXT_182 = ".";
  protected final String TEXT_183 = " = resultSet_";
  protected final String TEXT_184 = ".get";
  protected final String TEXT_185 = "(";
  protected final String TEXT_186 = ");" + NL + "                    }";
  protected final String TEXT_187 = NL + "            cache_";
  protected final String TEXT_188 = ".put(sk_";
  protected final String TEXT_189 = ", row_";
  protected final String TEXT_190 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_191 = ".close();" + NL + "        statement_";
  protected final String TEXT_192 = ".close();";
  protected final String TEXT_193 = NL + "            System.out.println(\"[";
  protected final String TEXT_194 = "] comparison cache loaded\");";
  protected final String TEXT_195 = NL + "        ";
  protected final String TEXT_196 = " nextSurrogateKey_";
  protected final String TEXT_197 = " = 1;";
  protected final String TEXT_198 = NL + "            if(cache_";
  protected final String TEXT_199 = ".size() > 0) {";
  protected final String TEXT_200 = NL + "        String tmpQuery_";
  protected final String TEXT_201 = " = \"SELECT MAX(`";
  protected final String TEXT_202 = "`) FROM `\" + tableName_";
  protected final String TEXT_203 = " + \"`\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_204 = " = connection_";
  protected final String TEXT_205 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_206 = " = tmpStmt_";
  protected final String TEXT_207 = ".executeQuery(tmpQuery_";
  protected final String TEXT_208 = ");";
  protected final String TEXT_209 = NL + "        if(tmpRS_";
  protected final String TEXT_210 = ".next() && tmpRS_";
  protected final String TEXT_211 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_212 = " = tmpRS_";
  protected final String TEXT_213 = ".get";
  protected final String TEXT_214 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_215 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_216 = ".close();";
  protected final String TEXT_217 = NL + "            }            ";
  protected final String TEXT_218 = NL + "    String insertionSQL_";
  protected final String TEXT_219 = " = \"";
  protected final String TEXT_220 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_221 = " = connection_";
  protected final String TEXT_222 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_223 = ");";
  protected final String TEXT_224 = NL + "            insertionStatement_";
  protected final String TEXT_225 = ".setTimestamp(";
  protected final String TEXT_226 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_227 = "\")));";
  protected final String TEXT_228 = NL + "            insertionStatement_";
  protected final String TEXT_229 = ".setNull(";
  protected final String TEXT_230 = ", java.sql.Types.DATE);";
  protected final String TEXT_231 = NL + "            String endDateTimeDetail_";
  protected final String TEXT_232 = " = ";
  protected final String TEXT_233 = ";" + NL + "            String datePattern_";
  protected final String TEXT_234 = " = \"yyyy-MM-dd\";" + NL + "            if(endDateTimeDetail_";
  protected final String TEXT_235 = ".length()>0){" + NL + "            \tendDateTimeDetail_";
  protected final String TEXT_236 = " = \" \"+endDateTimeDetail_";
  protected final String TEXT_237 = ";" + NL + "            \tdatePattern_";
  protected final String TEXT_238 = " = \"yyyy-MM-dd HH:mm:ss\";" + NL + "            }" + NL + "            insertionStatement_";
  protected final String TEXT_239 = ".setTimestamp(";
  protected final String TEXT_240 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(datePattern_";
  protected final String TEXT_241 = ").parse(";
  protected final String TEXT_242 = " + \"-01-01\"+endDateTimeDetail_";
  protected final String TEXT_243 = ").getTime()));";
  protected final String TEXT_244 = NL + "        String updateSQLForType1_";
  protected final String TEXT_245 = " = \"";
  protected final String TEXT_246 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_247 = " = connection_";
  protected final String TEXT_248 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_249 = ");        ";
  protected final String TEXT_250 = NL + "        String updateSQLForType2_";
  protected final String TEXT_251 = " = \"";
  protected final String TEXT_252 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_253 = " = connection_";
  protected final String TEXT_254 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_255 = ");";
  protected final String TEXT_256 = NL + "            updateForType2_";
  protected final String TEXT_257 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_258 = "\")));";
  protected final String TEXT_259 = NL + "        String updateSQLForType3_";
  protected final String TEXT_260 = " = \"";
  protected final String TEXT_261 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_262 = " = connection_";
  protected final String TEXT_263 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_264 = ");";
  protected final String TEXT_265 = NL + "    ";
  protected final String TEXT_266 = NL + "        SCDSK_";
  protected final String TEXT_267 = " lookUpKey_";
  protected final String TEXT_268 = " = null;        ";
  protected final String TEXT_269 = NL + "    SCDStruct_";
  protected final String TEXT_270 = " lookUpValue_";
