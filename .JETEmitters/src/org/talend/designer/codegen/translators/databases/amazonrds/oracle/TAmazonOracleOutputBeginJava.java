...
public class TAmazonOracleOutputBeginJava {
  ...
  protected final String TEXT_44 = NL + "\t \t// TODO unable to parse integer: ";
  protected final String TEXT_45 = NL + "\t \t// TODO error: ";
  protected final String TEXT_46 = NL + "\t";
  protected final String TEXT_47 = NL + "\t/* initialize feature count */" + NL + "\tint nbFeature_";
  protected final String TEXT_48 = " = 0;" + NL + "" + NL + "\tjava.util.Map<String, com.vividsolutions.jts.geom.Envelope> geometryColumnToExtends = new java.util.HashMap<String, com.vividsolutions.jts.geom.Envelope>();" + NL + "\t";
  protected final String TEXT_49 = NL + NL;
  protected final String TEXT_50 = NL;
  protected final String TEXT_51 = NL + "        int updateKeyCount_";
  protected final String TEXT_52 = " = ";
  protected final String TEXT_53 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_54 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_55 = NL + "        int deleteKeyCount_";
  protected final String TEXT_56 = " = ";
  protected final String TEXT_57 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_58 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_59 = NL + "int nb_line_";
  protected final String TEXT_60 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_61 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_62 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_63 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_64 = " = 0;" + NL + "" + NL + "int tmp_batchUpdateCount_";
  protected final String TEXT_65 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_66 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_67 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_68 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_69 = "=0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_70 = " = false;" + NL + "" + NL + "java.sql.Connection conn_";
  protected final String TEXT_71 = " = null;" + NL + "" + NL + "//optional table" + NL + "String dbschema_";
  protected final String TEXT_72 = " = null;" + NL + "String tableName_";
  protected final String TEXT_73 = " = null;";
  protected final String TEXT_74 = NL + "\tdbschema_";
  ...
  protected final String TEXT_81 = NL + "\t\tjava.lang.Class.forName(\"oracle.jdbc.OracleDriver\");" + NL + "\t\t";
  protected final String TEXT_82 = NL + "\t";
  protected final String TEXT_83 = NL + "\t\tjava.lang.Class.forName(\"oracle.jdbc.driver.OracleDriver\");" + NL + "\t\t";
  ...
  protected final String TEXT_89 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_90 = " + \":\" + ";
  protected final String TEXT_91 = " + \":\" + ";
  protected final String TEXT_92 = ";" + NL + "\t\t";
  protected final String TEXT_93 = NL + "\t\turl_";
  protected final String TEXT_94 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_95 = " + \")(port=\" + ";
  protected final String TEXT_96 = " + \"))(connect_data=(service_name=\" + ";
  ...
  protected final String TEXT_104 = NL + "\tString dbUser_";
  ...
  protected final String TEXT_116 = ";" + NL + "    dbschema_";
  ...
  protected final String TEXT_122 = ");" + NL + "\t\tif(dbschema_";
  protected final String TEXT_123 = "==null||\"\".equals(dbschema_";
  protected final String TEXT_124 = ")) //get schema from connection" + NL + "\t\t\t{" + NL + "\t\t\tdbschema_";
  protected final String TEXT_125 = "=conn_";
  protected final String TEXT_126 = ".getMetaData().getUserName();" + NL + "\t\t\t}" + NL + "" + NL + "\t";
  ...
  protected final String TEXT_132 = NL + "\tString atnParams_";
  protected final String TEXT_133 = " = ";
  protected final String TEXT_134 = ";" + NL + "\tatnParams_";
  protected final String TEXT_135 = " = atnParams_";
  protected final String TEXT_136 = ".replaceAll(\"&\", \"\\n\");" + NL + "\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_137 = " = new java.util.Properties();" + NL + "\tatnParamsPrope_";
  protected final String TEXT_138 = ".put(\"user\",dbUser_";
  protected final String TEXT_139 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_140 = ".put(\"password\",dbPwd_";
  protected final String TEXT_141 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_142 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_143 = ".getBytes()));" + NL + "\tconn_";
  protected final String TEXT_144 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_145 = ", atnParamsPrope_";
  protected final String TEXT_146 = ");";
  protected final String TEXT_147 = NL + "\t";
  protected final String TEXT_148 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_149 = "\", conn_";
  protected final String TEXT_150 = ");" + NL + "" + NL + "\t";
  protected final String TEXT_151 = NL + "        conn_";
  protected final String TEXT_152 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_153 = " = ";
  protected final String TEXT_154 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_155 = " = 0;";
  protected final String TEXT_156 = NL + "   int batchSize_";
  protected final String TEXT_157 = " = ";
  protected final String TEXT_158 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_159 = "=0;";
  protected final String TEXT_160 = NL;
  protected final String TEXT_161 = NL + "int count_";
  protected final String TEXT_162 = "=0;";
  protected final String TEXT_163 = NL + NL + "if(dbschema_";
  protected final String TEXT_164 = " == null || dbschema_";
  protected final String TEXT_165 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_166 = " = ";
  protected final String TEXT_167 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_168 = " = dbschema_";
  protected final String TEXT_169 = " + \".\" + ";
  protected final String TEXT_170 = ";" + NL + "}";
  protected final String TEXT_171 = NL + "  \ttableName_";
  protected final String TEXT_172 = " += \" \" +";
  protected final String TEXT_173 = ";";
  protected final String TEXT_174 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_175 = " = conn_";
  protected final String TEXT_176 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_177 = NL + "            stmtDrop_";
  protected final String TEXT_178 = ".execute(\"";
  protected final String TEXT_179 = "\" ";
  protected final String TEXT_180 = ");" + NL + "\t\t\t";
  protected final String TEXT_181 = NL + "            stmtDrop_";
  protected final String TEXT_182 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_183 = " = conn_";
  protected final String TEXT_184 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_185 = NL + "\t\t\t";
  protected final String TEXT_186 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_187 = ".execute(((\"";
  protected final String TEXT_188 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_189 = ".";
  protected final String TEXT_190 = ", \"";
  protected final String TEXT_191 = "\")";
  protected final String TEXT_192 = ".toUpperCase()";
  ...
  protected final String TEXT_199 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_200 = ".close();" + NL + "\t\t";
  protected final String TEXT_201 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_202 = " = conn_";
  protected final String TEXT_203 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_204 = NL + "\t\t\t";
  protected final String TEXT_205 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_206 = ".execute(((\"";
  protected final String TEXT_207 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_208 = ".";
  protected final String TEXT_209 = ", \"";
  protected final String TEXT_210 = "\")";
  protected final String TEXT_211 = ".toUpperCase()";
  ...
  protected final String TEXT_222 = NL + "\t\t    \t\tString keyCheckTable_";
  protected final String TEXT_223 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_224 = "+\"][\"+";
  protected final String TEXT_225 = "+\"][\"+";
  protected final String TEXT_226 = "+\"][\"+";
  protected final String TEXT_227 = "+\"][\"+";
  protected final String TEXT_228 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_229 = " + \"]\";" + NL + "\t\t    \t";
  protected final String TEXT_230 = NL + "        \t\t    // [%connection%][checktable][tableName]" + NL + "        \t\t    String keyCheckTable_";
  protected final String TEXT_231 = " = conn_";
  protected final String TEXT_232 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_233 = " + \"]\";" + NL + "    \t\t    ";
  protected final String TEXT_234 = NL + "\t\t    " + NL + "\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_235 = ")== null){//}" + NL + "\t\t\t" + NL + "\t\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_236 = ")) {//}" + NL + "\t\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_237 = ")== null){//}" + NL + "\t\t\t";
  protected final String TEXT_238 = "              " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_239 = NL + "    \t\t\t\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_240 = " = conn_";
  protected final String TEXT_241 = ".createStatement();" + NL + "                \t\t\t\tboolean whetherExist_";
  protected final String TEXT_242 = " = false;" + NL + "                \t\t\t\ttry {" + NL + "                \t\t\t\t\tisExistStmt_";
  protected final String TEXT_243 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_244 = " + \"]\" );" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_245 = " = true;" + NL + "                \t\t\t\t} catch (java.lang.Exception e){" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_246 = " = false;" + NL + "                \t\t\t\t}" + NL + "                \t\t\t\tisExistStmt_";
  protected final String TEXT_247 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_248 = "   \t" + NL + "                \t\t\t\t";
  protected final String TEXT_249 = NL + "                \t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_250 = " = conn_";
  protected final String TEXT_251 = ".getMetaData();" + NL + "                \t            if(tableNameForSearch_";
  protected final String TEXT_252 = ".indexOf(\"\\\"\")==-1){" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_253 = " = tableNameForSearch_";
  protected final String TEXT_254 = ".toUpperCase();" + NL + "                            \t}else{" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_255 = " = tableNameForSearch_";
  protected final String TEXT_256 = ".replaceAll(\"\\\"\",\"\");" + NL + "                            \t}" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_257 = " = dbMetaData_";
  protected final String TEXT_258 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_259 = ", tableNameForSearch_";
  protected final String TEXT_260 = ", new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_261 = " = false;" + NL + "                \t            if(rsTable_";
  protected final String TEXT_262 = ".next()) {" + NL + "                \t            \twhetherExist_";
  protected final String TEXT_263 = " = true;" + NL + "                \t            }" + NL + "    \t            \t\t\trsTable_";
  protected final String TEXT_264 = ".close();" + NL + "    \t            " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_273 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_274 = " = rsTable_";
  protected final String TEXT_275 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_276 = ".equals";
  protected final String TEXT_277 = "IgnoreCase";
  protected final String TEXT_278 = "(";
  protected final String TEXT_279 = ") " + NL + "                \t                \t&& (schema_";
  protected final String TEXT_280 = ".equals";
  protected final String TEXT_281 = "IgnoreCase";
  protected final String TEXT_282 = "(dbschema_";
  protected final String TEXT_283 = ") || dbschema_";
  protected final String TEXT_284 = ".trim().length() ==0)) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_285 = " = true;" + NL + "                \t                    break;" + NL + "        \t            \t    \t}" + NL + "                        \t\t}" + NL + "            \t            \trsTable_";
  protected final String TEXT_286 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_287 = NL + "                \t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_288 = " = conn_";
  protected final String TEXT_289 = ".getMetaData();" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_290 = " = dbMetaData_";
  protected final String TEXT_291 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_292 = " = false;" + NL + "                \t            while(rsTable_";
  protected final String TEXT_293 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_294 = " = rsTable_";
  protected final String TEXT_295 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_296 = " = rsTable_";
  protected final String TEXT_297 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_298 = ".equals";
  protected final String TEXT_299 = "IgnoreCase";
  protected final String TEXT_300 = "((";
  protected final String TEXT_301 = ")";
  protected final String TEXT_302 = ".toUpperCase()";
  protected final String TEXT_303 = ") " + NL + "                \t                \t&& (schema_";
  ...
  protected final String TEXT_308 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_309 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_310 = ")))) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_311 = " = true;" + NL + "                \t                    break;" + NL + "                \t                }" + NL + "                \t            }" + NL + "                \t            rsTable_";
  protected final String TEXT_312 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_313 = "  \t            " + NL + "                \t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_314 = " = conn_";
  protected final String TEXT_315 = ".getMetaData();" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_316 = " = dbMetaData_";
  protected final String TEXT_317 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_318 = " = false;" + NL + "                \t            String defaultSchema_";
  protected final String TEXT_319 = " = \"public\";" + NL + "                \t            if(dbschema_";
  protected final String TEXT_320 = " == null || dbschema_";
  protected final String TEXT_321 = ".trim().length() == 0) {" + NL + "                \t            \tjava.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_328 = ".getString(\"current_schema\");" + NL + "                \t            \t}" + NL + "                \t            \trsSchema_";
  protected final String TEXT_329 = ".close();" + NL + "                \t            \tstmtSchema_";
  protected final String TEXT_330 = ".close();" + NL + "                \t            }" + NL + "                \t            while(rsTable_";
  protected final String TEXT_331 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_332 = " = rsTable_";
  protected final String TEXT_333 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  ...
  protected final String TEXT_337 = "IgnoreCase";
  protected final String TEXT_338 = "(";
  protected final String TEXT_339 = ") " + NL + "                \t                \t&& (schema_";
  protected final String TEXT_340 = ".equals";
  protected final String TEXT_341 = "IgnoreCase";
  protected final String TEXT_342 = "(dbschema_";
  protected final String TEXT_343 = ") || ((dbschema_";
  protected final String TEXT_344 = " ==null || dbschema_";
  protected final String TEXT_345 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_346 = ".equals";
  protected final String TEXT_347 = "IgnoreCase";
  protected final String TEXT_348 = "(schema_";
  protected final String TEXT_349 = ")))) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_350 = " = true;" + NL + "                \t                    break;" + NL + "                \t                }" + NL + "                \t            }" + NL + "                \t            rsTable_";
  protected final String TEXT_351 = ".close();" + NL + "        \t\t\t\t\t";
  protected final String TEXT_352 = "      " + NL + "                \t            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_353 = " = conn_";
  protected final String TEXT_354 = ".getMetaData();" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_355 = " = dbMetaData_";
  protected final String TEXT_356 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_357 = " = false;" + NL + "                \t            while(rsTable_";
  protected final String TEXT_358 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_359 = " = rsTable_";
  protected final String TEXT_360 = ".getString(\"TABLE_NAME\");" + NL + "                \t                if(table_";
  protected final String TEXT_361 = ".equalsIgnoreCase(";
  protected final String TEXT_362 = ")) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_363 = " = true;" + NL + "                \t                    break;" + NL + "                \t                }" + NL + "                \t            }" + NL + "                \t            rsTable_";
  protected final String TEXT_364 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_365 = NL + "                    \t\t\tif(!whetherExist_";
  protected final String TEXT_366 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_372 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_373 = ".";
  protected final String TEXT_374 = ", \"";
  protected final String TEXT_375 = "\")";
  protected final String TEXT_376 = ".toUpperCase()";
  protected final String TEXT_377 = ")+\")";
  protected final String TEXT_378 = "\"));" + NL + "    \t\t\t\t\t\t\t\t\t";
  protected final String TEXT_379 = NL + "    \t\t\t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_380 = ".execute(\"";
  protected final String TEXT_381 = ")\");" + NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_382 = NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_383 = NL + "                    \t\t\t\tstmtCreate_";
  protected final String TEXT_384 = ".close();            " + NL + "                    \t\t\t}                " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_388 = ".createStatement();" + NL + "                \t    \t    \t";
  ...
  protected final String TEXT_396 = ".createStatement();" + NL + "            \t    \t    \t";
  protected final String TEXT_397 = NL + "        \t\t\t\t\t\t";
  protected final String TEXT_398 = NL + "        \t\t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_399 = ".execute(((\"";
  protected final String TEXT_400 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_401 = ".";
  protected final String TEXT_402 = ", \"";
  protected final String TEXT_403 = "\")";
  protected final String TEXT_404 = ".toUpperCase()";
  protected final String TEXT_405 = ")+\")";
  protected final String TEXT_406 = "\"));" + NL + "        \t\t\t\t\t\t\t";
  protected final String TEXT_407 = NL + "        \t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_408 = ".execute(\"";
  protected final String TEXT_409 = ")\");" + NL + "        \t\t\t\t\t\t";
  protected final String TEXT_410 = NL + "        \t    \t    \t\t";
  protected final String TEXT_411 = NL + "                        \t\tstmtCreate_";
  protected final String TEXT_412 = ".close();" + NL + "        \t\t\t\t\t";
  protected final String TEXT_413 = NL + "\t\t\t";
  protected final String TEXT_414 = NL + "    \t\t\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_415 = ", true);" + NL + "    \t\t//{{{" + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_416 = "            ";
  protected final String TEXT_417 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_418 = " = conn_";
  protected final String TEXT_419 = ".createStatement();" + NL + "    \t   \t";
  protected final String TEXT_420 = NL + "            stmtClear_";
  protected final String TEXT_421 = ".executeUpdate(\"";
  protected final String TEXT_422 = "\");" + NL + "   \t    \t";
  protected final String TEXT_423 = NL + "            stmtClear_";
  protected final String TEXT_424 = ".close();" + NL + "\t\t";
  protected final String TEXT_425 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_426 = " = conn_";
  protected final String TEXT_427 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_428 = " = stmtTruncCount_";
  protected final String TEXT_429 = ".executeQuery(\"";
  protected final String TEXT_430 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_431 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_432 = ".next()) {" + NL + "\t\t\t\trsTruncCountNumber_";
  protected final String TEXT_433 = " = rsTruncCount_";
  protected final String TEXT_434 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_435 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_436 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_442 = NL + "            stmtTrunc_";
  protected final String TEXT_443 = ".executeUpdate(\"";
  protected final String TEXT_444 = "\");";
  protected final String TEXT_445 = NL + "                if(!conn_";
  protected final String TEXT_446 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_447 = ".commit();" + NL + "                }";
  protected final String TEXT_448 = NL + "   \t    \t";
  protected final String TEXT_449 = NL + "   \t    \tdeletedCount_";
  protected final String TEXT_450 = " += rsTruncCountNumber_";
  protected final String TEXT_451 = ";" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_455 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_456 = " = stmtTruncCount_";
  protected final String TEXT_457 = ".executeQuery(\"";
  protected final String TEXT_458 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_459 = " = conn_";
  protected final String TEXT_460 = ".createStatement();" + NL + "  \t    \t";
  protected final String TEXT_461 = NL + "\t\t\t";
  protected final String TEXT_462 = NL + "\t\t\t\tconn_";
  protected final String TEXT_463 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_464 = NL + "            stmtTrunc_";
  protected final String TEXT_465 = ".executeUpdate(\"";
  ...
  protected final String TEXT_487 = "    " + NL + "" + NL + "        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_491 = NL + "\t    String update_";
  protected final String TEXT_492 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_493 = " + \" SET ";
  protected final String TEXT_494 = " WHERE ";
  protected final String TEXT_495 = "\";" + NL + "    \t";
  protected final String TEXT_496 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_497 = " = new StringBuffer(update_";
  protected final String TEXT_498 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_499 = ".insert(update_";
  protected final String TEXT_500 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_501 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_502 = " =updateStringBuffer_";
  protected final String TEXT_503 = ".toString(); ";
  protected final String TEXT_504 = NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_508 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_509 = " = conn_";
  protected final String TEXT_510 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_517 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_518 = " = new StringBuffer(insert_";
  protected final String TEXT_519 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_520 = ".insert(insert_";
  protected final String TEXT_521 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_522 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_523 = " =insertStringBuffer_";
  protected final String TEXT_524 = ".toString(); ";
  protected final String TEXT_525 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_526 = " = conn_";
  protected final String TEXT_527 = ".prepareStatement(insert_";
  protected final String TEXT_528 = ");" + NL + "\t    String update_";
  protected final String TEXT_529 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_530 = " + \" SET ";
  ...
  protected final String TEXT_541 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_550 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_551 = " = new StringBuffer(update_";
  protected final String TEXT_552 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_553 = ".insert(update_";
  protected final String TEXT_554 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_555 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_556 = " =updateStringBuffer_";
  protected final String TEXT_557 = ".toString(); ";
  protected final String TEXT_558 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_559 = " = conn_";
  protected final String TEXT_560 = ".prepareStatement(update_";
  ...
  protected final String TEXT_566 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_567 = " = new StringBuffer(insert_";
  protected final String TEXT_568 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_569 = ".insert(insert_";
  protected final String TEXT_570 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_571 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_572 = " =insertStringBuffer_";
  protected final String TEXT_573 = ".toString(); ";
  protected final String TEXT_574 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_575 = " = conn_";
  protected final String TEXT_576 = ".prepareStatement(insert_";
  protected final String TEXT_577 = ");" + NL + "\t    ";
  protected final String TEXT_578 = NL + "\t    String delete_";
  protected final String TEXT_579 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_580 = " + \" WHERE ";
  protected final String TEXT_581 = "\";" + NL + "\t    ";
  protected final String TEXT_582 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_583 = " = new StringBuffer(delete_";
  protected final String TEXT_584 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_585 = ".insert(delete_";
  protected final String TEXT_586 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_587 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_588 = " =deleteStringBuffer_";
  protected final String TEXT_589 = ".toString();  ";
  protected final String TEXT_590 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_591 = " = conn_";
  protected final String TEXT_592 = ".prepareStatement(delete_";
  protected final String TEXT_593 = ");" + NL + "\t    ";
  protected final String TEXT_594 = NL + "        StringBuffer query_";
  protected final String TEXT_595 = " = null;" + NL + "\t   ";
  protected final String TEXT_596 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_597 = " = insert_";
  protected final String TEXT_598 = ".split(\"\\\\?\");";
  protected final String TEXT_599 = NL + "\t\t\tupdate_";
  protected final String TEXT_600 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_601 = " = update_";
  protected final String TEXT_602 = ".split(\"\\\\?\");";
  protected final String TEXT_603 = NL + "\t\t\tupdate_";
  protected final String TEXT_604 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_605 = " = update_";
  protected final String TEXT_606 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_607 = " = insert_";
  protected final String TEXT_608 = ".split(\"\\\\?\");";
  protected final String TEXT_609 = NL + "\t\t\tdelete_";
  protected final String TEXT_610 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_611 = " = delete_";
  protected final String TEXT_612 = ".split(\"\\\\?\");";
  protected final String TEXT_613 = NL + "\t\t\treplace_";
  protected final String TEXT_614 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_615 = " = replace_";
  protected final String TEXT_616 = ".split(\"\\\\?\");";
  protected final String TEXT_617 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_618 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_619 = " = insertIgnore_";
  protected final String TEXT_620 = ".split(\"\\\\?\");";
  protected final String TEXT_621 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_622 = " = insert_";
  protected final String TEXT_623 = ".split(\"\\\\?\");";
  protected final String TEXT_624 = NL + "\t   ";
  protected final String TEXT_625 = NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_626 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_627 = " = 0;" + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_628 = " = true;" + NL + "    \t";
  protected final String TEXT_629 = NL + NL + "\tclass ClobTypeUtil_";
  protected final String TEXT_630 = " {" + NL + "\t\tpublic Object getCLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "\t\t\toracle.sql.CLOB tempClob = null;" + NL + "\t\t\ttry{" + NL + "\t\t\t\t// If the temporary CLOB has not yet been created, create one" + NL + "\t\t\t\ttempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION);" + NL + "\t\t\t\t// Open the temporary CLOB in readwrite mode, to enable writing" + NL + "\t\t\t\ttempClob.open(oracle.sql.CLOB.MODE_READWRITE);" + NL + "\t\t\t\t// Get the output stream to write" + NL + "\t\t\t\tjava.io.Writer tempClobWriter = tempClob.getCharacterOutputStream();" + NL + "\t\t\t\tif(data instanceof oracle.sql.CLOB) {" + NL + "\t\t\t\t\toracle.sql.CLOB inClob = (oracle.sql.CLOB) data;" + NL + "\t\t\t        java.io.Reader inReader = inClob.getCharacterStream();" + NL + "\t\t\t        char[] chs = new char[128];" + NL + "\t\t\t       \tint len = 0;" + NL + "\t\t\t\t\twhile ((len = inReader.read(chs)) != -1) {" + NL + "\t\t\t        \ttempClobWriter.write(chs, 0, len);" + NL + "\t\t\t        }" + NL + "\t\t\t    }else if(data instanceof String) {" + NL + "\t\t\t       // Write the data into the temporary CLOB" + NL + "\t\t\t\t\ttempClobWriter.write((String)data);" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\treturn data;" + NL + "\t\t\t\t}" + NL + "\t\t\t\t// Flush and close the stream" + NL + "\t\t\t\ttempClobWriter.flush();" + NL + "\t\t\t\ttempClobWriter.close();" + NL + "\t\t\t\t// Close the temporary CLOB" + NL + "\t\t\t\ttempClob.close();" + NL + "\t\t\t} catch( java.sql.SQLException sqlexp){" + NL + "\t  \t\t\t";
  protected final String TEXT_631 = NL + "\t\t\t\ttempClob.freeTemporary();" + NL + "\t\t\t\tsqlexp.printStackTrace();" + NL + "\t\t\t} catch(java.lang.Exception exp){" + NL + "\t  \t\t\t";
  protected final String TEXT_632 = NL + "\t\t\t\ttempClob.freeTemporary();" + NL + "\t\t\t\texp.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t\treturn tempClob;" + NL + "\t\t}" + NL + "\t}" + NL + "\tClobTypeUtil_";
  protected final String TEXT_633 = " clobTypeUtil_";
  protected final String TEXT_634 = "=new ClobTypeUtil_";
  protected final String TEXT_635 = "();";
  protected final String TEXT_636 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_637 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_638 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_639 = " =null;" + NL + "\t";
  protected final String TEXT_640 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_641 = " = null;" + NL + "\t\t";
  protected final String TEXT_642 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_643 = " = null;";
  protected final String TEXT_644 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_645 = " =  null;";
  protected final String TEXT_646 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_647 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_648 = " = null;";
  protected final String TEXT_649 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_650 = " = null;";
  protected final String TEXT_651 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_652 = " = null;";
  protected final String TEXT_653 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_654 = " = null;";
  protected final String TEXT_655 = NL + "\t\t \tString[] insertSQLSplits_";
...
if(useExistingConnection) {
    ...
    dbLog.conn().logJDBCDriver(dbLog.str("oracle.jdbc.OracleDriver"));
    stringBuffer.append(TEXT_82);
    }else {
    stringBuffer.append(TEXT_83);
    dbLog.conn().logJDBCDriver(dbLog.str("oracle.jdbc.driver.OracleDriver"));
