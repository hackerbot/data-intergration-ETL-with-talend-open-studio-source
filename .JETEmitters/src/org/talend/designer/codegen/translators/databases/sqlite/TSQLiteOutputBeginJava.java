...
public class TSQLiteOutputBeginJava {
  protected static String nl;
  public static synchronized TSQLiteOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLiteOutputBeginJava result = new TSQLiteOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_44 = NL + NL + "int nb_line_";
  protected final String TEXT_45 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_46 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_47 = " = 0;" + NL + "int nb_line_deleted_";
  ...
  protected final String TEXT_77 = NL + "    java.lang.Class.forName(\"";
  protected final String TEXT_78 = "\");" + NL + "    String url_";
  protected final String TEXT_79 = " = \"jdbc:sqlite:\"+ \"/\" + ";
  protected final String TEXT_80 = ";" + NL + "    \t";
  protected final String TEXT_81 = NL + "    conn_";
  protected final String TEXT_82 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_83 = ");";
  protected final String TEXT_84 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_85 = "\", conn_";
  protected final String TEXT_86 = ");";
  protected final String TEXT_87 = NL + "        conn_";
  protected final String TEXT_88 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_89 = " = ";
  protected final String TEXT_90 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_91 = " = 0;";
  protected final String TEXT_92 = NL;
  protected final String TEXT_93 = NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_94 = " = conn_";
  protected final String TEXT_95 = ".createStatement();" + NL + "            \t";
  protected final String TEXT_96 = NL + "            stmtDrop_";
  protected final String TEXT_97 = ".execute(\"";
  protected final String TEXT_98 = "\");";
  protected final String TEXT_99 = NL + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_100 = " = conn_";
  protected final String TEXT_101 = ".createStatement();" + NL + "            \t";
  protected final String TEXT_102 = NL + "            stmtCreate_";
  protected final String TEXT_103 = ".execute(\"";
  protected final String TEXT_104 = ")\");" + NL + "            \t";
  protected final String TEXT_105 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_106 = " = conn_";
  protected final String TEXT_107 = ".createStatement();" + NL + "            \t";
  protected final String TEXT_108 = NL + "            stmtCreate_";
  protected final String TEXT_109 = ".execute(\"";
  protected final String TEXT_110 = ")\");" + NL + "            \t";
  protected final String TEXT_111 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_112 = " = conn_";
  protected final String TEXT_113 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_114 = " = dbMetaData_";
  protected final String TEXT_115 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_116 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_117 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_118 = " = rsTable_";
  protected final String TEXT_119 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_120 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_124 = NL + "                if(!whetherExist_";
  protected final String TEXT_125 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_126 = " = conn_";
  protected final String TEXT_127 = ".createStatement();" + NL + "                    \t";
  protected final String TEXT_128 = NL + "                    stmtCreate_";
  protected final String TEXT_129 = ".execute(\"";
  protected final String TEXT_130 = ")\");" + NL + "                    \t";
  protected final String TEXT_131 = NL + "                }";
  protected final String TEXT_132 = NL + "                if(whetherExist_";
  ...
  protected final String TEXT_139 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_145 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_146 = " = conn_";
  protected final String TEXT_147 = ".createStatement();" + NL + "            \t";
  protected final String TEXT_148 = NL + "            deletedCount_";
  protected final String TEXT_149 = " = deletedCount_";
  protected final String TEXT_150 = " + stmtClear_";
  protected final String TEXT_151 = ".executeUpdate(\"";
  protected final String TEXT_152 = "\");" + NL + "            \t";
  protected final String TEXT_153 = NL + "\t    String insert_";
  protected final String TEXT_154 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_155 = " + \"\\\" (";
  protected final String TEXT_156 = ") VALUES (";
  protected final String TEXT_157 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_158 = " = conn_";
  protected final String TEXT_159 = ".prepareStatement(insert_";
  protected final String TEXT_160 = ");" + NL + "\t    ";
  protected final String TEXT_161 = NL + "\t    String update_";
  protected final String TEXT_162 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_163 = " + \"\\\" SET ";
  protected final String TEXT_164 = " WHERE ";
  protected final String TEXT_165 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_166 = " = conn_";
  protected final String TEXT_167 = ".prepareStatement(update_";
  protected final String TEXT_168 = ");" + NL + "\t    ";
  protected final String TEXT_169 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_170 = " = conn_";
  protected final String TEXT_171 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + ";
  protected final String TEXT_172 = " + \"\\\" WHERE ";
  protected final String TEXT_173 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_174 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_175 = " + \"\\\" (";
  protected final String TEXT_176 = ") VALUES (";
  protected final String TEXT_177 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_178 = " = conn_";
  protected final String TEXT_179 = ".prepareStatement(insert_";
  protected final String TEXT_180 = ");" + NL + "\t    String update_";
  protected final String TEXT_181 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_182 = " + \"\\\" SET ";
  protected final String TEXT_183 = " WHERE ";
  protected final String TEXT_184 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_185 = " = conn_";
  protected final String TEXT_186 = ".prepareStatement(update_";
  protected final String TEXT_187 = ");" + NL + "\t    ";
  protected final String TEXT_188 = NL + "\t    String update_";
  protected final String TEXT_189 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_190 = " + \"\\\" SET ";
  protected final String TEXT_191 = " WHERE ";
  protected final String TEXT_192 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_193 = " = conn_";
  protected final String TEXT_194 = ".prepareStatement(update_";
  ...
  protected final String TEXT_203 = NL + "\t    String delete_";
  protected final String TEXT_204 = " = \"DELETE FROM \\\"\" + ";
  protected final String TEXT_205 = " + \"\\\" WHERE ";
  protected final String TEXT_206 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_207 = " = conn_";
  protected final String TEXT_208 = ".prepareStatement(delete_";
  protected final String TEXT_209 = ");" + NL + "\t    ";
  protected final String TEXT_210 = NL + "        StringBuffer query_";
  protected final String TEXT_211 = " = null;" + NL + "       \t";
  protected final String TEXT_212 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_213 = " = insert_";
  protected final String TEXT_214 = ".split(\"\\\\?\");";
  protected final String TEXT_215 = NL + "\t\t\tupdate_";
  protected final String TEXT_216 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_217 = " = update_";
  protected final String TEXT_218 = ".split(\"\\\\?\");";
  protected final String TEXT_219 = NL + "\t\t\tupdate_";
  protected final String TEXT_220 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_221 = " = update_";
  protected final String TEXT_222 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_223 = " = insert_";
  protected final String TEXT_224 = ".split(\"\\\\?\");";
  protected final String TEXT_225 = NL + "\t\t\tdelete_";
  protected final String TEXT_226 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_227 = " = delete_";
  protected final String TEXT_228 = ".split(\"\\\\?\");";
  protected final String TEXT_229 = NL + "\t\t\treplace_";
  protected final String TEXT_230 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_231 = " = replace_";
  protected final String TEXT_232 = ".split(\"\\\\?\");";
  protected final String TEXT_233 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_234 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_235 = " = insertIgnore_";
  protected final String TEXT_236 = ".split(\"\\\\?\");";
  protected final String TEXT_237 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_238 = " = insert_";
