...
public class TSybaseSCDMainJava {
  protected static String nl;
  public static synchronized TSybaseSCDMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSybaseSCDMainJava result = new TSybaseSCDMainJava();
    nl = null;
    return result;
  }
