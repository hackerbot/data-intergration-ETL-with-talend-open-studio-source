...
public class TPostgresPlusBulkExecBeginJava {
  protected static String nl;
  public static synchronized TPostgresPlusBulkExecBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresPlusBulkExecBeginJava result = new TPostgresPlusBulkExecBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_107 = " + \"' \";" + NL + "    bulkSQL_";
  protected final String TEXT_108 = " += \"NULL AS '\" + ";
  protected final String TEXT_109 = " + \"' \";";
  protected final String TEXT_110 = NL + "        Character text_enclosure_";
  protected final String TEXT_111 = " = (";
  protected final String TEXT_112 = ").charAt(0);" + NL + "        bulkSQL_";
  protected final String TEXT_113 = " += \"CSV ";
  protected final String TEXT_114 = " QUOTE AS '\" + text_enclosure_";
  protected final String TEXT_115 = ".toString().replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";";
  protected final String TEXT_116 = "        " + NL + "        bulkSQL_";
  protected final String TEXT_117 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_118 = " + \"' \";";
  protected final String TEXT_119 = NL + "        bulkSQL_";
  protected final String TEXT_120 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_121 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";        ";
  protected final String TEXT_122 = "            " + NL + "        bulkSQL_";
  protected final String TEXT_123 = " += \"";
  protected final String TEXT_124 = "\";";
  protected final String TEXT_125 = " " + NL + "" + NL + "java.sql.Connection conn_";
  protected final String TEXT_126 = " = null;" + NL + "\t";
  protected final String TEXT_127 = NL + "\t \tconn_";
  protected final String TEXT_128 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_129 = "\");" + NL + "\t ";
  protected final String TEXT_130 = NL + "\t \tString driverClass_";
  protected final String TEXT_131 = " = \"org.postgresql.Driver\";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_132 = ").newInstance();" + NL + "\t\tString url_";
  protected final String TEXT_133 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_134 = " + \":\" + ";
  protected final String TEXT_135 = " + \"/\" + ";
  protected final String TEXT_136 = ";" + NL + "\t\tString dbUser_";
  ...
  protected final String TEXT_146 = NL + "\t\tString dbPwd_";
  protected final String TEXT_147 = " = decryptedPassword_";
  protected final String TEXT_148 = ";" + NL + "\t";
  protected final String TEXT_149 = NL + "\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_150 = " = conn_";
  protected final String TEXT_151 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_152 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_153 = " - Droping table ";
  ...
  protected final String TEXT_161 = " - Drop table ";
  protected final String TEXT_162 = "\" + tableName_";
  protected final String TEXT_163 = " + \"";
  protected final String TEXT_164 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_165 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_166 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_167 = " = conn_";
  protected final String TEXT_168 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_169 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_170 = " - Creating table ";
  protected final String TEXT_171 = "\" + tableName_";
  ...
  protected final String TEXT_178 = " - Create table ";
  protected final String TEXT_179 = "\" + tableName_";
  ...
  protected final String TEXT_184 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_185 = " = conn_";
  protected final String TEXT_186 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_187 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_188 = " - Creating table ";
  protected final String TEXT_189 = "\" + tableName_";
  ...
  protected final String TEXT_196 = " - Create table ";
  protected final String TEXT_197 = "\" + tableName_";
  protected final String TEXT_198 = " + \"";
  protected final String TEXT_199 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_200 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_201 = ".close();" + NL + "\t\t";
  protected final String TEXT_202 = "   " + NL + "\t\t\t\t";
  protected final String TEXT_203 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_204 = " = conn_";
  protected final String TEXT_205 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_206 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_207 = " = tableNameForSearch_";
  protected final String TEXT_208 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_209 = " = tableNameForSearch_";
  protected final String TEXT_210 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_211 = " = dbMetaData_";
  protected final String TEXT_212 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_213 = ", tableNameForSearch_";
  protected final String TEXT_214 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_215 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_216 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_217 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_221 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_222 = " = dbMetaData_";
  protected final String TEXT_223 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_224 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_225 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_226 = " = rsTable_";
  protected final String TEXT_227 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_228 = " = rsTable_";
  protected final String TEXT_229 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_230 = ".equalsIgnoreCase(";
  protected final String TEXT_231 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_232 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_233 = ") || dbschema_";
  protected final String TEXT_234 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_245 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_249 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_250 = ".equals(schema_";
  protected final String TEXT_251 = ") || (schema_";
  protected final String TEXT_252 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_253 = ".equalsIgnoreCase(bkSchema_";
  protected final String TEXT_254 = ")))) {" + NL + "\t\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_262 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_263 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_264 = " == null || dbschema_";
  protected final String TEXT_265 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_266 = " = conn_";
  protected final String TEXT_267 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_268 = " = stmtSchema_";
  protected final String TEXT_269 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_270 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_271 = " = rsSchema_";
  protected final String TEXT_272 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_273 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_274 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_288 = " ==null || dbschema_";
  protected final String TEXT_289 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_290 = ".equals";
  protected final String TEXT_291 = "IgnoreCase";
  protected final String TEXT_292 = "(schema_";
  protected final String TEXT_293 = ")))) {" + NL + "\t\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_304 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  ...
  protected final String TEXT_311 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_312 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_313 = " = conn_";
  protected final String TEXT_314 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_315 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_316 = " - Creating table ";
  protected final String TEXT_317 = "\" + tableName_";
  protected final String TEXT_318 = " + \"";
  protected final String TEXT_319 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_320 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_321 = ".execute(\"";
  protected final String TEXT_322 = ")\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_323 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_324 = " - Create table ";
  protected final String TEXT_325 = "\" + tableName_";
  protected final String TEXT_326 = " + \"";
  protected final String TEXT_327 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_328 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_329 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_330 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_331 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_335 = " - Droping table ";
  protected final String TEXT_336 = "\" + tableName_";
  protected final String TEXT_337 = " + \"";
  protected final String TEXT_338 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_339 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_340 = ".execute(\"";
  protected final String TEXT_341 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_342 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_343 = " - Drop table ";
  protected final String TEXT_344 = "\" + tableName_";
  protected final String TEXT_345 = " + \"";
  protected final String TEXT_346 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_347 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_348 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_349 = " = conn_";
  protected final String TEXT_350 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_351 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_352 = " - Creating table ";
  protected final String TEXT_353 = "\" + tableName_";
  protected final String TEXT_354 = " + \"";
  protected final String TEXT_355 = ".\" );" + NL + "\t\t\t\t";
  protected final String TEXT_356 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_357 = ".execute(\"";
  protected final String TEXT_358 = ")\");" + NL + "\t\t\t\t";
  protected final String TEXT_359 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_360 = " - Create table ";
  protected final String TEXT_361 = "\" + tableName_";
  protected final String TEXT_362 = " + \"";
  protected final String TEXT_363 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_364 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_365 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_366 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_370 = " - Clearing table ";
  protected final String TEXT_371 = "\" + tableName_";
  protected final String TEXT_372 = " + \"";
  protected final String TEXT_373 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_374 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_375 = ".executeUpdate(\"";
  protected final String TEXT_376 = "\");" + NL + "\t\t\t";
  protected final String TEXT_377 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_378 = "- Clear table ";
  protected final String TEXT_379 = "\" + tableName_";
  protected final String TEXT_380 = " + \"";
  protected final String TEXT_381 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_393 = " - Trancating table ";
  protected final String TEXT_394 = "\" + tableName_";
  protected final String TEXT_395 = " + \"";
  protected final String TEXT_396 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_397 = NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_398 = ".executeUpdate(\"";
  protected final String TEXT_399 = "\");" + NL + "   \t    \t";
  protected final String TEXT_400 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_401 = " - Truncate table ";
  protected final String TEXT_402 = "\" + tableName_";
  protected final String TEXT_403 = " + \"";
  protected final String TEXT_404 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_405 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_406 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_407 = " += rsTruncCount_";
  protected final String TEXT_408 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_409 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_410 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_411 = ".close();" + NL + "\t\t";
  protected final String TEXT_412 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_413 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_414 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_415 = NL + "\t";
  protected final String TEXT_416 = NL + "        int keyCount_";
  protected final String TEXT_417 = " = ";
  protected final String TEXT_418 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_419 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        tmpTableName_";
  protected final String TEXT_420 = " = tableName_";
  protected final String TEXT_421 = ";" + NL + "        tableName_";
  protected final String TEXT_422 = " = \"tmp_";
  protected final String TEXT_423 = "\" + \"_\" + pid + Thread.currentThread().getId();        " + NL + "        java.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_427 = " - Creating temp table ";
  protected final String TEXT_428 = "\" + tableName_";
  protected final String TEXT_429 = " + \"";
  protected final String TEXT_430 = ".\" );" + NL + "\t\t";
  protected final String TEXT_431 = NL + NL + "        stmtCreateTmp_";
  protected final String TEXT_432 = ".execute(\"";
  protected final String TEXT_433 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_434 = ".close();";
  protected final String TEXT_435 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_436 = " - Create temp table ";
  ...
  protected final String TEXT_441 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_442 = " =conn_";
  protected final String TEXT_443 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_444 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_445 = ".close();" + NL + "   \t\t";
  protected final String TEXT_446 = "    " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_447 = " = conn_";
  protected final String TEXT_448 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_449 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_450 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_451 = "+\".\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_452 = " - Bulk inserting data into ";
  protected final String TEXT_453 = "\" + tableName_";
  protected final String TEXT_454 = " + \"";
  protected final String TEXT_455 = ".\" );" + NL + "\t\t";
  protected final String TEXT_456 = NL + "        stmtTmpBulk_";
  protected final String TEXT_457 = ".execute(bulkSQL_";
  protected final String TEXT_458 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_459 = ".close();" + NL + "        " + NL + "\t\t";
  protected final String TEXT_460 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_461 = " - Bulk insert data into ";
  protected final String TEXT_462 = "\" + tableName_";
  protected final String TEXT_463 = " + \"";
  protected final String TEXT_464 = " has finished.\");" + NL + "\t\t";
  protected final String TEXT_465 = NL + "        tableName_";
  protected final String TEXT_466 = " = tmpTableName_";
  protected final String TEXT_467 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_468 = " = \"tmp_";
  protected final String TEXT_469 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_470 = " = conn_";
  protected final String TEXT_471 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_472 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_473 = " - Updating ";
  protected final String TEXT_474 = "\" + tableName_";
  protected final String TEXT_475 = " + \"";
  protected final String TEXT_476 = " from ";
  protected final String TEXT_477 = "\"+tmpTableName_";
  protected final String TEXT_478 = "+\"";
  protected final String TEXT_479 = ".\");" + NL + "\t\t";
  protected final String TEXT_480 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_481 = ".executeUpdate(\"";
  protected final String TEXT_482 = "\");" + NL + "\t\t";
  protected final String TEXT_483 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_484 = ".close();" + NL + "        tableName_";
  protected final String TEXT_485 = " = tmpTableName_";
  protected final String TEXT_486 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_487 = " = conn_";
  protected final String TEXT_488 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_489 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_490 = " - Droping temp table ";
  protected final String TEXT_491 = "\" + tableName_";
  protected final String TEXT_492 = " + \"";
  protected final String TEXT_493 = ".\");" + NL + "\t\t";
  protected final String TEXT_494 = NL + "        stmtTmpDrop_";
  protected final String TEXT_495 = ".execute(\"";
  protected final String TEXT_496 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_497 = ".close();" + NL + "\t\t";
  protected final String TEXT_498 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_499 = " - Drop temp table ";
  protected final String TEXT_500 = "\" + tableName_";
  protected final String TEXT_501 = "+ \"";
  protected final String TEXT_502 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_503 = NL + "\t    ";
  protected final String TEXT_504 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_505 = " =conn_";
  protected final String TEXT_506 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_507 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_508 = ".close();" + NL + "   \t\t";
  protected final String TEXT_509 = "    " + NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_510 = " = conn_";
  protected final String TEXT_511 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "\t";
  protected final String TEXT_512 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_513 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_514 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_515 = " - Inserting records in table ";
  protected final String TEXT_516 = "\" + tableName_";
  protected final String TEXT_517 = " + \"";
  protected final String TEXT_518 = ".\");" + NL + "\t";
  protected final String TEXT_519 = NL + "    stmtBulk_";
  protected final String TEXT_520 = ".execute(bulkSQL_";
  protected final String TEXT_521 = ");" + NL + "    stmtBulk_";
  protected final String TEXT_522 = ".close();    " + NL + "\t";
  protected final String TEXT_523 = NL + "\t\tlog.info(\"";
  protected final String TEXT_524 = " - Insert records in table ";
  protected final String TEXT_525 = "\" + tableName_";
  protected final String TEXT_526 = " + \"";
  protected final String TEXT_527 = " has finished.\");" + NL + "\t";
...
if(("BINARYFILE").equals(fileType)) {
    ...
    stringBuffer.append(ElementParameterParser.getValue(node, "__NULLSTRING__"));
