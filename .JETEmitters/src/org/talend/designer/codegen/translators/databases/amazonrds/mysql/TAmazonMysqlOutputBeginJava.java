...
public class TAmazonMysqlOutputBeginJava {
  ...
  protected final String TEXT_45 = NL + "        int updateKeyCount_";
  protected final String TEXT_46 = " = ";
  protected final String TEXT_47 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_48 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_49 = NL + "        int deleteKeyCount_";
  protected final String TEXT_50 = " = ";
  protected final String TEXT_51 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_52 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_53 = NL + NL + "int nb_line_";
  ...
  protected final String TEXT_57 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_58 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_59 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_60 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_61 = "=0;" + NL + "" + NL + "int rejectedCount_";
  protected final String TEXT_62 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_63 = " = ";
  protected final String TEXT_64 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_65 = " = false;" + NL + "" + NL + "java.util.Calendar calendar_";
  protected final String TEXT_66 = " = java.util.Calendar.getInstance();" + NL + "calendar_";
  protected final String TEXT_67 = ".set(1, 0, 1, 0, 0, 0);" + NL + "long year1_";
  protected final String TEXT_68 = " = calendar_";
  protected final String TEXT_69 = ".getTime().getTime();" + NL + "calendar_";
  protected final String TEXT_70 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "long year10000_";
  protected final String TEXT_71 = " = calendar_";
  protected final String TEXT_72 = ".getTime().getTime();" + NL + "long date_";
  protected final String TEXT_73 = ";" + NL + "" + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_79 = NL + "\tString dbProperties_";
  protected final String TEXT_80 = " = ";
  protected final String TEXT_81 = ";" + NL + "\tString url_";
  protected final String TEXT_82 = " = null;" + NL + "\tif(dbProperties_";
  protected final String TEXT_83 = " == null || dbProperties_";
  protected final String TEXT_84 = ".trim().length() == 0) {" + NL + "\t    url_";
  protected final String TEXT_85 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_86 = " + \":\" + ";
  protected final String TEXT_87 = " + \"/\" + ";
  protected final String TEXT_88 = " + \"?\" + \"rewriteBatchedStatements=true\";" + NL + "\t} else {" + NL + "\t\tString properties_";
  protected final String TEXT_89 = " = ";
  protected final String TEXT_90 = ";" + NL + "\t\tif (!properties_";
  protected final String TEXT_91 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\tproperties_";
  protected final String TEXT_92 = " += \"&rewriteBatchedStatements=true\";" + NL + "\t\t}" + NL + "" + NL + "\t    url_";
  protected final String TEXT_93 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_94 = " + \":\" + ";
  protected final String TEXT_95 = " + \"/\" + ";
  protected final String TEXT_96 = " + \"?\" + properties_";
  protected final String TEXT_97 = ";" + NL + "\t}" + NL + "    String dbUser_";
  ...
  protected final String TEXT_107 = NL + NL + "    String dbPwd_";
  protected final String TEXT_108 = " = decryptedPassword_";
  protected final String TEXT_109 = ";" + NL + "\tjava.lang.Class.forName(\"";
  ...
  protected final String TEXT_117 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_118 = "\", conn_";
  protected final String TEXT_119 = ");" + NL + "\t";
  protected final String TEXT_120 = NL + "        conn_";
  protected final String TEXT_121 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_122 = " = ";
  protected final String TEXT_123 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_124 = " = 0;";
  protected final String TEXT_125 = NL + "   int batchSize_";
  protected final String TEXT_126 = " = ";
  protected final String TEXT_127 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_128 = "=0;";
  protected final String TEXT_129 = NL;
  protected final String TEXT_130 = NL + "int count_";
  ...
  protected final String TEXT_135 = ".createStatement();" + NL + "\t\t\t";
  ...
  protected final String TEXT_160 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_166 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_189 = NL + "        \t\t    // [%connection%][checktable][tableName]" + NL + "        \t\t    String keyCheckTable_";
  protected final String TEXT_190 = " = conn_";
  protected final String TEXT_191 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_192 = " + \"]\";" + NL + "    \t\t    ";
  protected final String TEXT_193 = NL + "\t\t    " + NL + "\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_194 = ")== null){//}" + NL + "\t\t\t" + NL + "\t\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_195 = ")) {//}" + NL + "\t\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_196 = ")== null){//}" + NL + "\t\t\t";
  protected final String TEXT_197 = "              " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_198 = NL + "    \t\t\t\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_199 = " = conn_";
  protected final String TEXT_200 = ".createStatement();" + NL + "                \t\t\t\tboolean whetherExist_";
  protected final String TEXT_201 = " = false;" + NL + "                \t\t\t\ttry {" + NL + "                \t\t\t\t\tisExistStmt_";
  protected final String TEXT_202 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_203 = " + \"]\" );" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_204 = " = true;" + NL + "                \t\t\t\t} catch (java.lang.Exception e){" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_205 = " = false;" + NL + "                \t\t\t\t}" + NL + "                \t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_210 = ".getMetaData();" + NL + "                \t            if(tableNameForSearch_";
  protected final String TEXT_211 = ".indexOf(\"\\\"\")==-1){" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_212 = " = tableNameForSearch_";
  protected final String TEXT_213 = ".toUpperCase();" + NL + "                            \t}else{" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_214 = " = tableNameForSearch_";
  protected final String TEXT_215 = ".replaceAll(\"\\\"\",\"\");" + NL + "                            \t}" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_216 = " = dbMetaData_";
  protected final String TEXT_217 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_218 = ", tableNameForSearch_";
  protected final String TEXT_219 = ", new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_220 = " = false;" + NL + "                \t            if(rsTable_";
  protected final String TEXT_221 = ".next()) {" + NL + "                \t            \twhetherExist_";
  protected final String TEXT_222 = " = true;" + NL + "                \t            }" + NL + "    \t            \t\t\trsTable_";
  protected final String TEXT_223 = ".close();" + NL + "    \t            " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_243 = ".trim().length() ==0)) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_244 = " = true;" + NL + "                \t                    break;" + NL + "        \t            \t    \t}" + NL + "                        \t\t}" + NL + "            \t            \trsTable_";
  ...
  protected final String TEXT_250 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_251 = " = false;" + NL + "                \t            while(rsTable_";
  protected final String TEXT_252 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_253 = " = rsTable_";
  protected final String TEXT_254 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_255 = " = rsTable_";
  protected final String TEXT_256 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_257 = ".equals";
  protected final String TEXT_258 = "IgnoreCase";
  protected final String TEXT_259 = "((";
  protected final String TEXT_260 = ")";
  protected final String TEXT_261 = ".toUpperCase()";
  protected final String TEXT_262 = ") " + NL + "                \t                \t&& (schema_";
  ...
  protected final String TEXT_266 = ") || (dbschema_";
  protected final String TEXT_267 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_268 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_269 = ")))) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_270 = " = true;" + NL + "                \t                    break;" + NL + "                \t                }" + NL + "                \t            }" + NL + "                \t            rsTable_";
  protected final String TEXT_271 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_272 = "  \t            " + NL + "                \t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_273 = " = conn_";
  protected final String TEXT_274 = ".getMetaData();" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_275 = " = dbMetaData_";
  protected final String TEXT_276 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_277 = " = false;" + NL + "                \t            String defaultSchema_";
  protected final String TEXT_278 = " = \"public\";" + NL + "                \t            if(dbschema_";
  protected final String TEXT_279 = " == null || dbschema_";
  protected final String TEXT_280 = ".trim().length() == 0) {" + NL + "                \t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_281 = " = conn_";
  protected final String TEXT_282 = ".createStatement();" + NL + "                \t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_283 = " = stmtSchema_";
  protected final String TEXT_284 = ".executeQuery(\"select current_schema() \");" + NL + "                \t            \twhile(rsSchema_";
  protected final String TEXT_285 = ".next()){" + NL + "                \t            \t\tdefaultSchema_";
  protected final String TEXT_286 = " = rsSchema_";
  protected final String TEXT_287 = ".getString(\"current_schema\");" + NL + "                \t            \t}" + NL + "                \t            \trsSchema_";
  protected final String TEXT_288 = ".close();" + NL + "                \t            \tstmtSchema_";
  protected final String TEXT_289 = ".close();" + NL + "                \t            }" + NL + "                \t            while(rsTable_";
  protected final String TEXT_290 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_291 = " = rsTable_";
  protected final String TEXT_292 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_293 = " = rsTable_";
  protected final String TEXT_294 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_295 = ".equals";
  protected final String TEXT_296 = "IgnoreCase";
  protected final String TEXT_297 = "(";
  protected final String TEXT_298 = ") " + NL + "                \t                \t&& (schema_";
  ...
  protected final String TEXT_302 = ") || ((dbschema_";
  protected final String TEXT_303 = " ==null || dbschema_";
  protected final String TEXT_304 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_305 = ".equals";
  protected final String TEXT_306 = "IgnoreCase";
  protected final String TEXT_307 = "(schema_";
  ...
  protected final String TEXT_317 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_318 = " = rsTable_";
  protected final String TEXT_319 = ".getString(\"TABLE_NAME\");" + NL + "                \t                if(table_";
  protected final String TEXT_320 = ".equalsIgnoreCase(";
  protected final String TEXT_321 = ")) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_322 = " = true;" + NL + "                \t                    break;" + NL + "                \t                }" + NL + "                \t            }" + NL + "                \t            rsTable_";
  protected final String TEXT_323 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_324 = NL + "                    \t\t\tif(!whetherExist_";
  protected final String TEXT_325 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  protected final String TEXT_326 = " = conn_";
  protected final String TEXT_327 = ".createStatement();" + NL + "                        \t\t\t";
  protected final String TEXT_328 = NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_329 = NL + "    \t\t\t\t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_330 = ".execute(((\"";
  protected final String TEXT_331 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_332 = ".";
  protected final String TEXT_333 = ", \"";
  protected final String TEXT_334 = "\")";
  protected final String TEXT_335 = ".toUpperCase()";
  ...
  protected final String TEXT_343 = ".close();            " + NL + "                    \t\t\t}                " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_344 = NL + "                                if(whetherExist_";
  protected final String TEXT_345 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_346 = " = conn_";
  protected final String TEXT_347 = ".createStatement();" + NL + "                \t    \t    \t";
  protected final String TEXT_348 = NL + "                                    stmtDrop_";
  protected final String TEXT_349 = ".execute(\"";
  protected final String TEXT_350 = "\" ";
  protected final String TEXT_351 = ");" + NL + "                \t    \t    \t";
  protected final String TEXT_352 = NL + "                                    stmtDrop_";
  protected final String TEXT_353 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  protected final String TEXT_354 = " = conn_";
  protected final String TEXT_355 = ".createStatement();" + NL + "            \t    \t    \t";
  protected final String TEXT_356 = NL + "        \t\t\t\t\t\t";
  protected final String TEXT_357 = NL + "        \t\t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_358 = ".execute(((\"";
  protected final String TEXT_359 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_360 = ".";
  protected final String TEXT_361 = ", \"";
  protected final String TEXT_362 = "\")";
  protected final String TEXT_363 = ".toUpperCase()";
  ...
  protected final String TEXT_373 = NL + "    \t\t\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_374 = ", true);" + NL + "    \t\t//{{{" + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_375 = "            ";
  protected final String TEXT_376 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_380 = ".executeUpdate(\"";
  ...
  protected final String TEXT_389 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_390 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_391 = ".next()) {" + NL + "\t\t\t\trsTruncCountNumber_";
  ...
  protected final String TEXT_395 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_396 = " = conn_";
  protected final String TEXT_397 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_398 = NL + "\t\t\t";
  protected final String TEXT_399 = NL + "\t\t\t\tconn_";
  protected final String TEXT_400 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_401 = NL + "            stmtTrunc_";
  protected final String TEXT_402 = ".executeUpdate(\"";
  protected final String TEXT_403 = "\");";
  protected final String TEXT_404 = NL + "                if(!conn_";
  protected final String TEXT_405 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_406 = ".commit();" + NL + "                }";
  protected final String TEXT_407 = NL + "   \t    \t";
  protected final String TEXT_408 = NL + "   \t    \tdeletedCount_";
  protected final String TEXT_409 = " += rsTruncCountNumber_";
  protected final String TEXT_410 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_411 = ".close();            " + NL + "\t\t";
  protected final String TEXT_412 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_413 = " = conn_";
  protected final String TEXT_414 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_415 = " = stmtTruncCount_";
  protected final String TEXT_416 = ".executeQuery(\"";
  protected final String TEXT_417 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_418 = " = conn_";
  protected final String TEXT_419 = ".createStatement();" + NL + "  \t    \t";
  protected final String TEXT_420 = NL + "\t\t\t";
  protected final String TEXT_421 = NL + "\t\t\t\tconn_";
  protected final String TEXT_422 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_423 = NL + "            stmtTrunc_";
  protected final String TEXT_424 = ".executeUpdate(\"";
  ...
  protected final String TEXT_433 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_434 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");" + NL + "\t\t\t\t";
  protected final String TEXT_435 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_436 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_437 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_438 = ".append (\"`\" +  ";
  protected final String TEXT_439 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_440 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_441 = ".append (";
  protected final String TEXT_442 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_443 = NL;
  protected final String TEXT_444 = NL + "\t\t        String insert_";
  protected final String TEXT_445 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_446 = " + \"` (";
  protected final String TEXT_447 = ") VALUES (";
  protected final String TEXT_448 = ")\";";
  protected final String TEXT_449 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_450 = " += \tduplidateClause_";
  protected final String TEXT_451 = ".toString();";
  protected final String TEXT_452 = NL + "\t\t\t\t";
  protected final String TEXT_453 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_454 = " = new StringBuffer(insert_";
  protected final String TEXT_455 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_456 = ".insert(insert_";
  protected final String TEXT_457 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_458 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_459 = " =insertStringBuffer_";
  protected final String TEXT_460 = ".toString(); ";
  protected final String TEXT_461 = "    " + NL + "" + NL + "                java.sql.PreparedStatement pstmt_";
  protected final String TEXT_462 = " = conn_";
  protected final String TEXT_463 = ".prepareStatement(insert_";
  protected final String TEXT_464 = ");" + NL;
  protected final String TEXT_465 = NL + "\t            class BufferLine_";
  protected final String TEXT_466 = " {" + NL + "    \t            ";
  protected final String TEXT_467 = NL + "                            ";
  protected final String TEXT_468 = " ";
  protected final String TEXT_469 = ";";
  protected final String TEXT_470 = NL + NL + "\t                public BufferLine_";
  protected final String TEXT_471 = "(";
  protected final String TEXT_472 = NL + "                                ,";
  protected final String TEXT_473 = NL + "                            ";
  protected final String TEXT_474 = " ";
  protected final String TEXT_475 = NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_476 = NL + "                                this.";
  protected final String TEXT_477 = " = ";
  protected final String TEXT_478 = ";";
  protected final String TEXT_479 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_480 = "> exInsertColValueList";
  protected final String TEXT_481 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_482 = " exInsertColValue";
  protected final String TEXT_483 = " = null;" + NL + "" + NL + "" + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_484 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_485 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_486 = ".append(\"(";
  protected final String TEXT_487 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_488 = "-1) extendInsertValueStmt_";
  protected final String TEXT_489 = ".append(\",\");" + NL + "                }" + NL + "" + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_490 = " = \"INSERT INTO `\"+";
  protected final String TEXT_491 = "+\"` (";
  protected final String TEXT_492 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_493 = ".toString();";
  protected final String TEXT_494 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_495 = " += \tduplidateClause_";
  protected final String TEXT_496 = ".toString();";
  protected final String TEXT_497 = NL + "\t\t\t\t";
  protected final String TEXT_498 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_499 = " = new StringBuffer(insert_";
  protected final String TEXT_500 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_501 = ".insert(insert_";
  protected final String TEXT_502 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_503 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_504 = " =insertStringBuffer_";
  protected final String TEXT_505 = ".toString(); ";
  ...
  protected final String TEXT_509 = ");" + NL + "" + NL + "\t            String insertColName";
  protected final String TEXT_510 = " = \"";
  protected final String TEXT_511 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_512 = " =  \"";
  protected final String TEXT_513 = "\";" + NL + "\t            int rowCount";
  protected final String TEXT_514 = " = 0;";
  protected final String TEXT_515 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_516 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_517 = " + \"` (";
  protected final String TEXT_518 = ") VALUES (";
  protected final String TEXT_519 = ")\";";
  protected final String TEXT_520 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_521 = " += \tduplidateClause_";
  protected final String TEXT_522 = ".toString();";
  protected final String TEXT_523 = NL + "\t\t        int batchSize_";
  protected final String TEXT_524 = " = ";
  protected final String TEXT_525 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_526 = "=0;" + NL + "\t\t        ";
  protected final String TEXT_527 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_528 = " = new StringBuffer(insert_";
  protected final String TEXT_529 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_530 = ".insert(insert_";
  protected final String TEXT_531 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_532 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_533 = " =insertStringBuffer_";
  protected final String TEXT_534 = ".toString(); ";
  protected final String TEXT_535 = "    " + NL + "\t\t        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_536 = " = conn_";
  protected final String TEXT_537 = ".prepareStatement(insert_";
  protected final String TEXT_538 = ");" + NL;
  protected final String TEXT_539 = NL + "\t    String update_";
  protected final String TEXT_540 = " = \"UPDATE `\" + ";
  protected final String TEXT_541 = " + \"` SET ";
  protected final String TEXT_542 = " WHERE ";
  protected final String TEXT_543 = "\";" + NL + "\t    ";
  protected final String TEXT_544 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_545 = " = new StringBuffer(update_";
  protected final String TEXT_546 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_547 = ".insert(update_";
  protected final String TEXT_548 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_549 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_550 = " =updateStringBuffer_";
  protected final String TEXT_551 = ".toString(); ";
  protected final String TEXT_552 = NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_558 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  ...
  protected final String TEXT_563 = ") VALUES (";
  ...
  protected final String TEXT_573 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_577 = " = \"UPDATE `\" + ";
  protected final String TEXT_578 = " + \"` SET ";
  protected final String TEXT_579 = " WHERE ";
  protected final String TEXT_580 = "\";" + NL + "\t    ";
  protected final String TEXT_581 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_582 = " = new StringBuffer(update_";
  protected final String TEXT_583 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_584 = ".insert(update_";
  protected final String TEXT_585 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_586 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_587 = " =updateStringBuffer_";
  protected final String TEXT_588 = ".toString(); ";
  protected final String TEXT_589 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_590 = " = conn_";
  protected final String TEXT_591 = ".prepareStatement(update_";
  protected final String TEXT_592 = ");" + NL + "\t    ";
  protected final String TEXT_593 = NL + "\t    String update_";
  protected final String TEXT_594 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_606 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_607 = " = conn_";
  protected final String TEXT_608 = ".prepareStatement(update_";
  protected final String TEXT_609 = ");" + NL + "\t    String insert_";
  protected final String TEXT_610 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_611 = " + \"` (";
  protected final String TEXT_612 = ") VALUES (";
  protected final String TEXT_613 = ")\";" + NL + "\t     ";
  protected final String TEXT_614 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_615 = " = new StringBuffer(insert_";
  protected final String TEXT_616 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_617 = ".insert(insert_";
  protected final String TEXT_618 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_619 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_620 = " =insertStringBuffer_";
  protected final String TEXT_621 = ".toString(); ";
  protected final String TEXT_622 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_623 = " = conn_";
  protected final String TEXT_624 = ".prepareStatement(insert_";
  protected final String TEXT_625 = ");" + NL + "\t    ";
  protected final String TEXT_626 = NL + "\t    String delete_";
  protected final String TEXT_627 = " = \"DELETE  FROM `\" + ";
  protected final String TEXT_628 = " + \"` WHERE ";
  protected final String TEXT_629 = "\";" + NL + "\t    ";
  protected final String TEXT_630 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_631 = " = new StringBuffer(delete_";
  protected final String TEXT_632 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_633 = ".insert(delete_";
  protected final String TEXT_634 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_635 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_636 = " =deleteStringBuffer_";
  protected final String TEXT_637 = ".toString();  ";
  protected final String TEXT_638 = NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_642 = NL + "\t    String replace_";
  protected final String TEXT_643 = " = \"REPLACE INTO `\" + ";
  protected final String TEXT_644 = " + \"` (";
  protected final String TEXT_645 = ") VALUES (";
  protected final String TEXT_646 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_647 = " = conn_";
  protected final String TEXT_648 = ".prepareStatement(replace_";
  protected final String TEXT_649 = ");" + NL + "\t    ";
  protected final String TEXT_650 = NL + "\t    String insertIgnore_";
  protected final String TEXT_651 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_652 = " + \"` (";
  protected final String TEXT_653 = ") VALUES (";
  protected final String TEXT_654 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_655 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_656 = " = conn_";
  protected final String TEXT_657 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_658 = ");" + NL + "\t    ";
  protected final String TEXT_659 = NL + "\t    String insert_";
  protected final String TEXT_660 = " = \"INSERT IGNORE INTO `\" + ";
  ...
  protected final String TEXT_672 = "    " + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_676 = NL + "        StringBuffer query_";
  protected final String TEXT_677 = " = null;" + NL + "       \t";
  protected final String TEXT_678 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_679 = " = insert_";
  ...
  protected final String TEXT_686 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_687 = " = update_";
  protected final String TEXT_688 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_689 = " = insert_";
  protected final String TEXT_690 = ".split(\"\\\\?\");";
  protected final String TEXT_691 = NL + "\t\t\tdelete_";
  protected final String TEXT_692 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_693 = " = delete_";
  protected final String TEXT_694 = ".split(\"\\\\?\");";
  protected final String TEXT_695 = NL + "\t\t\treplace_";
  protected final String TEXT_696 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_697 = " = replace_";
  protected final String TEXT_698 = ".split(\"\\\\?\");";
  protected final String TEXT_699 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_700 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_701 = " = insertIgnore_";
  protected final String TEXT_702 = ".split(\"\\\\?\");";
  protected final String TEXT_703 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_704 = " = insert_";
  protected final String TEXT_705 = ".split(\"\\\\?\");";
  protected final String TEXT_706 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_707 = " {" + NL + "    \t            ";
  protected final String TEXT_708 = NL + "                            ";
  protected final String TEXT_709 = " ";
  protected final String TEXT_710 = ";";
  protected final String TEXT_711 = NL + "\t\t\t\troutines.system.Dynamic ";
  protected final String TEXT_712 = ";" + NL + "\t\t\t";
  protected final String TEXT_713 = NL + NL + "\t                public BufferLine_";
  protected final String TEXT_714 = "(";
  protected final String TEXT_715 = NL + "                                ,";
  protected final String TEXT_716 = NL + "                            ";
  protected final String TEXT_717 = " ";
  protected final String TEXT_718 = NL + "\t\t\t\t, routines.system.Dynamic ";
  protected final String TEXT_719 = NL + "\t\t\t";
  protected final String TEXT_720 = NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_721 = NL + "                                this.";
  protected final String TEXT_722 = " = ";
  protected final String TEXT_723 = ";";
  protected final String TEXT_724 = NL + "\t\t\t\tthis.";
  protected final String TEXT_725 = "=";
  protected final String TEXT_726 = ";" + NL + "\t\t\t";
  protected final String TEXT_727 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_728 = "> exInsertColValueList";
  protected final String TEXT_729 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_730 = " exInsertColValue";
  protected final String TEXT_731 = " = null;" + NL + "\t\t    String insert_";
  protected final String TEXT_732 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_733 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_734 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_735 = "=1;";
  protected final String TEXT_736 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_737 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_738 = "=0;";
  protected final String TEXT_739 = NL + NL + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_740 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_741 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_742 = " =null;" + NL + "\tint rowCount";
  protected final String TEXT_743 = "=0;" + NL + "\t";
  protected final String TEXT_744 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_745 = " = null;" + NL + "\t\t";
  protected final String TEXT_746 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_750 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_751 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_752 = " = null;";
  protected final String TEXT_753 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_754 = " = null;";
  protected final String TEXT_755 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_756 = " = null;";
  protected final String TEXT_757 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_758 = " = null;";
  protected final String TEXT_759 = NL + "\t\t \tString[] insertSQLSplits_";
