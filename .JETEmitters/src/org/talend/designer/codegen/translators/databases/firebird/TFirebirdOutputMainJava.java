...
public class TFirebirdOutputMainJava {
  protected static String nl;
  public static synchronized TFirebirdOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFirebirdOutputMainJava result = new TFirebirdOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_84 = NL + "                                   rejectedCount_";
  ...
  protected final String TEXT_95 = NL + "                        query_";
  protected final String TEXT_96 = " = ";
  protected final String TEXT_97 = ";";
  protected final String TEXT_98 = NL + NL + "\t\t\t\t\t";
  protected final String TEXT_99 = NL + "                    \t";
  protected final String TEXT_100 = NL + "                        query_";
  ...
  protected final String TEXT_163 = NL + "                            query_";
  protected final String TEXT_164 = " = ";
  protected final String TEXT_165 = ";";
  protected final String TEXT_166 = NL + "                    globalMap.put(\"";
  protected final String TEXT_167 = "_QUERY\", query_";
  protected final String TEXT_168 = ".toString().trim());";
  protected final String TEXT_169 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_170 = " = updatedCount_";
  protected final String TEXT_171 = " + pstmtUpdate_";
  protected final String TEXT_172 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_173 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_174 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_175 = " = true;";
  protected final String TEXT_176 = NL + "                        throw(e);";
  protected final String TEXT_177 = NL + "                    \tnb_line_";
  protected final String TEXT_178 = "++;" + NL + "                    \t";
  protected final String TEXT_179 = NL + "                            ";
  protected final String TEXT_180 = " = new ";
  protected final String TEXT_181 = "Struct();";
  protected final String TEXT_182 = NL + "                                ";
  protected final String TEXT_183 = ".";
  protected final String TEXT_184 = " = ";
  protected final String TEXT_185 = ".";
  protected final String TEXT_186 = ";";
  protected final String TEXT_187 = NL + "                            rejectedCount_";
  protected final String TEXT_188 = " = rejectedCount_";
  protected final String TEXT_189 = " + 1;";
  protected final String TEXT_190 = NL + "                            ";
  protected final String TEXT_191 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_192 = NL + "                            ";
  protected final String TEXT_193 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_194 = ";";
  protected final String TEXT_195 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_196 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_197 = NL + "                        ";
  protected final String TEXT_198 = NL + "                            query_";
  protected final String TEXT_199 = " = ";
  protected final String TEXT_200 = ";";
  protected final String TEXT_201 = NL + "                    globalMap.put(\"";
  protected final String TEXT_202 = "_QUERY\", query_";
  protected final String TEXT_203 = ".toString().trim());";
  protected final String TEXT_204 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_205 = " = insertedCount_";
  protected final String TEXT_206 = " + pstmtInsert_";
  protected final String TEXT_207 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_208 = "++;";
  protected final String TEXT_209 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_222 = NL + "                            rejectedCount_";
  protected final String TEXT_223 = " = rejectedCount_";
  protected final String TEXT_224 = " + 1;";
  protected final String TEXT_225 = NL + "                            ";
  protected final String TEXT_226 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_227 = NL + "                            ";
  protected final String TEXT_228 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_229 = ";";
  protected final String TEXT_230 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_231 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\t";
  protected final String TEXT_232 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_240 = NL + "\t                        query_";
  protected final String TEXT_241 = " = ";
  protected final String TEXT_242 = ";" + NL + "\t                        ";
  protected final String TEXT_243 = NL;
  protected final String TEXT_244 = NL + "                    ";
  protected final String TEXT_245 = NL + "                        query_";
  protected final String TEXT_246 = " = ";
  protected final String TEXT_247 = ";";
  protected final String TEXT_248 = NL + "                globalMap.put(\"";
  protected final String TEXT_249 = "_QUERY\", query_";
  protected final String TEXT_250 = ".toString().trim());";
  protected final String TEXT_251 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_252 = "=pstmtUpdate_";
  protected final String TEXT_253 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_254 = " = updatedCount_";
  protected final String TEXT_255 = " + updateFlag_";
  protected final String TEXT_256 = ";" + NL + "" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_264 = NL + "                    globalMap.put(\"";
  protected final String TEXT_265 = "_QUERY\", query_";
  protected final String TEXT_266 = ".toString().trim());";
  protected final String TEXT_267 = NL + "                \tinsertedCount_";
  protected final String TEXT_268 = " = insertedCount_";
  protected final String TEXT_269 = " + pstmtInsert_";
  protected final String TEXT_270 = ".executeUpdate();" + NL + "                \tnb_line_";
  protected final String TEXT_271 = "++;";
  protected final String TEXT_272 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_273 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_274 = NL + "             \t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_275 = " = true;";
  ...
  protected final String TEXT_281 = "Struct();";
  protected final String TEXT_282 = NL + "                                ";
  protected final String TEXT_283 = ".";
  protected final String TEXT_284 = " = ";
  protected final String TEXT_285 = ".";
  protected final String TEXT_286 = ";";
  protected final String TEXT_287 = NL + "                            rejectedCount_";
  protected final String TEXT_288 = " = rejectedCount_";
  protected final String TEXT_289 = " + 1;";
  protected final String TEXT_290 = NL + "                            ";
  protected final String TEXT_291 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_292 = NL + "                            ";
  protected final String TEXT_293 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_294 = ";";
  protected final String TEXT_295 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_304 = NL + "                        query_";
  protected final String TEXT_305 = " = ";
  protected final String TEXT_306 = ";";
  protected final String TEXT_307 = NL + "                globalMap.put(\"";
  protected final String TEXT_308 = "_QUERY\", query_";
  protected final String TEXT_309 = ".toString().trim());";
  protected final String TEXT_310 = NL;
  protected final String TEXT_311 = NL + "                       pstmt_";
  protected final String TEXT_312 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_313 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_314 = "++;";
  protected final String TEXT_315 = NL + "                       try {" + NL + "                           deletedCount_";
  protected final String TEXT_316 = " = deletedCount_";
  protected final String TEXT_317 = " + pstmt_";
  protected final String TEXT_318 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_319 = "++;";
  protected final String TEXT_320 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  protected final String TEXT_321 = " = true;";
  protected final String TEXT_322 = NL + "                               throw(e);";
  ...
  protected final String TEXT_333 = NL + "                                   rejectedCount_";
  protected final String TEXT_334 = " = rejectedCount_";
  protected final String TEXT_335 = " + 1;";
  protected final String TEXT_336 = NL + "                                   ";
  protected final String TEXT_337 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_338 = NL + "                                   ";
  protected final String TEXT_339 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_340 = ";";
  protected final String TEXT_341 = NL + "                                   System.err.print(e.getMessage());";
  protected final String TEXT_342 = NL + "                       }";
  protected final String TEXT_343 = NL + "    \t";
  protected final String TEXT_344 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_355 = NL + "                if ((batchSize_";
  protected final String TEXT_356 = " > 0) && (batchSize_";
  protected final String TEXT_357 = " <= batchSizeCounter_";
  protected final String TEXT_358 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_359 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_360 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_361 = " = 0;";
  protected final String TEXT_362 = NL + "                        status_";
  protected final String TEXT_363 = " = pstmt_";
  protected final String TEXT_364 = ".executeBatch();";
  protected final String TEXT_365 = NL + "                        for(int countEach_";
  protected final String TEXT_366 = ": status_";
  protected final String TEXT_367 = ") {" + NL + "                            countSum_";
  protected final String TEXT_368 = " += (countEach_";
  protected final String TEXT_369 = " < 0 ? 0 : countEach_";
  protected final String TEXT_370 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_371 = NL + "                            throw(e);";
  protected final String TEXT_372 = NL + "                        for(int countEach_";
  protected final String TEXT_373 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_374 = " += (countEach_";
  protected final String TEXT_375 = " < 0 ? 0 : countEach_";
  protected final String TEXT_376 = ");" + NL + "                        }";
  protected final String TEXT_377 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_378 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_379 = " = pstmt_";
  protected final String TEXT_380 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_381 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_382 = " = tmp_batchUpdateCount_";
  protected final String TEXT_383 = " > countSum_";
  protected final String TEXT_384 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_385 = " : countSum_";
  protected final String TEXT_386 = ";";
  protected final String TEXT_387 = NL + "                        insertedCount_";
  protected final String TEXT_388 = " += tmp_batchUpdateCount_";
  protected final String TEXT_389 = ";";
  protected final String TEXT_390 = NL + "                        updatedCount_";
  protected final String TEXT_391 = " += tmp_batchUpdateCount_";
  protected final String TEXT_392 = ";";
  protected final String TEXT_393 = NL + "                        deletedCount_";
  protected final String TEXT_394 = " += tmp_batchUpdateCount_";
  protected final String TEXT_395 = ";";
  protected final String TEXT_396 = NL + "               }";
  protected final String TEXT_397 = NL + "                commitCounter_";
  protected final String TEXT_398 = "++;" + NL + "" + NL + "                if(commitEvery_";
  protected final String TEXT_399 = " <= commitCounter_";
  protected final String TEXT_400 = ") {";
  protected final String TEXT_401 = NL + "                           if(batchSize_";
  protected final String TEXT_402 = " > 0){";
  protected final String TEXT_403 = NL + "                                 conn_";
  protected final String TEXT_404 = ".commit();";
  protected final String TEXT_405 = NL + "                                 commitCounter_";
  protected final String TEXT_406 = "=0;" + NL + "                           }";
  protected final String TEXT_407 = NL + "                           conn_";
  protected final String TEXT_408 = ".commit();";
  protected final String TEXT_409 = NL + "                           commitCounter_";
