...
public class TPostgresPlusSCDELTBeginJava {
  protected static String nl;
  public static synchronized TPostgresPlusSCDELTBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresPlusSCDELTBeginJava result = new TPostgresPlusSCDELTBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_27 = ");" + NL + "        String schema_";
  protected final String TEXT_28 = " = ";
  protected final String TEXT_29 = ";";
  protected final String TEXT_30 = NL + "    String tableName_";
  protected final String TEXT_31 = " = null;" + NL + "    String sourceTable_";
  protected final String TEXT_32 = " = null;" + NL + "    if(schema_";
  protected final String TEXT_33 = " != null && schema_";
  protected final String TEXT_34 = ".trim().length() != 0) {" + NL + "        tableName_";
  protected final String TEXT_35 = " = schema_";
  protected final String TEXT_36 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_37 = ";" + NL + "        sourceTable_";
  protected final String TEXT_38 = " = schema_";
  protected final String TEXT_39 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_40 = ";" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_41 = " = ";
  protected final String TEXT_42 = ";" + NL + "        sourceTable_";
  ...
  protected final String TEXT_67 = " = false;" + NL + "            String defaultSchema_";
  protected final String TEXT_68 = " = \"public\";" + NL + "            if(schema_";
  protected final String TEXT_69 = " == null || schema_";
  protected final String TEXT_70 = ".trim().length() == 0) {" + NL + "            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_71 = " = conn_";
  protected final String TEXT_72 = ".createStatement();" + NL + "            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_73 = " = stmtSchema_";
  protected final String TEXT_74 = ".executeQuery(\"select current_schema() \");" + NL + "            \twhile(rsSchema_";
  protected final String TEXT_75 = ".next()){" + NL + "            \t\tdefaultSchema_";
  protected final String TEXT_76 = " = rsSchema_";
  protected final String TEXT_77 = ".getString(\"current_schema\");" + NL + "            \t}" + NL + "            \trsSchema_";
  protected final String TEXT_78 = ".close();" + NL + "            \tstmtSchema_";
  protected final String TEXT_79 = ".close();" + NL + "            }" + NL + "            while(rsTable_";
  protected final String TEXT_80 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_81 = " = rsTable_";
  protected final String TEXT_82 = ".getString(\"TABLE_NAME\");" + NL + "                String schemaName_";
  protected final String TEXT_83 = " = rsTable_";
  protected final String TEXT_84 = ".getString(\"TABLE_SCHEM\");" + NL + "                if(table_";
  protected final String TEXT_85 = ".equals(";
  protected final String TEXT_86 = ")" + NL + "                \t && (schemaName_";
  protected final String TEXT_87 = ".equals(schema_";
  protected final String TEXT_88 = ") || ((schema_";
  protected final String TEXT_89 = " == null || schema_";
  protected final String TEXT_90 = ".trim().length() == 0) && defaultSchema_";
  protected final String TEXT_91 = ".equals(schemaName_";
  protected final String TEXT_92 = ")))) {" + NL + "                    whetherExist_";
  protected final String TEXT_93 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  protected final String TEXT_94 = ".close();";
  protected final String TEXT_95 = NL + "                if(!whetherExist_";
  protected final String TEXT_96 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_97 = " = conn_";
  protected final String TEXT_98 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_102 = NL + "                if(whetherExist_";
  protected final String TEXT_103 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_104 = " = conn_";
  protected final String TEXT_105 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_106 = ".execute(\"";
  protected final String TEXT_107 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_108 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_109 = " = conn_";
  protected final String TEXT_110 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_114 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_115 = " = conn_";
  protected final String TEXT_116 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_117 = ".executeUpdate(\"";
  protected final String TEXT_118 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_119 = ".close();";
  protected final String TEXT_120 = NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_121 = " = conn_";
  protected final String TEXT_122 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_123 = ".executeUpdate(\"";
  protected final String TEXT_124 = "\");" + NL + "            stmtTrunc_";
  protected final String TEXT_125 = ".close();";
  protected final String TEXT_126 = NL + "        System.out.println(\"[";
  protected final String TEXT_127 = "] table action ";
  protected final String TEXT_128 = " done\\n\");";
  protected final String TEXT_129 = NL + "        String updateForType1_";
  protected final String TEXT_130 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_131 = " + \"\\\" d SET ";
  protected final String TEXT_132 = " FROM \\\"\" + sourceTable_";
  protected final String TEXT_133 = " + \"\\\" t WHERE ";
  protected final String TEXT_134 = " AND (";
  protected final String TEXT_135 = ")\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_136 = " = conn_";
  protected final String TEXT_137 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_138 = ".executeUpdate(updateForType1_";
  protected final String TEXT_139 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_140 = ".close();";
  protected final String TEXT_141 = NL + "            System.out.println(\"[";
  protected final String TEXT_142 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_143 = " + \"\\ndone\");";
  protected final String TEXT_144 = NL + "        String updateForType2_";
  protected final String TEXT_145 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_146 = " + \"\\\" d SET \\\"";
  protected final String TEXT_147 = "\\\" = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_148 = "\"))) + \"'";
  protected final String TEXT_149 = ", \\\"";
  protected final String TEXT_150 = "\\\" = 0";
  protected final String TEXT_151 = " FROM \\\"\" + sourceTable_";
  protected final String TEXT_152 = " + \"\\\" t WHERE ";
  protected final String TEXT_153 = " AND (";
  protected final String TEXT_154 = ") AND d.\\\"";
  protected final String TEXT_155 = "\\\" IS NULL\";" + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_156 = " = conn_";
  protected final String TEXT_157 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_158 = ".executeUpdate(updateForType2_";
  protected final String TEXT_159 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_160 = ".close();";
  protected final String TEXT_161 = NL + "            System.out.println(\"[";
  protected final String TEXT_162 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_163 = " + \"\\ndone\");";
  protected final String TEXT_164 = NL + "        String insertForType2_";
  protected final String TEXT_165 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_166 = " + \"\\\"(";
  protected final String TEXT_167 = "\\\"";
  protected final String TEXT_168 = "\\\", ";
  protected final String TEXT_169 = ") SELECT ";
  protected final String TEXT_170 = "NEXTVAL('\" + ";
  protected final String TEXT_171 = " + \"'), ";
  protected final String TEXT_172 = "t.";
  protected final String TEXT_173 = ", '\" + " + NL + "        (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_174 = "\"))) + \"', NULL";
  protected final String TEXT_175 = ", 1";
  protected final String TEXT_176 = ", d.\\\"";
  protected final String TEXT_177 = "\\\" + 1";
  protected final String TEXT_178 = " FROM \\\"\" + " + NL + "        sourceTable_";
  protected final String TEXT_179 = " + \"\\\" t, \\\"\" + tableName_";
  protected final String TEXT_180 = " + \"\\\" d WHERE ";
  protected final String TEXT_181 = " AND (";
  protected final String TEXT_182 = ") AND d.\\\"";
  protected final String TEXT_183 = "\\\" = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_184 = "\"))) + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_185 = " = conn_";
  protected final String TEXT_186 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_187 = ".executeUpdate(insertForType2_";
  protected final String TEXT_188 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_189 = ".close();";
  protected final String TEXT_190 = NL + "            System.out.println(\"[";
  protected final String TEXT_191 = "] type2 new active row slq\\n\" + insertForType2_";
  protected final String TEXT_192 = " + \"\\ndone\");";
  protected final String TEXT_193 = NL + "    String insert_";
  protected final String TEXT_194 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_195 = " + \"\\\"(";
  protected final String TEXT_196 = "\\\"";
  protected final String TEXT_197 = "\\\", ";
  protected final String TEXT_198 = ") SELECT ";
  protected final String TEXT_199 = "NEXTVAL('\" + ";
  protected final String TEXT_200 = " + \"'), ";
  protected final String TEXT_201 = "t.";
  protected final String TEXT_202 = "\"";
  protected final String TEXT_203 = " + \", '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_204 = "\"))) + \"', NULL\"";
  protected final String TEXT_205 = NL + "    + \"";
  protected final String TEXT_206 = ", 1";
  protected final String TEXT_207 = ", 1";
  protected final String TEXT_208 = " FROM \\\"\" + " + NL + "    sourceTable_";
  protected final String TEXT_209 = " + \"\\\" t LEFT JOIN \\\"\" + tableName_";
  protected final String TEXT_210 = " + \"\\\" d ON ";
  protected final String TEXT_211 = " WHERE (";
  protected final String TEXT_212 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_213 = " = conn_";
  protected final String TEXT_214 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_215 = ".executeUpdate(insert_";
  protected final String TEXT_216 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_217 = ".close();";
  protected final String TEXT_218 = NL + "        System.out.println(\"[";
  protected final String TEXT_219 = "] new rows sql\\n\" + insert_";
