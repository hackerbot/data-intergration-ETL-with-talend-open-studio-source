...
public class TSQLiteOutputEndJava {
  ...
  protected final String TEXT_44 = " != null) {" + NL + "                pstmtUpdate_";
  protected final String TEXT_45 = ".close();" + NL + "            }" + NL + "            if(pstmtInsert_";
  protected final String TEXT_46 = " != null) {" + NL + "                pstmtInsert_";
  protected final String TEXT_47 = ".close();" + NL + "            }" + NL + "            if(pstmt_";
  protected final String TEXT_48 = " != null) {" + NL + "                pstmt_";
  protected final String TEXT_49 = ".close();" + NL + "            }";
  protected final String TEXT_50 = NL + "            if(pstmtUpdate_";
  protected final String TEXT_51 = " != null) {" + NL + "                pstmtUpdate_";
  protected final String TEXT_52 = ".close();" + NL + "            }" + NL + "            if(pstmtInsert_";
  protected final String TEXT_53 = " != null) {" + NL + "                pstmtInsert_";
  protected final String TEXT_54 = ".close();" + NL + "            }";
  protected final String TEXT_55 = NL;
  protected final String TEXT_56 = NL + "                    int[] status_";
  protected final String TEXT_57 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_58 = " = 0;" + NL + "                    try {" + NL + "                        if(pstmt_";
  protected final String TEXT_59 = "!=null && batchSizeCounter_";
  protected final String TEXT_60 = " > 0 ){";
  protected final String TEXT_61 = NL + "                            status_";
  protected final String TEXT_62 = " = pstmt_";
  protected final String TEXT_63 = ".executeBatch();";
  protected final String TEXT_64 = NL + "                            for(int countEach_";
  protected final String TEXT_65 = ": status_";
  protected final String TEXT_66 = ") {" + NL + "                                countSum_";
  protected final String TEXT_67 = " += (countEach_";
  protected final String TEXT_68 = " < 0 ? 0 : countEach_";
  protected final String TEXT_69 = ");" + NL + "                            }" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_70 = NL + "                            throw(e);";
  protected final String TEXT_71 = NL + "                        for(int countEach_";
  protected final String TEXT_72 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_73 = " += (countEach_";
  protected final String TEXT_74 = " < 0 ? 0 : countEach_";
  protected final String TEXT_75 = ");" + NL + "                        }" + NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_76 = NL + "                    }" + NL + "                    if(pstmt_";
  protected final String TEXT_77 = "!=null && batchSizeCounter_";
  protected final String TEXT_78 = " > 0 ){" + NL + "                        try {" + NL + "                            tmp_batchUpdateCount_";
  protected final String TEXT_79 = " = pstmt_";
  protected final String TEXT_80 = ".getUpdateCount();" + NL + "                        }catch (java.sql.SQLException e){" + NL + "" + NL + "                        }" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_81 = " = tmp_batchUpdateCount_";
  protected final String TEXT_82 = " > countSum_";
  protected final String TEXT_83 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_84 = " : countSum_";
  protected final String TEXT_85 = ";";
  protected final String TEXT_86 = NL + "                            insertedCount_";
  protected final String TEXT_87 = " += tmp_batchUpdateCount_";
  protected final String TEXT_88 = ";";
  protected final String TEXT_89 = NL + "                            updatedCount_";
  protected final String TEXT_90 = " += tmp_batchUpdateCount_";
  protected final String TEXT_91 = ";";
  protected final String TEXT_92 = NL + "                            deletedCount_";
  protected final String TEXT_93 = " += tmp_batchUpdateCount_";
  protected final String TEXT_94 = ";";
  protected final String TEXT_95 = NL + "                    }";
  protected final String TEXT_96 = NL + "                    if(pstmt_";
  protected final String TEXT_97 = " != null) {" + NL + "                        pstmt_";
  protected final String TEXT_98 = ".close();" + NL + "                    }";
  protected final String TEXT_99 = NL;
  protected final String TEXT_100 = NL + "        if (commitCounter_";
  protected final String TEXT_101 = " > 0) {";
  protected final String TEXT_102 = NL + "            conn_";
  protected final String TEXT_103 = ".commit();";
  ...
  protected final String TEXT_108 = "\", true);";
  protected final String TEXT_109 = NL + NL + "\tint rejectedCount_";
  protected final String TEXT_110 = " = 0;";
  protected final String TEXT_111 = NL + "\tnb_line_deleted_";
  protected final String TEXT_112 = "=nb_line_deleted_";
  protected final String TEXT_113 = "+ deletedCount_";
  protected final String TEXT_114 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_115 = "=nb_line_update_";
  protected final String TEXT_116 = " + updatedCount_";
  protected final String TEXT_117 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_118 = "=nb_line_inserted_";
  protected final String TEXT_119 = " + insertedCount_";
  protected final String TEXT_120 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_121 = "=nb_line_rejected_";
  protected final String TEXT_122 = " + rejectedCount_";
  protected final String TEXT_123 = ";" + NL + "\t";
  protected final String TEXT_124 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_125 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_126 = "_NB_LINE\",nb_line_";
  protected final String TEXT_127 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_128 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_129 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_130 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_131 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_132 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_133 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_134 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_135 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_136 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_137 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_138 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_139 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_140 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_141 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_142 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_143 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_144 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_145 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_146 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_147 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_148 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_149 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_150 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_151 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_152 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_153 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  ...
  protected final String TEXT_160 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_161 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_162 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_163 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_164 = "_NB_LINE_REJECTED\", nb_line_rejected_";
