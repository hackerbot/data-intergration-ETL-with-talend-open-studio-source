...
public class TPostgresqlOutputBeginJava {
  ...
  protected final String TEXT_44 = NL + NL + "String dbschema_";
  protected final String TEXT_45 = " = null;";
  protected final String TEXT_46 = NL + "\tdbschema_";
  protected final String TEXT_47 = " = (String)globalMap.get(\"schema_\" + \"";
  protected final String TEXT_48 = "\");" + NL + "\t";
  protected final String TEXT_49 = NL + "\tdbschema_";
  protected final String TEXT_50 = " = ";
  protected final String TEXT_51 = ";" + NL + "\t";
  protected final String TEXT_52 = NL + NL + "String tableName_";
  protected final String TEXT_53 = " = null;" + NL + "if(dbschema_";
  protected final String TEXT_54 = " == null || dbschema_";
  protected final String TEXT_55 = ".trim().length() == 0) {" + NL + "\ttableName_";
  protected final String TEXT_56 = " = ";
  protected final String TEXT_57 = ";" + NL + "} else {" + NL + "\ttableName_";
  protected final String TEXT_58 = " = dbschema_";
  protected final String TEXT_59 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_60 = ";" + NL + "}" + NL;
  protected final String TEXT_61 = NL + "        int updateKeyCount_";
  protected final String TEXT_62 = " = ";
  protected final String TEXT_63 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_64 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_65 = NL + "        int deleteKeyCount_";
  protected final String TEXT_66 = " = ";
  protected final String TEXT_67 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_68 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_69 = NL + "int nb_line_";
  protected final String TEXT_70 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_71 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_72 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_73 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_74 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_75 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_76 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_77 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_78 = "=0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_79 = " = false;" + NL + "" + NL + "java.sql.Connection conn_";
  protected final String TEXT_80 = " = null;" + NL + "String dbUser_";
  ...
  protected final String TEXT_93 = NL + "\t\tjava.sql.Savepoint  sp_";
  protected final String TEXT_94 = " = null;" + NL + "\t";
  protected final String TEXT_95 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_96 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  protected final String TEXT_97 = ") {" + NL + "\t\t\tconn_";
  protected final String TEXT_98 = " = dataSources_";
  protected final String TEXT_99 = ".get(";
  protected final String TEXT_100 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_101 = NL + "\t";
  protected final String TEXT_102 = NL + "    java.lang.Class.forName(\"org.postgresql.Driver\");" + NL + "    String url_";
  protected final String TEXT_103 = " = \"jdbc:postgresql://\"+";
  protected final String TEXT_104 = "+\":\"+";
  protected final String TEXT_105 = "+\"/\"+";
  protected final String TEXT_106 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_129 = NL + "    \tjava.sql.Savepoint  sp_";
  protected final String TEXT_130 = " = null;" + NL + "\t";
  protected final String TEXT_131 = NL + "        conn_";
  protected final String TEXT_132 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_133 = " = ";
  protected final String TEXT_134 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_135 = " = 0;";
  protected final String TEXT_136 = NL;
  protected final String TEXT_137 = NL + "    if(conn_";
  protected final String TEXT_138 = ".getAutoCommit()){" + NL + "    \tthrow new RuntimeException(\"Connection autocommit must be off to use savePoint\");" + NL + "    }";
  protected final String TEXT_139 = NL;
  protected final String TEXT_140 = NL + "   int batchSize_";
  protected final String TEXT_141 = " = ";
  protected final String TEXT_142 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_143 = "=0;";
  protected final String TEXT_144 = NL;
  protected final String TEXT_145 = NL + "int count_";
  protected final String TEXT_146 = "=0;";
  protected final String TEXT_147 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_148 = " = conn_";
  protected final String TEXT_149 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_150 = NL + "            stmtDrop_";
  protected final String TEXT_151 = ".execute(\"";
  protected final String TEXT_152 = "\" ";
  protected final String TEXT_153 = ");" + NL + "\t\t\t";
  protected final String TEXT_154 = NL + "            stmtDrop_";
  protected final String TEXT_155 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_161 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_180 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_195 = NL + "\t\t    \t\tString keyCheckTable_";
  protected final String TEXT_196 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_197 = "+\"][\"+";
  protected final String TEXT_198 = "+\"][\"+";
  protected final String TEXT_199 = "+\"][\"+";
  protected final String TEXT_200 = "+\"][\"+";
  protected final String TEXT_201 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_202 = " + \"]\";" + NL + "\t\t    \t";
  protected final String TEXT_203 = NL + "        \t\t    // [%connection%][checktable][tableName]" + NL + "        \t\t    String keyCheckTable_";
  protected final String TEXT_204 = " = conn_";
  protected final String TEXT_205 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_206 = " + \"]\";" + NL + "    \t\t    ";
  protected final String TEXT_207 = NL + "\t\t    " + NL + "\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_208 = ")== null){//}" + NL + "\t\t\t" + NL + "\t\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_209 = ")) {//}" + NL + "\t\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_210 = ")== null){//}" + NL + "\t\t\t";
  protected final String TEXT_211 = "              " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_212 = NL + "    \t\t\t\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_213 = " = conn_";
  protected final String TEXT_214 = ".createStatement();" + NL + "                \t\t\t\tboolean whetherExist_";
  protected final String TEXT_215 = " = false;" + NL + "                \t\t\t\ttry {" + NL + "                \t\t\t\t\tisExistStmt_";
  protected final String TEXT_216 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_217 = " + \"]\" );" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_218 = " = true;" + NL + "                \t\t\t\t} catch (java.lang.Exception e){" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_219 = " = false;" + NL + "                \t\t\t\t}" + NL + "                \t\t\t\tisExistStmt_";
  protected final String TEXT_220 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_221 = "   \t" + NL + "                \t\t\t\t";
  protected final String TEXT_222 = NL + "                \t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_223 = " = conn_";
  protected final String TEXT_224 = ".getMetaData();" + NL + "                \t            if(tableNameForSearch_";
  protected final String TEXT_225 = ".indexOf(\"\\\"\")==-1){" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_226 = " = tableNameForSearch_";
  protected final String TEXT_227 = ".toUpperCase();" + NL + "                            \t}else{" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_228 = " = tableNameForSearch_";
  protected final String TEXT_229 = ".replaceAll(\"\\\"\",\"\");" + NL + "                            \t}" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_230 = " = dbMetaData_";
  protected final String TEXT_231 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_232 = ", tableNameForSearch_";
  protected final String TEXT_233 = ", new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_234 = " = false;" + NL + "                \t            if(rsTable_";
  protected final String TEXT_235 = ".next()) {" + NL + "                \t            \twhetherExist_";
  protected final String TEXT_236 = " = true;" + NL + "                \t            }" + NL + "    \t            \t\t\trsTable_";
  protected final String TEXT_237 = ".close();" + NL + "    \t            " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_246 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_247 = " = rsTable_";
  protected final String TEXT_248 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_249 = ".equals";
  protected final String TEXT_250 = "IgnoreCase";
  protected final String TEXT_251 = "(";
  protected final String TEXT_252 = ") " + NL + "                \t                \t&& (schema_";
  protected final String TEXT_253 = ".equals";
  protected final String TEXT_254 = "IgnoreCase";
  protected final String TEXT_255 = "(dbschema_";
  protected final String TEXT_256 = ") || dbschema_";
  protected final String TEXT_257 = ".trim().length() ==0)) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_258 = " = true;" + NL + "                \t                    break;" + NL + "        \t            \t    \t}" + NL + "                        \t\t}" + NL + "            \t            \trsTable_";
  protected final String TEXT_259 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_260 = NL + "                \t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_261 = " = conn_";
  protected final String TEXT_262 = ".getMetaData();" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_263 = " = dbMetaData_";
  protected final String TEXT_264 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_265 = " = false;" + NL + "                \t            while(rsTable_";
  protected final String TEXT_266 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_267 = " = rsTable_";
  protected final String TEXT_268 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_269 = " = rsTable_";
  protected final String TEXT_270 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_271 = ".equals";
  protected final String TEXT_272 = "IgnoreCase";
  protected final String TEXT_273 = "((";
  protected final String TEXT_274 = ")";
  protected final String TEXT_275 = ".toUpperCase()";
  ...
  protected final String TEXT_281 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_282 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_286 = "  \t            " + NL + "                \t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_287 = " = conn_";
  protected final String TEXT_288 = ".getMetaData();" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_289 = " = dbMetaData_";
  protected final String TEXT_290 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_291 = " = false;" + NL + "                \t            String defaultSchema_";
  protected final String TEXT_292 = " = \"public\";" + NL + "                \t            if(dbschema_";
  protected final String TEXT_293 = " == null || dbschema_";
  protected final String TEXT_294 = ".trim().length() == 0) {" + NL + "                \t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_295 = " = conn_";
  protected final String TEXT_296 = ".createStatement();" + NL + "                \t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_297 = " = stmtSchema_";
  protected final String TEXT_298 = ".executeQuery(\"select current_schema() \");" + NL + "                \t            \twhile(rsSchema_";
  protected final String TEXT_299 = ".next()){" + NL + "                \t            \t\tdefaultSchema_";
  protected final String TEXT_300 = " = rsSchema_";
  protected final String TEXT_301 = ".getString(\"current_schema\");" + NL + "                \t            \t}" + NL + "                \t            \trsSchema_";
  protected final String TEXT_302 = ".close();" + NL + "                \t            \tstmtSchema_";
  protected final String TEXT_303 = ".close();" + NL + "                \t            }" + NL + "                \t            while(rsTable_";
  protected final String TEXT_304 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_305 = " = rsTable_";
  protected final String TEXT_306 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_307 = " = rsTable_";
  protected final String TEXT_308 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  ...
  protected final String TEXT_317 = " ==null || dbschema_";
  protected final String TEXT_318 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_319 = ".equals";
  protected final String TEXT_320 = "IgnoreCase";
  protected final String TEXT_321 = "(schema_";
  protected final String TEXT_322 = ")))) {" + NL + "                \t                    whetherExist_";
  ...
  protected final String TEXT_333 = ".getString(\"TABLE_NAME\");" + NL + "                \t                if(table_";
  protected final String TEXT_334 = ".equalsIgnoreCase(";
  protected final String TEXT_335 = ")) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_336 = " = true;" + NL + "                \t                    break;" + NL + "                \t                }" + NL + "                \t            }" + NL + "                \t            rsTable_";
  protected final String TEXT_337 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_338 = NL + "                    \t\t\tif(!whetherExist_";
  protected final String TEXT_339 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_345 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_346 = ".";
  protected final String TEXT_347 = ", \"";
  protected final String TEXT_348 = "\")";
  protected final String TEXT_349 = ".toUpperCase()";
  ...
  protected final String TEXT_356 = NL + "                    \t\t\t\tstmtCreate_";
  protected final String TEXT_357 = ".close();            " + NL + "                    \t\t\t}                " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_358 = NL + "                                if(whetherExist_";
  protected final String TEXT_359 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_360 = " = conn_";
  protected final String TEXT_361 = ".createStatement();" + NL + "                \t    \t    \t";
  protected final String TEXT_362 = NL + "                                    stmtDrop_";
  protected final String TEXT_363 = ".execute(\"";
  protected final String TEXT_364 = "\" ";
  protected final String TEXT_365 = ");" + NL + "                \t    \t    \t";
  protected final String TEXT_366 = NL + "                                    stmtDrop_";
  protected final String TEXT_367 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  protected final String TEXT_368 = " = conn_";
  protected final String TEXT_369 = ".createStatement();" + NL + "            \t    \t    \t";
  ...
  protected final String TEXT_384 = NL + "                        \t\tstmtCreate_";
  protected final String TEXT_385 = ".close();" + NL + "        \t\t\t\t\t";
  protected final String TEXT_386 = NL + "\t\t\t";
  protected final String TEXT_387 = NL + "    \t\t\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_388 = ", true);" + NL + "    \t\t//{{{" + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_389 = "            ";
  protected final String TEXT_390 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_391 = " = conn_";
  protected final String TEXT_392 = ".createStatement();" + NL + "    \t   \t";
  ...
  protected final String TEXT_400 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_401 = " = stmtTruncCount_";
  protected final String TEXT_402 = ".executeQuery(\"";
  protected final String TEXT_403 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_404 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_405 = ".next()) {" + NL + "\t\t\t\trsTruncCountNumber_";
  protected final String TEXT_406 = " = rsTruncCount_";
  protected final String TEXT_407 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_408 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_409 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_410 = " = conn_";
  protected final String TEXT_411 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_412 = NL + "\t\t\t";
  protected final String TEXT_413 = NL + "\t\t\t\tconn_";
  protected final String TEXT_414 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_415 = NL + "            stmtTrunc_";
  protected final String TEXT_416 = ".executeUpdate(\"";
  protected final String TEXT_417 = "\");";
  protected final String TEXT_418 = NL + "                if(!conn_";
  protected final String TEXT_419 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_420 = ".commit();" + NL + "                }";
  protected final String TEXT_421 = NL + "   \t    \t";
  protected final String TEXT_422 = NL + "   \t    \tdeletedCount_";
  protected final String TEXT_423 = " += rsTruncCountNumber_";
  protected final String TEXT_424 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_425 = ".close();            " + NL + "\t\t";
  protected final String TEXT_426 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_427 = " = conn_";
  protected final String TEXT_428 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_429 = " = stmtTruncCount_";
  protected final String TEXT_430 = ".executeQuery(\"";
  protected final String TEXT_431 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_432 = " = conn_";
  protected final String TEXT_433 = ".createStatement();" + NL + "  \t    \t";
  protected final String TEXT_434 = NL + "\t\t\t";
  protected final String TEXT_435 = NL + "\t\t\t\tconn_";
  protected final String TEXT_436 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_437 = NL + "            stmtTrunc_";
  protected final String TEXT_438 = ".executeUpdate(\"";
  ...
  protected final String TEXT_450 = ") VALUES (";
  protected final String TEXT_451 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_452 = " = conn_";
  protected final String TEXT_453 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_459 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_460 = " = conn_";
  protected final String TEXT_461 = ".prepareStatement(update_";
  ...
  protected final String TEXT_471 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_472 = " = conn_";
  protected final String TEXT_473 = ".prepareStatement(insert_";
  protected final String TEXT_474 = ");" + NL + "\t    String update_";
  protected final String TEXT_475 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_476 = " + \"\\\" SET ";
  protected final String TEXT_477 = " WHERE ";
  protected final String TEXT_478 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_486 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_487 = " = conn_";
  protected final String TEXT_488 = ".prepareStatement(update_";
  protected final String TEXT_489 = ");" + NL + "\t    String insert_";
  protected final String TEXT_490 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_491 = " + \"\\\" (";
  protected final String TEXT_492 = ") VALUES (";
  protected final String TEXT_493 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_504 = NL + "        StringBuffer query_";
  protected final String TEXT_505 = " = null;" + NL + "       \t";
  protected final String TEXT_506 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_528 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_529 = " = insertIgnore_";
  protected final String TEXT_530 = ".split(\"\\\\?\");";
  protected final String TEXT_531 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_532 = " = insert_";
  protected final String TEXT_533 = ".split(\"\\\\?\");";
  protected final String TEXT_534 = NL + "    \tString geometryColumnName_";
  protected final String TEXT_535 = " = null;" + NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_536 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_537 = " = 0;" + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_538 = " = true;" + NL + "    \t";
  protected final String TEXT_539 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_540 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_541 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_542 = " =null;" + NL + "\t";
  protected final String TEXT_543 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_549 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_550 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_551 = " = null;";
  protected final String TEXT_552 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_553 = " = null;";
  protected final String TEXT_554 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_555 = " = null;";
  protected final String TEXT_556 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_557 = " = null;";
  protected final String TEXT_558 = NL + "\t\t \tString[] insertSQLSplits_";
