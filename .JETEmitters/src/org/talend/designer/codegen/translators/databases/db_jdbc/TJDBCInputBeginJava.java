...
public class TJDBCInputBeginJava
{
  ...
  protected final String TEXT_188 = ".createStatement(java.sql.ResultSet.TYPE_FORWARD_ONLY," + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tjava.sql.ResultSet.CONCUR_READ_ONLY);" + NL + "\t\t\t\t((com.mysql.jdbc.Statement)stmt_";
  protected final String TEXT_189 = ").enableStreamingResults();";
  protected final String TEXT_190 = NL + "                stmt_";
  protected final String TEXT_191 = ".setFetchSize(";
  protected final String TEXT_192 = ");";
  protected final String TEXT_193 = NL + "\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_194 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\tif (null != dataSources_";
  protected final String TEXT_195 = ") {" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_196 = " = dataSources_";
  protected final String TEXT_197 = ".get(";
  protected final String TEXT_198 = ").getConnection();" + NL + "\t\t\t\t} else {";
  ...
  protected final String TEXT_213 = NL + NL + "\t\t\t\t\tString dbPwd_";
  protected final String TEXT_214 = " = decryptedPassword_";
  protected final String TEXT_215 = ";" + NL + "" + NL + "\t\t\t\t\t";
  protected final String TEXT_216 = NL + "\t\t\t\t}";
  protected final String TEXT_217 = NL + "            java.util.Date date_";
  protected final String TEXT_218 = " = null;" + NL + "            try{" + NL + "            \tdate_";
  protected final String TEXT_219 = " = rs_";
  protected final String TEXT_220 = ".getTimestamp(";
  protected final String TEXT_221 = "column_index_";
  protected final String TEXT_222 = ");" + NL + "            }catch(java.lang.Exception e){" + NL + "            \tdate_";
  protected final String TEXT_223 = " = rs_";
  protected final String TEXT_224 = ".getDate(";
  protected final String TEXT_225 = "column_index_";
  protected final String TEXT_226 = ");" + NL + "            }";
  protected final String TEXT_227 = NL + "            ";
  protected final String TEXT_228 = ".";
  protected final String TEXT_229 = " = date_";
  protected final String TEXT_230 = ";";
  protected final String TEXT_231 = NL + "    " + NL + "\t";
  protected final String TEXT_232 = NL + "\t\t    int nb_line_";
  protected final String TEXT_233 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_234 = " = null;";
  protected final String TEXT_235 = NL + "\t\t        conn_";
  protected final String TEXT_236 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_237 = "\");";
  protected final String TEXT_238 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_239 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_240 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_241 = " = dataSources_";
  protected final String TEXT_242 = ".get(";
  protected final String TEXT_243 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_244 = "\", conn_";
  protected final String TEXT_245 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_246 = NL + "\t\t\t\t";
  protected final String TEXT_247 = NL + "\t\t\t\t";
  protected final String TEXT_248 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_249 = " =  conn_";
  protected final String TEXT_250 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_251 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_252 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_253 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_254 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_255 = NL + "                 conn_";
  protected final String TEXT_256 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_257 = NL + "               ";
  protected final String TEXT_258 = " + \"=\" + ";
  protected final String TEXT_259 = " + \";\" +";
  protected final String TEXT_260 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_261 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_262 = ");";
  protected final String TEXT_263 = NL + "\t\t    ";
  protected final String TEXT_264 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_265 = " = ";
  protected final String TEXT_266 = ";" + NL + "\t\t\t";
  protected final String TEXT_267 = NL + "                log.info(\"";
  protected final String TEXT_268 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_269 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_270 = NL;
  protected final String TEXT_271 = NL + "                       globalMap.put(\"";
  protected final String TEXT_272 = "_QUERY\",dbquery_";
  protected final String TEXT_273 = ");";
  protected final String TEXT_274 = NL + "                       globalMap.put(\"";
  protected final String TEXT_275 = "_QUERY\",dbquery_";
  protected final String TEXT_276 = ");";
  protected final String TEXT_277 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_278 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_279 = " = stmt_";
  protected final String TEXT_280 = ".executeQuery(dbquery_";
  protected final String TEXT_281 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_282 = " = rs_";
  protected final String TEXT_283 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_284 = " = rsmd_";
  protected final String TEXT_285 = ".getColumnCount();" + NL;
  protected final String TEXT_286 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_287 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_288 = ".setDbmsId(\"";
  protected final String TEXT_289 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_290 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_291 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_292 = ".add(\"";
  protected final String TEXT_293 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_294 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_295 = " = ";
  protected final String TEXT_296 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_297 = "; i <= rsmd_";
  protected final String TEXT_298 = ".getColumnCount()-";
  protected final String TEXT_299 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_300 = ".contains(rsmd_";
  protected final String TEXT_301 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_302 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_303 = ".setName(rsmd_";
  protected final String TEXT_304 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_305 = ".setDbName(rsmd_";
  protected final String TEXT_306 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_307 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_308 = "\", rsmd_";
  protected final String TEXT_309 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_310 = ".getPrecision(i), rsmd_";
  protected final String TEXT_311 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_312 = ".setDbType(rsmd_";
  protected final String TEXT_313 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_314 = ".setDbTypeId(rsmd_";
  protected final String TEXT_315 = ".getColumnType(i));";
  protected final String TEXT_316 = NL + "                \tdcm_";
  protected final String TEXT_317 = ".setFormat(";
  protected final String TEXT_318 = ");";
  protected final String TEXT_319 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_320 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_321 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_322 = ".setLength(rsmd_";
  protected final String TEXT_323 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_324 = ".setLength(rsmd_";
  protected final String TEXT_325 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_326 = NL + "\t\t\tdcm_";
  protected final String TEXT_327 = ".setLength(rsmd_";
  protected final String TEXT_328 = ".getPrecision(i));";
  protected final String TEXT_329 = NL + "                \tdcm_";
  protected final String TEXT_330 = ".setPrecision(rsmd_";
  protected final String TEXT_331 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_332 = ".setNullable(rsmd_";
  protected final String TEXT_333 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_334 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_335 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_336 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_337 = ".metadatas.add(dcm_";
  protected final String TEXT_338 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_339 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_340 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_341 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_342 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_343 = NL + "\t\t    ";
  protected final String TEXT_344 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_345 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_346 = NL + "\t\t    while (rs_";
  protected final String TEXT_347 = ".next()) {" + NL + "\t\t        nb_line_";
  ...
  protected final String TEXT_353 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_354 = " = ";
  protected final String TEXT_355 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_356 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_357 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_358 = " < ";
  protected final String TEXT_359 = "column_index_";
  ...
  protected final String TEXT_369 = " = (List)rs_";
  protected final String TEXT_370 = ".getObject(";
  protected final String TEXT_371 = "column_index_";
  protected final String TEXT_372 = ");";
  protected final String TEXT_373 = NL + "\t\t                         ";
  protected final String TEXT_374 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_375 = ".getObject(";
  protected final String TEXT_376 = "column_index_";
  protected final String TEXT_377 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_378 = NL + "                                    ";
  protected final String TEXT_379 = ".";
  protected final String TEXT_380 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_389 = ".setEPSG(";
  protected final String TEXT_390 = ");" + NL + "                                        }";
  protected final String TEXT_391 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_392 = NL + "                                  ";
  protected final String TEXT_393 = ".";
  protected final String TEXT_394 = "=dcg_";
  ...
  protected final String TEXT_413 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_414 = ".";
  protected final String TEXT_415 = ", rs_";
  protected final String TEXT_416 = ", fixedColumnCount_";
  protected final String TEXT_417 = ",list_";
  protected final String TEXT_418 = ",";
  protected final String TEXT_419 = ");";
  protected final String TEXT_420 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_421 = ".";
  protected final String TEXT_422 = ", rs_";
  protected final String TEXT_423 = ", fixedColumnCount_";
  ...
  protected final String TEXT_432 = NL + "                                  Object geom = rs_";
  protected final String TEXT_433 = ".getObject(";
  protected final String TEXT_434 = "column_index_";
  protected final String TEXT_435 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_436 = ".";
  protected final String TEXT_437 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_444 = " - Retrieving the record \" + nb_line_";
