...
public class TInformixBulkExecBeginJava {
  protected static String nl;
  public static synchronized TInformixBulkExecBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInformixBulkExecBeginJava result = new TInformixBulkExecBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_70 = NL + "\tString dbschema_";
  protected final String TEXT_71 = " = dbschema_";
  protected final String TEXT_72 = " = (String)globalMap.get(\"dbschema_";
  protected final String TEXT_73 = "\");" + NL + "\tString dbName_";
  protected final String TEXT_74 = " =  (String)globalMap.get(\"dbname_";
  protected final String TEXT_75 = "\");" + NL + "\tString dbServer_";
  protected final String TEXT_76 = " = (String)globalMap.get(\"dbserver_";
  ...
  protected final String TEXT_94 = " = \"com.informix.jdbc.IfxDriver\";" + NL + "\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_95 = ");" + NL + "\tString dbschema_";
  protected final String TEXT_96 = " = ";
  protected final String TEXT_97 = ";" + NL + "\tString dbName_";
  protected final String TEXT_98 = " = ";
  protected final String TEXT_99 = ";" + NL + "\tString dbServer_";
  ...
  protected final String TEXT_113 = ";" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_114 = " = null;";
  protected final String TEXT_115 = NL + "\t\tString tableName_";
  protected final String TEXT_116 = " = null;" + NL + "\t\tif(dbschema_";
  protected final String TEXT_117 = " == null || dbschema_";
  protected final String TEXT_118 = ".trim().length() == 0) {" + NL + "    \t\ttableName_";
  protected final String TEXT_119 = " = ";
  protected final String TEXT_120 = ";" + NL + "\t\t} else {" + NL + "\t\t    tableName_";
  ...
  protected final String TEXT_286 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_287 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_288 = " = conn_";
  protected final String TEXT_289 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_290 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_291 = " - Creating table ";
  protected final String TEXT_292 = "\" + tableName_";
  ...
  protected final String TEXT_299 = " - Create table ";
  protected final String TEXT_300 = "\" + tableName_";
  protected final String TEXT_301 = " + \"";
  protected final String TEXT_302 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_303 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_304 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_305 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_306 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_310 = " - Droping table ";
  protected final String TEXT_311 = "\" + tableName_";
  ...
  protected final String TEXT_318 = " - Drop table ";
  protected final String TEXT_319 = "\" + tableName_";
  protected final String TEXT_320 = " + \"";
  protected final String TEXT_321 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_322 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_323 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_324 = " = conn_";
  protected final String TEXT_325 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_326 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_327 = " - Creating table ";
  protected final String TEXT_328 = "\" + tableName_";
  ...
  protected final String TEXT_335 = " - Create table ";
  protected final String TEXT_336 = "\" + tableName_";
  protected final String TEXT_337 = " + \"";
  protected final String TEXT_338 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_339 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_340 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_341 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  protected final String TEXT_342 = " = conn_";
  protected final String TEXT_343 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_344 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_345 = " - Clearing table ";
  protected final String TEXT_346 = "\" + tableName_";
  ...
  protected final String TEXT_353 = "- Clear table ";
  protected final String TEXT_354 = "\" + tableName_";
  protected final String TEXT_355 = " + \"";
  protected final String TEXT_356 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_357 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_358 = ".close();" + NL + "\t\t";
  protected final String TEXT_359 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_360 = " = conn_";
  protected final String TEXT_361 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_362 = " = stmtTruncCount_";
  protected final String TEXT_363 = ".executeQuery(\"";
  protected final String TEXT_364 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_368 = " - Trancating table ";
  protected final String TEXT_369 = "\" + tableName_";
  ...
  protected final String TEXT_376 = " - Truncate table ";
  protected final String TEXT_377 = "\" + tableName_";
  protected final String TEXT_378 = " + \"";
  protected final String TEXT_379 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_380 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_381 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_382 = " += rsTruncCount_";
  protected final String TEXT_383 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_384 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_385 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_386 = ".close();" + NL + "\t\t";
  protected final String TEXT_387 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_388 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_389 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_390 = NL + NL + "\t\tString fileName_";
  protected final String TEXT_391 = " = ";
  protected final String TEXT_392 = ";" + NL + "\t\tString cmdFile_";
  protected final String TEXT_393 = " = fileName_";
  protected final String TEXT_394 = " + \".cmd\";" + NL + "\t\tString logFile_";
  protected final String TEXT_395 = " = fileName_";
  protected final String TEXT_396 = " + \".log\";" + NL + "\t\tCharacter field_separator_";
  protected final String TEXT_397 = " = (";
  protected final String TEXT_398 = ").charAt(0);" + NL + " \t\tjava.io.BufferedWriter bw_";
  protected final String TEXT_399 = " = new java.io.BufferedWriter(new java.io.FileWriter(cmdFile_";
  protected final String TEXT_400 = "));" + NL + "    \tjava.io.PrintWriter pw_";
  protected final String TEXT_401 = " = new java.io.PrintWriter(bw_";
  protected final String TEXT_402 = " ,false) ;" + NL + "    \t//file \"c:\\informix_bulk.txt\" delimiter \"|\" 7 ;insert into feature9999;" + NL + "    \tpw_";
  protected final String TEXT_403 = ".print(\"FILE \\\"\" + ";
  protected final String TEXT_404 = " + \"\\\"\" );" + NL + "    \tpw_";
  protected final String TEXT_405 = ".print(\" DELIMITER \\\"\" + field_separator_";
  protected final String TEXT_406 = " + \"\\\"\");" + NL + "    \tpw_";
  protected final String TEXT_407 = ".println(\" \" + ";
  protected final String TEXT_408 = " +\" ;\" );";
  protected final String TEXT_409 = NL + "\t\tpw_";
  protected final String TEXT_410 = ".println(\"INSERT INTO \" + tableName_";
  protected final String TEXT_411 = " + \"(";
  protected final String TEXT_412 = ");\" );";
  protected final String TEXT_413 = NL + "\tbw_";
  protected final String TEXT_414 = ".close();" + NL + "\tpw_";
  protected final String TEXT_415 = ".close();" + NL + "\t//-----------------------dbload command" + NL + "\tStringBuilder command_";
  protected final String TEXT_416 = " =  new StringBuilder();" + NL + "\t//-------------------------1. add dbload cmd";
  protected final String TEXT_417 = NL + "\tcommand_";
  protected final String TEXT_418 = ".append(\"dbload \");";
  protected final String TEXT_419 = NL + "\tcommand_";
  protected final String TEXT_420 = ".append(\"./dbload \");";
  protected final String TEXT_421 = NL + "\t//-------------------------2.add database name" + NL + "\tcommand_";
  protected final String TEXT_422 = ".append(\"-d \" + dbName_";
  protected final String TEXT_423 = " + \" \");" + NL + "\t//-------------------------3.add command file" + NL + "\tcommand_";
  protected final String TEXT_424 = ".append(\"-c \" + cmdFile_";
  protected final String TEXT_425 = " + \" \");" + NL + "\t//-------------------------4.add  error log file" + NL + "\tcommand_";
  protected final String TEXT_426 = ".append(\"-l \" + logFile_";
  protected final String TEXT_427 = " + \" \");" + NL + "\t//-------------------------5.add  bad rows before abort" + NL + "\tcommand_";
  protected final String TEXT_428 = ".append(\"-e \" + ";
  protected final String TEXT_429 = " + \" \");" + NL + "\t//-------------------------6.add commit interval" + NL + "\tcommand_";
  protected final String TEXT_430 = ".append(\"-n \" + ";
  protected final String TEXT_431 = " + \";\"); " + NL + "\t" + NL + "\t//----------------get envionment variables";
  protected final String TEXT_432 = NL + "\tProcess ev_";
  protected final String TEXT_433 = " = Runtime.getRuntime().exec(\"cmd /c set\");" + NL + "\tjava.io.BufferedReader evReader_";
  protected final String TEXT_434 = " = new java.io.BufferedReader(new java.io.InputStreamReader(ev_";
  protected final String TEXT_435 = ".getInputStream()));";
  protected final String TEXT_436 = NL + NL + "\tProcess ev_";
  protected final String TEXT_437 = " = Runtime.getRuntime().exec(\"env\");" + NL + "\tjava.io.BufferedReader evReader_";
  protected final String TEXT_438 = " = new java.io.BufferedReader(new java.io.InputStreamReader(ev_";
  protected final String TEXT_439 = ".getInputStream()));";
  protected final String TEXT_440 = NL + "\tjava.util.List<String> evPara_";
  protected final String TEXT_441 = " = new java.util.ArrayList();" + NL + "\tString line_";
  protected final String TEXT_442 = " = null;" + NL + "\twhile((line_";
  protected final String TEXT_443 = " = evReader_";
  protected final String TEXT_444 = ".readLine()) != null) {" + NL + "\t   evPara_";
  protected final String TEXT_445 = ".add(line_";
  protected final String TEXT_446 = ");" + NL + "\t}" + NL + "\tevReader_";
  protected final String TEXT_447 = ".close();" + NL + "" + NL + "\tevPara_";
  protected final String TEXT_448 = ".add(\"INFORMIXDIR=\" + ";
  protected final String TEXT_449 = ");" + NL + "\tevPara_";
  protected final String TEXT_450 = ".add(\"INFORMIXSERVER=\" + dbServer_";
  protected final String TEXT_451 = ");" + NL + "\tevPara_";
  protected final String TEXT_452 = ".add(\"DBDATE=\" + \"";
  protected final String TEXT_453 = "\");" + NL + "\t";
  protected final String TEXT_454 = NL + "\tevPara_";
  protected final String TEXT_455 = ".add(\"DBMONEY=\" + ";
  protected final String TEXT_456 = ");";
  protected final String TEXT_457 = NL + "\t//----------------get envionment variables end" + NL + "\t" + NL + "\t//------------------get dbload directory" + NL + "\tjava.io.File dbLoadDirectory_";
  protected final String TEXT_458 = " = new java.io.File (";
  protected final String TEXT_459 = "+\"/bin\");" + NL + "\tboolean dbloadExist_";
  protected final String TEXT_460 = " = dbLoadDirectory_";
  protected final String TEXT_461 = ".exists();" + NL + "\tif(!dbloadExist_";
  protected final String TEXT_462 = "){" + NL + "\t\tthrow new RuntimeException(dbLoadDirectory_";
  protected final String TEXT_463 = "+\"' is not exist!\");" + NL + "\t}" + NL + "\t";
  protected final String TEXT_464 = NL + "\t\tlog.info(\"";
  protected final String TEXT_465 = " - Executing '\"+command_";
  protected final String TEXT_466 = ".toString()+\"'.\");" + NL + "\t";
  protected final String TEXT_467 = NL + " \tRuntime runtime_";
  protected final String TEXT_468 = " = Runtime.getRuntime();";
  protected final String TEXT_469 = NL + "\tfinal Process ps_";
  protected final String TEXT_470 = " = runtime_";
  protected final String TEXT_471 = ".exec(new String[]{\"cmd.exe\",\"/c\",command_";
  protected final String TEXT_472 = ".toString()}," + NL + "\t\t\t\t\t\t\t\tevPara_";
  protected final String TEXT_473 = ".toArray(new String[]{}),dbLoadDirectory_";
  protected final String TEXT_474 = ");";
  protected final String TEXT_475 = NL + "\tfinal Process ps_";
  protected final String TEXT_476 = " = runtime_";
  protected final String TEXT_477 = ".exec(command_";
  protected final String TEXT_478 = ".toString()," + NL + "\t\t\t\t\t\t\t\tevPara_";
  protected final String TEXT_479 = ".toArray(new String[]{}),dbLoadDirectory_";
  protected final String TEXT_480 = ");";
  protected final String TEXT_481 = NL;
  protected final String TEXT_482 = NL + NL + "Thread normal_";
  protected final String TEXT_483 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_484 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_485 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_486 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_487 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_488 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_489 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_490 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "normal_";
  protected final String TEXT_491 = ".start();" + NL + "" + NL + "Thread error_";
  ...
  protected final String TEXT_493 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_494 = NL + "\t\t\t\t        System.err.println(line);" + NL + "\t\t\t\t        ";
  ...
  protected final String TEXT_499 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_500 = ".start();" + NL + "" + NL + "ps_";
  protected final String TEXT_501 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_502 = ".interrupt();" + NL + "error_";
  protected final String TEXT_503 = ".interrupt();";
  protected final String TEXT_504 = NL + "        log.info(\"";
  protected final String TEXT_505 = " - Execute '\"+command_";
  protected final String TEXT_506 = ".toString()+\"' has finished。\");";
  protected final String TEXT_507 = NL + NL + NL + NL;
...
//end issue 0010346 Parallelization crash with "Drop table if exists and create"
    ...
    stringBuffer.append(badRows);
    stringBuffer.append(TEXT_429);
    stringBuffer.append(cid );
    stringBuffer.append(TEXT_430);
    stringBuffer.append(befroeCommit);
    ...
    stringBuffer.append(informixDir);
