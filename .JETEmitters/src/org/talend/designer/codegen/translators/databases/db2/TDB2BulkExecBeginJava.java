...
public class TDB2BulkExecBeginJava {
  ...
  protected final String TEXT_78 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_79 = " + \":\" + ";
  protected final String TEXT_80 = " + \"/\" + ";
  protected final String TEXT_81 = ";";
  protected final String TEXT_82 = NL + "\t\t\tString url_";
  protected final String TEXT_83 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_84 = " + \":\" + ";
  protected final String TEXT_85 = " + \"/\" + ";
  protected final String TEXT_86 = " + \":\" + ";
  protected final String TEXT_87 = ";";
  protected final String TEXT_88 = NL + "\t\tString driverClass_";
  protected final String TEXT_89 = " = \"com.ibm.db2.jcc.DB2Driver\";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_100 = NL + "\t\tString dbPwd_";
  protected final String TEXT_101 = " = decryptedPassword_";
  protected final String TEXT_102 = ";" + NL + "\t\tString schema_";
  protected final String TEXT_103 = " = ";
  protected final String TEXT_104 = ";" + NL + "\t\tjava.sql.Connection conn_";
  protected final String TEXT_105 = " = null;" + NL + "\t\t";
  protected final String TEXT_106 = NL + "\t\tString tableName_";
  protected final String TEXT_107 = " = null;" + NL + "\t\tif(schema_";
  protected final String TEXT_108 = " == null || schema_";
  protected final String TEXT_109 = ".trim().length() == 0) {" + NL + "\t\t\ttableName_";
  protected final String TEXT_110 = " = ";
  protected final String TEXT_111 = ";" + NL + "\t\t} else {" + NL + "\t\t\ttableName_";
  protected final String TEXT_112 = " = schema_";
  protected final String TEXT_113 = " +  \"\\\".\\\"\" + ";
  protected final String TEXT_114 = ";" + NL + "\t\t}" + NL + "" + NL + "\t\tString fileName_";
  protected final String TEXT_115 = " = ";
  protected final String TEXT_116 = ";" + NL;
  protected final String TEXT_117 = NL + "\t\tString sqlLoadPending_";
  protected final String TEXT_118 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "\t\tjava.sql.CallableStatement callStmtLoadPending_";
  protected final String TEXT_119 = " = conn_";
  protected final String TEXT_120 = ".prepareCall(sqlLoadPending_";
  protected final String TEXT_121 = ");" + NL + "\t\tcallStmtLoadPending_";
  protected final String TEXT_122 = ".setString(1, \"load from  /dev/null  of del terminate into \\\"\" + tableName_";
  protected final String TEXT_123 = " + \"\\\"\");" + NL + "\t\ttry {" + NL + "\t\t\tcallStmtLoadPending_";
  protected final String TEXT_124 = ".execute();" + NL + "\t\t} catch (java.sql.SQLException e) {" + NL + "\t\t\t//when table not in load pending mode will throw exception." + NL + "\t\t\t//and do nothing." + NL + "\t\t\t";
  protected final String TEXT_125 = NL + "\t\t}" + NL + "\t\tcallStmtLoadPending_";
  protected final String TEXT_126 = ".close();";
  protected final String TEXT_127 = NL;
  protected final String TEXT_128 = NL + "\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_132 = " - Droping table ";
  ...
  protected final String TEXT_140 = " - Drop table ";
  ...
  protected final String TEXT_149 = " - Creating table ";
  ...
  protected final String TEXT_157 = " - Create table ";
  ...
  protected final String TEXT_162 = ".close();" + NL + "\t\t";
  protected final String TEXT_163 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_167 = " - Creating table ";
  ...
  protected final String TEXT_175 = " - Create table ";
  protected final String TEXT_176 = "\" + tableName_";
  protected final String TEXT_177 = " + \"";
  protected final String TEXT_178 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_179 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_180 = ".close();" + NL + "\t\t";
  protected final String TEXT_181 = "   " + NL + "\t\t\t\t";
  protected final String TEXT_182 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_183 = " = conn_";
  protected final String TEXT_184 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_185 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_186 = " = tableNameForSearch_";
  protected final String TEXT_187 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_188 = " = tableNameForSearch_";
  protected final String TEXT_189 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_193 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_194 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_195 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_196 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_203 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_211 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_212 = ") || dbschema_";
  protected final String TEXT_213 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_214 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_215 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_216 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_217 = " = conn_";
  protected final String TEXT_218 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_219 = " = dbMetaData_";
  protected final String TEXT_220 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_221 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_222 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_223 = " = rsTable_";
  protected final String TEXT_224 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  protected final String TEXT_225 = " = rsTable_";
  protected final String TEXT_226 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_227 = ".equals(";
  protected final String TEXT_228 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_229 = ".equals(schema_";
  protected final String TEXT_230 = ") || (schema_";
  protected final String TEXT_231 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_232 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_236 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_237 = " = conn_";
  protected final String TEXT_238 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_239 = " = dbMetaData_";
  protected final String TEXT_240 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_241 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_242 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_243 = " == null || dbschema_";
  protected final String TEXT_244 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_245 = " = conn_";
  protected final String TEXT_246 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_247 = " = stmtSchema_";
  protected final String TEXT_248 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_249 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_250 = " = rsSchema_";
  protected final String TEXT_251 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_252 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_253 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_254 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_255 = " = rsTable_";
  protected final String TEXT_256 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_257 = " = rsTable_";
  protected final String TEXT_258 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  ...
  protected final String TEXT_267 = " ==null || dbschema_";
  protected final String TEXT_268 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_269 = ".equals";
  protected final String TEXT_270 = "IgnoreCase";
  protected final String TEXT_271 = "(schema_";
  protected final String TEXT_272 = ")))) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_273 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_274 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_275 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_276 = " = conn_";
  protected final String TEXT_277 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_278 = " = dbMetaData_";
  protected final String TEXT_279 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_280 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_281 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_282 = " = rsTable_";
  protected final String TEXT_283 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_284 = ".equals";
  protected final String TEXT_285 = "IgnoreCase";
  protected final String TEXT_286 = "(";
  protected final String TEXT_287 = ")) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_288 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_295 = " - Creating table ";
  ...
  protected final String TEXT_303 = " - Create table ";
  protected final String TEXT_304 = "\" + tableName_";
  protected final String TEXT_305 = " + \"";
  protected final String TEXT_306 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_307 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_308 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_309 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_310 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_314 = " - Droping table ";
  ...
  protected final String TEXT_322 = " - Drop table ";
  ...
  protected final String TEXT_327 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_331 = " - Creating table ";
  ...
  protected final String TEXT_339 = " - Create table ";
  ...
  protected final String TEXT_345 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_349 = " - Clearing table ";
  ...
  protected final String TEXT_357 = "- Clear table ";
  protected final String TEXT_358 = "\" + tableName_";
  protected final String TEXT_359 = " + \"";
  protected final String TEXT_360 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_365 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_366 = " = stmtTruncCount_";
  protected final String TEXT_367 = ".executeQuery(\"";
  protected final String TEXT_368 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_372 = " - Trancating table ";
  ...
  protected final String TEXT_380 = " - Truncate table ";
  protected final String TEXT_381 = "\" + tableName_";
  protected final String TEXT_382 = " + \"";
  protected final String TEXT_383 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_384 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_385 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_386 = " += rsTruncCount_";
  protected final String TEXT_387 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_388 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_389 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_390 = ".close();" + NL + "\t\t";
  protected final String TEXT_391 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_392 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_393 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_394 = NL;
  protected final String TEXT_395 = NL + "Character field_separator_";
  protected final String TEXT_396 = " = (";
  protected final String TEXT_397 = ").charAt(0);";
  protected final String TEXT_398 = NL + "\t\tString action_";
  protected final String TEXT_399 = " = \"";
  protected final String TEXT_400 = "\";" + NL + "\t\tjava.sql.CallableStatement callStmt_";
  protected final String TEXT_401 = " = null;" + NL + "\t\tString sql_";
  protected final String TEXT_402 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "\t\tString param_";
  protected final String TEXT_403 = " = \"LOAD FROM \\\"\"+ fileName_";
  protected final String TEXT_404 = " + \"\\\" OF DEL ";
  protected final String TEXT_405 = " MODIFIED BY COLDEL\"+ field_separator_";
  protected final String TEXT_406 = " +" + NL + "\t\t\t\t\t\t\" dateformat=\\\"\"+ ";
  protected final String TEXT_407 = "+ \"\\\" timeformat=\\\"\" + ";
  protected final String TEXT_408 = "+ \"\\\" timestampformat=\\\"\"+";
  protected final String TEXT_409 = " +\"\\\" ";
  protected final String TEXT_410 = " \" +" + NL + "\t\t\t\t\t\t action_";
  protected final String TEXT_411 = " +\" INTO \\\"\"  + tableName_";
  protected final String TEXT_412 = " + \"\\\" ";
  protected final String TEXT_413 = "\";" + NL + "\t\t";
  protected final String TEXT_414 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_415 = " - Bulk SQL:CALL SYSPROC.ADMIN_CMD(\"+param_";
  protected final String TEXT_416 = "+\").\");" + NL + "\t\t\t";
  protected final String TEXT_417 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_418 = " - Bulk inserting data into ";
  ...
  protected final String TEXT_423 = " - Bulk replacing data into ";
  protected final String TEXT_424 = "\" + tableName_";
  protected final String TEXT_425 = " + \"";
  protected final String TEXT_426 = ".\" );" + NL + "\t\t\t";
  protected final String TEXT_427 = NL + "\t\tcallStmt_";
  protected final String TEXT_428 = " = conn_";
  protected final String TEXT_429 = ".prepareCall(sql_";
  protected final String TEXT_430 = ");" + NL + "\t\tcallStmt_";
  protected final String TEXT_431 = ".setString(1, param_";
  protected final String TEXT_432 = ");" + NL + "\t\tcallStmt_";
  protected final String TEXT_433 = ".execute();" + NL + "\t\tcallStmt_";
  protected final String TEXT_434 = ".close();" + NL + "\t\t";
  protected final String TEXT_435 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_436 = " - Bulk insert data into ";
  protected final String TEXT_437 = "\" + tableName_";
  protected final String TEXT_438 = " + \"";
  protected final String TEXT_439 = " has finished.\");" + NL + "\t\t\t\t";
  protected final String TEXT_440 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_441 = " - Bulk replace data into ";
  protected final String TEXT_442 = "\" + tableName_";
  protected final String TEXT_443 = " + \"";
  protected final String TEXT_444 = " has finished.\");" + NL + "\t\t\t\t";
  protected final String TEXT_445 = NL + "\t\t\tint keyCount_";
  protected final String TEXT_446 = " = ";
  protected final String TEXT_447 = ";" + NL + "\t\t\tif(keyCount_";
  protected final String TEXT_448 = " == 0) {" + NL + "\t\t\t\tthrow new RuntimeException(\"For bulk update, Schema must have a key at least.\");" + NL + "\t\t\t}" + NL + "\t\t\tString tmpTableName_";
  protected final String TEXT_449 = " = tableName_";
  protected final String TEXT_450 = ";" + NL + "\t\t\ttableName_";
  protected final String TEXT_451 = " = \"tmp_";
  protected final String TEXT_452 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "\t\t\tjava.sql.Statement stmtCreateTmp_";
  protected final String TEXT_453 = " = conn_";
  protected final String TEXT_454 = ".createStatement();" + NL + "" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_455 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_456 = " - Creating temp table ";
  protected final String TEXT_457 = "\" + tableName_";
  protected final String TEXT_458 = " + \"";
  protected final String TEXT_459 = ".\" );" + NL + "\t\t\t";
  protected final String TEXT_460 = NL + "\t\t\tstmtCreateTmp_";
  protected final String TEXT_461 = ".execute(\"";
  protected final String TEXT_462 = ")\");" + NL + "\t\t\tstmtCreateTmp_";
  protected final String TEXT_463 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_464 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_465 = " - Create temp table ";
  protected final String TEXT_466 = "\" + tableName_";
  protected final String TEXT_467 = " + \"";
  protected final String TEXT_468 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_469 = NL + "\t\t\tjava.sql.CallableStatement callStmt_";
  protected final String TEXT_470 = " = null;" + NL + "\t\t\tString sql_";
  protected final String TEXT_471 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "\t\t\tString param_";
  protected final String TEXT_472 = " = \"LOAD FROM \\\"\"+ fileName_";
  protected final String TEXT_473 = ".replace(\"\\\\\",\"/\") + \"\\\" OF DEL ";
  protected final String TEXT_474 = " MODIFIED BY COLDEL\" + field_separator_";
  protected final String TEXT_475 = " +" + NL + "\t\t\t\t\t\t\t\t\t\" dateformat=\\\"\"+";
  protected final String TEXT_476 = "+\"\\\" timeformat=\\\"\" +";
  protected final String TEXT_477 = "+ \"\\\" timestampformat=\\\"\" + ";
  protected final String TEXT_478 = "+\"\\\"\" +" + NL + "\t\t\t\t\t\t\t\t\t\" ";
  protected final String TEXT_479 = " INSERT INTO \\\"\"  + tableName_";
  protected final String TEXT_480 = " + \"\\\" ";
  protected final String TEXT_481 = "\";" + NL + "\t\t\t";
  protected final String TEXT_482 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_483 = " - Bulk SQL:CALL SYSPROC.ADMIN_CMD(\"+param_";
  protected final String TEXT_484 = "+\").\");" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_485 = " - Bulk inserting data into ";
  protected final String TEXT_486 = "\" + tableName_";
  protected final String TEXT_487 = " + \"";
  protected final String TEXT_488 = ".\" );" + NL + "\t\t\t";
  protected final String TEXT_489 = NL + "\t\t\tcallStmt_";
  protected final String TEXT_490 = " = conn_";
  protected final String TEXT_491 = ".prepareCall(sql_";
  protected final String TEXT_492 = ");" + NL + "\t\t\tcallStmt_";
  protected final String TEXT_493 = ".setString(1, param_";
  protected final String TEXT_494 = ");" + NL + "\t\t\tcallStmt_";
  protected final String TEXT_495 = ".execute();" + NL + "\t\t\tcallStmt_";
  protected final String TEXT_496 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_497 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_498 = " - Bulk insert data into ";
  protected final String TEXT_499 = "\" + tableName_";
  protected final String TEXT_500 = " + \"";
  protected final String TEXT_501 = " has finished.\");" + NL + "\t\t\t";
  protected final String TEXT_502 = NL + "\t\t\ttableName_";
  protected final String TEXT_503 = " = tmpTableName_";
  protected final String TEXT_504 = ";" + NL + "\t\t\ttmpTableName_";
  protected final String TEXT_505 = " = \"tmp_";
  protected final String TEXT_506 = "\"+ \"_\" + pid + Thread.currentThread().getId();" + NL + "\t\t\tjava.sql.Statement stmtUpdateBulk_";
  ...
  protected final String TEXT_510 = " - Updating ";
  protected final String TEXT_511 = "\" + tableName_";
  protected final String TEXT_512 = " + \"";
  protected final String TEXT_513 = " from ";
  protected final String TEXT_514 = "\"+tmpTableName_";
  protected final String TEXT_515 = "+\"";
  protected final String TEXT_516 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_517 = NL + "\t\t\tstmtUpdateBulk_";
  protected final String TEXT_518 = ".executeUpdate(\"";
  protected final String TEXT_519 = "\");" + NL + "\t\t\t";
  protected final String TEXT_520 = NL + "\t\t\tstmtUpdateBulk_";
  protected final String TEXT_521 = ".close();" + NL + "\t\t\ttableName_";
  protected final String TEXT_522 = " = \"tmp_";
  protected final String TEXT_523 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "\t\t\tjava.sql.Statement stmtTmpDrop_";
  protected final String TEXT_524 = " = conn_";
  protected final String TEXT_525 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_526 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_527 = " - Droping temp table ";
  protected final String TEXT_528 = "\" + tableName_";
  protected final String TEXT_529 = " + \"";
  protected final String TEXT_530 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_531 = NL + "\t\t\tstmtTmpDrop_";
  protected final String TEXT_532 = ".execute(\"";
  protected final String TEXT_533 = "\");" + NL + "\t\t\t";
  protected final String TEXT_534 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_535 = " - Drop temp table ";
  protected final String TEXT_536 = "\" + tableName_";
  protected final String TEXT_537 = "+ \"";
  protected final String TEXT_538 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_539 = NL + "\t\t\tstmtTmpDrop_";
  protected final String TEXT_540 = ".close();" + NL + "\t\t\t";
