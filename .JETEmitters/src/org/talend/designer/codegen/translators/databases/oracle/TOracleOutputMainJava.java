...
public class TOracleOutputMainJava {
  ...
  protected final String TEXT_68 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_69 = " = conn_";
  protected final String TEXT_70 = ".createStatement();" + NL + "\t\t\t";
  ...
  protected final String TEXT_87 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_88 = " = conn_";
  protected final String TEXT_89 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_90 = NL + "\t\t\t";
  protected final String TEXT_91 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_92 = ".execute(((\"";
  protected final String TEXT_93 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_94 = ".";
  protected final String TEXT_95 = ", \"";
  protected final String TEXT_96 = "\")";
  protected final String TEXT_97 = ".toUpperCase()";
  ...
  protected final String TEXT_105 = ".close();" + NL + "\t\t";
  protected final String TEXT_106 = NL + "\t\t\t";
  protected final String TEXT_107 = "\t         " + NL + "\t\t    " + NL + "    \t\t    ";
  protected final String TEXT_108 = NL + "\t\t    \t\tString keyCheckTable_";
  protected final String TEXT_109 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_116 = NL + "        \t\t    // [%connection%][checktable][tableName]" + NL + "        \t\t    String keyCheckTable_";
  protected final String TEXT_117 = " = conn_";
  protected final String TEXT_118 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_119 = " + \"]\";" + NL + "    \t\t    ";
  protected final String TEXT_120 = NL + "\t\t    " + NL + "\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_121 = ")== null){//}" + NL + "\t\t\t" + NL + "\t\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_122 = ")) {//}" + NL + "\t\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_123 = ")== null){//}" + NL + "\t\t\t";
  protected final String TEXT_124 = "              " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_125 = NL + "    \t\t\t\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_126 = " = conn_";
  protected final String TEXT_127 = ".createStatement();" + NL + "                \t\t\t\tboolean whetherExist_";
  protected final String TEXT_128 = " = false;" + NL + "                \t\t\t\ttry {" + NL + "                \t\t\t\t\tisExistStmt_";
  protected final String TEXT_129 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_130 = " + \"]\" );" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_131 = " = true;" + NL + "                \t\t\t\t} catch (java.lang.Exception e){" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_132 = " = false;" + NL + "                \t\t\t\t}" + NL + "                \t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_137 = ".getMetaData();" + NL + "                \t            if(tableNameForSearch_";
  protected final String TEXT_138 = ".indexOf(\"\\\"\")==-1){" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_139 = " = tableNameForSearch_";
  protected final String TEXT_140 = ".toUpperCase();" + NL + "                            \t}else{" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_141 = " = tableNameForSearch_";
  protected final String TEXT_142 = ".replaceAll(\"\\\"\",\"\");" + NL + "                            \t}" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_143 = " = dbMetaData_";
  protected final String TEXT_144 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_145 = ", tableNameForSearch_";
  protected final String TEXT_146 = ", new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_147 = " = false;" + NL + "                \t            if(rsTable_";
  protected final String TEXT_148 = ".next()) {" + NL + "                \t            \twhetherExist_";
  protected final String TEXT_149 = " = true;" + NL + "                \t            }" + NL + "    \t            \t\t\trsTable_";
  protected final String TEXT_150 = ".close();" + NL + "    \t            " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_151 = "  \t            " + NL + "                \t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_152 = " = conn_";
  protected final String TEXT_153 = ".getMetaData();" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_154 = " = dbMetaData_";
  protected final String TEXT_155 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_156 = " = false;" + NL + "                \t            while(rsTable_";
  ...
  protected final String TEXT_170 = ".trim().length() ==0)) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_171 = " = true;" + NL + "                \t                    break;" + NL + "        \t            \t    \t}" + NL + "                        \t\t}" + NL + "            \t            \trsTable_";
  protected final String TEXT_172 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_173 = NL + "                \t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_174 = " = conn_";
  protected final String TEXT_175 = ".getMetaData();" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_176 = " = dbMetaData_";
  protected final String TEXT_177 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  ...
  protected final String TEXT_181 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_182 = " = rsTable_";
  protected final String TEXT_183 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_184 = ".equals";
  protected final String TEXT_185 = "IgnoreCase";
  protected final String TEXT_186 = "((";
  protected final String TEXT_187 = ")";
  protected final String TEXT_188 = ".toUpperCase()";
  protected final String TEXT_189 = ") " + NL + "                \t                \t&& (schema_";
  ...
  protected final String TEXT_193 = ") || (dbschema_";
  protected final String TEXT_194 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_195 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_196 = ")))) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_197 = " = true;" + NL + "                \t                    break;" + NL + "                \t                }" + NL + "                \t            }" + NL + "                \t            rsTable_";
  ...
  protected final String TEXT_204 = " = false;" + NL + "                \t            String defaultSchema_";
  protected final String TEXT_205 = " = \"public\";" + NL + "                \t            if(dbschema_";
  protected final String TEXT_206 = " == null || dbschema_";
  protected final String TEXT_207 = ".trim().length() == 0) {" + NL + "                \t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_208 = " = conn_";
  protected final String TEXT_209 = ".createStatement();" + NL + "                \t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_210 = " = stmtSchema_";
  protected final String TEXT_211 = ".executeQuery(\"select current_schema() \");" + NL + "                \t            \twhile(rsSchema_";
  protected final String TEXT_212 = ".next()){" + NL + "                \t            \t\tdefaultSchema_";
  protected final String TEXT_213 = " = rsSchema_";
  protected final String TEXT_214 = ".getString(\"current_schema\");" + NL + "                \t            \t}" + NL + "                \t            \trsSchema_";
  protected final String TEXT_215 = ".close();" + NL + "                \t            \tstmtSchema_";
  protected final String TEXT_216 = ".close();" + NL + "                \t            }" + NL + "                \t            while(rsTable_";
  protected final String TEXT_217 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_218 = " = rsTable_";
  protected final String TEXT_219 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_220 = " = rsTable_";
  protected final String TEXT_221 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_222 = ".equals";
  protected final String TEXT_223 = "IgnoreCase";
  protected final String TEXT_224 = "(";
  protected final String TEXT_225 = ") " + NL + "                \t                \t&& (schema_";
  ...
  protected final String TEXT_230 = " ==null || dbschema_";
  protected final String TEXT_231 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_232 = ".equals";
  protected final String TEXT_233 = "IgnoreCase";
  protected final String TEXT_234 = "(schema_";
  ...
  protected final String TEXT_238 = "      " + NL + "                \t            java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_242 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_243 = " = false;" + NL + "                \t            while(rsTable_";
  protected final String TEXT_244 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_245 = " = rsTable_";
  protected final String TEXT_246 = ".getString(\"TABLE_NAME\");" + NL + "                \t                if(table_";
  protected final String TEXT_247 = ".equalsIgnoreCase(";
  protected final String TEXT_248 = ")) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_249 = " = true;" + NL + "                \t                    break;" + NL + "                \t                }" + NL + "                \t            }" + NL + "                \t            rsTable_";
  protected final String TEXT_250 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_251 = NL + "                    \t\t\tif(!whetherExist_";
  protected final String TEXT_252 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_258 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_259 = ".";
  protected final String TEXT_260 = ", \"";
  protected final String TEXT_261 = "\")";
  protected final String TEXT_262 = ".toUpperCase()";
  ...
  protected final String TEXT_274 = ".createStatement();" + NL + "                \t    \t    \t";
  protected final String TEXT_275 = NL + "                                    stmtDrop_";
  protected final String TEXT_276 = ".execute(\"";
  protected final String TEXT_277 = "\" ";
  protected final String TEXT_278 = ");" + NL + "                \t    \t    \t";
  protected final String TEXT_279 = NL + "                                    stmtDrop_";
  protected final String TEXT_280 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_290 = ".toUpperCase()";
  protected final String TEXT_291 = ")+\")";
  protected final String TEXT_292 = "\"));" + NL + "        \t\t\t\t\t\t\t";
  protected final String TEXT_293 = NL + "        \t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_294 = ".execute(\"";
  protected final String TEXT_295 = ")\");" + NL + "        \t\t\t\t\t\t";
  protected final String TEXT_296 = NL + "        \t    \t    \t\t";
  protected final String TEXT_297 = NL + "                        \t\tstmtCreate_";
  protected final String TEXT_298 = ".close();" + NL + "        \t\t\t\t\t";
  protected final String TEXT_299 = NL + "\t\t\t";
  protected final String TEXT_300 = NL + "    \t\t\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_301 = ", true);" + NL + "    \t\t//{{{" + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_302 = "            ";
  protected final String TEXT_303 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_307 = ".executeUpdate(\"";
  ...
  protected final String TEXT_317 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_318 = ".next()) {" + NL + "\t\t\t\trsTruncCountNumber_";
  ...
  protected final String TEXT_322 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_323 = " = conn_";
  protected final String TEXT_324 = ".createStatement();" + NL + "\t\t\t";
  ...
  protected final String TEXT_329 = ".executeUpdate(\"";
  protected final String TEXT_330 = "\");";
  protected final String TEXT_331 = NL + "                if(!conn_";
  protected final String TEXT_332 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_333 = ".commit();" + NL + "                }";
  protected final String TEXT_334 = NL + "   \t    \t";
  protected final String TEXT_335 = NL + "   \t    \tdeletedCount_";
  protected final String TEXT_336 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_349 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_350 = NL + "            stmtTrunc_";
  protected final String TEXT_351 = ".executeUpdate(\"";
  protected final String TEXT_352 = "\");" + NL + "   \t    \t";
  protected final String TEXT_353 = NL + "            while(rsTruncCount_";
  protected final String TEXT_354 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_355 = " += rsTruncCount_";
  protected final String TEXT_356 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_357 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_358 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_382 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_383 = " = new StringBuffer(insert_";
  protected final String TEXT_384 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_385 = ".insert(insert_";
  protected final String TEXT_386 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_387 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_388 = " =insertStringBuffer_";
  protected final String TEXT_389 = ".toString(); ";
  protected final String TEXT_390 = "    " + NL;
  protected final String TEXT_391 = NL + "                        pstmt_";
  protected final String TEXT_392 = " = conn_";
  protected final String TEXT_393 = ".prepareStatement(insert_";
  protected final String TEXT_394 = ");";
  protected final String TEXT_395 = NL;
  protected final String TEXT_396 = NL + "                        pstmt_";
  protected final String TEXT_397 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_398 = " = conn_";
  protected final String TEXT_399 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_400 = " + \"]\";" + NL + "                        if(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_401 = ")== null){" + NL + "                            pstmt_";
  protected final String TEXT_402 = " = conn_";
  protected final String TEXT_403 = ".prepareStatement(insert_";
  protected final String TEXT_404 = ");" + NL + "                            GlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_405 = ", pstmt_";
  protected final String TEXT_406 = ");" + NL + "                        }else{" + NL + "                            pstmt_";
  protected final String TEXT_407 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_408 = ");" + NL + "                        }";
  protected final String TEXT_409 = NL;
  protected final String TEXT_410 = NL + "                            String update_";
  protected final String TEXT_411 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_412 = " + \" SET ";
  protected final String TEXT_413 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_422 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_423 = ".";
  protected final String TEXT_424 = ", \"";
  protected final String TEXT_425 = "\")";
  protected final String TEXT_426 = ".toUpperCase()";
  protected final String TEXT_427 = "+\" WHERE ";
  protected final String TEXT_428 = "\";";
  protected final String TEXT_429 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_430 = " = new StringBuffer(update_";
  protected final String TEXT_431 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_432 = ".insert(update_";
  protected final String TEXT_433 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_434 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_435 = " =updateStringBuffer_";
  protected final String TEXT_436 = ".toString(); ";
  protected final String TEXT_437 = NL + "                    pstmt_";
  protected final String TEXT_438 = " = conn_";
  protected final String TEXT_439 = ".prepareStatement(update_";
  ...
  protected final String TEXT_454 = "+\") VALUES (";
  protected final String TEXT_455 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_456 = ".";
  protected final String TEXT_457 = ")+\")\";";
  protected final String TEXT_458 = NL + "                            String insert_";
  protected final String TEXT_459 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_460 = " + \" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_461 = ".";
  protected final String TEXT_462 = ", \"";
  protected final String TEXT_463 = "\")";
  protected final String TEXT_464 = ".toUpperCase()";
  protected final String TEXT_465 = "+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_466 = ".";
  protected final String TEXT_467 = ")+\")\";";
  protected final String TEXT_468 = NL + "                            String update_";
  protected final String TEXT_469 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_470 = " + \" SET ";
  protected final String TEXT_471 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_472 = ".";
  protected final String TEXT_473 = ", \"";
  protected final String TEXT_474 = "\")";
  protected final String TEXT_475 = ".toUpperCase()";
  ...
  protected final String TEXT_484 = ".toUpperCase()";
  protected final String TEXT_485 = "+\" WHERE ";
  protected final String TEXT_486 = "\";";
  protected final String TEXT_487 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_488 = " = new StringBuffer(insert_";
  protected final String TEXT_489 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_490 = ".insert(insert_";
  protected final String TEXT_491 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_492 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_493 = " =insertStringBuffer_";
  protected final String TEXT_494 = ".toString(); ";
  protected final String TEXT_495 = "    " + NL + "                    pstmtInsert_";
  protected final String TEXT_496 = " = conn_";
  protected final String TEXT_497 = ".prepareStatement(insert_";
  protected final String TEXT_498 = ");";
  protected final String TEXT_499 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_500 = " = new StringBuffer(update_";
  protected final String TEXT_501 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_502 = ".insert(update_";
  protected final String TEXT_503 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_504 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_505 = " =updateStringBuffer_";
  ...
  protected final String TEXT_511 = NL + "                            String insert_";
  protected final String TEXT_512 = " = \"INSERT INTO \" + tableName_";
  ...
  protected final String TEXT_530 = "+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_531 = ".";
  protected final String TEXT_532 = ")+\")\";";
  protected final String TEXT_533 = NL + "                            String update_";
  protected final String TEXT_534 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_535 = " + \" SET ";
  protected final String TEXT_536 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_549 = ".toUpperCase()";
  ...
  protected final String TEXT_560 = NL + "                    pstmtUpdate_";
  protected final String TEXT_561 = " = conn_";
  protected final String TEXT_562 = ".prepareStatement(update_";
  protected final String TEXT_563 = ");";
  protected final String TEXT_564 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_565 = " = new StringBuffer(insert_";
  protected final String TEXT_566 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_567 = ".insert(insert_";
  protected final String TEXT_568 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_569 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_570 = " =insertStringBuffer_";
  protected final String TEXT_571 = ".toString(); ";
  protected final String TEXT_572 = "    " + NL + "                    pstmtInsert_";
  protected final String TEXT_573 = " = conn_";
  protected final String TEXT_574 = ".prepareStatement(insert_";
  protected final String TEXT_575 = ");";
  protected final String TEXT_576 = NL + "                    String delete_";
  protected final String TEXT_577 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_578 = " + \" WHERE ";
  protected final String TEXT_579 = "\";";
  protected final String TEXT_580 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_581 = " = new StringBuffer(delete_";
  protected final String TEXT_582 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_583 = ".insert(delete_";
  protected final String TEXT_584 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_585 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_586 = " =deleteStringBuffer_";
  protected final String TEXT_587 = ".toString();  ";
  protected final String TEXT_588 = NL + "                    pstmt_";
  protected final String TEXT_589 = " = conn_";
  protected final String TEXT_590 = ".prepareStatement(delete_";
  protected final String TEXT_591 = ");";
  protected final String TEXT_592 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_593 = " = insert_";
  protected final String TEXT_594 = ".split(\"\\\\?\");";
  protected final String TEXT_595 = NL + "\t\t\tupdate_";
  protected final String TEXT_596 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_597 = " = update_";
  protected final String TEXT_598 = ".split(\"\\\\?\");";
  protected final String TEXT_599 = NL + "\t\t\tupdate_";
  protected final String TEXT_600 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_601 = " = update_";
  protected final String TEXT_602 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_603 = " = insert_";
  protected final String TEXT_604 = ".split(\"\\\\?\");";
  protected final String TEXT_605 = NL + "\t\t\tdelete_";
  protected final String TEXT_606 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_607 = " = delete_";
  protected final String TEXT_608 = ".split(\"\\\\?\");";
  protected final String TEXT_609 = NL + "\t\t\treplace_";
  protected final String TEXT_610 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_611 = " = replace_";
  protected final String TEXT_612 = ".split(\"\\\\?\");";
  protected final String TEXT_613 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_614 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_615 = " = insertIgnore_";
  protected final String TEXT_616 = ".split(\"\\\\?\");";
  protected final String TEXT_617 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_618 = " = insert_";
  protected final String TEXT_619 = ".split(\"\\\\?\");";
  protected final String TEXT_620 = NL + "        }";
  protected final String TEXT_621 = NL + "        query_";
  protected final String TEXT_622 = " = new StringBuffer(\"\");";
  protected final String TEXT_623 = NL + "                commitEvery_";
  protected final String TEXT_624 = " = buffersSize_";
  protected final String TEXT_625 = ";";
  protected final String TEXT_626 = NL + "            batchSize_";
  protected final String TEXT_627 = " = buffersSize_";
  protected final String TEXT_628 = ";";
  protected final String TEXT_629 = NL + "        whetherReject_";
  protected final String TEXT_630 = " = false;";
  protected final String TEXT_631 = NL + "                            // TODO unable to parse integer: ";
  protected final String TEXT_632 = NL + "                            // TODO error: ";
  protected final String TEXT_633 = NL + "                        org.talend.sdi.geometry.Geometry tGeometry_";
  protected final String TEXT_634 = " = (org.talend.sdi.geometry.Geometry)";
  protected final String TEXT_635 = ".";
  protected final String TEXT_636 = ";" + NL + "                        com.vividsolutions.jts.geom.Geometry geometry_";
  protected final String TEXT_637 = " = tGeometry_";
  protected final String TEXT_638 = "._getInternalGeometry();" + NL + "" + NL + "                        com.vividsolutions.jts.geom.Envelope extends_";
  protected final String TEXT_639 = " = geometryColumnToExtends.get(\"";
  protected final String TEXT_640 = "\");" + NL + "                        if (extends_";
  protected final String TEXT_641 = " == null) {" + NL + "                            geometryColumnToExtends.put(\"";
  protected final String TEXT_642 = "\", geometry_";
  protected final String TEXT_643 = ".getEnvelopeInternal());" + NL + "                        }" + NL + "                        else {" + NL + "                            extends_";
  protected final String TEXT_644 = ".expandToInclude(geometry_";
  protected final String TEXT_645 = ".getEnvelopeInternal());" + NL + "                        }" + NL + "" + NL + "                        String wkt_";
  protected final String TEXT_646 = " = geometry_";
  protected final String TEXT_647 = ".toText();" + NL + "                        oracle.spatial.util.WKT oracle_wkt_";
  protected final String TEXT_648 = " = new oracle.spatial.util.WKT();" + NL + "                        oracle.spatial.geometry.JGeometry jgeometry_";
  protected final String TEXT_649 = " = oracle_wkt_";
  protected final String TEXT_650 = ".toJGeometry(wkt_";
  protected final String TEXT_651 = ".getBytes());" + NL;
  protected final String TEXT_652 = NL + "                            jgeometry_";
  protected final String TEXT_653 = ".setSRID(";
  protected final String TEXT_654 = ");";
  protected final String TEXT_655 = NL + "                        pstmt_";
  protected final String TEXT_656 = ".setObject(";
  protected final String TEXT_657 = ", oracle.spatial.geometry.JGeometry.store(jgeometry_";
  protected final String TEXT_658 = ", conn_";
  protected final String TEXT_659 = "));";
  protected final String TEXT_660 = NL + "                        ";
  protected final String TEXT_661 = NL + "                        query_";
  protected final String TEXT_662 = " = ";
  protected final String TEXT_663 = ";";
  protected final String TEXT_664 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_665 = ",";
  protected final String TEXT_666 = ".";
  protected final String TEXT_667 = ", ";
  protected final String TEXT_668 = ",insertSQLSplits_";
  protected final String TEXT_669 = ");";
  protected final String TEXT_670 = NL + "                    DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_671 = ".";
  protected final String TEXT_672 = ", pstmt_";
  protected final String TEXT_673 = ", ";
  protected final String TEXT_674 = ", \"";
  protected final String TEXT_675 = "\");";
  protected final String TEXT_676 = NL + "                globalMap.put(\"";
  protected final String TEXT_677 = "_QUERY\", query_";
  protected final String TEXT_678 = ".toString().trim());";
  protected final String TEXT_679 = NL + "                pstmt_";
  protected final String TEXT_680 = ".addBatch();" + NL + "                nb_line_";
  protected final String TEXT_681 = "++;";
  protected final String TEXT_682 = NL + "                batchSizeCounter_";
  protected final String TEXT_683 = "++;";
  protected final String TEXT_684 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_685 = "++;" + NL + "                    insertedCount_";
  protected final String TEXT_686 = " = insertedCount_";
  protected final String TEXT_687 = " + pstmt_";
  protected final String TEXT_688 = ".executeUpdate();";
  protected final String TEXT_689 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_690 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_691 = " = true;";
  protected final String TEXT_692 = NL + "                        throw(e_";
  ...
  protected final String TEXT_706 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_707 = ").getSQLState();";
  protected final String TEXT_708 = NL + "                            ";
  protected final String TEXT_709 = ".errorMessage = e_";
  protected final String TEXT_710 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_711 = ";";
  protected final String TEXT_712 = NL + "                            System.err.print(e_";
  protected final String TEXT_713 = ".getMessage());";
  protected final String TEXT_714 = NL + "                }";
  protected final String TEXT_715 = NL + "                    ";
  protected final String TEXT_716 = NL + "                        query_";
  protected final String TEXT_717 = " = ";
  protected final String TEXT_718 = ";";
  protected final String TEXT_719 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_720 = ",";
  protected final String TEXT_721 = ".";
  protected final String TEXT_722 = ", ";
  protected final String TEXT_723 = ",updateSQLSplits_";
  protected final String TEXT_724 = ");";
  protected final String TEXT_725 = NL + "                    int count_";
  ...
  protected final String TEXT_748 = NL + "                globalMap.put(\"";
  protected final String TEXT_749 = "_QUERY\", query_";
  protected final String TEXT_750 = ".toString().trim());";
  protected final String TEXT_751 = NL + "                pstmt_";
  protected final String TEXT_752 = ".addBatch();" + NL + "                nb_line_";
  protected final String TEXT_753 = "++;";
  protected final String TEXT_754 = NL + "                batchSizeCounter_";
  protected final String TEXT_755 = "++;";
  protected final String TEXT_756 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_757 = "++;" + NL + "                    updatedCount_";
  protected final String TEXT_758 = " = updatedCount_";
  protected final String TEXT_759 = " + pstmt_";
  protected final String TEXT_760 = ".executeUpdate();";
  protected final String TEXT_761 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_762 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_763 = " = true;";
  protected final String TEXT_764 = NL + "                        throw(e_";
  protected final String TEXT_765 = ");";
  protected final String TEXT_766 = NL + "                            ";
  protected final String TEXT_767 = " = new ";
  protected final String TEXT_768 = "Struct();";
  protected final String TEXT_769 = NL + "                                ";
  protected final String TEXT_770 = ".";
  protected final String TEXT_771 = " = ";
  protected final String TEXT_772 = ".";
  protected final String TEXT_773 = ";";
  protected final String TEXT_774 = NL + "                            rejectedCount_";
  protected final String TEXT_775 = " = rejectedCount_";
  protected final String TEXT_776 = " + 1;";
  protected final String TEXT_777 = NL + "                            ";
  protected final String TEXT_778 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_779 = ").getSQLState();";
  protected final String TEXT_780 = NL + "                            ";
  protected final String TEXT_781 = ".errorMessage = e_";
  protected final String TEXT_782 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_783 = ";";
  protected final String TEXT_784 = NL + "                            System.err.print(e_";
  protected final String TEXT_785 = ".getMessage());";
  ...
  protected final String TEXT_801 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_802 = ",";
  protected final String TEXT_803 = ".";
  protected final String TEXT_804 = ", ";
  protected final String TEXT_805 = ",updateSQLSplits_";
  protected final String TEXT_806 = ");";
  protected final String TEXT_807 = NL + "                        int count_";
  protected final String TEXT_808 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_809 = ".";
  protected final String TEXT_810 = ", pstmtUpdate_";
  ...
  protected final String TEXT_829 = NL + "                    globalMap.put(\"";
  protected final String TEXT_830 = "_QUERY\", query_";
  protected final String TEXT_831 = ".toString().trim());";
  protected final String TEXT_832 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_833 = " = updatedCount_";
  protected final String TEXT_834 = " + pstmtUpdate_";
  protected final String TEXT_835 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_836 = "++;";
  protected final String TEXT_837 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_838 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_839 = " = true;";
  protected final String TEXT_840 = NL + "                        throw(e_";
  protected final String TEXT_841 = ");";
  protected final String TEXT_842 = NL + "                        nb_line_";
  protected final String TEXT_843 = "++;";
  protected final String TEXT_844 = NL + "                            ";
  protected final String TEXT_845 = " = new ";
  protected final String TEXT_846 = "Struct();";
  protected final String TEXT_847 = NL + "                                ";
  protected final String TEXT_848 = ".";
  protected final String TEXT_849 = " = ";
  protected final String TEXT_850 = ".";
  protected final String TEXT_851 = ";";
  protected final String TEXT_852 = NL + "                            rejectedCount_";
  protected final String TEXT_853 = " = rejectedCount_";
  protected final String TEXT_854 = " + 1;";
  protected final String TEXT_855 = NL + "                            ";
  protected final String TEXT_856 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_857 = ").getSQLState();";
  protected final String TEXT_858 = NL + "                            ";
  protected final String TEXT_859 = ".errorMessage = e_";
  protected final String TEXT_860 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_861 = ";";
  protected final String TEXT_862 = NL + "                            System.err.print(e_";
  protected final String TEXT_863 = ".getMessage());";
  protected final String TEXT_864 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_873 = ",insertSQLSplits_";
  protected final String TEXT_874 = ");";
  protected final String TEXT_875 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_876 = ".";
  protected final String TEXT_877 = ", pstmtInsert_";
  protected final String TEXT_878 = ", ";
  protected final String TEXT_879 = ", \"";
  protected final String TEXT_880 = "\");";
  protected final String TEXT_881 = NL + "                    globalMap.put(\"";
  protected final String TEXT_882 = "_QUERY\", query_";
  protected final String TEXT_883 = ".toString().trim());";
  protected final String TEXT_884 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_885 = " = insertedCount_";
  protected final String TEXT_886 = " + pstmtInsert_";
  protected final String TEXT_887 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_888 = "++;";
  protected final String TEXT_889 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_890 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_891 = " = true;";
  protected final String TEXT_892 = NL + "                        throw(e_";
  protected final String TEXT_893 = ");";
  protected final String TEXT_894 = NL + "                        nb_line_";
  protected final String TEXT_895 = "++;";
  protected final String TEXT_896 = NL + "                            ";
  protected final String TEXT_897 = " = new ";
  protected final String TEXT_898 = "Struct();";
  protected final String TEXT_899 = NL + "                                ";
  protected final String TEXT_900 = ".";
  protected final String TEXT_901 = " = ";
  protected final String TEXT_902 = ".";
  protected final String TEXT_903 = ";";
  protected final String TEXT_904 = NL + "                            rejectedCount_";
  protected final String TEXT_905 = " = rejectedCount_";
  protected final String TEXT_906 = " + 1;";
  protected final String TEXT_907 = NL + "                            ";
  protected final String TEXT_908 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_909 = ").getSQLState();";
  protected final String TEXT_910 = NL + "                            ";
  protected final String TEXT_911 = ".errorMessage = e_";
  protected final String TEXT_912 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_913 = ";";
  protected final String TEXT_914 = NL + "                            System.err.print(e_";
  protected final String TEXT_915 = ".getMessage());";
  protected final String TEXT_916 = NL + "                }" + NL + "            }";
  protected final String TEXT_917 = NL + "            int updateFlag_";
  protected final String TEXT_918 = " = 0;";
  protected final String TEXT_919 = NL + "                    ";
  protected final String TEXT_920 = NL + "                        query_";
  protected final String TEXT_921 = " = ";
  protected final String TEXT_922 = ";";
  protected final String TEXT_923 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_924 = ",";
  protected final String TEXT_925 = ".";
  protected final String TEXT_926 = ", ";
  protected final String TEXT_927 = ",updateSQLSplits_";
  protected final String TEXT_928 = ");";
  protected final String TEXT_929 = NL + NL + "                    int count_";
  protected final String TEXT_930 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_931 = ".";
  protected final String TEXT_932 = ", pstmtUpdate_";
  ...
  protected final String TEXT_955 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_956 = " = pstmtUpdate_";
  protected final String TEXT_957 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_958 = " = updatedCount_";
  protected final String TEXT_959 = "+updateFlag_";
  protected final String TEXT_960 = ";" + NL + "                if(updateFlag_";
  protected final String TEXT_961 = " == 0) {";
  protected final String TEXT_962 = NL + "                        query_";
  protected final String TEXT_963 = " = new StringBuffer(\"\");";
  protected final String TEXT_964 = NL + "                            ";
  protected final String TEXT_965 = NL + "                                query_";
  protected final String TEXT_966 = " = ";
  protected final String TEXT_967 = ";";
  protected final String TEXT_968 = NL + "                                routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_969 = ",";
  protected final String TEXT_970 = ".";
  protected final String TEXT_971 = ", ";
  protected final String TEXT_972 = ",insertSQLSplits_";
  protected final String TEXT_973 = ");";
  protected final String TEXT_974 = NL + "                            DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_975 = ".";
  protected final String TEXT_976 = ", pstmtInsert_";
  ...
  protected final String TEXT_983 = NL + "                    insertedCount_";
  protected final String TEXT_984 = " = insertedCount_";
  protected final String TEXT_985 = " + pstmtInsert_";
  protected final String TEXT_986 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_987 = "++;";
  protected final String TEXT_988 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_989 = "++;";
  protected final String TEXT_990 = NL + "                }" + NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_991 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_992 = " = true;";
  protected final String TEXT_993 = NL + "                    throw(e_";
  ...
  protected final String TEXT_1009 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_1010 = ").getSQLState();";
  protected final String TEXT_1011 = NL + "                        ";
  protected final String TEXT_1012 = ".errorMessage = e_";
  protected final String TEXT_1013 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1014 = ";";
  protected final String TEXT_1015 = NL + "                        System.err.print(e_";
  protected final String TEXT_1016 = ".getMessage());";
  ...
  protected final String TEXT_1034 = NL + "                try {" + NL + "                    deletedCount_";
  protected final String TEXT_1035 = " = deletedCount_";
  protected final String TEXT_1036 = " + pstmt_";
  protected final String TEXT_1037 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1038 = "++;";
  protected final String TEXT_1039 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_1040 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_1041 = " = true;";
  protected final String TEXT_1042 = NL + "                        throw(e_";
  protected final String TEXT_1043 = ");";
  protected final String TEXT_1044 = NL + "                        nb_line_";
  protected final String TEXT_1045 = "++;";
  protected final String TEXT_1046 = NL + "                            ";
  protected final String TEXT_1047 = " = new ";
  protected final String TEXT_1048 = "Struct();";
  protected final String TEXT_1049 = NL + "                                ";
  protected final String TEXT_1050 = ".";
  protected final String TEXT_1051 = " = ";
  protected final String TEXT_1052 = ".";
  protected final String TEXT_1053 = ";";
  protected final String TEXT_1054 = NL + "                            rejectedCount_";
  protected final String TEXT_1055 = " = rejectedCount_";
  protected final String TEXT_1056 = " + 1;";
  protected final String TEXT_1057 = NL + "                            ";
  protected final String TEXT_1058 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_1059 = ").getSQLState();";
  protected final String TEXT_1060 = NL + "                            ";
  protected final String TEXT_1061 = ".errorMessage = e_";
  protected final String TEXT_1062 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1063 = ";";
  protected final String TEXT_1064 = NL + "                            System.err.print(e_";
  protected final String TEXT_1065 = ".getMessage());";
  protected final String TEXT_1066 = NL + "                }";
  protected final String TEXT_1067 = NL + "            if(!whetherReject_";
  protected final String TEXT_1068 = ") {";
  protected final String TEXT_1069 = NL + "                            ";
  protected final String TEXT_1070 = " = new ";
  protected final String TEXT_1071 = "Struct();";
  ...
  protected final String TEXT_1078 = NL + "            if (batchSize_";
  protected final String TEXT_1079 = " > 0 &&  batchSize_";
  protected final String TEXT_1080 = " <= batchSizeCounter_";
  protected final String TEXT_1081 = ") {" + NL + "                try {";
  protected final String TEXT_1082 = NL + "                    pstmt_";
  protected final String TEXT_1083 = ".executeBatch();";
  protected final String TEXT_1084 = NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1085 = "){";
  protected final String TEXT_1086 = NL + "                        throw(e_";
  protected final String TEXT_1087 = ");";
  protected final String TEXT_1088 = NL + "                        System.err.println(e_";
  protected final String TEXT_1089 = ".getMessage());";
  protected final String TEXT_1090 = NL + "                }" + NL + "                tmp_batchUpdateCount_";
  protected final String TEXT_1091 = " = pstmt_";
  protected final String TEXT_1092 = ".getUpdateCount();";
  protected final String TEXT_1093 = NL + "                    insertedCount_";
  protected final String TEXT_1094 = NL + "                    updatedCount_";
  protected final String TEXT_1095 = NL + "                    deletedCount_";
  protected final String TEXT_1096 = NL + "                += (tmp_batchUpdateCount_";
  protected final String TEXT_1097 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1098 = ":0);" + NL + "                batchSizeCounter_";
  protected final String TEXT_1099 = " = 0;" + NL + "            }";
  protected final String TEXT_1100 = NL + "                commitCounter_";
  protected final String TEXT_1101 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1102 = " <= commitCounter_";
  protected final String TEXT_1103 = ") {" + NL;
  protected final String TEXT_1104 = NL + "                        try {";
  protected final String TEXT_1105 = NL + "                            pstmt_";
  protected final String TEXT_1106 = ".executeBatch();";
  protected final String TEXT_1107 = NL + "                        }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1108 = "){";
  protected final String TEXT_1109 = NL + "                                throw(e_";
  protected final String TEXT_1110 = ");";
  protected final String TEXT_1111 = NL + "                                System.err.println(e_";
  protected final String TEXT_1112 = ".getMessage());";
  protected final String TEXT_1113 = NL + "                        }" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_1114 = " = pstmt_";
  protected final String TEXT_1115 = ".getUpdateCount();";
  protected final String TEXT_1116 = NL + "                            insertedCount_";
  protected final String TEXT_1117 = NL + "                            updatedCount_";
  protected final String TEXT_1118 = NL + "                            deletedCount_";
  protected final String TEXT_1119 = NL + "                        += (tmp_batchUpdateCount_";
  protected final String TEXT_1120 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1121 = ":0);";
  protected final String TEXT_1122 = NL + "                    conn_";
  protected final String TEXT_1123 = ".commit();";
  protected final String TEXT_1124 = NL + "                    commitCounter_";
  protected final String TEXT_1125 = "=0;" + NL + "                }";
