...
public class TPostgresPlusSCDELTEndJava {
  protected static String nl;
  public static synchronized TPostgresPlusSCDELTEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresPlusSCDELTEndJava result = new TPostgresPlusSCDELTEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_2 = NL + "        if(conn_";
  protected final String TEXT_3 = " != null && !conn_";
  protected final String TEXT_4 = ".isClosed()) {" + NL + "            conn_";
