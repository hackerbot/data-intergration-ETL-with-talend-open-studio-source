...
public class TMSSqlOutputBeginJava {
  ...
  protected final String TEXT_48 = " = 0;" + NL + "" + NL + "int deletedCount_";
  ...
  protected final String TEXT_52 = "=0;" + NL + "String dbschema_";
  protected final String TEXT_53 = " = null;" + NL + "String tableName_";
  protected final String TEXT_54 = " = null;" + NL + "boolean whetherReject_";
  protected final String TEXT_55 = " = false;" + NL + "" + NL + "java.util.Calendar calendar_";
  protected final String TEXT_56 = " = java.util.Calendar.getInstance();" + NL + "long year1_";
  protected final String TEXT_57 = " = TalendDate.parseDate(\"yyyy-MM-dd\",\"0001-01-01\").getTime();" + NL + "long year2_";
  protected final String TEXT_58 = " = TalendDate.parseDate(\"yyyy-MM-dd\",\"1753-01-01\").getTime();" + NL + "long year10000_";
  protected final String TEXT_59 = " = TalendDate.parseDate(\"yyyy-MM-dd HH:mm:ss\",\"9999-12-31 24:00:00\").getTime();" + NL + "long date_";
  protected final String TEXT_60 = ";" + NL + "" + NL + "java.util.Calendar calendar_datetimeoffset_";
  protected final String TEXT_61 = " = java.util.Calendar.getInstance(java.util.TimeZone.getTimeZone(\"UTC\"));" + NL;
  protected final String TEXT_62 = NL;
  protected final String TEXT_63 = NL + "        int updateKeyCount_";
  protected final String TEXT_64 = " = ";
  protected final String TEXT_65 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_66 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_67 = NL + "        int deleteKeyCount_";
  protected final String TEXT_68 = " = ";
  protected final String TEXT_69 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_70 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_71 = NL + "        int insertKeyCount_";
  protected final String TEXT_72 = " = ";
  protected final String TEXT_73 = ";" + NL + "        if(insertKeyCount_";
  protected final String TEXT_74 = " < 1) {" + NL + "            throw new RuntimeException(\"For insert if not exist, Schema must have a key\");" + NL + "        }";
  ...
  protected final String TEXT_80 = NL + "\tdbschema_";
  ...
  protected final String TEXT_85 = NL + "\t\tif (null == conn_";
  protected final String TEXT_86 = ") {" + NL + "\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_87 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\tconn_";
  protected final String TEXT_88 = " = dataSources_";
  protected final String TEXT_89 = ".get(";
  protected final String TEXT_90 = ").getConnection();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_91 = NL + "\t";
  protected final String TEXT_92 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_93 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  protected final String TEXT_94 = ") {" + NL + "\t\t\tconn_";
  protected final String TEXT_95 = " = dataSources_";
  protected final String TEXT_96 = ".get(";
  protected final String TEXT_97 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_98 = NL + "    dbschema_";
  protected final String TEXT_99 = " = ";
  protected final String TEXT_100 = ";" + NL + "    String driverClass_";
  protected final String TEXT_101 = " = \"net.sourceforge.jtds.jdbc.Driver\";" + NL + "\t";
  protected final String TEXT_102 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_103 = ");" + NL + "    String port_";
  protected final String TEXT_104 = " = ";
  protected final String TEXT_105 = ";" + NL + "    String dbname_";
  protected final String TEXT_106 = " = ";
  protected final String TEXT_107 = " ;" + NL + "    String url_";
  protected final String TEXT_108 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_109 = " ; " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_110 = ")) {" + NL + "    \turl_";
  protected final String TEXT_111 = " += \":\" + ";
  protected final String TEXT_112 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_113 = ")) {" + NL + "    \turl_";
  protected final String TEXT_114 = " += \"//\" + ";
  protected final String TEXT_115 = "; " + NL + "    }" + NL + "    url_";
  protected final String TEXT_116 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_117 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_137 = NL + "\t\tresourceMap.put(\"conn_";
  protected final String TEXT_138 = "\", conn_";
  protected final String TEXT_139 = ");" + NL + "\t";
  protected final String TEXT_140 = NL + "        conn_";
  protected final String TEXT_141 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_142 = " = ";
  protected final String TEXT_143 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_144 = " = 0;" + NL;
  protected final String TEXT_145 = NL + "   int batchSize_";
  protected final String TEXT_146 = " = ";
  protected final String TEXT_147 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_148 = "=0;";
  protected final String TEXT_149 = NL + NL + "if(dbschema_";
  protected final String TEXT_150 = " == null || dbschema_";
  protected final String TEXT_151 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_152 = " = ";
  protected final String TEXT_153 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_154 = " = dbschema_";
  protected final String TEXT_155 = " + \"].[\" + ";
  protected final String TEXT_156 = ";" + NL + "}";
  protected final String TEXT_157 = NL + "\tint count_";
  protected final String TEXT_158 = "=0;" + NL;
  protected final String TEXT_159 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_160 = " = conn_";
  protected final String TEXT_161 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_162 = NL + "            stmtDrop_";
  protected final String TEXT_163 = ".execute(\"";
  protected final String TEXT_164 = "\" ";
  protected final String TEXT_165 = ");" + NL + "\t\t\t";
  protected final String TEXT_166 = NL + "            stmtDrop_";
  protected final String TEXT_167 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_186 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_187 = " = conn_";
  protected final String TEXT_188 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_189 = NL + "\t\t\t";
  protected final String TEXT_190 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_191 = ".execute(((\"";
  protected final String TEXT_192 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_193 = ".";
  protected final String TEXT_194 = ", \"";
  protected final String TEXT_195 = "\")";
  protected final String TEXT_196 = ".toUpperCase()";
  protected final String TEXT_197 = ")+\")";
  protected final String TEXT_198 = "\"));" + NL + "\t\t\t\t";
  protected final String TEXT_199 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_200 = ".execute(\"";
  protected final String TEXT_201 = ")\");" + NL + "\t\t\t";
  protected final String TEXT_202 = NL + "\t\t\t";
  protected final String TEXT_203 = NL + "            stmtCreate_";
  protected final String TEXT_204 = ".close();" + NL + "\t\t";
  protected final String TEXT_205 = NL + "\t\t\t";
  protected final String TEXT_206 = "\t         " + NL + "\t\t    " + NL + "    \t\t    ";
  protected final String TEXT_207 = NL + "\t\t    \t\tString keyCheckTable_";
  protected final String TEXT_208 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_209 = "+\"][\"+";
  protected final String TEXT_210 = "+\"][\"+";
  protected final String TEXT_211 = "+\"][\"+";
  protected final String TEXT_212 = "+\"][\"+";
  protected final String TEXT_213 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_214 = " + \"]\";" + NL + "\t\t    \t";
  protected final String TEXT_215 = NL + "        \t\t    // [%connection%][checktable][tableName]" + NL + "        \t\t    String keyCheckTable_";
  protected final String TEXT_216 = " = conn_";
  protected final String TEXT_217 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_218 = " + \"]\";" + NL + "    \t\t    ";
  protected final String TEXT_219 = NL + "\t\t    " + NL + "\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_220 = ")== null){//}" + NL + "\t\t\t" + NL + "\t\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_221 = ")) {//}" + NL + "\t\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_222 = ")== null){//}" + NL + "\t\t\t";
  protected final String TEXT_223 = "              " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_224 = NL + "    \t\t\t\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_225 = " = conn_";
  protected final String TEXT_226 = ".createStatement();" + NL + "                \t\t\t\tboolean whetherExist_";
  protected final String TEXT_227 = " = false;" + NL + "                \t\t\t\ttry {" + NL + "                \t\t\t\t\tisExistStmt_";
  protected final String TEXT_228 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_229 = " + \"]\" );" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_230 = " = true;" + NL + "                \t\t\t\t} catch (java.lang.Exception e){" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_231 = " = false;" + NL + "                \t\t\t\t}" + NL + "                \t\t\t\tisExistStmt_";
  protected final String TEXT_232 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_233 = "   \t" + NL + "                \t\t\t\t";
  protected final String TEXT_234 = NL + "                \t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_235 = " = conn_";
  protected final String TEXT_236 = ".getMetaData();" + NL + "                \t            if(tableNameForSearch_";
  protected final String TEXT_237 = ".indexOf(\"\\\"\")==-1){" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_238 = " = tableNameForSearch_";
  protected final String TEXT_239 = ".toUpperCase();" + NL + "                            \t}else{" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_240 = " = tableNameForSearch_";
  protected final String TEXT_241 = ".replaceAll(\"\\\"\",\"\");" + NL + "                            \t}" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_242 = " = dbMetaData_";
  protected final String TEXT_243 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_244 = ", tableNameForSearch_";
  ...
  protected final String TEXT_249 = ".close();" + NL + "    \t            " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_264 = ") " + NL + "                \t                \t&& (schema_";
  protected final String TEXT_265 = ".equals";
  protected final String TEXT_266 = "IgnoreCase";
  protected final String TEXT_267 = "(dbschema_";
  protected final String TEXT_268 = ") || dbschema_";
  protected final String TEXT_269 = ".trim().length() ==0)) {" + NL + "                \t                    whetherExist_";
  ...
  protected final String TEXT_277 = " = false;" + NL + "                \t            while(rsTable_";
  protected final String TEXT_278 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_279 = " = rsTable_";
  protected final String TEXT_280 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_281 = " = rsTable_";
  protected final String TEXT_282 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  ...
  protected final String TEXT_293 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_294 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_295 = ")))) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_296 = " = true;" + NL + "                \t                    break;" + NL + "                \t                }" + NL + "                \t            }" + NL + "                \t            rsTable_";
  ...
  protected final String TEXT_300 = ".getMetaData();" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_301 = " = dbMetaData_";
  protected final String TEXT_302 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_303 = " = false;" + NL + "                \t            String defaultSchema_";
  protected final String TEXT_304 = " = \"public\";" + NL + "                \t            if(dbschema_";
  protected final String TEXT_305 = " == null || dbschema_";
  protected final String TEXT_306 = ".trim().length() == 0) {" + NL + "                \t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_307 = " = conn_";
  protected final String TEXT_308 = ".createStatement();" + NL + "                \t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_309 = " = stmtSchema_";
  protected final String TEXT_310 = ".executeQuery(\"select current_schema() \");" + NL + "                \t            \twhile(rsSchema_";
  protected final String TEXT_311 = ".next()){" + NL + "                \t            \t\tdefaultSchema_";
  protected final String TEXT_312 = " = rsSchema_";
  protected final String TEXT_313 = ".getString(\"current_schema\");" + NL + "                \t            \t}" + NL + "                \t            \trsSchema_";
  protected final String TEXT_314 = ".close();" + NL + "                \t            \tstmtSchema_";
  protected final String TEXT_315 = ".close();" + NL + "                \t            }" + NL + "                \t            while(rsTable_";
  protected final String TEXT_316 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_317 = " = rsTable_";
  protected final String TEXT_318 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_319 = " = rsTable_";
  protected final String TEXT_320 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_321 = ".equals";
  protected final String TEXT_322 = "IgnoreCase";
  protected final String TEXT_323 = "(";
  protected final String TEXT_324 = ") " + NL + "                \t                \t&& (schema_";
  protected final String TEXT_325 = ".equals";
  protected final String TEXT_326 = "IgnoreCase";
  protected final String TEXT_327 = "(dbschema_";
  protected final String TEXT_328 = ") || ((dbschema_";
  protected final String TEXT_329 = " ==null || dbschema_";
  protected final String TEXT_330 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_331 = ".equals";
  protected final String TEXT_332 = "IgnoreCase";
  protected final String TEXT_333 = "(schema_";
  protected final String TEXT_334 = ")))) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_335 = " = true;" + NL + "                \t                    break;" + NL + "                \t                }" + NL + "                \t            }" + NL + "                \t            rsTable_";
  protected final String TEXT_336 = ".close();" + NL + "        \t\t\t\t\t";
  protected final String TEXT_337 = "      " + NL + "                \t            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_338 = " = conn_";
  protected final String TEXT_339 = ".getMetaData();" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_340 = " = dbMetaData_";
  protected final String TEXT_341 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_342 = " = false;" + NL + "                \t            while(rsTable_";
  protected final String TEXT_343 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_344 = " = rsTable_";
  protected final String TEXT_345 = ".getString(\"TABLE_NAME\");" + NL + "                \t                if(table_";
  protected final String TEXT_346 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_350 = NL + "                    \t\t\tif(!whetherExist_";
  protected final String TEXT_351 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  protected final String TEXT_352 = " = conn_";
  protected final String TEXT_353 = ".createStatement();" + NL + "                        \t\t\t";
  protected final String TEXT_354 = NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_355 = NL + "    \t\t\t\t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_356 = ".execute(((\"";
  protected final String TEXT_357 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_358 = ".";
  protected final String TEXT_359 = ", \"";
  protected final String TEXT_360 = "\")";
  protected final String TEXT_361 = ".toUpperCase()";
  protected final String TEXT_362 = ")+\")";
  protected final String TEXT_363 = "\"));" + NL + "    \t\t\t\t\t\t\t\t\t";
  protected final String TEXT_364 = NL + "    \t\t\t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_365 = ".execute(\"";
  protected final String TEXT_366 = ")\");" + NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_367 = NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_368 = NL + "                    \t\t\t\tstmtCreate_";
  protected final String TEXT_369 = ".close();            " + NL + "                    \t\t\t}                " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_370 = NL + "                                if(whetherExist_";
  protected final String TEXT_371 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_372 = " = conn_";
  protected final String TEXT_373 = ".createStatement();" + NL + "                \t    \t    \t";
  protected final String TEXT_374 = NL + "                                    stmtDrop_";
  protected final String TEXT_375 = ".execute(\"";
  protected final String TEXT_376 = "\" ";
  protected final String TEXT_377 = ");" + NL + "                \t    \t    \t";
  protected final String TEXT_378 = NL + "                                    stmtDrop_";
  protected final String TEXT_379 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  protected final String TEXT_380 = " = conn_";
  protected final String TEXT_381 = ".createStatement();" + NL + "            \t    \t    \t";
  protected final String TEXT_382 = NL + "        \t\t\t\t\t\t";
  protected final String TEXT_383 = NL + "        \t\t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_384 = ".execute(((\"";
  protected final String TEXT_385 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_386 = ".";
  protected final String TEXT_387 = ", \"";
  protected final String TEXT_388 = "\")";
  protected final String TEXT_389 = ".toUpperCase()";
  protected final String TEXT_390 = ")+\")";
  protected final String TEXT_391 = "\"));" + NL + "        \t\t\t\t\t\t\t";
  protected final String TEXT_392 = NL + "        \t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_393 = ".execute(\"";
  protected final String TEXT_394 = ")\");" + NL + "        \t\t\t\t\t\t";
  protected final String TEXT_395 = NL + "        \t    \t    \t\t";
  protected final String TEXT_396 = NL + "                        \t\tstmtCreate_";
  protected final String TEXT_397 = ".close();" + NL + "        \t\t\t\t\t";
  protected final String TEXT_398 = NL + "\t\t\t";
  protected final String TEXT_399 = NL + "    \t\t\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_400 = ", true);" + NL + "    \t\t//{{{" + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_401 = "            ";
  protected final String TEXT_402 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_403 = " = conn_";
  protected final String TEXT_404 = ".createStatement();" + NL + "    \t   \t";
  protected final String TEXT_405 = NL + "            stmtClear_";
  protected final String TEXT_406 = ".executeUpdate(\"";
  protected final String TEXT_407 = "\");" + NL + "   \t    \t";
  protected final String TEXT_408 = NL + "            stmtClear_";
  protected final String TEXT_409 = ".close();" + NL + "\t\t";
  protected final String TEXT_410 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_411 = " = conn_";
  protected final String TEXT_412 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_413 = " = stmtTruncCount_";
  protected final String TEXT_414 = ".executeQuery(\"";
  protected final String TEXT_415 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_416 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_417 = ".next()) {" + NL + "\t\t\t\trsTruncCountNumber_";
  protected final String TEXT_418 = " = rsTruncCount_";
  protected final String TEXT_419 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_420 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_421 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_434 = NL + "   \t    \tdeletedCount_";
  protected final String TEXT_435 = " += rsTruncCountNumber_";
  protected final String TEXT_436 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_437 = ".close();            " + NL + "\t\t";
  protected final String TEXT_438 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_439 = " = conn_";
  protected final String TEXT_440 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_441 = " = stmtTruncCount_";
  protected final String TEXT_442 = ".executeQuery(\"";
  protected final String TEXT_443 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_444 = " = conn_";
  protected final String TEXT_445 = ".createStatement();" + NL + "  \t    \t";
  ...
  protected final String TEXT_452 = NL + "            while(rsTruncCount_";
  protected final String TEXT_453 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_454 = " += rsTruncCount_";
  protected final String TEXT_455 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_456 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_457 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_458 = ".close();" + NL + "\t\t";
  protected final String TEXT_459 = NL + "        String insert_";
  protected final String TEXT_460 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_461 = " + \"] (";
  protected final String TEXT_462 = ") VALUES (";
  protected final String TEXT_463 = ")\";";
  protected final String TEXT_464 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_465 = " = conn_";
  protected final String TEXT_466 = ".prepareStatement(insert_";
  protected final String TEXT_467 = ");";
  protected final String TEXT_468 = NL;
  protected final String TEXT_469 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_470 = " = null;" + NL + "\t\tString keyPsmt_";
  protected final String TEXT_471 = " = conn_";
  protected final String TEXT_472 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_473 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_474 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_475 = ",insert_";
  protected final String TEXT_476 = ",keyPsmt_";
  ...
  protected final String TEXT_482 = "\";" + NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_483 = " = conn_";
  protected final String TEXT_484 = ".prepareStatement(update_";
  protected final String TEXT_485 = ");";
  protected final String TEXT_486 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_487 = " = conn_";
  protected final String TEXT_488 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  ...
  protected final String TEXT_494 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_495 = " = conn_";
  protected final String TEXT_496 = ".prepareStatement(insert_";
  protected final String TEXT_497 = ");" + NL + "        String update_";
  protected final String TEXT_498 = " = \"UPDATE [\" + tableName_";
  protected final String TEXT_499 = " + \"] SET ";
  protected final String TEXT_500 = " WHERE ";
  protected final String TEXT_501 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_502 = " = conn_";
  protected final String TEXT_503 = ".prepareStatement(update_";
  ...
  protected final String TEXT_509 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_510 = " = conn_";
  protected final String TEXT_511 = ".prepareStatement(update_";
  ...
  protected final String TEXT_516 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_517 = " = conn_";
  protected final String TEXT_518 = ".prepareStatement(insert_";
  protected final String TEXT_519 = ");";
  protected final String TEXT_520 = NL + "        String delete_";
  protected final String TEXT_521 = " = \"DELETE FROM [\" + tableName_";
  protected final String TEXT_522 = " + \"] WHERE ";
  protected final String TEXT_523 = "\";" + NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_524 = " = conn_";
  protected final String TEXT_525 = ".prepareStatement(delete_";
  protected final String TEXT_526 = ");";
  protected final String TEXT_527 = NL + "        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_534 = ") VALUES (";
  protected final String TEXT_535 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_536 = " = conn_";
  protected final String TEXT_537 = ".prepareStatement(insert_";
  protected final String TEXT_538 = ");";
  protected final String TEXT_539 = NL + NL + "    class BufferLine_";
  protected final String TEXT_540 = " {";
  protected final String TEXT_541 = NL + "                ";
  protected final String TEXT_542 = " ";
  protected final String TEXT_543 = ";";
  protected final String TEXT_544 = NL + NL + "        public BufferLine_";
  ...
  protected final String TEXT_553 = NL + "        }" + NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_554 = "> sInsertColValueList";
  protected final String TEXT_555 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_556 = " sInsertColValue";
  protected final String TEXT_557 = " = null;" + NL + "" + NL + "    StringBuilder extendInsertValueStmt_";
  protected final String TEXT_558 = " = new StringBuilder();" + NL + "    for(int i=0;i < ";
  protected final String TEXT_559 = ";i++){" + NL + "         extendInsertValueStmt_";
  protected final String TEXT_560 = ".append(\"(";
  protected final String TEXT_561 = ")\");" + NL + "         if (i!=";
  protected final String TEXT_562 = "-1) extendInsertValueStmt_";
  protected final String TEXT_563 = ".append(\",\");" + NL + "    }" + NL + "" + NL + "\tString insert_";
  protected final String TEXT_564 = " = \"INSERT INTO \"+";
  protected final String TEXT_565 = "+\" (";
  protected final String TEXT_566 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_567 = ".toString();" + NL + "" + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_568 = " =  conn_";
  protected final String TEXT_569 = ".prepareStatement(insert_";
  protected final String TEXT_570 = ");" + NL + "" + NL + "    String insertColName";
  protected final String TEXT_571 = " = \"";
  protected final String TEXT_572 = "\";" + NL + "    String insertColValue";
  protected final String TEXT_573 = " =  \"";
  protected final String TEXT_574 = "\";" + NL + "    int rowCount";
  protected final String TEXT_575 = " = 0;";
  protected final String TEXT_576 = NL + "        StringBuffer query_";
  protected final String TEXT_577 = " = null;" + NL + "       \t";
  protected final String TEXT_578 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_579 = " = insert_";
  protected final String TEXT_580 = ".split(\"\\\\?\");";
  protected final String TEXT_581 = NL + "\t\t\tupdate_";
  protected final String TEXT_582 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_583 = " = update_";
  protected final String TEXT_584 = ".split(\"\\\\?\");";
  protected final String TEXT_585 = NL + "\t\t\tupdate_";
  protected final String TEXT_586 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_587 = " = update_";
  protected final String TEXT_588 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_589 = " = insert_";
  protected final String TEXT_590 = ".split(\"\\\\?\");";
  protected final String TEXT_591 = NL + "\t\t\tdelete_";
  protected final String TEXT_592 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_593 = " = delete_";
  protected final String TEXT_594 = ".split(\"\\\\?\");";
  protected final String TEXT_595 = NL + "\t\t\treplace_";
  protected final String TEXT_596 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_597 = " = replace_";
  protected final String TEXT_598 = ".split(\"\\\\?\");";
  protected final String TEXT_599 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_600 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_601 = " = insertIgnore_";
  protected final String TEXT_602 = ".split(\"\\\\?\");";
  protected final String TEXT_603 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_604 = " = insert_";
  protected final String TEXT_605 = ".split(\"\\\\?\");";
  protected final String TEXT_606 = NL + " \tboolean isShareIdentity_";
  protected final String TEXT_607 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_608 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_609 = "\") == true;";
  protected final String TEXT_610 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_611 = " = conn_";
  protected final String TEXT_612 = ".createStatement();";
  protected final String TEXT_613 = NL + "\t        if ( !isShareIdentity_";
  protected final String TEXT_614 = " ) {" + NL + "\t        \tstmt_";
  protected final String TEXT_615 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_616 = " +\"] ON\");" + NL + "\t        }";
  protected final String TEXT_617 = NL + "     \t\tstmt_";
  protected final String TEXT_618 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_619 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_620 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_621 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_622 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_623 = " =null;" + NL + "\t";
  protected final String TEXT_624 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_625 = " = null;" + NL + "\t\t";
  protected final String TEXT_626 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_630 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_631 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_632 = " = null;";
  protected final String TEXT_633 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_634 = " = null;";
  protected final String TEXT_635 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_636 = " = null;";
  protected final String TEXT_637 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_638 = " = null;";
  protected final String TEXT_639 = NL + "\t\t \tString[] insertSQLSplits_";
