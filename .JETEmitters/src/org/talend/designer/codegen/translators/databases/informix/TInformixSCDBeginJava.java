...
public class TInformixSCDBeginJava {
  protected static String nl;
  public static synchronized TInformixSCDBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInformixSCDBeginJava result = new TInformixSCDBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_14 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_15 = " + \":\" + ";
  protected final String TEXT_16 = " + \"/\" + ";
  protected final String TEXT_17 = " + \":informixserver=\" + ";
  protected final String TEXT_18 = ";";
  protected final String TEXT_19 = NL + "    String url_";
  protected final String TEXT_20 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_21 = " + \":\" + ";
  protected final String TEXT_22 = " + \"/\" + ";
  protected final String TEXT_23 = " + \":informixserver=\" + ";
  protected final String TEXT_24 = " + \";\" + ";
  protected final String TEXT_25 = ";";
  protected final String TEXT_26 = NL + "\tjava.lang.Class.forName(\"com.informix.jdbc.IfxDriver\");" + NL + "\tString schema_";
  ...
  protected final String TEXT_40 = ";" + NL + "" + NL + "\tjava.sql.Connection connection_";
  ...
  protected final String TEXT_46 = ".getAutoCommit()) {" + NL + "\t    connection_";
  protected final String TEXT_47 = ".setAutoCommit(false);" + NL + "\t}";
  protected final String TEXT_48 = NL + "    String tableName_";
  protected final String TEXT_49 = " = null;" + NL + "    if(schema_";
  protected final String TEXT_50 = " == null || schema_";
  protected final String TEXT_51 = ".trim().length() == 0) {" + NL + "        tableName_";
  protected final String TEXT_52 = " = ";
  protected final String TEXT_53 = ";" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_54 = " = schema_";
  protected final String TEXT_55 = " + \".\" + ";
  protected final String TEXT_56 = ";" + NL + "    }" + NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_57 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_58 = " = null;    ";
  protected final String TEXT_59 = NL + "        String searching_";
  protected final String TEXT_60 = " = \"";
  protected final String TEXT_61 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_62 = " = connection_";
  protected final String TEXT_63 = ".prepareStatement(searching_";
  protected final String TEXT_64 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_65 = " = null;";
  protected final String TEXT_66 = NL + "        String search_";
  protected final String TEXT_67 = " = \"";
  protected final String TEXT_68 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_69 = " = connection_";
  protected final String TEXT_70 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_71 = " = statement_";
  protected final String TEXT_72 = ".executeQuery(search_";
  protected final String TEXT_73 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_74 = ", SCDStruct_";
  protected final String TEXT_75 = "> cache_";
  protected final String TEXT_76 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_77 = ", SCDStruct_";
  protected final String TEXT_78 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_79 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_80 = " sk_";
  protected final String TEXT_81 = " = new SCDSK_";
  protected final String TEXT_82 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_83 = " row_";
  protected final String TEXT_84 = " = new SCDStruct_";
  protected final String TEXT_85 = "();";
  protected final String TEXT_86 = NL + "                    tmpValue_";
  protected final String TEXT_87 = " = resultSet_";
  protected final String TEXT_88 = ".getString(";
  protected final String TEXT_89 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_90 = " != null && tmpValue_";
  protected final String TEXT_91 = ".length() > 0) {";
  protected final String TEXT_92 = NL + "                        ";
  protected final String TEXT_93 = ".";
  protected final String TEXT_94 = " = tmpValue_";
  ...
  protected final String TEXT_100 = " = null;" + NL + "                            } else {";
  protected final String TEXT_101 = NL + "                                ";
  protected final String TEXT_102 = ".";
  protected final String TEXT_103 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_104 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_105 = ")) {";
  protected final String TEXT_106 = NL + "                                ";
  protected final String TEXT_107 = ".";
  protected final String TEXT_108 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_109 = "' in '";
  protected final String TEXT_110 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_111 = NL + "                    }";
  protected final String TEXT_112 = NL + "                    timestamp_";
  protected final String TEXT_113 = " = resultSet_";
  protected final String TEXT_114 = ".getTimestamp(";
  protected final String TEXT_115 = ");" + NL + "                    if(timestamp_";
  protected final String TEXT_116 = " != null) {";
  protected final String TEXT_117 = NL + "                        ";
  protected final String TEXT_118 = ".";
  protected final String TEXT_119 = " = new java.util.Date(timestamp_";
  protected final String TEXT_120 = ".getTime());" + NL + "                    } else {";
  protected final String TEXT_121 = NL + "                        ";
  protected final String TEXT_122 = ".";
  protected final String TEXT_123 = " = null;" + NL + "                    }";
  protected final String TEXT_124 = NL + "                    if(resultSet_";
  protected final String TEXT_125 = ".getObject(";
  protected final String TEXT_126 = ") != null) {";
  protected final String TEXT_127 = NL + "                        ";
  protected final String TEXT_128 = ".";
  protected final String TEXT_129 = " = resultSet_";
  protected final String TEXT_130 = ".get";
  protected final String TEXT_131 = "(";
  protected final String TEXT_132 = ");" + NL + "                    }";
  protected final String TEXT_133 = NL + "            cache_";
  protected final String TEXT_134 = ".put(sk_";
  protected final String TEXT_135 = ", row_";
  protected final String TEXT_136 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_137 = ".close();" + NL + "        statement_";
  protected final String TEXT_138 = ".close();";
  protected final String TEXT_139 = NL + "            System.out.println(\"[";
  protected final String TEXT_140 = "] comparison cache loaded\");";
  protected final String TEXT_141 = NL + "        ";
  protected final String TEXT_142 = " nextSurrogateKey_";
  protected final String TEXT_143 = " = 1;";
  protected final String TEXT_144 = NL + "            if(cache_";
  protected final String TEXT_145 = ".size() > 0) {";
  protected final String TEXT_146 = NL + "        String tmpQuery_";
  protected final String TEXT_147 = " = \"SELECT MAX(";
  protected final String TEXT_148 = ") FROM \" + tableName_";
  protected final String TEXT_149 = ";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_150 = " = connection_";
  protected final String TEXT_151 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_152 = " = tmpStmt_";
  protected final String TEXT_153 = ".executeQuery(tmpQuery_";
  protected final String TEXT_154 = ");";
  protected final String TEXT_155 = NL + "        if(tmpRS_";
  protected final String TEXT_156 = ".next() && tmpRS_";
  protected final String TEXT_157 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_158 = " = tmpRS_";
  protected final String TEXT_159 = ".get";
  protected final String TEXT_160 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_161 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_162 = ".close();";
  protected final String TEXT_163 = NL + "            }            ";
  protected final String TEXT_164 = NL + "    String insertionSQL_";
  protected final String TEXT_165 = " = \"";
  protected final String TEXT_166 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_167 = " = connection_";
  protected final String TEXT_168 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_169 = ");";
  protected final String TEXT_170 = NL + "            insertionStatement_";
  protected final String TEXT_171 = ".setTimestamp(";
  protected final String TEXT_172 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_173 = "\")));";
  protected final String TEXT_174 = NL + "            insertionStatement_";
  protected final String TEXT_175 = ".setNull(";
  protected final String TEXT_176 = ", java.sql.Types.DATE);";
  protected final String TEXT_177 = NL + "            String endDateTimeDetail_";
  protected final String TEXT_178 = " = ";
  protected final String TEXT_179 = ";" + NL + "            String datePattern_";
  protected final String TEXT_180 = " = \"yyyy-MM-dd\";" + NL + "            if(endDateTimeDetail_";
  protected final String TEXT_181 = ".length()>0){" + NL + "            \tendDateTimeDetail_";
  protected final String TEXT_182 = " = \" \"+endDateTimeDetail_";
  protected final String TEXT_183 = ";" + NL + "            \tdatePattern_";
  protected final String TEXT_184 = " = \"yyyy-MM-dd HH:mm:ss\";" + NL + "            }" + NL + "            insertionStatement_";
  protected final String TEXT_185 = ".setTimestamp(";
  protected final String TEXT_186 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(datePattern_";
  protected final String TEXT_187 = ").parse(";
  protected final String TEXT_188 = " + \"-01-01\"+endDateTimeDetail_";
  protected final String TEXT_189 = ").getTime()));";
  protected final String TEXT_190 = NL + "        String updateSQLForType1_";
  protected final String TEXT_191 = " = \"";
  protected final String TEXT_192 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_193 = " = connection_";
  protected final String TEXT_194 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_195 = ");        ";
  protected final String TEXT_196 = NL + "        String updateSQLForType2_";
  protected final String TEXT_197 = " = \"";
  protected final String TEXT_198 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_199 = " = connection_";
  protected final String TEXT_200 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_201 = ");";
  protected final String TEXT_202 = NL + "            updateForType2_";
  protected final String TEXT_203 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_204 = "\")));";
  protected final String TEXT_205 = NL + "        String updateSQLForType3_";
  protected final String TEXT_206 = " = \"";
  protected final String TEXT_207 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_208 = " = connection_";
  protected final String TEXT_209 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_210 = ");";
  protected final String TEXT_211 = NL + "    ";
  protected final String TEXT_212 = NL + "        SCDSK_";
  protected final String TEXT_213 = " lookUpKey_";
  protected final String TEXT_214 = " = null;        ";
  protected final String TEXT_215 = NL + "    SCDStruct_";
  protected final String TEXT_216 = " lookUpValue_";
