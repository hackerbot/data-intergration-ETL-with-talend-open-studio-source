...
public class TParAccelSCDMainJava {
  protected static String nl;
  public static synchronized TParAccelSCDMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TParAccelSCDMainJava result = new TParAccelSCDMainJava();
    nl = null;
    return result;
  }
