...
public class TEXAOutputMainJava {
  protected static String nl;
  public static synchronized TEXAOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TEXAOutputMainJava result = new TEXAOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_49 = NL + "        whetherReject_";
  protected final String TEXT_50 = " = false;";
  protected final String TEXT_51 = NL + "                query_";
  protected final String TEXT_52 = " = new String(insert_";
  ...
  protected final String TEXT_61 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_62 = " = insertedCount_";
  protected final String TEXT_63 = " + pstmt_";
  protected final String TEXT_64 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_65 = "++;";
  protected final String TEXT_66 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_82 = ".errorMessage = e.getMessage();";
  protected final String TEXT_83 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_84 = NL + "            }";
  protected final String TEXT_85 = NL + "                query_";
  protected final String TEXT_86 = " = new String(update_";
  ...
  protected final String TEXT_97 = "_QUERY\", query_";
  protected final String TEXT_98 = ");";
  protected final String TEXT_99 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_100 = " = updatedCount_";
  protected final String TEXT_101 = " + pstmt_";
  protected final String TEXT_102 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_103 = "++;";
  protected final String TEXT_104 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_105 = " = true;";
  protected final String TEXT_106 = NL + "                    throw(e);";
  ...
  protected final String TEXT_129 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  ...
  protected final String TEXT_134 = " = new String(update_";
  ...
  protected final String TEXT_141 = NL + "                            query_";
  protected final String TEXT_142 = " = ";
  protected final String TEXT_143 = ";";
  protected final String TEXT_144 = NL + "                    globalMap.put(\"";
  protected final String TEXT_145 = "_QUERY\", query_";
  protected final String TEXT_146 = ");";
  protected final String TEXT_147 = NL + "                try {" + NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_148 = " = updatedCount_";
  protected final String TEXT_149 = " + pstmtUpdate_";
  protected final String TEXT_150 = ".executeUpdate();" + NL + "        \t\t\tnb_line_";
  ...
  protected final String TEXT_168 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_169 = NL + "                            ";
  protected final String TEXT_170 = ".errorMessage = e.getMessage();";
  ...
  protected final String TEXT_174 = " = new String(insert_";
  protected final String TEXT_175 = ");";
  protected final String TEXT_176 = NL + "                        ";
  protected final String TEXT_177 = NL + "                            query_";
  protected final String TEXT_178 = " = ";
  protected final String TEXT_179 = ";";
  protected final String TEXT_180 = NL + "                    globalMap.put(\"";
  protected final String TEXT_181 = "_QUERY\", query_";
  protected final String TEXT_182 = ");";
  protected final String TEXT_183 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_184 = " = insertedCount_";
  protected final String TEXT_185 = " + pstmtInsert_";
  protected final String TEXT_186 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_187 = "++;";
  protected final String TEXT_188 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_201 = NL + "                            nb_line_rejected_";
  protected final String TEXT_202 = "++;";
  protected final String TEXT_203 = NL + "                            ";
  protected final String TEXT_204 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_208 = NL + "                }" + NL + "    \t\t}" + NL + "    " + NL + "    \t\t";
  protected final String TEXT_209 = NL + "                query_";
  protected final String TEXT_210 = " = new String(update_";
  protected final String TEXT_211 = ");";
  protected final String TEXT_212 = NL + "    \t    int updateFlag_";
  protected final String TEXT_213 = "=0;" + NL + "    \t    ";
  protected final String TEXT_214 = NL + "                    ";
  protected final String TEXT_215 = NL + "                        query_";
  ...
  protected final String TEXT_223 = "_QUERY\", query_";
  protected final String TEXT_224 = ");";
  protected final String TEXT_225 = "\t" + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_226 = "=pstmtUpdate_";
  protected final String TEXT_227 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_228 = " = updatedCount_";
  protected final String TEXT_229 = "+updateFlag_";
  protected final String TEXT_230 = ";" + NL + "                if(updateFlag_";
  protected final String TEXT_231 = " != 0) {" + NL + "            \t\tnb_line_";
  protected final String TEXT_232 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_233 = NL + "                }" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_234 = " = true;";
  protected final String TEXT_235 = NL + "                    throw(e);";
  ...
  protected final String TEXT_244 = NL + "                        nb_line_rejected_";
  protected final String TEXT_245 = "++;";
  protected final String TEXT_246 = NL + "                        ";
  protected final String TEXT_247 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_248 = NL + "                        ";
  protected final String TEXT_249 = ".errorMessage = e.getMessage();";
  protected final String TEXT_250 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_251 = NL + "            }" + NL + "            " + NL + "            if(updateFlag_";
  protected final String TEXT_252 = " == 0) {" + NL + "        \t\t";
  protected final String TEXT_253 = NL + "                    query_";
  protected final String TEXT_254 = " = new String(insert_";
  ...
  protected final String TEXT_263 = NL + "                try {" + NL + "                    insertedCount_";
  ...
  protected final String TEXT_268 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_269 = " = true;";
  protected final String TEXT_270 = NL + "                        throw(e);";
  protected final String TEXT_271 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_281 = NL + "                            nb_line_rejected_";
  protected final String TEXT_282 = "++;";
  protected final String TEXT_283 = NL + "                            ";
  protected final String TEXT_284 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_285 = NL + "                            ";
  protected final String TEXT_286 = ".errorMessage = e.getMessage();";
  protected final String TEXT_287 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_288 = NL + "                }" + NL + "            } ";
  protected final String TEXT_289 = NL + "                query_";
  protected final String TEXT_290 = " = new String(delete_";
  protected final String TEXT_291 = ");";
  protected final String TEXT_292 = NL + "                    ";
  protected final String TEXT_293 = NL + "                        query_";
  protected final String TEXT_294 = " = ";
  protected final String TEXT_295 = ";";
  protected final String TEXT_296 = NL + "                globalMap.put(\"";
  protected final String TEXT_297 = "_QUERY\", query_";
  protected final String TEXT_298 = ");";
  protected final String TEXT_299 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_300 = " = deletedCount_";
  protected final String TEXT_301 = " + pstmt_";
  protected final String TEXT_302 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_303 = "++;";
  protected final String TEXT_304 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_305 = " = true;";
  protected final String TEXT_306 = NL + "                    throw(e);";
  protected final String TEXT_307 = NL + "                \tnb_line_";
  protected final String TEXT_308 = "++;" + NL + "                \t";
  protected final String TEXT_309 = NL + "                        ";
  protected final String TEXT_310 = " = new ";
  protected final String TEXT_311 = "Struct();";
  protected final String TEXT_312 = NL + "                            ";
  protected final String TEXT_313 = ".";
  protected final String TEXT_314 = " = ";
  protected final String TEXT_315 = ".";
  protected final String TEXT_316 = ";";
  protected final String TEXT_317 = NL + "                        nb_line_rejected_";
  protected final String TEXT_318 = "++;";
  protected final String TEXT_319 = NL + "                        ";
  protected final String TEXT_320 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_321 = NL + "                        ";
  protected final String TEXT_322 = ".errorMessage = e.getMessage();";
  protected final String TEXT_323 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_324 = NL + "            }" + NL + "    \t";
  protected final String TEXT_325 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_336 = NL + "                    commitCounter_";
  protected final String TEXT_337 = "++;                " + NL + "                    if(commitEvery_";
  protected final String TEXT_338 = " <= commitCounter_";
...
DBLogUtil dbLog = null;
    ...
    stringBuffer.append(getManager(dbmsId, cid).retrieveSQL(typeToGenerate, column, incomingConnName, cid, "query_"));
    ...
    stringBuffer.append(getManager(dbmsId, cid).retrieveSQL(typeToGenerate, columnInsert, incomingConnName, cid, "query_"));
    ...
    stringBuffer.append(getManager(dbmsId, cid).retrieveSQL(typeToGenerate, columnUpdate, incomingConnName, cid, "query_"));
