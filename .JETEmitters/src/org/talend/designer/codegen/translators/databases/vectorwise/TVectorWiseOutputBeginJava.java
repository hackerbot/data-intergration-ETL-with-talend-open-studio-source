...
public class TVectorWiseOutputBeginJava {
  protected static String nl;
  public static synchronized TVectorWiseOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVectorWiseOutputBeginJava result = new TVectorWiseOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_51 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_52 = " = ";
  protected final String TEXT_53 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_54 = " = false;" + NL;
  protected final String TEXT_55 = NL;
  protected final String TEXT_56 = NL + "        int updateKeyCount_";
  protected final String TEXT_57 = " = ";
  protected final String TEXT_58 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_59 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_60 = NL + "        int deleteKeyCount_";
  protected final String TEXT_61 = " = ";
  protected final String TEXT_62 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_63 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  ...
  protected final String TEXT_69 = NL + "\tjava.lang.Class.forName(\"com.ingres.jdbc.IngresDriver\");" + NL + "\t";
  protected final String TEXT_70 = NL + "\tString url_";
  protected final String TEXT_71 = " = \"jdbc:ingres://\" + ";
  ...
  protected final String TEXT_84 = NL + NL + "\tString dbPwd_";
  ...
  protected final String TEXT_92 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_93 = "\", conn_";
  protected final String TEXT_94 = ");" + NL;
  protected final String TEXT_95 = NL + "                    conn_";
  protected final String TEXT_96 = ".setAutoCommit(false);";
  protected final String TEXT_97 = NL + NL + "\t";
  protected final String TEXT_98 = NL + "   int batchSize_";
  protected final String TEXT_99 = " = ";
  protected final String TEXT_100 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_101 = "=0;";
  protected final String TEXT_102 = NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_103 = " = conn_";
  protected final String TEXT_104 = ".createStatement();";
  protected final String TEXT_105 = NL + "            stmtDrop_";
  protected final String TEXT_106 = ".execute(\"";
  protected final String TEXT_107 = "\");";
  protected final String TEXT_108 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_109 = " = conn_";
  protected final String TEXT_110 = ".createStatement();";
  protected final String TEXT_111 = NL + "            stmtCreate_";
  protected final String TEXT_112 = ".execute(\"";
  protected final String TEXT_113 = ") WITH STRUCTURE = VECTORWISE\");";
  protected final String TEXT_114 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_115 = " = conn_";
  protected final String TEXT_116 = ".createStatement();";
  protected final String TEXT_117 = NL + "            stmtCreate_";
  protected final String TEXT_118 = ".execute(\"";
  protected final String TEXT_119 = ") WITH STRUCTURE = VECTORWISE\");";
  protected final String TEXT_120 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_121 = " = conn_";
  protected final String TEXT_122 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_123 = " = dbMetaData_";
  protected final String TEXT_124 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_125 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_126 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_127 = " = rsTable_";
  protected final String TEXT_128 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_129 = ".equalsIgnoreCase(";
  protected final String TEXT_130 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_131 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  protected final String TEXT_132 = NL + "                if(!whetherExist_";
  protected final String TEXT_133 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_138 = ") WITH STRUCTURE = VECTORWISE\");" + NL + "            \t\t";
  protected final String TEXT_139 = NL + "                }";
  protected final String TEXT_140 = NL + "                if(whetherExist_";
  protected final String TEXT_141 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_147 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_148 = " = conn_";
  protected final String TEXT_149 = ".createStatement();";
  protected final String TEXT_150 = NL + "                stmtCreate_";
  protected final String TEXT_151 = ".execute(\"";
  protected final String TEXT_152 = ") WITH STRUCTURE = VECTORWISE\");";
  protected final String TEXT_153 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_154 = " = conn_";
  protected final String TEXT_155 = ".createStatement();";
  protected final String TEXT_156 = NL + "            deletedCount_";
  protected final String TEXT_157 = " = deletedCount_";
  protected final String TEXT_158 = " + stmtClear_";
  ...
  protected final String TEXT_167 = ".prepareStatement(insert_";
  protected final String TEXT_168 = ");" + NL + "\t    ";
  protected final String TEXT_169 = NL + "\t    String update_";
  protected final String TEXT_170 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_171 = " + \"\\\" SET ";
  protected final String TEXT_172 = " WHERE ";
  protected final String TEXT_173 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_174 = " = conn_";
  protected final String TEXT_175 = ".prepareStatement(update_";
  protected final String TEXT_176 = ");" + NL + "\t    ";
  protected final String TEXT_177 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_178 = " = conn_";
  protected final String TEXT_179 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + ";
  protected final String TEXT_180 = " + \"\\\" WHERE ";
  protected final String TEXT_181 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_182 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_183 = " + \"\\\" (";
  protected final String TEXT_184 = ") VALUES (";
  protected final String TEXT_185 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_186 = " = conn_";
  protected final String TEXT_187 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_196 = NL + "\t    String update_";
  protected final String TEXT_197 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_198 = " + \"\\\" SET ";
  protected final String TEXT_199 = " WHERE ";
  protected final String TEXT_200 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_201 = " = conn_";
  protected final String TEXT_202 = ".prepareStatement(update_";
  ...
  protected final String TEXT_211 = NL + "\t    String delete_";
  protected final String TEXT_212 = " = \"DELETE  FROM \\\"\" + ";
  protected final String TEXT_213 = " + \"\\\" WHERE ";
  protected final String TEXT_214 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_215 = " = conn_";
  protected final String TEXT_216 = ".prepareStatement(delete_";
  protected final String TEXT_217 = ");" + NL + "\t    ";
  protected final String TEXT_218 = NL + "        StringBuffer query_";
  protected final String TEXT_219 = " = null;" + NL + "       \t";
  protected final String TEXT_220 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_221 = " = insert_";
  protected final String TEXT_222 = ".split(\"\\\\?\");";
  protected final String TEXT_223 = NL + "\t\t\tupdate_";
  protected final String TEXT_224 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_225 = " = update_";
  protected final String TEXT_226 = ".split(\"\\\\?\");";
  protected final String TEXT_227 = NL + "\t\t\tupdate_";
  protected final String TEXT_228 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_229 = " = update_";
  protected final String TEXT_230 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_231 = " = insert_";
  protected final String TEXT_232 = ".split(\"\\\\?\");";
  protected final String TEXT_233 = NL + "\t\t\tdelete_";
  protected final String TEXT_234 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_235 = " = delete_";
  protected final String TEXT_236 = ".split(\"\\\\?\");";
  protected final String TEXT_237 = NL + "\t\t\treplace_";
  protected final String TEXT_238 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_239 = " = replace_";
  protected final String TEXT_240 = ".split(\"\\\\?\");";
  protected final String TEXT_241 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_242 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_243 = " = insertIgnore_";
  protected final String TEXT_244 = ".split(\"\\\\?\");";
  protected final String TEXT_245 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_246 = " = insert_";
  protected final String TEXT_247 = ".split(\"\\\\?\");";
  protected final String TEXT_248 = NL + "\t        int commitEvery_";
  protected final String TEXT_249 = " = ";
  protected final String TEXT_250 = ";" + NL + "\t        int commitCounter_";
