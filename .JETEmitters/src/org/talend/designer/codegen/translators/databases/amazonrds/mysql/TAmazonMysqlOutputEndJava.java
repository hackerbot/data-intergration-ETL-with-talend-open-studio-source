...
public class TAmazonMysqlOutputEndJava {
  protected static String nl;
  public static synchronized TAmazonMysqlOutputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAmazonMysqlOutputEndJava result = new TAmazonMysqlOutputEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_185 = "++;" + NL + "\t        }" + NL + "\t        insertedCount_";
  ...
  protected final String TEXT_189 = NL + "                try {" + NL + "                \t\tif (batchSizeCounter_";
  protected final String TEXT_190 = " != 0) {" + NL + "\t\t\t\t\t\t\tint countSum_";
  protected final String TEXT_191 = " = 0;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_192 = NL + "\t\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_193 = ": pstmt_";
  protected final String TEXT_194 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_195 = " += (countEach_";
  protected final String TEXT_196 = " < 0 ? 0 : 1);" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_197 = NL + "\t            \t    \t";
  protected final String TEXT_198 = NL + "\t            \t    \t\tinsertedCount_";
  protected final String TEXT_199 = " += countSum_";
  protected final String TEXT_200 = ";" + NL + "\t            \t    \t";
  protected final String TEXT_201 = NL + "            \t    \t}" + NL + "" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_202 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_203 = NL + "                \tint countSum_";
  protected final String TEXT_204 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_205 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_206 = " += (countEach_";
  protected final String TEXT_207 = " < 0 ? 0 : countEach_";
  protected final String TEXT_208 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_209 = NL + "            \t    insertedCount_";
  protected final String TEXT_210 = " += countSum_";
  protected final String TEXT_211 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_212 = NL + "    \t    \t\t";
  protected final String TEXT_213 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_214 = NL + "                }" + NL + "                batchSizeCounter_";
  protected final String TEXT_215 = " = 0;";
  protected final String TEXT_216 = NL + "    \t\t";
  protected final String TEXT_217 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_218 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_219 = ".close();" + NL + "" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_220 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_221 = ".close();" + NL + "" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_222 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_223 = ".close();" + NL + "" + NL + "        }";
  protected final String TEXT_224 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_225 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_226 = ".close();" + NL + "" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_227 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_228 = ".close();" + NL + "" + NL + "        }";
  protected final String TEXT_229 = NL + "    try {" + NL + "\t\t\tint countSum_";
  protected final String TEXT_230 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_231 = NL + "\t\t\tfor(int countEach_";
  protected final String TEXT_232 = ": pstmt_";
  protected final String TEXT_233 = ".executeBatch()) {" + NL + "\t\t\t\tcountSum_";
  protected final String TEXT_234 = " += (countEach_";
  protected final String TEXT_235 = " < 0 ? 0 : ";
  ...
  protected final String TEXT_267 = NL + "            if(pstmt_";
  protected final String TEXT_268 = " != null) {" + NL + "    \t\t\tpstmt_";
  protected final String TEXT_269 = ".close();" + NL + "            }";
  protected final String TEXT_270 = NL;
  protected final String TEXT_271 = NL + "    \t\tif (commitCounter_";
  protected final String TEXT_272 = " > 0) {" + NL + "        \t\t";
  protected final String TEXT_273 = NL + "        \t\tconn_";
  protected final String TEXT_274 = ".commit();" + NL + "        \t\t";
  protected final String TEXT_275 = NL + "    \t\t}" + NL + "    \t\t";
  protected final String TEXT_276 = NL + "\t\t";
  protected final String TEXT_277 = NL + "    \tconn_";
  protected final String TEXT_278 = " .close();" + NL + "    \t";
  protected final String TEXT_279 = NL + "    \tresourceMap.put(\"finish_";
  protected final String TEXT_280 = "\", true);" + NL + "    \t";
  protected final String TEXT_281 = NL;
  protected final String TEXT_282 = NL + "\tnb_line_deleted_";
  protected final String TEXT_283 = "=nb_line_deleted_";
  protected final String TEXT_284 = "+ deletedCount_";
  protected final String TEXT_285 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_286 = "=nb_line_update_";
  protected final String TEXT_287 = " + updatedCount_";
  protected final String TEXT_288 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_289 = "=nb_line_inserted_";
  protected final String TEXT_290 = " + insertedCount_";
  protected final String TEXT_291 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_292 = "=nb_line_rejected_";
  protected final String TEXT_293 = " + rejectedCount_";
  protected final String TEXT_294 = ";" + NL + "\t";
  protected final String TEXT_295 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_296 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_297 = "_NB_LINE\",nb_line_";
  protected final String TEXT_298 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_299 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_300 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_301 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_302 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_303 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_304 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_305 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_306 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_307 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_308 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_309 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_310 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_311 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_312 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_313 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_314 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_315 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_316 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_317 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_318 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_319 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_320 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_321 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_322 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_323 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_324 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  protected final String TEXT_325 = ");" + NL + "        }" + NL + "\t";
  protected final String TEXT_326 = NL + "        globalMap.put(\"";
  protected final String TEXT_327 = "_NB_LINE\",nb_line_";
  protected final String TEXT_328 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_329 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_330 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_331 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_332 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_333 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_334 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_335 = "_NB_LINE_REJECTED\", nb_line_rejected_";
