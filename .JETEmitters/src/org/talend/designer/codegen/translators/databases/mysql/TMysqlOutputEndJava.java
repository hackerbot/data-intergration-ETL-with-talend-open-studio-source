...
public class TMysqlOutputEndJava {
  ...
  protected final String TEXT_44 = NL + "\t\t            if(bufferL";
  protected final String TEXT_45 = ".";
  protected final String TEXT_46 = "==null){" + NL + "\t\t                ";
  protected final String TEXT_47 = ".setNull(count";
  protected final String TEXT_48 = ",java.sql.Types.CHAR);" + NL + "\t                ";
  protected final String TEXT_49 = NL + "\t\t            if(bufferL";
  protected final String TEXT_50 = ".";
  protected final String TEXT_51 = "==null){" + NL + "\t\t                ";
  protected final String TEXT_52 = ".setNull(count";
  protected final String TEXT_53 = ",java.sql.Types.DATE);" + NL + "\t                ";
  protected final String TEXT_54 = NL + "\t\t            if(bufferL";
  protected final String TEXT_55 = ".";
  protected final String TEXT_56 = "==null){" + NL + "\t\t                ";
  protected final String TEXT_57 = ".setNull(count";
  protected final String TEXT_58 = ",java.sql.Types.ARRAY);" + NL + "\t                ";
  protected final String TEXT_59 = NL + "\t\t            if(bufferL";
  protected final String TEXT_60 = ".";
  protected final String TEXT_61 = "==null){" + NL + "\t\t                ";
  protected final String TEXT_62 = ".setNull(count";
  protected final String TEXT_63 = ",java.sql.Types.INTEGER);" + NL + "\t                ";
  protected final String TEXT_64 = NL + "\t\t            if(bufferL";
  protected final String TEXT_65 = ".";
  protected final String TEXT_66 = "==null){" + NL + "\t\t                ";
  protected final String TEXT_67 = ".setNull(count";
  protected final String TEXT_68 = ",java.sql.Types.VARCHAR);" + NL + "\t                ";
  protected final String TEXT_69 = NL + "\t\t            if(bufferL";
  protected final String TEXT_70 = ".";
  protected final String TEXT_71 = "==null){" + NL + "\t\t                ";
  protected final String TEXT_72 = ".setNull(count";
  protected final String TEXT_73 = ",java.sql.Types.OTHER);" + NL + "\t                ";
  protected final String TEXT_74 = NL + "\t\t            if(bufferL";
  protected final String TEXT_75 = ".";
  protected final String TEXT_76 = "==null){" + NL + "\t\t                ";
  protected final String TEXT_77 = ".setNull(count";
  protected final String TEXT_78 = ",java.sql.Types.BOOLEAN);" + NL + "\t                ";
  protected final String TEXT_79 = NL + "\t\t            if(bufferL";
  protected final String TEXT_80 = ".";
  protected final String TEXT_81 = "==null){" + NL + "\t\t                ";
  protected final String TEXT_82 = ".setNull(count";
  protected final String TEXT_83 = ",java.sql.Types.DOUBLE);" + NL + "\t                ";
  protected final String TEXT_84 = NL + "\t\t            if(bufferL";
  protected final String TEXT_85 = ".";
  protected final String TEXT_86 = "==null){" + NL + "\t\t                ";
  protected final String TEXT_87 = ".setNull(count";
  protected final String TEXT_88 = ",java.sql.Types.FLOAT);" + NL + "\t                ";
  protected final String TEXT_89 = NL + NL + "\t                }else{" + NL + "" + NL + "\t                ";
  protected final String TEXT_90 = NL + "\t\t        ";
  protected final String TEXT_91 = NL + "\t\t            if(bufferL";
  protected final String TEXT_92 = ".";
  protected final String TEXT_93 = "==null){" + NL + "\t\t        ";
  protected final String TEXT_94 = NL + "\t\t            if((\"null\").equals(String.valueOf(bufferL";
  protected final String TEXT_95 = ".";
  protected final String TEXT_96 = ").toLowerCase())){" + NL + "\t\t        ";
  protected final String TEXT_97 = NL + "\t            ";
  protected final String TEXT_98 = ".setNull(count";
  protected final String TEXT_99 = ",java.sql.Types.CHAR);" + NL + "" + NL + "\t\t        } else if(bufferL";
  protected final String TEXT_100 = ".";
  protected final String TEXT_101 = " == '\\0') {" + NL + "" + NL + "\t\t            ";
  protected final String TEXT_102 = ".setString(count";
  protected final String TEXT_103 = ",\"\");" + NL + "" + NL + "\t\t        } else {" + NL + "" + NL + "\t\t            ";
  protected final String TEXT_104 = ".setString(count";
  protected final String TEXT_105 = ",String.valueOf(bufferL";
  protected final String TEXT_106 = ".";
  protected final String TEXT_107 = "));" + NL + "\t\t        }" + NL + "\t\t        ";
  protected final String TEXT_108 = NL + "\t\t            if(bufferL";
  protected final String TEXT_109 = ".";
  protected final String TEXT_110 = "!=null){" + NL + "\t\t                // timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t                date_";
  protected final String TEXT_111 = " = bufferL";
  protected final String TEXT_112 = ".";
  protected final String TEXT_113 = ".getTime();" + NL + "\t\t                if (date_";
  protected final String TEXT_114 = " < year1_";
  protected final String TEXT_115 = " || date_";
  protected final String TEXT_116 = " >= year10000_";
  protected final String TEXT_117 = ") {" + NL + "\t\t                    ";
  protected final String TEXT_118 = ".setString(count";
  protected final String TEXT_119 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t                } else {" + NL + "\t\t                    ";
  protected final String TEXT_120 = ".setTimestamp(count";
  protected final String TEXT_121 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_122 = "));" + NL + "\t\t                }" + NL + "\t\t            }else{" + NL + "" + NL + "\t\t                ";
  protected final String TEXT_123 = ".setNull(count";
  protected final String TEXT_124 = ",java.sql.Types.DATE);" + NL + "" + NL + "\t\t            }" + NL + "\t\t            ";
  protected final String TEXT_125 = NL + "\t\t            ";
  protected final String TEXT_126 = ".set";
  protected final String TEXT_127 = "(count";
  protected final String TEXT_128 = ",bufferL";
  protected final String TEXT_129 = ".";
  protected final String TEXT_130 = ");" + NL + "\t\t            ";
  protected final String TEXT_131 = NL + NL + "\t\t            }" + NL + "" + NL + "\t\t        ";
  protected final String TEXT_132 = NL + NL + NL + "\t    if(rowCount";
  protected final String TEXT_133 = "!=0){" + NL + "" + NL + "\t        StringBuilder extendInsertValueStmt = new StringBuilder();" + NL + "\t        for(int i=0 ; i < rowCount";
  protected final String TEXT_134 = " ; i++){" + NL + "\t             extendInsertValueStmt.append(\"(\"+insertColValue";
  protected final String TEXT_135 = "+\")\");" + NL + "\t             if (i != rowCount";
  protected final String TEXT_136 = " - 1) extendInsertValueStmt.append(\",\");" + NL + "\t        }" + NL + "" + NL + "" + NL + "\t\t\t\t   insert_";
  protected final String TEXT_137 = " = \"INSERT INTO `\"+";
  protected final String TEXT_138 = "+\"` (\"+insertColName";
  protected final String TEXT_139 = "+\") VALUES \"+extendInsertValueStmt.toString();" + NL + "\t\t\t\t   ";
  protected final String TEXT_140 = NL + "\t\t\t\t    ";
  protected final String TEXT_141 = NL + "\t\t\t\t\t\tinsert_";
  protected final String TEXT_142 = " += \" ON DUPLICATE KEY UPDATE \";" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_143 = " = new StringBuffer(\"\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_144 = NL + "\t\t\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_145 = ".append(\",\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_146 = NL + "\t\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_147 = ".append (\"`\" +  ";
  protected final String TEXT_148 = " + \"`\");" + NL + "\t\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_149 = ".append (\"=\");" + NL + "\t\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_150 = ".append (";
  protected final String TEXT_151 = ");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_152 = NL + "\t\t\t\t\t\tinsert_";
  protected final String TEXT_153 = " += \tduplidateClause_";
  protected final String TEXT_154 = ".toString();" + NL + "\t\t\t\t\t";
  protected final String TEXT_155 = NL + "\t\t\t\t        ";
  protected final String TEXT_156 = NL + NL + NL + "\t        pstmt_";
  protected final String TEXT_157 = " = conn_";
  protected final String TEXT_158 = ".prepareStatement(insert_";
  protected final String TEXT_159 = ");" + NL + "" + NL + "\t        int row2Count";
  protected final String TEXT_160 = " = 0;";
  protected final String TEXT_161 = NL + "\t        \tint count";
  protected final String TEXT_162 = " = 1;";
  protected final String TEXT_163 = NL + "\t\t\tint count";
  protected final String TEXT_164 = " = 0;";
  protected final String TEXT_165 = NL + NL + "\t        for(BufferLine_";
  protected final String TEXT_166 = " bufferL";
  protected final String TEXT_167 = " : exInsertColValueList";
  protected final String TEXT_168 = "){";
  protected final String TEXT_169 = NL + "\t            count";
  protected final String TEXT_170 = " = row2Count";
  protected final String TEXT_171 = "*";
  protected final String TEXT_172 = "+1;";
  protected final String TEXT_173 = NL + "\t                    count";
  protected final String TEXT_174 = "++;" + NL + "\t                    ";
  protected final String TEXT_175 = NL + "\t\t\t\t\tint count_dyn_";
  protected final String TEXT_176 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_177 = ".";
  protected final String TEXT_178 = ", pstmt_";
  protected final String TEXT_179 = ", count";
  protected final String TEXT_180 = "-1, \"";
  protected final String TEXT_181 = "\");" + NL + "\t\t\t\t\tcount";
  protected final String TEXT_182 = "+=count_dyn_";
  protected final String TEXT_183 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_184 = NL + NL + "\t            row2Count";
  protected final String TEXT_185 = "++;" + NL + "\t        }" + NL + "\t        try{" + NL + "\t        \tinsertedCount_";
  protected final String TEXT_186 = " = insertedCount_";
  protected final String TEXT_187 = " + pstmt_";
  protected final String TEXT_188 = ".executeUpdate();" + NL + "\t        }catch(java.lang.Exception e){" + NL + "\t        \t";
  protected final String TEXT_189 = NL + "\t       \t\tthrow e;" + NL + "\t        \t";
  protected final String TEXT_190 = NL + "\t        \t\tSystem.err.println(e.getMessage());" + NL + "\t        \t";
  protected final String TEXT_191 = NL + "\t        }" + NL + "\t    }";
  protected final String TEXT_192 = NL + "                try {" + NL + "                \t\tif (batchSizeCounter_";
  protected final String TEXT_193 = " != 0) {" + NL + "\t\t\t\t\t\t\tint countSum_";
  protected final String TEXT_194 = " = 0;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_195 = NL + "\t\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_196 = ": pstmt_";
  protected final String TEXT_197 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_198 = " += (countEach_";
  protected final String TEXT_199 = " < 0 ? 0 : 1);" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_200 = NL + "\t            \t    \t";
  protected final String TEXT_201 = NL + "\t            \t    \t\tinsertedCount_";
  protected final String TEXT_202 = " += countSum_";
  protected final String TEXT_203 = ";" + NL + "\t            \t    \t";
  protected final String TEXT_204 = NL + "            \t    \t}" + NL + "" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_205 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_206 = NL + "                \tint countSum_";
  protected final String TEXT_207 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_208 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_209 = " += (countEach_";
  protected final String TEXT_210 = " < 0 ? 0 : countEach_";
  protected final String TEXT_211 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_212 = NL + "            \t    insertedCount_";
  protected final String TEXT_213 = " += countSum_";
  protected final String TEXT_214 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_215 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_216 = NL + "                }" + NL + "                batchSizeCounter_";
  protected final String TEXT_217 = " = 0;";
  protected final String TEXT_218 = NL + "    \t\t";
  protected final String TEXT_219 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_220 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_221 = ".close();" + NL + "" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_222 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_223 = ".close();" + NL + "" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_224 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_225 = ".close();" + NL + "" + NL + "        }";
  protected final String TEXT_226 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_227 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_228 = ".close();" + NL + "" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_229 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_230 = ".close();" + NL + "" + NL + "        }";
  protected final String TEXT_231 = NL + "\t";
  protected final String TEXT_232 = NL + "    try {" + NL + "    \tif(pstmt_";
  protected final String TEXT_233 = " != null){" + NL + "\t\t\tint countSum_";
  protected final String TEXT_234 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_235 = NL + "\t\t\tfor(int countEach_";
  protected final String TEXT_236 = ": pstmt_";
  protected final String TEXT_237 = ".executeBatch()) {" + NL + "\t\t\t\tcountSum_";
  protected final String TEXT_238 = " += (countEach_";
  protected final String TEXT_239 = " < 0 ? 0 : countEach_";
  protected final String TEXT_240 = ");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_241 = NL + "\t    \t";
  protected final String TEXT_242 = NL + "\t    \t\tupdatedCount_";
  protected final String TEXT_243 = " += countSum_";
  protected final String TEXT_244 = ";" + NL + "\t    \t";
  protected final String TEXT_245 = NL + "\t    \t    deletedCount_";
  protected final String TEXT_246 = " += countSum_";
  protected final String TEXT_247 = ";" + NL + "\t    \t";
  protected final String TEXT_248 = NL + "\t    }" + NL + "    }catch (java.sql.BatchUpdateException e){" + NL + "    \t";
  protected final String TEXT_249 = NL + "    \t\tthrow(e);" + NL + "    \t";
  protected final String TEXT_250 = NL + "    \tint countSum_";
  protected final String TEXT_251 = " = 0;" + NL + "\t\tfor(int countEach_";
  protected final String TEXT_252 = ": e.getUpdateCounts()) {" + NL + "\t\t\tcountSum_";
  protected final String TEXT_253 = " += (countEach_";
  protected final String TEXT_254 = " < 0 ? 0 : countEach_";
  protected final String TEXT_255 = ");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_256 = NL + "    \tupdatedCount_";
  protected final String TEXT_257 = " += countSum_";
  protected final String TEXT_258 = ";" + NL + "    \t";
  protected final String TEXT_259 = NL + "    \tdeletedCount_";
  protected final String TEXT_260 = " += countSum_";
  protected final String TEXT_261 = ";" + NL + "    \t";
  protected final String TEXT_262 = NL + "    \tSystem.err.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_263 = NL + "\t}";
  protected final String TEXT_264 = NL + NL + "        if(pstmt_";
  protected final String TEXT_265 = " != null) {" + NL + "\t\t\t";
  protected final String TEXT_266 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_267 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_268 = NL + "\t\t\t\tSharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
  protected final String TEXT_269 = ");" + NL + "\t\t\t";
  protected final String TEXT_270 = NL + "        }";
  protected final String TEXT_271 = NL;
  protected final String TEXT_272 = NL + "    \tif (commitCounter_";
  protected final String TEXT_273 = " > 0) {" + NL + "    \t\t";
  protected final String TEXT_274 = NL + "    \t\tconn_";
  protected final String TEXT_275 = ".commit();" + NL + "    \t\t";
  protected final String TEXT_276 = NL + "    \t}" + NL + "    \t\t";
  protected final String TEXT_277 = NL + "\t\t";
  protected final String TEXT_278 = NL + "    \tconn_";
  protected final String TEXT_279 = " .close();" + NL + "    \t";
  protected final String TEXT_280 = NL + "    \tresourceMap.put(\"finish_";
  protected final String TEXT_281 = "\", true);" + NL + "    \t";
  protected final String TEXT_282 = NL;
  protected final String TEXT_283 = NL + "\tnb_line_deleted_";
  protected final String TEXT_284 = "=nb_line_deleted_";
  protected final String TEXT_285 = "+ deletedCount_";
  protected final String TEXT_286 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_287 = "=nb_line_update_";
  protected final String TEXT_288 = " + updatedCount_";
  protected final String TEXT_289 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_290 = "=nb_line_inserted_";
  protected final String TEXT_291 = " + insertedCount_";
  protected final String TEXT_292 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_293 = "=nb_line_rejected_";
  protected final String TEXT_294 = " + rejectedCount_";
  protected final String TEXT_295 = ";" + NL + "\t";
  protected final String TEXT_296 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_297 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_298 = "_NB_LINE\",nb_line_";
  protected final String TEXT_299 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_300 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_301 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_302 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_303 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_304 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_305 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_306 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_307 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_308 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_309 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_310 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_311 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_312 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_313 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_314 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_315 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_316 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_317 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_318 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_319 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_320 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_321 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_322 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_323 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_324 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_325 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  protected final String TEXT_326 = ");" + NL + "        }" + NL + "\t";
  protected final String TEXT_327 = NL + "        globalMap.put(\"";
  protected final String TEXT_328 = "_NB_LINE\",nb_line_";
  protected final String TEXT_329 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_330 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_331 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_332 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_333 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_334 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_335 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_336 = "_NB_LINE_REJECTED\", nb_line_rejected_";
