...
public class TVerticaSCDEndJava {
  protected static String nl;
  public static synchronized TVerticaSCDEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVerticaSCDEndJava result = new TVerticaSCDEndJava();
    nl = null;
    return result;
  }
