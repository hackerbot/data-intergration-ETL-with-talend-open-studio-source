...
public class TOracleConnectionBeginJava
{
  ...
  protected final String TEXT_93 = NL + "        globalMap.put(\"localServiceName_\" + \"";
  protected final String TEXT_94 = "\",";
  protected final String TEXT_95 = ");";
  protected final String TEXT_96 = NL + "        globalMap.put(\"rac_url_\" + \"";
  protected final String TEXT_97 = "\", ";
  protected final String TEXT_98 = ");";
  protected final String TEXT_99 = NL + "        globalMap.put(\"host_\" + \"";
  protected final String TEXT_100 = "\",";
  protected final String TEXT_101 = ");" + NL + "        globalMap.put(\"port_\" + \"";
  protected final String TEXT_102 = "\",";
  protected final String TEXT_103 = ");" + NL + "        globalMap.put(\"dbname_\" + \"";
  protected final String TEXT_104 = "\",";
  protected final String TEXT_105 = ");";
  protected final String TEXT_106 = NL + NL + "\t";
  protected final String TEXT_107 = NL + NL + "\tString dbUser_";
  ...
  protected final String TEXT_123 = NL + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_124 = " = null;" + NL + "\t";
  protected final String TEXT_125 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_126 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_131 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_132 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_133 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_134 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_135 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_136 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_137 = " - Written records count: \" + nb_line_";
  protected final String TEXT_138 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_139 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_140 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_141 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_142 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_143 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_144 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_145 = " - Writing the record \" + nb_line_";
  protected final String TEXT_146 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_147 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_148 = " - Processing the record \" + nb_line_";
  protected final String TEXT_149 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_150 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_151 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_152 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_153 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_154 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_155 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_156 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_157 = " - Uses an existing connection ";
  protected final String TEXT_158 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_159 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_160 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_161 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_162 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_166 = ", dbUser_";
  protected final String TEXT_167 = ", dbPwd_";
  protected final String TEXT_168 = ");" + NL + "\t\t\t";
  protected final String TEXT_169 = NL + "\t\t\tconn_";
  protected final String TEXT_170 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_171 = NL + "\t\t\tconn_";
  protected final String TEXT_172 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_173 = NL + "\t\t\tconn_";
  protected final String TEXT_174 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_175 = NL + "\t\t\t\tconn_";
  protected final String TEXT_176 = ".setAutoCommit(";
  protected final String TEXT_177 = ");" + NL + "\t\t\t";
  protected final String TEXT_178 = NL + "\t\t\t\tlog.";
  protected final String TEXT_179 = "(\"";
  protected final String TEXT_180 = " - \" + ";
  protected final String TEXT_181 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_182 = NL + "\t    \t\tlog.";
  protected final String TEXT_183 = "(\"";
  protected final String TEXT_184 = "\");" + NL + "\t\t\t";
  protected final String TEXT_185 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_186 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_187 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_188 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_189 = ": pstmt_";
  protected final String TEXT_190 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_191 = " += (countEach_";
  protected final String TEXT_192 = " < 0 ? 0 : ";
  protected final String TEXT_193 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_194 = NL + "\t";
  protected final String TEXT_195 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  ...
  protected final String TEXT_206 = NL + NL + "\tglobalMap.put(\"conn_\" + \"";
  protected final String TEXT_207 = "\",conn_";
  protected final String TEXT_208 = ");";
  protected final String TEXT_209 = NL + "  \tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_210 = "\",conn_";
  protected final String TEXT_211 = ".getMetaData().getUserName());";
  protected final String TEXT_212 = NL + "\tglobalMap.put(\"dbschema_\" + \"";
