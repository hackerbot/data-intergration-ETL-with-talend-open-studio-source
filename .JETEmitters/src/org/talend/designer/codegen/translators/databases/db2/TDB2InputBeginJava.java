...
public class TDB2InputBeginJava
{
  protected static String nl;
  public static synchronized TDB2InputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDB2InputBeginJava result = new TDB2InputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_184 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_185 = " + \":\" + ";
  protected final String TEXT_186 = " + \"/\" + ";
  protected final String TEXT_187 = ";";
  protected final String TEXT_188 = NL + "\t\t\tString url_";
  protected final String TEXT_189 = " = \"jdbc:db2://\" + ";
  ...
  protected final String TEXT_196 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_197 = " = null;";
  protected final String TEXT_198 = NL + "\t\t        conn_";
  protected final String TEXT_199 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_200 = "\");";
  protected final String TEXT_201 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_202 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_203 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_204 = " = dataSources_";
  protected final String TEXT_205 = ".get(";
  protected final String TEXT_206 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_207 = "\", conn_";
  protected final String TEXT_208 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_209 = NL + "\t\t\t\t";
  protected final String TEXT_210 = NL + "\t\t\t\t";
  protected final String TEXT_211 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_212 = " =  conn_";
  protected final String TEXT_213 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_214 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_215 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_216 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_217 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_218 = NL + "                 conn_";
  protected final String TEXT_219 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_220 = NL + "               ";
  protected final String TEXT_221 = " + \"=\" + ";
  protected final String TEXT_222 = " + \";\" +";
  protected final String TEXT_223 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_224 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_225 = ");";
  protected final String TEXT_226 = NL + "\t\t    ";
  protected final String TEXT_227 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_228 = " = ";
  protected final String TEXT_229 = ";" + NL + "\t\t\t";
  protected final String TEXT_230 = NL + "                log.info(\"";
  protected final String TEXT_231 = " - Executing the query: '\"+dbquery_";
  ...
  protected final String TEXT_241 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_242 = " = stmt_";
  protected final String TEXT_243 = ".executeQuery(dbquery_";
  protected final String TEXT_244 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_245 = " = rs_";
  protected final String TEXT_246 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_247 = " = rsmd_";
  protected final String TEXT_248 = ".getColumnCount();" + NL;
  protected final String TEXT_249 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_250 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_251 = ".setDbmsId(\"";
  protected final String TEXT_252 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_253 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_254 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_255 = ".add(\"";
  protected final String TEXT_256 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_257 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_258 = " = ";
  protected final String TEXT_259 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_260 = "; i <= rsmd_";
  protected final String TEXT_261 = ".getColumnCount()-";
  protected final String TEXT_262 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_263 = ".contains(rsmd_";
  protected final String TEXT_264 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_265 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_266 = ".setName(rsmd_";
  protected final String TEXT_267 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_276 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_277 = ".setDbTypeId(rsmd_";
  protected final String TEXT_278 = ".getColumnType(i));";
  protected final String TEXT_279 = NL + "                \tdcm_";
  protected final String TEXT_280 = ".setFormat(";
  protected final String TEXT_281 = ");";
  protected final String TEXT_282 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_283 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_284 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_285 = ".setLength(rsmd_";
  protected final String TEXT_286 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_287 = ".setLength(rsmd_";
  protected final String TEXT_288 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_289 = NL + "\t\t\tdcm_";
  protected final String TEXT_290 = ".setLength(rsmd_";
  protected final String TEXT_291 = ".getPrecision(i));";
  protected final String TEXT_292 = NL + "                \tdcm_";
  protected final String TEXT_293 = ".setPrecision(rsmd_";
  protected final String TEXT_294 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_295 = ".setNullable(rsmd_";
  protected final String TEXT_296 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_297 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_298 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_299 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_300 = ".metadatas.add(dcm_";
  protected final String TEXT_301 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_302 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_303 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_304 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_305 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_306 = NL + "\t\t    ";
  protected final String TEXT_307 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_308 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_309 = NL + "\t\t    while (rs_";
  protected final String TEXT_310 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_311 = "++;" + NL + "\t\t        ";
  protected final String TEXT_312 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_313 = " = ";
  protected final String TEXT_314 = " + dcg_";
  protected final String TEXT_315 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_316 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_317 = " = ";
  protected final String TEXT_318 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_319 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_320 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_321 = " < ";
  protected final String TEXT_322 = "column_index_";
  protected final String TEXT_323 = ") {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_324 = ".";
  protected final String TEXT_325 = " = ";
  protected final String TEXT_326 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  protected final String TEXT_327 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_328 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_329 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_330 = NL + "\t\t                            ";
  protected final String TEXT_331 = ".";
  protected final String TEXT_332 = " = (List)rs_";
  protected final String TEXT_333 = ".getObject(";
  protected final String TEXT_334 = "column_index_";
  protected final String TEXT_335 = ");";
  protected final String TEXT_336 = NL + "\t\t                         ";
  protected final String TEXT_337 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_338 = ".getObject(";
  protected final String TEXT_339 = "column_index_";
  protected final String TEXT_340 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_341 = NL + "                                    ";
  protected final String TEXT_342 = ".";
  protected final String TEXT_343 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_359 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_360 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
