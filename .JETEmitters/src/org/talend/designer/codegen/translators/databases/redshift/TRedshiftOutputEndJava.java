...
public class TRedshiftOutputEndJava {
  protected static String nl;
  public static synchronized TRedshiftOutputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRedshiftOutputEndJava result = new TRedshiftOutputEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_43 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_44 = ".";
  protected final String TEXT_45 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_46 = ".setNull(count";
  protected final String TEXT_47 = ",java.sql.Types.CHAR);" + NL + "\t\t\t\t\t";
  protected final String TEXT_48 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_49 = ".";
  protected final String TEXT_50 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_51 = ".setNull(count";
  protected final String TEXT_52 = ",java.sql.Types.DATE);" + NL + "\t\t\t\t\t";
  protected final String TEXT_53 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_54 = ".";
  protected final String TEXT_55 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_56 = ".setNull(count";
  protected final String TEXT_57 = ",java.sql.Types.ARRAY);" + NL + "\t\t\t\t\t";
  protected final String TEXT_58 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_59 = ".";
  protected final String TEXT_60 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_61 = ".setNull(count";
  protected final String TEXT_62 = ",java.sql.Types.INTEGER);" + NL + "\t\t\t\t\t";
  protected final String TEXT_63 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_64 = ".";
  protected final String TEXT_65 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_66 = ".setNull(count";
  protected final String TEXT_67 = ",java.sql.Types.VARCHAR);" + NL + "\t\t\t\t\t";
  protected final String TEXT_68 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_69 = ".";
  protected final String TEXT_70 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_71 = ".setNull(count";
  protected final String TEXT_72 = ",java.sql.Types.OTHER);" + NL + "\t\t\t\t\t";
  protected final String TEXT_73 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_74 = ".";
  protected final String TEXT_75 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_76 = ".setNull(count";
  protected final String TEXT_77 = ",java.sql.Types.BOOLEAN);" + NL + "\t\t\t\t\t";
  protected final String TEXT_78 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_79 = ".";
  protected final String TEXT_80 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_81 = ".setNull(count";
  protected final String TEXT_82 = ",java.sql.Types.DOUBLE);" + NL + "\t\t\t\t\t";
  protected final String TEXT_83 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_84 = ".";
  protected final String TEXT_85 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_86 = ".setNull(count";
  protected final String TEXT_87 = ",java.sql.Types.FLOAT);" + NL + "\t\t\t\t\t";
  protected final String TEXT_88 = NL + NL + "\t\t\t\t\t}else{" + NL + "" + NL + "\t\t\t\t\t";
  protected final String TEXT_89 = NL + "\t\t\t\t";
  protected final String TEXT_90 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_91 = ".";
  protected final String TEXT_92 = "==null){" + NL + "\t\t\t\t";
  protected final String TEXT_93 = NL + "\t\t\t\t\tif((\"null\").equals(String.valueOf(bufferL";
  protected final String TEXT_94 = ".";
  protected final String TEXT_95 = ").toLowerCase())){" + NL + "\t\t\t\t";
  protected final String TEXT_96 = NL + "\t\t\t\t";
  protected final String TEXT_97 = ".setNull(count";
  protected final String TEXT_98 = ",java.sql.Types.CHAR);" + NL + "" + NL + "\t\t\t\t} else if(bufferL";
  protected final String TEXT_99 = ".";
  protected final String TEXT_100 = " == '\\0') {" + NL + "" + NL + "\t\t\t\t\t";
  protected final String TEXT_101 = ".setString(count";
  protected final String TEXT_102 = ",\"\");" + NL + "" + NL + "\t\t\t\t} else {" + NL + "" + NL + "\t\t\t\t\t";
  protected final String TEXT_103 = ".setString(count";
  protected final String TEXT_104 = ",String.valueOf(bufferL";
  protected final String TEXT_105 = ".";
  protected final String TEXT_106 = "));" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_107 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_108 = ".";
  protected final String TEXT_109 = "!=null){" + NL + "\t\t\t\t\t\t// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t\t\t\t\tdate_";
  protected final String TEXT_110 = " = bufferL";
  protected final String TEXT_111 = ".";
  protected final String TEXT_112 = ".getTime();" + NL + "\t\t\t\t\t\tif (date_";
  protected final String TEXT_113 = " < year1_";
  protected final String TEXT_114 = " || date_";
  protected final String TEXT_115 = " >= year10000_";
  protected final String TEXT_116 = ") {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_117 = ".setString(count";
  protected final String TEXT_118 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_119 = ".setTimestamp(count";
  protected final String TEXT_120 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_121 = "));" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}else{" + NL + "" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_122 = ".setNull(count";
  protected final String TEXT_123 = ",java.sql.Types.DATE);" + NL + "" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_124 = NL + "\t\t\t\t\t";
  protected final String TEXT_125 = ".set";
  protected final String TEXT_126 = "(count";
  protected final String TEXT_127 = ",bufferL";
  protected final String TEXT_128 = ".";
  protected final String TEXT_129 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_130 = NL + NL + "\t\t\t\t\t}" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_131 = NL + NL + NL + "\t    if(rowCount";
  protected final String TEXT_132 = "!=0){" + NL + "" + NL + "\t        StringBuilder extendInsertValue_";
  protected final String TEXT_133 = " = new StringBuilder();" + NL + "\t        for(int i_";
  protected final String TEXT_134 = "=0 ; i_";
  protected final String TEXT_135 = " < rowCount";
  protected final String TEXT_136 = " ; i_";
  protected final String TEXT_137 = "++){";
  protected final String TEXT_138 = NL + "        \t\t\textendInsertValue_";
  protected final String TEXT_139 = ".append(\"(";
  protected final String TEXT_140 = ",\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_141 = ".";
  protected final String TEXT_142 = ")+\")\");";
  protected final String TEXT_143 = NL + "        \t\t\textendInsertValue_";
  protected final String TEXT_144 = ".append(\"(\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_145 = ".";
  protected final String TEXT_146 = ")+\")\");";
  protected final String TEXT_147 = NL + "\t\t\t\textendInsertValue_";
  protected final String TEXT_148 = ".append(\"(";
  protected final String TEXT_149 = ")\");";
  protected final String TEXT_150 = NL + "     \t\t\tif (i_";
  protected final String TEXT_151 = " != rowCount";
  protected final String TEXT_152 = " - 1) extendInsertValue_";
  protected final String TEXT_153 = ".append(\",\");" + NL + "\t        }" + NL;
  protected final String TEXT_154 = NL + "                \tinsert_";
  protected final String TEXT_155 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_156 = " + \"\\\" (";
  protected final String TEXT_157 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_158 = ".";
  protected final String TEXT_159 = ", \"";
  protected final String TEXT_160 = "\")+\") VALUES \" + extendInsertValue_";
  protected final String TEXT_161 = ".toString();";
  protected final String TEXT_162 = NL + "                \tinsert_";
  protected final String TEXT_163 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_164 = " + \"\\\" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_165 = ".";
  protected final String TEXT_166 = ", \"";
  protected final String TEXT_167 = "\")+\") VALUES \" + extendInsertValue_";
  protected final String TEXT_168 = ".toString();";
  protected final String TEXT_169 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_170 = " = \"INSERT INTO \\\"\"+";
  protected final String TEXT_171 = "+\"\\\" (";
  protected final String TEXT_172 = ") VALUES \"+extendInsertValue_";
  protected final String TEXT_173 = ".toString();";
  protected final String TEXT_174 = NL + "        \tpstmt_";
  protected final String TEXT_175 = " =  conn_";
  protected final String TEXT_176 = ".prepareStatement(insert_";
  protected final String TEXT_177 = ");";
  protected final String TEXT_178 = NL + "\t\t\trowCount";
  protected final String TEXT_179 = " = 0;" + NL + "\t        for(BufferLine_";
  protected final String TEXT_180 = " bufferL";
  protected final String TEXT_181 = " : exInsertColValueList";
  protected final String TEXT_182 = "){" + NL + "\t\t\t\tint count";
  protected final String TEXT_183 = " = rowCount";
  protected final String TEXT_184 = " * " + NL + "\t\t\t\t\t(";
  protected final String TEXT_185 = NL + "\t\t\t\t\t\t+ bufferL";
  protected final String TEXT_186 = ".";
  protected final String TEXT_187 = ".getColumnCount()";
  protected final String TEXT_188 = " " + NL + "\t\t\t\t\t)" + NL + "\t\t\t\t+ 1;";
  protected final String TEXT_189 = NL + "\t                    count";
  protected final String TEXT_190 = "++;" + NL + "\t                    ";
  protected final String TEXT_191 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(bufferL";
  protected final String TEXT_192 = ".";
  protected final String TEXT_193 = ", pstmt_";
  protected final String TEXT_194 = ", count";
  protected final String TEXT_195 = "-1, \"";
  protected final String TEXT_196 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_197 = NL + NL + "\t            rowCount";
  protected final String TEXT_198 = "++;" + NL + "\t        }" + NL + "\t        insertedCount_";
  protected final String TEXT_199 = " = insertedCount_";
  protected final String TEXT_200 = " + pstmt_";
  protected final String TEXT_201 = ".executeUpdate();" + NL + "\t    }" + NL + "\t";
  protected final String TEXT_202 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_203 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_204 = ".close();" + NL + "" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_205 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_206 = ".close();" + NL + "" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_207 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_208 = ".close();" + NL + "" + NL + "        }";
  protected final String TEXT_209 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_210 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_211 = ".close();" + NL + "" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_212 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_213 = ".close();" + NL + "" + NL + "        }";
  protected final String TEXT_214 = NL + "                        int[] status_";
  protected final String TEXT_215 = " = null;" + NL + "                        int countSum_";
  protected final String TEXT_216 = " = 0;" + NL + "                        try {" + NL + "                            if(pstmt_";
  protected final String TEXT_217 = "!=null && batchSizeCounter_";
  protected final String TEXT_218 = " > 0 ){";
  protected final String TEXT_219 = NL + "                                status_";
  protected final String TEXT_220 = " = pstmt_";
  protected final String TEXT_221 = ".executeBatch();";
  protected final String TEXT_222 = NL + "                                for(int countEach_";
  protected final String TEXT_223 = ": status_";
  protected final String TEXT_224 = ") {" + NL + "                                    countSum_";
  protected final String TEXT_225 = " += (countEach_";
  protected final String TEXT_226 = " < 0 ? 0 : countEach_";
  protected final String TEXT_227 = ");" + NL + "                                }" + NL + "                            }" + NL + "                        }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_228 = NL + "                                throw(e);";
  protected final String TEXT_229 = NL + "                            for(int countEach_";
  protected final String TEXT_230 = ": e.getUpdateCounts()) {" + NL + "                                countSum_";
  protected final String TEXT_231 = " += (countEach_";
  protected final String TEXT_232 = " < 0 ? 0 : countEach_";
  protected final String TEXT_233 = ");" + NL + "                            }" + NL + "                            System.err.println(e.getMessage());";
  protected final String TEXT_234 = NL + "                        }" + NL + "                        if(pstmt_";
  protected final String TEXT_235 = "!=null && batchSizeCounter_";
  protected final String TEXT_236 = " > 0 ){" + NL + "                            try {" + NL + "                                tmp_batchUpdateCount_";
  protected final String TEXT_237 = " = pstmt_";
  protected final String TEXT_238 = ".getUpdateCount();" + NL + "                            }catch (java.sql.SQLException e){" + NL + "" + NL + "                            }" + NL + "                            tmp_batchUpdateCount_";
  protected final String TEXT_239 = " = tmp_batchUpdateCount_";
  protected final String TEXT_240 = " > countSum_";
  protected final String TEXT_241 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_242 = " : countSum_";
  protected final String TEXT_243 = ";";
  protected final String TEXT_244 = NL + "                                insertedCount_";
  protected final String TEXT_245 = " += tmp_batchUpdateCount_";
  protected final String TEXT_246 = ";";
  protected final String TEXT_247 = NL + "                                updatedCount_";
  protected final String TEXT_248 = " += tmp_batchUpdateCount_";
  protected final String TEXT_249 = ";";
  protected final String TEXT_250 = NL + "                                deletedCount_";
  protected final String TEXT_251 = " += tmp_batchUpdateCount_";
  protected final String TEXT_252 = ";";
  protected final String TEXT_253 = NL + "                        }";
  protected final String TEXT_254 = NL + "                        if(pstmt_";
  protected final String TEXT_255 = " != null) {" + NL + "                            pstmt_";
  protected final String TEXT_256 = ".close();" + NL + "                        }";
  protected final String TEXT_257 = NL;
  protected final String TEXT_258 = NL + "\t\tif (commitCounter_";
  protected final String TEXT_259 = " > 0) {" + NL + "\t\t\t";
  protected final String TEXT_260 = NL + "\t\t\tconn_";
  protected final String TEXT_261 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_262 = NL + "\t\t}";
  protected final String TEXT_263 = NL + "\t\t";
  protected final String TEXT_264 = NL + "    \tconn_";
  protected final String TEXT_265 = " .close();" + NL + "\t\t";
  protected final String TEXT_266 = NL + "    \tresourceMap.put(\"finish_";
  protected final String TEXT_267 = "\", true);" + NL + "    \t";
  protected final String TEXT_268 = NL + "\tnb_line_deleted_";
  protected final String TEXT_269 = "=nb_line_deleted_";
  protected final String TEXT_270 = "+ deletedCount_";
  protected final String TEXT_271 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_272 = "=nb_line_update_";
  protected final String TEXT_273 = " + updatedCount_";
  protected final String TEXT_274 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_275 = "=nb_line_inserted_";
  protected final String TEXT_276 = " + insertedCount_";
  protected final String TEXT_277 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_278 = "=nb_line_rejected_";
  protected final String TEXT_279 = " + rejectedCount_";
  protected final String TEXT_280 = ";" + NL + "\t";
  protected final String TEXT_281 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_282 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_283 = "_NB_LINE\",nb_line_";
  protected final String TEXT_284 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_285 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_286 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_287 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_288 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_289 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_290 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_291 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_292 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_293 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_294 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_295 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_296 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_297 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_298 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_299 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_300 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_301 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_302 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_303 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_304 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_305 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_306 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_307 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_308 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_309 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_310 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  protected final String TEXT_311 = ");" + NL + "        }" + NL + "\t";
  protected final String TEXT_312 = NL + "        globalMap.put(\"";
  protected final String TEXT_313 = "_NB_LINE\",nb_line_";
  protected final String TEXT_314 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_315 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_316 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_317 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_318 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_319 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_320 = ");" + NL + "        globalMap.put(\"";
