...
public class TGreenplumSCDMainJava {
  protected static String nl;
  public static synchronized TGreenplumSCDMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGreenplumSCDMainJava result = new TGreenplumSCDMainJava();
    nl = null;
    return result;
  }
