...
public class TCreateTableMainJava
{
  ...
  protected final String TEXT_188 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }";
  ...
  protected final String TEXT_193 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            while(rsTable_";
  protected final String TEXT_194 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_195 = " = rsTable_";
  protected final String TEXT_196 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  ...
  protected final String TEXT_201 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }     ";
  protected final String TEXT_202 = NL + "            rsTable_";
  protected final String TEXT_203 = ".close();";
  protected final String TEXT_204 = NL + "                if(!whetherExist_";
  protected final String TEXT_205 = ") {" + NL + "                    java.sql.Statement stmt_";
  ...
  protected final String TEXT_209 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_215 = " - Create table '\" + tableName_";
  protected final String TEXT_216 = " + \"' has succeeded.\");";
  protected final String TEXT_217 = NL + "\t\t            ";
  protected final String TEXT_218 = NL + "                }";
  protected final String TEXT_219 = NL + "                if(whetherExist_";
  protected final String TEXT_220 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_224 = " - Droping table '\" + tableName_";
  protected final String TEXT_225 = " + \"'.\");";
  protected final String TEXT_226 = NL + "                    stmtDrop_";
  protected final String TEXT_227 = ".execute(\"";
  protected final String TEXT_228 = "\");";
  protected final String TEXT_229 = NL + "                        log.info(\"";
  protected final String TEXT_230 = " - Drop table '\" + tableName_";
  protected final String TEXT_231 = " + \"' has succeeded.\");";
  protected final String TEXT_232 = NL + "                }" + NL + "                java.sql.Statement stmt_";
  protected final String TEXT_233 = " = conn_";
  protected final String TEXT_234 = ".createStatement();";
  protected final String TEXT_235 = NL + "                    log.info(\"";
  protected final String TEXT_236 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_242 = " - Create table '\" + tableName_";
  protected final String TEXT_243 = " + \"' has succeeded.\");";
  protected final String TEXT_244 = NL + "\t            ";
  protected final String TEXT_245 = NL + "        ";
  protected final String TEXT_246 = NL + "        globalMap.put(\"";
  protected final String TEXT_247 = "_QUERY\", \"";
  protected final String TEXT_248 = "\");        " + NL + "    } catch(java.lang.Exception e) {" + NL + "        globalMap.put(\"";
  protected final String TEXT_249 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "        throw new RuntimeException(\"Creating table failed\", e);" + NL + "    }";
...
class OracleManager extends Manager {
    ...
    public OracleManager(String host, String port, String dbName, String tableName, String dbSchema, String useName, String connectionType, boolean useExistingConnection, String connection, String cid,String jdbcURL,String localServiceName) {
...
class ManagerFactory {
    ...
    public Manager createManager(String dbType, INode node) {
        ...
        if(("ACCESS").equals(dbType)) {
            ...
            manager = new OracleManager(host, port, dbName, tableName, dbSchema, userName, connectionType, useExistingConnection, connection,cid,jdbcURL,localServiceName);
