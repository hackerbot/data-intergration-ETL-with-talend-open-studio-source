...
public class TParAccelOutputMainJava {
  protected static String nl;
  public static synchronized TParAccelOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TParAccelOutputMainJava result = new TParAccelOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_46 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_47 = " = buffersSize_";
  protected final String TEXT_48 = ";";
  protected final String TEXT_49 = NL + "            batchSize_";
  ...
  protected final String TEXT_56 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_57 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_58 = "++;";
  protected final String TEXT_59 = NL + "                       try {" + NL + "                           insertedCount_";
  protected final String TEXT_60 = " = insertedCount_";
  protected final String TEXT_61 = " + pstmt_";
  protected final String TEXT_62 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_63 = "++;";
  protected final String TEXT_64 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  protected final String TEXT_65 = " = true;";
  protected final String TEXT_66 = NL + "                               throw(e);";
  ...
  protected final String TEXT_75 = NL + "                                   rejectedCount_";
  protected final String TEXT_76 = " = rejectedCount_";
  protected final String TEXT_77 = " + 1;";
  protected final String TEXT_78 = NL + "                                   ";
  protected final String TEXT_79 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_88 = NL + "                        query_";
  protected final String TEXT_89 = " = ";
  protected final String TEXT_90 = ";";
  protected final String TEXT_91 = NL + "                    ";
  protected final String TEXT_92 = NL;
  protected final String TEXT_93 = NL + "                       pstmt_";
  protected final String TEXT_94 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_95 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_96 = "++;";
  protected final String TEXT_97 = NL + "                       try {" + NL + "                           updatedCount_";
  protected final String TEXT_98 = " = updatedCount_";
  ...
  protected final String TEXT_113 = NL + "                                   rejectedCount_";
  protected final String TEXT_114 = " = rejectedCount_";
  protected final String TEXT_115 = " + 1;";
  protected final String TEXT_116 = NL + "                                   ";
  protected final String TEXT_117 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_118 = NL + "                                   ";
  protected final String TEXT_119 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_120 = ";";
  protected final String TEXT_121 = NL + "                                   System.err.print(e.getMessage());";
  ...
  protected final String TEXT_131 = ".next()) {" + NL + "                checkCount_";
  ...
  protected final String TEXT_142 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_143 = " = updatedCount_";
  protected final String TEXT_144 = " + pstmtUpdate_";
  protected final String TEXT_145 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_146 = "++;";
  protected final String TEXT_147 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_148 = " = true;";
  ...
  protected final String TEXT_160 = NL + "                            rejectedCount_";
  protected final String TEXT_161 = " = rejectedCount_";
  protected final String TEXT_162 = " + 1;";
  protected final String TEXT_163 = NL + "                            ";
  protected final String TEXT_164 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_165 = NL + "                            ";
  protected final String TEXT_166 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_167 = ";";
  protected final String TEXT_168 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_169 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_170 = NL + "                        ";
  protected final String TEXT_171 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_172 = " = insertedCount_";
  protected final String TEXT_173 = " + pstmtInsert_";
  protected final String TEXT_174 = ".executeUpdate();" + NL + "                     nb_line_";
  protected final String TEXT_175 = "++;";
  protected final String TEXT_176 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_189 = NL + "                            rejectedCount_";
  protected final String TEXT_190 = " = rejectedCount_";
  protected final String TEXT_191 = " + 1;";
  protected final String TEXT_192 = NL + "                            ";
  protected final String TEXT_193 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_194 = NL + "                            ";
  protected final String TEXT_195 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_196 = ";";
  protected final String TEXT_197 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_198 = NL + "                }" + NL + "            }";
  protected final String TEXT_199 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_208 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_209 = "=pstmtUpdate_";
  protected final String TEXT_210 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_211 = " = updatedCount_";
  protected final String TEXT_212 = "+updateFlag_";
  protected final String TEXT_213 = ";" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_219 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_220 = "++;";
  protected final String TEXT_221 = NL + "             }else{" + NL + "             \t   nb_line_";
  protected final String TEXT_222 = "++;" + NL + "             \t   ";
  protected final String TEXT_223 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_224 = " = true;";
  protected final String TEXT_225 = NL + "                        throw(e);";
  protected final String TEXT_226 = NL + "                        nb_line_";
  ...
  protected final String TEXT_236 = NL + "                            rejectedCount_";
  protected final String TEXT_237 = " = rejectedCount_";
  protected final String TEXT_238 = " + 1;";
  protected final String TEXT_239 = NL + "                            ";
  protected final String TEXT_240 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_241 = NL + "                            ";
  protected final String TEXT_242 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_243 = ";";
  protected final String TEXT_244 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_252 = NL + "                           pstmt_";
  protected final String TEXT_253 = ".addBatch();" + NL + "                           batchSizeCounter_";
  protected final String TEXT_254 = "++;" + NL + "                           nb_line_";
  protected final String TEXT_255 = "++;";
  protected final String TEXT_256 = NL + "                       try {" + NL + "                           deletedCount_";
  protected final String TEXT_257 = " = deletedCount_";
  protected final String TEXT_258 = " + pstmt_";
  protected final String TEXT_259 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_260 = "++;";
  protected final String TEXT_261 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  ...
  protected final String TEXT_268 = "Struct();";
  protected final String TEXT_269 = NL + "                                       ";
  protected final String TEXT_270 = ".";
  protected final String TEXT_271 = " = ";
  protected final String TEXT_272 = ".";
  protected final String TEXT_273 = ";";
  protected final String TEXT_274 = NL + "                                   rejectedCount_";
  protected final String TEXT_275 = " = rejectedCount_";
  protected final String TEXT_276 = " + 1;";
  protected final String TEXT_277 = NL + "                                   ";
  protected final String TEXT_278 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_279 = NL + "                                   ";
  protected final String TEXT_280 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_281 = ";";
  protected final String TEXT_282 = NL + "                                   System.err.print(e.getMessage());";
  protected final String TEXT_283 = NL + "                       }";
  protected final String TEXT_284 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_295 = NL + "                if ((batchSize_";
  protected final String TEXT_296 = " > 0) && (batchSize_";
  protected final String TEXT_297 = " <= batchSizeCounter_";
  protected final String TEXT_298 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_299 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_300 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_301 = " = 0;";
  protected final String TEXT_302 = NL + "                        status_";
  protected final String TEXT_303 = " = pstmt_";
  protected final String TEXT_304 = ".executeBatch();";
  protected final String TEXT_305 = NL + "                        for(int countEach_";
  protected final String TEXT_306 = ": status_";
  protected final String TEXT_307 = ") {" + NL + "                            countSum_";
  protected final String TEXT_308 = " += (countEach_";
  protected final String TEXT_309 = " < 0 ? 0 : countEach_";
  protected final String TEXT_310 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_311 = NL + "                            throw(e);";
  protected final String TEXT_312 = NL + "                        for(int countEach_";
  protected final String TEXT_313 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_314 = " += (countEach_";
  protected final String TEXT_315 = " < 0 ? 0 : countEach_";
  protected final String TEXT_316 = ");" + NL + "                        }";
  protected final String TEXT_317 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_318 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_319 = " = pstmt_";
  protected final String TEXT_320 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_321 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_322 = " = tmp_batchUpdateCount_";
  protected final String TEXT_323 = " > countSum_";
  protected final String TEXT_324 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_325 = " : countSum_";
  protected final String TEXT_326 = ";";
  protected final String TEXT_327 = NL + "                        insertedCount_";
  protected final String TEXT_328 = " += tmp_batchUpdateCount_";
  protected final String TEXT_329 = ";";
  protected final String TEXT_330 = NL + "                        updatedCount_";
  protected final String TEXT_331 = " += tmp_batchUpdateCount_";
  protected final String TEXT_332 = ";";
  protected final String TEXT_333 = NL + "                        deletedCount_";
  protected final String TEXT_334 = " += tmp_batchUpdateCount_";
  protected final String TEXT_335 = ";";
  protected final String TEXT_336 = NL + "               }";
  protected final String TEXT_337 = NL + "                commitCounter_";
  protected final String TEXT_338 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_339 = "<=commitCounter_";
  protected final String TEXT_340 = ") {";
  protected final String TEXT_341 = NL + "                                   if(batchSize_";
  protected final String TEXT_342 = " > 0){";
  protected final String TEXT_343 = NL + "                                         conn_";
  protected final String TEXT_344 = ".commit();";
  protected final String TEXT_345 = NL + "                                         commitCounter_";
  protected final String TEXT_346 = "=0;" + NL + "                                   }";
  protected final String TEXT_347 = NL + "                                       conn_";
  protected final String TEXT_348 = ".commit();";
  protected final String TEXT_349 = NL + "                                       commitCounter_";
