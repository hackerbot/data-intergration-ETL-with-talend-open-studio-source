...
public class TFirebirdOutputBeginJava {
  ...
  protected final String TEXT_75 = NL + "    String url_";
  protected final String TEXT_76 = " =\"jdbc:firebirdsql:\" + ";
  ...
  protected final String TEXT_93 = ";" + NL + "" + NL + "    java.lang.Class.forName(\"";
  ...
  protected final String TEXT_108 = NL + "            java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_121 = ".commit();";
  protected final String TEXT_122 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_123 = " = conn_";
  protected final String TEXT_124 = ".createStatement();";
  ...
  protected final String TEXT_129 = ".commit();";
  protected final String TEXT_130 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_131 = " = conn_";
  protected final String TEXT_132 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_133 = " = dbMetaData_";
  protected final String TEXT_134 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_135 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_136 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_137 = " = rsTable_";
  protected final String TEXT_138 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_139 = ".equalsIgnoreCase(";
  protected final String TEXT_140 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_141 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  protected final String TEXT_142 = NL + "                if(!whetherExist_";
  protected final String TEXT_143 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_157 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_164 = ".commit();";
  protected final String TEXT_165 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_166 = " = conn_";
  protected final String TEXT_167 = ".createStatement();";
  protected final String TEXT_168 = NL + "            deletedCount_";
  protected final String TEXT_169 = " = deletedCount_";
  protected final String TEXT_170 = " + stmtClear_";
  ...
  protected final String TEXT_181 = NL + "\t    String update_";
  protected final String TEXT_182 = " = \"UPDATE \" + ";
  protected final String TEXT_183 = " + \" SET ";
  protected final String TEXT_184 = " WHERE ";
  protected final String TEXT_185 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_191 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  ...
  protected final String TEXT_197 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_198 = " = conn_";
  protected final String TEXT_199 = ".prepareStatement(insert_";
  protected final String TEXT_200 = ");" + NL + "\t    String update_";
  protected final String TEXT_201 = " = \"UPDATE \" + ";
  protected final String TEXT_202 = " + \" SET ";
  protected final String TEXT_203 = " WHERE ";
  protected final String TEXT_204 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_205 = " = conn_";
  protected final String TEXT_206 = ".prepareStatement(update_";
  protected final String TEXT_207 = ");" + NL + "\t    ";
  protected final String TEXT_208 = NL + "\t    String update_";
  protected final String TEXT_209 = " = \"UPDATE \" + ";
  protected final String TEXT_210 = " + \" SET ";
  protected final String TEXT_211 = " WHERE ";
  protected final String TEXT_212 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_213 = " = conn_";
  protected final String TEXT_214 = ".prepareStatement(update_";
  protected final String TEXT_215 = ");" + NL + "\t    String insert_";
  protected final String TEXT_216 = " = \"INSERT INTO \" + ";
  protected final String TEXT_217 = " + \" (";
  protected final String TEXT_218 = ") VALUES (";
  protected final String TEXT_219 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_220 = " = conn_";
  protected final String TEXT_221 = ".prepareStatement(insert_";
  protected final String TEXT_222 = ");" + NL + "\t    ";
  protected final String TEXT_223 = NL + "\t    String delete_";
  protected final String TEXT_224 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_225 = " + \" WHERE ";
  protected final String TEXT_226 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_227 = " = conn_";
  protected final String TEXT_228 = ".prepareStatement(delete_";
  protected final String TEXT_229 = ");" + NL + "\t    ";
  protected final String TEXT_230 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_231 = " = null;" + NL + "       \t";
  protected final String TEXT_232 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_233 = " = insert_";
  protected final String TEXT_234 = ".split(\"\\\\?\");";
  protected final String TEXT_235 = NL + "\t\t\tupdate_";
  protected final String TEXT_236 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_237 = " = update_";
  protected final String TEXT_238 = ".split(\"\\\\?\");";
  protected final String TEXT_239 = NL + "\t\t\tupdate_";
  protected final String TEXT_240 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_241 = " = update_";
  protected final String TEXT_242 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_243 = " = insert_";
  protected final String TEXT_244 = ".split(\"\\\\?\");";
  protected final String TEXT_245 = NL + "\t\t\tdelete_";
  protected final String TEXT_246 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_247 = " = delete_";
  protected final String TEXT_248 = ".split(\"\\\\?\");";
  protected final String TEXT_249 = NL + "\t\t\treplace_";
  protected final String TEXT_250 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_251 = " = replace_";
  protected final String TEXT_252 = ".split(\"\\\\?\");";
  protected final String TEXT_253 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_254 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_255 = " = insertIgnore_";
  protected final String TEXT_256 = ".split(\"\\\\?\");";
  protected final String TEXT_257 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_258 = " = insert_";
  protected final String TEXT_259 = ".split(\"\\\\?\");";
...
if(columnList != null && columnList.size() > 0) {
    ...
    dbLog.table().createDone(dbLog.var("tableName"));
            ...
            if(("true").equals(useExistingConn) || (!("true").equals(useExistingConn) && !("").equals(commitEvery) && !("0").equals(commitEvery))) {
