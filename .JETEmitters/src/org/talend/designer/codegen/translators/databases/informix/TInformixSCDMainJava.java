...
public class TInformixSCDMainJava {
  protected static String nl;
  public static synchronized TInformixSCDMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInformixSCDMainJava result = new TInformixSCDMainJava();
    nl = null;
    return result;
  }
