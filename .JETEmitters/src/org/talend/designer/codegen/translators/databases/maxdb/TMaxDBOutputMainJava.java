...
public class TMaxDBOutputMainJava {
  protected static String nl;
  public static synchronized TMaxDBOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMaxDBOutputMainJava result = new TMaxDBOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_54 = NL + "                        query_";
  protected final String TEXT_55 = " = ";
  protected final String TEXT_56 = ";";
  protected final String TEXT_57 = NL + "                globalMap.put(\"";
  protected final String TEXT_58 = "_QUERY\", query_";
  protected final String TEXT_59 = ".toString().trim());";
  protected final String TEXT_60 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_61 = " = insertedCount_";
  protected final String TEXT_62 = " + pstmt_";
  protected final String TEXT_63 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_64 = "++;";
  protected final String TEXT_65 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_73 = NL + "                        nb_line_rejected_";
  protected final String TEXT_74 = "++;";
  protected final String TEXT_75 = NL + "                        ";
  protected final String TEXT_76 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_77 = NL + "                        ";
  protected final String TEXT_78 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_96 = "_QUERY\", query_";
  protected final String TEXT_97 = ".toString().trim());";
  protected final String TEXT_98 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_99 = " = updatedCount_";
  protected final String TEXT_100 = " + pstmt_";
  protected final String TEXT_101 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_102 = "++;";
  protected final String TEXT_103 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_114 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_115 = NL + "                        ";
  protected final String TEXT_116 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_117 = ";";
  protected final String TEXT_118 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_119 = NL + "            }";
  protected final String TEXT_120 = NL + "\t\t\t\t\t";
  protected final String TEXT_121 = NL + "                    \t";
  protected final String TEXT_122 = NL + "                    ";
  protected final String TEXT_123 = NL + "                    ";
  protected final String TEXT_124 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_125 = " = pstmt_";
  protected final String TEXT_126 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_127 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_128 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_129 = " = rs_";
  protected final String TEXT_130 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_142 = NL + "                            query_";
  protected final String TEXT_143 = " = ";
  protected final String TEXT_144 = ";";
  protected final String TEXT_145 = NL + "                    globalMap.put(\"";
  protected final String TEXT_146 = "_QUERY\", query_";
  protected final String TEXT_147 = ".toString().trim());";
  protected final String TEXT_148 = NL + "                try {" + NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_149 = " = updatedCount_";
  protected final String TEXT_150 = " + pstmtUpdate_";
  protected final String TEXT_151 = ".executeUpdate();" + NL + "        \t\t\tnb_line_";
  protected final String TEXT_152 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_153 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_163 = NL + "                            nb_line_rejected_";
  ...
  protected final String TEXT_177 = "_QUERY\", query_";
  protected final String TEXT_178 = ".toString().trim());";
  protected final String TEXT_179 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_180 = " = insertedCount_";
  protected final String TEXT_181 = " + pstmtInsert_";
  protected final String TEXT_182 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_183 = "++;" + NL + "\t\t\t\t\t";
  protected final String TEXT_184 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_185 = " = true;";
  protected final String TEXT_186 = NL + "                        throw(e);";
  ...
  protected final String TEXT_203 = NL + "    \t    int updateFlag_";
  protected final String TEXT_204 = " = 0;" + NL + "    \t    ";
  protected final String TEXT_205 = NL + "                    ";
  protected final String TEXT_206 = NL + "                        query_";
  ...
  protected final String TEXT_219 = "_QUERY\", query_";
  protected final String TEXT_220 = ".toString().trim());";
  protected final String TEXT_221 = "\t" + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_222 = " = pstmtUpdate_";
  protected final String TEXT_223 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_224 = " = updatedCount_";
  protected final String TEXT_225 = " + updateFlag_";
  protected final String TEXT_226 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_234 = NL + "                        nb_line_rejected_";
  protected final String TEXT_235 = "++;";
  protected final String TEXT_236 = NL + "                        ";
  protected final String TEXT_237 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_238 = NL + "                        ";
  protected final String TEXT_239 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_240 = ";";
  protected final String TEXT_241 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_242 = NL + "            }" + NL + "            " + NL + "            if(updateFlag_";
  protected final String TEXT_243 = " == 0) {" + NL + "            \t";
  protected final String TEXT_244 = NL + "\t\t\t\tquery_";
  protected final String TEXT_245 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_246 = NL + "                        ";
  protected final String TEXT_247 = NL + "                            query_";
  protected final String TEXT_248 = " = ";
  protected final String TEXT_249 = ";";
  protected final String TEXT_250 = NL + "                    globalMap.put(\"";
  protected final String TEXT_251 = "_QUERY\", query_";
  protected final String TEXT_252 = ".toString().trim());";
  protected final String TEXT_253 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_254 = " = insertedCount_";
  protected final String TEXT_255 = " + pstmtInsert_";
  ...
  protected final String TEXT_268 = NL + "                            nb_line_rejected_";
  protected final String TEXT_269 = "++;";
  protected final String TEXT_270 = NL + "                            ";
  protected final String TEXT_271 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_272 = NL + "                            ";
  protected final String TEXT_273 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_274 = ";";
  protected final String TEXT_275 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_276 = NL + "                }" + NL + "            }else{" + NL + "                 nb_line_";
  protected final String TEXT_277 = "++;" + NL + "\t\t\t\t ";
  protected final String TEXT_278 = NL + "            }";
  protected final String TEXT_279 = NL + "\t\t\t\t\t";
  protected final String TEXT_280 = NL + "                    \t";
  protected final String TEXT_281 = NL + "\t                        query_";
  protected final String TEXT_282 = " = ";
  protected final String TEXT_283 = ";" + NL + "\t                        ";
  protected final String TEXT_284 = NL + "                    ";
  protected final String TEXT_285 = NL + "                        query_";
  protected final String TEXT_286 = " = ";
  protected final String TEXT_287 = ";";
  protected final String TEXT_288 = NL + "                globalMap.put(\"";
  protected final String TEXT_289 = "_QUERY\", query_";
  protected final String TEXT_290 = ".toString().trim());";
  protected final String TEXT_291 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_292 = " = deletedCount_";
  protected final String TEXT_293 = " + pstmt_";
  protected final String TEXT_294 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_295 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_296 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_297 = " = true;";
  protected final String TEXT_298 = NL + "                    throw(e);";
  ...
  protected final String TEXT_306 = NL + "                        nb_line_rejected_";
  protected final String TEXT_307 = "++;";
  protected final String TEXT_308 = NL + "                        ";
  protected final String TEXT_309 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_310 = NL + "                        ";
  protected final String TEXT_311 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_312 = ";";
  protected final String TEXT_313 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_314 = NL + "            }           " + NL + "    \t";
  protected final String TEXT_315 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_323 = NL + "            commitCounter_";
  protected final String TEXT_324 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_325 = " <= commitCounter_";
  protected final String TEXT_326 = ") {" + NL + "            " + NL + "            \t";
  protected final String TEXT_327 = NL + "            \tconn_";
  protected final String TEXT_328 = ".commit();" + NL + "            \t";
  protected final String TEXT_329 = NL + "            \t" + NL + "            \tcommitCounter_";
  protected final String TEXT_330 = "=0;" + NL + "            " + NL + "            }\t" + NL + "    \t";
