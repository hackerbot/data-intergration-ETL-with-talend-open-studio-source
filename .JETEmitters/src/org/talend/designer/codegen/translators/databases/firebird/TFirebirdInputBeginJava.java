...
public class TFirebirdInputBeginJava
{
  ...
  protected final String TEXT_184 = " =\"jdbc:firebirdsql:\" + ";
  ...
  protected final String TEXT_191 = NL + "\t\t    int nb_line_";
  protected final String TEXT_192 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_193 = " = null;";
  protected final String TEXT_194 = NL + "\t\t        conn_";
  protected final String TEXT_195 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_196 = "\");";
  protected final String TEXT_197 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_198 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_199 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_200 = " = dataSources_";
  protected final String TEXT_201 = ".get(";
  protected final String TEXT_202 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_203 = "\", conn_";
  protected final String TEXT_204 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_205 = NL + "\t\t\t\t";
  protected final String TEXT_206 = NL + "\t\t\t\t";
  protected final String TEXT_207 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_208 = " =  conn_";
  protected final String TEXT_209 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_210 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_211 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_212 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_213 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_214 = NL + "                 conn_";
  protected final String TEXT_215 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_216 = NL + "               ";
  protected final String TEXT_217 = " + \"=\" + ";
  protected final String TEXT_218 = " + \";\" +";
  protected final String TEXT_219 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_220 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_221 = ");";
  protected final String TEXT_222 = NL + "\t\t    ";
  protected final String TEXT_223 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_224 = " = ";
  protected final String TEXT_225 = ";" + NL + "\t\t\t";
  protected final String TEXT_226 = NL + "                log.info(\"";
  protected final String TEXT_227 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_228 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_229 = NL;
  protected final String TEXT_230 = NL + "                       globalMap.put(\"";
  protected final String TEXT_231 = "_QUERY\",dbquery_";
  protected final String TEXT_232 = ");";
  protected final String TEXT_233 = NL + "                       globalMap.put(\"";
  protected final String TEXT_234 = "_QUERY\",dbquery_";
  protected final String TEXT_235 = ");";
  protected final String TEXT_236 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_237 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_238 = " = stmt_";
  protected final String TEXT_239 = ".executeQuery(dbquery_";
  protected final String TEXT_240 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_241 = " = rs_";
  protected final String TEXT_242 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_243 = " = rsmd_";
  protected final String TEXT_244 = ".getColumnCount();" + NL;
  protected final String TEXT_245 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_246 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_247 = ".setDbmsId(\"";
  protected final String TEXT_248 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_249 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_250 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_251 = ".add(\"";
  protected final String TEXT_252 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_253 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_254 = " = ";
  protected final String TEXT_255 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_256 = "; i <= rsmd_";
  protected final String TEXT_257 = ".getColumnCount()-";
  protected final String TEXT_258 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_259 = ".contains(rsmd_";
  protected final String TEXT_260 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_261 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_262 = ".setName(rsmd_";
  protected final String TEXT_263 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_264 = ".setDbName(rsmd_";
  protected final String TEXT_265 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_266 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_267 = "\", rsmd_";
  protected final String TEXT_268 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_269 = ".getPrecision(i), rsmd_";
  protected final String TEXT_270 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_271 = ".setDbType(rsmd_";
  protected final String TEXT_272 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_273 = ".setDbTypeId(rsmd_";
  protected final String TEXT_274 = ".getColumnType(i));";
  protected final String TEXT_275 = NL + "                \tdcm_";
  protected final String TEXT_276 = ".setFormat(";
  protected final String TEXT_277 = ");";
  protected final String TEXT_278 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_279 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_280 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_281 = ".setLength(rsmd_";
  protected final String TEXT_282 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_283 = ".setLength(rsmd_";
  protected final String TEXT_284 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_285 = NL + "\t\t\tdcm_";
  protected final String TEXT_286 = ".setLength(rsmd_";
  protected final String TEXT_287 = ".getPrecision(i));";
  protected final String TEXT_288 = NL + "                \tdcm_";
  protected final String TEXT_289 = ".setPrecision(rsmd_";
  protected final String TEXT_290 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_291 = ".setNullable(rsmd_";
  protected final String TEXT_292 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_293 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_294 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_295 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_296 = ".metadatas.add(dcm_";
  protected final String TEXT_297 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_298 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_299 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_300 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_301 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_302 = NL + "\t\t    ";
  protected final String TEXT_303 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_304 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_305 = NL + "\t\t    while (rs_";
  protected final String TEXT_306 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_307 = "++;" + NL + "\t\t        ";
  protected final String TEXT_308 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_309 = " = ";
  protected final String TEXT_310 = " + dcg_";
  protected final String TEXT_311 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_312 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_313 = " = ";
  protected final String TEXT_314 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_315 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_316 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_328 = " = (List)rs_";
  protected final String TEXT_329 = ".getObject(";
  protected final String TEXT_330 = "column_index_";
  protected final String TEXT_331 = ");";
  protected final String TEXT_332 = NL + "\t\t                         ";
  protected final String TEXT_333 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_334 = ".getObject(";
  protected final String TEXT_335 = "column_index_";
  protected final String TEXT_336 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_337 = NL + "                                    ";
  protected final String TEXT_338 = ".";
  protected final String TEXT_339 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_348 = ".setEPSG(";
  protected final String TEXT_349 = ");" + NL + "                                        }";
  protected final String TEXT_350 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_351 = NL + "                                  ";
  protected final String TEXT_352 = ".";
  protected final String TEXT_353 = "=dcg_";
  protected final String TEXT_354 = ";";
  protected final String TEXT_355 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_356 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_357 = " = ";
  protected final String TEXT_358 = "; i_";
  protected final String TEXT_359 = "  <= rsmd_";
  protected final String TEXT_360 = ".getColumnCount(); i_";
  protected final String TEXT_361 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_362 = ".getColumnTypeName(i_";
  protected final String TEXT_363 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_364 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_365 = ".getClob(i_";
  protected final String TEXT_366 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_367 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_368 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_369 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_370 = ".add(tNTextImpl_";
  protected final String TEXT_371 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_372 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_373 = ".";
  protected final String TEXT_374 = ", rs_";
  protected final String TEXT_375 = ", fixedColumnCount_";
  protected final String TEXT_376 = ",list_";
  ...
  protected final String TEXT_385 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_386 = ".";
  protected final String TEXT_387 = ", rs_";
  protected final String TEXT_388 = ", fixedColumnCount_";
  protected final String TEXT_389 = ",";
  protected final String TEXT_390 = ");";
  protected final String TEXT_391 = NL + "                                  Object geom = rs_";
  protected final String TEXT_392 = ".getObject(";
  protected final String TEXT_393 = "column_index_";
  protected final String TEXT_394 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_395 = ".";
  protected final String TEXT_396 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
