...
public class TSybaseOutputMainJava {
  protected static String nl;
  public static synchronized TSybaseOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSybaseOutputMainJava result = new TSybaseOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_509 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_510 = " = conn_";
  protected final String TEXT_511 = ".createStatement();" + NL + "        stmt_";
  protected final String TEXT_512 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_513 = " +\" ON\");";
  protected final String TEXT_514 = NL + "        }";
  protected final String TEXT_515 = NL + "                commitEvery_";
  protected final String TEXT_516 = " = buffersSize_";
  protected final String TEXT_517 = ";";
  protected final String TEXT_518 = NL + "                batchSize_";
  protected final String TEXT_519 = " = buffersSize_";
  protected final String TEXT_520 = ";";
  protected final String TEXT_521 = NL + "        whetherReject_";
  protected final String TEXT_522 = " = false;";
  ...
  protected final String TEXT_531 = ",insertSQLSplits_";
  protected final String TEXT_532 = ");";
  protected final String TEXT_533 = NL + "                    DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_534 = ".";
  protected final String TEXT_535 = ", pstmt_";
  protected final String TEXT_536 = ", ";
  protected final String TEXT_537 = ", \"";
  protected final String TEXT_538 = "\");";
  protected final String TEXT_539 = NL + "                globalMap.put(\"";
  protected final String TEXT_540 = "_QUERY\", query_";
  protected final String TEXT_541 = ".toString().trim());";
  protected final String TEXT_542 = NL + "                pstmt_";
  protected final String TEXT_543 = ".addBatch();" + NL + "                nb_line_";
  protected final String TEXT_544 = "++;";
  protected final String TEXT_545 = NL + "              batchSizeCounter_";
  protected final String TEXT_546 = "++;";
  protected final String TEXT_547 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_548 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_549 = " = insertedCount_";
  protected final String TEXT_550 = " + pstmt_";
  protected final String TEXT_551 = ".executeUpdate();";
  protected final String TEXT_552 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_553 = " = true;";
  protected final String TEXT_554 = NL + "                    throw(e);";
  ...
  protected final String TEXT_563 = NL + "                        rejectedCount_";
  protected final String TEXT_564 = " = rejectedCount_";
  protected final String TEXT_565 = " + 1;";
  protected final String TEXT_566 = NL + "                        ";
  protected final String TEXT_567 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_568 = NL + "                        ";
  protected final String TEXT_569 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_570 = ";";
  protected final String TEXT_571 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_572 = NL + "            }";
  protected final String TEXT_573 = NL + "                    ";
  protected final String TEXT_574 = NL + "                        query_";
  protected final String TEXT_575 = " = ";
  protected final String TEXT_576 = ";";
  protected final String TEXT_577 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_578 = ",";
  protected final String TEXT_579 = ".";
  protected final String TEXT_580 = ", ";
  protected final String TEXT_581 = ",updateSQLSplits_";
  protected final String TEXT_582 = ");";
  protected final String TEXT_583 = NL + "                    int count_";
  protected final String TEXT_584 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_613 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_614 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_615 = " = updatedCount_";
  protected final String TEXT_616 = " + pstmt_";
  protected final String TEXT_617 = ".executeUpdate();";
  protected final String TEXT_618 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_637 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_638 = NL + "            }";
  protected final String TEXT_639 = NL + "                        ";
  protected final String TEXT_640 = NL + "                    ";
  protected final String TEXT_641 = NL + NL + "            java.sql.ResultSet rs_";
  ...
  protected final String TEXT_648 = " > 0) {";
  ...
  protected final String TEXT_675 = NL + "                            query_";
  ...
  protected final String TEXT_684 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_685 = " = updatedCount_";
  protected final String TEXT_686 = " + pstmtUpdate_";
  protected final String TEXT_687 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_688 = "++;";
  protected final String TEXT_689 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_690 = " = true;";
  protected final String TEXT_691 = NL + "                        throw(e);";
  protected final String TEXT_692 = NL + "                        nb_line_";
  ...
  protected final String TEXT_711 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_720 = ",insertSQLSplits_";
  protected final String TEXT_721 = ");";
  protected final String TEXT_722 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_723 = ".";
  protected final String TEXT_724 = ", pstmtInsert_";
  protected final String TEXT_725 = ", ";
  protected final String TEXT_726 = ", \"";
  protected final String TEXT_727 = "\");";
  protected final String TEXT_728 = NL + "                    globalMap.put(\"";
  protected final String TEXT_729 = "_QUERY\", query_";
  protected final String TEXT_730 = ".toString().trim());";
  protected final String TEXT_731 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_732 = " = insertedCount_";
  protected final String TEXT_733 = " + pstmtInsert_";
  protected final String TEXT_734 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_735 = "++;";
  protected final String TEXT_736 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_737 = " = true;";
  protected final String TEXT_738 = NL + "                        throw(e);";
  protected final String TEXT_739 = NL + "                        nb_line_";
  protected final String TEXT_740 = "++;";
  protected final String TEXT_741 = NL + "                            ";
  protected final String TEXT_742 = " = new ";
  protected final String TEXT_743 = "Struct();";
  protected final String TEXT_744 = NL + "                                ";
  protected final String TEXT_745 = ".";
  protected final String TEXT_746 = " = ";
  protected final String TEXT_747 = ".";
  protected final String TEXT_748 = ";";
  protected final String TEXT_749 = NL + "                            rejectedCount_";
  protected final String TEXT_750 = " = rejectedCount_";
  protected final String TEXT_751 = " + 1;";
  protected final String TEXT_752 = NL + "                            ";
  protected final String TEXT_753 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_754 = NL + "                            ";
  protected final String TEXT_755 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_756 = ";";
  protected final String TEXT_757 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_758 = NL + "                }" + NL + "            }";
  protected final String TEXT_759 = NL + "            int updateFlag_";
  protected final String TEXT_760 = " = 0;";
  ...
  protected final String TEXT_771 = NL + NL + "                    int count_";
  protected final String TEXT_772 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_773 = ".";
  protected final String TEXT_774 = ", pstmtUpdate_";
  ...
  protected final String TEXT_796 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_797 = "=pstmtUpdate_";
  protected final String TEXT_798 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_799 = " = updatedCount_";
  protected final String TEXT_800 = "+updateFlag_";
  protected final String TEXT_801 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_802 = " == 0) {";
  protected final String TEXT_803 = NL + "                query_";
  protected final String TEXT_804 = " = new StringBuffer(\"\");";
  protected final String TEXT_805 = NL + "                        ";
  protected final String TEXT_806 = NL + "                            query_";
  protected final String TEXT_807 = " = ";
  protected final String TEXT_808 = ";";
  protected final String TEXT_809 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_810 = ",";
  protected final String TEXT_811 = ".";
  protected final String TEXT_812 = ", ";
  protected final String TEXT_813 = ",insertSQLSplits_";
  protected final String TEXT_814 = ");";
  protected final String TEXT_815 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_816 = ".";
  protected final String TEXT_817 = ", pstmtInsert_";
  protected final String TEXT_818 = ", ";
  protected final String TEXT_819 = ", \"";
  protected final String TEXT_820 = "\");";
  protected final String TEXT_821 = NL + "                    globalMap.put(\"";
  protected final String TEXT_822 = "_QUERY\", query_";
  protected final String TEXT_823 = ".toString().trim());";
  protected final String TEXT_824 = NL + "                    insertedCount_";
  protected final String TEXT_825 = " = insertedCount_";
  protected final String TEXT_826 = " + pstmtInsert_";
  protected final String TEXT_827 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_828 = "++;";
  protected final String TEXT_829 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_830 = "++;";
  protected final String TEXT_831 = NL + "                }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_862 = NL + "                globalMap.put(\"";
  protected final String TEXT_863 = "_QUERY\", query_";
  protected final String TEXT_864 = ".toString().trim());";
  protected final String TEXT_865 = NL + "                    pstmt_";
  protected final String TEXT_866 = ".addBatch();" + NL + "                    nb_line_";
  protected final String TEXT_867 = "++;";
  protected final String TEXT_868 = NL + "                    batchSizeCounter_";
  protected final String TEXT_869 = "++;";
  protected final String TEXT_870 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_871 = " = deletedCount_";
  protected final String TEXT_872 = " + pstmt_";
  protected final String TEXT_873 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_874 = "++;";
  protected final String TEXT_875 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_876 = " = true;";
  protected final String TEXT_877 = NL + "                    throw(e);";
  protected final String TEXT_878 = NL + "                    nb_line_";
  protected final String TEXT_879 = "++;";
  protected final String TEXT_880 = NL + "                        ";
  protected final String TEXT_881 = " = new ";
  protected final String TEXT_882 = "Struct();";
  protected final String TEXT_883 = NL + "                            ";
  protected final String TEXT_884 = ".";
  protected final String TEXT_885 = " = ";
  protected final String TEXT_886 = ".";
  protected final String TEXT_887 = ";";
  protected final String TEXT_888 = NL + "                        rejectedCount_";
  protected final String TEXT_889 = " = rejectedCount_";
  protected final String TEXT_890 = " + 1;";
  protected final String TEXT_891 = NL + "                        ";
  protected final String TEXT_892 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_893 = NL + "                        ";
  protected final String TEXT_894 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_895 = ";";
  protected final String TEXT_896 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_897 = NL + "            }";
  protected final String TEXT_898 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_909 = NL + "                if ((batchSize_";
  protected final String TEXT_910 = " > 0) && (batchSize_";
  protected final String TEXT_911 = " <= batchSizeCounter_";
  protected final String TEXT_912 = ")) {" + NL + "                try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_913 = " = 0;" + NL + "                        int countSum_";
  protected final String TEXT_914 = " = 0;";
  protected final String TEXT_915 = NL + "                        for(int countEach_";
  protected final String TEXT_916 = ": pstmt_";
  protected final String TEXT_917 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_918 = " += (countEach_";
  protected final String TEXT_919 = " < 0 ? 0 : countEach_";
  protected final String TEXT_920 = ");" + NL + "                        }";
  protected final String TEXT_921 = NL + "                            insertedCount_";
  protected final String TEXT_922 = " += countSum_";
  protected final String TEXT_923 = ";";
  protected final String TEXT_924 = NL + "                            updatedCount_";
  protected final String TEXT_925 = " += countSum_";
  protected final String TEXT_926 = ";";
  protected final String TEXT_927 = NL + "                            deletedCount_";
  protected final String TEXT_928 = " += countSum_";
  protected final String TEXT_929 = ";";
  protected final String TEXT_930 = NL + "                batchSizeCounter_";
  protected final String TEXT_931 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_932 = NL + "                        throw(e);";
  protected final String TEXT_933 = NL + "                    int countSum_";
  protected final String TEXT_934 = " = 0;" + NL + "                    for(int countEach_";
  protected final String TEXT_935 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  protected final String TEXT_936 = " += (countEach_";
  protected final String TEXT_937 = " < 0 ? 0 : countEach_";
  protected final String TEXT_938 = ");" + NL + "                    }";
  protected final String TEXT_939 = NL + "                        insertedCount_";
  protected final String TEXT_940 = " += countSum_";
  protected final String TEXT_941 = ";";
  protected final String TEXT_942 = NL + "                        updatedCount_";
  protected final String TEXT_943 = " += countSum_";
  protected final String TEXT_944 = ";";
  protected final String TEXT_945 = NL + "                        deletedCount_";
  protected final String TEXT_946 = " += countSum_";
  protected final String TEXT_947 = ";";
  protected final String TEXT_948 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_949 = NL + "                }" + NL + "                }";
  protected final String TEXT_950 = NL + "                commitCounter_";
  protected final String TEXT_951 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_952 = " <= commitCounter_";
  protected final String TEXT_953 = ") {";
  protected final String TEXT_954 = NL + "                try {" + NL + "                        if ( batchSizeCounter_";
  protected final String TEXT_955 = " > 0 ) {" + NL + "                        int countSum_";
  protected final String TEXT_956 = " = 0;";
  protected final String TEXT_957 = NL + "                        for(int countEach_";
  protected final String TEXT_958 = ": pstmt_";
  protected final String TEXT_959 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_960 = " += (countEach_";
  protected final String TEXT_961 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_966 = NL + "                            updatedCount_";
  protected final String TEXT_967 = " += countSum_";
  protected final String TEXT_968 = ";";
  protected final String TEXT_969 = NL + "                            deletedCount_";
  protected final String TEXT_970 = " += countSum_";
  protected final String TEXT_971 = ";";
  protected final String TEXT_972 = NL + "                        batchSizeCounter_";
  protected final String TEXT_973 = " = 0;" + NL + "                        }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_974 = NL + "                        throw(e);";
  protected final String TEXT_975 = NL + "                        int countSum_";
  protected final String TEXT_976 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_977 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  ...
  protected final String TEXT_984 = NL + "                            updatedCount_";
  protected final String TEXT_985 = " += countSum_";
  protected final String TEXT_986 = ";";
  protected final String TEXT_987 = NL + "                            deletedCount_";
  protected final String TEXT_988 = " += countSum_";
  protected final String TEXT_989 = ";";
  protected final String TEXT_990 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_991 = NL + "                }";
  protected final String TEXT_992 = NL + "                    conn_";
  protected final String TEXT_993 = ".commit();";
  protected final String TEXT_994 = NL + "                    commitCounter_";
  protected final String TEXT_995 = "=0;" + NL + "                }";
