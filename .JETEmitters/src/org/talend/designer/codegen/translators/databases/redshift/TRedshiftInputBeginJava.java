...
public class TRedshiftInputBeginJava
{
  ...
  protected final String TEXT_184 = " > 0) {" + NL + "\t\t\t\t\tjava.io.Writer output_";
  protected final String TEXT_185 = " = new java.io.FileWriter(";
  protected final String TEXT_186 = ", true);" + NL + "\t\t\t\t\tjava.sql.DriverManager.setLogWriter(new java.io.PrintWriter(output_";
  protected final String TEXT_187 = ",true));" + NL + "\t\t\t\t}\t\t\t\t" + NL + "\t\t\torg.postgresql.Driver.setLogLevel(";
  protected final String TEXT_188 = ");" + NL + "" + NL + "\t\t\tString url_";
  protected final String TEXT_189 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_190 = " + \":\" + ";
  protected final String TEXT_191 = " + \"/\" + ";
  protected final String TEXT_192 = " +\"?prepareThreshold=100&loglevel=\"+";
  protected final String TEXT_193 = "+\"&protocolVersion=3\";";
  protected final String TEXT_194 = NL + "                stmt_";
  protected final String TEXT_195 = ".setFetchSize(";
  ...
  protected final String TEXT_272 = ".getColumnLabel(i));" + NL + "                \tdcm_";
