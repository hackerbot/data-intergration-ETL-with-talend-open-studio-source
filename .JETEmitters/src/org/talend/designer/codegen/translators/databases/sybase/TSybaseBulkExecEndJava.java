...
public class TSybaseBulkExecEndJava {
  protected static String nl;
  public static synchronized TSybaseBulkExecEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSybaseBulkExecEndJava result = new TSybaseBulkExecEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_70 = NL + "        tableName_";
  protected final String TEXT_71 = " = tmpTableName_";
  protected final String TEXT_72 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_73 = " = \"tmp_";
  protected final String TEXT_74 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        if(dbschema_";
  protected final String TEXT_75 = " != null && dbschema_";
  protected final String TEXT_76 = ".trim().length() != 0) {" + NL + "    \t\ttmpTableName_";
  protected final String TEXT_77 = "=dbschema_";
  protected final String TEXT_78 = " + \".\" + tmpTableName_";
  protected final String TEXT_79 = ";" + NL + "    \t}" + NL + "        java.sql.Statement stmtUpdateBulk_";
  ...
  protected final String TEXT_83 = " - Updating ";
  protected final String TEXT_84 = "\" + tableName_";
  protected final String TEXT_85 = " + \"";
  protected final String TEXT_86 = " from ";
  protected final String TEXT_87 = "\"+tmpTableName_";
  protected final String TEXT_88 = "+\"";
  protected final String TEXT_89 = ".\");";
  protected final String TEXT_90 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_91 = ".executeUpdate(\"";
  protected final String TEXT_92 = "\");";
  protected final String TEXT_93 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_94 = ".close();" + NL + "        tableName_";
  protected final String TEXT_95 = " = tmpTableName_";
  protected final String TEXT_96 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_97 = " = conn_";
  protected final String TEXT_98 = ".createStatement();";
  protected final String TEXT_99 = NL + "            log.info(\"";
  protected final String TEXT_100 = " - Droping table ";
  protected final String TEXT_101 = "\" + tableName_";
  protected final String TEXT_102 = " + \"";
  protected final String TEXT_103 = ".\");";
  protected final String TEXT_104 = NL + "        stmtTmpDrop_";
  protected final String TEXT_105 = ".execute(\"";
  protected final String TEXT_106 = "\");";
  protected final String TEXT_107 = NL + "            log.info(\"";
  protected final String TEXT_108 = " - Drop table ";
  protected final String TEXT_109 = "\" + tableName_";
  protected final String TEXT_110 = " + \"";
  protected final String TEXT_111 = " has succeeded.\");";
  protected final String TEXT_112 = NL + "        stmtTmpDrop_";
  protected final String TEXT_113 = ".close();         ";
  protected final String TEXT_114 = NL;
  protected final String TEXT_115 = NL + "\t    if(conn_";
  protected final String TEXT_116 = " != null && !conn_";
  protected final String TEXT_117 = ".isClosed()) {" + NL + "\t        ";
