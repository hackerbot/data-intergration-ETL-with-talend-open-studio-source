...
public class TJDBCSPMainJava
{
  ...
  protected final String TEXT_47 = " == null) {" + NL + "\t\t\t\t\t\tstatement_";
  protected final String TEXT_48 = ".setNull(";
  ...
  protected final String TEXT_53 = " == '\\0') {" + NL + "\t\t\t\t\t\tstatement_";
  protected final String TEXT_54 = ".setString(";
  protected final String TEXT_55 = ", \"\");" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\tstatement_";
  protected final String TEXT_56 = ".setString(";
  protected final String TEXT_57 = ", String.valueOf(";
  protected final String TEXT_58 = ".";
  protected final String TEXT_59 = "));" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_60 = NL + "\t\t\t\t\tstatement_";
  protected final String TEXT_61 = ".setDate(";
  protected final String TEXT_62 = ", new java.sql.Date(";
  protected final String TEXT_63 = ".";
  protected final String TEXT_64 = ".getTime()));" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_72 = NL + "\t\t\t\tstatement_";
  protected final String TEXT_73 = ".registerOutParameter(";
  protected final String TEXT_74 = ", java.sql.Types.";
  protected final String TEXT_75 = ");" + NL + "\t  \t\t\t";
  protected final String TEXT_76 = NL + "\t\tstatement_";
  protected final String TEXT_77 = ".execute();" + NL + "\t\t";
  ...
  protected final String TEXT_85 = " = statement_";
  protected final String TEXT_86 = ".getResultSet();";
  protected final String TEXT_87 = NL + "\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_88 = " = statement_";
  protected final String TEXT_89 = ".getString(";
  protected final String TEXT_90 = ");" + NL + "\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_91 = " != null && tmpString_";
  protected final String TEXT_92 = ".length() > 0) {" + NL + "\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_93 = ".";
  protected final String TEXT_94 = " = tmpString_";
  protected final String TEXT_95 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_96 = NL + "\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_97 = " = statement_";
  protected final String TEXT_98 = ".getDate(";
  protected final String TEXT_99 = ");" + NL + "\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_100 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_101 = ".";
  protected final String TEXT_102 = " = new java.util.Date(tmpDate_";
  protected final String TEXT_103 = ".getTime());" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_104 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_105 = ".";
  protected final String TEXT_106 = " = statement_";
  protected final String TEXT_107 = ".get";
  protected final String TEXT_108 = "(";
  protected final String TEXT_109 = ");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_110 = NL + "\t\t\t\t\t\t\t\t\tif (statement_";
  protected final String TEXT_111 = ".wasNull()) {" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_112 = ".";
  protected final String TEXT_113 = " = null;" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_124 = NL + "\t\t// No code generated: define a schema for ";
