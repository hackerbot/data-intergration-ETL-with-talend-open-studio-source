...
public class TEXAOutputEndJava
{
  ...
  protected final String TEXT_55 = NL + "        if(pstmt_";
  protected final String TEXT_56 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_57 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_58 = NL + "    ";
  protected final String TEXT_59 = NL + "            if(commitCounter_";
  protected final String TEXT_60 = " > 0) {" + NL + "            \t";
  protected final String TEXT_61 = NL + "                conn_";
  protected final String TEXT_62 = ".commit();";
  protected final String TEXT_63 = NL + "            }";
  protected final String TEXT_64 = "  ";
  protected final String TEXT_65 = NL + "    conn_";
  protected final String TEXT_66 = " .close();";
  protected final String TEXT_67 = NL + "    resourceMap.put(\"finish_";
  protected final String TEXT_68 = "\", true);" + NL + "    " + NL + "\tint rejectedCount_";
  protected final String TEXT_69 = " = 0; " + NL + "\t";
  protected final String TEXT_70 = NL + "\tnb_line_deleted_";
  protected final String TEXT_71 = "=nb_line_deleted_";
  protected final String TEXT_72 = "+ deletedCount_";
  protected final String TEXT_73 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_74 = "=nb_line_update_";
  protected final String TEXT_75 = " + updatedCount_";
  protected final String TEXT_76 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_77 = "=nb_line_inserted_";
  protected final String TEXT_78 = " + insertedCount_";
  protected final String TEXT_79 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_80 = "=nb_line_rejected_";
  protected final String TEXT_81 = " + rejectedCount_";
  protected final String TEXT_82 = ";" + NL + "\t";
  protected final String TEXT_83 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_84 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_85 = "_NB_LINE\",nb_line_";
  protected final String TEXT_86 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_87 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_88 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_89 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_90 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_91 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_92 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_93 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_94 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_95 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_96 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_97 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_98 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_99 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_100 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_101 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_102 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_103 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_104 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_105 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_106 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_107 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_108 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_109 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_110 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_111 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_112 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  ...
  protected final String TEXT_119 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_120 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_121 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_122 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_123 = "_NB_LINE_REJECTED\", nb_line_rejected_";
