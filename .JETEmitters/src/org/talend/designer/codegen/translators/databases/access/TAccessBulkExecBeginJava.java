...
public class TAccessBulkExecBeginJava {
  protected static String nl;
  public static synchronized TAccessBulkExecBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAccessBulkExecBeginJava result = new TAccessBulkExecBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_70 = NL + "\tString file_";
  protected final String TEXT_71 = " = ";
  protected final String TEXT_72 = ";" + NL + "\tfile_";
  protected final String TEXT_73 = " = file_";
  protected final String TEXT_74 = ".replaceAll(\"\\\\\\\\\", \"/\");" + NL + "\tString fileName_";
  protected final String TEXT_75 = " = file_";
  protected final String TEXT_76 = ".substring(file_";
  protected final String TEXT_77 = ".lastIndexOf(\"/\")+1);" + NL + "\tString fileDirectory_";
  protected final String TEXT_78 = " = file_";
  protected final String TEXT_79 = ".substring(0,file_";
  protected final String TEXT_80 = ".lastIndexOf(\"/\"));" + NL + "\t" + NL + "\tString tableName_";
  ...
  protected final String TEXT_88 = " = \"sun.jdbc.odbc.JdbcOdbcDriver\";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_89 = ");" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_90 = NL + "\t\t\tString url_";
  protected final String TEXT_91 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ=\" + ";
  protected final String TEXT_92 = ";" + NL + "\t\t";
  protected final String TEXT_93 = NL + "\t\t\tString url_";
  protected final String TEXT_94 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=\" + ";
  ...
  protected final String TEXT_114 = NL + "\t\tString atnParams_";
  protected final String TEXT_115 = " = ";
  protected final String TEXT_116 = ";" + NL + "\t\tatnParams_";
  protected final String TEXT_117 = " = atnParams_";
  protected final String TEXT_118 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_119 = " = new java.util.Properties();" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_120 = ".put(\"user\",dbUser_";
  protected final String TEXT_121 = ");" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_122 = ".put(\"password\",dbPwd_";
  protected final String TEXT_123 = ");" + NL + "\t\tatnParamsPrope_";
  protected final String TEXT_124 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_125 = ".getBytes()));" + NL + "\t  " + NL + "\t\tconn_";
  protected final String TEXT_126 = " =  java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_127 = ", atnParamsPrope_";
  ...
  protected final String TEXT_134 = " - Droping table ";
  protected final String TEXT_135 = "\" + tableName_";
  ...
  protected final String TEXT_142 = " - Drop table ";
  protected final String TEXT_143 = "\" + tableName_";
  protected final String TEXT_144 = " + \"";
  protected final String TEXT_145 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_146 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_147 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_151 = " - Creating table ";
  protected final String TEXT_152 = "\" + tableName_";
  ...
  protected final String TEXT_159 = " - Create table ";
  ...
  protected final String TEXT_168 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_169 = " - Creating table ";
  protected final String TEXT_170 = "\" + tableName_";
  ...
  protected final String TEXT_177 = " - Create table ";
  protected final String TEXT_178 = "\" + tableName_";
  ...
  protected final String TEXT_186 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_187 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_188 = " = tableNameForSearch_";
  protected final String TEXT_189 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_190 = " = tableNameForSearch_";
  protected final String TEXT_191 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_192 = " = dbMetaData_";
  protected final String TEXT_193 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_194 = ", tableNameForSearch_";
  protected final String TEXT_195 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_196 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_197 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_198 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_211 = ".equalsIgnoreCase(";
  protected final String TEXT_212 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_213 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_226 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_230 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_231 = ".equals(schema_";
  protected final String TEXT_232 = ") || (schema_";
  protected final String TEXT_233 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_234 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_243 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_244 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_245 = " == null || dbschema_";
  protected final String TEXT_246 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_247 = " = conn_";
  protected final String TEXT_248 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_249 = " = stmtSchema_";
  protected final String TEXT_250 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_251 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_252 = " = rsSchema_";
  protected final String TEXT_253 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_254 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_255 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_269 = " ==null || dbschema_";
  protected final String TEXT_270 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_271 = ".equals";
  protected final String TEXT_272 = "IgnoreCase";
  protected final String TEXT_273 = "(schema_";
  ...
  protected final String TEXT_285 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  ...
  protected final String TEXT_292 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_293 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_297 = " - Creating table ";
  ...
  protected final String TEXT_305 = " - Create table ";
  ...
  protected final String TEXT_310 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_311 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_312 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_316 = " - Droping table ";
  protected final String TEXT_317 = "\" + tableName_";
  protected final String TEXT_318 = " + \"";
  protected final String TEXT_319 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_320 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_321 = ".execute(\"";
  protected final String TEXT_322 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_323 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_324 = " - Drop table ";
  protected final String TEXT_325 = "\" + tableName_";
  protected final String TEXT_326 = " + \"";
  protected final String TEXT_327 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_328 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_329 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_330 = " = conn_";
  protected final String TEXT_331 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_332 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_333 = " - Creating table ";
  protected final String TEXT_334 = "\" + tableName_";
  ...
  protected final String TEXT_341 = " - Create table ";
  ...
  protected final String TEXT_347 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_351 = " - Clearing table ";
  protected final String TEXT_352 = "\" + tableName_";
  protected final String TEXT_353 = " + \"";
  protected final String TEXT_354 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_355 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_356 = ".executeUpdate(\"";
  protected final String TEXT_357 = "\");" + NL + "\t\t\t";
  protected final String TEXT_358 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_359 = "- Clear table ";
  protected final String TEXT_360 = "\" + tableName_";
  ...
  protected final String TEXT_370 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_374 = " - Trancating table ";
  protected final String TEXT_375 = "\" + tableName_";
  protected final String TEXT_376 = " + \"";
  protected final String TEXT_377 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_378 = NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_379 = ".executeUpdate(\"";
  protected final String TEXT_380 = "\");" + NL + "   \t    \t";
  protected final String TEXT_381 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_382 = " - Truncate table ";
  ...
  protected final String TEXT_393 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_394 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_395 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_396 = " " + NL;
  protected final String TEXT_397 = NL + "\t\tString bulkInsert_";
  protected final String TEXT_398 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_399 = " + \"] SELECT * FROM [Text;Database=\"" + NL + "\t\t\t\t\t\t\t\t\t\t+ fileDirectory_";
  protected final String TEXT_400 = " + \";HDR=";
  protected final String TEXT_401 = "].[\" + fileName_";
  ...
  protected final String TEXT_406 = " - Bulk SQL:\"+bulkInsert_";
  protected final String TEXT_407 = "+\".\");" + NL + "    \t\tlog.info(\"";
  protected final String TEXT_408 = " - Bulk inserting data into \" + tableName_";
  protected final String TEXT_409 = " + \".\" );" + NL + "\t\t";
  protected final String TEXT_410 = NL + "\t\tstmt_";
  protected final String TEXT_411 = ".execute(bulkInsert_";
  protected final String TEXT_412 = ");" + NL + "" + NL + "\t\tstmt_";
  protected final String TEXT_413 = ".close();" + NL + "\t\t";
  protected final String TEXT_414 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_415 = " - Bulk insert data into \" + tableName_";
  protected final String TEXT_416 = " + \" has finished.\");" + NL + "    \t";
...
//end issue 0010346 Parallelization crash with "Drop table if exists and create"
    ...
    stringBuffer.append((includeHeader)? "YES":"NO");
