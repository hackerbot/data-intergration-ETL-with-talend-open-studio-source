...
public class TJavaDBInputBeginJava
{
  ...
  protected final String TEXT_183 = NL + "\t\t\t\t//set the root path of the database" + NL + "\t\t\t\tSystem.setProperty(\"derby.system.home\", ";
  protected final String TEXT_184 = ");";
  protected final String TEXT_185 = NL + "        \t\t\torg.apache.derby.drda.NetworkServerControl serverControl_";
  protected final String TEXT_186 = ";" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_187 = " = new org.apache.derby.drda.NetworkServerControl(java.net.InetAddress.getByName(";
  protected final String TEXT_188 = "),Integer.parseInt(";
  protected final String TEXT_189 = "));" + NL + "        \t\t\t//start server" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_190 = ".start(new java.io.PrintWriter(System.out,true));" + NL + "        \t\t\tboolean isServerUp_";
  protected final String TEXT_191 = " = false;" + NL + "        \t\t\tint timeOut_";
  protected final String TEXT_192 = " = 5;" + NL + "        \t\t\twhile(!isServerUp_";
  protected final String TEXT_193 = " && timeOut_";
  protected final String TEXT_194 = " > 0) {" + NL + "        \t\t\t\ttry {" + NL + "            \t\t\t\ttimeOut_";
  protected final String TEXT_195 = "--;" + NL + "            \t\t\t\t/*" + NL + "    \t\t\t\t\t\t* testing for connection to see if the network server is up and running." + NL + "    \t\t\t\t\t\t* if server is not ready yet, this method will throw an exception.\t\t" + NL + "    \t\t\t\t\t\t*/" + NL + "            \t\t\t\tserverControl_";
  protected final String TEXT_196 = ".ping();" + NL + "            \t\t\t\tisServerUp_";
  protected final String TEXT_197 = " = true;" + NL + "        \t\t\t\t} catch(java.lang.Exception e) {" + NL + "    \t\t\t\t\t\t//Unable to obtain a connection to network server, trying again after 3000 ms." + NL + "    \t\t\t\t\t\tThread.currentThread().sleep(3000);" + NL + "    \t\t\t\t\t}    \t\t\t\t" + NL + "        \t\t\t}" + NL + "        \t\t\tif(!isServerUp_";
  protected final String TEXT_198 = ") {" + NL + "        \t\t\t\t/*" + NL + "    \t\t\t\t\t * can not obtain a connection to network server." + NL + "    \t\t\t\t\t */ \t " + NL + "        \t\t\t\tthrow new java.lang.Exception(\"Can not obtain a connection to network server\");" + NL + "        \t\t\t}" + NL + "        \t\t\t//derby network server started.";
  protected final String TEXT_199 = NL + "\t\t\t\tString url_";
  protected final String TEXT_200 = " = \"jdbc:derby:\" + ";
  protected final String TEXT_201 = ";";
  protected final String TEXT_202 = NL + "    \t\t\t\tString url_";
  protected final String TEXT_203 = " = \"jdbc:derby:net://\" + ";
  protected final String TEXT_204 = " + \":\" + ";
  protected final String TEXT_205 = " + \"/\" + ";
  protected final String TEXT_206 = ";";
  protected final String TEXT_207 = NL + "    \t\t\t\tString url_";
  protected final String TEXT_208 = " = \"jdbc:derby://\" + ";
  ...
  protected final String TEXT_215 = ").newInstance();" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_231 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_232 = " = null;";
  protected final String TEXT_233 = NL + "\t\t        conn_";
  protected final String TEXT_234 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_235 = "\");";
  protected final String TEXT_236 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_237 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_238 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_239 = " = dataSources_";
  protected final String TEXT_240 = ".get(";
  protected final String TEXT_241 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_242 = "\", conn_";
  protected final String TEXT_243 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_244 = NL + "\t\t\t\t";
  protected final String TEXT_245 = NL + "\t\t\t\t";
  protected final String TEXT_246 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_247 = " =  conn_";
  protected final String TEXT_248 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_249 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_250 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_251 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_252 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_253 = NL + "                 conn_";
  protected final String TEXT_254 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_255 = NL + "               ";
  protected final String TEXT_256 = " + \"=\" + ";
  protected final String TEXT_257 = " + \";\" +";
  protected final String TEXT_258 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_259 = ".setAutoCommit(currentAutoCommitMode";
  ...
  protected final String TEXT_270 = "_QUERY\",dbquery_";
  protected final String TEXT_271 = ");";
  protected final String TEXT_272 = NL + "                       globalMap.put(\"";
  protected final String TEXT_273 = "_QUERY\",dbquery_";
  protected final String TEXT_274 = ");";
  protected final String TEXT_275 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_276 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_277 = " = stmt_";
  protected final String TEXT_278 = ".executeQuery(dbquery_";
  protected final String TEXT_279 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_280 = " = rs_";
  protected final String TEXT_281 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_282 = " = rsmd_";
  protected final String TEXT_283 = ".getColumnCount();" + NL;
  protected final String TEXT_284 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_285 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_286 = ".setDbmsId(\"";
  protected final String TEXT_287 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_288 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_289 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_290 = ".add(\"";
  protected final String TEXT_291 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_292 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_293 = " = ";
  protected final String TEXT_294 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_295 = "; i <= rsmd_";
  protected final String TEXT_296 = ".getColumnCount()-";
  protected final String TEXT_297 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_298 = ".contains(rsmd_";
  protected final String TEXT_299 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_300 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_301 = ".setName(rsmd_";
  protected final String TEXT_302 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_303 = ".setDbName(rsmd_";
  protected final String TEXT_304 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_305 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_306 = "\", rsmd_";
  protected final String TEXT_307 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_308 = ".getPrecision(i), rsmd_";
  protected final String TEXT_309 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_310 = ".setDbType(rsmd_";
  protected final String TEXT_311 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_312 = ".setDbTypeId(rsmd_";
  protected final String TEXT_313 = ".getColumnType(i));";
  protected final String TEXT_314 = NL + "                \tdcm_";
  protected final String TEXT_315 = ".setFormat(";
  protected final String TEXT_316 = ");";
  protected final String TEXT_317 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_318 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_319 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_320 = ".setLength(rsmd_";
  protected final String TEXT_321 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_322 = ".setLength(rsmd_";
  protected final String TEXT_323 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_324 = NL + "\t\t\tdcm_";
  protected final String TEXT_325 = ".setLength(rsmd_";
  protected final String TEXT_326 = ".getPrecision(i));";
  protected final String TEXT_327 = NL + "                \tdcm_";
  protected final String TEXT_328 = ".setPrecision(rsmd_";
  protected final String TEXT_329 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_330 = ".setNullable(rsmd_";
  protected final String TEXT_331 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_332 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_333 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_334 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_335 = ".metadatas.add(dcm_";
  protected final String TEXT_336 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_337 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_338 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_339 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_340 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_341 = NL + "\t\t    ";
  protected final String TEXT_342 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_343 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_344 = NL + "\t\t    while (rs_";
  protected final String TEXT_345 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_346 = "++;" + NL + "\t\t        ";
  protected final String TEXT_347 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_348 = " = ";
  protected final String TEXT_349 = " + dcg_";
  protected final String TEXT_350 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_351 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_352 = " = ";
  protected final String TEXT_353 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_354 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_355 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_356 = " < ";
  protected final String TEXT_357 = "column_index_";
  protected final String TEXT_358 = ") {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_359 = ".";
  protected final String TEXT_360 = " = ";
  protected final String TEXT_361 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  protected final String TEXT_362 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_363 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_364 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_365 = NL + "\t\t                            ";
  protected final String TEXT_366 = ".";
  protected final String TEXT_367 = " = (List)rs_";
  protected final String TEXT_368 = ".getObject(";
  protected final String TEXT_369 = "column_index_";
  protected final String TEXT_370 = ");";
  protected final String TEXT_371 = NL + "\t\t                         ";
  protected final String TEXT_372 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_373 = ".getObject(";
  protected final String TEXT_374 = "column_index_";
  protected final String TEXT_375 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_376 = NL + "                                    ";
  protected final String TEXT_377 = ".";
  protected final String TEXT_378 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_387 = ".setEPSG(";
  protected final String TEXT_388 = ");" + NL + "                                        }";
  protected final String TEXT_389 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_390 = NL + "                                  ";
  protected final String TEXT_391 = ".";
  protected final String TEXT_392 = "=dcg_";
  protected final String TEXT_393 = ";";
  protected final String TEXT_394 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_395 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_396 = " = ";
  protected final String TEXT_397 = "; i_";
  protected final String TEXT_398 = "  <= rsmd_";
  protected final String TEXT_399 = ".getColumnCount(); i_";
  protected final String TEXT_400 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_401 = ".getColumnTypeName(i_";
  protected final String TEXT_402 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_403 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_404 = ".getClob(i_";
  protected final String TEXT_405 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_406 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_407 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_408 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_409 = ".add(tNTextImpl_";
  protected final String TEXT_410 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_411 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_412 = ".";
  protected final String TEXT_413 = ", rs_";
  protected final String TEXT_414 = ", fixedColumnCount_";
  protected final String TEXT_415 = ",list_";
  protected final String TEXT_416 = ",";
  protected final String TEXT_417 = ");";
  protected final String TEXT_418 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_419 = ".";
  protected final String TEXT_420 = ", rs_";
  protected final String TEXT_421 = ", fixedColumnCount_";
  protected final String TEXT_422 = ",";
  protected final String TEXT_423 = ");";
  protected final String TEXT_424 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_425 = ".";
  protected final String TEXT_426 = ", rs_";
  protected final String TEXT_427 = ", fixedColumnCount_";
  protected final String TEXT_428 = ",";
  protected final String TEXT_429 = ");";
  protected final String TEXT_430 = NL + "                                  Object geom = rs_";
  protected final String TEXT_431 = ".getObject(";
  protected final String TEXT_432 = "column_index_";
  protected final String TEXT_433 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_434 = ".";
  protected final String TEXT_435 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_436 = ".";
  protected final String TEXT_437 = " = null;" + NL + "                                  }";
  protected final String TEXT_438 = NL + "\t\t                          ";
  protected final String TEXT_439 = NL + "\t\t                    }";
  protected final String TEXT_440 = NL + "\t\t\t\t\t";
  protected final String TEXT_441 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_442 = " - Retrieving the record \" + nb_line_";
