...
public class TVerticaSCDBeginJava {
  ...
  protected final String TEXT_11 = NL + "        dbschema_";
  protected final String TEXT_12 = " = (String)globalMap.get(\"";
  protected final String TEXT_13 = "\");" + NL + "        java.sql.Connection connection_";
  protected final String TEXT_14 = " = (java.sql.Connection) globalMap.get(\"";
  protected final String TEXT_15 = "\");";
  protected final String TEXT_16 = NL + "\t\t\tjava.lang.Class.forName(\"com.vertica.jdbc.Driver\");" + NL + "\t\t";
  protected final String TEXT_17 = NL + "        \tjava.lang.Class.forName(\"com.vertica.Driver\");" + NL + "\t\t";
  protected final String TEXT_18 = NL + "        dbschema_";
  protected final String TEXT_19 = " = ";
  protected final String TEXT_20 = ";" + NL + "        ";
  protected final String TEXT_21 = NL + "\t\tString url_";
  protected final String TEXT_22 = " = \"jdbc:vertica://\" + ";
  protected final String TEXT_23 = " + \":\" + ";
  protected final String TEXT_24 = " + \"/\" + ";
  protected final String TEXT_25 = ";" + NL + "\t\t";
  protected final String TEXT_26 = NL + "\t\tString url_";
  protected final String TEXT_27 = " = \"jdbc:vertica://\" + ";
  protected final String TEXT_28 = " + \":\" + ";
  protected final String TEXT_29 = " + \"/\" + ";
  protected final String TEXT_30 = " + \"?\" + ";
  protected final String TEXT_31 = ";" + NL + "\t\t";
  protected final String TEXT_32 = NL + "\t\t" + NL + "\t\tString dbUser_";
  ...
  protected final String TEXT_42 = NL + NL + "\t\tString dbPwd_";
  protected final String TEXT_43 = " = decryptedPassword_";
  protected final String TEXT_44 = ";" + NL + "" + NL + "        java.sql.Connection connection_";
  ...
  protected final String TEXT_49 = NL + "    if(dbschema_";
  protected final String TEXT_50 = "!=null&&!\"\".equals(dbschema_";
  protected final String TEXT_51 = ")){" + NL + "    \ttableName_";
  protected final String TEXT_52 = " =dbschema_";
  protected final String TEXT_53 = "+\".\"+tableName_";
  protected final String TEXT_54 = ";" + NL + "    }";
  protected final String TEXT_55 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_56 = " = connection_";
  protected final String TEXT_57 = ".createStatement();" + NL + "            stmtCreate_";
  protected final String TEXT_58 = ".execute(\"";
  protected final String TEXT_59 = "\");" + NL + "            stmtCreate_";
  protected final String TEXT_60 = ".close();";
  protected final String TEXT_61 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_62 = " = connection_";
  protected final String TEXT_63 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_64 = " = dbMetaData_";
  protected final String TEXT_65 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_66 = " = false;" + NL + "            String defaultSchema_";
  protected final String TEXT_67 = " = \"public\";" + NL + "            if(dbschema_";
  protected final String TEXT_68 = " == null || dbschema_";
  protected final String TEXT_69 = ".trim().length() == 0) {" + NL + "            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_70 = " = connection_";
  protected final String TEXT_71 = ".createStatement();" + NL + "            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_72 = " = stmtSchema_";
  protected final String TEXT_73 = ".executeQuery(\"select current_schema() \");" + NL + "            \twhile(rsSchema_";
  protected final String TEXT_74 = ".next()){" + NL + "            \t\tdefaultSchema_";
  protected final String TEXT_75 = " = rsSchema_";
  protected final String TEXT_76 = ".getString(\"current_schema\");" + NL + "            \t}" + NL + "            \trsSchema_";
  protected final String TEXT_77 = ".close();" + NL + "            \tstmtSchema_";
  protected final String TEXT_78 = ".close();" + NL + "            }" + NL + "            while(rsTable_";
  protected final String TEXT_79 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_80 = " = rsTable_";
  protected final String TEXT_81 = ".getString(\"TABLE_NAME\");" + NL + "                String schema_";
  protected final String TEXT_82 = " = rsTable_";
  protected final String TEXT_83 = ".getString(\"TABLE_SCHEM\");" + NL + "                if(table_";
  protected final String TEXT_84 = ".equalsIgnoreCase(";
  protected final String TEXT_85 = ") && (schema_";
  protected final String TEXT_86 = ".equals(dbschema_";
  protected final String TEXT_87 = ") || ((dbschema_";
  protected final String TEXT_88 = " == null || dbschema_";
  protected final String TEXT_89 = ".trim().length() == 0) && defaultSchema_";
  protected final String TEXT_90 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_91 = ")))) {" + NL + "                    whetherExist_";
  protected final String TEXT_92 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  protected final String TEXT_93 = ".close();" + NL + "            if(!whetherExist_";
  protected final String TEXT_94 = ") {" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_95 = " = connection_";
  ...
  protected final String TEXT_100 = NL + "        " + NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_101 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_102 = " = null;    ";
  protected final String TEXT_103 = NL + "        String searching_";
  protected final String TEXT_104 = " = \"";
  protected final String TEXT_105 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_106 = " = connection_";
  protected final String TEXT_107 = ".prepareStatement(searching_";
  protected final String TEXT_108 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_109 = " = null;";
  protected final String TEXT_110 = NL + "        String search_";
  protected final String TEXT_111 = " = \"";
  protected final String TEXT_112 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_113 = " = connection_";
  protected final String TEXT_114 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_115 = " = statement_";
  protected final String TEXT_116 = ".executeQuery(search_";
  protected final String TEXT_117 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_118 = ", SCDStruct_";
  protected final String TEXT_119 = "> cache_";
  protected final String TEXT_120 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_121 = ", SCDStruct_";
  protected final String TEXT_122 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_123 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_124 = " sk_";
  protected final String TEXT_125 = " = new SCDSK_";
  protected final String TEXT_126 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_127 = " row_";
  protected final String TEXT_128 = " = new SCDStruct_";
  protected final String TEXT_129 = "();";
  protected final String TEXT_130 = NL + "                    tmpValue_";
  protected final String TEXT_131 = " = resultSet_";
  protected final String TEXT_132 = ".getString(";
  protected final String TEXT_133 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_134 = " != null && tmpValue_";
  protected final String TEXT_135 = ".length() > 0) {";
  protected final String TEXT_136 = NL + "                        ";
  protected final String TEXT_137 = ".";
  protected final String TEXT_138 = " = tmpValue_";
  protected final String TEXT_139 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_140 = NL + "                            if(tmpValue_";
  ...
  protected final String TEXT_148 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_149 = ")) {";
  protected final String TEXT_150 = NL + "                                ";
  protected final String TEXT_151 = ".";
  protected final String TEXT_152 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  ...
  protected final String TEXT_156 = NL + "                    timestamp_";
  protected final String TEXT_157 = " = resultSet_";
  protected final String TEXT_158 = ".getTimestamp(";
  protected final String TEXT_159 = ");" + NL + "                    if(timestamp_";
  protected final String TEXT_160 = " != null) {";
  protected final String TEXT_161 = NL + "                        ";
  protected final String TEXT_162 = ".";
  protected final String TEXT_163 = " = new java.util.Date(timestamp_";
  protected final String TEXT_164 = ".getTime());" + NL + "                    } else {";
  protected final String TEXT_165 = NL + "                        ";
  protected final String TEXT_166 = ".";
  protected final String TEXT_167 = " = null;" + NL + "                    }";
  protected final String TEXT_168 = NL + "                    if(resultSet_";
  protected final String TEXT_169 = ".getObject(";
  protected final String TEXT_170 = ") != null) {";
  protected final String TEXT_171 = NL + "                        ";
  protected final String TEXT_172 = ".";
  protected final String TEXT_173 = " = resultSet_";
  protected final String TEXT_174 = ".get";
  protected final String TEXT_175 = "(";
  protected final String TEXT_176 = ");" + NL + "                    }";
  protected final String TEXT_177 = NL + "            cache_";
  protected final String TEXT_178 = ".put(sk_";
  protected final String TEXT_179 = ", row_";
  protected final String TEXT_180 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_181 = ".close();" + NL + "        statement_";
  protected final String TEXT_182 = ".close();";
  protected final String TEXT_183 = NL + "            System.out.println(\"[";
  protected final String TEXT_184 = "] comparison cache loaded\");";
  protected final String TEXT_185 = NL + "        ";
  protected final String TEXT_186 = " nextSurrogateKey_";
  protected final String TEXT_187 = " = 1;";
  protected final String TEXT_188 = NL + "            if(cache_";
  protected final String TEXT_189 = ".size() > 0) {";
  protected final String TEXT_190 = NL + "        String tmpQuery_";
  protected final String TEXT_191 = " = \"SELECT MAX(";
  protected final String TEXT_192 = ") FROM \" + tableName_";
  protected final String TEXT_193 = ";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_194 = " = connection_";
  protected final String TEXT_195 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_196 = " = tmpStmt_";
  protected final String TEXT_197 = ".executeQuery(tmpQuery_";
  protected final String TEXT_198 = ");";
  protected final String TEXT_199 = NL + "        if(tmpRS_";
  protected final String TEXT_200 = ".next() && tmpRS_";
  protected final String TEXT_201 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_202 = " = tmpRS_";
  protected final String TEXT_203 = ".get";
  protected final String TEXT_204 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_205 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_206 = ".close();";
  protected final String TEXT_207 = NL + "            }            ";
  protected final String TEXT_208 = NL + "    String insertionSQL_";
  protected final String TEXT_209 = " = \"";
  protected final String TEXT_210 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_211 = " = connection_";
  protected final String TEXT_212 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_213 = ");";
  protected final String TEXT_214 = NL + "            insertionStatement_";
  protected final String TEXT_215 = ".setTimestamp(";
  protected final String TEXT_216 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_217 = "\")));";
  protected final String TEXT_218 = NL + "            insertionStatement_";
  protected final String TEXT_219 = ".setNull(";
  protected final String TEXT_220 = ", java.sql.Types.DATE);";
  protected final String TEXT_221 = NL + "            String endDateTimeDetail_";
  protected final String TEXT_222 = " = ";
  protected final String TEXT_223 = ";" + NL + "            String datePattern_";
  protected final String TEXT_224 = " = \"yyyy-MM-dd\";" + NL + "            if(endDateTimeDetail_";
  protected final String TEXT_225 = ".length()>0){" + NL + "            \tendDateTimeDetail_";
  protected final String TEXT_226 = " = \" \"+endDateTimeDetail_";
  protected final String TEXT_227 = ";" + NL + "            \tdatePattern_";
  protected final String TEXT_228 = " = \"yyyy-MM-dd HH:mm:ss\";" + NL + "            }" + NL + "            insertionStatement_";
  protected final String TEXT_229 = ".setTimestamp(";
  protected final String TEXT_230 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(datePattern_";
  protected final String TEXT_231 = ").parse(";
  protected final String TEXT_232 = " + \"-01-01\"+endDateTimeDetail_";
  protected final String TEXT_233 = ").getTime()));";
  protected final String TEXT_234 = NL + "        String updateSQLForType1_";
  ...
  protected final String TEXT_249 = NL + "        String updateSQLForType3_";
  ...
  protected final String TEXT_256 = NL + "        SCDSK_";
  protected final String TEXT_257 = " lookUpKey_";
  protected final String TEXT_258 = " = null;        ";
  protected final String TEXT_259 = NL + "    SCDStruct_";
