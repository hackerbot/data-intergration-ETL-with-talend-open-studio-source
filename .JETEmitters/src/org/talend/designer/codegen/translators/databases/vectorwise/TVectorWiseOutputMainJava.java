...
public class TVectorWiseOutputMainJava {
  protected static String nl;
  public static synchronized TVectorWiseOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVectorWiseOutputMainJava result = new TVectorWiseOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_63 = ".addBatch();" + NL + "        \t\tnb_line_";
  protected final String TEXT_64 = "++;" + NL + "\t\t  \t\t";
  protected final String TEXT_65 = NL + " \t\t \t\t\tbatchSizeCounter_";
  ...
  protected final String TEXT_85 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_86 = NL + "                            ";
  protected final String TEXT_87 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_88 = ";";
  protected final String TEXT_89 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_90 = NL + "                }" + NL + "\t\t\t";
  protected final String TEXT_91 = NL + "                    ";
  protected final String TEXT_92 = NL + "                        query_";
  ...
  protected final String TEXT_102 = NL + "                        query_";
  protected final String TEXT_103 = " = ";
  protected final String TEXT_104 = ";";
  protected final String TEXT_105 = NL + "                globalMap.put(\"";
  protected final String TEXT_106 = "_QUERY\", query_";
  protected final String TEXT_107 = ".toString().trim());";
  protected final String TEXT_108 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_109 = " = updatedCount_";
  protected final String TEXT_110 = " + pstmt_";
  protected final String TEXT_111 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_112 = "++;";
  protected final String TEXT_113 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_124 = NL + "                        nb_line_rejected_";
  protected final String TEXT_125 = "++;";
  protected final String TEXT_126 = NL + "                        ";
  protected final String TEXT_127 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_139 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_140 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_141 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_142 = " = rs_";
  protected final String TEXT_143 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_159 = "_QUERY\", query_";
  protected final String TEXT_160 = ".toString().trim());";
  protected final String TEXT_161 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_162 = " = updatedCount_";
  protected final String TEXT_163 = " + pstmtUpdate_";
  protected final String TEXT_164 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_165 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_166 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_167 = " = true;";
  protected final String TEXT_168 = NL + "                        throw(e);";
  protected final String TEXT_169 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_179 = NL + "                            nb_line_rejected_";
  protected final String TEXT_180 = "++;";
  protected final String TEXT_181 = NL + "                            ";
  protected final String TEXT_182 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_193 = "_QUERY\", query_";
  protected final String TEXT_194 = ".toString().trim());";
  protected final String TEXT_195 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_196 = " = insertedCount_";
  protected final String TEXT_197 = " + pstmtInsert_";
  protected final String TEXT_198 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_199 = "++;";
  protected final String TEXT_200 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_201 = " = true;";
  protected final String TEXT_202 = NL + "                        throw(e);";
  protected final String TEXT_203 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_213 = NL + "                            nb_line_rejected_";
  protected final String TEXT_214 = "++;";
  protected final String TEXT_215 = NL + "                            ";
  protected final String TEXT_216 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_217 = NL + "                            ";
  protected final String TEXT_218 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_219 = ";";
  protected final String TEXT_220 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_221 = NL + "                }" + NL + "            }";
  protected final String TEXT_222 = NL + "            int updateFlag_";
  protected final String TEXT_223 = "=0;";
  protected final String TEXT_224 = NL + "                    ";
  protected final String TEXT_225 = NL + "                        query_";
  ...
  protected final String TEXT_239 = "_QUERY\", query_";
  protected final String TEXT_240 = ".toString().trim());";
  protected final String TEXT_241 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_242 = "=pstmtUpdate_";
  protected final String TEXT_243 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_244 = " = updatedCount_";
  protected final String TEXT_245 = " + updateFlag_";
  protected final String TEXT_246 = ";" + NL + "                if(updateFlag_";
  protected final String TEXT_247 = " != 0){" + NL + "            \t\tnb_line_";
  protected final String TEXT_248 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_249 = NL + "                }" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_250 = " = true;";
  protected final String TEXT_251 = NL + "                    throw(e);";
  protected final String TEXT_252 = NL + "                        ";
  protected final String TEXT_253 = " = new ";
  protected final String TEXT_254 = "Struct();";
  protected final String TEXT_255 = NL + "                            ";
  protected final String TEXT_256 = ".";
  protected final String TEXT_257 = " = ";
  protected final String TEXT_258 = ".";
  protected final String TEXT_259 = ";";
  protected final String TEXT_260 = NL + "                        nb_line_rejected_";
  protected final String TEXT_261 = "++;";
  protected final String TEXT_262 = NL + "                        ";
  protected final String TEXT_263 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_264 = NL + "                        ";
  protected final String TEXT_265 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_266 = ";";
  protected final String TEXT_267 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_268 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_269 = " == 0) {" + NL + "            \t";
  protected final String TEXT_270 = NL + "\t\t\t\tquery_";
  protected final String TEXT_271 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_272 = NL + "                        ";
  protected final String TEXT_273 = NL + "                            query_";
  protected final String TEXT_274 = " = ";
  protected final String TEXT_275 = ";";
  protected final String TEXT_276 = NL + "                    globalMap.put(\"";
  protected final String TEXT_277 = "_QUERY\", query_";
  protected final String TEXT_278 = ".toString().trim());";
  protected final String TEXT_279 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_280 = " = insertedCount_";
  protected final String TEXT_281 = " + pstmtInsert_";
  protected final String TEXT_282 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_283 = "++;";
  protected final String TEXT_284 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_285 = " = true;";
  protected final String TEXT_286 = NL + "                        throw(e);";
  protected final String TEXT_287 = NL + "                    \tnb_line_";
  protected final String TEXT_288 = "++;" + NL + "                    \t";
  protected final String TEXT_289 = NL + "                            ";
  protected final String TEXT_290 = " = new ";
  protected final String TEXT_291 = "Struct();";
  protected final String TEXT_292 = NL + "                                ";
  protected final String TEXT_293 = ".";
  protected final String TEXT_294 = " = ";
  protected final String TEXT_295 = ".";
  protected final String TEXT_296 = ";";
  protected final String TEXT_297 = NL + "                            nb_line_rejected_";
  protected final String TEXT_298 = "++;";
  protected final String TEXT_299 = NL + "                            ";
  protected final String TEXT_300 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_301 = NL + "                            ";
  protected final String TEXT_302 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_303 = ";";
  protected final String TEXT_304 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_305 = NL + "                }" + NL + "            }" + NL;
  protected final String TEXT_306 = NL + "\t\t\t\t\t";
  protected final String TEXT_307 = NL + "                    \t";
  protected final String TEXT_308 = NL + "\t                        query_";
  protected final String TEXT_309 = " = ";
  protected final String TEXT_310 = ";" + NL + "\t                        ";
  protected final String TEXT_311 = NL + "                    ";
  protected final String TEXT_312 = NL + "                        query_";
  protected final String TEXT_313 = " = ";
  protected final String TEXT_314 = ";";
  protected final String TEXT_315 = NL + "                globalMap.put(\"";
  protected final String TEXT_316 = "_QUERY\", query_";
  protected final String TEXT_317 = ".toString().trim());";
  protected final String TEXT_318 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_319 = " = deletedCount_";
  protected final String TEXT_320 = " + pstmt_";
  protected final String TEXT_321 = ".executeUpdate();" + NL + "                nb_line_";
  ...
  protected final String TEXT_330 = "Struct();";
  protected final String TEXT_331 = NL + "                            ";
  protected final String TEXT_332 = ".";
  protected final String TEXT_333 = " = ";
  protected final String TEXT_334 = ".";
  protected final String TEXT_335 = ";";
  protected final String TEXT_336 = NL + "                        nb_line_rejected_";
  protected final String TEXT_337 = "++;";
  protected final String TEXT_338 = NL + "                        ";
  protected final String TEXT_339 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_340 = NL + "                        ";
  protected final String TEXT_341 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_342 = ";";
  protected final String TEXT_343 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_344 = NL + "            }";
  protected final String TEXT_345 = NL + "            if(!whetherReject_";
  protected final String TEXT_346 = ") {";
  protected final String TEXT_347 = NL + "                            ";
  protected final String TEXT_348 = " = new ";
  protected final String TEXT_349 = "Struct();";
  ...
  protected final String TEXT_356 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_357 = " > 0) && (batchSize_";
  protected final String TEXT_358 = " <= batchSizeCounter_";
  protected final String TEXT_359 = ")) {" + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_360 = " = 0;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_361 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_362 = ": pstmt_";
  protected final String TEXT_363 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_364 = " == -2 || countEach_";
  protected final String TEXT_365 = " == -3) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_366 = " += countEach_";
  protected final String TEXT_367 = ";" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_368 = NL + "        \t    \t\tinsertedCount_";
  protected final String TEXT_369 = " += countSum_";
  protected final String TEXT_370 = ";" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_371 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_372 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_373 = NL + "                \tint countSum_";
  protected final String TEXT_374 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_375 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_376 = " += (countEach_";
  protected final String TEXT_377 = " < 0 ? 0 : countEach_";
  protected final String TEXT_378 = ");" + NL + "\t\t\t\t\t}" + NL + "" + NL + "    \t    \t\tinsertedCount_";
  ...
  protected final String TEXT_383 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_384 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_385 = " <= commitCounter_";
  protected final String TEXT_386 = ") {";
  protected final String TEXT_387 = NL + "                if ((batchSize_";
  protected final String TEXT_388 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_389 = " > 0)) {" + NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_390 = " = 0;" + NL + "                \t\t";
  protected final String TEXT_391 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_392 = ": pstmt_";
  protected final String TEXT_393 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_394 = " == -2 || countEach_";
  protected final String TEXT_395 = " == -3) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_396 = " += countEach_";
  protected final String TEXT_397 = ";" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_398 = NL + "        \t    \t\tinsertedCount_";
  protected final String TEXT_399 = " += countSum_";
  protected final String TEXT_400 = ";" + NL + "                        batchSizeCounter_";
  protected final String TEXT_401 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_402 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_403 = NL + "                \tint countSum_";
  protected final String TEXT_404 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_405 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_406 = " += (countEach_";
  protected final String TEXT_407 = " < 0 ? 0 : countEach_";
  protected final String TEXT_408 = ");" + NL + "\t\t\t\t\t}" + NL + "    \t    \t\tinsertedCount_";
  protected final String TEXT_409 = " += countSum_";
  protected final String TEXT_410 = ";" + NL + "\t    \t\t\t";
  protected final String TEXT_411 = NL + "                    System.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_412 = NL + "                }" + NL + "                }";
  protected final String TEXT_413 = NL + "                \t";
  protected final String TEXT_414 = NL + "                \tconn_";
  protected final String TEXT_415 = ".commit();" + NL + "                \t";
  protected final String TEXT_416 = NL + "                \tcommitCounter_";
