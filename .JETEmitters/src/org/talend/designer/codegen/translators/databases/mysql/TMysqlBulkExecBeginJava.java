...
public class TMysqlBulkExecBeginJava {
  ...
  protected final String TEXT_70 = NL + "String charset_";
  protected final String TEXT_71 = " = ";
  protected final String TEXT_72 = ";" + NL + "String tableName_";
  protected final String TEXT_73 = " = ";
  protected final String TEXT_74 = ";" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_75 = "=0;" + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_82 = "\";" + NL + "\t\tClass.forName(driverClass_";
  protected final String TEXT_83 = ").newInstance();" + NL + "\t\t";
  ...
  protected final String TEXT_106 = ";" + NL + "\t\tString dbPwd_";
  protected final String TEXT_107 = " = decryptedPassword_";
  protected final String TEXT_108 = ";" + NL + "\t\t";
  protected final String TEXT_109 = NL + "\t";
  protected final String TEXT_110 = NL + "\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_111 = " = conn_";
  protected final String TEXT_112 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_113 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_114 = " - Droping table ";
  protected final String TEXT_115 = "\" + tableName_";
  protected final String TEXT_116 = " + \"";
  protected final String TEXT_117 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_118 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_119 = ".execute(\"";
  protected final String TEXT_120 = "\");" + NL + "\t\t\t";
  protected final String TEXT_121 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_122 = " - Drop table ";
  protected final String TEXT_123 = "\" + tableName_";
  protected final String TEXT_124 = " + \"";
  protected final String TEXT_125 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_126 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_127 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_128 = " = conn_";
  protected final String TEXT_129 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_130 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_131 = " - Creating table ";
  protected final String TEXT_132 = "\" + tableName_";
  ...
  protected final String TEXT_139 = " - Create table ";
  protected final String TEXT_140 = "\" + tableName_";
  ...
  protected final String TEXT_166 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_167 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_168 = " = tableNameForSearch_";
  protected final String TEXT_169 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_170 = " = tableNameForSearch_";
  protected final String TEXT_171 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_172 = " = dbMetaData_";
  protected final String TEXT_173 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_174 = ", tableNameForSearch_";
  protected final String TEXT_175 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_176 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_177 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_178 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_179 = ".close();" + NL + "\t\t\t";
  ...
  protected final String TEXT_191 = ".equalsIgnoreCase(";
  protected final String TEXT_192 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_193 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_194 = ") || dbschema_";
  protected final String TEXT_195 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_206 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_210 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_211 = ".equals(schema_";
  protected final String TEXT_212 = ") || (schema_";
  protected final String TEXT_213 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_214 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_223 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_224 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_225 = " == null || dbschema_";
  protected final String TEXT_226 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_227 = " = conn_";
  protected final String TEXT_228 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_229 = " = stmtSchema_";
  protected final String TEXT_230 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_231 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_232 = " = rsSchema_";
  protected final String TEXT_233 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_234 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_235 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_244 = ") " + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_245 = ".equals";
  protected final String TEXT_246 = "IgnoreCase";
  ...
  protected final String TEXT_250 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_251 = ".equals";
  protected final String TEXT_252 = "IgnoreCase";
  protected final String TEXT_253 = "(schema_";
  ...
  protected final String TEXT_265 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  ...
  protected final String TEXT_272 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_273 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_274 = " = conn_";
  protected final String TEXT_275 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_276 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_277 = " - Creating table ";
  protected final String TEXT_278 = "\" + tableName_";
  ...
  protected final String TEXT_285 = " - Create table ";
  protected final String TEXT_286 = "\" + tableName_";
  ...
  protected final String TEXT_292 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_296 = " - Droping table ";
  protected final String TEXT_297 = "\" + tableName_";
  protected final String TEXT_298 = " + \"";
  protected final String TEXT_299 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_300 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_301 = ".execute(\"";
  protected final String TEXT_302 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_303 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_304 = " - Drop table ";
  protected final String TEXT_305 = "\" + tableName_";
  protected final String TEXT_306 = " + \"";
  protected final String TEXT_307 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_308 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_309 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_313 = " - Creating table ";
  protected final String TEXT_314 = "\" + tableName_";
  ...
  protected final String TEXT_321 = " - Create table ";
  protected final String TEXT_322 = "\" + tableName_";
  protected final String TEXT_323 = " + \"";
  protected final String TEXT_324 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_325 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_326 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_327 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_331 = " - Clearing table ";
  ...
  protected final String TEXT_339 = "- Clear table ";
  ...
  protected final String TEXT_350 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  protected final String TEXT_351 = " = conn_";
  protected final String TEXT_352 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_353 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_354 = " - Trancating table ";
  protected final String TEXT_355 = "\" + tableName_";
  ...
  protected final String TEXT_362 = " - Truncate table ";
  protected final String TEXT_363 = "\" + tableName_";
  protected final String TEXT_364 = " + \"";
  protected final String TEXT_365 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_366 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_367 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_368 = " += rsTruncCount_";
  protected final String TEXT_369 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_370 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_371 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_372 = ".close();" + NL + "\t\t";
  protected final String TEXT_373 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_374 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_375 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_376 = NL + "String lines_separator_";
  protected final String TEXT_377 = " = ";
  protected final String TEXT_378 = ";" + NL + "String field_separator_";
  protected final String TEXT_379 = " = ";
  protected final String TEXT_380 = ";" + NL + "String escaped_str_";
  protected final String TEXT_381 = " = ";
  protected final String TEXT_382 = ";" + NL + "String enclosed_str_";
  protected final String TEXT_383 = " = ";
  protected final String TEXT_384 = ";" + NL + "String file_";
  protected final String TEXT_385 = " = ";
  protected final String TEXT_386 = ";" + NL + "file_";
  protected final String TEXT_387 = " = file_";
  protected final String TEXT_388 = ".replaceAll(\"\\\\\\\\\", \"/\");" + NL + "String replace_";
  protected final String TEXT_389 = " = null;";
  protected final String TEXT_390 = NL + "\t\tint keyCount_";
  protected final String TEXT_391 = " = ";
  protected final String TEXT_392 = ";" + NL + "\t\tif(keyCount_";
  protected final String TEXT_393 = " == 0) {" + NL + "\t\t\tthrow new RuntimeException(\"For bulk update, Schema must have a key at least.\");" + NL + "\t\t}" + NL + "\t\ttableName_";
  protected final String TEXT_394 = " = \"tmp_";
  protected final String TEXT_395 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "\t\tjava.sql.Statement stmtTmpCreate_";
  ...
  protected final String TEXT_399 = " - Creating temp table \" + tableName_";
  protected final String TEXT_400 = " + \".\" );" + NL + "\t\t";
  protected final String TEXT_401 = NL + "\t\tstmtTmpCreate_";
  protected final String TEXT_402 = ".execute(\"";
  protected final String TEXT_403 = ")\");" + NL + "\t\tstmtTmpCreate_";
  protected final String TEXT_404 = ".close();" + NL + "" + NL + "\t\tjava.sql.Statement stmtTmpBulk_";
  protected final String TEXT_405 = " = conn_";
  protected final String TEXT_406 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_407 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_408 = " - Create temp table \" + tableName_";
  protected final String TEXT_409 = " + \" has succeeded.\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_410 = " - Bulk inserting data into \" + tableName_";
  protected final String TEXT_411 = " + \".\" );" + NL + "\t\t";
  protected final String TEXT_412 = NL + "\t\tstmtTmpBulk_";
  protected final String TEXT_413 = ".execute(\"SET character_set_database=\" + charset_";
  protected final String TEXT_414 = ");" + NL + "\t\tstmtTmpBulk_";
  protected final String TEXT_415 = ".execute(" + NL + "\t\t\t\"LOAD DATA LOCAL INFILE '\" + file_";
  protected final String TEXT_416 = " + \"' \"" + NL + "\t\t\t+ \" INTO TABLE \" + tableName_";
  protected final String TEXT_417 = NL + "\t\t\t+ \" FIELDS TERMINATED BY '\" + field_separator_";
  protected final String TEXT_418 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t\t+ \" ENCLOSED BY '\"+(\"'\".equals(enclosed_str_";
  protected final String TEXT_419 = ")?\"\\\\\":\"\")+ enclosed_str_";
  protected final String TEXT_420 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t\t+ \" ESCAPED BY '\" +(\"'\".equals(escaped_str_";
  protected final String TEXT_421 = ")?\"\\\\\":\"\")+ escaped_str_";
  protected final String TEXT_422 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\")+ \"'\"" + NL + "\t\t\t+ \" LINES TERMINATED BY '\" + lines_separator_";
  protected final String TEXT_423 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' ";
  protected final String TEXT_424 = "\"";
  protected final String TEXT_425 = NL + "\t\t\t+ \" SET\"";
  protected final String TEXT_426 = NL + "\t\t\t+ \" ";
  protected final String TEXT_427 = "=CAST(@";
  protected final String TEXT_428 = "_";
  protected final String TEXT_429 = " AS UNSIGNED)\"";
  protected final String TEXT_430 = NL + "\t\t\t+ \",\"";
  protected final String TEXT_431 = NL + "\t\t);" + NL + "\t\t";
  protected final String TEXT_432 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_433 = " - Bulk insert data into \" + tableName_";
  protected final String TEXT_434 = " + \" has finished.\");" + NL + "\t\t";
  protected final String TEXT_435 = NL + "\t\ttableName_";
  protected final String TEXT_436 = " = ";
  protected final String TEXT_437 = ";" + NL + "\t\tString tmpTableName_";
  protected final String TEXT_438 = " = \"tmp_";
  protected final String TEXT_439 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "\t\tjava.sql.Statement stmtUpdateBulk_";
  ...
  protected final String TEXT_443 = " - Updating \" + tableName_";
  protected final String TEXT_444 = " + \" from \"+tmpTableName_";
  protected final String TEXT_445 = "+\".\");" + NL + "\t\t";
  protected final String TEXT_446 = NL + "\t\tstmtUpdateBulk_";
  protected final String TEXT_447 = ".executeUpdate(\"";
  protected final String TEXT_448 = "\");" + NL + "\t\t";
  protected final String TEXT_449 = NL + "\t\tstmtUpdateBulk_";
  protected final String TEXT_450 = ".close();" + NL + "\t\ttableName_";
  protected final String TEXT_451 = " = tmpTableName_";
  protected final String TEXT_452 = ";" + NL + "\t\tjava.sql.Statement stmtTmpDrop_";
  ...
  protected final String TEXT_456 = " - Droping temp table \" + tableName_";
  protected final String TEXT_457 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_458 = NL + "\t\tstmtTmpDrop_";
  protected final String TEXT_459 = ".execute(\"";
  protected final String TEXT_460 = "\");" + NL + "\t\tstmtTmpDrop_";
  protected final String TEXT_461 = ".close();" + NL + "\t\t";
  protected final String TEXT_462 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_463 = " - Drop temp table \" + tableName_";
  protected final String TEXT_464 = "+ \" has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_465 = NL + "\t\t";
  protected final String TEXT_466 = NL + "\t\treplace_";
  protected final String TEXT_467 = " = \"REPLACE\";" + NL + "\t\t";
  protected final String TEXT_468 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_469 = " - Replacing records in table \" + tableName_";
  protected final String TEXT_470 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_471 = NL + "\t\treplace_";
  protected final String TEXT_472 = " = \"IGNORE\";" + NL + "\t\t";
  protected final String TEXT_473 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_474 = " - Loading data ignore records in table \" + tableName_";
  protected final String TEXT_475 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_476 = NL + "\t\treplace_";
  protected final String TEXT_477 = " = \"\";" + NL + "\t\t";
  protected final String TEXT_478 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_479 = " - Inserting records in table \" + tableName_";
  protected final String TEXT_480 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_481 = NL + "\tString bulkSQL_";
  protected final String TEXT_482 = " = \"LOAD DATA LOCAL INFILE '\" + file_";
  protected final String TEXT_483 = " + \"' \"" + NL + "\t\t+ replace_";
  protected final String TEXT_484 = NL + "\t\t+ \" INTO TABLE \" + tableName_";
  protected final String TEXT_485 = NL + "\t\t+ \" FIELDS TERMINATED BY '\" + field_separator_";
  protected final String TEXT_486 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t+ \" ENCLOSED BY '\"+(\"'\".equals(enclosed_str_";
  protected final String TEXT_487 = ")?\"\\\\\":\"\") + enclosed_str_";
  protected final String TEXT_488 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t+ \" ESCAPED BY '\" + (\"'\".equals(escaped_str_";
  protected final String TEXT_489 = ")?\"\\\\\":\"\")+ escaped_str_";
  protected final String TEXT_490 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t+ \" LINES TERMINATED BY '\" + lines_separator_";
  protected final String TEXT_491 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' ";
  protected final String TEXT_492 = "\"";
  protected final String TEXT_493 = NL + "\t\t+ \" SET\"";
  protected final String TEXT_494 = NL + "\t\t+ \" ";
  protected final String TEXT_495 = "=CAST(@";
  protected final String TEXT_496 = "_";
  protected final String TEXT_497 = " AS UNSIGNED)\"";
  protected final String TEXT_498 = NL + "\t\t+ \",\"";
  protected final String TEXT_499 = ";" + NL + "\t";
  protected final String TEXT_500 = NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_501 = "=conn_";
  protected final String TEXT_502 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_503 = ".execute(\"SET character_set_database=\" + charset_";
  protected final String TEXT_504 = ");" + NL + "\t" + NL + "\tstmt_";
  protected final String TEXT_505 = ".execute(bulkSQL_";
  protected final String TEXT_506 = ");" + NL + "\t";
  protected final String TEXT_507 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_508 = " - Replace records in table \" + tableName_";
  protected final String TEXT_509 = " + \" has finished.\");" + NL + "\t\t";
  protected final String TEXT_510 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_511 = " - Load data ignore records in table \" + tableName_";
  protected final String TEXT_512 = " + \" has finished.\");" + NL + "\t\t";
  protected final String TEXT_513 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_514 = " - Insert records in table \" + tableName_";
  protected final String TEXT_515 = " + \" has finished.\");" + NL + "\t\t";
...
if(columnList != null && columnList.size() > 0) {
    ...
    stringBuffer.append(ElementParameterParser.getValue(node, "__LINES_TERMINATED_BY__") );
    ...
    stringBuffer.append(containNULL?"\"\\\\\"":ElementParameterParser.getValue(node, "__ESCAPED_BY__") );
    stringBuffer.append(TEXT_382);
    stringBuffer.append(cid );
    stringBuffer.append(TEXT_383);
    stringBuffer.append(ElementParameterParser.getValue(node, "__ENCLOSED_BY__") );
...
if(("UPDATE").equals(dataAction)) {
    ...
    stringBuffer.append(loadingCols.toString());
    ...
    stringBuffer.append(bitCols.get(i));
