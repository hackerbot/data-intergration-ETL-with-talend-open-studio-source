...
public class TGreenplumSCDBeginJava {
  protected static String nl;
  public static synchronized TGreenplumSCDBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGreenplumSCDBeginJava result = new TGreenplumSCDBeginJava();
    nl = null;
    return result;
  }
