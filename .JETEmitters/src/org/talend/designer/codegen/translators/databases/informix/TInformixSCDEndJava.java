...
public class TInformixSCDEndJava {
  protected static String nl;
  public static synchronized TInformixSCDEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInformixSCDEndJava result = new TInformixSCDEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_2 = NL + "        searchingStmt_";
  protected final String TEXT_3 = ".close();";
  protected final String TEXT_4 = NL + "    insertionStatement_";
  protected final String TEXT_5 = ".close();";
  protected final String TEXT_6 = NL + "        updateForType1_";
  protected final String TEXT_7 = ".close();";
  protected final String TEXT_8 = NL + "        updateForType2_";
  protected final String TEXT_9 = ".close();";
  protected final String TEXT_10 = NL + "        updateForType3_";
  protected final String TEXT_11 = ".close();";
  protected final String TEXT_12 = NL + "\t\tif(!connection_";
  protected final String TEXT_13 = ".getAutoCommit()) {" + NL + "\t\t\tconnection_";
  protected final String TEXT_14 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_15 = NL + "        if(connection_";
  protected final String TEXT_16 = " != null && !connection_";
  protected final String TEXT_17 = ".isClosed()) {" + NL + "     \t" + NL + "            connection_";
  protected final String TEXT_18 = ".close();" + NL + "        }";
  protected final String TEXT_19 = NL + "    globalMap.put(\"";
  protected final String TEXT_20 = "_NB_LINE_UPDATED\", nb_line_update_";
  protected final String TEXT_21 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_22 = "_NB_LINE_INSERTED\", nb_line_inserted_";
