...
public class TParAccelSCDEndJava {
  protected static String nl;
  public static synchronized TParAccelSCDEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TParAccelSCDEndJava result = new TParAccelSCDEndJava();
    nl = null;
    return result;
  }
