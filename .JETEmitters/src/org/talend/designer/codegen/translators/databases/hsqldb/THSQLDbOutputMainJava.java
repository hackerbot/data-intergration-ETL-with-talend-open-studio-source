...
public class THSQLDbOutputMainJava {
  protected static String nl;
  public static synchronized THSQLDbOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    THSQLDbOutputMainJava result = new THSQLDbOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_77 = NL + "                        rejectedCount_";
  protected final String TEXT_78 = " = rejectedCount_";
  protected final String TEXT_79 = " + 1;";
  protected final String TEXT_80 = NL + "                        ";
  protected final String TEXT_81 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_82 = NL + "                        ";
  protected final String TEXT_83 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_84 = ";";
  protected final String TEXT_85 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_142 = "_QUERY\", query_";
  protected final String TEXT_143 = ".toString().trim());";
  protected final String TEXT_144 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_145 = " = updatedCount_";
  protected final String TEXT_146 = " + pstmtUpdate_";
  protected final String TEXT_147 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_148 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_149 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_150 = " = true;";
  protected final String TEXT_151 = NL + "                        throw(e);";
  ...
  protected final String TEXT_162 = NL + "                            rejectedCount_";
  protected final String TEXT_163 = " = rejectedCount_";
  protected final String TEXT_164 = " + 1;";
  ...
  protected final String TEXT_171 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_197 = NL + "                            rejectedCount_";
  protected final String TEXT_198 = " = rejectedCount_";
  protected final String TEXT_199 = " + 1;";
  protected final String TEXT_200 = NL + "                            ";
  protected final String TEXT_201 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_202 = NL + "                            ";
  protected final String TEXT_203 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_204 = ";";
  protected final String TEXT_205 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_206 = NL + "                }" + NL + "            }";
  protected final String TEXT_207 = NL + "            int updateFlag_";
  protected final String TEXT_208 = "=0;";
  protected final String TEXT_209 = NL + "                    ";
  protected final String TEXT_210 = NL + "                        query_";
  protected final String TEXT_211 = " = ";
  protected final String TEXT_212 = ";";
  protected final String TEXT_213 = NL + "                    ";
  protected final String TEXT_214 = NL + "                        query_";
  protected final String TEXT_215 = " = ";
  protected final String TEXT_216 = ";";
  protected final String TEXT_217 = NL + "                globalMap.put(\"";
  protected final String TEXT_218 = "_QUERY\", query_";
  protected final String TEXT_219 = ".toString().trim());";
  protected final String TEXT_220 = "  " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_221 = "=pstmtUpdate_";
  protected final String TEXT_222 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_223 = " = updatedCount_";
  protected final String TEXT_224 = " + updateFlag_";
  protected final String TEXT_225 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_226 = " == 0) {" + NL + "            \t";
  protected final String TEXT_227 = NL + "\t\t\t\tquery_";
  protected final String TEXT_228 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_229 = NL + "                        ";
  protected final String TEXT_230 = NL + "                            query_";
  protected final String TEXT_231 = " = ";
  protected final String TEXT_232 = ";";
  protected final String TEXT_233 = NL + "                    globalMap.put(\"";
  protected final String TEXT_234 = "_QUERY\", query_";
  protected final String TEXT_235 = ".toString().trim());";
  protected final String TEXT_236 = NL + "                    insertedCount_";
  protected final String TEXT_237 = " = insertedCount_";
  protected final String TEXT_238 = " + pstmtInsert_";
  protected final String TEXT_239 = ".executeUpdate();  " + NL + "         \t\t\tnb_line_";
  protected final String TEXT_240 = "++;";
  protected final String TEXT_241 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_242 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_243 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_244 = " = true;";
  protected final String TEXT_245 = NL + "                        throw(e);";
  ...
  protected final String TEXT_256 = NL + "                            rejectedCount_";
  protected final String TEXT_257 = " = rejectedCount_";
  protected final String TEXT_258 = " + 1;";
  protected final String TEXT_259 = NL + "                            ";
  protected final String TEXT_260 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_261 = NL + "                            ";
  protected final String TEXT_262 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_263 = ";";
  protected final String TEXT_264 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_265 = NL + "                }";
  protected final String TEXT_266 = NL + "                    ";
  protected final String TEXT_267 = NL + "                        query_";
  protected final String TEXT_268 = " = ";
  protected final String TEXT_269 = ";";
  protected final String TEXT_270 = NL + "                globalMap.put(\"";
  protected final String TEXT_271 = "_QUERY\", query_";
  protected final String TEXT_272 = ".toString().trim());";
  protected final String TEXT_273 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_274 = " = deletedCount_";
  protected final String TEXT_275 = " + pstmt_";
  protected final String TEXT_276 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_277 = "++;";
  protected final String TEXT_278 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_279 = " = true;";
  protected final String TEXT_280 = NL + "                    throw(e);";
  ...
  protected final String TEXT_291 = NL + "                        rejectedCount_";
  protected final String TEXT_292 = " = rejectedCount_";
  protected final String TEXT_293 = " + 1;";
  protected final String TEXT_294 = NL + "                        ";
  protected final String TEXT_295 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_296 = NL + "                        ";
  protected final String TEXT_297 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_298 = ";";
  protected final String TEXT_299 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_300 = NL + "            }";
  protected final String TEXT_301 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_312 = NL + "            commitCounter_";
  protected final String TEXT_313 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_314 = " <= commitCounter_";
  protected final String TEXT_315 = ") {" + NL + "            \t";
  protected final String TEXT_316 = NL + "                conn_";
  protected final String TEXT_317 = ".commit();" + NL + "\t\t\t\t";
  protected final String TEXT_318 = "                " + NL + "                commitCounter_";
  protected final String TEXT_319 = "=0;" + NL + "            " + NL + "            }" + NL + "        ";
