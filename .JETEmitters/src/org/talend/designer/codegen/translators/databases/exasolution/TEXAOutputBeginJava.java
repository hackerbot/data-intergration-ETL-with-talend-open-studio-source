...
public class TEXAOutputBeginJava {
  protected static String nl;
  public static synchronized TEXAOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TEXAOutputBeginJava result = new TEXAOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_64 = " = false;" + NL + "" + NL + "" + NL + "    String dbProperties_";
  protected final String TEXT_65 = " = ";
  protected final String TEXT_66 = ";" + NL + "    String url_";
  protected final String TEXT_67 = " = null;" + NL + "    if(dbProperties_";
  protected final String TEXT_68 = " == null || dbProperties_";
  protected final String TEXT_69 = ".trim().length() == 0) {" + NL + "        url_";
  protected final String TEXT_70 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_71 = " + \":\" + ";
  protected final String TEXT_72 = "+ \";schema=\" + ";
  protected final String TEXT_73 = "; " + NL + "    } else {" + NL + "       url_";
  protected final String TEXT_74 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_75 = " + \":\" + ";
  protected final String TEXT_76 = " + \";schema=\" + ";
  protected final String TEXT_77 = " + \";\" + ";
  protected final String TEXT_78 = ";" + NL + "    }" + NL + "    String dbUser_";
  ...
  protected final String TEXT_88 = NL + NL + "    String dbPwd_";
  protected final String TEXT_89 = " = decryptedPassword_";
  protected final String TEXT_90 = ";" + NL + "    " + NL + "    java.lang.Class.forName(\"com.exasol.jdbc.EXADriver\");" + NL + "\t";
  ...
  protected final String TEXT_97 = NL + "    resourceMap.put(\"conn_";
  protected final String TEXT_98 = "\", conn_";
  protected final String TEXT_99 = ");";
  protected final String TEXT_100 = NL + "            conn_";
  protected final String TEXT_101 = ".setAutoCommit(false);" + NL + "            int commitEvery_";
  protected final String TEXT_102 = " = ";
  protected final String TEXT_103 = ";                " + NL + "            int commitCounter_";
  ...
  protected final String TEXT_111 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_112 = " = conn_";
  protected final String TEXT_113 = ".createStatement();";
  protected final String TEXT_114 = NL + "            stmtCreate_";
  protected final String TEXT_115 = ".execute(\"";
  ...
  protected final String TEXT_134 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_143 = NL + "                if(whetherExist_";
  ...
  protected final String TEXT_150 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_151 = " = conn_";
  protected final String TEXT_152 = ".createStatement();";
  protected final String TEXT_153 = NL + "                stmtCreate_";
  protected final String TEXT_154 = ".execute(\"";
  protected final String TEXT_155 = ")\");";
  protected final String TEXT_156 = "                ";
  protected final String TEXT_157 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_158 = " = conn_";
  protected final String TEXT_159 = ".createStatement();";
  protected final String TEXT_160 = NL + "            deletedCount_";
  protected final String TEXT_161 = " = deletedCount_";
  protected final String TEXT_162 = " + stmtClear_";
  ...
  protected final String TEXT_173 = NL + "\t    String update_";
  protected final String TEXT_174 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_179 = ".prepareStatement(update_";
  protected final String TEXT_180 = ");" + NL + "\t    ";
  protected final String TEXT_181 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_182 = " = conn_";
  protected final String TEXT_183 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  ...
  protected final String TEXT_189 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_190 = " = conn_";
  protected final String TEXT_191 = ".prepareStatement(insert_";
  protected final String TEXT_192 = ");" + NL + "\t    String update_";
  protected final String TEXT_193 = " = \"UPDATE \" + ";
  protected final String TEXT_194 = " + \" SET ";
  protected final String TEXT_195 = " WHERE ";
  protected final String TEXT_196 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_197 = " = conn_";
  protected final String TEXT_198 = ".prepareStatement(update_";
  ...
  protected final String TEXT_207 = ");" + NL + "\t    String insert_";
  protected final String TEXT_208 = " = \"INSERT INTO \" + ";
  protected final String TEXT_209 = " + \" (";
  protected final String TEXT_210 = ") VALUES (";
  protected final String TEXT_211 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_212 = " = conn_";
  protected final String TEXT_213 = ".prepareStatement(insert_";
  protected final String TEXT_214 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_215 = NL + "\t    String delete_";
  protected final String TEXT_216 = " = \"DELETE FROM \" + ";
  protected final String TEXT_217 = " + \" WHERE ";
  protected final String TEXT_218 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_219 = " = conn_";
  protected final String TEXT_220 = ".prepareStatement(delete_";
  protected final String TEXT_221 = ");" + NL + "\t    ";
  protected final String TEXT_222 = NL + "        String query_";
...
if(dataAction.equals("UPDATE") || dataAction.equals("INSERT_OR_UPDATE") || dataAction.equals("UPDATE_OR_INSERT")) {
    ...
    dbLog.conn().logJDBCDriver(dbLog.str("com.exasol.jdbc.EXADriver"));
    ...
    if(useCommitControl.equals("true")) {// if use commit control
...
if(columnList != null && columnList.size() > 0) {    
    if(!isParallelize && !tableAction.equals("NONE")) {
        Manager manager = getManager(dbmsId, cid);
