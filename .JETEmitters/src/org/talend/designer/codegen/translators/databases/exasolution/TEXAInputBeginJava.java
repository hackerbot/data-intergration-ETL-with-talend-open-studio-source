...
public class TEXAInputBeginJava
{
  ...
  protected final String TEXT_183 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_184 = " + \":\" + ";
  protected final String TEXT_185 = "+ \";schema=\" + ";
  protected final String TEXT_186 = "; ";
  protected final String TEXT_187 = NL + "                String url_";
  protected final String TEXT_188 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_189 = " + \":\" + ";
  protected final String TEXT_190 = " + \";schema=\" + ";
  ...
  protected final String TEXT_212 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_213 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_214 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_215 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_216 = NL + "                 conn_";
  protected final String TEXT_217 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_218 = NL + "               ";
  protected final String TEXT_219 = " + \"=\" + ";
  protected final String TEXT_220 = " + \";\" +";
  protected final String TEXT_221 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_222 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_223 = ");";
  protected final String TEXT_224 = NL + "\t\t    ";
  protected final String TEXT_225 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_226 = " = ";
  protected final String TEXT_227 = ";" + NL + "\t\t\t";
  protected final String TEXT_228 = NL + "                log.info(\"";
  protected final String TEXT_229 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_230 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_231 = NL;
  protected final String TEXT_232 = NL + "                       globalMap.put(\"";
  protected final String TEXT_233 = "_QUERY\",dbquery_";
  protected final String TEXT_234 = ");";
  protected final String TEXT_235 = NL + "                       globalMap.put(\"";
  protected final String TEXT_236 = "_QUERY\",dbquery_";
  protected final String TEXT_237 = ");";
  protected final String TEXT_238 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_239 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  ...
  protected final String TEXT_251 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_252 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_253 = ".add(\"";
  protected final String TEXT_254 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_255 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_256 = " = ";
  protected final String TEXT_257 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_258 = "; i <= rsmd_";
  protected final String TEXT_259 = ".getColumnCount()-";
  protected final String TEXT_260 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_261 = ".contains(rsmd_";
  protected final String TEXT_262 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_263 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_264 = ".setName(rsmd_";
  protected final String TEXT_265 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_266 = ".setDbName(rsmd_";
  protected final String TEXT_267 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_268 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_269 = "\", rsmd_";
  protected final String TEXT_270 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_271 = ".getPrecision(i), rsmd_";
  protected final String TEXT_272 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_273 = ".setDbType(rsmd_";
  protected final String TEXT_274 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_275 = ".setDbTypeId(rsmd_";
  protected final String TEXT_276 = ".getColumnType(i));";
  ...
  protected final String TEXT_301 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_302 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_303 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_304 = NL + "\t\t    ";
  protected final String TEXT_305 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_306 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_307 = NL + "\t\t    while (rs_";
  protected final String TEXT_308 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_309 = "++;" + NL + "\t\t        ";
  protected final String TEXT_310 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_311 = " = ";
  protected final String TEXT_312 = " + dcg_";
  protected final String TEXT_313 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_314 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_315 = " = ";
  protected final String TEXT_316 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_317 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_318 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_330 = " = (List)rs_";
  protected final String TEXT_331 = ".getObject(";
  protected final String TEXT_332 = "column_index_";
  protected final String TEXT_333 = ");";
  protected final String TEXT_334 = NL + "\t\t                         ";
  protected final String TEXT_335 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_336 = ".getObject(";
  protected final String TEXT_337 = "column_index_";
  protected final String TEXT_338 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_339 = NL + "                                    ";
  protected final String TEXT_340 = ".";
  protected final String TEXT_341 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_350 = ".setEPSG(";
  protected final String TEXT_351 = ");" + NL + "                                        }";
  protected final String TEXT_352 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_353 = NL + "                                  ";
  protected final String TEXT_354 = ".";
  protected final String TEXT_355 = "=dcg_";
  protected final String TEXT_356 = ";";
  protected final String TEXT_357 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_358 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_359 = " = ";
  protected final String TEXT_360 = "; i_";
  protected final String TEXT_361 = "  <= rsmd_";
  protected final String TEXT_362 = ".getColumnCount(); i_";
  protected final String TEXT_363 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_364 = ".getColumnTypeName(i_";
  protected final String TEXT_365 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_366 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_367 = ".getClob(i_";
  protected final String TEXT_368 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_369 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_370 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_371 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_372 = ".add(tNTextImpl_";
  protected final String TEXT_373 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_374 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_375 = ".";
  protected final String TEXT_376 = ", rs_";
  protected final String TEXT_377 = ", fixedColumnCount_";
  protected final String TEXT_378 = ",list_";
  protected final String TEXT_379 = ",";
  protected final String TEXT_380 = ");";
  protected final String TEXT_381 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_382 = ".";
  protected final String TEXT_383 = ", rs_";
  protected final String TEXT_384 = ", fixedColumnCount_";
  protected final String TEXT_385 = ",";
  protected final String TEXT_386 = ");";
  protected final String TEXT_387 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_388 = ".";
  protected final String TEXT_389 = ", rs_";
  protected final String TEXT_390 = ", fixedColumnCount_";
  protected final String TEXT_391 = ",";
  protected final String TEXT_392 = ");";
  protected final String TEXT_393 = NL + "                                  Object geom = rs_";
  protected final String TEXT_394 = ".getObject(";
  protected final String TEXT_395 = "column_index_";
  protected final String TEXT_396 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_397 = ".";
  protected final String TEXT_398 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
