...
public class TDBOutputBeginJava {
  ...
  protected final String TEXT_52 = " = 0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_53 = " = false;" + NL;
  protected final String TEXT_54 = NL + "    String url_";
  protected final String TEXT_55 = " = \"jdbc:odbc:\" + ";
  protected final String TEXT_56 = ";";
  protected final String TEXT_57 = NL + "    String url_";
  protected final String TEXT_58 = " = \"jdbc:odbc:\" + ";
  protected final String TEXT_59 = ";";
  protected final String TEXT_60 = NL + "    String url_";
  protected final String TEXT_61 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_62 = " + \":\" + ";
  protected final String TEXT_63 = " + \":\" + ";
  protected final String TEXT_64 = ";";
  protected final String TEXT_65 = NL + "    String url_";
  protected final String TEXT_66 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_67 = " + \":\" + ";
  protected final String TEXT_68 = " + \"/\" + ";
  protected final String TEXT_69 = ";";
  protected final String TEXT_70 = NL + "    String url_";
  protected final String TEXT_71 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_72 = " + \":\" + ";
  protected final String TEXT_73 = " + \"/\" + ";
  protected final String TEXT_74 = ";";
  protected final String TEXT_75 = NL;
  protected final String TEXT_76 = NL + "        int updateKeyCount_";
  protected final String TEXT_77 = " = ";
  protected final String TEXT_78 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_79 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_80 = NL + "        int deleteKeyCount_";
  protected final String TEXT_81 = " = ";
  protected final String TEXT_82 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_83 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_84 = " " + NL + "java.lang.Class.forName(\"";
  ...
  protected final String TEXT_98 = ";" + NL + "" + NL + "String dbProperties_";
  protected final String TEXT_99 = " = ";
  protected final String TEXT_100 = ";" + NL + "java.sql.Connection conn_";
  protected final String TEXT_101 = " = null;";
  protected final String TEXT_102 = "\t" + NL + "if(dbProperties_";
  protected final String TEXT_103 = " == null || dbProperties_";
  protected final String TEXT_104 = ".trim().length() == 0) {" + NL + "\tconn_";
  protected final String TEXT_105 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_106 = ",dbUser_";
  protected final String TEXT_107 = ",dbPwd_";
  protected final String TEXT_108 = ");" + NL + "}else{" + NL + "\tdbProperties_";
  protected final String TEXT_109 = " = dbProperties_";
  protected final String TEXT_110 = ".replaceAll(\"&\", \"\\n\");" + NL + "\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_111 = " = new java.util.Properties();" + NL + "\tatnParamsPrope_";
  protected final String TEXT_112 = ".put(\"user\",dbUser_";
  protected final String TEXT_113 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_114 = ".put(\"password\",dbPwd_";
  protected final String TEXT_115 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_116 = ".load(new java.io.ByteArrayInputStream(dbProperties_";
  protected final String TEXT_117 = ".getBytes()));" + NL + "\tconn_";
  protected final String TEXT_118 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_119 = ", atnParamsPrope_";
  ...
  protected final String TEXT_127 = NL + "    java.sql.Statement stmtClear_";
  protected final String TEXT_128 = " = conn_";
  protected final String TEXT_129 = ".createStatement();" + NL + "    deletedCount_";
  protected final String TEXT_130 = " = deletedCount_";
  protected final String TEXT_131 = " + stmtClear_";
  protected final String TEXT_132 = ".executeUpdate(\"delete from \" + ";
  protected final String TEXT_133 = ");";
  protected final String TEXT_134 = NL + "\t    String insert_";
  protected final String TEXT_135 = " = \"INSERT INTO \" + ";
  protected final String TEXT_136 = " + \" (";
  protected final String TEXT_137 = ") VALUES (";
  protected final String TEXT_138 = ")\";" + NL + "\t\t";
  protected final String TEXT_139 = NL + "\t    \tjava.sql.Statement pstmt_";
  protected final String TEXT_140 = " = conn_";
  protected final String TEXT_141 = ".createStatement();" + NL + "\t    ";
  protected final String TEXT_142 = NL + "\t    \tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_143 = " = conn_";
  protected final String TEXT_144 = ".prepareStatement(insert_";
  protected final String TEXT_145 = ");" + NL + "\t    ";
  protected final String TEXT_146 = NL + "\t    String update_";
  protected final String TEXT_147 = " = \"UPDATE \" + ";
  protected final String TEXT_148 = " + \" SET ";
  protected final String TEXT_149 = " WHERE ";
  protected final String TEXT_150 = "\";" + NL + "\t    ";
  protected final String TEXT_151 = NL + "\t    \tjava.sql.Statement pstmt_";
  protected final String TEXT_152 = " = conn_";
  protected final String TEXT_153 = ".createStatement();" + NL + "\t    ";
  protected final String TEXT_154 = NL + "\t    \tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_155 = " = conn_";
  protected final String TEXT_156 = ".prepareStatement(update_";
  protected final String TEXT_157 = ");" + NL + "\t    ";
  protected final String TEXT_158 = NL + "\t    \tString checkExist_";
  protected final String TEXT_159 = " = \"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_160 = " + \" WHERE ";
  protected final String TEXT_161 = "\";" + NL + "\t    \tString insert_";
  protected final String TEXT_162 = " = \"INSERT INTO \" + ";
  protected final String TEXT_163 = " + \" (";
  protected final String TEXT_164 = ") VALUES (";
  protected final String TEXT_165 = ")\";" + NL + "\t    \tString update_";
  protected final String TEXT_166 = " = \"UPDATE \" + ";
  protected final String TEXT_167 = " + \" SET ";
  protected final String TEXT_168 = " WHERE ";
  protected final String TEXT_169 = "\";" + NL + "\t    ";
  protected final String TEXT_170 = NL + "\t    \tString[] checkExistSQLSplits_";
  protected final String TEXT_171 = " = (checkExist_";
  protected final String TEXT_172 = "+\" \").split(\"\\\\?\");" + NL + "\t    \tjava.sql.Statement pstmt_";
  protected final String TEXT_173 = " = conn_";
  protected final String TEXT_174 = ".createStatement();" + NL + "\t    \tjava.sql.Statement pstmtInsert_";
  protected final String TEXT_175 = " = conn_";
  protected final String TEXT_176 = ".createStatement();" + NL + "\t    \tjava.sql.Statement pstmtUpdate_";
  protected final String TEXT_177 = " = conn_";
  protected final String TEXT_178 = ".createStatement();" + NL + "\t    ";
  protected final String TEXT_179 = NL + "\t\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_180 = " = conn_";
  protected final String TEXT_181 = ".prepareStatement(checkExist_";
  protected final String TEXT_182 = ");" + NL + "\t\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_183 = " = conn_";
  protected final String TEXT_184 = ".prepareStatement(insert_";
  protected final String TEXT_185 = ");" + NL + "\t\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_186 = " = conn_";
  protected final String TEXT_187 = ".prepareStatement(update_";
  protected final String TEXT_188 = ");\t" + NL + "\t    ";
  protected final String TEXT_189 = NL + "\t    String update_";
  protected final String TEXT_190 = " = \"UPDATE \" + ";
  protected final String TEXT_191 = " + \" SET ";
  protected final String TEXT_192 = " WHERE ";
  protected final String TEXT_193 = "\";" + NL + "\t    String insert_";
  protected final String TEXT_194 = " = \"INSERT INTO \" + ";
  protected final String TEXT_195 = " + \" (";
  protected final String TEXT_196 = ") VALUES (";
  protected final String TEXT_197 = ")\";" + NL + "\t    ";
  protected final String TEXT_198 = NL + "\t\t    java.sql.Statement pstmtUpdate_";
  protected final String TEXT_199 = " = conn_";
  protected final String TEXT_200 = ".createStatement();" + NL + "\t\t    java.sql.Statement pstmtInsert_";
  protected final String TEXT_201 = " = conn_";
  protected final String TEXT_202 = ".createStatement();\t\t" + NL + "\t    ";
  protected final String TEXT_203 = NL + "\t\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_204 = " = conn_";
  protected final String TEXT_205 = ".prepareStatement(update_";
  protected final String TEXT_206 = ");" + NL + "\t\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_207 = " = conn_";
  protected final String TEXT_208 = ".prepareStatement(insert_";
  protected final String TEXT_209 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_210 = NL + "\t    String delete_";
  protected final String TEXT_211 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_212 = " + \" WHERE ";
  protected final String TEXT_213 = "\";" + NL + "\t    ";
  protected final String TEXT_214 = NL + "\t    \tjava.sql.Statement pstmt_";
  protected final String TEXT_215 = " = conn_";
  protected final String TEXT_216 = ".createStatement();" + NL + "\t    ";
  protected final String TEXT_217 = NL + "\t    \tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_218 = " = conn_";
  protected final String TEXT_219 = ".prepareStatement(delete_";
  protected final String TEXT_220 = ");" + NL + "\t    ";
  protected final String TEXT_221 = NL + "        StringBuffer query_";
  protected final String TEXT_222 = " = null;" + NL + "       \t";
  protected final String TEXT_223 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_224 = " = insert_";
  protected final String TEXT_225 = ".split(\"\\\\?\");";
  protected final String TEXT_226 = NL + "\t\t\tupdate_";
  protected final String TEXT_227 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_228 = " = update_";
  protected final String TEXT_229 = ".split(\"\\\\?\");";
  protected final String TEXT_230 = NL + "\t\t\tupdate_";
  protected final String TEXT_231 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_232 = " = update_";
  protected final String TEXT_233 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_234 = " = insert_";
  protected final String TEXT_235 = ".split(\"\\\\?\");";
  protected final String TEXT_236 = NL + "\t\t\tdelete_";
  protected final String TEXT_237 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_238 = " = delete_";
  protected final String TEXT_239 = ".split(\"\\\\?\");";
  protected final String TEXT_240 = NL + "\t\t\treplace_";
  protected final String TEXT_241 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_242 = " = replace_";
  protected final String TEXT_243 = ".split(\"\\\\?\");";
  protected final String TEXT_244 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_245 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_246 = " = insertIgnore_";
  protected final String TEXT_247 = ".split(\"\\\\?\");";
  protected final String TEXT_248 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_249 = " = insert_";
  protected final String TEXT_250 = ".split(\"\\\\?\");";
  protected final String TEXT_251 = NL + "\t    int commitEvery_";
  protected final String TEXT_252 = " = ";
  protected final String TEXT_253 = ";" + NL + "\t    int commitCounter_";
