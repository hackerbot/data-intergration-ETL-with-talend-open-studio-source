...
public class TParAccelOutputBeginJava {
  protected static String nl;
  public static synchronized TParAccelOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TParAccelOutputBeginJava result = new TParAccelOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_92 = NL + NL + "    java.lang.Class.forName(\"com.paraccel.Driver\");";
  protected final String TEXT_93 = NL + NL + "    String url_";
  protected final String TEXT_94 = " = \"jdbc:paraccel://\"+";
  ...
  protected final String TEXT_114 = NL + NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_115 = "\", conn_";
  protected final String TEXT_116 = ");" + NL;
  protected final String TEXT_117 = NL + "            conn_";
  protected final String TEXT_118 = ".setAutoCommit(false);";
  ...
  protected final String TEXT_127 = NL + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_147 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_148 = ".equals(";
  protected final String TEXT_149 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_150 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_163 = NL + "                    stmtDrop_";
  protected final String TEXT_164 = ".execute(\"";
  protected final String TEXT_165 = "\");" + NL + "                    \t";
  protected final String TEXT_166 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_172 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_173 = " = conn_";
  protected final String TEXT_174 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_175 = " = stmtClearCount_";
  protected final String TEXT_176 = ".executeQuery(\"";
  protected final String TEXT_177 = "\");" + NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_178 = " = conn_";
  protected final String TEXT_179 = ".createStatement();" + NL + "            \t";
  protected final String TEXT_180 = NL + "            stmtClear_";
  protected final String TEXT_181 = ".executeUpdate(\"";
  protected final String TEXT_182 = "\");" + NL + "            \t";
  protected final String TEXT_183 = NL + "            while(rsClearCount_";
  protected final String TEXT_184 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_185 = " += rsClearCount_";
  protected final String TEXT_186 = ".getInt(1);" + NL + "            }";
  protected final String TEXT_187 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_188 = " = conn_";
  protected final String TEXT_189 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_190 = " + \"\\\" (";
  protected final String TEXT_191 = ") VALUES (";
  ...
  protected final String TEXT_201 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_202 = " + \"\\\" WHERE ";
  protected final String TEXT_203 = "\");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_204 = " = conn_";
  protected final String TEXT_205 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_206 = " + \"\\\" (";
  protected final String TEXT_207 = ") VALUES (";
  protected final String TEXT_208 = ")\");" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_209 = " = conn_";
  protected final String TEXT_210 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_216 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_221 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_222 = " + \"\\\" (";
  protected final String TEXT_223 = ") VALUES (";
  protected final String TEXT_224 = ")\");" + NL + "\t    ";
  protected final String TEXT_225 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_226 = " = conn_";
  protected final String TEXT_227 = ".prepareStatement(\"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_228 = " + \"\\\" WHERE ";
  protected final String TEXT_229 = "\");" + NL + "\t    ";
  protected final String TEXT_230 = NL + "            int commitEvery_";
  protected final String TEXT_231 = " = ";
  protected final String TEXT_232 = ";" + NL + "            int commitCounter_";
...
if(("true").equals(useExistingConn)) {
    ...
    dbLog.conn().logJDBCDriver(dbLog.str("com.paraccel.Driver"));
