...
public class TPostgresqlSCDEndJava {
  protected static String nl;
  public static synchronized TPostgresqlSCDEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresqlSCDEndJava result = new TPostgresqlSCDEndJava();
    nl = null;
    return result;
  }
