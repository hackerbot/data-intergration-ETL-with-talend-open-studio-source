...
public class TInformixOutputMainJava {
  protected static String nl;
  public static synchronized TInformixOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInformixOutputMainJava result = new TInformixOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_425 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_484 = ".prepareStatement(delete_";
  protected final String TEXT_485 = ");" + NL + "\t    ";
  protected final String TEXT_486 = NL + "       \t";
  protected final String TEXT_487 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_488 = " = insert_";
  protected final String TEXT_489 = ".split(\"\\\\?\");";
  protected final String TEXT_490 = NL + "\t\t\tupdate_";
  protected final String TEXT_491 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_492 = " = update_";
  protected final String TEXT_493 = ".split(\"\\\\?\");";
  protected final String TEXT_494 = NL + "\t\t\tupdate_";
  protected final String TEXT_495 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_496 = " = update_";
  protected final String TEXT_497 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_498 = " = insert_";
  protected final String TEXT_499 = ".split(\"\\\\?\");";
  protected final String TEXT_500 = NL + "\t\t\tdelete_";
  protected final String TEXT_501 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_502 = " = delete_";
  protected final String TEXT_503 = ".split(\"\\\\?\");";
  protected final String TEXT_504 = NL + "\t\t\treplace_";
  protected final String TEXT_505 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_506 = " = replace_";
  protected final String TEXT_507 = ".split(\"\\\\?\");";
  protected final String TEXT_508 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_509 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_510 = " = insertIgnore_";
  protected final String TEXT_511 = ".split(\"\\\\?\");";
  protected final String TEXT_512 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_513 = " = insert_";
  protected final String TEXT_514 = ".split(\"\\\\?\");";
  protected final String TEXT_515 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_516 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_517 = " = buffersSize_";
  protected final String TEXT_518 = ";";
  protected final String TEXT_519 = NL + "\t\t\t\t\tbatchSize_";
  protected final String TEXT_520 = " = buffersSize_";
  protected final String TEXT_521 = ";";
  protected final String TEXT_522 = NL + NL;
  protected final String TEXT_523 = NL + "        whetherReject_";
  protected final String TEXT_524 = " = false;";
  protected final String TEXT_525 = NL + "                    ";
  protected final String TEXT_526 = NL + "                        query_";
  protected final String TEXT_527 = " = ";
  protected final String TEXT_528 = ";";
  protected final String TEXT_529 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_530 = ",";
  protected final String TEXT_531 = ".";
  protected final String TEXT_532 = ", ";
  protected final String TEXT_533 = ",insertSQLSplits_";
  protected final String TEXT_534 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_535 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_536 = ".";
  protected final String TEXT_537 = ", pstmt_";
  protected final String TEXT_538 = ", ";
  protected final String TEXT_539 = ", \"";
  protected final String TEXT_540 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_541 = NL + "                globalMap.put(\"";
  protected final String TEXT_542 = "_QUERY\", query_";
  protected final String TEXT_543 = ".toString().trim());";
  protected final String TEXT_544 = NL;
  protected final String TEXT_545 = NL + "    \t\tpstmt_";
  protected final String TEXT_546 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_547 = "++;" + NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_548 = "++;";
  protected final String TEXT_549 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_550 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_551 = " = insertedCount_";
  protected final String TEXT_552 = " + pstmt_";
  protected final String TEXT_553 = ".executeUpdate();";
  protected final String TEXT_554 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_555 = " = true;";
  protected final String TEXT_556 = NL + "                    throw(e);";
  protected final String TEXT_557 = NL + "                        ";
  protected final String TEXT_558 = " = new ";
  protected final String TEXT_559 = "Struct();";
  protected final String TEXT_560 = NL + "                            ";
  protected final String TEXT_561 = ".";
  protected final String TEXT_562 = " = ";
  protected final String TEXT_563 = ".";
  protected final String TEXT_564 = ";";
  protected final String TEXT_565 = NL + "                        rejectedCount_";
  protected final String TEXT_566 = " = rejectedCount_";
  protected final String TEXT_567 = " + 1;";
  protected final String TEXT_568 = NL + "                        ";
  protected final String TEXT_569 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_570 = NL + "                        ";
  protected final String TEXT_571 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_572 = ";";
  protected final String TEXT_573 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_616 = "++;" + NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_617 = "++;";
  protected final String TEXT_618 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_619 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_620 = " = updatedCount_";
  protected final String TEXT_621 = " + pstmt_";
  protected final String TEXT_622 = ".executeUpdate();" + NL + "        \t    ";
  protected final String TEXT_623 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_624 = " = true;";
  protected final String TEXT_625 = NL + "                    throw(e);";
  protected final String TEXT_626 = NL + "                        ";
  protected final String TEXT_627 = " = new ";
  protected final String TEXT_628 = "Struct();";
  protected final String TEXT_629 = NL + "                            ";
  protected final String TEXT_630 = ".";
  protected final String TEXT_631 = " = ";
  protected final String TEXT_632 = ".";
  protected final String TEXT_633 = ";";
  protected final String TEXT_634 = NL + "                        rejectedCount_";
  protected final String TEXT_635 = " = rejectedCount_";
  protected final String TEXT_636 = " + 1;";
  protected final String TEXT_637 = NL + "                        ";
  protected final String TEXT_638 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_639 = NL + "                        ";
  protected final String TEXT_640 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_641 = ";";
  protected final String TEXT_642 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_647 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_648 = " = pstmt_";
  protected final String TEXT_649 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_650 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_651 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_652 = " = rs_";
  protected final String TEXT_653 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_654 = " > 0) {";
  protected final String TEXT_655 = NL + "                        ";
  protected final String TEXT_656 = NL + "                            query_";
  protected final String TEXT_657 = " = ";
  protected final String TEXT_658 = ";";
  protected final String TEXT_659 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_660 = ",";
  protected final String TEXT_661 = ".";
  protected final String TEXT_662 = ", ";
  protected final String TEXT_663 = ",updateSQLSplits_";
  protected final String TEXT_664 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_665 = NL + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_666 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_667 = ".";
  protected final String TEXT_668 = ", pstmtUpdate_";
  ...
  protected final String TEXT_689 = NL + "                    globalMap.put(\"";
  protected final String TEXT_690 = "_QUERY\", query_";
  protected final String TEXT_691 = ".toString().trim());";
  protected final String TEXT_692 = NL + "                try {" + NL + "                    updatedCount_";
  ...
  protected final String TEXT_697 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_698 = " = true;";
  protected final String TEXT_699 = NL + "                        throw(e);";
  protected final String TEXT_700 = NL + "                    \tnb_line_";
  protected final String TEXT_701 = "++;" + NL + "                    \t";
  protected final String TEXT_702 = NL + "                            ";
  protected final String TEXT_703 = " = new ";
  protected final String TEXT_704 = "Struct();";
  protected final String TEXT_705 = NL + "                                ";
  protected final String TEXT_706 = ".";
  protected final String TEXT_707 = " = ";
  protected final String TEXT_708 = ".";
  protected final String TEXT_709 = ";";
  protected final String TEXT_710 = NL + "                            rejectedCount_";
  protected final String TEXT_711 = " = rejectedCount_";
  protected final String TEXT_712 = " + 1;";
  protected final String TEXT_713 = NL + "                            ";
  protected final String TEXT_714 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_715 = NL + "                            ";
  protected final String TEXT_716 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_717 = ";";
  protected final String TEXT_718 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_744 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_745 = " = true;";
  protected final String TEXT_746 = NL + "                        throw(e);";
  protected final String TEXT_747 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_767 = NL + "            int updateFlag_";
  protected final String TEXT_768 = "=0;";
  protected final String TEXT_769 = NL + "                    ";
  protected final String TEXT_770 = NL + "                        query_";
  protected final String TEXT_771 = " = ";
  protected final String TEXT_772 = ";";
  protected final String TEXT_773 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_774 = ",";
  protected final String TEXT_775 = ".";
  protected final String TEXT_776 = ", ";
  protected final String TEXT_777 = ",updateSQLSplits_";
  protected final String TEXT_778 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_779 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_780 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_781 = ".";
  protected final String TEXT_782 = ", pstmtUpdate_";
  ...
  protected final String TEXT_807 = NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_808 = "=pstmtUpdate_";
  protected final String TEXT_809 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_810 = " = updatedCount_";
  protected final String TEXT_811 = " + updateFlag_";
  protected final String TEXT_812 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_813 = " == 0) {" + NL + "            \t";
  protected final String TEXT_814 = NL + "\t\t\t\tquery_";
  protected final String TEXT_815 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_816 = NL + "                        ";
  protected final String TEXT_817 = NL + "                            query_";
  protected final String TEXT_818 = " = ";
  protected final String TEXT_819 = ";";
  protected final String TEXT_820 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_821 = ",";
  protected final String TEXT_822 = ".";
  protected final String TEXT_823 = ", ";
  protected final String TEXT_824 = ",insertSQLSplits_";
  ...
  protected final String TEXT_835 = NL + "                    insertedCount_";
  protected final String TEXT_836 = " = insertedCount_";
  protected final String TEXT_837 = " + pstmtInsert_";
  protected final String TEXT_838 = ".executeUpdate();" + NL + "             \t\tnb_line_";
  protected final String TEXT_839 = "++;";
  protected final String TEXT_840 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_841 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_842 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_843 = " = true;";
  protected final String TEXT_844 = NL + "                        throw(e);";
  protected final String TEXT_845 = NL + "                    \tnb_line_";
  protected final String TEXT_846 = "++;" + NL + "                    \t";
  protected final String TEXT_847 = NL + "                            ";
  protected final String TEXT_848 = " = new ";
  protected final String TEXT_849 = "Struct();";
  protected final String TEXT_850 = NL + "                                ";
  protected final String TEXT_851 = ".";
  protected final String TEXT_852 = " = ";
  protected final String TEXT_853 = ".";
  protected final String TEXT_854 = ";";
  protected final String TEXT_855 = NL + "                            rejectedCount_";
  protected final String TEXT_856 = " = rejectedCount_";
  protected final String TEXT_857 = " + 1;";
  protected final String TEXT_858 = NL + "                            ";
  protected final String TEXT_859 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_860 = NL + "                            ";
  protected final String TEXT_861 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_862 = ";";
  protected final String TEXT_863 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_874 = NL + "                globalMap.put(\"";
  protected final String TEXT_875 = "_QUERY\", query_";
  protected final String TEXT_876 = ".toString().trim());";
  protected final String TEXT_877 = NL;
  protected final String TEXT_878 = NL + "\t\t    \t\tpstmt_";
  protected final String TEXT_879 = ".addBatch();" + NL + "\t\t    \t\tbatchSizeCounter_";
  protected final String TEXT_880 = "++;" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_881 = "++;" + NL + "    \t\t\t";
  protected final String TEXT_882 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_883 = " = deletedCount_";
  protected final String TEXT_884 = " + pstmt_";
  protected final String TEXT_885 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_886 = "++;";
  protected final String TEXT_887 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_888 = " = true;";
  protected final String TEXT_889 = NL + "                    throw(e);";
  protected final String TEXT_890 = NL + "                \tnb_line_";
  protected final String TEXT_891 = "++;" + NL + "                \t";
  protected final String TEXT_892 = NL + "                        ";
  protected final String TEXT_893 = " = new ";
  protected final String TEXT_894 = "Struct();";
  protected final String TEXT_895 = NL + "                            ";
  protected final String TEXT_896 = ".";
  protected final String TEXT_897 = " = ";
  protected final String TEXT_898 = ".";
  protected final String TEXT_899 = ";";
  protected final String TEXT_900 = NL + "                        rejectedCount_";
  protected final String TEXT_901 = " = rejectedCount_";
  protected final String TEXT_902 = " + 1;";
  protected final String TEXT_903 = NL + "                        ";
  protected final String TEXT_904 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_910 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_921 = NL + "\t\t\t\tif ((batchSize_";
  protected final String TEXT_922 = " > 0) && (batchSize_";
  protected final String TEXT_923 = " <= batchSizeCounter_";
  protected final String TEXT_924 = ")) {" + NL + "                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_925 = " = 0;" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_926 = " = 0;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_927 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_928 = ": pstmt_";
  protected final String TEXT_929 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_930 = " += (countEach_";
  protected final String TEXT_931 = " < 0 ? 0 : countEach_";
  protected final String TEXT_932 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_933 = NL + "            \t    \t";
  protected final String TEXT_934 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_935 = " += countSum_";
  protected final String TEXT_936 = ";" + NL + "            \t    \t";
  protected final String TEXT_937 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_938 = " += countSum_";
  protected final String TEXT_939 = ";" + NL + "            \t    \t";
  protected final String TEXT_940 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_941 = " += countSum_";
  protected final String TEXT_942 = ";" + NL + "            \t    \t";
  protected final String TEXT_943 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_944 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_945 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_946 = NL + "                \t}" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_947 = NL + "            commitCounter_";
  protected final String TEXT_948 = "++;" + NL + "" + NL + "            if(commitEvery_";
  protected final String TEXT_949 = "<=commitCounter_";
  protected final String TEXT_950 = ") {" + NL + "            \t";
  protected final String TEXT_951 = NL + "                conn_";
  protected final String TEXT_952 = ".commit();";
  protected final String TEXT_953 = NL + "                commitCounter_";
  protected final String TEXT_954 = " = 0;" + NL + "" + NL + "            }" + NL;
