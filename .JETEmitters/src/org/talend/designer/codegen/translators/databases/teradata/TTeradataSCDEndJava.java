...
public class TTeradataSCDEndJava {
  protected static String nl;
  public static synchronized TTeradataSCDEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataSCDEndJava result = new TTeradataSCDEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_2 = NL + NL + "        searchingStmt_";
  protected final String TEXT_3 = ".close();" + NL;
  protected final String TEXT_4 = NL + NL + "    insertionStatement_";
  protected final String TEXT_5 = ".close();" + NL;
  protected final String TEXT_6 = NL + NL + "        updateForType1_";
  ...
  protected final String TEXT_10 = NL + NL + "        updateForType3_";
  protected final String TEXT_11 = ".close();" + NL;
  protected final String TEXT_12 = NL + NL + "        if(connection_";
