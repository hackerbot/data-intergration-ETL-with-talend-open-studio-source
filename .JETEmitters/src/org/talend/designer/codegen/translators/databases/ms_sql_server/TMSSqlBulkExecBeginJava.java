...
public class TMSSqlBulkExecBeginJava {
  ...
  protected final String TEXT_43 = NL + "int deletedCount_";
  protected final String TEXT_44 = "=0;";
  protected final String TEXT_45 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_46 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  protected final String TEXT_47 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_48 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_49 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_50 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_51 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_52 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_53 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_54 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_55 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_56 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_57 = " - Written records count: \" + nb_line_";
  protected final String TEXT_58 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_59 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_60 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_61 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_62 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_63 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_64 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_65 = " - Writing the record \" + nb_line_";
  protected final String TEXT_66 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_67 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_68 = " - Processing the record \" + nb_line_";
  protected final String TEXT_69 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_70 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_71 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_72 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_73 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_74 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_75 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_76 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_77 = " - Uses an existing connection ";
  protected final String TEXT_78 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_79 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_80 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_81 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_82 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_83 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_84 = NL + "\t\t\tconn_";
  protected final String TEXT_85 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_86 = ", dbUser_";
  protected final String TEXT_87 = ", dbPwd_";
  protected final String TEXT_88 = ");" + NL + "\t\t\t";
  protected final String TEXT_89 = NL + "\t\t\tconn_";
  protected final String TEXT_90 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_91 = NL + "\t\t\tconn_";
  protected final String TEXT_92 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_93 = NL + "\t\t\tconn_";
  protected final String TEXT_94 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_95 = NL + "\t\t\t\tconn_";
  protected final String TEXT_96 = ".setAutoCommit(";
  protected final String TEXT_97 = ");" + NL + "\t\t\t";
  protected final String TEXT_98 = NL + "\t\t\t\tlog.";
  protected final String TEXT_99 = "(\"";
  protected final String TEXT_100 = " - \" + ";
  protected final String TEXT_101 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_102 = NL + "\t    \t\tlog.";
  protected final String TEXT_103 = "(\"";
  protected final String TEXT_104 = "\");" + NL + "\t\t\t";
  protected final String TEXT_105 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_106 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_107 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_108 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_109 = ": pstmt_";
  protected final String TEXT_110 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_111 = " += (countEach_";
  protected final String TEXT_112 = " < 0 ? 0 : ";
  ...
  protected final String TEXT_122 = NL + "\t" + NL + "\tStringBuffer command_";
  protected final String TEXT_123 = " = new StringBuffer();" + NL + "\tcommand_";
  protected final String TEXT_124 = ".append(";
  protected final String TEXT_125 = ")" + NL + "\t\t.append(\" \\\"\")" + NL + "\t\t.append(";
  protected final String TEXT_126 = ")" + NL + "\t\t.append(\"\\\" queryout \\\"\")" + NL + "\t\t.append(";
  protected final String TEXT_127 = ")" + NL + "\t\t.append(\"\\\" \")" + NL + "\t\t.append(\"";
  protected final String TEXT_128 = "\")" + NL + "\t";
  protected final String TEXT_129 = NL + "\t\t.append(\" -S\")" + NL + "\t\t.append(";
  protected final String TEXT_130 = ")" + NL + "\t";
  protected final String TEXT_131 = NL + "\t\t.append(\" -T\")" + NL + "\t";
  protected final String TEXT_132 = NL + "\t\t.append(\" -U\")" + NL + "\t\t.append(";
  protected final String TEXT_133 = ")" + NL + "\t\t.append(\" -P\")" + NL + "\t\t.append(decryptedPassword_";
  protected final String TEXT_134 = ")" + NL + "\t";
  protected final String TEXT_135 = NL + "\t\t.append(\" -t\")" + NL + "\t\t.append(";
  protected final String TEXT_136 = ")" + NL + "\t\t.append(\" -r\")" + NL + "\t\t.append(";
  protected final String TEXT_137 = ");" + NL + "\t" + NL + "\tRuntime runtime_";
  protected final String TEXT_138 = " = Runtime.getRuntime();" + NL + "\t";
  protected final String TEXT_139 = NL + "\tfinal Process ps";
  protected final String TEXT_140 = " = runtime_";
  protected final String TEXT_141 = ".exec(command_";
  protected final String TEXT_142 = ".toString());" + NL + "\tThread normal_";
  protected final String TEXT_143 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps";
  protected final String TEXT_144 = ".getInputStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_145 = NL + "\t\t\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_146 = NL + "\t\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_147 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_148 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_149 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\treader.close();" + NL + "\t\t\t\t}" + NL + "\t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\t";
  protected final String TEXT_150 = NL + "\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\tnormal_";
  protected final String TEXT_151 = ".start();" + NL + "\tThread error_";
  protected final String TEXT_152 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps";
  protected final String TEXT_153 = ".getErrorStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_154 = NL + "\t\t\t\t\t\t\tSystem.err.println(line);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_155 = NL + "\t\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_156 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_157 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_158 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\treader.close();" + NL + "\t\t\t\t}" + NL + "\t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\t";
  protected final String TEXT_159 = NL + "\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\terror_";
  protected final String TEXT_160 = ".start();" + NL + "\tps";
  protected final String TEXT_161 = ".waitFor();" + NL + "\tnormal_";
  protected final String TEXT_162 = ".interrupt();" + NL + "\terror_";
  protected final String TEXT_163 = ".interrupt();" + NL + "\t";
  protected final String TEXT_164 = NL + "\tString dbschema_";
  protected final String TEXT_165 = " = \"\";" + NL + "\t";
  protected final String TEXT_166 = NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_170 = NL + "\tdbschema_";
  protected final String TEXT_171 = " = (String)globalMap.get(\"";
  protected final String TEXT_172 = "\");" + NL + "\tconn_";
  protected final String TEXT_173 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_174 = "\");";
  protected final String TEXT_175 = NL + "\t\tif (null == conn_";
  protected final String TEXT_176 = ") {" + NL + "\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_177 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\tconn_";
  protected final String TEXT_178 = " = dataSources_";
  protected final String TEXT_179 = ".get(";
  protected final String TEXT_180 = ").getConnection();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_181 = NL + "\t";
  protected final String TEXT_182 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_183 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  protected final String TEXT_184 = ") {" + NL + "\t\t\tconn_";
  protected final String TEXT_185 = " = dataSources_";
  protected final String TEXT_186 = ".get(";
  protected final String TEXT_187 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_188 = NL + "    dbschema_";
  protected final String TEXT_189 = " = ";
  protected final String TEXT_190 = ";" + NL + "    String driverClass_";
  protected final String TEXT_191 = " = \"net.sourceforge.jtds.jdbc.Driver\";" + NL + "\t";
  protected final String TEXT_192 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_193 = ");" + NL + "    String port_";
  protected final String TEXT_194 = " = ";
  protected final String TEXT_195 = ";" + NL + "    String dbname_";
  protected final String TEXT_196 = " = ";
  protected final String TEXT_197 = " ;" + NL + "    String url_";
  protected final String TEXT_198 = " = \"jdbc:jtds:sqlserver://\" + ";
  ...
  protected final String TEXT_205 = "; " + NL + "    }" + NL + "    url_";
  protected final String TEXT_206 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_207 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_227 = NL + "\tString tableName_";
  protected final String TEXT_228 = " = null;\t" + NL + "\tif(dbschema_";
  protected final String TEXT_229 = " == null || dbschema_";
  protected final String TEXT_230 = ".trim().length() == 0) {" + NL + "\t\ttableName_";
  protected final String TEXT_231 = " = ";
  protected final String TEXT_232 = ";" + NL + "\t} else {" + NL + "\t\ttableName_";
  protected final String TEXT_233 = " = dbschema_";
  ...
  protected final String TEXT_239 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_240 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_241 = " - Droping table ";
  protected final String TEXT_242 = "\" + tableName_";
  protected final String TEXT_243 = " + \"";
  protected final String TEXT_244 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_245 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_246 = ".execute(\"";
  protected final String TEXT_247 = "\");" + NL + "\t\t\t";
  protected final String TEXT_248 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_249 = " - Drop table ";
  protected final String TEXT_250 = "\" + tableName_";
  protected final String TEXT_251 = " + \"";
  protected final String TEXT_252 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_253 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_254 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_258 = " - Creating table ";
  protected final String TEXT_259 = "\" + tableName_";
  ...
  protected final String TEXT_266 = " - Create table ";
  protected final String TEXT_267 = "\" + tableName_";
  protected final String TEXT_268 = " + \"";
  protected final String TEXT_269 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_270 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_271 = ".close();" + NL + "\t\t";
  protected final String TEXT_272 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_276 = " - Creating table ";
  protected final String TEXT_277 = "\" + tableName_";
  ...
  protected final String TEXT_284 = " - Create table ";
  protected final String TEXT_285 = "\" + tableName_";
  protected final String TEXT_286 = " + \"";
  protected final String TEXT_287 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_288 = NL + "\t\t\tstmtCreate_";
  protected final String TEXT_289 = ".close();" + NL + "\t\t";
  protected final String TEXT_290 = "   " + NL + "\t\t\t\t";
  protected final String TEXT_291 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_292 = " = conn_";
  protected final String TEXT_293 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_294 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_295 = " = tableNameForSearch_";
  protected final String TEXT_296 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_297 = " = tableNameForSearch_";
  protected final String TEXT_298 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_299 = " = dbMetaData_";
  protected final String TEXT_300 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_301 = ", tableNameForSearch_";
  ...
  protected final String TEXT_311 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_312 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_313 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_314 = " = rsTable_";
  protected final String TEXT_315 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_316 = " = rsTable_";
  protected final String TEXT_317 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_318 = ".equalsIgnoreCase(";
  protected final String TEXT_319 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_320 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_321 = ") || dbschema_";
  protected final String TEXT_322 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_323 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_324 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_325 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_329 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_330 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_331 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_332 = " = rsTable_";
  protected final String TEXT_333 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  protected final String TEXT_334 = " = rsTable_";
  protected final String TEXT_335 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_336 = ".equals(";
  protected final String TEXT_337 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_338 = ".equals(schema_";
  protected final String TEXT_339 = ") || (schema_";
  protected final String TEXT_340 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_341 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_345 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_346 = " = conn_";
  protected final String TEXT_347 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_348 = " = dbMetaData_";
  protected final String TEXT_349 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_350 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_351 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_352 = " == null || dbschema_";
  protected final String TEXT_353 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_354 = " = conn_";
  protected final String TEXT_355 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_356 = " = stmtSchema_";
  protected final String TEXT_357 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_358 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_359 = " = rsSchema_";
  protected final String TEXT_360 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_361 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_362 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_363 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_364 = " = rsTable_";
  protected final String TEXT_365 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_366 = " = rsTable_";
  protected final String TEXT_367 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_368 = ".equals";
  protected final String TEXT_369 = "IgnoreCase";
  protected final String TEXT_370 = "(";
  protected final String TEXT_371 = ") " + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_372 = ".equals";
  protected final String TEXT_373 = "IgnoreCase";
  protected final String TEXT_374 = "(dbschema_";
  protected final String TEXT_375 = ") || ((dbschema_";
  protected final String TEXT_376 = " ==null || dbschema_";
  protected final String TEXT_377 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_378 = ".equals";
  protected final String TEXT_379 = "IgnoreCase";
  protected final String TEXT_380 = "(schema_";
  protected final String TEXT_381 = ")))) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_382 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_383 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_384 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_385 = " = conn_";
  protected final String TEXT_386 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_387 = " = dbMetaData_";
  protected final String TEXT_388 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_389 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_390 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_391 = " = rsTable_";
  protected final String TEXT_392 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_393 = ".equals";
  protected final String TEXT_394 = "IgnoreCase";
  protected final String TEXT_395 = "(";
  protected final String TEXT_396 = ")) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_397 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_398 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_399 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_400 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_404 = " - Creating table ";
  protected final String TEXT_405 = "\" + tableName_";
  protected final String TEXT_406 = " + \"";
  protected final String TEXT_407 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_408 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_409 = ".execute(\"";
  protected final String TEXT_410 = ")\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_411 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_412 = " - Create table ";
  protected final String TEXT_413 = "\" + tableName_";
  protected final String TEXT_414 = " + \"";
  protected final String TEXT_415 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_416 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_417 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_418 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_419 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_420 = " = conn_";
  protected final String TEXT_421 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_422 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_423 = " - Droping table ";
  protected final String TEXT_424 = "\" + tableName_";
  protected final String TEXT_425 = " + \"";
  protected final String TEXT_426 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_427 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_428 = ".execute(\"";
  protected final String TEXT_429 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_430 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_431 = " - Drop table ";
  protected final String TEXT_432 = "\" + tableName_";
  protected final String TEXT_433 = " + \"";
  protected final String TEXT_434 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_435 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_436 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_437 = " = conn_";
  protected final String TEXT_438 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_439 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_440 = " - Creating table ";
  protected final String TEXT_441 = "\" + tableName_";
  protected final String TEXT_442 = " + \"";
  protected final String TEXT_443 = ".\" );" + NL + "\t\t\t\t";
  protected final String TEXT_444 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_445 = ".execute(\"";
  protected final String TEXT_446 = ")\");" + NL + "\t\t\t\t";
  protected final String TEXT_447 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_448 = " - Create table ";
  protected final String TEXT_449 = "\" + tableName_";
  protected final String TEXT_450 = " + \"";
  protected final String TEXT_451 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_452 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_453 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_454 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  ...
  protected final String TEXT_458 = " - Clearing table ";
  protected final String TEXT_459 = "\" + tableName_";
  ...
  protected final String TEXT_465 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_466 = "- Clear table ";
  protected final String TEXT_467 = "\" + tableName_";
  protected final String TEXT_468 = " + \"";
  protected final String TEXT_469 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_470 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_471 = ".close();" + NL + "\t\t";
  protected final String TEXT_472 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_473 = " = conn_";
  protected final String TEXT_474 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_475 = " = stmtTruncCount_";
  protected final String TEXT_476 = ".executeQuery(\"";
  protected final String TEXT_477 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_481 = " - Trancating table ";
  protected final String TEXT_482 = "\" + tableName_";
  protected final String TEXT_483 = " + \"";
  protected final String TEXT_484 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_485 = NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_486 = ".executeUpdate(\"";
  protected final String TEXT_487 = "\");" + NL + "   \t    \t";
  protected final String TEXT_488 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_489 = " - Truncate table ";
  protected final String TEXT_490 = "\" + tableName_";
  protected final String TEXT_491 = " + \"";
  protected final String TEXT_492 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_493 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_494 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_495 = " += rsTruncCount_";
  protected final String TEXT_496 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_497 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_498 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_499 = ".close();" + NL + "\t\t";
  protected final String TEXT_500 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_501 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_502 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_503 = NL + "    \t";
  protected final String TEXT_504 = NL + "    \t\tjava.sql.Statement stmtBulkInsert_";
  protected final String TEXT_505 = " = conn_";
  protected final String TEXT_506 = ".createStatement();" + NL + "    \t\tString bulkSQL_";
  protected final String TEXT_507 = " = \"BULK INSERT ";
  protected final String TEXT_508 = "\" + tableName_";
  protected final String TEXT_509 = " + \"";
  protected final String TEXT_510 = " FROM '\" + ";
  protected final String TEXT_511 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_512 = " + \"',DATAFILETYPE='";
  protected final String TEXT_513 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_514 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_515 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_516 = "+\"')\";" + NL + "    \t\t";
  protected final String TEXT_517 = NL + "    \t\t\tlog.debug(\"";
  protected final String TEXT_518 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_519 = "+\".\");" + NL + "    \t\t\tlog.info(\"";
  protected final String TEXT_520 = " - Bulk inserting data into ";
  protected final String TEXT_521 = "\" + tableName_";
  protected final String TEXT_522 = " + \"";
  protected final String TEXT_523 = ".\" );" + NL + "    \t\t";
  protected final String TEXT_524 = NL + "    \t\tstmtBulkInsert_";
  protected final String TEXT_525 = ".execute(bulkSQL_";
  protected final String TEXT_526 = ");" + NL + "    \t\tstmtBulkInsert_";
  protected final String TEXT_527 = ".close();" + NL + "    \t\t";
  protected final String TEXT_528 = NL + "    \t\t\tlog.info(\"";
  protected final String TEXT_529 = " - Bulk insert data into ";
  protected final String TEXT_530 = "\" + tableName_";
  protected final String TEXT_531 = " + \"";
  protected final String TEXT_532 = " has finished.\");" + NL + "    \t\t";
  protected final String TEXT_533 = NL + "    \t\t\tint keyCount_";
  protected final String TEXT_534 = " = ";
  protected final String TEXT_535 = ";" + NL + "    \t\t\tif(keyCount_";
  protected final String TEXT_536 = " == 0) {" + NL + "    \t\t\t\tthrow new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "    \t\t\t}" + NL + "    \t\t\tString tmpTableName_";
  protected final String TEXT_537 = " = tableName_";
  protected final String TEXT_538 = ";" + NL + "    \t\t\ttableName_";
  protected final String TEXT_539 = " = \"tmp_";
  protected final String TEXT_540 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_544 = " - Creating temp table ";
  protected final String TEXT_545 = "\" + tableName_";
  protected final String TEXT_546 = " + \"";
  protected final String TEXT_547 = ".\" );" + NL + "    \t\t\t";
  protected final String TEXT_548 = NL + "    \t\t\tstmtCreateTmp_";
  protected final String TEXT_549 = ".execute(\"";
  protected final String TEXT_550 = ")\");" + NL + "    \t\t\t";
  protected final String TEXT_551 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_552 = " - Create temp table ";
  protected final String TEXT_553 = "\" + tableName_";
  protected final String TEXT_554 = " + \"";
  protected final String TEXT_555 = " has succeeded.\");" + NL + "    \t\t\t";
  protected final String TEXT_556 = NL + "    \t\t\tstmtCreateTmp_";
  protected final String TEXT_557 = ".close();" + NL + "    \t\t\tjava.sql.Statement stmtTmpBulk_";
  protected final String TEXT_558 = " = conn_";
  protected final String TEXT_559 = ".createStatement();" + NL + "    \t\t\tString bulkSQL_";
  protected final String TEXT_560 = " = \"BULK INSERT ";
  protected final String TEXT_561 = "\" + tableName_";
  protected final String TEXT_562 = " + \"";
  protected final String TEXT_563 = " FROM '\" + ";
  protected final String TEXT_564 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_565 = " + \"',DATAFILETYPE='";
  protected final String TEXT_566 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_567 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_568 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_569 = "+\"')\";" + NL + "    \t\t\t";
  protected final String TEXT_570 = NL + "    \t\t\t\tlog.debug(\"";
  protected final String TEXT_571 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_572 = "+\".\");" + NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_573 = " - Bulk inserting data into ";
  protected final String TEXT_574 = "\" + tableName_";
  protected final String TEXT_575 = " + \"";
  protected final String TEXT_576 = ".\" );" + NL + "    \t\t\t";
  protected final String TEXT_577 = NL + "    \t\t\tstmtTmpBulk_";
  protected final String TEXT_578 = ".execute(bulkSQL_";
  protected final String TEXT_579 = ");" + NL + "    \t\t\tstmtTmpBulk_";
  protected final String TEXT_580 = ".close();" + NL + "    \t\t\t";
  protected final String TEXT_581 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_582 = " - Bulk insert data into ";
  protected final String TEXT_583 = "\" + tableName_";
  protected final String TEXT_584 = " + \"";
  protected final String TEXT_585 = " has finished.\");" + NL + "    \t\t\t";
  protected final String TEXT_586 = NL + "    \t\t\ttableName_";
  protected final String TEXT_587 = " = tmpTableName_";
  protected final String TEXT_588 = ";" + NL + "    \t\t\ttmpTableName_";
  protected final String TEXT_589 = " = \"tmp_";
  protected final String TEXT_590 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_591 = " = conn_";
  protected final String TEXT_592 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_593 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_594 = " - Updating ";
  protected final String TEXT_595 = "\" + tableName_";
  protected final String TEXT_596 = " + \"";
  protected final String TEXT_597 = " from ";
  protected final String TEXT_598 = "\"+tmpTableName_";
  protected final String TEXT_599 = "+\"";
  protected final String TEXT_600 = ".\");" + NL + "    \t\t\t";
  protected final String TEXT_601 = NL + "    \t\t\tstmtUpdateBulk_";
  protected final String TEXT_602 = ".executeUpdate(\"";
  protected final String TEXT_603 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_604 = NL + "    \t\t\tstmtUpdateBulk_";
  protected final String TEXT_605 = ".close();" + NL + "    \t\t\ttableName_";
  protected final String TEXT_606 = " = \"tmp_";
  protected final String TEXT_607 = "\" + \"_\" +pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtTmpDrop_";
  protected final String TEXT_608 = " = conn_";
  protected final String TEXT_609 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_610 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_611 = " - Droping temp table ";
  protected final String TEXT_612 = "\" + tableName_";
  protected final String TEXT_613 = " + \"";
  protected final String TEXT_614 = ".\");" + NL + "    \t\t\t";
  protected final String TEXT_615 = NL + "    \t\t\tstmtTmpDrop_";
  protected final String TEXT_616 = ".execute(\"";
  protected final String TEXT_617 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_618 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_619 = " - Drop temp table ";
  protected final String TEXT_620 = "\" + tableName_";
  protected final String TEXT_621 = "+ \"";
  protected final String TEXT_622 = " has succeeded.\");" + NL + "    \t\t\t";
  protected final String TEXT_623 = NL + "    \t\t\tstmtTmpDrop_";
  protected final String TEXT_624 = ".close();" + NL + "    \t\t\t";
  protected final String TEXT_625 = NL + "\t\tif(conn_";
  protected final String TEXT_626 = " != null && !conn_";
  protected final String TEXT_627 = ".isClosed()) {" + NL + "\t\t   ";
...
if(("EXPORT").equals(action)) {
    ...
    stringBuffer.append(bcp_utility);
    stringBuffer.append(TEXT_125);
    stringBuffer.append(query_statement);
    stringBuffer.append(TEXT_126);
    stringBuffer.append(output_file_name);
    stringBuffer.append(TEXT_127);
    stringBuffer.append(char_type);
    ...
    stringBuffer.append(row_terminated_export);
