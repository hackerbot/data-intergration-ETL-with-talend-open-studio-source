...
public class TSQLiteOutputMainJava {
  protected static String nl;
  public static synchronized TSQLiteOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLiteOutputMainJava result = new TSQLiteOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_51 = NL + "            batchSize_";
  protected final String TEXT_52 = " = buffersSize_";
  protected final String TEXT_53 = ";";
  protected final String TEXT_54 = NL + "        whetherReject_";
  ...
  protected final String TEXT_61 = "_QUERY\", query_";
  protected final String TEXT_62 = ".toString().trim());";
  protected final String TEXT_63 = NL;
  protected final String TEXT_64 = NL + "                       pstmt_";
  protected final String TEXT_65 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_66 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_67 = "++;";
  protected final String TEXT_68 = NL + "                       try {" + NL + "                           insertedCount_";
  protected final String TEXT_69 = " = insertedCount_";
  protected final String TEXT_70 = " + pstmt_";
  protected final String TEXT_71 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_72 = "++;";
  protected final String TEXT_73 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  protected final String TEXT_74 = " = true;";
  protected final String TEXT_75 = NL + "                               throw(e);";
  ...
  protected final String TEXT_84 = NL + "                                   nb_line_rejected_";
  protected final String TEXT_85 = "++;";
  protected final String TEXT_86 = NL + "                                   ";
  protected final String TEXT_87 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_88 = NL + "                                   ";
  protected final String TEXT_89 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_90 = ";";
  protected final String TEXT_91 = NL + "                                   System.err.print(e.getMessage());";
  ...
  protected final String TEXT_99 = NL + "                        query_";
  protected final String TEXT_100 = " = ";
  protected final String TEXT_101 = ";";
  protected final String TEXT_102 = NL + "                    ";
  protected final String TEXT_103 = NL + "                        query_";
  protected final String TEXT_104 = " = ";
  protected final String TEXT_105 = ";";
  protected final String TEXT_106 = NL + "                globalMap.put(\"";
  protected final String TEXT_107 = "_QUERY\", query_";
  protected final String TEXT_108 = ".toString().trim());";
  protected final String TEXT_109 = NL;
  protected final String TEXT_110 = NL + "                       pstmt_";
  protected final String TEXT_111 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_112 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_113 = "++;";
  protected final String TEXT_114 = NL + "                        try {" + NL + "                            updatedCount_";
  protected final String TEXT_115 = " = updatedCount_";
  protected final String TEXT_116 = " + pstmt_";
  protected final String TEXT_117 = ".executeUpdate();" + NL + "                            nb_line_";
  protected final String TEXT_118 = "++;";
  protected final String TEXT_119 = NL + "                        } catch(java.lang.Exception e) {" + NL + "                            whetherReject_";
  ...
  protected final String TEXT_130 = NL + "                                    nb_line_rejected_";
  ...
  protected final String TEXT_144 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_145 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_146 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_147 = " = rs_";
  protected final String TEXT_148 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_149 = " > 0) {";
  protected final String TEXT_150 = NL + "                        ";
  protected final String TEXT_151 = NL + "                            query_";
  protected final String TEXT_152 = " = ";
  protected final String TEXT_153 = ";";
  protected final String TEXT_154 = NL + "\t                    \t";
  protected final String TEXT_155 = NL + "\t                    ";
  protected final String TEXT_156 = NL + "\t                        query_";
  protected final String TEXT_157 = " = ";
  protected final String TEXT_158 = ";" + NL + "\t                        ";
  protected final String TEXT_159 = NL + "                        ";
  protected final String TEXT_160 = NL + "                            query_";
  protected final String TEXT_161 = " = ";
  protected final String TEXT_162 = ";";
  protected final String TEXT_163 = NL + "                    globalMap.put(\"";
  protected final String TEXT_164 = "_QUERY\", query_";
  protected final String TEXT_165 = ".toString().trim());";
  protected final String TEXT_166 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_167 = " = updatedCount_";
  protected final String TEXT_168 = " + pstmtUpdate_";
  protected final String TEXT_169 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_170 = "++;";
  protected final String TEXT_171 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_172 = " = true;";
  protected final String TEXT_173 = NL + "                        throw(e);";
  ...
  protected final String TEXT_184 = NL + "                            nb_line_rejected_";
  protected final String TEXT_185 = "++;";
  protected final String TEXT_186 = NL + "                            ";
  protected final String TEXT_187 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_188 = NL + "                            ";
  protected final String TEXT_189 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_190 = ";";
  protected final String TEXT_191 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_192 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_193 = NL + "                        ";
  protected final String TEXT_194 = NL + "                            query_";
  protected final String TEXT_195 = " = ";
  protected final String TEXT_196 = ";";
  protected final String TEXT_197 = NL + "                    globalMap.put(\"";
  protected final String TEXT_198 = "_QUERY\", query_";
  protected final String TEXT_199 = ".toString().trim());";
  protected final String TEXT_200 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_201 = " = insertedCount_";
  protected final String TEXT_202 = " + pstmtInsert_";
  protected final String TEXT_203 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_204 = "++;";
  protected final String TEXT_205 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_206 = " = true;";
  protected final String TEXT_207 = NL + "                        throw(e);";
  protected final String TEXT_208 = NL + "                        nb_line_";
  ...
  protected final String TEXT_218 = NL + "                            nb_line_rejected_";
  protected final String TEXT_219 = "++;";
  protected final String TEXT_220 = NL + "                            ";
  protected final String TEXT_221 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_222 = NL + "                            ";
  protected final String TEXT_223 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_224 = ";";
  protected final String TEXT_225 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_226 = NL + "                }" + NL + "            }";
  protected final String TEXT_227 = NL + "            int updateFlag_";
  protected final String TEXT_228 = "=0;";
  protected final String TEXT_229 = NL + "                    ";
  protected final String TEXT_230 = NL + "                        query_";
  protected final String TEXT_231 = " = ";
  protected final String TEXT_232 = ";";
  protected final String TEXT_233 = NL + "\t\t\t\t\t";
  protected final String TEXT_234 = NL + "                    \t";
  protected final String TEXT_235 = NL + "\t                        query_";
  protected final String TEXT_236 = " = ";
  protected final String TEXT_237 = ";" + NL + "\t                        ";
  protected final String TEXT_238 = NL + "                    ";
  protected final String TEXT_239 = NL + "                        query_";
  protected final String TEXT_240 = " = ";
  protected final String TEXT_241 = ";";
  protected final String TEXT_242 = NL + "                globalMap.put(\"";
  protected final String TEXT_243 = "_QUERY\", query_";
  protected final String TEXT_244 = ".toString().trim());";
  protected final String TEXT_245 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_246 = "=pstmtUpdate_";
  protected final String TEXT_247 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_248 = " = updatedCount_";
  protected final String TEXT_249 = " + updateFlag_";
  protected final String TEXT_250 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_251 = " = true;";
  protected final String TEXT_252 = NL + "                    throw(e);";
  ...
  protected final String TEXT_261 = NL + "                        nb_line_rejected_";
  protected final String TEXT_262 = "++;";
  protected final String TEXT_263 = NL + "                        ";
  protected final String TEXT_264 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_265 = NL + "                        ";
  protected final String TEXT_266 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_267 = ";";
  protected final String TEXT_268 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_269 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_270 = " == 0) {" + NL + "            \t";
  protected final String TEXT_271 = NL + "\t\t\t\tquery_";
  protected final String TEXT_272 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_273 = NL + "                        ";
  protected final String TEXT_274 = NL + "                            query_";
  protected final String TEXT_275 = " = ";
  protected final String TEXT_276 = ";";
  protected final String TEXT_277 = NL + "                    globalMap.put(\"";
  protected final String TEXT_278 = "_QUERY\", query_";
  protected final String TEXT_279 = ".toString().trim());";
  protected final String TEXT_280 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_281 = " = insertedCount_";
  protected final String TEXT_282 = " + pstmtInsert_";
  protected final String TEXT_283 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_284 = "++;";
  protected final String TEXT_285 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_286 = " = true;";
  protected final String TEXT_287 = NL + "                        throw(e);";
  protected final String TEXT_288 = NL + "                        nb_line_";
  protected final String TEXT_289 = "++;";
  protected final String TEXT_290 = NL + "                            ";
  protected final String TEXT_291 = " = new ";
  protected final String TEXT_292 = "Struct();";
  ...
  protected final String TEXT_301 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_302 = NL + "                            ";
  protected final String TEXT_303 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_304 = ";";
  protected final String TEXT_305 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_306 = NL + "                }" + NL + "            }else{" + NL + "            \tnb_line_";
  protected final String TEXT_307 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_308 = NL + "            }";
  protected final String TEXT_309 = NL + "\t\t\t\t\t";
  protected final String TEXT_310 = NL + "                    \t";
  protected final String TEXT_311 = NL + "\t                        query_";
  ...
  protected final String TEXT_319 = "_QUERY\", query_";
  protected final String TEXT_320 = ".toString().trim());";
  protected final String TEXT_321 = NL + "                     pstmt_";
  protected final String TEXT_322 = ".addBatch();" + NL + "                     batchSizeCounter_";
  protected final String TEXT_323 = "++;" + NL + "                     nb_line_";
  protected final String TEXT_324 = "++;";
  protected final String TEXT_325 = NL + "                      try {" + NL + "                          deletedCount_";
  protected final String TEXT_326 = " = deletedCount_";
  protected final String TEXT_327 = " + pstmt_";
  protected final String TEXT_328 = ".executeUpdate();" + NL + "                          nb_line_";
  protected final String TEXT_329 = "++;";
  protected final String TEXT_330 = NL + "                      } catch(java.lang.Exception e) {" + NL + "                          whetherReject_";
  protected final String TEXT_331 = " = true;";
  protected final String TEXT_332 = NL + "                              throw(e);";
  protected final String TEXT_333 = NL + "                               nb_line_";
  protected final String TEXT_334 = "++;";
  protected final String TEXT_335 = NL + "                                  ";
  protected final String TEXT_336 = " = new ";
  protected final String TEXT_337 = "Struct();";
  protected final String TEXT_338 = NL + "                                      ";
  protected final String TEXT_339 = ".";
  protected final String TEXT_340 = " = ";
  protected final String TEXT_341 = ".";
  protected final String TEXT_342 = ";";
  protected final String TEXT_343 = NL + "                                  nb_line_rejected_";
  protected final String TEXT_344 = "++;";
  protected final String TEXT_345 = NL + "                                  ";
  protected final String TEXT_346 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_347 = NL + "                                  ";
  protected final String TEXT_348 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_349 = ";";
  protected final String TEXT_350 = NL + "                                  System.err.print(e.getMessage());";
  ...
  protected final String TEXT_364 = " > 0) && (batchSize_";
  protected final String TEXT_365 = " <= batchSizeCounter_";
  protected final String TEXT_366 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_367 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_368 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_369 = " = 0;";
  protected final String TEXT_370 = NL + "                        status_";
  protected final String TEXT_371 = " = pstmt_";
  protected final String TEXT_372 = ".executeBatch();";
  protected final String TEXT_373 = NL + "                        for(int countEach_";
  protected final String TEXT_374 = ": status_";
  protected final String TEXT_375 = ") {" + NL + "                            countSum_";
  protected final String TEXT_376 = " += (countEach_";
  protected final String TEXT_377 = " < 0 ? 0 : countEach_";
  protected final String TEXT_378 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_379 = NL + "                            throw(e);";
  protected final String TEXT_380 = NL + "                        for(int countEach_";
  protected final String TEXT_381 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_382 = " += (countEach_";
  protected final String TEXT_383 = " < 0 ? 0 : countEach_";
  protected final String TEXT_384 = ");" + NL + "                        }";
  protected final String TEXT_385 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_386 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_387 = " = pstmt_";
  protected final String TEXT_388 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_389 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_390 = " = tmp_batchUpdateCount_";
  protected final String TEXT_391 = " > countSum_";
  protected final String TEXT_392 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_393 = " : countSum_";
  protected final String TEXT_394 = ";";
  protected final String TEXT_395 = NL + "                        insertedCount_";
  protected final String TEXT_396 = " += tmp_batchUpdateCount_";
  protected final String TEXT_397 = ";";
  protected final String TEXT_398 = NL + "                        updatedCount_";
  protected final String TEXT_399 = " += tmp_batchUpdateCount_";
  protected final String TEXT_400 = ";";
  protected final String TEXT_401 = NL + "                        deletedCount_";
  protected final String TEXT_402 = " += tmp_batchUpdateCount_";
  protected final String TEXT_403 = ";";
  protected final String TEXT_404 = NL + "               }";
  protected final String TEXT_405 = NL + "                commitCounter_";
  protected final String TEXT_406 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_407 = " <= commitCounter_";
  protected final String TEXT_408 = ") {";
  protected final String TEXT_409 = NL + "                               if(batchSize_";
  protected final String TEXT_410 = " > 0){";
  protected final String TEXT_411 = NL + "                                     conn_";
  protected final String TEXT_412 = ".commit();";
  protected final String TEXT_413 = NL + "                                     commitCounter_";
  protected final String TEXT_414 = "=0;" + NL + "                               }";
  protected final String TEXT_415 = NL + "                               conn_";
  protected final String TEXT_416 = ".commit();";
  protected final String TEXT_417 = NL + "                               commitCounter_";
  protected final String TEXT_418 = "=0;";
