...
public class TAS400OutputBeginJava {
  ...
  protected final String TEXT_57 = " = 0;" + NL + "" + NL + "int nb_line_rejected_";
  protected final String TEXT_58 = " = 0;" + NL + "int rejectedCount_";
  protected final String TEXT_59 = "=0;" + NL + "int tmp_batchUpdateCount_";
  protected final String TEXT_60 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_61 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_62 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_63 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_64 = " = ";
  protected final String TEXT_65 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_66 = " = false;" + NL + NL;
  protected final String TEXT_67 = NL + "    java.sql.Connection conn_";
  protected final String TEXT_68 = " = (java.sql.Connection)globalMap.get(\"";
  ...
  protected final String TEXT_76 = " = \"jdbc:as400://\" + ";
  protected final String TEXT_77 = " + \"/\" + ";
  protected final String TEXT_78 = ";" + NL + "    } else {" + NL + "        url_";
  protected final String TEXT_79 = " = \"jdbc:as400://\" + ";
  protected final String TEXT_80 = " + \"/\" + ";
  protected final String TEXT_81 = "+ \";\" + ";
  protected final String TEXT_82 = ";" + NL + "    }" + NL + "    String dbUser_";
  ...
  protected final String TEXT_94 = ";" + NL + "" + NL + "    java.lang.Class.forName(\"com.ibm.as400.access.AS400JDBCDriver\");";
  ...
  protected final String TEXT_100 = NL + NL + "    resourceMap.put(\"conn_";
  protected final String TEXT_101 = "\", conn_";
  protected final String TEXT_102 = ");";
  protected final String TEXT_103 = NL + "            conn_";
  protected final String TEXT_104 = ".setAutoCommit(false);" + NL + "            int commitEvery_";
  protected final String TEXT_105 = " = ";
  protected final String TEXT_106 = ";" + NL + "            int commitCounter_";
  protected final String TEXT_107 = " = 0;";
  protected final String TEXT_108 = NL + "       int batchSize_";
  protected final String TEXT_109 = " = ";
  protected final String TEXT_110 = ";" + NL + "       int batchSizeCounter_";
  protected final String TEXT_111 = "=0;";
  protected final String TEXT_112 = NL + "int count_";
  protected final String TEXT_113 = "=0;";
  protected final String TEXT_114 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_115 = " = conn_";
  protected final String TEXT_116 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_117 = NL + "            stmtDrop_";
  protected final String TEXT_118 = ".execute(\"";
  protected final String TEXT_119 = "\" ";
  protected final String TEXT_120 = ");" + NL + "\t\t\t";
  protected final String TEXT_121 = NL + "            stmtDrop_";
  protected final String TEXT_122 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_123 = " = conn_";
  protected final String TEXT_124 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_125 = NL + "\t\t\t";
  protected final String TEXT_126 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_127 = ".execute(((\"";
  protected final String TEXT_128 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_129 = ".";
  protected final String TEXT_130 = ", \"";
  protected final String TEXT_131 = "\")";
  protected final String TEXT_132 = ".toUpperCase()";
  ...
  protected final String TEXT_141 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_162 = NL + "\t\t    \t\tString keyCheckTable_";
  protected final String TEXT_163 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_164 = "+\"][\"+";
  protected final String TEXT_165 = "+\"][\"+";
  protected final String TEXT_166 = "+\"][\"+";
  protected final String TEXT_167 = "+\"][\"+";
  protected final String TEXT_168 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_169 = " + \"]\";" + NL + "\t\t    \t";
  protected final String TEXT_170 = NL + "        \t\t    // [%connection%][checktable][tableName]" + NL + "        \t\t    String keyCheckTable_";
  protected final String TEXT_171 = " = conn_";
  protected final String TEXT_172 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_173 = " + \"]\";" + NL + "    \t\t    ";
  protected final String TEXT_174 = NL + "\t\t    " + NL + "\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_175 = ")== null){//}" + NL + "\t\t\t" + NL + "\t\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_176 = ")) {//}" + NL + "\t\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_177 = ")== null){//}" + NL + "\t\t\t";
  protected final String TEXT_178 = "              " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_179 = NL + "    \t\t\t\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_180 = " = conn_";
  protected final String TEXT_181 = ".createStatement();" + NL + "                \t\t\t\tboolean whetherExist_";
  protected final String TEXT_182 = " = false;" + NL + "                \t\t\t\ttry {" + NL + "                \t\t\t\t\tisExistStmt_";
  protected final String TEXT_183 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_184 = " + \"]\" );" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_185 = " = true;" + NL + "                \t\t\t\t} catch (java.lang.Exception e){" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_186 = " = false;" + NL + "                \t\t\t\t}" + NL + "                \t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_191 = ".getMetaData();" + NL + "                \t            if(tableNameForSearch_";
  protected final String TEXT_192 = ".indexOf(\"\\\"\")==-1){" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_193 = " = tableNameForSearch_";
  protected final String TEXT_194 = ".toUpperCase();" + NL + "                            \t}else{" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_195 = " = tableNameForSearch_";
  protected final String TEXT_196 = ".replaceAll(\"\\\"\",\"\");" + NL + "                            \t}" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_197 = " = dbMetaData_";
  protected final String TEXT_198 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_199 = ", tableNameForSearch_";
  protected final String TEXT_200 = ", new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_201 = " = false;" + NL + "                \t            if(rsTable_";
  protected final String TEXT_202 = ".next()) {" + NL + "                \t            \twhetherExist_";
  protected final String TEXT_203 = " = true;" + NL + "                \t            }" + NL + "    \t            \t\t\trsTable_";
  protected final String TEXT_204 = ".close();" + NL + "    \t            " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_235 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_236 = " = rsTable_";
  protected final String TEXT_237 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  ...
  protected final String TEXT_248 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_249 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_258 = " = false;" + NL + "                \t            String defaultSchema_";
  protected final String TEXT_259 = " = \"public\";" + NL + "                \t            if(dbschema_";
  protected final String TEXT_260 = " == null || dbschema_";
  protected final String TEXT_261 = ".trim().length() == 0) {" + NL + "                \t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_262 = " = conn_";
  protected final String TEXT_263 = ".createStatement();" + NL + "                \t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_264 = " = stmtSchema_";
  protected final String TEXT_265 = ".executeQuery(\"select current_schema() \");" + NL + "                \t            \twhile(rsSchema_";
  protected final String TEXT_266 = ".next()){" + NL + "                \t            \t\tdefaultSchema_";
  protected final String TEXT_267 = " = rsSchema_";
  protected final String TEXT_268 = ".getString(\"current_schema\");" + NL + "                \t            \t}" + NL + "                \t            \trsSchema_";
  protected final String TEXT_269 = ".close();" + NL + "                \t            \tstmtSchema_";
  protected final String TEXT_270 = ".close();" + NL + "                \t            }" + NL + "                \t            while(rsTable_";
  ...
  protected final String TEXT_285 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_286 = ".equals";
  protected final String TEXT_287 = "IgnoreCase";
  protected final String TEXT_288 = "(schema_";
  protected final String TEXT_289 = ")))) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_290 = " = true;" + NL + "                \t                    break;" + NL + "                \t                }" + NL + "                \t            }" + NL + "                \t            rsTable_";
  ...
  protected final String TEXT_301 = ".equalsIgnoreCase(";
  protected final String TEXT_302 = ")) {" + NL + "                \t                    whetherExist_";
  ...
  protected final String TEXT_306 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  protected final String TEXT_307 = " = conn_";
  protected final String TEXT_308 = ".createStatement();" + NL + "                        \t\t\t";
  protected final String TEXT_309 = NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_310 = NL + "    \t\t\t\t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_311 = ".execute(((\"";
  protected final String TEXT_312 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_313 = ".";
  protected final String TEXT_314 = ", \"";
  protected final String TEXT_315 = "\")";
  protected final String TEXT_316 = ".toUpperCase()";
  ...
  protected final String TEXT_329 = NL + "                                    stmtDrop_";
  protected final String TEXT_330 = ".execute(\"";
  protected final String TEXT_331 = "\" ";
  protected final String TEXT_332 = ");" + NL + "                \t    \t    \t";
  protected final String TEXT_333 = NL + "                                    stmtDrop_";
  protected final String TEXT_334 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_344 = ".toUpperCase()";
  protected final String TEXT_345 = ")+\")";
  protected final String TEXT_346 = "\"));" + NL + "        \t\t\t\t\t\t\t";
  protected final String TEXT_347 = NL + "        \t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_348 = ".execute(\"";
  protected final String TEXT_349 = ")\");" + NL + "        \t\t\t\t\t\t";
  protected final String TEXT_350 = NL + "        \t    \t    \t\t";
  protected final String TEXT_351 = NL + "                        \t\tstmtCreate_";
  protected final String TEXT_352 = ".close();" + NL + "        \t\t\t\t\t";
  protected final String TEXT_353 = NL + "\t\t\t";
  protected final String TEXT_354 = NL + "    \t\t\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_355 = ", true);" + NL + "    \t\t//{{{" + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_356 = "            ";
  protected final String TEXT_357 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_358 = " = conn_";
  protected final String TEXT_359 = ".createStatement();" + NL + "    \t   \t";
  protected final String TEXT_360 = NL + "            stmtClear_";
  protected final String TEXT_361 = ".executeUpdate(\"";
  protected final String TEXT_362 = "\");" + NL + "   \t    \t";
  protected final String TEXT_363 = NL + "            stmtClear_";
  protected final String TEXT_364 = ".close();" + NL + "\t\t";
  protected final String TEXT_365 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_366 = " = conn_";
  protected final String TEXT_367 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_368 = " = stmtTruncCount_";
  protected final String TEXT_369 = ".executeQuery(\"";
  protected final String TEXT_370 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_371 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_372 = ".next()) {" + NL + "\t\t\t\trsTruncCountNumber_";
  protected final String TEXT_373 = " = rsTruncCount_";
  protected final String TEXT_374 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_375 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_376 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_377 = " = conn_";
  protected final String TEXT_378 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_379 = NL + "\t\t\t";
  protected final String TEXT_380 = NL + "\t\t\t\tconn_";
  ...
  protected final String TEXT_386 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_387 = ".commit();" + NL + "                }";
  protected final String TEXT_388 = NL + "   \t    \t";
  protected final String TEXT_389 = NL + "   \t    \tdeletedCount_";
  protected final String TEXT_390 = " += rsTruncCountNumber_";
  protected final String TEXT_391 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_392 = ".close();            " + NL + "\t\t";
  protected final String TEXT_393 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_394 = " = conn_";
  protected final String TEXT_395 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_396 = " = stmtTruncCount_";
  protected final String TEXT_397 = ".executeQuery(\"";
  protected final String TEXT_398 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_399 = " = conn_";
  protected final String TEXT_400 = ".createStatement();" + NL + "  \t    \t";
  protected final String TEXT_401 = NL + "\t\t\t";
  protected final String TEXT_402 = NL + "\t\t\t\tconn_";
  protected final String TEXT_403 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_404 = NL + "            stmtTrunc_";
  protected final String TEXT_405 = ".executeUpdate(\"";
  protected final String TEXT_406 = "\");" + NL + "   \t    \t";
  protected final String TEXT_407 = NL + "            while(rsTruncCount_";
  protected final String TEXT_408 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_409 = " += rsTruncCount_";
  protected final String TEXT_410 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_411 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_412 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_413 = ".close();" + NL + "\t\t";
  protected final String TEXT_414 = NL + "\t    String insert_";
  protected final String TEXT_415 = " = \"INSERT INTO \" + ";
  protected final String TEXT_416 = " + \" (";
  protected final String TEXT_417 = ") VALUES (";
  protected final String TEXT_418 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_419 = " = conn_";
  protected final String TEXT_420 = ".prepareStatement(insert_";
  protected final String TEXT_421 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  protected final String TEXT_422 = NL + "\t    String update_";
  protected final String TEXT_423 = " = \"UPDATE \" + ";
  protected final String TEXT_424 = " + \" SET ";
  protected final String TEXT_425 = " WHERE ";
  protected final String TEXT_426 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_427 = " = conn_";
  protected final String TEXT_428 = ".prepareStatement(update_";
  protected final String TEXT_429 = ");" + NL + "\t    ";
  protected final String TEXT_430 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_431 = " = conn_";
  protected final String TEXT_432 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_433 = " + \" WHERE ";
  protected final String TEXT_434 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_435 = " = \"INSERT INTO \" + ";
  protected final String TEXT_436 = " + \" (";
  protected final String TEXT_437 = ") VALUES (";
  protected final String TEXT_438 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_442 = " = \"UPDATE \" + ";
  protected final String TEXT_443 = " + \" SET ";
  protected final String TEXT_444 = " WHERE ";
  protected final String TEXT_445 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_446 = " = conn_";
  protected final String TEXT_447 = ".prepareStatement(update_";
  protected final String TEXT_448 = ");" + NL + "\t    ";
  protected final String TEXT_449 = NL + "\t    String update_";
  protected final String TEXT_450 = " = \"UPDATE \" + ";
  protected final String TEXT_451 = " + \" SET ";
  protected final String TEXT_452 = " WHERE ";
  protected final String TEXT_453 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_460 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_461 = " = conn_";
  protected final String TEXT_462 = ".prepareStatement(insert_";
  protected final String TEXT_463 = ");" + NL + "\t    ";
  protected final String TEXT_464 = NL + "\t    String delete_";
  protected final String TEXT_465 = " = \"DELETE FROM \" + ";
  protected final String TEXT_466 = " + \" WHERE ";
  protected final String TEXT_467 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_468 = " = conn_";
  protected final String TEXT_469 = ".prepareStatement(delete_";
  protected final String TEXT_470 = ");" + NL + "\t    ";
  protected final String TEXT_471 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_477 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_478 = " = update_";
  protected final String TEXT_479 = ".split(\"\\\\?\");";
  protected final String TEXT_480 = NL + "\t\t\tupdate_";
  protected final String TEXT_481 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_482 = " = update_";
  protected final String TEXT_483 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_484 = " = insert_";
  protected final String TEXT_485 = ".split(\"\\\\?\");";
  protected final String TEXT_486 = NL + "\t\t\tdelete_";
  protected final String TEXT_487 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_488 = " = delete_";
  protected final String TEXT_489 = ".split(\"\\\\?\");";
  protected final String TEXT_490 = NL + "\t\t\treplace_";
  protected final String TEXT_491 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_492 = " = replace_";
  protected final String TEXT_493 = ".split(\"\\\\?\");";
  protected final String TEXT_494 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_495 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_496 = " = insertIgnore_";
  protected final String TEXT_497 = ".split(\"\\\\?\");";
  protected final String TEXT_498 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_509 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_510 = " =  null;";
  protected final String TEXT_511 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_512 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_516 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_517 = " = null;";
  protected final String TEXT_518 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_522 = NL + NL + NL;
