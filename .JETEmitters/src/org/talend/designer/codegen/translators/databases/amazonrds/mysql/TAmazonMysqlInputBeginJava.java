...
public class TAmazonMysqlInputBeginJava
{
  ...
  protected final String TEXT_183 = NL + "\t\t    java.util.Calendar calendar_";
  protected final String TEXT_184 = " = java.util.Calendar.getInstance();" + NL + "\t\t    calendar_";
  protected final String TEXT_185 = ".set(0, 0, 0, 0, 0, 0);" + NL + "\t\t    java.util.Date year0_";
  protected final String TEXT_186 = " = calendar_";
  protected final String TEXT_187 = ".getTime();";
  ...
  protected final String TEXT_194 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_195 = " + \":\" + ";
  protected final String TEXT_196 = " + \"/\" + ";
  protected final String TEXT_197 = " + \"?\" + ";
  protected final String TEXT_198 = ";";
  protected final String TEXT_199 = NL + "\t\t        ((com.mysql.jdbc.Statement)stmt_";
  protected final String TEXT_200 = ").enableStreamingResults();";
  protected final String TEXT_201 = NL + "\t        if(rs_";
  protected final String TEXT_202 = ".getString(";
  ...
  protected final String TEXT_207 = "column_index_";
  protected final String TEXT_208 = ");" + NL + "\t            if (!(\"0000-00-00\").equals(dateString_";
  protected final String TEXT_209 = ") && !(\"0000-00-00 00:00:00\").equals(dateString_";
  protected final String TEXT_210 = ")) {" + NL + "\t                ";
  protected final String TEXT_211 = ".";
  protected final String TEXT_212 = " = rs_";
  protected final String TEXT_213 = ".getTimestamp(";
  protected final String TEXT_214 = "column_index_";
  protected final String TEXT_215 = ");" + NL + "\t            } else {" + NL + "\t                ";
  protected final String TEXT_216 = ".";
  protected final String TEXT_217 = " = (java.util.Date) year0_";
  protected final String TEXT_218 = ".clone();" + NL + "\t            }" + NL + "\t        } else {" + NL + "\t            ";
  ...
  protected final String TEXT_228 = NL + "\t\t        \tif (null == conn_";
  ...
  protected final String TEXT_238 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_239 = " =  conn_";
  protected final String TEXT_240 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_241 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_242 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_243 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_244 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_245 = NL + "                 conn_";
  protected final String TEXT_246 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_247 = NL + "               ";
  protected final String TEXT_248 = " + \"=\" + ";
  protected final String TEXT_249 = " + \";\" +";
  protected final String TEXT_250 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_251 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_252 = ");";
  protected final String TEXT_253 = NL + "\t\t    ";
  protected final String TEXT_254 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_255 = " = ";
  protected final String TEXT_256 = ";" + NL + "\t\t\t";
  protected final String TEXT_257 = NL + "                log.info(\"";
  protected final String TEXT_258 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_259 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_260 = NL;
  protected final String TEXT_261 = NL + "                       globalMap.put(\"";
  protected final String TEXT_262 = "_QUERY\",dbquery_";
  protected final String TEXT_263 = ");";
  protected final String TEXT_264 = NL + "                       globalMap.put(\"";
  protected final String TEXT_265 = "_QUERY\",dbquery_";
  protected final String TEXT_266 = ");";
  protected final String TEXT_267 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_268 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_269 = " = stmt_";
  protected final String TEXT_270 = ".executeQuery(dbquery_";
  protected final String TEXT_271 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_272 = " = rs_";
  protected final String TEXT_273 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_274 = " = rsmd_";
  protected final String TEXT_275 = ".getColumnCount();" + NL;
  protected final String TEXT_276 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_277 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_278 = ".setDbmsId(\"";
  protected final String TEXT_279 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_280 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_281 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_282 = ".add(\"";
  protected final String TEXT_283 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_284 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_285 = " = ";
  protected final String TEXT_286 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_287 = "; i <= rsmd_";
  protected final String TEXT_288 = ".getColumnCount()-";
  protected final String TEXT_289 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_290 = ".contains(rsmd_";
  protected final String TEXT_291 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_292 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_293 = ".setName(rsmd_";
  protected final String TEXT_294 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_295 = ".setDbName(rsmd_";
  protected final String TEXT_296 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_297 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_298 = "\", rsmd_";
  protected final String TEXT_299 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_300 = ".getPrecision(i), rsmd_";
  protected final String TEXT_301 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_302 = ".setDbType(rsmd_";
  protected final String TEXT_303 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_304 = ".setDbTypeId(rsmd_";
  protected final String TEXT_305 = ".getColumnType(i));";
  protected final String TEXT_306 = NL + "                \tdcm_";
  protected final String TEXT_307 = ".setFormat(";
  protected final String TEXT_308 = ");";
  protected final String TEXT_309 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_310 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_311 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_312 = ".setLength(rsmd_";
  protected final String TEXT_313 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_314 = ".setLength(rsmd_";
  protected final String TEXT_315 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_316 = NL + "\t\t\tdcm_";
  protected final String TEXT_317 = ".setLength(rsmd_";
  protected final String TEXT_318 = ".getPrecision(i));";
  protected final String TEXT_319 = NL + "                \tdcm_";
  protected final String TEXT_320 = ".setPrecision(rsmd_";
  protected final String TEXT_321 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_322 = ".setNullable(rsmd_";
  protected final String TEXT_323 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_324 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_325 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_326 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_327 = ".metadatas.add(dcm_";
  protected final String TEXT_328 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_329 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_330 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_331 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_332 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_333 = NL + "\t\t    ";
  protected final String TEXT_334 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_335 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_336 = NL + "\t\t    while (rs_";
  protected final String TEXT_337 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_338 = "++;" + NL + "\t\t        ";
  protected final String TEXT_339 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_340 = " = ";
  protected final String TEXT_341 = " + dcg_";
  protected final String TEXT_342 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_343 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_344 = " = ";
  protected final String TEXT_345 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_346 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_347 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_348 = " < ";
  protected final String TEXT_349 = "column_index_";
  ...
  protected final String TEXT_359 = " = (List)rs_";
  protected final String TEXT_360 = ".getObject(";
  protected final String TEXT_361 = "column_index_";
  protected final String TEXT_362 = ");";
  protected final String TEXT_363 = NL + "\t\t                         ";
  protected final String TEXT_364 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_365 = ".getObject(";
  protected final String TEXT_366 = "column_index_";
  protected final String TEXT_367 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_368 = NL + "                                    ";
  protected final String TEXT_369 = ".";
  protected final String TEXT_370 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_379 = ".setEPSG(";
  protected final String TEXT_380 = ");" + NL + "                                        }";
  protected final String TEXT_381 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_382 = NL + "                                  ";
  protected final String TEXT_383 = ".";
  protected final String TEXT_384 = "=dcg_";
  protected final String TEXT_385 = ";";
  protected final String TEXT_386 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_387 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_388 = " = ";
  protected final String TEXT_389 = "; i_";
  protected final String TEXT_390 = "  <= rsmd_";
  protected final String TEXT_391 = ".getColumnCount(); i_";
  protected final String TEXT_392 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_393 = ".getColumnTypeName(i_";
  protected final String TEXT_394 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_395 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_396 = ".getClob(i_";
  protected final String TEXT_397 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_398 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_399 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_400 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_401 = ".add(tNTextImpl_";
  protected final String TEXT_402 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_403 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_404 = ".";
  protected final String TEXT_405 = ", rs_";
  protected final String TEXT_406 = ", fixedColumnCount_";
  protected final String TEXT_407 = ",list_";
  protected final String TEXT_408 = ",";
  protected final String TEXT_409 = ");";
  protected final String TEXT_410 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_411 = ".";
  protected final String TEXT_412 = ", rs_";
  protected final String TEXT_413 = ", fixedColumnCount_";
  protected final String TEXT_414 = ",";
  protected final String TEXT_415 = ");";
  protected final String TEXT_416 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_417 = ".";
  protected final String TEXT_418 = ", rs_";
  protected final String TEXT_419 = ", fixedColumnCount_";
  protected final String TEXT_420 = ",";
  protected final String TEXT_421 = ");";
  protected final String TEXT_422 = NL + "                                  Object geom = rs_";
  protected final String TEXT_423 = ".getObject(";
  protected final String TEXT_424 = "column_index_";
  protected final String TEXT_425 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_426 = ".";
  protected final String TEXT_427 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
