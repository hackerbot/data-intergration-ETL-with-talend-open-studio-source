...
public class TMaxDBOutputBeginJava {
  protected static String nl;
  public static synchronized TMaxDBOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMaxDBOutputBeginJava result = new TMaxDBOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_46 = NL + "        int updateKeyCount_";
  protected final String TEXT_47 = " = ";
  protected final String TEXT_48 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_49 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_50 = NL + "        int deleteKeyCount_";
  protected final String TEXT_51 = " = ";
  protected final String TEXT_52 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_53 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_54 = NL + NL + "int nb_line_";
  protected final String TEXT_55 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_56 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_57 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_58 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_59 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_60 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_61 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_62 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_63 = " = ";
  protected final String TEXT_64 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_65 = " = false;" + NL + "java.lang.Class.forName(\"com.sap.dbtech.jdbc.DriverSapDB\");";
  protected final String TEXT_66 = NL + "String url_";
  protected final String TEXT_67 = " = \"jdbc:sapdb://\" + ";
  protected final String TEXT_68 = " + \":\" + ";
  protected final String TEXT_69 = " + \"/\" + ";
  protected final String TEXT_70 = "; " + NL + "String dbUser_";
  ...
  protected final String TEXT_80 = NL + NL + "String dbPwd_";
  protected final String TEXT_81 = " = decryptedPassword_";
  protected final String TEXT_82 = ";" + NL;
  protected final String TEXT_83 = NL + "java.sql.Connection conn_";
  protected final String TEXT_84 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_85 = ",dbUser_";
  protected final String TEXT_86 = ",dbPwd_";
  protected final String TEXT_87 = ");";
  protected final String TEXT_88 = NL + NL + "resourceMap.put(\"conn_";
  protected final String TEXT_89 = "\", conn_";
  protected final String TEXT_90 = ");" + NL;
  protected final String TEXT_91 = NL + "                     conn_";
  protected final String TEXT_92 = ".setAutoCommit(false);";
  protected final String TEXT_93 = NL;
  protected final String TEXT_94 = NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_95 = " = conn_";
  protected final String TEXT_96 = ".createStatement();" + NL + "            \t";
  protected final String TEXT_97 = NL + "            stmtDrop_";
  protected final String TEXT_98 = ".execute(\"";
  protected final String TEXT_99 = "\");" + NL + "            \t";
  protected final String TEXT_100 = NL + "            stmtDrop_";
  protected final String TEXT_101 = ".close();" + NL + "            " + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_102 = " = conn_";
  protected final String TEXT_103 = ".createStatement();" + NL + "            \t";
  ...
  protected final String TEXT_108 = ".close();";
  protected final String TEXT_109 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_110 = " = conn_";
  protected final String TEXT_111 = ".createStatement();" + NL + "            \t";
  protected final String TEXT_112 = NL + "            stmtCreate_";
  protected final String TEXT_113 = ".execute(\"";
  ...
  protected final String TEXT_147 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_155 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_156 = " = conn_";
  protected final String TEXT_157 = ".createStatement();" + NL + "            \t";
  protected final String TEXT_158 = NL + "            deletedCount_";
  protected final String TEXT_159 = " = deletedCount_";
  protected final String TEXT_160 = " + stmtClear_";
  protected final String TEXT_161 = ".executeUpdate(\"";
  protected final String TEXT_162 = "\");" + NL + "            \t";
  protected final String TEXT_163 = NL + "            stmtClear_";
  protected final String TEXT_164 = ".close();";
  protected final String TEXT_165 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_166 = " = conn_";
  protected final String TEXT_167 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_168 = " = stmtTruncCount_";
  protected final String TEXT_169 = ".executeQuery(\"";
  protected final String TEXT_170 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_171 = " = conn_";
  protected final String TEXT_172 = ".createStatement();" + NL + "            \t";
  protected final String TEXT_173 = NL + "            stmtTrunc_";
  protected final String TEXT_174 = ".executeUpdate(\"";
  protected final String TEXT_175 = "\");" + NL + "            \t";
  protected final String TEXT_176 = NL + "            while(rsTruncCount_";
  protected final String TEXT_177 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_178 = " += rsTruncCount_";
  protected final String TEXT_179 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_180 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_181 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_182 = ".close();";
  protected final String TEXT_183 = NL + "\t    String insert_";
  protected final String TEXT_184 = " = \"INSERT INTO \" + ";
  protected final String TEXT_185 = " + \" (";
  protected final String TEXT_186 = ") VALUES (";
  protected final String TEXT_187 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_188 = " = conn_";
  protected final String TEXT_189 = ".prepareStatement(insert_";
  protected final String TEXT_190 = ");" + NL + "\t    ";
  protected final String TEXT_191 = NL + "\t    String update_";
  protected final String TEXT_192 = " = \"UPDATE \" + ";
  protected final String TEXT_193 = " + \" SET ";
  protected final String TEXT_194 = " WHERE ";
  protected final String TEXT_195 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_196 = " = conn_";
  protected final String TEXT_197 = ".prepareStatement(update_";
  protected final String TEXT_198 = ");" + NL + "\t    ";
  protected final String TEXT_199 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_200 = " = conn_";
  protected final String TEXT_201 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_202 = " + \" WHERE ";
  protected final String TEXT_203 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_204 = " = \"INSERT INTO \" + ";
  protected final String TEXT_205 = " + \" (";
  protected final String TEXT_206 = ") VALUES (";
  protected final String TEXT_207 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_208 = " = conn_";
  protected final String TEXT_209 = ".prepareStatement(insert_";
  protected final String TEXT_210 = ");" + NL + "\t    String update_";
  protected final String TEXT_211 = " = \"UPDATE \" + ";
  protected final String TEXT_212 = " + \" SET ";
  protected final String TEXT_213 = " WHERE ";
  protected final String TEXT_214 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_215 = " = conn_";
  protected final String TEXT_216 = ".prepareStatement(update_";
  protected final String TEXT_217 = ");" + NL + "\t    ";
  protected final String TEXT_218 = NL + "\t    String update_";
  protected final String TEXT_219 = " = \"UPDATE \" + ";
  protected final String TEXT_220 = " + \" SET ";
  protected final String TEXT_221 = " WHERE ";
  protected final String TEXT_222 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_223 = " = conn_";
  protected final String TEXT_224 = ".prepareStatement(update_";
  protected final String TEXT_225 = ");" + NL + "\t    String insert_";
  protected final String TEXT_226 = " = \"INSERT INTO \" + ";
  protected final String TEXT_227 = " + \" (";
  protected final String TEXT_228 = ") VALUES (";
  protected final String TEXT_229 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_230 = " = conn_";
  protected final String TEXT_231 = ".prepareStatement(insert_";
  protected final String TEXT_232 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_233 = NL + "\t    String delete_";
  protected final String TEXT_234 = " = \"DELETE FROM \" + ";
  protected final String TEXT_235 = " + \" WHERE ";
  protected final String TEXT_236 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_237 = " = conn_";
  protected final String TEXT_238 = ".prepareStatement(delete_";
  protected final String TEXT_239 = ");" + NL + "\t    ";
  protected final String TEXT_240 = NL + "        StringBuffer query_";
  protected final String TEXT_241 = " = null;" + NL + "       \t";
  protected final String TEXT_242 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_243 = " = insert_";
  protected final String TEXT_244 = ".split(\"\\\\?\");";
  protected final String TEXT_245 = NL + "\t\t\tupdate_";
  protected final String TEXT_246 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_247 = " = update_";
  protected final String TEXT_248 = ".split(\"\\\\?\");";
  protected final String TEXT_249 = NL + "\t\t\tupdate_";
  protected final String TEXT_250 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_251 = " = update_";
  protected final String TEXT_252 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_253 = " = insert_";
  protected final String TEXT_254 = ".split(\"\\\\?\");";
  protected final String TEXT_255 = NL + "\t\t\tdelete_";
  protected final String TEXT_256 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_257 = " = delete_";
  protected final String TEXT_258 = ".split(\"\\\\?\");";
  protected final String TEXT_259 = NL + "\t\t\treplace_";
  protected final String TEXT_260 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_261 = " = replace_";
  protected final String TEXT_262 = ".split(\"\\\\?\");";
  protected final String TEXT_263 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_264 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_265 = " = insertIgnore_";
  protected final String TEXT_266 = ".split(\"\\\\?\");";
  protected final String TEXT_267 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_268 = " = insert_";
  protected final String TEXT_269 = ".split(\"\\\\?\");";
  protected final String TEXT_270 = NL + "        int commitEvery_";
  protected final String TEXT_271 = " = ";
  protected final String TEXT_272 = ";" + NL + "        int commitCounter_";
