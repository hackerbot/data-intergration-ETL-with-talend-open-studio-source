...
public class TJavaDBOutputBeginJava {
  ...
  protected final String TEXT_53 = " " + NL + "" + NL + "String jdbcDriver_";
  protected final String TEXT_54 = " = null;" + NL + "String url_";
  protected final String TEXT_55 = " = null;";
  protected final String TEXT_56 = NL + "\tjdbcDriver_";
  protected final String TEXT_57 = " = \"org.apache.derby.jdbc.EmbeddedDriver\";" + NL + "\turl_";
  protected final String TEXT_58 = " = \"jdbc:derby:\" + ";
  protected final String TEXT_59 = ";" + NL + "\t//set the root path of the database" + NL + "\tSystem.setProperty(\"derby.system.home\",";
  protected final String TEXT_60 = ");" + NL + "\t";
  protected final String TEXT_61 = NL + "\t\tjdbcDriver_";
  protected final String TEXT_62 = " = \"com.ibm.db2.jcc.DB2Driver\";" + NL + "\t\turl_";
  protected final String TEXT_63 = " = \"jdbc:derby:net://\" + ";
  protected final String TEXT_64 = " + \":\" + ";
  protected final String TEXT_65 = " + \"/\" + ";
  protected final String TEXT_66 = ";" + NL + "\t\t";
  protected final String TEXT_67 = NL + "\t\tjdbcDriver_";
  protected final String TEXT_68 = " = \"org.apache.derby.jdbc.ClientDriver\";" + NL + "\t\turl_";
  protected final String TEXT_69 = " = \"jdbc:derby://\" + ";
  protected final String TEXT_70 = " + \":\" + ";
  protected final String TEXT_71 = " + \"/\" + ";
  protected final String TEXT_72 = ";" + NL + "\t\t";
  protected final String TEXT_73 = NL + "\t";
  protected final String TEXT_74 = NL + "    \torg.apache.derby.drda.NetworkServerControl serverControl_";
  protected final String TEXT_75 = ";" + NL + "    \tserverControl_";
  protected final String TEXT_76 = " = new org.apache.derby.drda.NetworkServerControl(java.net.InetAddress.getByName(";
  protected final String TEXT_77 = "),Integer.parseInt(";
  protected final String TEXT_78 = "));" + NL + "    \t//start server" + NL + "    \tserverControl_";
  protected final String TEXT_79 = ".start(new java.io.PrintWriter(System.out,true));" + NL + "    \tboolean isServerUp_";
  protected final String TEXT_80 = " = false;" + NL + "    \tint timeOut_";
  protected final String TEXT_81 = " = 5;" + NL + "    \twhile(!isServerUp_";
  protected final String TEXT_82 = " && timeOut_";
  protected final String TEXT_83 = " > 0) {" + NL + "    \t\ttry {" + NL + "    \t\t\ttimeOut_";
  protected final String TEXT_84 = "--;" + NL + "    \t\t\t/*" + NL + "    \t\t\t* testing for connection to see if the network server is up and running." + NL + "    \t\t\t* if server is not ready yet, this method will throw an exception.\t\t" + NL + "    \t\t\t*/" + NL + "    \t\t\tserverControl_";
  protected final String TEXT_85 = ".ping();" + NL + "    \t\t\tisServerUp_";
  protected final String TEXT_86 = " = true;" + NL + "    \t\t} catch(java.lang.Exception e) {" + NL + "    \t\t\t//Unable to obtain a connection to network server, trying again after 3000 ms." + NL + "    \t\t\tThread.currentThread().sleep(3000);" + NL + "    \t\t}    \t\t\t\t" + NL + "    \t}" + NL + "    \tif(!isServerUp_";
  protected final String TEXT_87 = ") {" + NL + "    \t\t/*" + NL + "    \t\t * can not obtain a connection to network server." + NL + "    \t\t */ \t " + NL + "    \t\tthrow new java.lang.Exception(\"Can not obtain a connection to network server\");" + NL + "    \t}" + NL + "    \t//derby network server started." + NL + "\t";
  protected final String TEXT_88 = NL + NL + "int nb_line_";
  protected final String TEXT_89 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_90 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_91 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_92 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_93 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_94 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_95 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_96 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_97 = " = ";
  protected final String TEXT_98 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_99 = " = false;" + NL + "" + NL + "Class.forName(jdbcDriver_";
  protected final String TEXT_100 = ").newInstance();";
  protected final String TEXT_101 = NL + "java.util.Properties properties_";
  protected final String TEXT_102 = " = new java.util.Properties();" + NL + "properties_";
  protected final String TEXT_103 = ".put(\"user\",";
  ...
  protected final String TEXT_112 = NL + "  " + NL + "" + NL + "properties_";
  protected final String TEXT_113 = ".put(\"password\",decryptedPassword_";
  ...
  protected final String TEXT_151 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_152 = ".equalsIgnoreCase(";
  protected final String TEXT_153 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_154 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  protected final String TEXT_155 = NL + "                if(!whetherExist_";
  protected final String TEXT_156 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_163 = NL + "                if(whetherExist_";
  protected final String TEXT_164 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_165 = " = conn_";
  protected final String TEXT_166 = ".createStatement();";
  ...
  protected final String TEXT_173 = ".createStatement();";
  protected final String TEXT_174 = NL + "                stmtCreate_";
  protected final String TEXT_175 = ".execute(\"";
  protected final String TEXT_176 = ")\");                ";
  protected final String TEXT_177 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_178 = " = conn_";
  protected final String TEXT_179 = ".createStatement();";
  protected final String TEXT_180 = NL + "            deletedCount_";
  protected final String TEXT_181 = " = deletedCount_";
  protected final String TEXT_182 = " + stmtClear_";
  protected final String TEXT_183 = ".executeUpdate(\"";
  protected final String TEXT_184 = "\");";
  protected final String TEXT_185 = NL + "\t    String insert_";
  protected final String TEXT_186 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_187 = " + \"\\\" (";
  protected final String TEXT_188 = ") VALUES (";
  protected final String TEXT_189 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_190 = " = conn_";
  protected final String TEXT_191 = ".prepareStatement(insert_";
  protected final String TEXT_192 = ");" + NL + "\t    ";
  protected final String TEXT_193 = NL + "\t    String update_";
  protected final String TEXT_194 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_195 = " + \"\\\" SET ";
  protected final String TEXT_196 = " WHERE ";
  protected final String TEXT_197 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_198 = " = conn_";
  protected final String TEXT_199 = ".prepareStatement(update_";
  protected final String TEXT_200 = ");" + NL + "\t    ";
  protected final String TEXT_201 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_202 = " = conn_";
  protected final String TEXT_203 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + ";
  protected final String TEXT_204 = " + \"\\\" WHERE ";
  protected final String TEXT_205 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_206 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_207 = " + \"\\\" (";
  protected final String TEXT_208 = ") VALUES (";
  protected final String TEXT_209 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_210 = " = conn_";
  protected final String TEXT_211 = ".prepareStatement(insert_";
  protected final String TEXT_212 = ");" + NL + "\t    String update_";
  protected final String TEXT_213 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_214 = " + \"\\\" SET ";
  protected final String TEXT_215 = " WHERE ";
  protected final String TEXT_216 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_217 = " = conn_";
  protected final String TEXT_218 = ".prepareStatement(update_";
  protected final String TEXT_219 = ");" + NL + "\t    ";
  protected final String TEXT_220 = NL + "\t    String update_";
  protected final String TEXT_221 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_222 = " + \"\\\" SET ";
  protected final String TEXT_223 = " WHERE ";
  protected final String TEXT_224 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_225 = " = conn_";
  protected final String TEXT_226 = ".prepareStatement(update_";
  protected final String TEXT_227 = ");" + NL + "\t    String insert_";
  protected final String TEXT_228 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_229 = " + \"\\\" (";
  protected final String TEXT_230 = ") VALUES (";
  protected final String TEXT_231 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_232 = " = conn_";
  protected final String TEXT_233 = ".prepareStatement(insert_";
  protected final String TEXT_234 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_235 = NL + "\t    String delete_";
  protected final String TEXT_236 = " = \"DELETE  FROM \\\"\" + ";
  protected final String TEXT_237 = " + \"\\\" WHERE ";
  protected final String TEXT_238 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_239 = " = conn_";
  protected final String TEXT_240 = ".prepareStatement(delete_";
  protected final String TEXT_241 = ");" + NL + "\t    ";
  protected final String TEXT_242 = NL + "        StringBuffer query_";
  protected final String TEXT_243 = " = null;" + NL + "       \t";
  protected final String TEXT_244 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_245 = " = insert_";
  protected final String TEXT_246 = ".split(\"\\\\?\");";
  protected final String TEXT_247 = NL + "\t\t\tupdate_";
  protected final String TEXT_248 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_249 = " = update_";
  protected final String TEXT_250 = ".split(\"\\\\?\");";
  protected final String TEXT_251 = NL + "\t\t\tupdate_";
  protected final String TEXT_252 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_253 = " = update_";
  protected final String TEXT_254 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_255 = " = insert_";
  protected final String TEXT_256 = ".split(\"\\\\?\");";
  protected final String TEXT_257 = NL + "\t\t\tdelete_";
  protected final String TEXT_258 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_259 = " = delete_";
  protected final String TEXT_260 = ".split(\"\\\\?\");";
  protected final String TEXT_261 = NL + "\t\t\treplace_";
  protected final String TEXT_262 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_263 = " = replace_";
  protected final String TEXT_264 = ".split(\"\\\\?\");";
  protected final String TEXT_265 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_266 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_267 = " = insertIgnore_";
  protected final String TEXT_268 = ".split(\"\\\\?\");";
  protected final String TEXT_269 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_270 = " = insert_";
  protected final String TEXT_271 = ".split(\"\\\\?\");";
  protected final String TEXT_272 = NL + "        " + NL + "        int commitEvery_";
  protected final String TEXT_273 = " = ";
  protected final String TEXT_274 = ";" + NL + "        " + NL + "        int commitCounter_";
  protected final String TEXT_275 = " = 0;" + NL + "        ";
