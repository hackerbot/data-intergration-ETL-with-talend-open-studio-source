...
public class TPostgresPlusSCDBeginJava {
  protected static String nl;
  public static synchronized TPostgresPlusSCDBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresPlusSCDBeginJava result = new TPostgresPlusSCDBeginJava();
    nl = null;
    return result;
  }
