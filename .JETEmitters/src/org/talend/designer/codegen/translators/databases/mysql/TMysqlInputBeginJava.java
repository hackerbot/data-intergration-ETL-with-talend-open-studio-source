...
public class TMysqlInputBeginJava
{
  ...
  protected final String TEXT_201 = NL + "\t\t        ((com.mysql.jdbc.Statement)stmt_";
  protected final String TEXT_202 = ").enableStreamingResults();";
  protected final String TEXT_203 = NL + "\t        if(rs_";
  protected final String TEXT_204 = ".getString(";
  protected final String TEXT_205 = "column_index_";
  protected final String TEXT_206 = ") != null) {" + NL + "\t            String dateString_";
  protected final String TEXT_207 = " = rs_";
  protected final String TEXT_208 = ".getString(";
  protected final String TEXT_209 = "column_index_";
  protected final String TEXT_210 = ");" + NL + "\t            if (!(\"0000-00-00\").equals(dateString_";
  protected final String TEXT_211 = ") && !(\"0000-00-00 00:00:00\").equals(dateString_";
  protected final String TEXT_212 = ")) {" + NL + "\t                ";
  protected final String TEXT_213 = ".";
  protected final String TEXT_214 = " = rs_";
  protected final String TEXT_215 = ".getTimestamp(";
  protected final String TEXT_216 = "column_index_";
  protected final String TEXT_217 = ");" + NL + "\t            } else {" + NL + "\t                ";
  protected final String TEXT_218 = ".";
  protected final String TEXT_219 = " = (java.util.Date) year0_";
  protected final String TEXT_220 = ".clone();" + NL + "\t            }" + NL + "\t        } else {" + NL + "\t            ";
  protected final String TEXT_221 = ".";
  protected final String TEXT_222 = " =  null;" + NL + "\t        }\t\t\t ";
  protected final String TEXT_223 = NL + "\t";
  protected final String TEXT_224 = NL + "\t\t    int nb_line_";
  protected final String TEXT_225 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_226 = " = null;";
  protected final String TEXT_227 = NL + "\t\t        conn_";
  protected final String TEXT_228 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_229 = "\");";
  protected final String TEXT_230 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_231 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_232 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_233 = " = dataSources_";
  protected final String TEXT_234 = ".get(";
  protected final String TEXT_235 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_236 = "\", conn_";
  protected final String TEXT_237 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_238 = NL + "\t\t\t\t";
  protected final String TEXT_239 = NL + "\t\t\t\t";
  protected final String TEXT_240 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_241 = " =  conn_";
  protected final String TEXT_242 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_243 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_244 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_245 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_246 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_247 = NL + "                 conn_";
  protected final String TEXT_248 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_249 = NL + "               ";
  protected final String TEXT_250 = " + \"=\" + ";
  protected final String TEXT_251 = " + \";\" +";
  protected final String TEXT_252 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_253 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_254 = ");";
  protected final String TEXT_255 = NL + "\t\t    ";
  protected final String TEXT_256 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_257 = " = ";
  protected final String TEXT_258 = ";" + NL + "\t\t\t";
  protected final String TEXT_259 = NL + "                log.info(\"";
  protected final String TEXT_260 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_261 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_262 = NL;
  protected final String TEXT_263 = NL + "                       globalMap.put(\"";
  protected final String TEXT_264 = "_QUERY\",dbquery_";
  protected final String TEXT_265 = ");";
  protected final String TEXT_266 = NL + "                       globalMap.put(\"";
  protected final String TEXT_267 = "_QUERY\",dbquery_";
  protected final String TEXT_268 = ");";
  protected final String TEXT_269 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_270 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_271 = " = stmt_";
  protected final String TEXT_272 = ".executeQuery(dbquery_";
  protected final String TEXT_273 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_274 = " = rs_";
  protected final String TEXT_275 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_276 = " = rsmd_";
  protected final String TEXT_277 = ".getColumnCount();" + NL;
  protected final String TEXT_278 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_279 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_280 = ".setDbmsId(\"";
  protected final String TEXT_281 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_282 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_283 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_284 = ".add(\"";
  protected final String TEXT_285 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_286 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_287 = " = ";
  protected final String TEXT_288 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_289 = "; i <= rsmd_";
  protected final String TEXT_290 = ".getColumnCount()-";
  protected final String TEXT_291 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_292 = ".contains(rsmd_";
  protected final String TEXT_293 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_294 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_295 = ".setName(rsmd_";
  protected final String TEXT_296 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_297 = ".setDbName(rsmd_";
  protected final String TEXT_298 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_299 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_300 = "\", rsmd_";
  protected final String TEXT_301 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_302 = ".getPrecision(i), rsmd_";
  protected final String TEXT_303 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_304 = ".setDbType(rsmd_";
  protected final String TEXT_305 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_306 = ".setDbTypeId(rsmd_";
  protected final String TEXT_307 = ".getColumnType(i));";
  protected final String TEXT_308 = NL + "                \tdcm_";
  protected final String TEXT_309 = ".setFormat(";
  protected final String TEXT_310 = ");";
  protected final String TEXT_311 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_312 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_313 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_314 = ".setLength(rsmd_";
  protected final String TEXT_315 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_316 = ".setLength(rsmd_";
  protected final String TEXT_317 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_318 = NL + "\t\t\tdcm_";
  protected final String TEXT_319 = ".setLength(rsmd_";
  protected final String TEXT_320 = ".getPrecision(i));";
  protected final String TEXT_321 = NL + "                \tdcm_";
  protected final String TEXT_322 = ".setPrecision(rsmd_";
  protected final String TEXT_323 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_324 = ".setNullable(rsmd_";
  protected final String TEXT_325 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_326 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_327 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_328 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_329 = ".metadatas.add(dcm_";
  protected final String TEXT_330 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_331 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_332 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_333 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_334 = " =1;" + NL + "\t\t    ";
  ...
  protected final String TEXT_361 = " = (List)rs_";
  protected final String TEXT_362 = ".getObject(";
  protected final String TEXT_363 = "column_index_";
  protected final String TEXT_364 = ");";
  protected final String TEXT_365 = NL + "\t\t                         ";
  protected final String TEXT_366 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_367 = ".getObject(";
  protected final String TEXT_368 = "column_index_";
  protected final String TEXT_369 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_370 = NL + "                                    ";
  protected final String TEXT_371 = ".";
  protected final String TEXT_372 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_381 = ".setEPSG(";
  protected final String TEXT_382 = ");" + NL + "                                        }";
  protected final String TEXT_383 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_384 = NL + "                                  ";
  protected final String TEXT_385 = ".";
  protected final String TEXT_386 = "=dcg_";
  protected final String TEXT_387 = ";";
  protected final String TEXT_388 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_389 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_390 = " = ";
  protected final String TEXT_391 = "; i_";
  protected final String TEXT_392 = "  <= rsmd_";
  protected final String TEXT_393 = ".getColumnCount(); i_";
  protected final String TEXT_394 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_395 = ".getColumnTypeName(i_";
  protected final String TEXT_396 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_397 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_398 = ".getClob(i_";
  protected final String TEXT_399 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_400 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_401 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_402 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_403 = ".add(tNTextImpl_";
  protected final String TEXT_404 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_405 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_406 = ".";
  protected final String TEXT_407 = ", rs_";
  protected final String TEXT_408 = ", fixedColumnCount_";
  protected final String TEXT_409 = ",list_";
  protected final String TEXT_410 = ",";
  protected final String TEXT_411 = ");";
  protected final String TEXT_412 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_413 = ".";
  protected final String TEXT_414 = ", rs_";
  protected final String TEXT_415 = ", fixedColumnCount_";
  protected final String TEXT_416 = ",";
  protected final String TEXT_417 = ");";
  protected final String TEXT_418 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_419 = ".";
  protected final String TEXT_420 = ", rs_";
  protected final String TEXT_421 = ", fixedColumnCount_";
  protected final String TEXT_422 = ",";
  protected final String TEXT_423 = ");";
  protected final String TEXT_424 = NL + "                                  Object geom = rs_";
  protected final String TEXT_425 = ".getObject(";
