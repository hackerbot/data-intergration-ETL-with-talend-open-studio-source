...
public class TRedshiftBulkExecBeginJava {
  protected static String nl;
  public static synchronized TRedshiftBulkExecBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRedshiftBulkExecBeginJava result = new TRedshiftBulkExecBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_78 = NL + "\tString tableName_";
  protected final String TEXT_79 = " = null;" + NL + "\tString tableName2_";
  protected final String TEXT_80 = " = null;" + NL + "\tif(dbschema_";
  protected final String TEXT_81 = " == null || dbschema_";
  protected final String TEXT_82 = ".trim().length() == 0) {" + NL + "\t\ttableName_";
  protected final String TEXT_83 = " = ";
  protected final String TEXT_84 = ";" + NL + "\t\ttableName2_";
  protected final String TEXT_85 = " = ";
  protected final String TEXT_86 = ";" + NL + "\t} else {" + NL + "\t\ttableName_";
  protected final String TEXT_87 = " = dbschema_";
  protected final String TEXT_88 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_89 = ";" + NL + "\t\ttableName2_";
  protected final String TEXT_90 = " = dbschema_";
  protected final String TEXT_91 = " + \".\" + ";
  protected final String TEXT_92 = ";" + NL + "\t}" + NL + "" + NL + "\tjava.sql.Connection conn_";
  ...
  protected final String TEXT_97 = NL + "\t\tString driverClass_";
  protected final String TEXT_98 = " = \"org.postgresql.Driver\";" + NL + "\t\tClass.forName(driverClass_";
  protected final String TEXT_99 = ").newInstance();" + NL + "\t\t";
  ...
  protected final String TEXT_106 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_107 = " + \":\" + ";
  protected final String TEXT_108 = " + \"/\" + ";
  protected final String TEXT_109 = " + \"?\" + ";
  protected final String TEXT_110 = ";" + NL + "\t\t";
  protected final String TEXT_111 = NL + "\t\t";
  protected final String TEXT_112 = " " + NL + "\t\tfinal String decryptedPass_";
  protected final String TEXT_113 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_114 = ");" + NL + "\t\t";
  protected final String TEXT_115 = NL + "\t\tfinal String decryptedPass_";
  protected final String TEXT_116 = " = ";
  protected final String TEXT_117 = "; " + NL + "\t\t";
  protected final String TEXT_118 = NL + "\t\tString dbUser_";
  protected final String TEXT_119 = " = ";
  protected final String TEXT_120 = ";" + NL + "\t\tString dbPwd_";
  protected final String TEXT_121 = " = decryptedPass_";
  ...
  protected final String TEXT_390 = NL + "\tStringBuilder command_";
  protected final String TEXT_391 = " = new StringBuilder();";
  protected final String TEXT_392 = NL + "\t\tchar fieldSeparator_";
  protected final String TEXT_393 = " = ";
  protected final String TEXT_394 = NL + "\t\t',';";
  protected final String TEXT_395 = NL + "\t\tString.valueOf(";
  protected final String TEXT_396 = ").charAt(0);";
  protected final String TEXT_397 = NL + "\t\tchar textEnclosure_";
  protected final String TEXT_398 = " = ";
  protected final String TEXT_399 = NL + "\t\t'\\0';" + NL + "\t";
  protected final String TEXT_400 = NL + "\t\t'\"';";
  protected final String TEXT_401 = NL + "\t\tString.valueOf(";
  protected final String TEXT_402 = ").charAt(0);";
  protected final String TEXT_403 = NL + "\tcommand_";
  protected final String TEXT_404 = ".append(\"COPY \").append(tableName2_";
  protected final String TEXT_405 = ")" + NL + "\t";
  protected final String TEXT_406 = NL + "\t\t.append(\" (\")";
  protected final String TEXT_407 = NL + "\t\t\t.append(\"";
  protected final String TEXT_408 = "\")";
  protected final String TEXT_409 = NL + "\t\t\t.append(\",\")";
  protected final String TEXT_410 = NL + "\t\t.append(\")\")";
  protected final String TEXT_411 = NL + "\t.append(\" FROM '\");";
  protected final String TEXT_412 = NL + "\t";
  protected final String TEXT_413 = " " + NL + "\tfinal String decryptedPwd_";
  protected final String TEXT_414 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_415 = ");" + NL + "\t";
  protected final String TEXT_416 = NL + "\tfinal String decryptedPwd_";
  protected final String TEXT_417 = " = ";
  protected final String TEXT_418 = "; " + NL + "\t";
  protected final String TEXT_419 = NL + "\tcommand_";
  protected final String TEXT_420 = ".append(\"s3://\").append(";
  protected final String TEXT_421 = ").append(\"/\").append(";
  protected final String TEXT_422 = ")" + NL + "\t.append(\"' \")" + NL + "\t.append(\"credentials 'aws_access_key_id=\").append(";
  protected final String TEXT_423 = ").append(\";aws_secret_access_key=\").append(decryptedPwd_";
  protected final String TEXT_424 = ")";
  protected final String TEXT_425 = NL + "\t\t.append(\";master_symmetric_key=\").append(";
  protected final String TEXT_426 = ")";
  protected final String TEXT_427 = NL + "\t.append(\"' \")";
  protected final String TEXT_428 = NL + "\t.append(\"DELIMITER '\").append(fieldSeparator_";
  protected final String TEXT_429 = ").append(\"' \")";
  protected final String TEXT_430 = NL + "\t.append(\"JSON '\").append(";
  protected final String TEXT_431 = ").append(\"' \")";
  protected final String TEXT_432 = NL + "\t.append(\"FIXEDWIDTH '\").append(";
  protected final String TEXT_433 = ").append(\"' \")";
  protected final String TEXT_434 = NL + "\t;";
  protected final String TEXT_435 = NL + "\tif(textEnclosure_";
  protected final String TEXT_436 = "!='\\0') {" + NL + "\t\tcommand_";
  protected final String TEXT_437 = ".append(\"CSV QUOTE '\").append(textEnclosure_";
  protected final String TEXT_438 = ").append(\"' \");" + NL + "\t}";
  protected final String TEXT_439 = NL + "\tcommand_";
  protected final String TEXT_440 = ".append(\"ENCODING \").append(";
  protected final String TEXT_441 = ").append(\" \")";
  protected final String TEXT_442 = NL + "\t\t\t.append(\"";
  protected final String TEXT_443 = " '\").append(";
  protected final String TEXT_444 = ").append(\"' \")";
  protected final String TEXT_445 = NL + "\t\t\t.append(\"";
  protected final String TEXT_446 = " \")";
  protected final String TEXT_447 = NL + "\t\t\t.append(\"";
  protected final String TEXT_448 = " \").append(";
  protected final String TEXT_449 = ").append(\" \")";
  protected final String TEXT_450 = NL + "\t\t\t.append(\"MAXERROR \").append(";
  protected final String TEXT_451 = ").append(\" \")";
  protected final String TEXT_452 = NL + "\t\t\t\t.append(\"ACCEPTINVCHARS \")";
  protected final String TEXT_453 = NL + "\t\t\t\t.append(\"ACCEPTINVCHARS '\").append(";
  protected final String TEXT_454 = ").append(\"' \")";
  protected final String TEXT_455 = NL + "\t\t\t\t.append(\"";
  protected final String TEXT_456 = " ON\")";
  protected final String TEXT_457 = NL + "\t\t\t\t.append(\"";
  protected final String TEXT_458 = " OFF\")";
  protected final String TEXT_459 = NL + "\t\t.append(\"ENCRYPTED \")";
  protected final String TEXT_460 = NL + "\t\t.append(\"";
  protected final String TEXT_461 = " \")";
  protected final String TEXT_462 = NL + "\t\t.append(\"DATEFORMAT '\").append(";
  protected final String TEXT_463 = ").append(\"' \")";
  protected final String TEXT_464 = NL + "\t\t.append(\"DATEFORMAT 'auto' \")";
  protected final String TEXT_465 = NL + "\t\t.append(\"TIMEFORMAT '\").append(";
  protected final String TEXT_466 = ").append(\"' \")";
  protected final String TEXT_467 = NL + "\t\t.append(\"TIMEFORMAT 'auto' \")";
  protected final String TEXT_468 = NL + "\t\t.append(\"TIMEFORMAT 'epochsecs' \")";
  protected final String TEXT_469 = NL + "\t\t.append(\"TIMEFORMAT 'epochmillisecs' \")";
  protected final String TEXT_470 = NL + "\t;" + NL + "\t" + NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_471 = "=conn_";
  protected final String TEXT_472 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_473 = ".execute(command_";
  protected final String TEXT_474 = ".toString());";
  protected final String TEXT_475 = NL + "\t\tif(stmt_";
  protected final String TEXT_476 = ".getWarnings()!=null) {";
  protected final String TEXT_477 = NL + "\t\t\tlog.warn(\"";
  protected final String TEXT_478 = " - \" + stmt_";
  protected final String TEXT_479 = ".getWarnings().getMessage());";
  protected final String TEXT_480 = NL + "\t\t\tSystem.err.println(stmt_";
  protected final String TEXT_481 = ".getWarnings().getMessage());";
  protected final String TEXT_482 = NL + "\t\t}";
  protected final String TEXT_483 = NL + "\t";
  protected final String TEXT_484 = NL + "\t\tlog.info(\"";
  protected final String TEXT_485 = " - Finish loading data to table : \" + tableName2_";
