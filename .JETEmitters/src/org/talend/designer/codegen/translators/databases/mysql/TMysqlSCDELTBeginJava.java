...
public class TMysqlSCDELTBeginJava {
  protected static String nl;
  public static synchronized TMysqlSCDELTBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMysqlSCDELTBeginJava result = new TMysqlSCDELTBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_17 = ";" + NL + "        } else {" + NL + "            url_";
  protected final String TEXT_18 = " = \"";
  protected final String TEXT_19 = "://\" + ";
  protected final String TEXT_20 = " + \":\" + ";
  protected final String TEXT_21 = " + \"/\" + ";
  protected final String TEXT_22 = " + \"?\" + dbProperties_";
  ...
  protected final String TEXT_33 = NL + NL + "        String dbPwd_";
  protected final String TEXT_34 = " = decryptedPassword_";
  protected final String TEXT_35 = ";" + NL + "" + NL + "        java.sql.Connection conn_";
  ...
  protected final String TEXT_42 = ";" + NL + "    String sourceTable_";
  protected final String TEXT_43 = " = ";
  protected final String TEXT_44 = ";";
  protected final String TEXT_45 = NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_46 = " = conn_";
  protected final String TEXT_47 = ".createStatement();" + NL + "            stmtDrop_";
  protected final String TEXT_48 = ".execute(\"";
  protected final String TEXT_49 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_50 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_51 = " = conn_";
  protected final String TEXT_52 = ".createStatement();" + NL + "            stmtCreate_";
  ...
  protected final String TEXT_62 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_63 = " = conn_";
  protected final String TEXT_64 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_65 = " = dbMetaData_";
  protected final String TEXT_66 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_67 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_68 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_69 = " = rsTable_";
  protected final String TEXT_70 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_71 = ".equalsIgnoreCase(";
  protected final String TEXT_72 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_73 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  protected final String TEXT_74 = ".close();";
  protected final String TEXT_75 = NL + "                if(!whetherExist_";
  protected final String TEXT_76 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_77 = " = conn_";
  protected final String TEXT_78 = ".createStatement();" + NL + "\t\t            stmtCreate_";
  ...
  protected final String TEXT_88 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_94 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_95 = " = conn_";
  protected final String TEXT_96 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_97 = ".executeUpdate(\"";
  protected final String TEXT_98 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_99 = ".close();";
  protected final String TEXT_100 = NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_101 = " = conn_";
  protected final String TEXT_102 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_103 = ".executeUpdate(\"";
  protected final String TEXT_104 = "\");" + NL + "            stmtTrunc_";
  protected final String TEXT_105 = ".close();";
  protected final String TEXT_106 = NL + "        System.out.println(\"[";
  protected final String TEXT_107 = "] table action ";
  protected final String TEXT_108 = " done\\n\");";
  protected final String TEXT_109 = NL + "    ";
  protected final String TEXT_110 = NL + "        String updateForType1_";
  protected final String TEXT_111 = " = \"UPDATE `\" + tableName_";
  protected final String TEXT_112 = " + \"` d, `\" + sourceTable_";
  protected final String TEXT_113 = " + \"` t SET ";
  protected final String TEXT_114 = " WHERE ";
  protected final String TEXT_115 = " AND (";
  protected final String TEXT_116 = ")\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_117 = " = conn_";
  protected final String TEXT_118 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_119 = ".executeUpdate(updateForType1_";
  protected final String TEXT_120 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_121 = ".close();";
  protected final String TEXT_122 = NL + "            System.out.println(\"[";
  protected final String TEXT_123 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_124 = " + \"\\ndone\");";
  protected final String TEXT_125 = "        " + NL + "        String changeDateTime_";
  protected final String TEXT_126 = " = (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_127 = "\"))).toString();" + NL + "\t";
  protected final String TEXT_128 = NL + "        String changeDateTime_";
  protected final String TEXT_129 = "_begin = changeDateTime_";
  protected final String TEXT_130 = ";" + NL + "        String changeDateTime_";
  protected final String TEXT_131 = "_end = changeDateTime_";
  protected final String TEXT_132 = ";" + NL + "        ";
  protected final String TEXT_133 = NL + "\t\t        changeDateTime_";
  protected final String TEXT_134 = "_begin = routines.system.DBDateParser.getDBDateParser(\"";
  protected final String TEXT_135 = "\").getDateString(\"";
  protected final String TEXT_136 = "\",\"";
  protected final String TEXT_137 = "\",(Long)start_Hash.get(\"";
  protected final String TEXT_138 = "\"),";
  protected final String TEXT_139 = ");" + NL + "\t\t";
  protected final String TEXT_140 = NL + "        \t\tchangeDateTime_";
  protected final String TEXT_141 = "_end = routines.system.DBDateParser.getDBDateParser(\"";
  protected final String TEXT_142 = "\").getDateString(\"";
  protected final String TEXT_143 = "\",\"";
  protected final String TEXT_144 = "\",(Long)start_Hash.get(\"";
  protected final String TEXT_145 = "\"),";
  protected final String TEXT_146 = ");";
  protected final String TEXT_147 = NL + "        String updateForType2_";
  protected final String TEXT_148 = " = \"UPDATE `\" + tableName_";
  protected final String TEXT_149 = " + \"` d, `\" + sourceTable_";
  protected final String TEXT_150 = " + \"` t SET `";
  protected final String TEXT_151 = "` = '\" + (changeDateTime_";
  protected final String TEXT_152 = ") + \"'";
  protected final String TEXT_153 = ", `";
  protected final String TEXT_154 = "` = 0";
  protected final String TEXT_155 = " WHERE ";
  protected final String TEXT_156 = " AND (";
  protected final String TEXT_157 = ") AND d.`";
  protected final String TEXT_158 = "` IS NULL\"; " + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_159 = " = conn_";
  protected final String TEXT_160 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_161 = ".executeUpdate(updateForType2_";
  protected final String TEXT_162 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_163 = ".close();";
  protected final String TEXT_164 = NL + "        \tString updateForType2_";
  protected final String TEXT_165 = "_debug = \"UPDATE `\" + tableName_";
  protected final String TEXT_166 = " + \"` d, `\" + sourceTable_";
  protected final String TEXT_167 = " + \"` t SET `";
  protected final String TEXT_168 = "` = '\" + (changeDateTime_";
  protected final String TEXT_169 = "_end) + \"'";
  protected final String TEXT_170 = ", `";
  protected final String TEXT_171 = "` = 0";
  protected final String TEXT_172 = " WHERE ";
  protected final String TEXT_173 = " AND (";
  protected final String TEXT_174 = ") AND d.`";
  protected final String TEXT_175 = "` IS NULL\"; " + NL + "            System.out.println(\"[";
  protected final String TEXT_176 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_177 = "_debug + \"\\ndone\");";
  protected final String TEXT_178 = NL + "        String insertForType2_";
  protected final String TEXT_179 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_180 = " + \"`(";
  protected final String TEXT_181 = ") SELECT t.";
  protected final String TEXT_182 = ", '\" + " + NL + "        (changeDateTime_";
  protected final String TEXT_183 = ") + \"', NULL";
  protected final String TEXT_184 = ", 1";
  protected final String TEXT_185 = ", d.`";
  protected final String TEXT_186 = "` + 1";
  protected final String TEXT_187 = " FROM `\" + " + NL + "        sourceTable_";
  protected final String TEXT_188 = " + \"` t, `\" + tableName_";
  protected final String TEXT_189 = " + \"` d WHERE ";
  protected final String TEXT_190 = " AND (";
  protected final String TEXT_191 = ") AND d.`";
  protected final String TEXT_192 = "` = '\" + (changeDateTime_";
  protected final String TEXT_193 = ") + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_194 = " = conn_";
  protected final String TEXT_195 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_196 = ".executeUpdate(insertForType2_";
  protected final String TEXT_197 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_198 = ".close();";
  protected final String TEXT_199 = NL + "\t\t\tString insertForType2_";
  protected final String TEXT_200 = "_debug = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_201 = " + \"`(";
  protected final String TEXT_202 = ") SELECT t.";
  protected final String TEXT_203 = ", '\" + (changeDateTime_";
  protected final String TEXT_204 = "_begin) + \"', NULL";
  protected final String TEXT_205 = ", 1";
  protected final String TEXT_206 = ", d.`";
  protected final String TEXT_207 = "` + 1";
  protected final String TEXT_208 = " FROM `\" + sourceTable_";
  protected final String TEXT_209 = " + \"` t, `\" + tableName_";
  protected final String TEXT_210 = " + \"` d WHERE ";
  protected final String TEXT_211 = " AND (";
  protected final String TEXT_212 = ") AND d.`";
  protected final String TEXT_213 = "` = '\" + (changeDateTime_";
  protected final String TEXT_214 = "_end) + \"'\";" + NL + "            System.out.println(\"[";
  protected final String TEXT_215 = "] type2 new active row slq\\n\" + insertForType2_";
  protected final String TEXT_216 = "_debug + \"\\ndone\");";
  protected final String TEXT_217 = NL + "    String insert_";
  protected final String TEXT_218 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_219 = " + \"`(";
  protected final String TEXT_220 = ") SELECT t.";
  protected final String TEXT_221 = "\"";
  protected final String TEXT_222 = " + \", '\" + (changeDateTime_";
  ...
  protected final String TEXT_228 = " + \"` t LEFT JOIN `\" + tableName_";
  protected final String TEXT_229 = " + \"` d ON ";
  protected final String TEXT_230 = " WHERE (";
  protected final String TEXT_231 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_232 = " = conn_";
  protected final String TEXT_233 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_234 = ".executeUpdate(insert_";
  protected final String TEXT_235 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_236 = ".close();";
  protected final String TEXT_237 = NL + "    \tString insert_";
  protected final String TEXT_238 = "_debug = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_239 = " + \"`(";
  protected final String TEXT_240 = ") SELECT t.";
  protected final String TEXT_241 = "\"";
  protected final String TEXT_242 = " + \", '\" + (changeDateTime_";
  protected final String TEXT_243 = "_begin) + \"', NULL\"";
  protected final String TEXT_244 = " + \"";
  protected final String TEXT_245 = ", 1";
  protected final String TEXT_246 = ", 1";
  protected final String TEXT_247 = " FROM `\" + sourceTable_";
  protected final String TEXT_248 = " + \"` t LEFT JOIN `\" + tableName_";
  protected final String TEXT_249 = " + \"` d ON ";
  protected final String TEXT_250 = " WHERE (";
  protected final String TEXT_251 = ")\";" + NL + "        System.out.println(\"[";
  protected final String TEXT_252 = "] new rows sql\\n\" + insert_";
  protected final String TEXT_253 = "_debug + \"\\ndone\");";
...
if(columnList != null && columnList.size() > 0) {
    ...
    if(dbproperties == null || dbproperties.trim().length() == 0) {
