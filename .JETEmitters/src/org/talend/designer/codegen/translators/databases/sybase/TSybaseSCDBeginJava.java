...
public class TSybaseSCDBeginJava {
  protected static String nl;
  public static synchronized TSybaseSCDBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSybaseSCDBeginJava result = new TSybaseSCDBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_14 = "\");" + NL + "        dbschema_";
  protected final String TEXT_15 = "= (String)globalMap.get(\"";
  protected final String TEXT_16 = "\");";
  protected final String TEXT_17 = NL + "        java.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");";
  protected final String TEXT_18 = NL + "\t\tString connectionString_";
  protected final String TEXT_19 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_20 = " + \":\" + ";
  protected final String TEXT_21 = " + \"/\" + ";
  protected final String TEXT_22 = ";";
  protected final String TEXT_23 = NL + "\t\tString connectionString_";
  protected final String TEXT_24 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_37 = NL + "\t   \t" + NL + "        java.sql.Connection connection_";
  ...
  protected final String TEXT_42 = NL + "    if(dbschema_";
  protected final String TEXT_43 = " != null && dbschema_";
  protected final String TEXT_44 = ".trim().length() != 0) {" + NL + "\t\ttableName_";
  protected final String TEXT_45 = " = dbschema_";
  ...
  protected final String TEXT_203 = NL + "        SCDSK_";
  protected final String TEXT_204 = " lookUpKey_";
