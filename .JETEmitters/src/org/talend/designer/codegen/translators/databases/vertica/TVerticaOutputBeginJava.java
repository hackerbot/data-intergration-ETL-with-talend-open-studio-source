...
public class TVerticaOutputBeginJava {
  protected static String nl;
  public static synchronized TVerticaOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVerticaOutputBeginJava result = new TVerticaOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_48 = " = 0;" + NL + "int nb_line_copied_";
  protected final String TEXT_49 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_50 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_51 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_52 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_53 = "=0;" + NL + "int copiedCount_";
  protected final String TEXT_54 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_55 = " = null;" + NL + "String dbschema_";
  protected final String TEXT_56 = " = null;" + NL + "boolean whetherReject_";
  protected final String TEXT_57 = " = false;";
  protected final String TEXT_58 = NL;
  protected final String TEXT_59 = NL + "        int updateKeyCount_";
  protected final String TEXT_60 = " = ";
  protected final String TEXT_61 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_62 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_63 = NL + "        int deleteKeyCount_";
  protected final String TEXT_64 = " = ";
  protected final String TEXT_65 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_66 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_67 = NL + "\t\t    java.sql.Connection conn_";
  ...
  protected final String TEXT_79 = " = \"com.vertica.jdbc.Driver\";" + NL + "\t\t\t";
  protected final String TEXT_80 = NL + "\t\t\t\t\tString driverClass_";
  protected final String TEXT_81 = " = \"com.vertica.Driver\";" + NL + "\t\t\t";
  ...
  protected final String TEXT_91 = " = \"jdbc:vertica://\" + ";
  protected final String TEXT_92 = " + \":\" + ";
  protected final String TEXT_93 = " + \"/\" + ";
  protected final String TEXT_94 = " + \"?\" + ";
  protected final String TEXT_95 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_96 = NL + NL + "\t\t\t\tString dbUser_";
  ...
  protected final String TEXT_117 = NL + NL + "if(dbschema_";
  protected final String TEXT_118 = " == null || dbschema_";
  protected final String TEXT_119 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_120 = " = ";
  protected final String TEXT_121 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_122 = " = dbschema_";
  protected final String TEXT_123 = " + \".\" + ";
  protected final String TEXT_124 = ";" + NL + "}";
  protected final String TEXT_125 = NL + "conn_";
  protected final String TEXT_126 = ".setAutoCommit(false);" + NL + "" + NL + "int commitEvery_";
  protected final String TEXT_127 = " = ";
  protected final String TEXT_128 = ";" + NL + "" + NL + "int commitCounter_";
  protected final String TEXT_129 = " = 0;";
  protected final String TEXT_130 = NL + "   int batchSize_";
  protected final String TEXT_131 = " = ";
  protected final String TEXT_132 = ";" + NL + "   int batchSizeCounter_";
  ...
  protected final String TEXT_138 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_139 = " = conn_";
  protected final String TEXT_140 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_141 = NL + "            stmtDrop_";
  protected final String TEXT_142 = ".execute(\"";
  protected final String TEXT_143 = "\" ";
  protected final String TEXT_144 = ");" + NL + "\t\t\t";
  protected final String TEXT_145 = NL + "            stmtDrop_";
  protected final String TEXT_146 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_152 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_153 = ".";
  protected final String TEXT_154 = ", \"";
  protected final String TEXT_155 = "\")";
  protected final String TEXT_156 = ".toUpperCase()";
  ...
  protected final String TEXT_167 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_168 = NL + "\t\t\t";
  protected final String TEXT_169 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_170 = ".execute(((\"";
  protected final String TEXT_171 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_183 = ".close();" + NL + "\t\t";
  ...
  protected final String TEXT_203 = NL + "    \t\t\t\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_204 = " = conn_";
  protected final String TEXT_205 = ".createStatement();" + NL + "                \t\t\t\tboolean whetherExist_";
  protected final String TEXT_206 = " = false;" + NL + "                \t\t\t\ttry {" + NL + "                \t\t\t\t\tisExistStmt_";
  protected final String TEXT_207 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_208 = " + \"]\" );" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_209 = " = true;" + NL + "                \t\t\t\t} catch (java.lang.Exception e){" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_210 = " = false;" + NL + "                \t\t\t\t}" + NL + "                \t\t\t\tisExistStmt_";
  protected final String TEXT_211 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_212 = "   \t" + NL + "                \t\t\t\t";
  protected final String TEXT_213 = NL + "                \t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_214 = " = conn_";
  protected final String TEXT_215 = ".getMetaData();" + NL + "                \t            if(tableNameForSearch_";
  protected final String TEXT_216 = ".indexOf(\"\\\"\")==-1){" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_217 = " = tableNameForSearch_";
  protected final String TEXT_218 = ".toUpperCase();" + NL + "                            \t}else{" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_219 = " = tableNameForSearch_";
  protected final String TEXT_220 = ".replaceAll(\"\\\"\",\"\");" + NL + "                            \t}" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_221 = " = dbMetaData_";
  protected final String TEXT_222 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_223 = ", tableNameForSearch_";
  protected final String TEXT_224 = ", new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_225 = " = false;" + NL + "                \t            if(rsTable_";
  protected final String TEXT_226 = ".next()) {" + NL + "                \t            \twhetherExist_";
  protected final String TEXT_227 = " = true;" + NL + "                \t            }" + NL + "    \t            \t\t\trsTable_";
  protected final String TEXT_228 = ".close();" + NL + "    \t            " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_233 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_234 = " = false;" + NL + "                \t            while(rsTable_";
  protected final String TEXT_235 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_236 = " = rsTable_";
  protected final String TEXT_237 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_238 = " = rsTable_";
  protected final String TEXT_239 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_240 = ".equals";
  protected final String TEXT_241 = "IgnoreCase";
  protected final String TEXT_242 = "(";
  protected final String TEXT_243 = ") " + NL + "                \t                \t&& (schema_";
  ...
  protected final String TEXT_247 = ") || dbschema_";
  protected final String TEXT_248 = ".trim().length() ==0)) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_249 = " = true;" + NL + "                \t                    break;" + NL + "        \t            \t    \t}" + NL + "                        \t\t}" + NL + "            \t            \trsTable_";
  protected final String TEXT_250 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_251 = NL + "                \t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_255 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_256 = " = false;" + NL + "                \t            while(rsTable_";
  protected final String TEXT_257 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_258 = " = rsTable_";
  protected final String TEXT_259 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_260 = " = rsTable_";
  protected final String TEXT_261 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  ...
  protected final String TEXT_267 = ") " + NL + "                \t                \t&& (schema_";
  protected final String TEXT_268 = ".equals";
  protected final String TEXT_269 = "IgnoreCase";
  protected final String TEXT_270 = "(dbschema_";
  protected final String TEXT_271 = ") || (dbschema_";
  protected final String TEXT_272 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_273 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_282 = " = false;" + NL + "                \t            String defaultSchema_";
  protected final String TEXT_283 = " = \"public\";" + NL + "                \t            if(dbschema_";
  protected final String TEXT_284 = " == null || dbschema_";
  protected final String TEXT_285 = ".trim().length() == 0) {" + NL + "                \t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_286 = " = conn_";
  protected final String TEXT_287 = ".createStatement();" + NL + "                \t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_288 = " = stmtSchema_";
  protected final String TEXT_289 = ".executeQuery(\"select current_schema() \");" + NL + "                \t            \twhile(rsSchema_";
  protected final String TEXT_290 = ".next()){" + NL + "                \t            \t\tdefaultSchema_";
  protected final String TEXT_291 = " = rsSchema_";
  protected final String TEXT_292 = ".getString(\"current_schema\");" + NL + "                \t            \t}" + NL + "                \t            \trsSchema_";
  protected final String TEXT_293 = ".close();" + NL + "                \t            \tstmtSchema_";
  protected final String TEXT_294 = ".close();" + NL + "                \t            }" + NL + "                \t            while(rsTable_";
  protected final String TEXT_295 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_296 = " = rsTable_";
  protected final String TEXT_297 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_298 = " = rsTable_";
  protected final String TEXT_299 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_300 = ".equals";
  protected final String TEXT_301 = "IgnoreCase";
  ...
  protected final String TEXT_308 = " ==null || dbschema_";
  protected final String TEXT_309 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_310 = ".equals";
  protected final String TEXT_311 = "IgnoreCase";
  protected final String TEXT_312 = "(schema_";
  ...
  protected final String TEXT_316 = "      " + NL + "                \t            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_317 = " = conn_";
  protected final String TEXT_318 = ".getMetaData();" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_319 = " = dbMetaData_";
  protected final String TEXT_320 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_321 = " = false;" + NL + "                \t            while(rsTable_";
  protected final String TEXT_322 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_323 = " = rsTable_";
  protected final String TEXT_324 = ".getString(\"TABLE_NAME\");" + NL + "                \t                if(table_";
  protected final String TEXT_325 = ".equalsIgnoreCase(";
  protected final String TEXT_326 = ")) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_327 = " = true;" + NL + "                \t                    break;" + NL + "                \t                }" + NL + "                \t            }" + NL + "                \t            rsTable_";
  protected final String TEXT_328 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_329 = NL + "                    \t\t\tif(!whetherExist_";
  protected final String TEXT_330 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_335 = ".execute(((\"";
  protected final String TEXT_336 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_337 = ".";
  protected final String TEXT_338 = ", \"";
  protected final String TEXT_339 = "\")";
  protected final String TEXT_340 = ".toUpperCase()";
  protected final String TEXT_341 = ")+\")";
  protected final String TEXT_342 = "\"));" + NL + "    \t\t\t\t\t\t\t\t\t";
  protected final String TEXT_343 = NL + "    \t\t\t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_344 = ".execute(\"";
  protected final String TEXT_345 = ")\");" + NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_346 = NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_347 = NL + "                    \t\t\t\tstmtCreate_";
  protected final String TEXT_348 = ".close();            " + NL + "                    \t\t\t}                " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_349 = NL + "                                if(whetherExist_";
  protected final String TEXT_350 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_351 = " = conn_";
  protected final String TEXT_352 = ".createStatement();" + NL + "                \t    \t    \t";
  ...
  protected final String TEXT_358 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_364 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_375 = NL + "                        \t\tstmtCreate_";
  protected final String TEXT_376 = ".close();" + NL + "        \t\t\t\t\t";
  protected final String TEXT_377 = NL + "\t\t\t";
  protected final String TEXT_378 = NL + "    \t\t\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_379 = ", true);" + NL + "    \t\t//{{{" + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_380 = "            ";
  protected final String TEXT_381 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_382 = " = conn_";
  protected final String TEXT_383 = ".createStatement();" + NL + "    \t   \t";
  protected final String TEXT_384 = NL + "            stmtClear_";
  protected final String TEXT_385 = ".executeUpdate(\"";
  protected final String TEXT_386 = "\");" + NL + "   \t    \t";
  protected final String TEXT_387 = NL + "            stmtClear_";
  protected final String TEXT_388 = ".close();" + NL + "\t\t";
  protected final String TEXT_389 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_390 = " = conn_";
  protected final String TEXT_391 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_392 = " = stmtTruncCount_";
  protected final String TEXT_393 = ".executeQuery(\"";
  protected final String TEXT_394 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_395 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_396 = ".next()) {" + NL + "\t\t\t\trsTruncCountNumber_";
  protected final String TEXT_397 = " = rsTruncCount_";
  protected final String TEXT_398 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_399 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_400 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_405 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_406 = NL + "            stmtTrunc_";
  protected final String TEXT_407 = ".executeUpdate(\"";
  protected final String TEXT_408 = "\");";
  protected final String TEXT_409 = NL + "                if(!conn_";
  protected final String TEXT_410 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_411 = ".commit();" + NL + "                }";
  ...
  protected final String TEXT_416 = ".close();            " + NL + "\t\t";
  protected final String TEXT_417 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_418 = " = conn_";
  protected final String TEXT_419 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_420 = " = stmtTruncCount_";
  protected final String TEXT_421 = ".executeQuery(\"";
  protected final String TEXT_422 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_423 = " = conn_";
  protected final String TEXT_424 = ".createStatement();" + NL + "  \t    \t";
  protected final String TEXT_425 = NL + "\t\t\t";
  protected final String TEXT_426 = NL + "\t\t\t\tconn_";
  protected final String TEXT_427 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_428 = NL + "            stmtTrunc_";
  protected final String TEXT_429 = ".executeUpdate(\"";
  protected final String TEXT_430 = "\");" + NL + "   \t    \t";
  protected final String TEXT_431 = NL + "            while(rsTruncCount_";
  protected final String TEXT_432 = ".next()) {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_436 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_437 = ".close();" + NL + "\t\t";
  protected final String TEXT_438 = NL + "\t\t\t\tjava.sql.Statement stmtCreateProjection_";
  protected final String TEXT_439 = " = conn_";
  protected final String TEXT_440 = ".createStatement();" + NL + "\t\t\t\tstmtCreateProjection_";
  protected final String TEXT_441 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_442 = " + \"_proj (";
  protected final String TEXT_443 = ") AS SELECT ";
  protected final String TEXT_444 = " FROM \" + tableName_";
  protected final String TEXT_445 = ");" + NL + "\t\t\t\tstmtCreateProjection_";
  protected final String TEXT_446 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_447 = NL + "\t\t\t\tif(!whetherExist_";
  ...
  protected final String TEXT_456 = ".prepareStatement(insert_";
  protected final String TEXT_457 = ");";
  protected final String TEXT_458 = NL + "        int batchCount_";
  ...
  protected final String TEXT_466 = ".prepareStatement(update_";
  protected final String TEXT_467 = ");";
  protected final String TEXT_468 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_469 = " = conn_";
  protected final String TEXT_470 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_475 = ") VALUES (";
  protected final String TEXT_476 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_477 = " = conn_";
  protected final String TEXT_478 = ".prepareStatement(insert_";
  protected final String TEXT_479 = ");" + NL + "        String update_";
  protected final String TEXT_480 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_481 = " + \" SET ";
  protected final String TEXT_482 = " WHERE ";
  protected final String TEXT_483 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_484 = " = conn_";
  protected final String TEXT_485 = ".prepareStatement(update_";
  protected final String TEXT_486 = ");";
  protected final String TEXT_487 = NL + "        String update_";
  protected final String TEXT_488 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_489 = " + \" SET ";
  protected final String TEXT_490 = " WHERE ";
  protected final String TEXT_491 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_498 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_499 = " = conn_";
  protected final String TEXT_500 = ".prepareStatement(insert_";
  protected final String TEXT_501 = ");";
  protected final String TEXT_502 = NL + "        String delete_";
  protected final String TEXT_503 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_509 = NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_510 = " = new StringBuilder();" + NL + "        java.sql.Statement stmt_";
  protected final String TEXT_511 = " = conn_";
  protected final String TEXT_512 = ".createStatement();" + NL + "        String template_";
  protected final String TEXT_513 = " = \"COPY \" + tableName_";
  protected final String TEXT_514 = " +\" (";
  protected final String TEXT_515 = ")\"" + NL + "\t\t\t\t\t\t          + \" FROM STDIN UNCOMPRESSED WITH DELIMITER ';' RECORD TERMINATOR '\\n' ENCLOSED BY '|' NULL AS '' ";
  protected final String TEXT_516 = "DIRECT";
  protected final String TEXT_517 = "\";" + NL + "\t\t";
  protected final String TEXT_518 = NL + "        StringBuffer query_";
  protected final String TEXT_519 = " = null;" + NL + "       \t";
  protected final String TEXT_520 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_521 = " = insert_";
  protected final String TEXT_522 = ".split(\"\\\\?\");";
  protected final String TEXT_523 = NL + "\t\t\tupdate_";
  protected final String TEXT_524 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_525 = " = update_";
  protected final String TEXT_526 = ".split(\"\\\\?\");";
  protected final String TEXT_527 = NL + "\t\t\tupdate_";
  protected final String TEXT_528 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_529 = " = update_";
  protected final String TEXT_530 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_531 = " = insert_";
  protected final String TEXT_532 = ".split(\"\\\\?\");";
  protected final String TEXT_533 = NL + "\t\t\tdelete_";
  protected final String TEXT_534 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_535 = " = delete_";
  protected final String TEXT_536 = ".split(\"\\\\?\");";
  protected final String TEXT_537 = NL + "\t\t\treplace_";
  protected final String TEXT_538 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_539 = " = replace_";
  protected final String TEXT_540 = ".split(\"\\\\?\");";
  protected final String TEXT_541 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_542 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_543 = " = insertIgnore_";
  protected final String TEXT_544 = ".split(\"\\\\?\");";
  protected final String TEXT_545 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_546 = " = insert_";
  protected final String TEXT_547 = ".split(\"\\\\?\");";
  protected final String TEXT_548 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_549 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_550 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_551 = " =null;";
  protected final String TEXT_552 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_553 = " = null;" + NL + "\t\t";
  protected final String TEXT_554 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_555 = " = null;";
  protected final String TEXT_556 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_557 = " =  null;";
  protected final String TEXT_558 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_559 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_560 = " = null;";
  protected final String TEXT_561 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_562 = " = null;";
  protected final String TEXT_563 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_564 = " = null;";
  protected final String TEXT_565 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_569 = NL + "\t\tjava.sql.Statement stmt_";
  protected final String TEXT_570 = " = null;" + NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_571 = " = null;" + NL + "\t\tString template_";
...
//end issue 0010346 Parallelization crash with "Drop table if exists and create"
    ...
    stringBuffer.append(columnListStr.toString());
