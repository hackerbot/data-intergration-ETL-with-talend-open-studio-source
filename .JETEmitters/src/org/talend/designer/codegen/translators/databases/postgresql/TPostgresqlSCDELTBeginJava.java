...
public class TPostgresqlSCDELTBeginJava {
  protected static String nl;
  public static synchronized TPostgresqlSCDELTBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresqlSCDELTBeginJava result = new TPostgresqlSCDELTBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_191 = "] type2 new active row sql\\n\" + insertForType2_";
