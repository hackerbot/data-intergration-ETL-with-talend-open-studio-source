...
public class TEXARowBeginJava
{
  ...
  protected final String TEXT_83 = " " + NL + "\t\t\t\t\tif (null == conn_";
  protected final String TEXT_84 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_85 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES); " + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_86 = " = dataSources_";
  protected final String TEXT_87 = ".get(";
  protected final String TEXT_88 = ").getConnection();" + NL + "\t\t\t\t\t\tif (conn_";
  protected final String TEXT_89 = " != null) { " + NL + "\t\t\t\t\t\t\tconn_";
  protected final String TEXT_90 = ".setAutoCommit(";
  ...
  protected final String TEXT_96 = " = dataSources_";
  protected final String TEXT_97 = ".get(";
  protected final String TEXT_98 = ").getConnection();" + NL + "\t\t            } else {" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_116 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_117 = ".getAutoCommit()) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_118 = NL + "\t\t\t\t\t}        " + NL + "\t\t\t\t\tint commitEvery_";
  protected final String TEXT_119 = " = ";
  protected final String TEXT_120 = ";" + NL + "\t\t\t\t\tint commitCounter_";
  protected final String TEXT_121 = " = 0;" + NL + "\t\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\tString dbProperties_";
  protected final String TEXT_123 = " = ";
  protected final String TEXT_124 = ";" + NL + "\t        String url_";
  protected final String TEXT_125 = " = null;" + NL + "\t        if(dbProperties_";
  protected final String TEXT_126 = " == null || dbProperties_";
  protected final String TEXT_127 = ".trim().length() == 0) {" + NL + "\t            url_";
  protected final String TEXT_128 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_129 = " + \":\" + ";
  protected final String TEXT_130 = "+ \";schema=\" + ";
  protected final String TEXT_131 = "; " + NL + "\t        } else {" + NL + "\t            url_";
  protected final String TEXT_132 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_133 = " + \":\" + ";
  protected final String TEXT_134 = " + \";schema=\" + ";
  ...
  protected final String TEXT_141 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_142 = " = conn_";
  protected final String TEXT_143 = ".prepareStatement(";
