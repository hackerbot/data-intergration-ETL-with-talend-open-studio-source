...
public class TNetezzaNzLoadEndJava {
  protected static String nl;
  public static synchronized TNetezzaNzLoadEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNetezzaNzLoadEndJava result = new TNetezzaNzLoadEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_7 = " - Executing '\"+command_";
  protected final String TEXT_8 = ".toString()+\"'\");" + NL + "\t\t\t\t";
  protected final String TEXT_9 = NL + "\t";
  protected final String TEXT_10 = NL + "\t\t\tnzloadThread_";
  protected final String TEXT_11 = ".join(0);" + NL + "\t\t\t//TODO: clean up named pipe" + NL + "\t\t\t";
  protected final String TEXT_12 = NL + "\t\t\tnzloadThread_";
  protected final String TEXT_13 = ".start();" + NL + "\t\t\tnzloadThread_";
  protected final String TEXT_14 = ".join(0);" + NL + "\t\t\t";
  protected final String TEXT_15 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_16 = " - Execute '\"+command_";
  protected final String TEXT_17 = ".toString()+\"' has finished.\");" + NL + "\t\t\t\t";
  protected final String TEXT_18 = NL + "\t\t\t\t// added \"show log output\" feature" + NL + "\t\t\t\t";
  protected final String TEXT_19 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\t// System.out.println(\"reading log file :\" + ";
  protected final String TEXT_20 = " );" + NL + "\t\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t\t// Open the file and print contents " + NL + "\t\t\t\t\t\t\t java.io.FileInputStream fstream = new java.io.FileInputStream(";
  protected final String TEXT_21 = ");" + NL + "\t\t\t\t\t\t\t java.io.DataInputStream in = new java.io.DataInputStream(fstream);" + NL + "\t\t\t\t\t\t\t java.io.BufferedReader br = new java.io.BufferedReader(new java.io.InputStreamReader(in));" + NL + "\t\t\t\t\t\t\t String strLine;" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\twhile ((strLine = br.readLine()) != null)   {" + NL + "\t\t\t\t\t\t\t\tSystem.out.println (strLine);" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\tin.close();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tcatch (java.lang.Exception e) {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_22 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_23 = " - \" + e.getMessage());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_24 = NL + "\t\t\t\t\t\t\t// System.err.println(\"Error Reading Log File \" + e.getMessage());" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_25 = NL + "\t\t\t\t// end \"show log output\"" + NL + "\t\t\t\t";
    ...
    public String generate(Object argument)
  {
    ...
    stringBuffer.append(file_location);
