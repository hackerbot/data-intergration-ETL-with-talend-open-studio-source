...
public class TSybaseSCDELTBeginJava {
  protected static String nl;
  public static synchronized TSybaseSCDELTBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSybaseSCDELTBeginJava result = new TSybaseSCDELTBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_34 = NL + "    String tableName_";
  protected final String TEXT_35 = " = ";
  protected final String TEXT_36 = ";" + NL + "    String sourceTable_";
  ...
  protected final String TEXT_43 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_44 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_45 = " = conn_";
  protected final String TEXT_46 = ".createStatement();" + NL + "            stmtCreate_";
  ...
  protected final String TEXT_56 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_57 = " = conn_";
  protected final String TEXT_58 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_59 = " = dbMetaData_";
  protected final String TEXT_60 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_61 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_62 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_63 = " = rsTable_";
  protected final String TEXT_64 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_65 = ".equalsIgnoreCase(";
  protected final String TEXT_66 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_67 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  protected final String TEXT_68 = ".close();";
  protected final String TEXT_69 = NL + "                if(!whetherExist_";
  protected final String TEXT_70 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_71 = " = conn_";
  protected final String TEXT_72 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_76 = NL + "                if(whetherExist_";
  protected final String TEXT_77 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_78 = " = conn_";
  protected final String TEXT_79 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_80 = ".execute(\"";
  protected final String TEXT_81 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_82 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_83 = " = conn_";
  protected final String TEXT_84 = ".createStatement();" + NL + "                stmtCreate_";
  protected final String TEXT_85 = ".execute(\"";
  protected final String TEXT_86 = ")\");" + NL + "                stmtCreate_";
  protected final String TEXT_87 = ".close();";
  protected final String TEXT_88 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_89 = " = conn_";
  protected final String TEXT_90 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_91 = ".executeUpdate(\"";
  protected final String TEXT_92 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_93 = ".close();";
  protected final String TEXT_94 = NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_95 = " = conn_";
  protected final String TEXT_96 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_97 = ".executeUpdate(\"";
  protected final String TEXT_98 = "\");" + NL + "            stmtTrunc_";
  protected final String TEXT_99 = ".close();";
  protected final String TEXT_100 = NL + "        System.out.println(\"[";
  protected final String TEXT_101 = "] table action ";
  protected final String TEXT_102 = " done\\n\");";
  protected final String TEXT_103 = NL + "        String updateForType1_";
  protected final String TEXT_104 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_105 = " + \" SET ";
  protected final String TEXT_106 = " FROM \" + sourceTable_";
  protected final String TEXT_107 = " + \" t WHERE ";
  protected final String TEXT_108 = " AND (";
  protected final String TEXT_109 = ")\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_110 = " = conn_";
  protected final String TEXT_111 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_112 = ".executeUpdate(updateForType1_";
  protected final String TEXT_113 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_114 = ".close();";
  protected final String TEXT_115 = NL + "            System.out.println(\"[";
  protected final String TEXT_116 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_117 = " + \"\\ndone\");";
  protected final String TEXT_118 = NL + "        String updateForType2_";
  protected final String TEXT_119 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_120 = " + \" SET ";
  protected final String TEXT_121 = " = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_122 = "\"))) + \"'";
  protected final String TEXT_123 = ", ";
  protected final String TEXT_124 = " = 0";
  protected final String TEXT_125 = " FROM \" + sourceTable_";
  protected final String TEXT_126 = " + \" t WHERE ";
  protected final String TEXT_127 = " AND (";
  protected final String TEXT_128 = ") AND \" + tableName_";
  protected final String TEXT_129 = " + \".";
  protected final String TEXT_130 = " IS NULL\";" + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_131 = " = conn_";
  protected final String TEXT_132 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_133 = ".executeUpdate(updateForType2_";
  protected final String TEXT_134 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_135 = ".close();";
  protected final String TEXT_136 = NL + "            System.out.println(\"[";
  protected final String TEXT_137 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_138 = " + \"\\ndone\");";
  protected final String TEXT_139 = NL + "        String insertForType2_";
  protected final String TEXT_140 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_141 = " + \"(";
  protected final String TEXT_142 = ", ";
  protected final String TEXT_143 = ") SELECT ";
  protected final String TEXT_144 = "\" + ";
  protected final String TEXT_145 = " + \".NEXTVAL, ";
  protected final String TEXT_146 = "t.";
  protected final String TEXT_147 = ", '\" + " + NL + "        (new java.sql.Timestamp((Long)start_Hash.get(\"";
  ...
  protected final String TEXT_152 = " FROM \" + " + NL + "        sourceTable_";
  protected final String TEXT_153 = " + \" t, \" + tableName_";
  protected final String TEXT_154 = " + \" d WHERE ";
  protected final String TEXT_155 = " AND (";
  protected final String TEXT_156 = ") AND d.";
  protected final String TEXT_157 = " = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_158 = "\"))) + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_159 = " = conn_";
  protected final String TEXT_160 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_161 = ".executeUpdate(insertForType2_";
  protected final String TEXT_162 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_163 = ".close();";
  protected final String TEXT_164 = NL + "            System.out.println(\"[";
  protected final String TEXT_165 = "] type2 new active row slq\\n\" + insertForType2_";
  protected final String TEXT_166 = " + \"\\ndone\");";
  protected final String TEXT_167 = NL + "    String insert_";
  protected final String TEXT_168 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_169 = " + \"(";
  protected final String TEXT_170 = ", ";
  protected final String TEXT_171 = ") SELECT ";
  protected final String TEXT_172 = "\" + ";
  protected final String TEXT_173 = " + \".NEXTVAL, ";
  protected final String TEXT_174 = "t.";
  protected final String TEXT_175 = "\"";
  protected final String TEXT_176 = " + \", '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_177 = "\"))) + \"', NULL\"";
  protected final String TEXT_178 = NL + "    + \"";
  protected final String TEXT_179 = ", 1";
  protected final String TEXT_180 = ", 1";
  protected final String TEXT_181 = " FROM \" + " + NL + "    sourceTable_";
  protected final String TEXT_182 = " + \" t LEFT JOIN \" + tableName_";
  protected final String TEXT_183 = " + \" d ON ";
  protected final String TEXT_184 = " WHERE (";
  protected final String TEXT_185 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_186 = " = conn_";
  protected final String TEXT_187 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_188 = ".executeUpdate(insert_";
  protected final String TEXT_189 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_190 = ".close();";
  protected final String TEXT_191 = NL + "        System.out.println(\"[";
  protected final String TEXT_192 = "] new rows sql\\n\" + insert_";
