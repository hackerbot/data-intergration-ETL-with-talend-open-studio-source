...
public class TDB2SCDELTBeginJava {
  protected static String nl;
  public static synchronized TDB2SCDELTBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDB2SCDELTBeginJava result = new TDB2SCDELTBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_10 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_11 = " + \":\" + ";
  protected final String TEXT_12 = " + \"/\" + ";
  protected final String TEXT_13 = ";    ";
  protected final String TEXT_14 = NL + "\t\t\tString url_";
  protected final String TEXT_15 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_16 = " + \":\" + ";
  protected final String TEXT_17 = " + \"/\" + ";
  protected final String TEXT_18 = " + \":\" + ";
  protected final String TEXT_19 = ";";
  protected final String TEXT_20 = NL + "        java.lang.Class.forName(\"com.ibm.db2.jcc.DB2Driver\");" + NL + "        String dbUser_";
  ...
  protected final String TEXT_30 = NL + NL + "        String dbPwd_";
  ...
  protected final String TEXT_36 = ");" + NL + "        String schema_";
  protected final String TEXT_37 = " = ";
  protected final String TEXT_38 = ";";
  protected final String TEXT_39 = NL + "    String tableName_";
  protected final String TEXT_40 = " = null;" + NL + "    String sourceTable_";
  protected final String TEXT_41 = " = null;" + NL + "    if(schema_";
  protected final String TEXT_42 = " != null && schema_";
  protected final String TEXT_43 = ".trim().length() != 0) {" + NL + "        tableName_";
  protected final String TEXT_44 = " = schema_";
  protected final String TEXT_45 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_46 = ";" + NL + "        sourceTable_";
  protected final String TEXT_47 = " = schema_";
  protected final String TEXT_48 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_49 = ";" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_50 = " = ";
  protected final String TEXT_51 = ";" + NL + "        sourceTable_";
  protected final String TEXT_52 = " = ";
  protected final String TEXT_53 = ";" + NL + "    }";
  protected final String TEXT_54 = NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_55 = " = conn_";
  protected final String TEXT_56 = ".createStatement();" + NL + "            stmtDrop_";
  ...
  protected final String TEXT_61 = ".createStatement();" + NL + "            stmtCreate_";
  protected final String TEXT_62 = ".execute(\"";
  protected final String TEXT_63 = ")\");" + NL + "            stmtCreate_";
  protected final String TEXT_64 = ".close();";
  protected final String TEXT_65 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_66 = " = conn_";
  protected final String TEXT_67 = ".createStatement();" + NL + "            stmtCreate_";
  protected final String TEXT_68 = ".execute(\"";
  protected final String TEXT_69 = ")\");" + NL + "            stmtCreate_";
  protected final String TEXT_70 = ".close();";
  protected final String TEXT_71 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_72 = " = conn_";
  protected final String TEXT_73 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_74 = " = dbMetaData_";
  protected final String TEXT_75 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_76 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_77 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_78 = " = rsTable_";
  protected final String TEXT_79 = ".getString(\"TABLE_NAME\");" + NL + "                String qSchema_";
  protected final String TEXT_80 = " = rsTable_";
  protected final String TEXT_81 = ".getString(\"TABLE_SCHEM\");" + NL + "                if(table_";
  protected final String TEXT_82 = ".equals(";
  protected final String TEXT_83 = ") " + NL + "                \t&& (qSchema_";
  protected final String TEXT_84 = ".equals(schema_";
  protected final String TEXT_85 = ") || ((schema_";
  protected final String TEXT_86 = " == null || schema_";
  protected final String TEXT_87 = ".trim().length() ==0) && dbUser_";
  protected final String TEXT_88 = ".equalsIgnoreCase(qSchema_";
  protected final String TEXT_89 = ")))) {" + NL + "                    whetherExist_";
  protected final String TEXT_90 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  protected final String TEXT_91 = ".close();";
  protected final String TEXT_92 = NL + "                if(!whetherExist_";
  protected final String TEXT_93 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_94 = " = conn_";
  protected final String TEXT_95 = ".createStatement();" + NL + "\t\t            stmtCreate_";
  protected final String TEXT_96 = ".execute(\"";
  protected final String TEXT_97 = ")\");" + NL + "                    stmtCreate_";
  protected final String TEXT_98 = ".close();" + NL + "                }                ";
  protected final String TEXT_99 = NL + "                if(whetherExist_";
  protected final String TEXT_100 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_101 = " = conn_";
  protected final String TEXT_102 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_103 = ".execute(\"";
  protected final String TEXT_104 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_105 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_106 = " = conn_";
  protected final String TEXT_107 = ".createStatement();" + NL + "\t            stmtCreate_";
  ...
  protected final String TEXT_111 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_112 = " = conn_";
  protected final String TEXT_113 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_114 = ".executeUpdate(\"";
  protected final String TEXT_115 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_116 = ".close();";
  protected final String TEXT_117 = NL + "        System.out.println(\"[";
  protected final String TEXT_118 = "] table action ";
  protected final String TEXT_119 = " done\\n\");";
  protected final String TEXT_120 = NL + "        String updateForType1_";
  protected final String TEXT_121 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_122 = " + \"\\\" d SET (";
  protected final String TEXT_123 = ") = (SELECT ";
  protected final String TEXT_124 = " FROM \\\"\" + sourceTable_";
  protected final String TEXT_125 = " + \"\\\" t WHERE ";
  protected final String TEXT_126 = " AND (";
  protected final String TEXT_127 = ")) WHERE EXISTS (SELECT 1 FROM \\\"\" + sourceTable_";
  protected final String TEXT_128 = " + \"\\\" t WHERE ";
  protected final String TEXT_129 = " AND (";
  protected final String TEXT_130 = "))\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_131 = " = conn_";
  protected final String TEXT_132 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_133 = ".executeUpdate(updateForType1_";
  protected final String TEXT_134 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_135 = ".close();";
  protected final String TEXT_136 = NL + "            System.out.println(\"[";
  protected final String TEXT_137 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_138 = " + \"\\ndone\");";
  protected final String TEXT_139 = NL + "        String updateForType2_";
  protected final String TEXT_140 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_141 = " + \"\\\" d SET \\\"";
  protected final String TEXT_142 = "\\\" = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_143 = "\"))) + \"'";
  protected final String TEXT_144 = ", \\\"";
  protected final String TEXT_145 = "\\\" = 0";
  protected final String TEXT_146 = " WHERE EXISTS (SELECT 1 FROM \\\"\" + sourceTable_";
  protected final String TEXT_147 = " + " + NL + "        \"\\\" t WHERE ";
  protected final String TEXT_148 = " AND (";
  protected final String TEXT_149 = ")) AND d.\\\"";
  protected final String TEXT_150 = "\\\" IS NULL\";" + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_151 = " = conn_";
  protected final String TEXT_152 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_153 = ".executeUpdate(updateForType2_";
  protected final String TEXT_154 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_155 = ".close();";
  protected final String TEXT_156 = NL + "            System.out.println(\"[";
  protected final String TEXT_157 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_158 = " + \"\\ndone\");";
  protected final String TEXT_159 = NL + "        String insertForType2_";
  protected final String TEXT_160 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_161 = " + \"\\\"(";
  protected final String TEXT_162 = "\\\"";
  protected final String TEXT_163 = "\\\", ";
  protected final String TEXT_164 = ") SELECT ";
  protected final String TEXT_165 = "NEXT VALUE FOR \" + ";
  protected final String TEXT_166 = " + \", ";
  protected final String TEXT_167 = "t.";
  protected final String TEXT_168 = ", '\" + " + NL + "        (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_169 = "\"))) + \"', CAST(NULL AS ";
  protected final String TEXT_170 = ")";
  protected final String TEXT_171 = ", 1";
  protected final String TEXT_172 = ", d.\\\"";
  protected final String TEXT_173 = "\\\" + 1";
  protected final String TEXT_174 = " FROM \\\"\" + " + NL + "        sourceTable_";
  protected final String TEXT_175 = " + \"\\\" t, \\\"\" + tableName_";
  protected final String TEXT_176 = " + \"\\\" d WHERE ";
  protected final String TEXT_177 = " AND (";
  protected final String TEXT_178 = ") AND d.\\\"";
  protected final String TEXT_179 = "\\\" = '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_180 = "\"))) + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_181 = " = conn_";
  protected final String TEXT_182 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_183 = ".executeUpdate(insertForType2_";
  protected final String TEXT_184 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_185 = ".close();";
  protected final String TEXT_186 = NL + "            System.out.println(\"[";
  protected final String TEXT_187 = "] type2 new active row slq\\n\" + insertForType2_";
  protected final String TEXT_188 = " + \"\\ndone\");";
  protected final String TEXT_189 = NL + "    String insert_";
  protected final String TEXT_190 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_191 = " + \"\\\"(";
  protected final String TEXT_192 = "\\\"";
  protected final String TEXT_193 = "\\\", ";
  protected final String TEXT_194 = ") SELECT ";
  protected final String TEXT_195 = "NEXT VALUE FOR \" + ";
  protected final String TEXT_196 = " + \", ";
  protected final String TEXT_197 = "t.";
  protected final String TEXT_198 = "\"";
  protected final String TEXT_199 = " + \", '\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_200 = "\"))) + \"', CAST(NULL AS ";
  protected final String TEXT_201 = ")\"";
  protected final String TEXT_202 = NL + "    + \"";
  protected final String TEXT_203 = ", 1";
  protected final String TEXT_204 = ", 1";
  protected final String TEXT_205 = " FROM \\\"\" + " + NL + "    sourceTable_";
  protected final String TEXT_206 = " + \"\\\" t LEFT JOIN \\\"\" + tableName_";
  protected final String TEXT_207 = " + \"\\\" d ON ";
  protected final String TEXT_208 = " WHERE (";
  protected final String TEXT_209 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_210 = " = conn_";
  protected final String TEXT_211 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_212 = ".executeUpdate(insert_";
  protected final String TEXT_213 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_214 = ".close();";
  protected final String TEXT_215 = NL + "        System.out.println(\"[";
  protected final String TEXT_216 = "] new rows sql\\n\" + insert_";
