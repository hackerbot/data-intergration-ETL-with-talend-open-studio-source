...
public class TGreenplumInputBeginJava
{
  protected static String nl;
  public static synchronized TGreenplumInputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGreenplumInputBeginJava result = new TGreenplumInputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_184 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_185 = " + \":\" + ";
  protected final String TEXT_186 = " + \"/\" + ";
  protected final String TEXT_187 = ";";
  protected final String TEXT_188 = NL + "                stmt_";
  protected final String TEXT_189 = ".setFetchSize(";
  protected final String TEXT_190 = ");";
  protected final String TEXT_191 = NL + "    " + NL + "\t";
  protected final String TEXT_192 = NL + "\t\t    int nb_line_";
  protected final String TEXT_193 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  ...
  protected final String TEXT_198 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_199 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_200 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_201 = " = dataSources_";
  protected final String TEXT_202 = ".get(";
  protected final String TEXT_203 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_204 = "\", conn_";
  protected final String TEXT_205 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_206 = NL + "\t\t\t\t";
  protected final String TEXT_207 = NL + "\t\t\t\t";
  protected final String TEXT_208 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_209 = " =  conn_";
  protected final String TEXT_210 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_211 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_212 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_213 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_214 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_215 = NL + "                 conn_";
  protected final String TEXT_216 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_217 = NL + "               ";
  protected final String TEXT_218 = " + \"=\" + ";
  protected final String TEXT_219 = " + \";\" +";
  protected final String TEXT_220 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_221 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_222 = ");";
  protected final String TEXT_223 = NL + "\t\t    ";
  protected final String TEXT_224 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_225 = " = ";
  protected final String TEXT_226 = ";" + NL + "\t\t\t";
  protected final String TEXT_227 = NL + "                log.info(\"";
  protected final String TEXT_228 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_229 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_230 = NL;
  protected final String TEXT_231 = NL + "                       globalMap.put(\"";
  protected final String TEXT_232 = "_QUERY\",dbquery_";
  protected final String TEXT_233 = ");";
  protected final String TEXT_234 = NL + "                       globalMap.put(\"";
  protected final String TEXT_235 = "_QUERY\",dbquery_";
  protected final String TEXT_236 = ");";
  protected final String TEXT_237 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_238 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_239 = " = stmt_";
  protected final String TEXT_240 = ".executeQuery(dbquery_";
  protected final String TEXT_241 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_242 = " = rs_";
  protected final String TEXT_243 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_244 = " = rsmd_";
  protected final String TEXT_245 = ".getColumnCount();" + NL;
  protected final String TEXT_246 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_247 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_248 = ".setDbmsId(\"";
  protected final String TEXT_249 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_250 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_251 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_252 = ".add(\"";
  protected final String TEXT_253 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_254 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_255 = " = ";
  protected final String TEXT_256 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_257 = "; i <= rsmd_";
  protected final String TEXT_258 = ".getColumnCount()-";
  protected final String TEXT_259 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_260 = ".contains(rsmd_";
  protected final String TEXT_261 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_262 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_263 = ".setName(rsmd_";
  protected final String TEXT_264 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_265 = ".setDbName(rsmd_";
  protected final String TEXT_266 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_267 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_268 = "\", rsmd_";
  protected final String TEXT_269 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_270 = ".getPrecision(i), rsmd_";
  protected final String TEXT_271 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_272 = ".setDbType(rsmd_";
  protected final String TEXT_273 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_274 = ".setDbTypeId(rsmd_";
  protected final String TEXT_275 = ".getColumnType(i));";
  ...
  protected final String TEXT_301 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_302 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_303 = NL + "\t\t    ";
  protected final String TEXT_304 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_305 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_306 = NL + "\t\t    while (rs_";
  protected final String TEXT_307 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_308 = "++;" + NL + "\t\t        ";
  protected final String TEXT_309 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_310 = " = ";
  protected final String TEXT_311 = " + dcg_";
  protected final String TEXT_312 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_313 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_314 = " = ";
  protected final String TEXT_315 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_316 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_317 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_318 = " < ";
  protected final String TEXT_319 = "column_index_";
  ...
  protected final String TEXT_329 = " = (List)rs_";
  protected final String TEXT_330 = ".getObject(";
  protected final String TEXT_331 = "column_index_";
  protected final String TEXT_332 = ");";
  protected final String TEXT_333 = NL + "\t\t                         ";
  protected final String TEXT_334 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_335 = ".getObject(";
  protected final String TEXT_336 = "column_index_";
  protected final String TEXT_337 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_338 = NL + "                                    ";
  protected final String TEXT_339 = ".";
  protected final String TEXT_340 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_356 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_357 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_380 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_381 = ".";
  protected final String TEXT_382 = ", rs_";
  protected final String TEXT_383 = ", fixedColumnCount_";
  protected final String TEXT_384 = ",";
  protected final String TEXT_385 = ");";
  protected final String TEXT_386 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_387 = ".";
  protected final String TEXT_388 = ", rs_";
  protected final String TEXT_389 = ", fixedColumnCount_";
  protected final String TEXT_390 = ",";
  protected final String TEXT_391 = ");";
  protected final String TEXT_392 = NL + "                                  Object geom = rs_";
  protected final String TEXT_393 = ".getObject(";
  protected final String TEXT_394 = "column_index_";
  protected final String TEXT_395 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_396 = ".";
  protected final String TEXT_397 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_398 = ".";
  protected final String TEXT_399 = " = null;" + NL + "                                  }";
  protected final String TEXT_400 = NL + "\t\t                          ";
  protected final String TEXT_401 = NL + "\t\t                    }";
  protected final String TEXT_402 = NL + "\t\t\t\t\t";
  protected final String TEXT_403 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_404 = " - Retrieving the record \" + nb_line_";
