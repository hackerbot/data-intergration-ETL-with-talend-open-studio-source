...
public class TSybaseOutputBeginJava {
  protected static String nl;
  public static synchronized TSybaseOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSybaseOutputBeginJava result = new TSybaseOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_52 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_53 = " = ";
  protected final String TEXT_54 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_55 = " = false;" + NL + "String dbschema_";
  ...
  protected final String TEXT_70 = NL + "\tdbschema_";
  protected final String TEXT_71 = "= (String)globalMap.get(\"";
  protected final String TEXT_72 = "\");" + NL + "\t";
  protected final String TEXT_73 = NL + "    String dbUser_";
  ...
  protected final String TEXT_85 = ";" + NL + "" + NL + "    java.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");" + NL + "\t";
  protected final String TEXT_86 = NL + "\t\tString url_";
  protected final String TEXT_87 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_88 = " + \":\" + ";
  protected final String TEXT_89 = " + \"/\" + ";
  protected final String TEXT_90 = ";";
  protected final String TEXT_91 = NL + "\t\tString url_";
  protected final String TEXT_92 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_93 = " + \":\" + ";
  protected final String TEXT_94 = " + \"/\" + ";
  protected final String TEXT_95 = " + \"?\" + ";
  protected final String TEXT_96 = ";";
  protected final String TEXT_97 = NL + "\t";
  protected final String TEXT_98 = NL + "    java.sql.Connection conn_";
  ...
  protected final String TEXT_103 = NL + "\tresourceMap.put(\"conn_";
  ...
  protected final String TEXT_108 = NL + "        int commitEvery_";
  protected final String TEXT_109 = " = ";
  protected final String TEXT_110 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_111 = " = 0;";
  protected final String TEXT_112 = NL;
  protected final String TEXT_113 = NL + "   int batchSize_";
  protected final String TEXT_114 = " = ";
  protected final String TEXT_115 = ";" + NL + "   int batchSizeCounter_";
  ...
  protected final String TEXT_123 = NL + "int count_";
  protected final String TEXT_124 = "=0;";
  protected final String TEXT_125 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_126 = " = conn_";
  protected final String TEXT_127 = ".createStatement();" + NL + "\t\t\t";
  ...
  protected final String TEXT_133 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_138 = ".execute(((\"";
  protected final String TEXT_139 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_140 = ".";
  protected final String TEXT_141 = ", \"";
  protected final String TEXT_142 = "\")";
  protected final String TEXT_143 = ".toUpperCase()";
  ...
  protected final String TEXT_152 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_173 = NL + "\t\t    \t\tString keyCheckTable_";
  protected final String TEXT_174 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_175 = "+\"][\"+";
  protected final String TEXT_176 = "+\"][\"+";
  protected final String TEXT_177 = "+\"][\"+";
  protected final String TEXT_178 = "+\"][\"+";
  protected final String TEXT_179 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_180 = " + \"]\";" + NL + "\t\t    \t";
  protected final String TEXT_181 = NL + "        \t\t    // [%connection%][checktable][tableName]" + NL + "        \t\t    String keyCheckTable_";
  protected final String TEXT_182 = " = conn_";
  protected final String TEXT_183 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_184 = " + \"]\";" + NL + "    \t\t    ";
  protected final String TEXT_185 = NL + "\t\t    " + NL + "\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_186 = ")== null){//}" + NL + "\t\t\t" + NL + "\t\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_187 = ")) {//}" + NL + "\t\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_188 = ")== null){//}" + NL + "\t\t\t";
  protected final String TEXT_189 = "              " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_190 = NL + "    \t\t\t\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_191 = " = conn_";
  protected final String TEXT_192 = ".createStatement();" + NL + "                \t\t\t\tboolean whetherExist_";
  protected final String TEXT_193 = " = false;" + NL + "                \t\t\t\ttry {" + NL + "                \t\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_197 = " = false;" + NL + "                \t\t\t\t}" + NL + "                \t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_207 = ".replaceAll(\"\\\"\",\"\");" + NL + "                            \t}" + NL + "                \t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_211 = ", new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_212 = " = false;" + NL + "                \t            if(rsTable_";
  protected final String TEXT_213 = ".next()) {" + NL + "                \t            \twhetherExist_";
  protected final String TEXT_214 = " = true;" + NL + "                \t            }" + NL + "    \t            \t\t\trsTable_";
  protected final String TEXT_215 = ".close();" + NL + "    \t            " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_224 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  ...
  protected final String TEXT_230 = ") " + NL + "                \t                \t&& (schema_";
  ...
  protected final String TEXT_234 = ") || dbschema_";
  protected final String TEXT_235 = ".trim().length() ==0)) {" + NL + "                \t                    whetherExist_";
  ...
  protected final String TEXT_253 = ".toUpperCase()";
  ...
  protected final String TEXT_322 = ".execute(((\"";
  protected final String TEXT_323 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_324 = ".";
  protected final String TEXT_325 = ", \"";
  protected final String TEXT_326 = "\")";
  protected final String TEXT_327 = ".toUpperCase()";
  ...
  protected final String TEXT_335 = ".close();            " + NL + "                    \t\t\t}                " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_336 = NL + "                                if(whetherExist_";
  protected final String TEXT_337 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_344 = NL + "                                    stmtDrop_";
  protected final String TEXT_345 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_351 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_352 = ".";
  protected final String TEXT_353 = ", \"";
  protected final String TEXT_354 = "\")";
  protected final String TEXT_355 = ".toUpperCase()";
  protected final String TEXT_356 = ")+\")";
  protected final String TEXT_357 = "\"));" + NL + "        \t\t\t\t\t\t\t";
  protected final String TEXT_358 = NL + "        \t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_359 = ".execute(\"";
  protected final String TEXT_360 = ")\");" + NL + "        \t\t\t\t\t\t";
  protected final String TEXT_361 = NL + "        \t    \t    \t\t";
  protected final String TEXT_362 = NL + "                        \t\tstmtCreate_";
  protected final String TEXT_363 = ".close();" + NL + "        \t\t\t\t\t";
  protected final String TEXT_364 = NL + "\t\t\t";
  protected final String TEXT_365 = NL + "    \t\t\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_366 = ", true);" + NL + "    \t\t//{{{" + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_367 = "            ";
  protected final String TEXT_368 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_369 = " = conn_";
  protected final String TEXT_370 = ".createStatement();" + NL + "    \t   \t";
  protected final String TEXT_371 = NL + "            stmtClear_";
  protected final String TEXT_372 = ".executeUpdate(\"";
  protected final String TEXT_373 = "\");" + NL + "   \t    \t";
  protected final String TEXT_374 = NL + "            stmtClear_";
  protected final String TEXT_375 = ".close();" + NL + "\t\t";
  protected final String TEXT_376 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_377 = " = conn_";
  protected final String TEXT_378 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_379 = " = stmtTruncCount_";
  protected final String TEXT_380 = ".executeQuery(\"";
  protected final String TEXT_381 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_382 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_383 = ".next()) {" + NL + "\t\t\t\trsTruncCountNumber_";
  protected final String TEXT_384 = " = rsTruncCount_";
  protected final String TEXT_385 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_386 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_387 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_388 = " = conn_";
  protected final String TEXT_389 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_390 = NL + "\t\t\t";
  protected final String TEXT_391 = NL + "\t\t\t\tconn_";
  protected final String TEXT_392 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_393 = NL + "            stmtTrunc_";
  protected final String TEXT_394 = ".executeUpdate(\"";
  protected final String TEXT_395 = "\");";
  protected final String TEXT_396 = NL + "                if(!conn_";
  protected final String TEXT_397 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_398 = ".commit();" + NL + "                }";
  protected final String TEXT_399 = NL + "   \t    \t";
  protected final String TEXT_400 = NL + "   \t    \tdeletedCount_";
  protected final String TEXT_401 = " += rsTruncCountNumber_";
  protected final String TEXT_402 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_403 = ".close();            " + NL + "\t\t";
  protected final String TEXT_404 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_405 = " = conn_";
  protected final String TEXT_406 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_407 = " = stmtTruncCount_";
  protected final String TEXT_408 = ".executeQuery(\"";
  protected final String TEXT_409 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_418 = NL + "            while(rsTruncCount_";
  protected final String TEXT_419 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_420 = " += rsTruncCount_";
  protected final String TEXT_421 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_422 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_423 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_428 = ") VALUES (";
  protected final String TEXT_429 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_430 = " = conn_";
  protected final String TEXT_431 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_436 = " WHERE ";
  protected final String TEXT_437 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_448 = ") VALUES (";
  protected final String TEXT_449 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_450 = " = conn_";
  protected final String TEXT_451 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_456 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_464 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_475 = NL + "\t    String delete_";
  protected final String TEXT_476 = " = \"DELETE  FROM \" + tableName_";
  protected final String TEXT_477 = " + \" WHERE ";
  protected final String TEXT_478 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_479 = " = conn_";
  protected final String TEXT_480 = ".prepareStatement(delete_";
  protected final String TEXT_481 = ");" + NL + "\t    ";
  protected final String TEXT_482 = NL + "        StringBuffer query_";
  protected final String TEXT_483 = " = null;" + NL + "       \t";
  protected final String TEXT_484 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_485 = " = insert_";
  protected final String TEXT_486 = ".split(\"\\\\?\");";
  protected final String TEXT_487 = NL + "\t\t\tupdate_";
  protected final String TEXT_488 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_489 = " = update_";
  protected final String TEXT_490 = ".split(\"\\\\?\");";
  protected final String TEXT_491 = NL + "\t\t\tupdate_";
  protected final String TEXT_492 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_493 = " = update_";
  protected final String TEXT_494 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_495 = " = insert_";
  protected final String TEXT_496 = ".split(\"\\\\?\");";
  protected final String TEXT_497 = NL + "\t\t\tdelete_";
  protected final String TEXT_498 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_499 = " = delete_";
  protected final String TEXT_500 = ".split(\"\\\\?\");";
  protected final String TEXT_501 = NL + "\t\t\treplace_";
  protected final String TEXT_502 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_503 = " = replace_";
  protected final String TEXT_504 = ".split(\"\\\\?\");";
  protected final String TEXT_505 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_506 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_507 = " = insertIgnore_";
  protected final String TEXT_508 = ".split(\"\\\\?\");";
  protected final String TEXT_509 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_510 = " = insert_";
  protected final String TEXT_511 = ".split(\"\\\\?\");";
  protected final String TEXT_512 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_513 = " = conn_";
  protected final String TEXT_514 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_515 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_516 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_517 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_518 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_519 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_520 = " =null;" + NL + "\t";
  protected final String TEXT_521 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_522 = " = null;" + NL + "\t\t";
  protected final String TEXT_523 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_524 = " = null;";
  protected final String TEXT_525 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_526 = " =  null;";
  protected final String TEXT_527 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_528 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_529 = " = null;";
  protected final String TEXT_530 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_531 = " = null;";
  protected final String TEXT_532 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_533 = " = null;";
  protected final String TEXT_534 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_535 = " = null;";
  protected final String TEXT_536 = NL + "\t\t \tString[] insertSQLSplits_";
