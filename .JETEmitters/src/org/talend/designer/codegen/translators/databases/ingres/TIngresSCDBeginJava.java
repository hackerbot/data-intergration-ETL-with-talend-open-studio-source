...
public class TIngresSCDBeginJava {
  ...
  protected final String TEXT_9 = ";" + NL + "    String schema_";
  ...
  protected final String TEXT_14 = NL + "    \tjava.lang.Class.forName(\"com.ingres.jdbc.IngresDriver\");" + NL + "    \tString connectionString_";
  protected final String TEXT_15 = " = \"jdbc:ingres://\" + ";
  ...
  protected final String TEXT_26 = NL + "\t   \t" + NL + "    \tjava.sql.Connection connection_";
  ...
  protected final String TEXT_31 = NL + "    java.sql.Timestamp timestamp_";
  ...
  protected final String TEXT_79 = NL + "                            if(tmpValue_";
  ...
  protected final String TEXT_152 = NL + "            String endDateTimeDetail_";
  protected final String TEXT_153 = " = ";
  protected final String TEXT_154 = ";" + NL + "            String datePattern_";
  protected final String TEXT_155 = " = \"yyyy-MM-dd\";" + NL + "            if(endDateTimeDetail_";
  protected final String TEXT_156 = ".length()>0){" + NL + "            \tendDateTimeDetail_";
  protected final String TEXT_157 = " = \" \"+endDateTimeDetail_";
  protected final String TEXT_158 = ";" + NL + "            \tdatePattern_";
  protected final String TEXT_159 = " = \"yyyy-MM-dd HH:mm:ss\";" + NL + "            }" + NL + "            insertionStatement_";
  protected final String TEXT_160 = ".setTimestamp(";
  protected final String TEXT_161 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(datePattern_";
  protected final String TEXT_162 = ").parse(";
  protected final String TEXT_163 = " + \"-01-01\"+endDateTimeDetail_";
  protected final String TEXT_164 = ").getTime()));";
  protected final String TEXT_165 = NL + "        String updateSQLForType1_";
  protected final String TEXT_166 = " = \"";
  protected final String TEXT_167 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_168 = " = connection_";
  protected final String TEXT_169 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_170 = ");        ";
  protected final String TEXT_171 = NL + "        String updateSQLForType2_";
  protected final String TEXT_172 = " = \"";
  protected final String TEXT_173 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_174 = " = connection_";
  protected final String TEXT_175 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_176 = ");";
  protected final String TEXT_177 = NL + "            updateForType2_";
  protected final String TEXT_178 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_179 = "\")));";
  protected final String TEXT_180 = NL + "        String updateSQLForType3_";
  protected final String TEXT_181 = " = \"";
  protected final String TEXT_182 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_183 = " = connection_";
  protected final String TEXT_184 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_185 = ");";
  protected final String TEXT_186 = NL + "    ";
  protected final String TEXT_187 = NL + "        SCDSK_";
  protected final String TEXT_188 = " lookUpKey_";
  protected final String TEXT_189 = " = null;        ";
  protected final String TEXT_190 = NL + "    SCDStruct_";
  protected final String TEXT_191 = " lookUpValue_";
