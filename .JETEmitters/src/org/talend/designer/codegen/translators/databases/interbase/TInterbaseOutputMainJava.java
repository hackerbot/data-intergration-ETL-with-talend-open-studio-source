...
public class TInterbaseOutputMainJava {
  protected static String nl;
  public static synchronized TInterbaseOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInterbaseOutputMainJava result = new TInterbaseOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_63 = ".addBatch();" + NL + "                      batchSizeCounter_";
  protected final String TEXT_64 = "++;" + NL + "                      nb_line_";
  protected final String TEXT_65 = "++;";
  protected final String TEXT_66 = NL + "                       try {" + NL + "                           insertedCount_";
  protected final String TEXT_67 = " = insertedCount_";
  protected final String TEXT_68 = " + pstmt_";
  protected final String TEXT_69 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_70 = "++;";
  protected final String TEXT_71 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  ...
  protected final String TEXT_82 = NL + "                                   rejectedCount_";
  protected final String TEXT_83 = " = rejectedCount_";
  protected final String TEXT_84 = " + 1;";
  protected final String TEXT_85 = NL + "                                   ";
  protected final String TEXT_86 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_87 = NL + "                                   ";
  protected final String TEXT_88 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_89 = ";";
  protected final String TEXT_90 = NL + "                                   System.err.print(e.getMessage());";
  protected final String TEXT_91 = NL + "                       }";
  protected final String TEXT_92 = NL + "                    ";
  protected final String TEXT_93 = NL + "                        query_";
  protected final String TEXT_94 = " = ";
  protected final String TEXT_95 = ";";
  protected final String TEXT_96 = NL + NL + "\t\t\t\t\t";
  protected final String TEXT_97 = NL + "                    \t";
  protected final String TEXT_98 = NL + "                        query_";
  ...
  protected final String TEXT_109 = NL + "                       pstmt_";
  protected final String TEXT_110 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_111 = "++;" + NL + "                       nb_line_";
  ...
  protected final String TEXT_118 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  protected final String TEXT_119 = " = true;";
  ...
  protected final String TEXT_129 = NL + "                                   rejectedCount_";
  protected final String TEXT_130 = " = rejectedCount_";
  ...
  protected final String TEXT_184 = NL + "                            rejectedCount_";
  protected final String TEXT_185 = " = rejectedCount_";
  protected final String TEXT_186 = " + 1;";
  protected final String TEXT_187 = NL + "                            ";
  protected final String TEXT_188 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_189 = NL + "                            ";
  protected final String TEXT_190 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_191 = ";";
  protected final String TEXT_192 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_193 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_194 = NL + "                        ";
  protected final String TEXT_195 = NL + "                            query_";
  protected final String TEXT_196 = " = ";
  protected final String TEXT_197 = ";";
  protected final String TEXT_198 = NL + "                    globalMap.put(\"";
  protected final String TEXT_199 = "_QUERY\", query_";
  protected final String TEXT_200 = ".toString().trim());";
  protected final String TEXT_201 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_202 = " = insertedCount_";
  protected final String TEXT_203 = " + pstmtInsert_";
  protected final String TEXT_204 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_205 = "++;";
  protected final String TEXT_206 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_207 = " = true;";
  protected final String TEXT_208 = NL + "                        throw(e);";
  protected final String TEXT_209 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_219 = NL + "                            rejectedCount_";
  protected final String TEXT_220 = " = rejectedCount_";
  protected final String TEXT_221 = " + 1;";
  protected final String TEXT_222 = NL + "                            ";
  protected final String TEXT_223 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_224 = NL + "                            ";
  protected final String TEXT_225 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_226 = ";";
  protected final String TEXT_227 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_228 = NL + "                }" + NL + "            }";
  protected final String TEXT_229 = NL + "            int updateFlag_";
  protected final String TEXT_230 = "=0;";
  protected final String TEXT_231 = NL + "                    ";
  protected final String TEXT_232 = NL + "                        query_";
  ...
  protected final String TEXT_241 = NL + "                        query_";
  protected final String TEXT_242 = " = ";
  protected final String TEXT_243 = ";";
  protected final String TEXT_244 = NL + "                globalMap.put(\"";
  protected final String TEXT_245 = "_QUERY\", query_";
  protected final String TEXT_246 = ".toString().trim());";
  protected final String TEXT_247 = NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_248 = "=pstmtUpdate_";
  protected final String TEXT_249 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_250 = " = updatedCount_";
  protected final String TEXT_251 = "+updateFlag_";
  protected final String TEXT_252 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_253 = " == 0) {" + NL + "            \t";
  protected final String TEXT_254 = NL + "\t\t\t\tquery_";
  protected final String TEXT_255 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_256 = NL + "                        ";
  protected final String TEXT_257 = NL + "                            query_";
  protected final String TEXT_258 = " = ";
  protected final String TEXT_259 = ";";
  protected final String TEXT_260 = NL + "                    globalMap.put(\"";
  protected final String TEXT_261 = "_QUERY\", query_";
  protected final String TEXT_262 = ".toString().trim());";
  protected final String TEXT_263 = NL + "                    insertedCount_";
  protected final String TEXT_264 = " = insertedCount_";
  protected final String TEXT_265 = " + pstmtInsert_";
  protected final String TEXT_266 = ".executeUpdate();" + NL + "             \t\tnb_line_";
  protected final String TEXT_267 = "++;";
  protected final String TEXT_268 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_269 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_270 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_271 = " = true;";
  protected final String TEXT_272 = NL + "                        throw(e);";
  ...
  protected final String TEXT_283 = NL + "                            rejectedCount_";
  protected final String TEXT_284 = " = rejectedCount_";
  protected final String TEXT_285 = " + 1;";
  protected final String TEXT_286 = NL + "                            ";
  protected final String TEXT_287 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_288 = NL + "                            ";
  protected final String TEXT_289 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_290 = ";";
  protected final String TEXT_291 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_306 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_307 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_308 = "++;";
  protected final String TEXT_309 = NL + "                       try {" + NL + "                           deletedCount_";
  protected final String TEXT_310 = " = deletedCount_";
  protected final String TEXT_311 = " + pstmt_";
  protected final String TEXT_312 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_313 = "++;";
  protected final String TEXT_314 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  protected final String TEXT_315 = " = true;";
  protected final String TEXT_316 = NL + "                               throw(e);";
  protected final String TEXT_317 = NL + "                            nb_line_";
  ...
  protected final String TEXT_327 = NL + "                                   rejectedCount_";
  protected final String TEXT_328 = " = rejectedCount_";
  protected final String TEXT_329 = " + 1;";
  protected final String TEXT_330 = NL + "                                   ";
  protected final String TEXT_331 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_332 = NL + "                                   ";
  protected final String TEXT_333 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_334 = ";";
  protected final String TEXT_335 = NL + "                                   System.err.print(e.getMessage());";
  protected final String TEXT_336 = NL + "                       }";
  protected final String TEXT_337 = NL + "            if(!whetherReject_";
  protected final String TEXT_338 = ") {";
  protected final String TEXT_339 = NL + "                            ";
  protected final String TEXT_340 = " = new ";
  protected final String TEXT_341 = "Struct();";
  ...
  protected final String TEXT_348 = NL + "                if ((batchSize_";
  protected final String TEXT_349 = " > 0) && (batchSize_";
  protected final String TEXT_350 = " <= batchSizeCounter_";
  protected final String TEXT_351 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_352 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_353 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_354 = " = 0;";
  protected final String TEXT_355 = NL + "                        status_";
  protected final String TEXT_356 = " = pstmt_";
  protected final String TEXT_357 = ".executeBatch();";
  protected final String TEXT_358 = NL + "                        for(int countEach_";
  protected final String TEXT_359 = ": status_";
  protected final String TEXT_360 = ") {" + NL + "                            countSum_";
  protected final String TEXT_361 = " += (countEach_";
  protected final String TEXT_362 = " < 0 ? 0 : countEach_";
  protected final String TEXT_363 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_364 = NL + "                            throw(e);";
  protected final String TEXT_365 = NL + "                        for(int countEach_";
  protected final String TEXT_366 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_367 = " += (countEach_";
  protected final String TEXT_368 = " < 0 ? 0 : countEach_";
  protected final String TEXT_369 = ");" + NL + "                        }";
  protected final String TEXT_370 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_371 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_372 = " = pstmt_";
  protected final String TEXT_373 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_374 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_375 = " = tmp_batchUpdateCount_";
  protected final String TEXT_376 = " > countSum_";
  protected final String TEXT_377 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_378 = " : countSum_";
  protected final String TEXT_379 = ";";
  protected final String TEXT_380 = NL + "                        insertedCount_";
  protected final String TEXT_381 = " += tmp_batchUpdateCount_";
  protected final String TEXT_382 = ";";
  protected final String TEXT_383 = NL + "                        updatedCount_";
  protected final String TEXT_384 = " += tmp_batchUpdateCount_";
  protected final String TEXT_385 = ";";
  protected final String TEXT_386 = NL + "                        deletedCount_";
  protected final String TEXT_387 = " += tmp_batchUpdateCount_";
  protected final String TEXT_388 = ";";
  protected final String TEXT_389 = NL + "               }";
  protected final String TEXT_390 = NL + "                commitCounter_";
  protected final String TEXT_391 = "++;" + NL + "" + NL + "                if(commitEvery_";
  protected final String TEXT_392 = " <= commitCounter_";
  protected final String TEXT_393 = ") {";
  protected final String TEXT_394 = NL + "                                  if(batchSize_";
  protected final String TEXT_395 = " > 0){";
  protected final String TEXT_396 = NL + "                                        conn_";
  protected final String TEXT_397 = ".commit();";
  protected final String TEXT_398 = NL + "                                        commitCounter_";
  protected final String TEXT_399 = "=0;" + NL + "                                  }";
  protected final String TEXT_400 = NL + "                                     conn_";
  protected final String TEXT_401 = ".commit();";
  protected final String TEXT_402 = NL + "                                     commitCounter_";
