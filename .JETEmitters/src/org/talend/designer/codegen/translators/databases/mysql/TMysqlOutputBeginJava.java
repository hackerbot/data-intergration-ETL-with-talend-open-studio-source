...
public class TMysqlOutputBeginJava {
  ...
  protected final String TEXT_78 = NL + "\t\tif (null == conn_";
  protected final String TEXT_79 = ") {" + NL + "\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_80 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\tconn_";
  protected final String TEXT_81 = " = dataSources_";
  protected final String TEXT_82 = ".get(";
  protected final String TEXT_83 = ").getConnection();" + NL + "\t\t\tif (conn_";
  protected final String TEXT_84 = " != null) {" + NL + "\t\t\t\tconn_";
  ...
  protected final String TEXT_93 = ").getConnection();" + NL + "\t\t} else {";
  protected final String TEXT_94 = NL + "\t\tString dbProperties_";
  protected final String TEXT_95 = " = ";
  protected final String TEXT_96 = ";" + NL + "\t\tString url_";
  protected final String TEXT_97 = " = null;" + NL + "\t\tif(dbProperties_";
  protected final String TEXT_98 = " == null || dbProperties_";
  protected final String TEXT_99 = ".trim().length() == 0) {" + NL + "\t\t\turl_";
  protected final String TEXT_100 = " = \"";
  protected final String TEXT_101 = "://\" + ";
  protected final String TEXT_102 = " + \":\" + ";
  protected final String TEXT_103 = " + \"/\" + ";
  protected final String TEXT_104 = " + \"?\" + \"rewriteBatchedStatements=true\";" + NL + "\t\t} else {" + NL + "\t\t\tString properties_";
  protected final String TEXT_105 = " = ";
  protected final String TEXT_106 = ";" + NL + "\t\t\tif (!properties_";
  protected final String TEXT_107 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\t\tproperties_";
  protected final String TEXT_108 = " += \"&rewriteBatchedStatements=true\";" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\turl_";
  protected final String TEXT_109 = " = \"";
  protected final String TEXT_110 = "://\" + ";
  protected final String TEXT_111 = " + \":\" + ";
  protected final String TEXT_112 = " + \"/\" + ";
  protected final String TEXT_113 = " + \"?\" + properties_";
  protected final String TEXT_114 = ";" + NL + "\t\t}" + NL + "\t\tString driverClass_";
  ...
  protected final String TEXT_129 = ";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_138 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_139 = "\", conn_";
  protected final String TEXT_140 = ");";
  protected final String TEXT_141 = NL + "        conn_";
  protected final String TEXT_142 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_143 = " = ";
  protected final String TEXT_144 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_145 = " = 0;";
  protected final String TEXT_146 = NL + "   int batchSize_";
  protected final String TEXT_147 = " = ";
  protected final String TEXT_148 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_149 = "=0;";
  protected final String TEXT_150 = NL;
  protected final String TEXT_151 = NL + "int count_";
  ...
  protected final String TEXT_156 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_157 = NL + "            stmtDrop_";
  protected final String TEXT_158 = ".execute(\"";
  protected final String TEXT_159 = "\" ";
  protected final String TEXT_160 = ");" + NL + "\t\t\t";
  protected final String TEXT_161 = NL + "            stmtDrop_";
  protected final String TEXT_162 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_163 = " = conn_";
  protected final String TEXT_164 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_165 = NL + "\t\t\t";
  protected final String TEXT_166 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_167 = ".execute(((\"";
  protected final String TEXT_168 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_169 = ".";
  protected final String TEXT_170 = ", \"";
  protected final String TEXT_171 = "\")";
  protected final String TEXT_172 = ".toUpperCase()";
  ...
  protected final String TEXT_180 = ".close();" + NL + "\t\t";
  protected final String TEXT_181 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_182 = " = conn_";
  protected final String TEXT_183 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_184 = NL + "\t\t\t";
  protected final String TEXT_185 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_186 = ".execute(((\"";
  protected final String TEXT_187 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_202 = NL + "\t\t    \t\tString keyCheckTable_";
  protected final String TEXT_203 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_204 = "+\"][\"+";
  protected final String TEXT_205 = "+\"][\"+";
  protected final String TEXT_206 = "+\"][\"+";
  protected final String TEXT_207 = "+\"][\"+";
  protected final String TEXT_208 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_209 = " + \"]\";" + NL + "\t\t    \t";
  protected final String TEXT_210 = NL + "        \t\t    // [%connection%][checktable][tableName]" + NL + "        \t\t    String keyCheckTable_";
  protected final String TEXT_211 = " = conn_";
  protected final String TEXT_212 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_213 = " + \"]\";" + NL + "    \t\t    ";
  protected final String TEXT_214 = NL + "\t\t    " + NL + "\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_215 = ")== null){//}" + NL + "\t\t\t" + NL + "\t\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_216 = ")) {//}" + NL + "\t\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_217 = ")== null){//}" + NL + "\t\t\t";
  protected final String TEXT_218 = "              " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_219 = NL + "    \t\t\t\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_220 = " = conn_";
  protected final String TEXT_221 = ".createStatement();" + NL + "                \t\t\t\tboolean whetherExist_";
  protected final String TEXT_222 = " = false;" + NL + "                \t\t\t\ttry {" + NL + "                \t\t\t\t\tisExistStmt_";
  protected final String TEXT_223 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_224 = " + \"]\" );" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_225 = " = true;" + NL + "                \t\t\t\t} catch (java.lang.Exception e){" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_226 = " = false;" + NL + "                \t\t\t\t}" + NL + "                \t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_231 = ".getMetaData();" + NL + "                \t            if(tableNameForSearch_";
  protected final String TEXT_232 = ".indexOf(\"\\\"\")==-1){" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_233 = " = tableNameForSearch_";
  protected final String TEXT_234 = ".toUpperCase();" + NL + "                            \t}else{" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_235 = " = tableNameForSearch_";
  protected final String TEXT_236 = ".replaceAll(\"\\\"\",\"\");" + NL + "                            \t}" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_237 = " = dbMetaData_";
  protected final String TEXT_238 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_239 = ", tableNameForSearch_";
  protected final String TEXT_240 = ", new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_241 = " = false;" + NL + "                \t            if(rsTable_";
  protected final String TEXT_242 = ".next()) {" + NL + "                \t            \twhetherExist_";
  protected final String TEXT_243 = " = true;" + NL + "                \t            }" + NL + "    \t            \t\t\trsTable_";
  protected final String TEXT_244 = ".close();" + NL + "    \t            " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_245 = "  \t            " + NL + "                \t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_246 = " = conn_";
  protected final String TEXT_247 = ".getMetaData();" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_248 = " = dbMetaData_";
  protected final String TEXT_249 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_250 = " = false;" + NL + "                \t            while(rsTable_";
  protected final String TEXT_251 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_252 = " = rsTable_";
  protected final String TEXT_253 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_254 = " = rsTable_";
  protected final String TEXT_255 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_256 = ".equals";
  protected final String TEXT_257 = "IgnoreCase";
  protected final String TEXT_258 = "(";
  protected final String TEXT_259 = ") " + NL + "                \t                \t&& (schema_";
  protected final String TEXT_260 = ".equals";
  protected final String TEXT_261 = "IgnoreCase";
  protected final String TEXT_262 = "(dbschema_";
  protected final String TEXT_263 = ") || dbschema_";
  protected final String TEXT_264 = ".trim().length() ==0)) {" + NL + "                \t                    whetherExist_";
  ...
  protected final String TEXT_282 = ".toUpperCase()";
  ...
  protected final String TEXT_331 = ".close();" + NL + "        \t\t\t\t\t";
  ...
  protected final String TEXT_352 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_363 = NL + "                    \t\t\t\tstmtCreate_";
  protected final String TEXT_364 = ".close();            " + NL + "                    \t\t\t}                " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_365 = NL + "                                if(whetherExist_";
  protected final String TEXT_366 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_367 = " = conn_";
  protected final String TEXT_368 = ".createStatement();" + NL + "                \t    \t    \t";
  protected final String TEXT_369 = NL + "                                    stmtDrop_";
  protected final String TEXT_370 = ".execute(\"";
  ...
  protected final String TEXT_380 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_381 = ".";
  protected final String TEXT_382 = ", \"";
  protected final String TEXT_383 = "\")";
  protected final String TEXT_384 = ".toUpperCase()";
  ...
  protected final String TEXT_394 = NL + "    \t\t\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_395 = ", true);" + NL + "    \t\t//{{{" + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_396 = "            ";
  protected final String TEXT_397 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_398 = " = conn_";
  protected final String TEXT_399 = ".createStatement();" + NL + "    \t   \t";
  protected final String TEXT_400 = NL + "            stmtClear_";
  protected final String TEXT_401 = ".executeUpdate(\"";
  protected final String TEXT_402 = "\");" + NL + "   \t    \t";
  protected final String TEXT_403 = NL + "            stmtClear_";
  ...
  protected final String TEXT_410 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_411 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_412 = ".next()) {" + NL + "\t\t\t\trsTruncCountNumber_";
  protected final String TEXT_413 = " = rsTruncCount_";
  protected final String TEXT_414 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_415 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_416 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_420 = NL + "\t\t\t\tconn_";
  protected final String TEXT_421 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_422 = NL + "            stmtTrunc_";
  protected final String TEXT_423 = ".executeUpdate(\"";
  protected final String TEXT_424 = "\");";
  protected final String TEXT_425 = NL + "                if(!conn_";
  protected final String TEXT_426 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_427 = ".commit();" + NL + "                }";
  protected final String TEXT_428 = NL + "   \t    \t";
  protected final String TEXT_429 = NL + "   \t    \tdeletedCount_";
  protected final String TEXT_430 = " += rsTruncCountNumber_";
  protected final String TEXT_431 = ";" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_443 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_444 = NL + "            stmtTrunc_";
  protected final String TEXT_445 = ".executeUpdate(\"";
  protected final String TEXT_446 = "\");" + NL + "   \t    \t";
  protected final String TEXT_447 = NL + "            while(rsTruncCount_";
  protected final String TEXT_448 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_449 = " += rsTruncCount_";
  protected final String TEXT_450 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_451 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_452 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_453 = ".close();" + NL + "\t\t";
  protected final String TEXT_454 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_455 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");" + NL + "\t\t\t\t";
  protected final String TEXT_456 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_457 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_458 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_459 = ".append (\"`\" +  ";
  protected final String TEXT_460 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_461 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_468 = ") VALUES (";
  protected final String TEXT_469 = ")\";";
  protected final String TEXT_470 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_471 = " += \tduplidateClause_";
  ...
  protected final String TEXT_483 = NL + "                        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_489 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_490 = " = conn_";
  protected final String TEXT_491 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_492 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_493 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_494 = ",insert_";
  protected final String TEXT_495 = ",keyPsmt_";
  protected final String TEXT_496 = ");";
  protected final String TEXT_497 = NL;
  protected final String TEXT_498 = NL + "\t            class BufferLine_";
  protected final String TEXT_499 = " {" + NL + "    \t            ";
  protected final String TEXT_500 = NL + "                            ";
  protected final String TEXT_501 = " ";
  protected final String TEXT_502 = ";";
  protected final String TEXT_503 = NL + NL + "\t                public BufferLine_";
  ...
  protected final String TEXT_512 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_513 = "> exInsertColValueList";
  protected final String TEXT_514 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_515 = " exInsertColValue";
  protected final String TEXT_516 = " = null;" + NL + "" + NL + "" + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_517 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_518 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_519 = ".append(\"(";
  protected final String TEXT_520 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_521 = "-1) extendInsertValueStmt_";
  protected final String TEXT_522 = ".append(\",\");" + NL + "                }" + NL + "" + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_523 = " = \"INSERT INTO `\"+";
  protected final String TEXT_524 = "+\"` (";
  protected final String TEXT_525 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_526 = ".toString();";
  protected final String TEXT_527 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_528 = " += \tduplidateClause_";
  protected final String TEXT_529 = ".toString();";
  ...
  protected final String TEXT_539 = "    " + NL + "\t            java.sql.PreparedStatement pstmt_";
  protected final String TEXT_540 = " =  conn_";
  protected final String TEXT_541 = ".prepareStatement(insert_";
  protected final String TEXT_542 = ");" + NL + "" + NL + "\t            String insertColName";
  protected final String TEXT_543 = " = \"";
  protected final String TEXT_544 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_545 = " =  \"";
  protected final String TEXT_546 = "\";" + NL + "\t            int rowCount";
  protected final String TEXT_547 = " = 0;";
  protected final String TEXT_548 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_549 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_550 = " + \"` (";
  protected final String TEXT_551 = ") VALUES (";
  protected final String TEXT_552 = ")\";";
  protected final String TEXT_553 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_554 = " += \tduplidateClause_";
  protected final String TEXT_555 = ".toString();";
  protected final String TEXT_556 = NL + "\t\t        int batchSize_";
  protected final String TEXT_557 = " = ";
  protected final String TEXT_558 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_559 = "=0;" + NL + "\t\t        ";
  protected final String TEXT_560 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_561 = " = new StringBuffer(insert_";
  protected final String TEXT_562 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_563 = ".insert(insert_";
  protected final String TEXT_564 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_565 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_566 = " =insertStringBuffer_";
  protected final String TEXT_567 = ".toString(); ";
  protected final String TEXT_568 = "    " + NL + "\t\t        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_569 = " = conn_";
  protected final String TEXT_570 = ".prepareStatement(insert_";
  protected final String TEXT_571 = ");" + NL;
  protected final String TEXT_572 = NL + "\t    String update_";
  protected final String TEXT_573 = " = \"UPDATE `\" + ";
  protected final String TEXT_574 = " + \"` SET ";
  protected final String TEXT_575 = " WHERE ";
  protected final String TEXT_576 = "\";" + NL + "\t    ";
  protected final String TEXT_577 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_578 = " = new StringBuffer(update_";
  protected final String TEXT_579 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_580 = ".insert(update_";
  protected final String TEXT_581 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_582 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_583 = " =updateStringBuffer_";
  ...
  protected final String TEXT_587 = ".prepareStatement(update_";
  protected final String TEXT_588 = ");" + NL + "\t    ";
  protected final String TEXT_589 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_590 = " = conn_";
  protected final String TEXT_591 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_592 = " + \"` WHERE ";
  protected final String TEXT_593 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_594 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_595 = " + \"` (";
  protected final String TEXT_596 = ") VALUES (";
  ...
  protected final String TEXT_606 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_610 = " = \"UPDATE `\" + ";
  protected final String TEXT_611 = " + \"` SET ";
  protected final String TEXT_612 = " WHERE ";
  protected final String TEXT_613 = "\";" + NL + "\t    ";
  protected final String TEXT_614 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_615 = " = new StringBuffer(update_";
  protected final String TEXT_616 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_617 = ".insert(update_";
  protected final String TEXT_618 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_619 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_620 = " =updateStringBuffer_";
  protected final String TEXT_621 = ".toString(); ";
  protected final String TEXT_622 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_623 = " = conn_";
  protected final String TEXT_624 = ".prepareStatement(update_";
  ...
  protected final String TEXT_643 = " = \"INSERT INTO `\" + ";
  ...
  protected final String TEXT_655 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_671 = NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_679 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_739 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_740 = " {" + NL + "    \t            ";
  protected final String TEXT_741 = NL + "                            ";
  protected final String TEXT_742 = " ";
  protected final String TEXT_743 = ";";
  protected final String TEXT_744 = NL + "\t\t\t\troutines.system.Dynamic ";
  protected final String TEXT_745 = ";" + NL + "\t\t\t";
  protected final String TEXT_746 = NL + NL + "\t                public BufferLine_";
  protected final String TEXT_747 = "(";
  protected final String TEXT_748 = NL + "                                ,";
  protected final String TEXT_749 = NL + "                            ";
  protected final String TEXT_750 = " ";
  protected final String TEXT_751 = NL + "\t\t\t\t, routines.system.Dynamic ";
  ...
  protected final String TEXT_760 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_761 = "> exInsertColValueList";
  protected final String TEXT_762 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_763 = " exInsertColValue";
  protected final String TEXT_764 = " = null;" + NL + "\t\t    String insert_";
  protected final String TEXT_765 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_766 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_767 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_768 = "=1;";
  protected final String TEXT_769 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_770 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_771 = "=0;";
  protected final String TEXT_772 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_773 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_774 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_775 = " =null;" + NL + "\tint rowCount";
  protected final String TEXT_776 = "=0;" + NL + "\t";
  protected final String TEXT_777 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_778 = " = null;" + NL + "\t\t";
  protected final String TEXT_779 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_780 = " = null;";
  protected final String TEXT_781 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_782 = " =  null;";
  protected final String TEXT_783 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_784 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_785 = " = null;";
  protected final String TEXT_786 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_787 = " = null;";
  protected final String TEXT_788 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_789 = " = null;";
  protected final String TEXT_790 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_791 = " = null;";
  protected final String TEXT_792 = NL + "\t\t \tString[] insertSQLSplits_";
