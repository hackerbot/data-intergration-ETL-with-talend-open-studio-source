...
public class TOracleSCDELTBeginJava {
  ...
  protected final String TEXT_46 = NL + "\tString atnParams_";
  protected final String TEXT_47 = " = ";
  protected final String TEXT_48 = ";" + NL + "\tatnParams_";
  protected final String TEXT_49 = " = atnParams_";
  protected final String TEXT_50 = ".replaceAll(\"&\", \"\\n\");" + NL + "\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_51 = " = new java.util.Properties();" + NL + "\tatnParamsPrope_";
  protected final String TEXT_52 = ".put(\"user\",dbUser_";
  protected final String TEXT_53 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_54 = ".put(\"password\",dbPwd_";
  protected final String TEXT_55 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_56 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_57 = ".getBytes()));" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_58 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_59 = ", atnParamsPrope_";
  protected final String TEXT_60 = ");";
  protected final String TEXT_61 = NL + "        " + NL + "        String schema_";
  protected final String TEXT_62 = " = ";
  protected final String TEXT_63 = ";";
  protected final String TEXT_64 = NL + "    String tableName_";
  protected final String TEXT_65 = " = null;" + NL + "    String sourceTable_";
  protected final String TEXT_66 = " = null;" + NL + "    String schema4search_";
  protected final String TEXT_67 = " = null;" + NL + "    if(schema_";
  protected final String TEXT_68 = " != null && schema_";
  protected final String TEXT_69 = ".trim().length() != 0) {" + NL + "        tableName_";
  protected final String TEXT_70 = " = schema_";
  protected final String TEXT_71 = " + \".\" + ";
  protected final String TEXT_72 = ";" + NL + "        sourceTable_";
  protected final String TEXT_73 = " = schema_";
  protected final String TEXT_74 = " + \".\" + ";
  protected final String TEXT_75 = ";" + NL + "        schema4search_";
  protected final String TEXT_76 = " = schema_";
  protected final String TEXT_77 = ".toUpperCase();" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_78 = " = ";
  protected final String TEXT_79 = ";" + NL + "        sourceTable_";
  protected final String TEXT_80 = " = ";
  protected final String TEXT_81 = ";" + NL + "        schema4search_";
  protected final String TEXT_82 = " = dbUser_";
  protected final String TEXT_83 = ".toUpperCase();" + NL + "    }";
  protected final String TEXT_84 = NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_85 = " = conn_";
  protected final String TEXT_86 = ".createStatement();" + NL + "            stmtDrop_";
  protected final String TEXT_87 = ".execute(\"";
  protected final String TEXT_88 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_89 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_90 = " = conn_";
  protected final String TEXT_91 = ".createStatement();" + NL + "            stmtCreate_";
  ...
  protected final String TEXT_97 = ".createStatement();" + NL + "            stmtCreate_";
  protected final String TEXT_98 = ".execute(\"";
  protected final String TEXT_99 = ")\");" + NL + "            stmtCreate_";
  protected final String TEXT_100 = ".close();";
  protected final String TEXT_101 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_102 = " = conn_";
  protected final String TEXT_103 = ".getMetaData();" + NL + "            String tableName4Search_";
  protected final String TEXT_104 = " = ";
  protected final String TEXT_105 = ";" + NL + "            if(tableName4Search_";
  protected final String TEXT_106 = ".indexOf(\"\\\"\")==-1){" + NL + "            \ttableName4Search_";
  protected final String TEXT_107 = " = tableName4Search_";
  protected final String TEXT_108 = ".toUpperCase();" + NL + "            }else{" + NL + "            \ttableName4Search_";
  protected final String TEXT_109 = " = tableName4Search_";
  protected final String TEXT_110 = ".replaceAll(\"\\\"\",\"\");" + NL + "            }" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_111 = " = dbMetaData_";
  protected final String TEXT_112 = ".getTables(null, schema4search_";
  protected final String TEXT_113 = ", tableName4Search_";
  protected final String TEXT_114 = ", new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_115 = " = false;" + NL + "            if(rsTable_";
  protected final String TEXT_116 = ".next()) {" + NL + "                    whetherExist_";
  protected final String TEXT_117 = " = true;" + NL + "            }" + NL + "            rsTable_";
  protected final String TEXT_118 = ".close();";
  protected final String TEXT_119 = NL + "                if(!whetherExist_";
  protected final String TEXT_120 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_121 = " = conn_";
  protected final String TEXT_122 = ".createStatement();" + NL + "                    stmtCreate_";
  protected final String TEXT_123 = ".execute(\"";
  protected final String TEXT_124 = ")\");" + NL + "                    stmtCreate_";
  protected final String TEXT_125 = ".close();" + NL + "                }                ";
  protected final String TEXT_126 = NL + "                if(whetherExist_";
  ...
  protected final String TEXT_132 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_133 = " = conn_";
  protected final String TEXT_134 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_138 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_139 = " = conn_";
  protected final String TEXT_140 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_141 = ".executeUpdate(\"";
  protected final String TEXT_142 = "\");" + NL + "            stmtClear_";
  ...
  protected final String TEXT_148 = "\");" + NL + "            stmtTrunc_";
  protected final String TEXT_149 = ".close();";
  protected final String TEXT_150 = NL + "        System.out.println(\"[";
  protected final String TEXT_151 = "] table action ";
  protected final String TEXT_152 = " done\\n\");";
  protected final String TEXT_153 = NL + "    java.util.Date currentDate_";
  protected final String TEXT_154 = " = new java.util.Date((Long)start_Hash.get(\"";
  protected final String TEXT_155 = "\"));" + NL + "    String dateString_";
  protected final String TEXT_156 = " = routines.system.FormatterUtils.format_Date(currentDate_";
  protected final String TEXT_157 = ", \"yyyy-MM-dd HH:mm:ss\");" + NL + "    String dateValue_";
  protected final String TEXT_158 = " = \"to_date('\" + dateString_";
  protected final String TEXT_159 = " + \"', 'yyyy-mm-dd HH24:MI:SS')\";    ";
  protected final String TEXT_160 = NL + "        String updateForType1_";
  protected final String TEXT_161 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_162 = " + \" d SET (";
  protected final String TEXT_163 = ") = (SELECT ";
  protected final String TEXT_164 = " FROM \" + sourceTable_";
  protected final String TEXT_165 = " + \" t WHERE ";
  protected final String TEXT_166 = " AND (";
  protected final String TEXT_167 = ")) WHERE EXISTS (SELECT 1 FROM \" + sourceTable_";
  protected final String TEXT_168 = " + \" t WHERE ";
  protected final String TEXT_169 = " AND (";
  protected final String TEXT_170 = "))\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_171 = " = conn_";
  protected final String TEXT_172 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_173 = ".executeUpdate(updateForType1_";
  protected final String TEXT_174 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_175 = ".close();";
  protected final String TEXT_176 = NL + "            System.out.println(\"[";
  protected final String TEXT_177 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_178 = " + \"\\ndone\");";
  protected final String TEXT_179 = NL + "        String updateForType2_";
  protected final String TEXT_180 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_181 = " + \" d SET ";
  protected final String TEXT_182 = " = \" + ";
  protected final String TEXT_183 = NL + "\t        \"(SELECT t.";
  protected final String TEXT_184 = " FROM \" + sourceTable_";
  protected final String TEXT_185 = " + " + NL + "\t        \" t WHERE ";
  protected final String TEXT_186 = ")\"";
  protected final String TEXT_187 = NL + "        \tdateValue_";
  protected final String TEXT_188 = " " + NL + "        + \"";
  protected final String TEXT_189 = ", ";
  protected final String TEXT_190 = " = 0";
  protected final String TEXT_191 = " WHERE EXISTS (SELECT 1 FROM \" + sourceTable_";
  protected final String TEXT_192 = " + " + NL + "        \" t WHERE ";
  protected final String TEXT_193 = " AND (";
  protected final String TEXT_194 = ")) AND d.";
  protected final String TEXT_195 = " \"" + NL + "        +";
  protected final String TEXT_196 = NL + "         \" IS NULL\";";
  protected final String TEXT_197 = NL + "         \"= to_date ('\" + ";
  protected final String TEXT_198 = " +\"-01-01', 'yyyy-mm-dd')\";";
  protected final String TEXT_199 = "        " + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_200 = " = conn_";
  protected final String TEXT_201 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_202 = ".executeUpdate(updateForType2_";
  protected final String TEXT_203 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_204 = ".close();";
  protected final String TEXT_205 = NL + "            System.out.println(\"[";
  protected final String TEXT_206 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_207 = " + \"\\ndone\");";
  protected final String TEXT_208 = NL + "        String insertForType2_";
  protected final String TEXT_209 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_210 = " + \"(";
  protected final String TEXT_211 = ", ";
  protected final String TEXT_212 = ") SELECT ";
  protected final String TEXT_213 = "\" + ";
  protected final String TEXT_214 = " + \".NEXTVAL, ";
  protected final String TEXT_215 = "t.";
  protected final String TEXT_216 = ", \" " + NL + "        + ";
  protected final String TEXT_217 = NL + "        dateValue_";
  protected final String TEXT_218 = NL + "        \"t.";
  protected final String TEXT_219 = "\"  ";
  protected final String TEXT_220 = "                " + NL + "         + ";
  protected final String TEXT_221 = NL + "         \", NULL\"";
  protected final String TEXT_222 = NL + "         \", to_date('\"+";
  protected final String TEXT_223 = "+\"-01-01', 'yyyy-mm-dd')\" ";
  protected final String TEXT_224 = NL + "         +\"";
  protected final String TEXT_225 = ", 1";
  protected final String TEXT_226 = ", d.";
  protected final String TEXT_227 = " + 1";
  protected final String TEXT_228 = " FROM \" + " + NL + "        sourceTable_";
  protected final String TEXT_229 = " + \" t, \" + tableName_";
  protected final String TEXT_230 = " + \" d WHERE ";
  protected final String TEXT_231 = " AND (";
  protected final String TEXT_232 = ") AND d.";
  protected final String TEXT_233 = " = \"" + NL + "        " + NL + "                 " + NL + "        + ";
  protected final String TEXT_234 = NL + "\t        \"(SELECT t.";
  protected final String TEXT_235 = " FROM \" + sourceTable_";
  protected final String TEXT_236 = " + " + NL + "\t        \" t WHERE ";
  protected final String TEXT_237 = ")\"";
  protected final String TEXT_238 = NL + "        \tdateValue_";
  protected final String TEXT_239 = " " + NL + "        ;  " + NL + "     \t" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_240 = " = conn_";
  protected final String TEXT_241 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_242 = ".executeUpdate(insertForType2_";
  protected final String TEXT_243 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_244 = ".close();";
  protected final String TEXT_245 = NL + "            System.out.println(\"[";
  protected final String TEXT_246 = "] type2 new active row slq\\n\" + insertForType2_";
  protected final String TEXT_247 = " + \"\\ndone\");";
  protected final String TEXT_248 = NL + "    String insert_";
  protected final String TEXT_249 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_250 = " + \"(";
  protected final String TEXT_251 = ", ";
  protected final String TEXT_252 = ") SELECT ";
  protected final String TEXT_253 = "\" + ";
  protected final String TEXT_254 = " + \".NEXTVAL, ";
  protected final String TEXT_255 = "t.";
  protected final String TEXT_256 = "\"" + NL + "    ";
  protected final String TEXT_257 = " + \", \"" + NL + "    \t+\t " + NL + "    \t";
  protected final String TEXT_258 = NL + "    \t dateValue_";
  protected final String TEXT_259 = NL + "    \t";
  protected final String TEXT_260 = NL + "    \t\"t.";
  protected final String TEXT_261 = "\"" + NL + "    \t";
  protected final String TEXT_262 = NL + "    \t+" + NL + "    \t";
  protected final String TEXT_263 = NL + "    \t\t\", NULL\"\t" + NL + "    \t";
  protected final String TEXT_264 = NL + "    \t\t \", to_date('\"+";
  protected final String TEXT_265 = "+\"-01-01', 'yyyy-mm-dd')\"" + NL + "    \t";
  protected final String TEXT_266 = "     " + NL + "     ";
  protected final String TEXT_267 = NL + "    " + NL + "    + \"";
  protected final String TEXT_268 = ", 1";
  protected final String TEXT_269 = ", 1";
  protected final String TEXT_270 = " FROM \" +" + NL + "     " + NL + "    sourceTable_";
  protected final String TEXT_271 = " + \" t LEFT JOIN \" + tableName_";
  protected final String TEXT_272 = " + \" d ON ";
  protected final String TEXT_273 = " WHERE (";
  protected final String TEXT_274 = ")\";" + NL + "    " + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_275 = " = conn_";
  protected final String TEXT_276 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_277 = ".executeUpdate(insert_";
  protected final String TEXT_278 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_279 = ".close();";
  protected final String TEXT_280 = NL + "        System.out.println(\"[";
  protected final String TEXT_281 = "] new rows sql\\n\" + insert_";
