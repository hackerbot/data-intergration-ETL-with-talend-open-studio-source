...
public class TGreenplumOutputBeginJava {
  protected static String nl;
  public static synchronized TGreenplumOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGreenplumOutputBeginJava result = new TGreenplumOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_45 = NL + "String dbschema_";
  ...
  protected final String TEXT_93 = " = \"org.postgresql.Driver\";" + NL + "\t";
  protected final String TEXT_94 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_95 = ");" + NL + "    String url_";
  protected final String TEXT_96 = " = \"jdbc:postgresql://\"+";
  protected final String TEXT_97 = "+\":\"+";
  protected final String TEXT_98 = "+\"/\"+";
  protected final String TEXT_99 = ";" + NL + "    String dbUser_";
  ...
  protected final String TEXT_121 = NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_122 = " = conn_";
  protected final String TEXT_123 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_124 = NL + "            stmtDrop_";
  ...
  protected final String TEXT_144 = " = false;" + NL + "            String defaultSchema_";
  ...
  protected final String TEXT_163 = ") && (schema_";
  protected final String TEXT_164 = ".equals(dbschema_";
  protected final String TEXT_165 = ") || ((dbschema_";
  protected final String TEXT_166 = " == null || dbschema_";
  protected final String TEXT_167 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_168 = ".equals(schema_";
  protected final String TEXT_169 = ")))) {" + NL + "                    whetherExist_";
  protected final String TEXT_170 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  protected final String TEXT_171 = NL + "                if(!whetherExist_";
  protected final String TEXT_172 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_186 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_192 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_193 = " = conn_";
  protected final String TEXT_194 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_195 = " = stmtClearCount_";
  protected final String TEXT_196 = ".executeQuery(\"";
  protected final String TEXT_197 = "\");" + NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_198 = " = conn_";
  protected final String TEXT_199 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_200 = NL + "            stmtClear_";
  protected final String TEXT_201 = ".executeUpdate(\"";
  protected final String TEXT_202 = "\");" + NL + "\t\t\t";
  protected final String TEXT_203 = NL + "            while(rsClearCount_";
  protected final String TEXT_204 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_205 = " += rsClearCount_";
  protected final String TEXT_206 = ".getInt(1);" + NL + "            }";
  protected final String TEXT_207 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_208 = " = conn_";
  protected final String TEXT_209 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_210 = " + \"\\\" (";
  protected final String TEXT_211 = ") VALUES (";
  protected final String TEXT_212 = ")\");" + NL + "\t    ";
  protected final String TEXT_213 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_214 = " = conn_";
  protected final String TEXT_215 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_216 = " + \"\\\" SET ";
  protected final String TEXT_217 = " WHERE ";
  protected final String TEXT_218 = "\");" + NL + "\t    ";
  protected final String TEXT_219 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_220 = " = conn_";
  protected final String TEXT_221 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_222 = " + \"\\\" WHERE ";
  protected final String TEXT_223 = "\");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_224 = " = conn_";
  protected final String TEXT_225 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_226 = " + \"\\\" (";
  protected final String TEXT_227 = ") VALUES (";
  protected final String TEXT_228 = ")\");" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_229 = " = conn_";
  protected final String TEXT_230 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_231 = " + \"\\\" SET ";
  protected final String TEXT_232 = " WHERE ";
  protected final String TEXT_233 = "\");" + NL + "\t    ";
  protected final String TEXT_234 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_235 = " = conn_";
  protected final String TEXT_236 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_237 = " + \"\\\" SET ";
  protected final String TEXT_238 = " WHERE ";
  protected final String TEXT_239 = "\");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_240 = " = conn_";
  protected final String TEXT_241 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_242 = " + \"\\\" (";
  protected final String TEXT_243 = ") VALUES (";
  protected final String TEXT_244 = ")\");" + NL + "\t    ";
  protected final String TEXT_245 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_246 = " = conn_";
  protected final String TEXT_247 = ".prepareStatement(\"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_248 = " + \"\\\" WHERE ";
  protected final String TEXT_249 = "\");" + NL + "\t    ";
  protected final String TEXT_250 = NL + "            int commitEvery_";
  protected final String TEXT_251 = " = ";
  protected final String TEXT_252 = ";" + NL + "            int commitCounter_";
