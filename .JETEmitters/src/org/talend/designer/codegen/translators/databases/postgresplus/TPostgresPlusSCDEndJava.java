...
public class TPostgresPlusSCDEndJava {
  protected static String nl;
  public static synchronized TPostgresPlusSCDEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresPlusSCDEndJava result = new TPostgresPlusSCDEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_14 = ".isClosed()) {" + NL + "            connection_";
  protected final String TEXT_15 = ".close();" + NL + "        }";
  protected final String TEXT_16 = NL + "    globalMap.put(\"";
  protected final String TEXT_17 = "_NB_LINE_UPDATED\", nb_line_update_";
  protected final String TEXT_18 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_19 = "_NB_LINE_INSERTED\", nb_line_inserted_";
  protected final String TEXT_20 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_21 = "_NB_LINE_REJECTED\",nb_line_rejected_";
