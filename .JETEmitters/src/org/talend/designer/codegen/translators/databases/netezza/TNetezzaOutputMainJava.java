...
public class TNetezzaOutputMainJava {
  protected static String nl;
  public static synchronized TNetezzaOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNetezzaOutputMainJava result = new TNetezzaOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_45 = NL + "                commitEvery_";
  protected final String TEXT_46 = " = buffersSize_";
  protected final String TEXT_47 = ";";
  protected final String TEXT_48 = NL + "                batchSize_";
  ...
  protected final String TEXT_56 = ".addBatch();" + NL + "                    nb_line_";
  protected final String TEXT_57 = "++;";
  protected final String TEXT_58 = NL + "                    batchSizeCounter_";
  protected final String TEXT_59 = "++;";
  protected final String TEXT_60 = NL + "                try{" + NL + "                    nb_line_";
  protected final String TEXT_61 = "++;" + NL + "                    insertedCount_";
  protected final String TEXT_62 = " = insertedCount_";
  protected final String TEXT_63 = " + pstmt_";
  protected final String TEXT_64 = ".executeUpdate();";
  protected final String TEXT_65 = NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  protected final String TEXT_66 = " = true;";
  protected final String TEXT_67 = NL + "                        throw(e);";
  ...
  protected final String TEXT_76 = NL + "                            rejectedCount_";
  protected final String TEXT_77 = " = rejectedCount_";
  protected final String TEXT_78 = " + 1;";
  protected final String TEXT_79 = NL + "                            ";
  protected final String TEXT_80 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_81 = NL + "                            ";
  protected final String TEXT_82 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_83 = ";";
  protected final String TEXT_84 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_85 = NL + "                }";
  protected final String TEXT_86 = NL + "                    ";
  protected final String TEXT_87 = NL;
  protected final String TEXT_88 = NL + "                        ";
  protected final String TEXT_89 = NL + "                        query_";
  protected final String TEXT_90 = " = ";
  protected final String TEXT_91 = ";";
  protected final String TEXT_92 = NL + "                    ";
  protected final String TEXT_93 = NL + "            pstmt_";
  protected final String TEXT_94 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_95 = "++;";
  protected final String TEXT_96 = NL + "            batchSizeCounter_";
  protected final String TEXT_97 = "++;";
  protected final String TEXT_98 = NL + "            try{" + NL + "                nb_line_";
  protected final String TEXT_99 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_100 = " = updatedCount_";
  protected final String TEXT_101 = " + pstmt_";
  protected final String TEXT_102 = ".executeUpdate();";
  protected final String TEXT_103 = NL + "            }catch(java.lang.Exception e)" + NL + "            {" + NL + "                whetherReject_";
  protected final String TEXT_104 = " = true;";
  ...
  protected final String TEXT_114 = NL + "                        rejectedCount_";
  protected final String TEXT_115 = " = rejectedCount_";
  protected final String TEXT_116 = " + 1;";
  protected final String TEXT_117 = NL + "                        ";
  protected final String TEXT_118 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_127 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_128 = " = pstmt_";
  protected final String TEXT_129 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_130 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_131 = ".next())" + NL + "            {" + NL + "                checkCount_";
  protected final String TEXT_132 = " = rs_";
  protected final String TEXT_133 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_134 = " > 0)" + NL + "            {";
  protected final String TEXT_135 = NL + "                        ";
  protected final String TEXT_136 = NL + "                            ";
  protected final String TEXT_137 = NL + "                            query_";
  protected final String TEXT_138 = " = ";
  protected final String TEXT_139 = ";";
  protected final String TEXT_140 = NL + "                        ";
  protected final String TEXT_141 = NL + "                try{" + NL + "                    updatedCount_";
  protected final String TEXT_142 = " = updatedCount_";
  protected final String TEXT_143 = " + pstmtUpdate_";
  protected final String TEXT_144 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_145 = "++;";
  protected final String TEXT_146 = NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_159 = NL + "                            rejectedCount_";
  protected final String TEXT_160 = " = rejectedCount_";
  protected final String TEXT_161 = " + 1;";
  protected final String TEXT_162 = NL + "                            ";
  protected final String TEXT_163 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_164 = NL + "                            ";
  protected final String TEXT_165 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_166 = ";";
  protected final String TEXT_167 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_168 = NL + "                }" + NL + "            }" + NL + "            else" + NL + "            {";
  protected final String TEXT_169 = NL + "                        ";
  protected final String TEXT_170 = NL + "                try{" + NL + "                    insertedCount_";
  protected final String TEXT_171 = " = insertedCount_";
  protected final String TEXT_172 = " + pstmtInsert_";
  protected final String TEXT_173 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_174 = "++;";
  protected final String TEXT_175 = NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_188 = NL + "                            rejectedCount_";
  protected final String TEXT_189 = " = rejectedCount_";
  protected final String TEXT_190 = " + 1;";
  protected final String TEXT_191 = NL + "                            ";
  protected final String TEXT_192 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_198 = NL + "            int updateFlag_";
  protected final String TEXT_199 = "=0;";
  protected final String TEXT_200 = NL + "                    ";
  protected final String TEXT_201 = NL + "                        ";
  protected final String TEXT_202 = NL + "                            query_";
  protected final String TEXT_203 = " = ";
  protected final String TEXT_204 = ";";
  protected final String TEXT_205 = NL + "                    ";
  protected final String TEXT_206 = NL + NL + "            try{" + NL + "                updateFlag_";
  protected final String TEXT_207 = "=pstmtUpdate_";
  protected final String TEXT_208 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_209 = " = updatedCount_";
  protected final String TEXT_210 = "+updateFlag_";
  protected final String TEXT_211 = ";" + NL + "" + NL + "            if(updateFlag_";
  protected final String TEXT_212 = " == 0) {";
  protected final String TEXT_213 = NL + "                        ";
  protected final String TEXT_214 = NL + "                    insertedCount_";
  protected final String TEXT_215 = " = insertedCount_";
  protected final String TEXT_216 = " + pstmtInsert_";
  protected final String TEXT_217 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_218 = "++;";
  protected final String TEXT_219 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_220 = "++;";
  protected final String TEXT_221 = NL + "                }" + NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_228 = "Struct();";
  protected final String TEXT_229 = NL + "                                ";
  protected final String TEXT_230 = ".";
  protected final String TEXT_231 = " = ";
  protected final String TEXT_232 = ".";
  protected final String TEXT_233 = ";";
  protected final String TEXT_234 = NL + "                            rejectedCount_";
  protected final String TEXT_235 = " = rejectedCount_";
  protected final String TEXT_236 = " + 1;";
  protected final String TEXT_237 = NL + "                            ";
  protected final String TEXT_238 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_239 = NL + "                            ";
  protected final String TEXT_240 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_241 = ";";
  protected final String TEXT_242 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_249 = NL + "                pstmt_";
  protected final String TEXT_250 = ".addBatch();" + NL + "                nb_line_";
  protected final String TEXT_251 = "++;";
  protected final String TEXT_252 = NL + "                batchSizeCounter_";
  protected final String TEXT_253 = "++;";
  protected final String TEXT_254 = NL + "        try{" + NL + "            deletedCount_";
  protected final String TEXT_255 = " = deletedCount_";
  protected final String TEXT_256 = " + pstmt_";
  protected final String TEXT_257 = ".executeUpdate();" + NL + "            nb_line_";
  protected final String TEXT_258 = "++;";
  protected final String TEXT_259 = NL + "        }catch(java.lang.Exception e)" + NL + "        {" + NL + "            whetherReject_";
  protected final String TEXT_260 = " = true;";
  protected final String TEXT_261 = NL + "                throw(e);";
  protected final String TEXT_262 = NL + "                nb_line_";
  ...
  protected final String TEXT_272 = NL + "                    rejectedCount_";
  protected final String TEXT_273 = " = rejectedCount_";
  ...
  protected final String TEXT_282 = NL + "            if(!whetherReject_";
  protected final String TEXT_283 = ") {";
  protected final String TEXT_284 = NL + "                            ";
  protected final String TEXT_285 = " = new ";
  protected final String TEXT_286 = "Struct();";
  ...
  protected final String TEXT_293 = NL + "                if ((batchSize_";
  protected final String TEXT_294 = " > 0) && (batchSize_";
  protected final String TEXT_295 = " <= batchSizeCounter_";
  protected final String TEXT_296 = ")) {" + NL + "                try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_297 = " = 0;";
  protected final String TEXT_298 = NL + "                        pstmt_";
  protected final String TEXT_299 = ".executeBatch();";
  protected final String TEXT_300 = NL + "                        pstmt_";
  protected final String TEXT_301 = ".clearBatch();";
  protected final String TEXT_302 = NL + "                            insertedCount_";
  protected final String TEXT_303 = " += pstmt_";
  protected final String TEXT_304 = ".getUpdateCount();";
  protected final String TEXT_305 = NL + "                            updatedCount_";
  protected final String TEXT_306 = " += pstmt_";
  protected final String TEXT_307 = ". getUpdateCount();";
  protected final String TEXT_308 = NL + "                            deletedCount_";
  protected final String TEXT_309 = " += pstmt_";
  protected final String TEXT_310 = ". getUpdateCount();";
  protected final String TEXT_311 = NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_312 = NL + "                        throw(e);";
  protected final String TEXT_313 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_314 = NL + NL + "                }catch (java.sql.SQLException e){";
  protected final String TEXT_315 = NL + "                        throw(e);";
  protected final String TEXT_316 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_317 = NL + "                }" + NL + "                }";
  protected final String TEXT_318 = NL + "                commitCounter_";
  protected final String TEXT_319 = "++;" + NL + "" + NL + "                if(commitEvery_";
  protected final String TEXT_320 = " <= commitCounter_";
  protected final String TEXT_321 = "){";
  protected final String TEXT_322 = NL + "                try {" + NL + "                    if(batchSizeCounter_";
  protected final String TEXT_323 = " >0){" + NL + "                        batchSizeCounter_";
  protected final String TEXT_324 = " = 0;";
  protected final String TEXT_325 = NL + "                        pstmt_";
  protected final String TEXT_326 = ".executeBatch();";
  protected final String TEXT_327 = NL + "                        pstmt_";
  protected final String TEXT_328 = ".clearBatch();" + NL + "                    }";
  protected final String TEXT_329 = NL + "                            insertedCount_";
  protected final String TEXT_330 = " += pstmt_";
  protected final String TEXT_331 = ".getUpdateCount();";
  protected final String TEXT_332 = NL + "                            updatedCount_";
  protected final String TEXT_333 = " += pstmt_";
  protected final String TEXT_334 = ".getUpdateCount();";
  protected final String TEXT_335 = NL + "                            deletedCount_";
  protected final String TEXT_336 = " += pstmt_";
  protected final String TEXT_337 = ".getUpdateCount();";
  protected final String TEXT_338 = NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_339 = NL + "                        throw(e);";
  protected final String TEXT_340 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_341 = NL + NL + "                }catch (java.sql.SQLException e){";
  protected final String TEXT_342 = NL + "                        throw(e);";
  protected final String TEXT_343 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_344 = NL + "                }";
  protected final String TEXT_345 = NL + "                    conn_";
  protected final String TEXT_346 = ".commit();";
  protected final String TEXT_347 = NL + "                    commitCounter_";
  protected final String TEXT_348 = "=0;" + NL + "" + NL + "                }" + NL;
