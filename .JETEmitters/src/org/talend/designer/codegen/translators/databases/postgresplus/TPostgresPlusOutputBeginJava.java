...
public class TPostgresPlusOutputBeginJava {
  protected static String nl;
  public static synchronized TPostgresPlusOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresPlusOutputBeginJava result = new TPostgresPlusOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_45 = NL + NL + "String dbschema_";
  protected final String TEXT_46 = " = null;";
  protected final String TEXT_47 = NL + "\tdbschema_";
  protected final String TEXT_48 = " = (String)globalMap.get(\"schema_\" + \"";
  protected final String TEXT_49 = "\");" + NL + "\t";
  protected final String TEXT_50 = NL + "\tdbschema_";
  protected final String TEXT_51 = " = ";
  protected final String TEXT_52 = ";" + NL + "\t";
  protected final String TEXT_53 = NL + NL + "String tableName_";
  protected final String TEXT_54 = " = null;" + NL + "if(dbschema_";
  protected final String TEXT_55 = " == null || dbschema_";
  protected final String TEXT_56 = ".trim().length() == 0) {" + NL + "\ttableName_";
  protected final String TEXT_57 = " = ";
  protected final String TEXT_58 = ";" + NL + "} else {" + NL + "\ttableName_";
  protected final String TEXT_59 = " = dbschema_";
  protected final String TEXT_60 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_61 = ";" + NL + "}" + NL;
  protected final String TEXT_62 = NL + "        int updateKeyCount_";
  protected final String TEXT_63 = " = ";
  protected final String TEXT_64 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_65 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_66 = NL + "        int deleteKeyCount_";
  protected final String TEXT_67 = " = ";
  protected final String TEXT_68 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_69 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_70 = NL + "int nb_line_";
  protected final String TEXT_71 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_72 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_73 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_74 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_75 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_76 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_77 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_78 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_79 = "=0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_80 = " = false;" + NL;
  protected final String TEXT_81 = NL + "       int batchSize_";
  protected final String TEXT_82 = " = ";
  protected final String TEXT_83 = ";" + NL + "       int batchSizeCounter_";
  protected final String TEXT_84 = "=0;" + NL + "       int tmp_batchUpdateCount_";
  protected final String TEXT_85 = " = 0;";
  protected final String TEXT_86 = NL + NL + "java.sql.Connection conn_";
  protected final String TEXT_87 = " = null;";
  protected final String TEXT_88 = NL + "\tconn_";
  protected final String TEXT_89 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_90 = "\");" + NL + "\t";
  protected final String TEXT_91 = NL + "\t";
  protected final String TEXT_92 = NL + "\t";
  protected final String TEXT_93 = NL + "    java.lang.Class.forName(\"org.postgresql.Driver\");" + NL + "    String url_";
  protected final String TEXT_94 = " = \"jdbc:postgresql://\"+";
  ...
  protected final String TEXT_112 = ",dbUser_";
  protected final String TEXT_113 = ",dbPwd_";
  protected final String TEXT_114 = ");";
  protected final String TEXT_115 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_116 = "\", conn_";
  protected final String TEXT_117 = ");" + NL + "\t";
  protected final String TEXT_118 = NL + "        conn_";
  protected final String TEXT_119 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  ...
  protected final String TEXT_126 = ".createStatement();";
  protected final String TEXT_127 = NL + "            stmtDrop_";
  ...
  protected final String TEXT_152 = " = false;" + NL + "            String defaultSchema_";
  protected final String TEXT_153 = " = \"public\";" + NL + "            if(dbschema_";
  protected final String TEXT_154 = " == null || dbschema_";
  protected final String TEXT_155 = ".trim().length() == 0) {" + NL + "            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_156 = " = conn_";
  protected final String TEXT_157 = ".createStatement();" + NL + "            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_158 = " = stmtSchema_";
  protected final String TEXT_159 = ".executeQuery(\"select current_schema() \");" + NL + "            \twhile(rsSchema_";
  protected final String TEXT_160 = ".next()){" + NL + "            \t\tdefaultSchema_";
  protected final String TEXT_161 = " = rsSchema_";
  protected final String TEXT_162 = ".getString(\"current_schema\");" + NL + "            \t}" + NL + "            \trsSchema_";
  protected final String TEXT_163 = ".close();" + NL + "            \tstmtSchema_";
  protected final String TEXT_164 = ".close();" + NL + "            }" + NL + "            while(rsTable_";
  protected final String TEXT_165 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_166 = " = rsTable_";
  protected final String TEXT_167 = ".getString(\"TABLE_NAME\");" + NL + "                String schema_";
  protected final String TEXT_168 = " = rsTable_";
  protected final String TEXT_169 = ".getString(\"TABLE_SCHEM\");" + NL + "                if(table_";
  protected final String TEXT_170 = ".equals(";
  protected final String TEXT_171 = ")" + NL + "                \t&& (schema_";
  protected final String TEXT_172 = ".equals(dbschema_";
  protected final String TEXT_173 = ") || ((dbschema_";
  protected final String TEXT_174 = " == null || dbschema_";
  protected final String TEXT_175 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_176 = ".equals(schema_";
  ...
  protected final String TEXT_192 = ".createStatement();";
  protected final String TEXT_193 = NL + "                    stmtDrop_";
  protected final String TEXT_194 = ".execute(\"";
  protected final String TEXT_195 = "\");";
  protected final String TEXT_196 = NL + "                    stmtDrop_";
  protected final String TEXT_197 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_201 = ".execute(\"";
  protected final String TEXT_202 = ")\");";
  protected final String TEXT_203 = NL + "                stmtCreate_";
  protected final String TEXT_204 = ".close();";
  protected final String TEXT_205 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_206 = " = conn_";
  protected final String TEXT_207 = ".createStatement();";
  protected final String TEXT_208 = NL + "            deletedCount_";
  protected final String TEXT_209 = " = deletedCount_";
  protected final String TEXT_210 = " + stmtClear_";
  protected final String TEXT_211 = ".executeUpdate(\"";
  protected final String TEXT_212 = "\");";
  protected final String TEXT_213 = NL + "            stmtClear_";
  ...
  protected final String TEXT_222 = ".createStatement();";
  protected final String TEXT_223 = NL + "            stmtTrunc_";
  protected final String TEXT_224 = ".executeUpdate(\"";
  ...
  protected final String TEXT_237 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_238 = " = conn_";
  protected final String TEXT_239 = ".prepareStatement(insert_";
  protected final String TEXT_240 = ");" + NL + "\t    ";
  protected final String TEXT_241 = NL + "\t    String update_";
  protected final String TEXT_242 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_243 = " + \"\\\" SET ";
  protected final String TEXT_244 = " WHERE ";
  protected final String TEXT_245 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_246 = " = conn_";
  protected final String TEXT_247 = ".prepareStatement(update_";
  protected final String TEXT_248 = ");" + NL + "\t    ";
  protected final String TEXT_249 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_250 = " = conn_";
  protected final String TEXT_251 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_252 = " + \"\\\" WHERE ";
  protected final String TEXT_253 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_254 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_255 = " + \"\\\" (";
  protected final String TEXT_256 = ") VALUES (";
  protected final String TEXT_257 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_258 = " = conn_";
  protected final String TEXT_259 = ".prepareStatement(insert_";
  protected final String TEXT_260 = ");" + NL + "\t    String update_";
  protected final String TEXT_261 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_262 = " + \"\\\" SET ";
  protected final String TEXT_263 = " WHERE ";
  protected final String TEXT_264 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_265 = " = conn_";
  protected final String TEXT_266 = ".prepareStatement(update_";
  protected final String TEXT_267 = ");" + NL + "\t    ";
  protected final String TEXT_268 = NL + "\t    String update_";
  protected final String TEXT_269 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_270 = " + \"\\\" SET ";
  protected final String TEXT_271 = " WHERE ";
  protected final String TEXT_272 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_273 = " = conn_";
  protected final String TEXT_274 = ".prepareStatement(update_";
  protected final String TEXT_275 = ");" + NL + "\t    String insert_";
  protected final String TEXT_276 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_277 = " + \"\\\" (";
  protected final String TEXT_278 = ") VALUES (";
  protected final String TEXT_279 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_280 = " = conn_";
  protected final String TEXT_281 = ".prepareStatement(insert_";
  protected final String TEXT_282 = ");" + NL + "\t    ";
  protected final String TEXT_283 = NL + "\t    String delete_";
  protected final String TEXT_284 = " = \"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_285 = " + \"\\\" WHERE ";
  protected final String TEXT_286 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_287 = " = conn_";
  protected final String TEXT_288 = ".prepareStatement(delete_";
  protected final String TEXT_289 = ");" + NL + "\t    ";
  protected final String TEXT_290 = NL + "        StringBuffer query_";
  protected final String TEXT_291 = " = null;" + NL + "       \t";
  protected final String TEXT_292 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_293 = " = insert_";
  protected final String TEXT_294 = ".split(\"\\\\?\");";
  protected final String TEXT_295 = NL + "\t\t\tupdate_";
  protected final String TEXT_296 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_297 = " = update_";
  protected final String TEXT_298 = ".split(\"\\\\?\");";
  protected final String TEXT_299 = NL + "\t\t\tupdate_";
  protected final String TEXT_300 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_301 = " = update_";
  protected final String TEXT_302 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_303 = " = insert_";
  protected final String TEXT_304 = ".split(\"\\\\?\");";
  protected final String TEXT_305 = NL + "\t\t\tdelete_";
  protected final String TEXT_306 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_307 = " = delete_";
  protected final String TEXT_308 = ".split(\"\\\\?\");";
  protected final String TEXT_309 = NL + "\t\t\treplace_";
  protected final String TEXT_310 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_311 = " = replace_";
  protected final String TEXT_312 = ".split(\"\\\\?\");";
  protected final String TEXT_313 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_314 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_315 = " = insertIgnore_";
  protected final String TEXT_316 = ".split(\"\\\\?\");";
  protected final String TEXT_317 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_318 = " = insert_";
  protected final String TEXT_319 = ".split(\"\\\\?\");";
