...
public class TDB2OutputBeginJava {
  protected static String nl;
  public static synchronized TDB2OutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDB2OutputBeginJava result = new TDB2OutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_58 = " = 0;" + NL + "int deletedCount_";
  ...
  protected final String TEXT_62 = " = 0;" + NL + "boolean whetherReject_";
  protected final String TEXT_63 = " = false;" + NL + "java.sql.Connection conn_";
  protected final String TEXT_64 = " = null;" + NL + "String dbschema_";
  protected final String TEXT_65 = " = null;" + NL + "String dbUser_";
  protected final String TEXT_66 = " = null;";
  protected final String TEXT_67 = NL + "    dbschema_";
  protected final String TEXT_68 = " = (String)globalMap.get(\"";
  protected final String TEXT_69 = "\");" + NL + "    conn_";
  protected final String TEXT_70 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_71 = "\");";
  protected final String TEXT_72 = NL + "\t\tif (null == conn_";
  protected final String TEXT_73 = ") {" + NL + "\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_74 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\tconn_";
  protected final String TEXT_75 = " = dataSources_";
  protected final String TEXT_76 = ".get(";
  protected final String TEXT_77 = ").getConnection();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_78 = NL + "    dbUser_";
  protected final String TEXT_79 = " = (String)globalMap.get(\"";
  protected final String TEXT_80 = "\");";
  protected final String TEXT_81 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_82 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  protected final String TEXT_83 = ") {" + NL + "\t\t\tconn_";
  protected final String TEXT_84 = " = dataSources_";
  protected final String TEXT_85 = ".get(";
  protected final String TEXT_86 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_87 = NL + "\t    String url_";
  protected final String TEXT_88 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_89 = " + \":\" + ";
  protected final String TEXT_90 = " + \"/\" + ";
  protected final String TEXT_91 = ";";
  protected final String TEXT_92 = NL + "\t\tString url_";
  protected final String TEXT_93 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_94 = " + \":\" + ";
  protected final String TEXT_95 = " + \"/\" + ";
  protected final String TEXT_96 = " + \":\" + ";
  protected final String TEXT_97 = ";";
  protected final String TEXT_98 = NL + "    java.lang.Class.forName(\"com.ibm.db2.jcc.DB2Driver\");" + NL + "\t";
  protected final String TEXT_99 = NL + "    dbUser_";
  ...
  protected final String TEXT_109 = NL + NL + "    String dbPwd_";
  protected final String TEXT_110 = " = decryptedPassword_";
  protected final String TEXT_111 = ";" + NL + "" + NL + "    dbschema_";
  ...
  protected final String TEXT_124 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_125 = " = ";
  protected final String TEXT_126 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_127 = " = 0;";
  ...
  protected final String TEXT_133 = NL + "String tableName_";
  protected final String TEXT_134 = " = null;" + NL + "if(dbschema_";
  protected final String TEXT_135 = " == null || dbschema_";
  protected final String TEXT_136 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_137 = " = ";
  protected final String TEXT_138 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_139 = " = dbschema_";
  protected final String TEXT_140 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_141 = ";" + NL + "}" + NL;
  protected final String TEXT_142 = NL + "int count_";
  protected final String TEXT_143 = "=0;";
  protected final String TEXT_144 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_145 = " = conn_";
  protected final String TEXT_146 = ".createStatement();" + NL + "\t\t\t";
  ...
  protected final String TEXT_152 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_153 = " = conn_";
  protected final String TEXT_154 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_155 = NL + "\t\t\t";
  protected final String TEXT_156 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_157 = ".execute(((\"";
  protected final String TEXT_158 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_159 = ".";
  protected final String TEXT_160 = ", \"";
  protected final String TEXT_161 = "\")";
  protected final String TEXT_162 = ".toUpperCase()";
  ...
  protected final String TEXT_171 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_172 = " = conn_";
  protected final String TEXT_173 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_174 = NL + "\t\t\t";
  protected final String TEXT_175 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_176 = ".execute(((\"";
  protected final String TEXT_177 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_178 = ".";
  protected final String TEXT_179 = ", \"";
  protected final String TEXT_180 = "\")";
  protected final String TEXT_181 = ".toUpperCase()";
  ...
  protected final String TEXT_192 = NL + "\t\t    \t\tString keyCheckTable_";
  protected final String TEXT_193 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_194 = "+\"][\"+";
  protected final String TEXT_195 = "+\"][\"+";
  protected final String TEXT_196 = "+\"][\"+";
  protected final String TEXT_197 = "+\"][\"+";
  protected final String TEXT_198 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_199 = " + \"]\";" + NL + "\t\t    \t";
  protected final String TEXT_200 = NL + "        \t\t    // [%connection%][checktable][tableName]" + NL + "        \t\t    String keyCheckTable_";
  protected final String TEXT_201 = " = conn_";
  protected final String TEXT_202 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_203 = " + \"]\";" + NL + "    \t\t    ";
  protected final String TEXT_204 = NL + "\t\t    " + NL + "\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_205 = ")== null){//}" + NL + "\t\t\t" + NL + "\t\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_206 = ")) {//}" + NL + "\t\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_207 = ")== null){//}" + NL + "\t\t\t";
  protected final String TEXT_208 = "              " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_209 = NL + "    \t\t\t\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_210 = " = conn_";
  protected final String TEXT_211 = ".createStatement();" + NL + "                \t\t\t\tboolean whetherExist_";
  protected final String TEXT_212 = " = false;" + NL + "                \t\t\t\ttry {" + NL + "                \t\t\t\t\tisExistStmt_";
  protected final String TEXT_213 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_214 = " + \"]\" );" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_215 = " = true;" + NL + "                \t\t\t\t} catch (java.lang.Exception e){" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_216 = " = false;" + NL + "                \t\t\t\t}" + NL + "                \t\t\t\tisExistStmt_";
  protected final String TEXT_217 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_218 = "   \t" + NL + "                \t\t\t\t";
  protected final String TEXT_219 = NL + "                \t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_220 = " = conn_";
  protected final String TEXT_221 = ".getMetaData();" + NL + "                \t            if(tableNameForSearch_";
  protected final String TEXT_222 = ".indexOf(\"\\\"\")==-1){" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_223 = " = tableNameForSearch_";
  protected final String TEXT_224 = ".toUpperCase();" + NL + "                            \t}else{" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_225 = " = tableNameForSearch_";
  protected final String TEXT_226 = ".replaceAll(\"\\\"\",\"\");" + NL + "                            \t}" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_227 = " = dbMetaData_";
  protected final String TEXT_228 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_229 = ", tableNameForSearch_";
  protected final String TEXT_230 = ", new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_231 = " = false;" + NL + "                \t            if(rsTable_";
  protected final String TEXT_232 = ".next()) {" + NL + "                \t            \twhetherExist_";
  protected final String TEXT_233 = " = true;" + NL + "                \t            }" + NL + "    \t            \t\t\trsTable_";
  protected final String TEXT_234 = ".close();" + NL + "    \t            " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_243 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_244 = " = rsTable_";
  protected final String TEXT_245 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_246 = ".equals";
  protected final String TEXT_247 = "IgnoreCase";
  protected final String TEXT_248 = "(";
  protected final String TEXT_249 = ") " + NL + "                \t                \t&& (schema_";
  protected final String TEXT_250 = ".equals";
  protected final String TEXT_251 = "IgnoreCase";
  protected final String TEXT_252 = "(dbschema_";
  protected final String TEXT_253 = ") || dbschema_";
  protected final String TEXT_254 = ".trim().length() ==0)) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_255 = " = true;" + NL + "                \t                    break;" + NL + "        \t            \t    \t}" + NL + "                        \t\t}" + NL + "            \t            \trsTable_";
  ...
  protected final String TEXT_261 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_262 = " = false;" + NL + "                \t            while(rsTable_";
  protected final String TEXT_263 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_264 = " = rsTable_";
  protected final String TEXT_265 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_266 = " = rsTable_";
  protected final String TEXT_267 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_268 = ".equals";
  protected final String TEXT_269 = "IgnoreCase";
  protected final String TEXT_270 = "((";
  protected final String TEXT_271 = ")";
  protected final String TEXT_272 = ".toUpperCase()";
  ...
  protected final String TEXT_278 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_279 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_280 = ")))) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_281 = " = true;" + NL + "                \t                    break;" + NL + "                \t                }" + NL + "                \t            }" + NL + "                \t            rsTable_";
  ...
  protected final String TEXT_288 = " = false;" + NL + "                \t            String defaultSchema_";
  protected final String TEXT_289 = " = \"public\";" + NL + "                \t            if(dbschema_";
  protected final String TEXT_290 = " == null || dbschema_";
  protected final String TEXT_291 = ".trim().length() == 0) {" + NL + "                \t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_292 = " = conn_";
  protected final String TEXT_293 = ".createStatement();" + NL + "                \t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_294 = " = stmtSchema_";
  protected final String TEXT_295 = ".executeQuery(\"select current_schema() \");" + NL + "                \t            \twhile(rsSchema_";
  protected final String TEXT_296 = ".next()){" + NL + "                \t            \t\tdefaultSchema_";
  protected final String TEXT_297 = " = rsSchema_";
  protected final String TEXT_298 = ".getString(\"current_schema\");" + NL + "                \t            \t}" + NL + "                \t            \trsSchema_";
  protected final String TEXT_299 = ".close();" + NL + "                \t            \tstmtSchema_";
  protected final String TEXT_300 = ".close();" + NL + "                \t            }" + NL + "                \t            while(rsTable_";
  protected final String TEXT_301 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_302 = " = rsTable_";
  protected final String TEXT_303 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  ...
  protected final String TEXT_338 = ".createStatement();" + NL + "                        \t\t\t";
  protected final String TEXT_339 = NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_340 = NL + "    \t\t\t\t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_341 = ".execute(((\"";
  protected final String TEXT_342 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_343 = ".";
  protected final String TEXT_344 = ", \"";
  protected final String TEXT_345 = "\")";
  protected final String TEXT_346 = ".toUpperCase()";
  protected final String TEXT_347 = ")+\")";
  protected final String TEXT_348 = "\"));" + NL + "    \t\t\t\t\t\t\t\t\t";
  protected final String TEXT_349 = NL + "    \t\t\t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_350 = ".execute(\"";
  protected final String TEXT_351 = ")\");" + NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_352 = NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_353 = NL + "                    \t\t\t\tstmtCreate_";
  protected final String TEXT_354 = ".close();            " + NL + "                    \t\t\t}                " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_355 = NL + "                                if(whetherExist_";
  protected final String TEXT_356 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_357 = " = conn_";
  protected final String TEXT_358 = ".createStatement();" + NL + "                \t    \t    \t";
  ...
  protected final String TEXT_364 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_384 = NL + "    \t\t\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_385 = ", true);" + NL + "    \t\t//{{{" + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_386 = "            ";
  protected final String TEXT_387 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_388 = " = conn_";
  protected final String TEXT_389 = ".createStatement();" + NL + "    \t   \t";
  protected final String TEXT_390 = NL + "            stmtClear_";
  protected final String TEXT_391 = ".executeUpdate(\"";
  protected final String TEXT_392 = "\");" + NL + "   \t    \t";
  protected final String TEXT_393 = NL + "            stmtClear_";
  protected final String TEXT_394 = ".close();" + NL + "\t\t";
  protected final String TEXT_395 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_396 = " = conn_";
  protected final String TEXT_397 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_398 = " = stmtTruncCount_";
  protected final String TEXT_399 = ".executeQuery(\"";
  protected final String TEXT_400 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_401 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_402 = ".next()) {" + NL + "\t\t\t\trsTruncCountNumber_";
  ...
  protected final String TEXT_406 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_412 = NL + "            stmtTrunc_";
  protected final String TEXT_413 = ".executeUpdate(\"";
  protected final String TEXT_414 = "\");";
  protected final String TEXT_415 = NL + "                if(!conn_";
  protected final String TEXT_416 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_417 = ".commit();" + NL + "                }";
  protected final String TEXT_418 = NL + "   \t    \t";
  protected final String TEXT_419 = NL + "   \t    \tdeletedCount_";
  protected final String TEXT_420 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_428 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_429 = " = conn_";
  protected final String TEXT_430 = ".createStatement();" + NL + "  \t    \t";
  ...
  protected final String TEXT_437 = NL + "            while(rsTruncCount_";
  protected final String TEXT_438 = ".next()) {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_442 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_448 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_456 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_460 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_461 = " = conn_";
  protected final String TEXT_462 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_468 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_475 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_476 = " = conn_";
  protected final String TEXT_477 = ".prepareStatement(update_";
  ...
  protected final String TEXT_486 = ");" + NL + "\t    String insert_";
  protected final String TEXT_487 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_488 = " + \"\\\" (";
  protected final String TEXT_489 = ") VALUES (";
  protected final String TEXT_490 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_494 = NL + "\t    String delete_";
  protected final String TEXT_495 = " = \"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_496 = " + \"\\\" WHERE ";
  protected final String TEXT_497 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_498 = " = conn_";
  protected final String TEXT_499 = ".prepareStatement(delete_";
  protected final String TEXT_500 = ");" + NL + "\t    ";
  protected final String TEXT_501 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_502 = " = null;" + NL + "       \t";
  protected final String TEXT_503 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_504 = " = insert_";
  protected final String TEXT_505 = ".split(\"\\\\?\");";
  protected final String TEXT_506 = NL + "\t\t\tupdate_";
  protected final String TEXT_507 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_508 = " = update_";
  ...
  protected final String TEXT_513 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_514 = " = insert_";
  protected final String TEXT_515 = ".split(\"\\\\?\");";
  protected final String TEXT_516 = NL + "\t\t\tdelete_";
  protected final String TEXT_517 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_518 = " = delete_";
  protected final String TEXT_519 = ".split(\"\\\\?\");";
  protected final String TEXT_520 = NL + "\t\t\treplace_";
  protected final String TEXT_521 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_522 = " = replace_";
  protected final String TEXT_523 = ".split(\"\\\\?\");";
  protected final String TEXT_524 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_525 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_526 = " = insertIgnore_";
  protected final String TEXT_527 = ".split(\"\\\\?\");";
  protected final String TEXT_528 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_529 = " = insert_";
  protected final String TEXT_530 = ".split(\"\\\\?\");";
  protected final String TEXT_531 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_532 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_533 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_539 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_540 = " =  null;";
  protected final String TEXT_541 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_542 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_543 = " = null;";
  protected final String TEXT_544 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_545 = " = null;";
  protected final String TEXT_546 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_547 = " = null;";
  protected final String TEXT_548 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_552 = NL + "class SetPrepareStatementUtil_";
  protected final String TEXT_553 = " {";
  protected final String TEXT_554 = NL + "\t\t\tvoid set";
  protected final String TEXT_555 = "_";
  protected final String TEXT_556 = "(" + NL + "\t\t\t\tfinal ";
  protected final String TEXT_557 = "Struct ";
  protected final String TEXT_558 = "," + NL + "\t\t\t\tfinal java.sql.PreparedStatement";
  ...
  protected final String TEXT_562 = NL + "\t\t\t\t," + NL + "\t\t\t\tfinal StringBuffer query_";
  protected final String TEXT_563 = NL + "\t\t\t\t," + NL + "\t\t\t\tfinal String[] ";
  protected final String TEXT_564 = NL + "\t\t\t) throws java.sql.SQLException {" + NL + "\t\t\t//}";
  ...
  protected final String TEXT_570 = NL + "}" + NL + "" + NL + "SetPrepareStatementUtil_";
  protected final String TEXT_571 = " setPrepareStatementUtil_";
  protected final String TEXT_572 = " = new SetPrepareStatementUtil_";
  protected final String TEXT_573 = "();" + NL;
  protected final String TEXT_574 = NL + NL + "class DataPropagateUtil_";
  protected final String TEXT_575 = " {";
  protected final String TEXT_576 = NL + "\t\t\tvoid assign_";
  protected final String TEXT_577 = "_";
  protected final String TEXT_578 = "(final ";
  protected final String TEXT_579 = "Struct ";
  protected final String TEXT_580 = ",final ";
  protected final String TEXT_581 = "Struct ";
  ...
  protected final String TEXT_590 = NL + "}" + NL + "" + NL + "DataPropagateUtil_";
  protected final String TEXT_591 = " dataPropagateUtil_";
  protected final String TEXT_592 = " = new DataPropagateUtil_";
  protected final String TEXT_593 = "();" + NL + NL + NL;
...
for(String type : types) {
    ...
    stringBuffer.append(NodeUtil.getPrivateConnClassName(inputConn) );
    ...
    stringBuffer.append(getManager(dbmsId, cid).generateSetStmt(typeToGenerate, column, counter, incomingConnName, cid, actionType));
    
    	if(isEnableDebug) {

    stringBuffer.append(TEXT_566);
    stringBuffer.append(getManager(dbmsId, cid).retrieveSQL(typeToGenerate, column, incomingConnName, cid, "query_" , counter, splits));
...
if(outputConns.isEmpty()) {
    ...
    stringBuffer.append(sourceObjectType);
    stringBuffer.append(TEXT_579);
    stringBuffer.append(sourceObjectName);
