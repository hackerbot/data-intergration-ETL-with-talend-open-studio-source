...
public class TMSSqlSCDMainJava {
  ...
  protected final String TEXT_30 = " = null;" + NL + "                            } else {" + NL + "                                lookUpValue_";
  protected final String TEXT_31 = ".";
  protected final String TEXT_32 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_33 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_34 = ")) {" + NL + "                                lookUpValue_";
  protected final String TEXT_35 = ".";
  protected final String TEXT_36 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_37 = "' in '";
  protected final String TEXT_38 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_39 = NL + "                    }";
  protected final String TEXT_40 = NL + "                     lookUpValue_";
  protected final String TEXT_41 = ".";
  protected final String TEXT_42 = " = mssqlGTU_";
  protected final String TEXT_43 = ".getDate(searchingResult_";
  protected final String TEXT_44 = ".getMetaData(), searchingResult_";
  protected final String TEXT_45 = ", ";
  protected final String TEXT_46 = ");";
  protected final String TEXT_47 = NL + "                    if(searchingResult_";
  protected final String TEXT_48 = ".getObject(";
  protected final String TEXT_49 = ") != null) {" + NL + "                        lookUpValue_";
  protected final String TEXT_50 = ".";
  protected final String TEXT_51 = " = searchingResult_";
  protected final String TEXT_52 = ".get";
  protected final String TEXT_53 = "(";
  protected final String TEXT_54 = ");" + NL + "                    }";
  protected final String TEXT_55 = NL + "\t\t\t mssqlSCD_Util_";
  protected final String TEXT_56 = ".getSearchResult_";
  protected final String TEXT_57 = "(searchingResult_";
  protected final String TEXT_58 = ",lookUpValue_";
  protected final String TEXT_59 = ",tmpValue_";
  protected final String TEXT_60 = ",mssqlGTU_";
  ...
  protected final String TEXT_103 = "nextSurrogateKey_";
  protected final String TEXT_104 = "=";
  protected final String TEXT_105 = "mssqlSCD_Util_";
  protected final String TEXT_106 = ".genInsertSetStatment_";
  protected final String TEXT_107 = "(insertionStatement_";
  protected final String TEXT_108 = ",";
  protected final String TEXT_109 = NL + "\t\t\t\t";
  protected final String TEXT_110 = ",nextSurrogateKey_";
  protected final String TEXT_111 = ");\t\t";
  protected final String TEXT_112 = NL + "        nb_line_inserted_";
  protected final String TEXT_113 = " += insertionStatement_";
  protected final String TEXT_114 = ".executeUpdate();";
  protected final String TEXT_115 = NL + "            System.out.println(\"[";
  protected final String TEXT_116 = "] new source id inserted\");";
  protected final String TEXT_117 = NL + "    } else {";
  protected final String TEXT_118 = NL + "            if(";
  protected final String TEXT_119 = ") {";
  protected final String TEXT_120 = NL + "                    ";
  protected final String TEXT_121 = NL + "\t\t\t\t\tmssqlSCD_Util_";
  protected final String TEXT_122 = ".genUpdateType1SetStatment_";
  protected final String TEXT_123 = "(updateForType1_";
  protected final String TEXT_124 = ",";
  protected final String TEXT_125 = ");";
  protected final String TEXT_126 = NL + "                    ";
  protected final String TEXT_127 = NL + "\t\t\t\t\tmssqlSCD_Util_";
  protected final String TEXT_128 = ".genUpdateType1SetStatment_";
  protected final String TEXT_129 = "(updateForType1_";
  protected final String TEXT_130 = ",";
  protected final String TEXT_131 = ");";
  protected final String TEXT_132 = NL + "                nb_line_update_";
  protected final String TEXT_133 = " += updateForType1_";
  protected final String TEXT_134 = ".executeUpdate();";
  protected final String TEXT_135 = NL + "                    System.out.println(\"[";
  protected final String TEXT_136 = "] l1 update done\");";
  protected final String TEXT_137 = NL + "            }";
  protected final String TEXT_138 = NL + "            if(";
  protected final String TEXT_139 = ") {";
  protected final String TEXT_140 = NL + "                    ";
  protected final String TEXT_141 = NL + "                    mssqlSCD_Util_";
  protected final String TEXT_142 = ".genUpdateType2SetStatment_0(updateForType2_";
  protected final String TEXT_143 = ",";
  protected final String TEXT_144 = ");";
  protected final String TEXT_145 = NL + "                    ";
  protected final String TEXT_146 = NL + "\t\t\t\t\tmssqlSCD_Util_";
  protected final String TEXT_147 = ".genUpdateType2SetStatment_";
  protected final String TEXT_148 = "(updateForType2_";
  protected final String TEXT_149 = ",";
  protected final String TEXT_150 = ");";
  protected final String TEXT_151 = NL + "                nb_line_update_";
  protected final String TEXT_152 = " += updateForType2_";
  protected final String TEXT_153 = ".executeUpdate();";
  protected final String TEXT_154 = NL + "                            ";
  protected final String TEXT_155 = NL + "                            ";
  protected final String TEXT_156 = " skRoutine_";
  protected final String TEXT_157 = " = ";
  protected final String TEXT_158 = ";";
  protected final String TEXT_159 = NL + "                            ";
  protected final String TEXT_160 = "                    ";
  protected final String TEXT_161 = NL + "                            ";
  protected final String TEXT_162 = NL + "                            nextSurrogateKey_";
  protected final String TEXT_163 = "++;";
  protected final String TEXT_164 = NL + "                            ";
  protected final String TEXT_165 = NL + "                        ";
  protected final String TEXT_166 = " maxVersion_";
  protected final String TEXT_167 = " = lookUpValue_";
  protected final String TEXT_168 = ".";
  protected final String TEXT_169 = " + 1;";
  protected final String TEXT_170 = NL + "                            lookUpValue_";
  protected final String TEXT_171 = ".";
  protected final String TEXT_172 = " = lookUpValue_";
  protected final String TEXT_173 = ".";
  protected final String TEXT_174 = " + 1;                            ";
  protected final String TEXT_175 = NL + "                        ";
  protected final String TEXT_176 = NL + "                            ";
  protected final String TEXT_177 = NL + "\t\t\t\t\t";
  protected final String TEXT_178 = "nextSurrogateKey_";
  protected final String TEXT_179 = "=";
  protected final String TEXT_180 = "mssqlSCD_Util_";
  protected final String TEXT_181 = ".genInsertType2SetStatment_";
  protected final String TEXT_182 = "(" + NL + "\t\t\t\t\t\tinsertionStatement_";
  protected final String TEXT_183 = ",";
  protected final String TEXT_184 = ",nextSurrogateKey_";
  protected final String TEXT_185 = ",lookUpValue_";
  protected final String TEXT_186 = ");";
  protected final String TEXT_187 = NL + "                nb_line_inserted_";
  protected final String TEXT_188 = " += insertionStatement_";
  protected final String TEXT_189 = ".executeUpdate();";
  protected final String TEXT_190 = NL + "                    System.out.println(\"[";
  protected final String TEXT_191 = "] new history line\");";
  protected final String TEXT_192 = NL + "            }";
  protected final String TEXT_193 = NL + "            if(";
  protected final String TEXT_194 = ") {";
  protected final String TEXT_195 = NL + "                    ";
  protected final String TEXT_196 = NL + "                    mssqlSCD_Util_";
  protected final String TEXT_197 = ".genUpdateType3SetStatment_";
  protected final String TEXT_198 = "(lookUpValue_";
  protected final String TEXT_199 = ",updateForType3_";
  ...
  protected final String TEXT_209 = NL + "                    mssqlSCD_Util_";
  protected final String TEXT_210 = ".genUpdateType3SetStatment_";
  protected final String TEXT_211 = "(lookUpValue_";
  protected final String TEXT_212 = ",updateForType3_";
  protected final String TEXT_213 = ",";
  protected final String TEXT_214 = ");";
  protected final String TEXT_215 = NL + "                    ";
  protected final String TEXT_216 = NL + "                    mssqlSCD_Util_";
  protected final String TEXT_217 = ".genUpdateType3SetStatment_";
  protected final String TEXT_218 = "(lookUpValue_";
  protected final String TEXT_219 = ",updateForType3_";
  protected final String TEXT_220 = ",";
  protected final String TEXT_221 = ");";
  protected final String TEXT_222 = NL + "                nb_line_update_";
  protected final String TEXT_223 = " += updateForType3_";
  protected final String TEXT_224 = ".executeUpdate();";
  protected final String TEXT_225 = NL + "                    System.out.println(\"[";
  protected final String TEXT_226 = "] l3 update done\");";
  protected final String TEXT_227 = NL + "            }";
  protected final String TEXT_228 = NL + "    }" + NL + "    " + NL + "\t} catch (java.lang.Exception e) {//catch" + NL + "  \t\t";
  protected final String TEXT_229 = NL + "            throw(e);";
  ...
  protected final String TEXT_238 = NL + "\t\t\t\t\tmssqlSCD_Util_";
  protected final String TEXT_239 = ".putFlowValueToReject_";
  protected final String TEXT_240 = "(";
  protected final String TEXT_241 = ", ";
  protected final String TEXT_242 = ");";
  protected final String TEXT_243 = NL + "                nb_line_rejected_";
  protected final String TEXT_244 = "++;";
  protected final String TEXT_245 = NL + "                ";
  protected final String TEXT_246 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_251 = NL + "\t}//end catch" + NL + "\t";
  protected final String TEXT_252 = NL + "                lookUpValue_";
  protected final String TEXT_253 = ".";
  protected final String TEXT_254 = " = ";
  protected final String TEXT_255 = ".";
  protected final String TEXT_256 = ";";
  protected final String TEXT_257 = NL + "                lookUpValue_";
  protected final String TEXT_258 = ".";
  protected final String TEXT_259 = " = ";
  protected final String TEXT_260 = ".";
  protected final String TEXT_261 = ";";
  protected final String TEXT_262 = NL + "                lookUpValue_";
  protected final String TEXT_263 = ".";
  protected final String TEXT_264 = " = ";
  protected final String TEXT_265 = ".";
  protected final String TEXT_266 = ";";
  protected final String TEXT_267 = NL + "        cache_";
  protected final String TEXT_268 = ".put(lookUpKey_";
