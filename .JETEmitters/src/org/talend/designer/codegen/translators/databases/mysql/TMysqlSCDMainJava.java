...
public class TMysqlSCDMainJava {
  protected static String nl;
  public static synchronized TMysqlSCDMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMysqlSCDMainJava result = new TMysqlSCDMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_3 = " = null; // reinitialize the reject connection for branch system (option HAS_CONDITIONAL_OUTPUTS)";
  ...
  protected final String TEXT_168 = NL + "    }" + NL + "    " + NL + "\t} catch (java.lang.Exception e) {//catch" + NL + "  \t\t";
  ...
  protected final String TEXT_187 = NL + "\t}//end catch";
  ...
  protected final String TEXT_198 = NL + "                lookUpValue_";
  protected final String TEXT_199 = ".";
  protected final String TEXT_200 = " = ";
  protected final String TEXT_201 = ".";
  protected final String TEXT_202 = ";";
  protected final String TEXT_203 = NL + "        cache_";
  protected final String TEXT_204 = ".put(lookUpKey_";
  protected final String TEXT_205 = ", lookUpValue_";
