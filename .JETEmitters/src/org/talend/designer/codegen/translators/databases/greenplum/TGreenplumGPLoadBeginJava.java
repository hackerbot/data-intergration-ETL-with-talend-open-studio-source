...
public class TGreenplumGPLoadBeginJava {
  protected static String nl;
  public static synchronized TGreenplumGPLoadBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGreenplumGPLoadBeginJava result = new TGreenplumGPLoadBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_71 = NL + "\tint deletedCount_";
  protected final String TEXT_72 = " = 0;" + NL + "\tint insertedCount_";
  protected final String TEXT_73 = " = 0;";
  protected final String TEXT_74 = NL + "\t\tboolean missConfiguration_";
  protected final String TEXT_75 = " = true;" + NL + "\t\tString missConfigurationMsg_";
  protected final String TEXT_76 = " = \"";
  protected final String TEXT_77 = "\";" + NL + "\t\tif (missConfiguration_";
  protected final String TEXT_78 = ") {" + NL + "\t\t\tthrow new java.lang.Exception(missConfigurationMsg_";
  protected final String TEXT_79 = ");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_80 = NL + NL + "\tString tableName_";
  protected final String TEXT_81 = " = ";
  protected final String TEXT_82 = ";" + NL + "\tString dbschema_";
  protected final String TEXT_83 = " = ";
  protected final String TEXT_84 = ";" + NL + "\tString tableName4Load_";
  protected final String TEXT_85 = " = \"\\\"\" + tableName_";
  ...
  protected final String TEXT_89 = " = dbschema_";
  protected final String TEXT_90 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_91 = ";" + NL + "\t\ttableName4Load_";
  protected final String TEXT_92 = " = \"\\\"\"+dbschema_";
  protected final String TEXT_93 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_94 = "+\"\\\"\";" + NL + "\t}";
  protected final String TEXT_95 = NL + NL + "\t\tString driverClass_";
  protected final String TEXT_96 = " = \"org.postgresql.Driver\";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_97 = ");    " + NL + "\t\tString url_";
  protected final String TEXT_98 = " = \"jdbc:postgresql://\"+";
  ...
  protected final String TEXT_115 = NL + "\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_116 = " = conn_";
  protected final String TEXT_117 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_118 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_119 = " - Droping table '\" + tableName_";
  protected final String TEXT_120 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_121 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_122 = ".execute(\"";
  protected final String TEXT_123 = "\");" + NL + "\t\t\t";
  protected final String TEXT_124 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_125 = " - Drop table '\" + tableName_";
  protected final String TEXT_126 = " + \"' has succeeded.\" );" + NL + "\t\t\t";
  protected final String TEXT_127 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_128 = " =  null;" + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_129 = " = conn_";
  protected final String TEXT_130 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_131 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_132 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_138 = " - Create table '\" + tableName_";
  protected final String TEXT_139 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_140 = NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_141 = "){" + NL + "\t\t\t\t\tthrow new RuntimeException (\"Table '\" + tableName4Load_";
  protected final String TEXT_142 = "  + \"' already exists. process terminated.\");" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_143 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_144 = " - Table '\" + tableName4Load_";
  protected final String TEXT_145 = "  + \"' already exists. process terminated.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_146 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_147 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_148 = " = null; " + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_149 = " = conn_";
  protected final String TEXT_150 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_151 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_152 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_158 = " - Create table '\" + tableName_";
  protected final String TEXT_159 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_160 = NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_161 = "){" + NL + "\t\t\t\t\t throw new RuntimeException (\"Table '\" + tableName4Load_";
  protected final String TEXT_162 = "  + \"' already exists. process terminated.\");" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_163 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_164 = " - Table '\" + tableName4Load_";
  protected final String TEXT_165 = " + \"' already exists. process terminated.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_166 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  ...
  protected final String TEXT_172 = " = false;" + NL + "\t\t\tString defaultSchema_";
  protected final String TEXT_173 = " = \"public\";" + NL + "\t\t\tif(dbschema_";
  protected final String TEXT_174 = " == null || dbschema_";
  protected final String TEXT_175 = ".trim().length() == 0) {" + NL + "\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_176 = " = conn_";
  protected final String TEXT_177 = ".createStatement();" + NL + "\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_178 = " = stmtSchema_";
  protected final String TEXT_179 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\twhile(rsSchema_";
  protected final String TEXT_180 = ".next()){" + NL + "\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_181 = " = rsSchema_";
  protected final String TEXT_182 = ".getString(\"current_schema\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsSchema_";
  protected final String TEXT_183 = ".close();" + NL + "\t\t\t\tstmtSchema_";
  protected final String TEXT_184 = ".close();" + NL + "\t\t\t}" + NL + "\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_192 = ".equals(dbschema_";
  protected final String TEXT_193 = ") || ((dbschema_";
  protected final String TEXT_194 = "==null || dbschema_";
  protected final String TEXT_195 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_196 = ".equals(schema_";
  protected final String TEXT_197 = ")))) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_198 = " = true;" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_199 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_200 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_201 = " = null;" + NL + "\t\t\t\t\ttry{" + NL + "\t\t\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_205 = " - Creating table '\" + tableName_";
  protected final String TEXT_206 = " + \"'.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_207 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_208 = ".execute(\"";
  protected final String TEXT_209 = ")\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_210 = NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_211 = " - Create table '\" + tableName_";
  protected final String TEXT_212 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_213 = " " + NL + "\t\t\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_214 = "){" + NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName4Load_";
  protected final String TEXT_215 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_216 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_217 = " - Failure to create table '\" + tableName4Load_";
  protected final String TEXT_218 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_219 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}                ";
  protected final String TEXT_220 = NL + "                if(whetherExist_";
  protected final String TEXT_221 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_222 = " = null;" + NL + "                    try{" + NL + "                    \tstmtDrop_";
  ...
  protected final String TEXT_226 = " - Droping table '\" + tableName_";
  protected final String TEXT_227 = " + \"'.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_228 = NL + "                    \tstmtDrop_";
  protected final String TEXT_229 = ".execute(\"";
  protected final String TEXT_230 = "\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_231 = NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_232 = " - Drop table '\" + tableName_";
  protected final String TEXT_233 = " + \"' has succeeded.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_234 = NL + "                    }catch(java.sql.SQLException e){" + NL + "                    \tif(";
  protected final String TEXT_235 = "){" + NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to drop table '\" + tableName4Load_";
  protected final String TEXT_236 = "  + \"'. process terminated.\");" + NL + "                    \t}else{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_237 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_238 = " - Failure to drop table '\" + tableName4Load_";
  protected final String TEXT_239 = " + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_240 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "                    \t}" + NL + "                    }" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_241 = " = null;" + NL + "                try{" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_245 = " - Creating table '\" + tableName_";
  protected final String TEXT_246 = " + \"'.\");" + NL + "\t\t\t\t";
  protected final String TEXT_247 = NL + "                stmtCreate_";
  protected final String TEXT_248 = ".execute(\"";
  protected final String TEXT_249 = ")\");" + NL + "\t\t\t\t";
  protected final String TEXT_250 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_251 = " - Create table '\" + tableName_";
  protected final String TEXT_252 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_253 = "           " + NL + "                }catch(java.sql.SQLException e){" + NL + "                \tif(";
  protected final String TEXT_254 = "){" + NL + "\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName4Load_";
  protected final String TEXT_255 = "  + \"'. process terminated.\");" + NL + "                \t}else{" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_256 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_257 = " - Failure to create table '\" + tableName4Load_";
  protected final String TEXT_258 = " + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_259 = NL + "\t\t\t\t\t\t e.printStackTrace();" + NL + "                \t}" + NL + "                }";
  protected final String TEXT_260 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_261 = " = conn_";
  protected final String TEXT_262 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_263 = " = stmtClearCount_";
  protected final String TEXT_264 = ".executeQuery(\"";
  protected final String TEXT_265 = "\");" + NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_269 = " - Truncating table '\" + tableName_";
  protected final String TEXT_270 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_271 = NL + "            stmtClear_";
  protected final String TEXT_272 = ".executeUpdate(\"";
  protected final String TEXT_273 = "\");" + NL + "\t\t\t";
  protected final String TEXT_274 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_275 = " - Truncate table '\" + tableName_";
  protected final String TEXT_276 = " + \"' has succeeded.\" );" + NL + "\t\t\t";
  protected final String TEXT_277 = NL + "            while(rsClearCount_";
  protected final String TEXT_278 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_279 = " = rsClearCount_";
  protected final String TEXT_280 = ".getInt(1);" + NL + "            }";
  protected final String TEXT_281 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_282 = " = null;" + NL + "            try{" + NL + "            \tstmtClear_";
  protected final String TEXT_283 = " = conn_";
  protected final String TEXT_284 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_285 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_286 = " - Clearing table '\" + tableName_";
  protected final String TEXT_287 = " + \"'.\");" + NL + "\t\t\t\t";
  protected final String TEXT_288 = NL + "            \tdeletedCount_";
  protected final String TEXT_289 = " = stmtClear_";
  protected final String TEXT_290 = ".executeUpdate(\"";
  protected final String TEXT_291 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_292 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_293 = "- Clear table '\" + tableName_";
  protected final String TEXT_294 = " +  \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_295 = NL + "            \tstmtClear_";
  protected final String TEXT_296 = ".close();" + NL + "            }catch(java.sql.SQLException e){" + NL + "            \tif(";
  protected final String TEXT_297 = "){" + NL + "\t\t\t\t\t throw new RuntimeException (\"Failure to clear table '\" + tableName4Load_";
  protected final String TEXT_298 = "  + \"'. process terminated.\");" + NL + "            \t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_299 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_300 = " - Failure to clear table '\" + tableName4Load_";
  protected final String TEXT_301 = " + \"'. process terminated.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_302 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "            \t}" + NL + "            }";
  protected final String TEXT_303 = NL;
  protected final String TEXT_304 = NL + "\t\tString delim_";
  protected final String TEXT_305 = " = ";
  protected final String TEXT_306 = ";" + NL + "\t\tString escape_";
  protected final String TEXT_307 = " = ";
  protected final String TEXT_308 = ";" + NL + "\t\tString quote_";
  protected final String TEXT_309 = " = ";
  protected final String TEXT_310 = ";" + NL + "\t\tdelim_";
  protected final String TEXT_311 = " = \"\\t\".equals(delim_";
  protected final String TEXT_312 = ") ? \"\\\\t\" : delim_";
  protected final String TEXT_313 = ";" + NL + "\t\t" + NL + "\t\tjava.io.PrintWriter gpctrl_";
  protected final String TEXT_314 = " = new java.io.PrintWriter(new java.io.FileOutputStream(";
  protected final String TEXT_315 = ", false), true);" + NL + "\t\tgpctrl_";
  protected final String TEXT_316 = ".println(\"---\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_317 = ".println(\"VERSION: 1.0.0.1\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_318 = ".println(\"DATABASE: \" + ";
  protected final String TEXT_319 = ");" + NL + "\t\tgpctrl_";
  protected final String TEXT_320 = ".println(\"USER: \" + ";
  protected final String TEXT_321 = ");" + NL + "\t\tgpctrl_";
  protected final String TEXT_322 = ".println(\"HOST: \" + ";
  protected final String TEXT_323 = ");" + NL + "\t\tgpctrl_";
  protected final String TEXT_324 = ".println(\"PORT: \" + ";
  protected final String TEXT_325 = ");" + NL + "\t\tgpctrl_";
  protected final String TEXT_326 = ".println(\"GPLOAD:\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_327 = ".println(\"  INPUT:\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_328 = ".println(\"    - SOURCE:\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_329 = ".println(\"        FILE:\");" + NL + "\t\t";
  protected final String TEXT_330 = NL + "\t\tgpctrl_";
  protected final String TEXT_331 = ".println(\"          - \" + (new com.infobright.io.NamedPipeFactory()).getNativePipeName(";
  protected final String TEXT_332 = "));" + NL + "\t\t";
  protected final String TEXT_333 = NL + "\t\tgpctrl_";
  protected final String TEXT_334 = ".println(\"          - \" + ";
  protected final String TEXT_335 = ");" + NL + "\t\t";
  protected final String TEXT_336 = NL + "\t\tgpctrl_";
  protected final String TEXT_337 = ".println(\"    - DELIMITER: '\" + delim_";
  protected final String TEXT_338 = " + \"'\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_339 = ".println(\"    - ESCAPE: '\" + escape_";
  protected final String TEXT_340 = " + \"'\");" + NL + "\t\t";
  protected final String TEXT_341 = NL + "\t\tgpctrl_";
  protected final String TEXT_342 = ".println(\"    - FORMAT: csv\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_343 = ".println(\"    - QUOTE: '\" + quote_";
  protected final String TEXT_344 = " + \"'\");" + NL + "\t\t";
  protected final String TEXT_345 = NL + "\t\tgpctrl_";
  protected final String TEXT_346 = ".println(\"    - FORMAT: text\");" + NL + "\t\t";
  protected final String TEXT_347 = NL + "\t\t";
  protected final String TEXT_348 = NL + "\t\tgpctrl_";
  protected final String TEXT_349 = ".println(\"    - HEADER: true\");" + NL + "\t\t";
  protected final String TEXT_350 = NL + "\t\tgpctrl_";
  protected final String TEXT_351 = ".println(\"    - ENCODING: \" + ";
  protected final String TEXT_352 = ");" + NL + "\t\t";
  protected final String TEXT_353 = NL + "\t\t\t\tgpctrl_";
  protected final String TEXT_354 = ".println(\"    - ";
  protected final String TEXT_355 = ": \" + ";
  protected final String TEXT_356 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_357 = NL + "\t\tgpctrl_";
  protected final String TEXT_358 = ".println(\"  OUTPUT: \");" + NL + "\t\tgpctrl_";
  protected final String TEXT_359 = ".println(\"    - TABLE: '\" + tableName4Load_";
  protected final String TEXT_360 = "+\"'\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_361 = ".println(\"    - MODE: ";
  protected final String TEXT_362 = "\");" + NL + "\t\t";
  protected final String TEXT_363 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_364 = ".println(\"    - MATCH_COLUMNS:\");" + NL + "\t\t\t";
  protected final String TEXT_365 = NL + "\t\t\t\t\tgpctrl_";
  protected final String TEXT_366 = ".println(\"      - ";
  protected final String TEXT_367 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_368 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_369 = ".println(\"    - UPDATE_COLUMNS:\");" + NL + "\t\t\t";
  protected final String TEXT_370 = NL + "\t\t\t\t\tgpctrl_";
  protected final String TEXT_371 = ".println(\"      - ";
  protected final String TEXT_372 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_373 = NL + "\t\t\t\tgpctrl_";
  protected final String TEXT_374 = ".println(\"    - UPDATE_CONDITION: \" + ";
  protected final String TEXT_375 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_376 = NL + "\t\tgpctrl_";
  protected final String TEXT_377 = ".close();" + NL + "\t\t";
  protected final String TEXT_378 = NL + NL + "\tfinal StringBuilder gploadOutput_";
  protected final String TEXT_379 = " = new StringBuilder(200);" + NL + "\tThread gploadThread_";
  protected final String TEXT_380 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tString[] envp = null;" + NL + "\t\t\t\tString[] cmds = new String[] {";
  protected final String TEXT_381 = ",";
  protected final String TEXT_382 = "};" + NL + "\t\t\t\tRuntime rt = Runtime.getRuntime();" + NL + "\t\t\t\tfinal Process ps = rt.exec(cmds, envp);" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getInputStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\twhile ((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\tgploadOutput_";
  protected final String TEXT_383 = ".append(line);" + NL + "\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tcatch (java.lang.Exception e) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_384 = "_GPLOAD_ERROR\",e.getMessage());" + NL + "\t\t\t\tthrow new RuntimeException(e.getMessage(),e.getCause());" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL;
  protected final String TEXT_385 = NL + "\t\tStringBuffer command_";
  protected final String TEXT_386 = " = new StringBuffer(";
  protected final String TEXT_387 = ");" + NL + "\t\t";
  protected final String TEXT_388 = NL + "\t\t\tcommand_";
  protected final String TEXT_389 = ".append(";
  protected final String TEXT_390 = " +\" \");" + NL + "\t\t";
  protected final String TEXT_391 = NL + "\t";
  protected final String TEXT_392 = NL + "\t\t\tcom.infobright.io.NamedPipe outputStream_";
  protected final String TEXT_393 = " = (new com.infobright.io.NamedPipeFactory()).createServer(";
  protected final String TEXT_394 = ", true, true, 1024000, 10000);" + NL + "\t\t\tgploadThread_";
  protected final String TEXT_395 = ".start();" + NL + "\t\t\t// in Windows wait for named pipe to get opened by gpload.exe" + NL + "\t\t\tif ((new com.infobright.io.NamedPipeFactory()).isWindowsMode()) { " + NL + "\t\t\t\tThread.sleep(10000);" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_396 = NL + "\t\t\tjava.io.BufferedOutputStream outputStream_";
  protected final String TEXT_397 = " = new java.io.BufferedOutputStream(new java.io.FileOutputStream(";
  protected final String TEXT_398 = ",false), 1024000);" + NL + "\t\t";
  protected final String TEXT_399 = NL + "\t\t";
  protected final String TEXT_400 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_401 = " - Executing '\"+command_";
  protected final String TEXT_402 = ".toString()+\"'.\");" + NL + "\t\t";
  protected final String TEXT_403 = NL + "\tgploadThread_";
  protected final String TEXT_404 = ".start();" + NL + "\tgploadThread_";
  protected final String TEXT_405 = ".join(0);" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_406 = "_GPLOAD_OUTPUT\", gploadOutput_";
  protected final String TEXT_407 = ".toString());" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_408 = "_NB_LINE\", insertedCount_";
  protected final String TEXT_409 = ");" + NL + "\t\t";
  protected final String TEXT_410 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_411 = " - Execute '\"+command_";
  protected final String TEXT_412 = ".toString()+\"' has finished.\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_413 = " - Loaded records count:\" + insertedCount_";
    ...
    public String generate(Object argument)
  {
    ...
    stringBuffer.append(gploadCtrlFile);
    ...
    stringBuffer.append(dataAction.toLowerCase());
    ...
    stringBuffer.append(updateCondition);
    ...
    stringBuffer.append(gploadExePath);
    
						for (int i=0; i < parametersList.size(); i++) {
							
    stringBuffer.append(TEXT_381);
    stringBuffer.append(parametersList.get(i));
