...
public class TOracleRowBeginJava
{
  ...
  protected final String TEXT_82 = " " + NL + "\t\t\t\t\tif (null == conn_";
  protected final String TEXT_83 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_84 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES); " + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_85 = " = dataSources_";
  protected final String TEXT_86 = ".get(";
  protected final String TEXT_87 = ").getConnection();" + NL + "\t\t\t\t\t\tif (conn_";
  protected final String TEXT_88 = " != null) { " + NL + "\t\t\t\t\t\t\tconn_";
  protected final String TEXT_89 = ".setAutoCommit(";
  protected final String TEXT_90 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_91 = NL + "\t\t            java.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_92 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t            if (null != dataSources_";
  ...
  protected final String TEXT_115 = NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_116 = ".getAutoCommit()) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_117 = NL + "\t\t\t\t\t}        " + NL + "\t\t\t\t\tint commitEvery_";
  protected final String TEXT_118 = " = ";
  protected final String TEXT_119 = ";" + NL + "\t\t\t\t\tint commitCounter_";
  ...
  protected final String TEXT_126 = NL + "\t\t\t\turl_";
  protected final String TEXT_127 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_128 = " + \":\" + ";
  protected final String TEXT_129 = " + \":\" + ";
  protected final String TEXT_130 = ";";
  protected final String TEXT_131 = NL + "\t\t\t\turl_";
  protected final String TEXT_132 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_133 = " + \")(port=\" + ";
  protected final String TEXT_134 = " + \"))(connect_data=(service_name=\" + ";
  protected final String TEXT_135 = " + \")))\";";
  protected final String TEXT_136 = NL + "\t\t\t\turl_";
  protected final String TEXT_137 = " = \"jdbc:oracle:oci8:@\" + ";
  protected final String TEXT_138 = ";";
  protected final String TEXT_139 = NL + "\t    \t\t\turl_";
  protected final String TEXT_140 = " = ";
  protected final String TEXT_141 = ";";
  protected final String TEXT_142 = NL + "\t\t\t\tString atnParams_";
  protected final String TEXT_143 = " = ";
  protected final String TEXT_144 = ";" + NL + "\t\t\t\tatnParams_";
  protected final String TEXT_145 = " = atnParams_";
  protected final String TEXT_146 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\t\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_147 = " = new java.util.Properties();" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_148 = ".put(\"user\",dbUser_";
  protected final String TEXT_149 = ");" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_150 = ".put(\"password\",dbPwd_";
  protected final String TEXT_151 = ");" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_152 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_153 = ".getBytes()));" + NL + "\t\t\t\tconn_";
  protected final String TEXT_154 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_155 = ", atnParamsPrope_";
  protected final String TEXT_156 = ");" + NL + "\t\t\t";
  protected final String TEXT_157 = NL + "\t\t\t\tint nb_line_inserted_";
  protected final String TEXT_158 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_159 = NL + "\t\t\t\tint nb_line_update_";
  protected final String TEXT_160 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_161 = NL + "\t\t\t\tint nb_line_deleted_";
  protected final String TEXT_162 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_163 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_164 = " = null;" + NL + "\tString query_";
  protected final String TEXT_165 = " = \"\";" + NL + "\tboolean whetherReject_";
  ...
  protected final String TEXT_169 = ".prepareStatement(";
  protected final String TEXT_170 = ");\t" + NL + "\t";
  protected final String TEXT_171 = NL + "\t\tjava.sql.Statement stmt_";
