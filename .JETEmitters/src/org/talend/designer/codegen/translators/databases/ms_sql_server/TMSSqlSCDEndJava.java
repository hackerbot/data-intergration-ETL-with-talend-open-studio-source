...
public class TMSSqlSCDEndJava {
  protected static String nl;
  public static synchronized TMSSqlSCDEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMSSqlSCDEndJava result = new TMSSqlSCDEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_13 = NL + "    if(conn_";
  ...
  protected final String TEXT_22 = "_NB_LINE_REJECTED\",nb_line_rejected_";
