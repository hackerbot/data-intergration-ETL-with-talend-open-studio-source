...
public class TOracleSCDBeginJava {
  ...
  protected final String TEXT_59 = ".getBytes()));" + NL + "\t\tjava.sql.Connection connection_";
  protected final String TEXT_60 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_61 = ", atnParamsPrope_";
  protected final String TEXT_62 = ");";
  protected final String TEXT_63 = NL + "        ";
  protected final String TEXT_64 = NL + "    String tableName_";
  protected final String TEXT_65 = " = null;" + NL + "    if(schema_";
  protected final String TEXT_66 = " == null || schema_";
  protected final String TEXT_67 = ".trim().length() == 0) {" + NL + "        tableName_";
  protected final String TEXT_68 = " = ";
  protected final String TEXT_69 = ";" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_70 = " = schema_";
  protected final String TEXT_71 = " + \".\" + ";
  protected final String TEXT_72 = ";" + NL + "    }" + NL + "    ";
  protected final String TEXT_73 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_74 = " = connection_";
  protected final String TEXT_75 = ".createStatement();" + NL + "            stmtCreate_";
  protected final String TEXT_76 = ".execute(\"";
  protected final String TEXT_77 = "\");" + NL + "            stmtCreate_";
  protected final String TEXT_78 = ".close();";
  protected final String TEXT_79 = NL + "\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_80 = " = connection_";
  protected final String TEXT_81 = ".getMetaData();";
  protected final String TEXT_82 = "   " + NL + "\t\t\t\tString dbschemaForSearch_";
  protected final String TEXT_83 = " = null;" + NL + "\t\t\t\tif (schema_";
  protected final String TEXT_84 = " == null" + NL + "\t\t\t\t\t\t|| schema_";
  protected final String TEXT_85 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tdbschemaForSearch_";
  protected final String TEXT_86 = " = ((String)";
  protected final String TEXT_87 = ").toUpperCase();" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdbschemaForSearch_";
  protected final String TEXT_88 = " = schema_";
  protected final String TEXT_89 = ".toUpperCase();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tString tableName4Search_";
  protected final String TEXT_90 = " = ";
  protected final String TEXT_91 = ";" + NL + "            \tif(tableName4Search_";
  protected final String TEXT_92 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableName4Search_";
  protected final String TEXT_93 = " = tableName4Search_";
  protected final String TEXT_94 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableName4Search_";
  protected final String TEXT_95 = " = tableName4Search_";
  ...
  protected final String TEXT_99 = ", tableName4Search_";
  protected final String TEXT_100 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_101 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_102 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_103 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  protected final String TEXT_104 = ".close();" + NL + "\t            ";
  protected final String TEXT_105 = NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_118 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_122 = NL + "    " + NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_123 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_124 = " = null;    ";
  protected final String TEXT_125 = NL + "        String searching_";
  protected final String TEXT_126 = " = \"";
  protected final String TEXT_127 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_128 = " = connection_";
  protected final String TEXT_129 = ".prepareStatement(searching_";
  protected final String TEXT_130 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_131 = " = null;";
  protected final String TEXT_132 = NL + "        String search_";
  protected final String TEXT_133 = " = \"";
  protected final String TEXT_134 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_135 = " = connection_";
  protected final String TEXT_136 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_137 = " = statement_";
  protected final String TEXT_138 = ".executeQuery(search_";
  protected final String TEXT_139 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_140 = ", SCDStruct_";
  protected final String TEXT_141 = "> cache_";
  protected final String TEXT_142 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_143 = ", SCDStruct_";
  protected final String TEXT_144 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_145 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_146 = " sk_";
  protected final String TEXT_147 = " = new SCDSK_";
  protected final String TEXT_148 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_149 = " row_";
  protected final String TEXT_150 = " = new SCDStruct_";
  protected final String TEXT_151 = "();";
  protected final String TEXT_152 = NL + "                    tmpValue_";
  protected final String TEXT_153 = " = resultSet_";
  protected final String TEXT_154 = ".getString(";
  protected final String TEXT_155 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_156 = " != null && tmpValue_";
  protected final String TEXT_157 = ".length() > 0) {";
  protected final String TEXT_158 = NL + "                        ";
  protected final String TEXT_159 = ".";
  protected final String TEXT_160 = " = tmpValue_";
  protected final String TEXT_161 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_162 = NL + "                            if(tmpValue_";
  protected final String TEXT_163 = " == null) {";
  protected final String TEXT_164 = NL + "                                ";
  protected final String TEXT_165 = ".";
  protected final String TEXT_166 = " = null;" + NL + "                            } else {";
  protected final String TEXT_167 = NL + "                                ";
  protected final String TEXT_168 = ".";
  protected final String TEXT_169 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_170 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_171 = ")) {";
  protected final String TEXT_172 = NL + "                                ";
  protected final String TEXT_173 = ".";
  protected final String TEXT_174 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_175 = "' in '";
  protected final String TEXT_176 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_177 = NL + "                    }";
  protected final String TEXT_178 = NL + "\t                    if(((oracle.jdbc.OracleResultSet) resultSet_";
  protected final String TEXT_179 = ").getTIMESTAMPTZ(";
  protected final String TEXT_180 = ") != null){" + NL + "\t                    \t";
  protected final String TEXT_181 = ".";
  protected final String TEXT_182 = " = org.talend.oracle.OracleTSTZUtil.toTalendTSTZ(((oracle.jdbc.OracleResultSet) resultSet_";
  protected final String TEXT_183 = ").getTIMESTAMPTZ(";
  protected final String TEXT_184 = ").toBytes());" + NL + "\t                    }else{" + NL + "\t                    \t";
  protected final String TEXT_185 = ".";
  protected final String TEXT_186 = " = null;" + NL + "\t                    }" + NL + "\t                ";
  protected final String TEXT_187 = NL + "\t                    timestamp_";
  protected final String TEXT_188 = " = resultSet_";
  protected final String TEXT_189 = ".getTimestamp(";
  protected final String TEXT_190 = ");" + NL + "\t                    if(timestamp_";
  protected final String TEXT_191 = " != null) {" + NL + "\t                        ";
  protected final String TEXT_192 = ".";
  protected final String TEXT_193 = " = new java.util.Date(timestamp_";
  protected final String TEXT_194 = ".getTime());" + NL + "\t                    } else {" + NL + "\t                        ";
  protected final String TEXT_195 = ".";
  protected final String TEXT_196 = " = null;" + NL + "\t                    }";
  protected final String TEXT_197 = NL + "                    if(resultSet_";
  protected final String TEXT_198 = ".getObject(";
  protected final String TEXT_199 = ") != null) {";
  protected final String TEXT_200 = NL + "                        ";
  protected final String TEXT_201 = ".";
  protected final String TEXT_202 = " = resultSet_";
  protected final String TEXT_203 = ".get";
  protected final String TEXT_204 = "(";
  protected final String TEXT_205 = ");" + NL + "                    }";
  protected final String TEXT_206 = NL + "            cache_";
  protected final String TEXT_207 = ".put(sk_";
  protected final String TEXT_208 = ", row_";
  protected final String TEXT_209 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_210 = ".close();" + NL + "        statement_";
  protected final String TEXT_211 = ".close();";
  protected final String TEXT_212 = NL + "            System.out.println(\"[";
  protected final String TEXT_213 = "] comparison cache loaded\");";
  protected final String TEXT_214 = NL + "        ";
  protected final String TEXT_215 = " nextSurrogateKey_";
  protected final String TEXT_216 = " = 1;";
  protected final String TEXT_217 = NL + "            if(cache_";
  protected final String TEXT_218 = ".size() > 0) {";
  protected final String TEXT_219 = NL + "        String tmpQuery_";
  protected final String TEXT_220 = " = \"SELECT MAX(";
  protected final String TEXT_221 = ") FROM \" + tableName_";
  protected final String TEXT_222 = ";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_223 = " = connection_";
  protected final String TEXT_224 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_225 = " = tmpStmt_";
  protected final String TEXT_226 = ".executeQuery(tmpQuery_";
  protected final String TEXT_227 = ");";
  protected final String TEXT_228 = NL + "        if(tmpRS_";
  protected final String TEXT_229 = ".next() && tmpRS_";
  protected final String TEXT_230 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_231 = " = tmpRS_";
  protected final String TEXT_232 = ".get";
  protected final String TEXT_233 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_234 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_235 = ".close();";
  protected final String TEXT_236 = NL + "            }            ";
  protected final String TEXT_237 = NL + "    String insertionSQL_";
  protected final String TEXT_238 = " = \"";
  protected final String TEXT_239 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_240 = " = connection_";
  protected final String TEXT_241 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_242 = ");";
  protected final String TEXT_243 = NL + "            insertionStatement_";
  protected final String TEXT_244 = ".setTimestamp(";
  protected final String TEXT_245 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_246 = "\")));";
  protected final String TEXT_247 = NL + "            insertionStatement_";
  protected final String TEXT_248 = ".setNull(";
  protected final String TEXT_249 = ", java.sql.Types.DATE);";
  protected final String TEXT_250 = NL + "            String endDateTimeDetail_";
  protected final String TEXT_251 = " = ";
  protected final String TEXT_252 = ";" + NL + "            String datePattern_";
  protected final String TEXT_253 = " = \"yyyy-MM-dd\";" + NL + "            if(endDateTimeDetail_";
  protected final String TEXT_254 = ".length()>0){" + NL + "            \tendDateTimeDetail_";
  protected final String TEXT_255 = " = \" \"+endDateTimeDetail_";
  protected final String TEXT_256 = ";" + NL + "            \tdatePattern_";
  protected final String TEXT_257 = " = \"yyyy-MM-dd HH:mm:ss\";" + NL + "            }" + NL + "            insertionStatement_";
  protected final String TEXT_258 = ".setTimestamp(";
  protected final String TEXT_259 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(datePattern_";
  protected final String TEXT_260 = ").parse(";
  protected final String TEXT_261 = " + \"-01-01\"+endDateTimeDetail_";
  protected final String TEXT_262 = ").getTime()));";
  protected final String TEXT_263 = NL + "        String updateSQLForType1_";
  protected final String TEXT_264 = " = \"";
  protected final String TEXT_265 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_266 = " = connection_";
  protected final String TEXT_267 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_268 = ");        ";
  protected final String TEXT_269 = NL + "        String updateSQLForType2_";
  protected final String TEXT_270 = " = \"";
  protected final String TEXT_271 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_272 = " = connection_";
  protected final String TEXT_273 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_274 = ");";
  protected final String TEXT_275 = NL + "            updateForType2_";
  protected final String TEXT_276 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_277 = "\")));";
  protected final String TEXT_278 = NL + "        String updateSQLForType3_";
  protected final String TEXT_279 = " = \"";
  protected final String TEXT_280 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_281 = " = connection_";
  protected final String TEXT_282 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_283 = ");";
  protected final String TEXT_284 = NL + "    ";
  protected final String TEXT_285 = NL + "        SCDSK_";
  protected final String TEXT_286 = " lookUpKey_";
  protected final String TEXT_287 = " = null;        ";
  protected final String TEXT_288 = NL + "    SCDStruct_";
  protected final String TEXT_289 = " lookUpValue_";
