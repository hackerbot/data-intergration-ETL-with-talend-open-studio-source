...
public class TOracleTableListBeginJava
{
  ...
  protected final String TEXT_73 = NL + NL + "String whereClause_";
  protected final String TEXT_74 = " = ";
  protected final String TEXT_75 = ";" + NL + "" + NL + "String query_";
  protected final String TEXT_76 = " = \"\";" + NL + "" + NL + "if(whereClause_";
  protected final String TEXT_77 = " != null && whereClause_";
  protected final String TEXT_78 = ".length() > 0){" + NL + "" + NL + "\tquery_";
  protected final String TEXT_79 = " = \"SELECT tname FROM tab WHERE tabtype='TABLE' AND (\" + whereClause_";
  protected final String TEXT_80 = " + \") ORDER BY tname ASC\";" + NL + "" + NL + "}else{" + NL + "" + NL + "\tquery_";
  protected final String TEXT_81 = " = \"SELECT tname FROM tab WHERE tabtype='TABLE' ORDER BY tname ASC\";" + NL + "" + NL + "}";
  protected final String TEXT_82 = NL + "    log.info(\"";
  protected final String TEXT_83 = " - Query:'\"+query_";
  protected final String TEXT_84 = "+\"'.\");";
  protected final String TEXT_85 = NL + NL + "int nb_table_";
  protected final String TEXT_86 = " = 0;" + NL + "" + NL + "java.sql.Statement stmt2_";
  protected final String TEXT_87 = " = conn_";
  protected final String TEXT_88 = ".createStatement();" + NL + "" + NL + "java.sql.ResultSet rs_";
  protected final String TEXT_89 = " = stmt2_";
  protected final String TEXT_90 = ".executeQuery(query_";
  protected final String TEXT_91 = ");" + NL + "" + NL + "while (rs_";
  protected final String TEXT_92 = ".next()) {" + NL + "" + NL + "\tString currentTableName_";
  protected final String TEXT_93 = " = rs_";
  protected final String TEXT_94 = ".getString(1); " + NL + "" + NL + "\tnb_table_";
  protected final String TEXT_95 = "++;" + NL + "        " + NL + "\t";
  protected final String TEXT_96 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_97 = " - Retrieving the table \"+nb_table_";
  protected final String TEXT_98 = "+\".\");" + NL + "\t\tlog.trace(\"";
  protected final String TEXT_99 = " - Name of table \"+nb_table_";
  protected final String TEXT_100 = "+\":\"+currentTableName_";
  protected final String TEXT_101 = "+\".\");" + NL + "\t";
  protected final String TEXT_102 = NL + "\tglobalMap.put(\"";
  protected final String TEXT_103 = "_CURRENT_TABLE\", currentTableName_";
