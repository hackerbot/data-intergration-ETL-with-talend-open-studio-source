...
public class TOleDbOutputBeginJava {
  protected static String nl;
  public static synchronized TOleDbOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TOleDbOutputBeginJava result = new TOleDbOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_42 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_43 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_44 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_45 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_46 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_47 = " = 0;" + NL + "int updatedCount_";
  protected final String TEXT_48 = " = 0;" + NL + "int insertedCount_";
  protected final String TEXT_49 = " = 0;" + NL + "int rejectedCount_";
  protected final String TEXT_50 = " = 0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_51 = " = false;";
  protected final String TEXT_52 = NL;
  protected final String TEXT_53 = NL + "        int updateKeyCount_";
  protected final String TEXT_54 = " = ";
  protected final String TEXT_55 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_56 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_57 = NL + "        int deleteKeyCount_";
  ...
  protected final String TEXT_62 = NL + "org.talend.net.Object conn_";
  protected final String TEXT_63 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_64 = ",";
  protected final String TEXT_65 = ",new java.lang.Object[]{";
  protected final String TEXT_66 = "});";
  protected final String TEXT_67 = NL;
  protected final String TEXT_68 = NL + "conn_";
  protected final String TEXT_69 = ".invokeGeneric(\"Open\");";
  protected final String TEXT_70 = NL + NL + NL;
  protected final String TEXT_71 = NL + "    org.talend.net.Object delCmd_";
  protected final String TEXT_72 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_73 = "," + NL + "    \t\"System.Data.OleDb.OleDbCommand\",new java.lang.Object[] {" + NL + "    \t\"DELETE FROM \"+";
  protected final String TEXT_74 = "," + NL + "    \tconn_";
  protected final String TEXT_75 = NL + "    \t});";
  protected final String TEXT_76 = NL + "   \tdeletedCount_";
  protected final String TEXT_77 = " = deletedCount_";
  protected final String TEXT_78 = " + (Integer)delCmd_";
  protected final String TEXT_79 = ".invokeGeneric(\"ExecuteNonQuery\");" + NL + "    ";
  protected final String TEXT_80 = NL + "\t    String insert_";
  protected final String TEXT_81 = " = \"INSERT INTO \" + ";
  protected final String TEXT_82 = " + \" (";
  protected final String TEXT_83 = ") VALUES (";
  protected final String TEXT_84 = ")\";" + NL + "            org.talend.net.Object cmd_";
  protected final String TEXT_85 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_86 = "," + NL + "    \t\t\"System.Data.OleDb.OleDbCommand\",new java.lang.Object[] {" + NL + "    \t\tinsert_";
  protected final String TEXT_87 = "," + NL + "    \t\tconn_";
  protected final String TEXT_88 = NL + "    \t});";
  protected final String TEXT_89 = NL + "\t    String update_";
  protected final String TEXT_90 = " = \"UPDATE \" + ";
  protected final String TEXT_91 = " + \" SET ";
  protected final String TEXT_92 = " WHERE ";
  protected final String TEXT_93 = "\";" + NL + "\t    org.talend.net.Object cmd_";
  protected final String TEXT_94 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_95 = "," + NL + "    \t\t\"System.Data.OleDb.OleDbCommand\",new java.lang.Object[] {" + NL + "    \t\tupdate_";
  protected final String TEXT_96 = "," + NL + "    \t\tconn_";
  protected final String TEXT_97 = NL + "    \t});" + NL + "\t    ";
  protected final String TEXT_98 = NL + "\t    org.talend.net.Object cmd_";
  protected final String TEXT_99 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_100 = "," + NL + "    \t\t\"System.Data.OleDb.OleDbCommand\",new java.lang.Object[] {" + NL + "    \t\t\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_101 = " + \" WHERE ";
  protected final String TEXT_102 = "\"," + NL + "    \t\tconn_";
  protected final String TEXT_103 = NL + "    \t});" + NL + "\t    String insert_";
  protected final String TEXT_104 = " = \"INSERT INTO \" + ";
  protected final String TEXT_105 = " + \" (";
  protected final String TEXT_106 = ") VALUES (";
  protected final String TEXT_107 = ")\";" + NL + "\t    org.talend.net.Object cmdInsert_";
  protected final String TEXT_108 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_109 = "," + NL + "    \t\t\"System.Data.OleDb.OleDbCommand\",new java.lang.Object[] {" + NL + "    \t\tinsert_";
  protected final String TEXT_110 = "," + NL + "    \t\tconn_";
  protected final String TEXT_111 = NL + "    \t});" + NL + "\t    String update_";
  protected final String TEXT_112 = " = \"UPDATE \" + ";
  protected final String TEXT_113 = " + \" SET ";
  protected final String TEXT_114 = " WHERE ";
  protected final String TEXT_115 = "\";" + NL + "\t    org.talend.net.Object cmdUpdate_";
  protected final String TEXT_116 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_117 = "," + NL + "    \t\t\"System.Data.OleDb.OleDbCommand\",new java.lang.Object[] {" + NL + "    \t\tupdate_";
  protected final String TEXT_118 = "," + NL + "    \t\tconn_";
  protected final String TEXT_119 = NL + "    \t});" + NL + "\t    ";
  protected final String TEXT_120 = NL + "\t    String update_";
  protected final String TEXT_121 = " = \"UPDATE \" + ";
  protected final String TEXT_122 = " + \" SET ";
  protected final String TEXT_123 = " WHERE ";
  protected final String TEXT_124 = "\";" + NL + "\t    org.talend.net.Object cmdUpdate_";
  protected final String TEXT_125 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_126 = "," + NL + "    \t\t\"System.Data.OleDb.OleDbCommand\",new java.lang.Object[] {" + NL + "    \t\tupdate_";
  protected final String TEXT_127 = "," + NL + "    \t\tconn_";
  protected final String TEXT_128 = NL + "    \t});" + NL + "\t    String insert_";
  protected final String TEXT_129 = " = \"INSERT INTO \" + ";
  protected final String TEXT_130 = " + \" (";
  protected final String TEXT_131 = ") VALUES (";
  protected final String TEXT_132 = ")\";" + NL + "\t    org.talend.net.Object cmdInsert_";
  protected final String TEXT_133 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_134 = "," + NL + "    \t\t\"System.Data.OleDb.OleDbCommand\",new java.lang.Object[] {" + NL + "    \t\tinsert_";
  protected final String TEXT_135 = "," + NL + "    \t\tconn_";
  protected final String TEXT_136 = NL + "    \t});\t\t" + NL + "\t    ";
  protected final String TEXT_137 = NL + "\t    String delete_";
  protected final String TEXT_138 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_139 = " + \" WHERE ";
  protected final String TEXT_140 = "\";" + NL + "\t    org.talend.net.Object cmd_";
  protected final String TEXT_141 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_142 = "," + NL + "    \t\t\"System.Data.OleDb.OleDbCommand\",new java.lang.Object[] {" + NL + "    \t\tdelete_";
  protected final String TEXT_143 = "," + NL + "    \t\tconn_";
  protected final String TEXT_144 = NL + "    \t});" + NL + "\t    ";
  protected final String TEXT_145 = NL + "        StringBuffer query_";
  protected final String TEXT_146 = " = null;" + NL + "       \t";
  protected final String TEXT_147 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_148 = " = insert_";
  protected final String TEXT_149 = ".split(\"\\\\?\");";
  protected final String TEXT_150 = NL + "\t\t\tupdate_";
  protected final String TEXT_151 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_152 = " = update_";
  protected final String TEXT_153 = ".split(\"\\\\?\");";
  protected final String TEXT_154 = NL + "\t\t\tupdate_";
  protected final String TEXT_155 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_156 = " = update_";
  protected final String TEXT_157 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_158 = " = insert_";
  protected final String TEXT_159 = ".split(\"\\\\?\");";
  protected final String TEXT_160 = NL + "\t\t\tdelete_";
  protected final String TEXT_161 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_162 = " = delete_";
  protected final String TEXT_163 = ".split(\"\\\\?\");";
  protected final String TEXT_164 = NL + "\t\t\treplace_";
  protected final String TEXT_165 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_166 = " = replace_";
  protected final String TEXT_167 = ".split(\"\\\\?\");";
  protected final String TEXT_168 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_169 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_170 = " = insertIgnore_";
  protected final String TEXT_171 = ".split(\"\\\\?\");";
  protected final String TEXT_172 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_173 = " = insert_";
  protected final String TEXT_174 = ".split(\"\\\\?\");";
  protected final String TEXT_175 = NL + "\t    int commitEvery_";
  protected final String TEXT_176 = " = ";
  protected final String TEXT_177 = ";" + NL + "\t    int commitCounter_";
...
if(("true").equals(tableAction)) {
    ...
    stringBuffer.append(TEXT_75);
            ...
            logtpl.info("\"Try to clear table: \"",tableName,"\".\"");
...
if(columnList != null && columnList.size() > 0) {
    ...
    stringBuffer.append(TEXT_88);
     logtpl.debug("\"Data action: \"",logtpl.str(dataAction),"\", Insert SQL: \"",logtpl.var("insert"),"\".\"");
    ...
    stringBuffer.append(TEXT_97);
     logtpl.debug("\"Data action: \"",logtpl.str(dataAction),"\", Update SQL: \"",logtpl.var("update"),"\".\"");
    ...
    stringBuffer.append(TEXT_119);
        ...
        logtpl.debug("\"Data action: \"",logtpl.str(dataAction),"\", Insert SQL: \"",logtpl.var("insert"),"\", Update SQL: \"",logtpl.var("update"),"\".\"");
    ...
    stringBuffer.append(TEXT_136);
        ...
        logtpl.debug("\"Data action: \"",logtpl.str(dataAction),"\", Update SQL: \"",logtpl.var("update"),"\", Insert SQL: \"",logtpl.var("insert"),"\".\"");
	} else if (("DELETE").equals(dataAction)) {
    ...
    stringBuffer.append(TEXT_144);
        ...
        logtpl.debug("\"Data action: \"",logtpl.str(dataAction),"\", Delete SQL: \"",logtpl.var("delete"),"\".\"");
	}
    if(isEnableDebug) {
