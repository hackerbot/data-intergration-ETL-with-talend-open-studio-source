...
public class THSQLDbOutputBeginJava {
  protected static String nl;
  public static synchronized THSQLDbOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    THSQLDbOutputBeginJava result = new THSQLDbOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_45 = NL + "\t\t\turl_";
  protected final String TEXT_46 = " = \"jdbc:hsqldb:hsqls://\" + ";
  protected final String TEXT_47 = " + \":\" + ";
  protected final String TEXT_48 = " + \"/\" + ";
  protected final String TEXT_49 = ";" + NL + "\t\t\t";
  protected final String TEXT_50 = NL + "\t\t\turl_";
  protected final String TEXT_51 = " = \"jdbc:hsqldb:hsql://\" + ";
  protected final String TEXT_52 = " + \":\" + ";
  protected final String TEXT_53 = " + \"/\" + ";
  protected final String TEXT_54 = ";" + NL + "\t\t\t";
  protected final String TEXT_55 = NL + "\t\t\turl_";
  protected final String TEXT_56 = " = \"jdbc:hsqldb:https://\" + ";
  protected final String TEXT_57 = " + \":\" + ";
  protected final String TEXT_58 = " + \"/\" + ";
  protected final String TEXT_59 = ";" + NL + "\t\t\t";
  protected final String TEXT_60 = NL + "\t\t\turl_";
  protected final String TEXT_61 = " = \"jdbc:hsqldb:http://\" + ";
  protected final String TEXT_62 = " + \":\" + ";
  protected final String TEXT_63 = " + \"/\" + ";
  protected final String TEXT_64 = ";" + NL + "\t\t\t";
  protected final String TEXT_65 = NL + "\t\turl_";
  protected final String TEXT_66 = " = \"jdbc:hsqldb:file:\" + ";
  protected final String TEXT_67 = " + \"/\" + ";
  protected final String TEXT_68 = " ;" + NL + "\t\t";
  protected final String TEXT_69 = NL + "\t\turl_";
  protected final String TEXT_70 = " = \"jdbc:hsqldb:mem:\" + ";
  protected final String TEXT_71 = " ;" + NL + "\t\t";
  protected final String TEXT_72 = NL + "\t\turl_";
  protected final String TEXT_73 = " += \";\" + ";
  protected final String TEXT_74 = ";";
  protected final String TEXT_75 = NL + NL + "int nb_line_";
  ...
  protected final String TEXT_79 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_80 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_81 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_82 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_83 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_84 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_85 = " = ";
  protected final String TEXT_86 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_87 = " = false;";
  protected final String TEXT_88 = NL;
  protected final String TEXT_89 = NL + "        int updateKeyCount_";
  protected final String TEXT_90 = " = ";
  protected final String TEXT_91 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_92 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_93 = NL + "        int deleteKeyCount_";
  protected final String TEXT_94 = " = ";
  protected final String TEXT_95 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_96 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_97 = " " + NL + "java.lang.Class.forName(\"org.hsqldb.jdbcDriver\");";
  ...
  protected final String TEXT_111 = "\t" + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_128 = ".createStatement();";
  protected final String TEXT_129 = NL + "            stmtCreate_";
  protected final String TEXT_130 = ".execute(\"";
  protected final String TEXT_131 = ")\");";
  protected final String TEXT_132 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_146 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_147 = ".equalsIgnoreCase(";
  protected final String TEXT_148 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_149 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  protected final String TEXT_150 = NL + "                if(!whetherExist_";
  protected final String TEXT_151 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_158 = NL + "                if(whetherExist_";
  ...
  protected final String TEXT_165 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_172 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_173 = " = conn_";
  protected final String TEXT_174 = ".createStatement();";
  protected final String TEXT_175 = NL + "            deletedCount_";
  protected final String TEXT_176 = " = deletedCount_";
  protected final String TEXT_177 = " + stmtClear_";
  protected final String TEXT_178 = ".executeUpdate(\"";
  protected final String TEXT_179 = "\");";
  protected final String TEXT_180 = NL + "\t    String insert_";
  protected final String TEXT_181 = " = \"INSERT INTO \" + ";
  protected final String TEXT_182 = " + \" (";
  protected final String TEXT_183 = ") VALUES (";
  protected final String TEXT_184 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_185 = " = conn_";
  protected final String TEXT_186 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_192 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_193 = " = conn_";
  protected final String TEXT_194 = ".prepareStatement(update_";
  protected final String TEXT_195 = ");" + NL + "\t    ";
  protected final String TEXT_196 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_197 = " = conn_";
  protected final String TEXT_198 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_199 = " + \" WHERE ";
  protected final String TEXT_200 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_201 = " = \"INSERT INTO \" + ";
  protected final String TEXT_202 = " + \" (";
  protected final String TEXT_203 = ") VALUES (";
  protected final String TEXT_204 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_205 = " = conn_";
  protected final String TEXT_206 = ".prepareStatement(insert_";
  protected final String TEXT_207 = ");" + NL + "\t    String update_";
  protected final String TEXT_208 = " = \"UPDATE \" + ";
  protected final String TEXT_209 = " + \" SET ";
  protected final String TEXT_210 = " WHERE ";
  protected final String TEXT_211 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_212 = " = conn_";
  protected final String TEXT_213 = ".prepareStatement(update_";
  protected final String TEXT_214 = ");" + NL + "\t    ";
  protected final String TEXT_215 = NL + "\t    String update_";
  protected final String TEXT_216 = " = \"UPDATE \" + ";
  protected final String TEXT_217 = " + \" SET ";
  protected final String TEXT_218 = " WHERE ";
  protected final String TEXT_219 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_220 = " = conn_";
  protected final String TEXT_221 = ".prepareStatement(update_";
  protected final String TEXT_222 = ");" + NL + "\t    String insert_";
  protected final String TEXT_223 = " = \"INSERT INTO \" + ";
  protected final String TEXT_224 = " + \" (";
  protected final String TEXT_225 = ") VALUES (";
  protected final String TEXT_226 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_227 = " = conn_";
  protected final String TEXT_228 = ".prepareStatement(insert_";
  protected final String TEXT_229 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_230 = NL + "\t    String delete_";
  protected final String TEXT_231 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_232 = " + \" WHERE ";
  protected final String TEXT_233 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_234 = " = conn_";
  protected final String TEXT_235 = ".prepareStatement(delete_";
  protected final String TEXT_236 = ");" + NL + "\t    ";
  protected final String TEXT_237 = NL + "        StringBuffer query_";
  protected final String TEXT_238 = " = null;" + NL + "       \t";
  protected final String TEXT_239 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_240 = " = insert_";
  protected final String TEXT_241 = ".split(\"\\\\?\");";
  protected final String TEXT_242 = NL + "\t\t\tupdate_";
  protected final String TEXT_243 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_244 = " = update_";
  protected final String TEXT_245 = ".split(\"\\\\?\");";
  protected final String TEXT_246 = NL + "\t\t\tupdate_";
  protected final String TEXT_247 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_248 = " = update_";
  protected final String TEXT_249 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_250 = " = insert_";
  protected final String TEXT_251 = ".split(\"\\\\?\");";
  protected final String TEXT_252 = NL + "\t\t\tdelete_";
  protected final String TEXT_253 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_254 = " = delete_";
  protected final String TEXT_255 = ".split(\"\\\\?\");";
  protected final String TEXT_256 = NL + "\t\t\treplace_";
  protected final String TEXT_257 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_258 = " = replace_";
  protected final String TEXT_259 = ".split(\"\\\\?\");";
  protected final String TEXT_260 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_261 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_262 = " = insertIgnore_";
  protected final String TEXT_263 = ".split(\"\\\\?\");";
  protected final String TEXT_264 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_265 = " = insert_";
  protected final String TEXT_266 = ".split(\"\\\\?\");";
  protected final String TEXT_267 = NL + "        " + NL + "        int commitEvery_";
  protected final String TEXT_268 = " = ";
  protected final String TEXT_269 = ";" + NL + "        " + NL + "        int commitCounter_";
