...
public class TDB2SCDBeginJava {
  protected static String nl;
  public static synchronized TDB2SCDBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDB2SCDBeginJava result = new TDB2SCDBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_9 = " = (String) globalMap.get(\"tableschema_";
  ...
  protected final String TEXT_14 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_15 = " + \":\" + ";
  protected final String TEXT_16 = " + \"/\" + ";
  protected final String TEXT_17 = ";    ";
  protected final String TEXT_18 = NL + "\t\t\tString connectionString_";
  protected final String TEXT_19 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_20 = " + \":\" + ";
  protected final String TEXT_21 = " + \"/\" + ";
  protected final String TEXT_22 = " + \":\" + ";
  protected final String TEXT_23 = ";";
  protected final String TEXT_24 = NL + "        java.lang.Class.forName(\"com.ibm.db2.jcc.DB2Driver\");" + NL + "        " + NL + "\t\t";
  ...
  protected final String TEXT_32 = NL + "\t   \t" + NL + "        java.sql.Connection connection_";
  protected final String TEXT_33 = " = java.sql.DriverManager.getConnection(connectionString_";
  ...
  protected final String TEXT_40 = " = null;" + NL + "    if(schema_";
  protected final String TEXT_41 = " == null || schema_";
  protected final String TEXT_42 = ".trim().length() == 0) {" + NL + "        tableName_";
  protected final String TEXT_43 = " = ";
  protected final String TEXT_44 = ";" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_45 = " = schema_";
  protected final String TEXT_46 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_47 = ";" + NL + "    }" + NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_48 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_49 = " = null;    ";
  protected final String TEXT_50 = NL + "        String searching_";
  protected final String TEXT_51 = " = \"";
  protected final String TEXT_52 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_53 = " = connection_";
  protected final String TEXT_54 = ".prepareStatement(searching_";
  protected final String TEXT_55 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_56 = " = null;";
  protected final String TEXT_57 = NL + "        String search_";
  protected final String TEXT_58 = " = \"";
  protected final String TEXT_59 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_60 = " = connection_";
  protected final String TEXT_61 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_62 = " = statement_";
  protected final String TEXT_63 = ".executeQuery(search_";
  protected final String TEXT_64 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_65 = ", SCDStruct_";
  protected final String TEXT_66 = "> cache_";
  protected final String TEXT_67 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_68 = ", SCDStruct_";
  protected final String TEXT_69 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_70 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_71 = " sk_";
  protected final String TEXT_72 = " = new SCDSK_";
  protected final String TEXT_73 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_74 = " row_";
  protected final String TEXT_75 = " = new SCDStruct_";
  protected final String TEXT_76 = "();";
  protected final String TEXT_77 = NL + "                    tmpValue_";
  protected final String TEXT_78 = " = resultSet_";
  protected final String TEXT_79 = ".getString(";
  protected final String TEXT_80 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_81 = " != null && tmpValue_";
  protected final String TEXT_82 = ".length() > 0) {";
  protected final String TEXT_83 = NL + "                        ";
  protected final String TEXT_84 = ".";
  protected final String TEXT_85 = " = tmpValue_";
  protected final String TEXT_86 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_87 = NL + "                            if(tmpValue_";
  protected final String TEXT_88 = " == null) {";
  protected final String TEXT_89 = NL + "                                ";
  protected final String TEXT_90 = ".";
  protected final String TEXT_91 = " = null;" + NL + "                            } else {";
  protected final String TEXT_92 = NL + "                                ";
  protected final String TEXT_93 = ".";
  protected final String TEXT_94 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_95 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_96 = ")) {";
  protected final String TEXT_97 = NL + "                                ";
  protected final String TEXT_98 = ".";
  protected final String TEXT_99 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_100 = "' in '";
  protected final String TEXT_101 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_102 = NL + "                    }";
  protected final String TEXT_103 = NL + "                    timestamp_";
  protected final String TEXT_104 = " = resultSet_";
  protected final String TEXT_105 = ".getTimestamp(";
  protected final String TEXT_106 = ");" + NL + "                    if(timestamp_";
  protected final String TEXT_107 = " != null) {";
  protected final String TEXT_108 = NL + "                        ";
  protected final String TEXT_109 = ".";
  protected final String TEXT_110 = " = new java.util.Date(timestamp_";
  protected final String TEXT_111 = ".getTime());" + NL + "                    } else {";
  protected final String TEXT_112 = NL + "                        ";
  protected final String TEXT_113 = ".";
  protected final String TEXT_114 = " = null;" + NL + "                    }";
  protected final String TEXT_115 = NL + "                    if(resultSet_";
  protected final String TEXT_116 = ".getObject(";
  protected final String TEXT_117 = ") != null) {";
  protected final String TEXT_118 = NL + "                        ";
  protected final String TEXT_119 = ".";
  protected final String TEXT_120 = " = resultSet_";
  protected final String TEXT_121 = ".get";
  protected final String TEXT_122 = "(";
  protected final String TEXT_123 = ");" + NL + "                    }";
  protected final String TEXT_124 = NL + "            cache_";
  protected final String TEXT_125 = ".put(sk_";
  protected final String TEXT_126 = ", row_";
  protected final String TEXT_127 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_128 = ".close();" + NL + "        statement_";
  protected final String TEXT_129 = ".close();";
  protected final String TEXT_130 = NL + "            System.out.println(\"[";
  protected final String TEXT_131 = "] comparison cache loaded\");";
  protected final String TEXT_132 = NL + "        ";
  protected final String TEXT_133 = " nextSurrogateKey_";
  protected final String TEXT_134 = " = 1;";
  protected final String TEXT_135 = NL + "            if(cache_";
  protected final String TEXT_136 = ".size() > 0) {";
  protected final String TEXT_137 = NL + "        String tmpQuery_";
  protected final String TEXT_138 = " = \"SELECT MAX(\\\"";
  protected final String TEXT_139 = "\\\") FROM \\\"\" + tableName_";
  protected final String TEXT_140 = " + \"\\\"\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_141 = " = connection_";
  protected final String TEXT_142 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_143 = " = tmpStmt_";
  protected final String TEXT_144 = ".executeQuery(tmpQuery_";
  protected final String TEXT_145 = ");";
  protected final String TEXT_146 = NL + "        if(tmpRS_";
  protected final String TEXT_147 = ".next() && tmpRS_";
  protected final String TEXT_148 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_149 = " = tmpRS_";
  protected final String TEXT_150 = ".get";
  protected final String TEXT_151 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_152 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_153 = ".close();";
  protected final String TEXT_154 = NL + "            }            ";
  protected final String TEXT_155 = NL + "    String insertionSQL_";
  protected final String TEXT_156 = " = \"";
  protected final String TEXT_157 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_158 = " = connection_";
  protected final String TEXT_159 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_160 = ");";
  protected final String TEXT_161 = NL + "            insertionStatement_";
  protected final String TEXT_162 = ".setTimestamp(";
  protected final String TEXT_163 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_164 = "\")));";
  protected final String TEXT_165 = NL + "            insertionStatement_";
  protected final String TEXT_166 = ".setNull(";
  protected final String TEXT_167 = ", java.sql.Types.DATE);";
  protected final String TEXT_168 = NL + "            String endDateTimeDetail_";
  protected final String TEXT_169 = " = ";
  protected final String TEXT_170 = ";" + NL + "            String datePattern_";
  protected final String TEXT_171 = " = \"yyyy-MM-dd\";" + NL + "            if(endDateTimeDetail_";
  protected final String TEXT_172 = ".length()>0){" + NL + "            \tendDateTimeDetail_";
  protected final String TEXT_173 = " = \" \"+endDateTimeDetail_";
  protected final String TEXT_174 = ";" + NL + "            \tdatePattern_";
  protected final String TEXT_175 = " = \"yyyy-MM-dd HH:mm:ss\";" + NL + "            }" + NL + "            insertionStatement_";
  protected final String TEXT_176 = ".setTimestamp(";
  protected final String TEXT_177 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(datePattern_";
  protected final String TEXT_178 = ").parse(";
  protected final String TEXT_179 = " + \"-01-01\"+endDateTimeDetail_";
  protected final String TEXT_180 = ").getTime()));";
  protected final String TEXT_181 = NL + "        String updateSQLForType1_";
  protected final String TEXT_182 = " = \"";
  protected final String TEXT_183 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_184 = " = connection_";
  protected final String TEXT_185 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_186 = ");        ";
  protected final String TEXT_187 = NL + "        String updateSQLForType2_";
  protected final String TEXT_188 = " = \"";
  protected final String TEXT_189 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_190 = " = connection_";
  protected final String TEXT_191 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_192 = ");";
  protected final String TEXT_193 = NL + "            updateForType2_";
  protected final String TEXT_194 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_195 = "\")));";
  protected final String TEXT_196 = NL + "        String updateSQLForType3_";
  protected final String TEXT_197 = " = \"";
  protected final String TEXT_198 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_199 = " = connection_";
  protected final String TEXT_200 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_201 = ");";
  protected final String TEXT_202 = NL + "        SCDSK_";
  protected final String TEXT_203 = " lookUpKey_";
  protected final String TEXT_204 = " = null;        ";
  protected final String TEXT_205 = NL + "    SCDStruct_";
  protected final String TEXT_206 = " lookUpValue_";
