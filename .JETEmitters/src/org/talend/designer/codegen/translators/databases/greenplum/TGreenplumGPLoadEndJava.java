...
public class TGreenplumGPLoadEndJava {
  protected static String nl;
  public static synchronized TGreenplumGPLoadEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGreenplumGPLoadEndJava result = new TGreenplumGPLoadEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_10 = NL + "\t\t\tgploadThread_";
  protected final String TEXT_11 = ".join(0);" + NL + "\t\t\t";
  protected final String TEXT_12 = NL + "\t\t\tgploadThread_";
  protected final String TEXT_13 = ".start();" + NL + "\t\t\tgploadThread_";
  ...
  protected final String TEXT_17 = ".toString()+\"' has finished.\");" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_18 = " - Loaded records count:\"+insertedCount_";
  protected final String TEXT_19 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_20 = NL + "\tglobalMap.put(\"";
  protected final String TEXT_21 = "_GPLOAD_OUTPUT\", gploadOutput_";
  protected final String TEXT_22 = ".toString());" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_23 = "_NB_LINE\", insertedCount_";
