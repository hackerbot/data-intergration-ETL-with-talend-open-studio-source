...
public class TSybaseSPMainJava
{
  ...
  protected final String TEXT_43 = NL + "\t\t\t// No code generated: IN or INOUT arguments defined, whereas ";
  protected final String TEXT_44 = " has no input" + NL + "\t\t\t";
  protected final String TEXT_45 = NL + "\t\t\t\tif(true){" + NL + "\t\t\t\t\tthrow new RuntimeException(\"Please specify the \\\"return\\\" column in the drop-down list of \\\"Return result in\\\"! You should select \\\"IN\\\" as input parameter type only when \\\"is function\\\" is checked!\");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_46 = NL + "\t\t\t\t\tif (";
  protected final String TEXT_47 = ".";
  protected final String TEXT_48 = " == null) {" + NL + "\t\t\t\t\t\tstatement_";
  protected final String TEXT_49 = ".setNull(";
  protected final String TEXT_50 = ", java.sql.Types.";
  protected final String TEXT_51 = ");" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t";
  protected final String TEXT_52 = NL + "\t\t\t\t\tif (";
  protected final String TEXT_53 = ".";
  protected final String TEXT_54 = " == '\\0') {" + NL + "\t\t\t\t\t\tstatement_";
  protected final String TEXT_55 = ".setString(";
  protected final String TEXT_56 = ", \"\");" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\tstatement_";
  protected final String TEXT_57 = ".setString(";
  protected final String TEXT_58 = ", String.valueOf(";
  protected final String TEXT_59 = ".";
  protected final String TEXT_60 = "));" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_61 = NL + "\t\t\t\t\tstatement_";
  protected final String TEXT_62 = ".setDate(";
  protected final String TEXT_63 = ", new java.sql.Date(";
  ...
  protected final String TEXT_74 = ".registerOutParameter(";
  protected final String TEXT_75 = ", java.sql.Types.";
  protected final String TEXT_76 = ");" + NL + "\t  \t\t\t";
  protected final String TEXT_77 = NL + "\t";
  protected final String TEXT_78 = NL + "\t\tjava.sql.ResultSet rs_";
  protected final String TEXT_79 = " = statement_";
  protected final String TEXT_80 = ".executeQuery();" + NL + "\t";
  protected final String TEXT_81 = NL + "\t\tstatement_";
  protected final String TEXT_82 = ".executeQuery();" + NL + "\t";
  protected final String TEXT_83 = NL + "\t\tstatement_";
  protected final String TEXT_84 = ".executeUpdate();" + NL + "\t";
  protected final String TEXT_85 = NL + "\t\tstatement_";
  protected final String TEXT_86 = ".execute();" + NL + "\t";
  ...
  protected final String TEXT_95 = " = statement_";
  protected final String TEXT_96 = ".getResultSet();";
  protected final String TEXT_97 = NL + "\t\t\t\t\t  \t\t\t\twhile(rs_";
  protected final String TEXT_98 = ".next()){" + NL + "\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_99 = NL + "\t\t\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_100 = " = rs_";
  protected final String TEXT_101 = ".getString(";
  protected final String TEXT_102 = ");" + NL + "\t\t\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_103 = " != null && tmpString_";
  protected final String TEXT_104 = ".length() > 0) {" + NL + "\t\t\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_105 = ".";
  protected final String TEXT_106 = " = tmpString_";
  protected final String TEXT_107 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_108 = NL + "\t\t\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_109 = " = rs_";
  protected final String TEXT_110 = ".getDate(";
  protected final String TEXT_111 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_112 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_113 = ".";
  protected final String TEXT_114 = " = new java.util.Date(tmpDate_";
  protected final String TEXT_115 = ".getTime());" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_123 = NL + "\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_124 = " = statement_";
  protected final String TEXT_125 = ".getString(";
  protected final String TEXT_126 = ");" + NL + "\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_127 = " != null && tmpString_";
  protected final String TEXT_128 = ".length() > 0) {" + NL + "\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_129 = ".";
  protected final String TEXT_130 = " = tmpString_";
  protected final String TEXT_131 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_132 = NL + "\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_133 = " = statement_";
  protected final String TEXT_134 = ".getDate(";
  protected final String TEXT_135 = ");" + NL + "\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_136 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_137 = ".";
  protected final String TEXT_138 = " = new java.util.Date(tmpDate_";
  protected final String TEXT_139 = ".getTime());" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_140 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_141 = ".";
  protected final String TEXT_142 = " = statement_";
  protected final String TEXT_143 = ".get";
  protected final String TEXT_144 = "(";
  protected final String TEXT_145 = ");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_146 = NL + "\t\t\t\t\t\t\t\t\tif (statement_";
  protected final String TEXT_147 = ".wasNull()) {" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_148 = ".";
  protected final String TEXT_149 = " = null;" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_160 = NL + "\t\t// No code generated: define a schema for ";
