...
public class TPostgresqlSCDMainJava {
  protected static String nl;
  public static synchronized TPostgresqlSCDMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresqlSCDMainJava result = new TPostgresqlSCDMainJava();
    nl = null;
    return result;
  }
