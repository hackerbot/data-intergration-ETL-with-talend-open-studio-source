...
public class TNetezzaOutputBeginJava {
  protected static String nl;
  public static synchronized TNetezzaOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNetezzaOutputBeginJava result = new TNetezzaOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_80 = " = \"org.netezza.Driver\";" + NL + "\tjava.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_89 = " = \"jdbc:netezza://\" + ";
  ...
  protected final String TEXT_109 = ", dbUser_";
  protected final String TEXT_110 = ", dbPwd_";
  protected final String TEXT_111 = ");" + NL + "\t";
  protected final String TEXT_112 = NL + "\tresourceMap.put(\"conn_";
  ...
  protected final String TEXT_166 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_167 = " = conn_";
  protected final String TEXT_168 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_169 = " = stmtClearCount_";
  protected final String TEXT_170 = ".executeQuery(\"";
  protected final String TEXT_171 = "\");" + NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_175 = ".executeUpdate(\"";
  protected final String TEXT_176 = "\");";
  protected final String TEXT_177 = NL + "            while(rsClearCount_";
  protected final String TEXT_178 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_179 = " += rsClearCount_";
  protected final String TEXT_180 = ".getInt(1);" + NL + "            }";
  ...
  protected final String TEXT_184 = NL + "            deletedCount_";
  protected final String TEXT_185 = " = deletedCount_";
  protected final String TEXT_186 = " + stmtClear_";
  protected final String TEXT_187 = ".executeUpdate(\"";
  protected final String TEXT_188 = "\");";
  protected final String TEXT_189 = NL + "            stmtClear_";
  protected final String TEXT_190 = ".close();";
  protected final String TEXT_191 = NL + "    \tconn_";
  protected final String TEXT_192 = ".setAutoCommit(false);";
  protected final String TEXT_193 = NL + "\t        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_194 = " = conn_";
  protected final String TEXT_195 = ".prepareStatement(\"INSERT INTO \"+";
  protected final String TEXT_196 = "+\" (";
  protected final String TEXT_197 = ") VALUES (";
  protected final String TEXT_198 = ")\");" + NL + "\t        ";
  protected final String TEXT_199 = NL + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_200 = " = conn_";
  protected final String TEXT_201 = ".prepareStatement(\"UPDATE \" + ";
  protected final String TEXT_202 = " + \" SET ";
  protected final String TEXT_203 = " WHERE ";
  protected final String TEXT_204 = "\");" + NL + "" + NL + "\t    ";
  protected final String TEXT_205 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_206 = " = conn_";
  protected final String TEXT_207 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_208 = " + \" WHERE ";
  protected final String TEXT_209 = "\");" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_210 = " = conn_";
  protected final String TEXT_211 = ".prepareStatement(\"INSERT INTO \" + ";
  protected final String TEXT_212 = " + \" (";
  protected final String TEXT_213 = ") VALUES (";
  protected final String TEXT_214 = ")\");" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_215 = " = conn_";
  protected final String TEXT_216 = ".prepareStatement(\"UPDATE \" + ";
  protected final String TEXT_217 = " + \" SET ";
  protected final String TEXT_218 = " WHERE ";
  protected final String TEXT_219 = "\");" + NL + "" + NL + "\t    ";
  protected final String TEXT_220 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_221 = " = conn_";
  protected final String TEXT_222 = ".prepareStatement(\"UPDATE \" + ";
  protected final String TEXT_223 = " + \" SET ";
  protected final String TEXT_224 = " WHERE ";
  protected final String TEXT_225 = "\");" + NL + "" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_226 = " = conn_";
  protected final String TEXT_227 = ".prepareStatement(\"INSERT INTO \" + ";
  protected final String TEXT_228 = " + \" (";
  protected final String TEXT_229 = ") VALUES (";
  protected final String TEXT_230 = ")\");" + NL + "" + NL + "\t    ";
  protected final String TEXT_231 = NL + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_232 = " = conn_";
  protected final String TEXT_233 = ".prepareStatement(\"DELETE  FROM \" + ";
  protected final String TEXT_234 = " + \" WHERE ";
  protected final String TEXT_235 = "\");" + NL + "" + NL + "\t    ";
  protected final String TEXT_236 = NL + NL + "\t    int commitEvery_";
  protected final String TEXT_237 = " = ";
  protected final String TEXT_238 = ";" + NL + "" + NL + "\t    int commitCounter_";
  protected final String TEXT_239 = " = 0;" + NL + "" + NL + "\t";
  protected final String TEXT_240 = NL + "\t   int batchSize_";
  protected final String TEXT_241 = " = ";
  protected final String TEXT_242 = ";" + NL + "\t   int batchSizeCounter_";
