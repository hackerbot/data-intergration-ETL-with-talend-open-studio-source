...
public class TIngresOutputMainJava {
  protected static String nl;
  public static synchronized TIngresOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TIngresOutputMainJava result = new TIngresOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_47 = NL + "                commitEvery_";
  protected final String TEXT_48 = " = buffersSize_";
  protected final String TEXT_49 = ";";
  protected final String TEXT_50 = NL + "            batchSize_";
  protected final String TEXT_51 = " = buffersSize_";
  protected final String TEXT_52 = ";";
  protected final String TEXT_53 = NL + "        whetherReject_";
  protected final String TEXT_54 = " = false;";
  protected final String TEXT_55 = NL + "                    ";
  protected final String TEXT_56 = NL + "                        query_";
  protected final String TEXT_57 = " = ";
  protected final String TEXT_58 = ";";
  protected final String TEXT_59 = NL + "                globalMap.put(\"";
  protected final String TEXT_60 = "_QUERY\", query_";
  protected final String TEXT_61 = ".toString().trim());";
  protected final String TEXT_62 = NL;
  protected final String TEXT_63 = NL + "                      pstmt_";
  protected final String TEXT_64 = ".addBatch();" + NL + "                      batchSizeCounter_";
  protected final String TEXT_65 = "++;" + NL + "                      nb_line_";
  protected final String TEXT_66 = "++;";
  protected final String TEXT_67 = NL + "                      try {" + NL + "                          insertedCount_";
  protected final String TEXT_68 = " = insertedCount_";
  protected final String TEXT_69 = " + pstmt_";
  protected final String TEXT_70 = ".executeUpdate();" + NL + "                          nb_line_";
  protected final String TEXT_71 = "++;";
  protected final String TEXT_72 = NL + "                      } catch(java.lang.Exception e) {" + NL + "                          whetherReject_";
  protected final String TEXT_73 = " = true;";
  protected final String TEXT_74 = NL + "                              throw(e);";
  ...
  protected final String TEXT_83 = NL + "                                  rejectedCount_";
  protected final String TEXT_84 = " = rejectedCount_";
  ...
  protected final String TEXT_108 = "_QUERY\", query_";
  protected final String TEXT_109 = ".toString().trim());";
  protected final String TEXT_110 = NL;
  protected final String TEXT_111 = NL + "                      pstmt_";
  protected final String TEXT_112 = ".addBatch();" + NL + "                      batchSizeCounter_";
  protected final String TEXT_113 = "++;" + NL + "                      nb_line_";
  protected final String TEXT_114 = "++;";
  protected final String TEXT_115 = NL + "                      try {" + NL + "                          updatedCount_";
  protected final String TEXT_116 = " = updatedCount_";
  protected final String TEXT_117 = " + pstmt_";
  protected final String TEXT_118 = ".executeUpdate();" + NL + "                          nb_line_";
  protected final String TEXT_119 = "++;";
  protected final String TEXT_120 = NL + "                      } catch(java.lang.Exception e) {" + NL + "                          whetherReject_";
  ...
  protected final String TEXT_131 = NL + "                                  rejectedCount_";
  protected final String TEXT_132 = " = rejectedCount_";
  protected final String TEXT_133 = " + 1;";
  protected final String TEXT_134 = NL + "                                  ";
  protected final String TEXT_135 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_144 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_145 = " = pstmt_";
  protected final String TEXT_146 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_147 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_148 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_149 = " = rs_";
  protected final String TEXT_150 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_151 = " > 0) {";
  protected final String TEXT_152 = NL + "                        ";
  protected final String TEXT_153 = NL + "                            query_";
  protected final String TEXT_154 = " = ";
  protected final String TEXT_155 = ";";
  protected final String TEXT_156 = NL + "                            ";
  protected final String TEXT_157 = NL + "                            query_";
  ...
  protected final String TEXT_165 = "_QUERY\", query_";
  protected final String TEXT_166 = ".toString().trim());";
  protected final String TEXT_167 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_168 = " = updatedCount_";
  protected final String TEXT_169 = " + pstmtUpdate_";
  protected final String TEXT_170 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_171 = "++;";
  protected final String TEXT_172 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_185 = NL + "                            rejectedCount_";
  protected final String TEXT_186 = " = rejectedCount_";
  protected final String TEXT_187 = " + 1;";
  protected final String TEXT_188 = NL + "                            ";
  protected final String TEXT_189 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_190 = NL + "                            ";
  protected final String TEXT_191 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_192 = ";";
  protected final String TEXT_193 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_194 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_195 = NL + "                        ";
  protected final String TEXT_196 = NL + "                            query_";
  protected final String TEXT_197 = " = ";
  protected final String TEXT_198 = ";";
  protected final String TEXT_199 = NL + "                    globalMap.put(\"";
  protected final String TEXT_200 = "_QUERY\", query_";
  protected final String TEXT_201 = ".toString().trim());";
  protected final String TEXT_202 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_203 = " = insertedCount_";
  protected final String TEXT_204 = " + pstmtInsert_";
  protected final String TEXT_205 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_206 = "++;";
  protected final String TEXT_207 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_208 = " = true;";
  protected final String TEXT_209 = NL + "                        throw(e);";
  ...
  protected final String TEXT_220 = NL + "                            rejectedCount_";
  protected final String TEXT_221 = " = rejectedCount_";
  protected final String TEXT_222 = " + 1;";
  protected final String TEXT_223 = NL + "                            ";
  protected final String TEXT_224 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_225 = NL + "                            ";
  protected final String TEXT_226 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_227 = ";";
  protected final String TEXT_228 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_229 = NL + "                }" + NL + "            }";
  protected final String TEXT_230 = NL + "            int updateFlag_";
  protected final String TEXT_231 = "=0;";
  protected final String TEXT_232 = NL + "                    ";
  protected final String TEXT_233 = NL + "                        query_";
  protected final String TEXT_234 = " = ";
  protected final String TEXT_235 = ";";
  protected final String TEXT_236 = NL + "                        ";
  protected final String TEXT_237 = NL + "                            query_";
  ...
  protected final String TEXT_246 = "_QUERY\", query_";
  protected final String TEXT_247 = ".toString().trim());";
  protected final String TEXT_248 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_249 = "=pstmtUpdate_";
  protected final String TEXT_250 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_251 = " = updatedCount_";
  protected final String TEXT_252 = " + updateFlag_";
  protected final String TEXT_253 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_254 = " == 0) {";
  protected final String TEXT_255 = NL + "                query_";
  protected final String TEXT_256 = " = new StringBuffer(\"\");";
  protected final String TEXT_257 = NL + "                        ";
  protected final String TEXT_258 = NL + "                            query_";
  protected final String TEXT_259 = " = ";
  protected final String TEXT_260 = ";";
  protected final String TEXT_261 = NL + "                    globalMap.put(\"";
  protected final String TEXT_262 = "_QUERY\", query_";
  protected final String TEXT_263 = ".toString().trim());";
  protected final String TEXT_264 = NL + "                    insertedCount_";
  protected final String TEXT_265 = " = insertedCount_";
  protected final String TEXT_266 = " + pstmtInsert_";
  protected final String TEXT_267 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_268 = "++;";
  protected final String TEXT_269 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_270 = "++;";
  protected final String TEXT_271 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_284 = NL + "                            rejectedCount_";
  protected final String TEXT_285 = " = rejectedCount_";
  protected final String TEXT_286 = " + 1;";
  protected final String TEXT_287 = NL + "                            ";
  protected final String TEXT_288 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_289 = NL + "                            ";
  protected final String TEXT_290 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_291 = ";";
  protected final String TEXT_292 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_293 = NL + "                }" + NL;
  protected final String TEXT_294 = NL + "                        ";
  protected final String TEXT_295 = NL + "                            query_";
  protected final String TEXT_296 = " = ";
  protected final String TEXT_297 = ";";
  protected final String TEXT_298 = NL + "                    ";
  protected final String TEXT_299 = NL + "                        query_";
  protected final String TEXT_300 = " = ";
  protected final String TEXT_301 = ";";
  protected final String TEXT_302 = NL + "                globalMap.put(\"";
  protected final String TEXT_303 = "_QUERY\", query_";
  protected final String TEXT_304 = ".toString().trim());";
  protected final String TEXT_305 = NL;
  protected final String TEXT_306 = NL + "                       pstmt_";
  protected final String TEXT_307 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_308 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_309 = "++;";
  protected final String TEXT_310 = NL + "                       try {" + NL + "                           deletedCount_";
  protected final String TEXT_311 = " = deletedCount_";
  protected final String TEXT_312 = " + pstmt_";
  protected final String TEXT_313 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_314 = "++;";
  protected final String TEXT_315 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  protected final String TEXT_316 = " = true;";
  protected final String TEXT_317 = NL + "                               throw(e);";
  protected final String TEXT_318 = NL + "                               nb_line_";
  ...
  protected final String TEXT_328 = NL + "                                   rejectedCount_";
  protected final String TEXT_329 = " = rejectedCount_";
  protected final String TEXT_330 = " + 1;";
  protected final String TEXT_331 = NL + "                                   ";
  protected final String TEXT_332 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_333 = NL + "                                   ";
  protected final String TEXT_334 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_335 = ";";
  protected final String TEXT_336 = NL + "                                   System.err.print(e.getMessage());";
  protected final String TEXT_337 = NL + "                       }";
  protected final String TEXT_338 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_349 = NL + "                if ((batchSize_";
  protected final String TEXT_350 = " > 0) && (batchSize_";
  protected final String TEXT_351 = " <= batchSizeCounter_";
  protected final String TEXT_352 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_353 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_354 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_355 = " = 0;";
  protected final String TEXT_356 = NL + "                        status_";
  protected final String TEXT_357 = " = pstmt_";
  protected final String TEXT_358 = ".executeBatch();";
  protected final String TEXT_359 = NL + "                        for(int countEach_";
  protected final String TEXT_360 = ": status_";
  protected final String TEXT_361 = ") {" + NL + "                            countSum_";
  protected final String TEXT_362 = " += (countEach_";
  protected final String TEXT_363 = " < 0 ? 0 : countEach_";
  protected final String TEXT_364 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_365 = NL + "                            throw(e);";
  protected final String TEXT_366 = NL + "                        for(int countEach_";
  protected final String TEXT_367 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_368 = " += (countEach_";
  protected final String TEXT_369 = " < 0 ? 0 : countEach_";
  protected final String TEXT_370 = ");" + NL + "                        }";
  protected final String TEXT_371 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_372 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_373 = " = pstmt_";
  protected final String TEXT_374 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_375 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_376 = " = tmp_batchUpdateCount_";
  protected final String TEXT_377 = " > countSum_";
  protected final String TEXT_378 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_379 = " : countSum_";
  protected final String TEXT_380 = ";";
  protected final String TEXT_381 = NL + "                        insertedCount_";
  protected final String TEXT_382 = " += tmp_batchUpdateCount_";
  protected final String TEXT_383 = ";";
  protected final String TEXT_384 = NL + "                        updatedCount_";
  protected final String TEXT_385 = " += tmp_batchUpdateCount_";
  protected final String TEXT_386 = ";";
  protected final String TEXT_387 = NL + "                        deletedCount_";
  protected final String TEXT_388 = " += tmp_batchUpdateCount_";
  protected final String TEXT_389 = ";";
  protected final String TEXT_390 = NL + "               }";
  protected final String TEXT_391 = NL + "                commitCounter_";
  protected final String TEXT_392 = "++;" + NL + "" + NL + "                if(commitEvery_";
  protected final String TEXT_393 = " <= commitCounter_";
  protected final String TEXT_394 = ") {";
  protected final String TEXT_395 = NL + "                                      if(batchSize_";
  protected final String TEXT_396 = " > 0){";
  protected final String TEXT_397 = NL + "                                            conn_";
  protected final String TEXT_398 = ".commit();";
  protected final String TEXT_399 = NL + "                                            commitCounter_";
  protected final String TEXT_400 = "=0;" + NL + "                                      }";
  protected final String TEXT_401 = NL + "                               conn_";
  protected final String TEXT_402 = ".commit();";
  protected final String TEXT_403 = NL + "                               commitCounter_";
