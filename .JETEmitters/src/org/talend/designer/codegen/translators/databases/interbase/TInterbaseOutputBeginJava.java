...
public class TInterbaseOutputBeginJava {
  protected static String nl;
  public static synchronized TInterbaseOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInterbaseOutputBeginJava result = new TInterbaseOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_75 = NL + "    java.lang.Class.forName(\"";
  protected final String TEXT_76 = "\");";
  protected final String TEXT_77 = NL + "    String url_";
  protected final String TEXT_78 = " = \"jdbc:interbase://\" + ";
  ...
  protected final String TEXT_94 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_95 = ",dbUser_";
  protected final String TEXT_96 = ",dbPwd_";
  protected final String TEXT_97 = ");";
  protected final String TEXT_98 = NL + "    resourceMap.put(\"conn_";
  protected final String TEXT_99 = "\", conn_";
  protected final String TEXT_100 = ");";
  protected final String TEXT_101 = NL + "        conn_";
  protected final String TEXT_102 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_103 = " = ";
  protected final String TEXT_104 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_105 = " = 0;";
  protected final String TEXT_106 = NL;
  protected final String TEXT_107 = NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_108 = " = conn_";
  protected final String TEXT_109 = ".createStatement();";
  ...
  protected final String TEXT_115 = ".createStatement();";
  protected final String TEXT_116 = NL + "            stmtCreate_";
  protected final String TEXT_117 = ".execute(\"";
  ...
  protected final String TEXT_129 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_130 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_131 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_132 = " = rsTable_";
  protected final String TEXT_133 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_134 = ".equalsIgnoreCase(";
  protected final String TEXT_135 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_136 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_146 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_152 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_153 = " = conn_";
  protected final String TEXT_154 = ".createStatement();";
  protected final String TEXT_155 = NL + "                stmtCreate_";
  protected final String TEXT_156 = ".execute(\"";
  protected final String TEXT_157 = ")\");";
  protected final String TEXT_158 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_159 = " = conn_";
  protected final String TEXT_160 = ".createStatement();";
  protected final String TEXT_161 = NL + "            deletedCount_";
  protected final String TEXT_162 = " = deletedCount_";
  protected final String TEXT_163 = " + stmtClear_";
  protected final String TEXT_164 = ".executeUpdate(\"";
  protected final String TEXT_165 = "\");";
  protected final String TEXT_166 = NL + "\t    String insert_";
  protected final String TEXT_167 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_168 = " + \"\\\" (";
  protected final String TEXT_169 = ") VALUES (";
  protected final String TEXT_170 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_171 = " = conn_";
  protected final String TEXT_172 = ".prepareStatement(insert_";
  protected final String TEXT_173 = ");" + NL + "\t    ";
  protected final String TEXT_174 = NL + "\t    String update_";
  protected final String TEXT_175 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_176 = " + \"\\\" SET ";
  protected final String TEXT_177 = " WHERE ";
  protected final String TEXT_178 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_179 = " = conn_";
  protected final String TEXT_180 = ".prepareStatement(update_";
  protected final String TEXT_181 = ");" + NL + "\t    ";
  protected final String TEXT_182 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_183 = " = conn_";
  protected final String TEXT_184 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + ";
  protected final String TEXT_185 = " + \"\\\" WHERE ";
  protected final String TEXT_186 = "\");" + NL + "\t    String update_";
  protected final String TEXT_187 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_188 = " + \"\\\" SET ";
  protected final String TEXT_189 = " WHERE ";
  protected final String TEXT_190 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_191 = " = conn_";
  protected final String TEXT_192 = ".prepareStatement(update_";
  ...
  protected final String TEXT_201 = NL + "\t    String update_";
  protected final String TEXT_202 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_203 = " + \"\\\" SET ";
  protected final String TEXT_204 = " WHERE ";
  protected final String TEXT_205 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_206 = " = conn_";
  protected final String TEXT_207 = ".prepareStatement(update_";
  protected final String TEXT_208 = ");" + NL + "\t    String insert_";
  protected final String TEXT_209 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_210 = " + \"\\\" (";
  protected final String TEXT_211 = ") VALUES (";
  protected final String TEXT_212 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_213 = " = conn_";
  protected final String TEXT_214 = ".prepareStatement(insert_";
  protected final String TEXT_215 = ");" + NL + "\t    ";
  protected final String TEXT_216 = NL + "\t    String delete_";
  protected final String TEXT_217 = " = \"DELETE  FROM \\\"\" + ";
  protected final String TEXT_218 = " + \"\\\" WHERE ";
  protected final String TEXT_219 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_220 = " = conn_";
  protected final String TEXT_221 = ".prepareStatement(delete_";
  protected final String TEXT_222 = ");" + NL + "\t    ";
  protected final String TEXT_223 = NL + "        StringBuffer query_";
  protected final String TEXT_224 = " = null;" + NL + "       \t";
  protected final String TEXT_225 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_226 = " = insert_";
  protected final String TEXT_227 = ".split(\"\\\\?\");";
  protected final String TEXT_228 = NL + "\t\t\tupdate_";
  protected final String TEXT_229 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_230 = " = update_";
  protected final String TEXT_231 = ".split(\"\\\\?\");";
  protected final String TEXT_232 = NL + "\t\t\tupdate_";
  protected final String TEXT_233 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_234 = " = update_";
  protected final String TEXT_235 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_236 = " = insert_";
  protected final String TEXT_237 = ".split(\"\\\\?\");";
  protected final String TEXT_238 = NL + "\t\t\tdelete_";
  protected final String TEXT_239 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_240 = " = delete_";
  protected final String TEXT_241 = ".split(\"\\\\?\");";
  protected final String TEXT_242 = NL + "\t\t\treplace_";
  protected final String TEXT_243 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_244 = " = replace_";
  protected final String TEXT_245 = ".split(\"\\\\?\");";
  protected final String TEXT_246 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_247 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_248 = " = insertIgnore_";
  protected final String TEXT_249 = ".split(\"\\\\?\");";
  protected final String TEXT_250 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_251 = " = insert_";
