...
public class TMSSqlInputBeginJava
{
  ...
  protected final String TEXT_183 = NL + "\t\t\torg.talend.designer.components.util.mssql.MSSqlGenerateTimestampUtil mssqlGTU_";
  protected final String TEXT_184 = " = org.talend.designer.components.util.mssql.MSSqlUtilFactory.getMSSqlGenerateTimestampUtil();" + NL + "\t\t\t" + NL + "\t\t\tjava.util.List<String> talendToDBList_";
  protected final String TEXT_185 = " = new java.util.ArrayList();" + NL + "\t\t\tString[] talendToDBArray_";
  protected final String TEXT_186 = "  = new String[]{\"FLOAT\",\"NUMERIC\",\"NUMERIC IDENTITY\",\"DECIMAL\",\"DECIMAL IDENTITY\",\"REAL\"}; " + NL + "\t\t\tjava.util.Collections.addAll(talendToDBList_";
  protected final String TEXT_187 = ", talendToDBArray_";
  protected final String TEXT_188 = "); ";
  protected final String TEXT_189 = NL + "\t\t\tString dbschema_";
  protected final String TEXT_190 = " = (String)globalMap.get(\"";
  protected final String TEXT_191 = "\");";
  protected final String TEXT_192 = NL + "\t\t    String port_";
  protected final String TEXT_193 = " = ";
  protected final String TEXT_194 = ";" + NL + "\t\t    String dbname_";
  protected final String TEXT_195 = " = ";
  protected final String TEXT_196 = " ;" + NL + "\t\t    String url_";
  protected final String TEXT_197 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_198 = " ; " + NL + "\t\t    if (!\"\".equals(port_";
  protected final String TEXT_199 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_200 = " += \":\" + ";
  protected final String TEXT_201 = ";" + NL + "\t\t    }" + NL + "\t\t    if (!\"\".equals(dbname_";
  protected final String TEXT_202 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_203 = " += \"//\" + ";
  protected final String TEXT_204 = "; " + NL + "\t\t    }" + NL + "\t\t    url_";
  protected final String TEXT_205 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_206 = ";" + NL + "\t\t    String dbschema_";
  protected final String TEXT_207 = " = ";
  protected final String TEXT_208 = ";";
  protected final String TEXT_209 = NL + "\t\t\t";
  protected final String TEXT_210 = ".";
  protected final String TEXT_211 = " = mssqlGTU_";
  protected final String TEXT_212 = ".getDate(rsmd_";
  protected final String TEXT_213 = ", rs_";
  protected final String TEXT_214 = ", ";
  protected final String TEXT_215 = "column_index_";
  protected final String TEXT_216 = ");" + NL + "\t\t\t";
  protected final String TEXT_217 = NL + "\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_218 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_219 = ".getClob(";
  protected final String TEXT_220 = ");" + NL + "\t\t\t\tif(clob_";
  protected final String TEXT_221 = "!=null){" + NL + "\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_222 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_223 = ");" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_224 = " = tNTextImpl_";
  protected final String TEXT_225 = ".getValue();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_226 = " = null;\t\t\t\t" + NL + "\t\t\t\t}";
  protected final String TEXT_227 = NL + "           \t\ttmpContent_";
  ...
  protected final String TEXT_232 = NL + "            if(tmpContent_";
  protected final String TEXT_233 = " != null) {" + NL + "            \tif (talendToDBList_";
  protected final String TEXT_234 = " .contains(rsmd_";
  protected final String TEXT_235 = ".getColumnTypeName(";
  protected final String TEXT_236 = "column_index_";
  protected final String TEXT_237 = ").toUpperCase(java.util.Locale.ENGLISH))) {" + NL + "            \t\t";
  protected final String TEXT_238 = ".";
  protected final String TEXT_239 = " = FormatterUtils.formatUnwithE(tmpContent_";
  protected final String TEXT_240 = ");" + NL + "            \t} else {" + NL + "                \t";
  protected final String TEXT_241 = ".";
  protected final String TEXT_242 = " = tmpContent_";
  protected final String TEXT_243 = ";" + NL + "                }" + NL + "            } else {";
  protected final String TEXT_244 = NL + "                ";
  protected final String TEXT_245 = ".";
  protected final String TEXT_246 = " = null;" + NL + "            }";
  protected final String TEXT_247 = NL + "    " + NL + "\t";
  protected final String TEXT_248 = NL + "\t\t    int nb_line_";
  protected final String TEXT_249 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_250 = " = null;";
  protected final String TEXT_251 = NL + "\t\t        conn_";
  protected final String TEXT_252 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_253 = "\");";
  protected final String TEXT_254 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_255 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_256 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_257 = " = dataSources_";
  protected final String TEXT_258 = ".get(";
  protected final String TEXT_259 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_260 = "\", conn_";
  protected final String TEXT_261 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_262 = NL + "\t\t\t\t";
  protected final String TEXT_263 = NL + "\t\t\t\t";
  protected final String TEXT_264 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_265 = " =  conn_";
  protected final String TEXT_266 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_267 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_268 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_269 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_270 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_271 = NL + "                 conn_";
  protected final String TEXT_272 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_273 = NL + "               ";
  protected final String TEXT_274 = " + \"=\" + ";
  protected final String TEXT_275 = " + \";\" +";
  protected final String TEXT_276 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_277 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_278 = ");";
  protected final String TEXT_279 = NL + "\t\t    ";
  protected final String TEXT_280 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_281 = " = ";
  protected final String TEXT_282 = ";" + NL + "\t\t\t";
  protected final String TEXT_283 = NL + "                log.info(\"";
  protected final String TEXT_284 = " - Executing the query: '\"+dbquery_";
  ...
  protected final String TEXT_291 = "_QUERY\",dbquery_";
  protected final String TEXT_292 = ");";
  protected final String TEXT_293 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_294 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_295 = " = stmt_";
  protected final String TEXT_296 = ".executeQuery(dbquery_";
  protected final String TEXT_297 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_298 = " = rs_";
  protected final String TEXT_299 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_300 = " = rsmd_";
  protected final String TEXT_301 = ".getColumnCount();" + NL;
  protected final String TEXT_302 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_303 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_304 = ".setDbmsId(\"";
  protected final String TEXT_305 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_306 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_307 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_308 = ".add(\"";
  protected final String TEXT_309 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_310 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_311 = " = ";
  protected final String TEXT_312 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_313 = "; i <= rsmd_";
  protected final String TEXT_314 = ".getColumnCount()-";
  protected final String TEXT_315 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_316 = ".contains(rsmd_";
  protected final String TEXT_317 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_318 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_319 = ".setName(rsmd_";
  protected final String TEXT_320 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_321 = ".setDbName(rsmd_";
  protected final String TEXT_322 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_323 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_324 = "\", rsmd_";
  protected final String TEXT_325 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_326 = ".getPrecision(i), rsmd_";
  protected final String TEXT_327 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_328 = ".setDbType(rsmd_";
  protected final String TEXT_329 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_330 = ".setDbTypeId(rsmd_";
  protected final String TEXT_331 = ".getColumnType(i));";
  protected final String TEXT_332 = NL + "                \tdcm_";
  protected final String TEXT_333 = ".setFormat(";
  protected final String TEXT_334 = ");";
  protected final String TEXT_335 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_336 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_337 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_338 = ".setLength(rsmd_";
  protected final String TEXT_339 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_340 = ".setLength(rsmd_";
  protected final String TEXT_341 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_342 = NL + "\t\t\tdcm_";
  protected final String TEXT_343 = ".setLength(rsmd_";
  protected final String TEXT_344 = ".getPrecision(i));";
  protected final String TEXT_345 = NL + "                \tdcm_";
  protected final String TEXT_346 = ".setPrecision(rsmd_";
  protected final String TEXT_347 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_348 = ".setNullable(rsmd_";
  protected final String TEXT_349 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_350 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_351 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_352 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_353 = ".metadatas.add(dcm_";
  protected final String TEXT_354 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_355 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_356 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_357 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_358 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_359 = NL + "\t\t    ";
  protected final String TEXT_360 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_361 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_362 = NL + "\t\t    while (rs_";
  protected final String TEXT_363 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_364 = "++;" + NL + "\t\t        ";
  protected final String TEXT_365 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_366 = " = ";
  protected final String TEXT_367 = " + dcg_";
  protected final String TEXT_368 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_369 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_370 = " = ";
  protected final String TEXT_371 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_372 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_373 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_385 = " = (List)rs_";
  protected final String TEXT_386 = ".getObject(";
  protected final String TEXT_387 = "column_index_";
  protected final String TEXT_388 = ");";
  protected final String TEXT_389 = NL + "\t\t                         ";
  protected final String TEXT_390 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_391 = ".getObject(";
  protected final String TEXT_392 = "column_index_";
  protected final String TEXT_393 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_394 = NL + "                                    ";
  protected final String TEXT_395 = ".";
  protected final String TEXT_396 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_405 = ".setEPSG(";
  protected final String TEXT_406 = ");" + NL + "                                        }";
  protected final String TEXT_407 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_408 = NL + "                                  ";
  protected final String TEXT_409 = ".";
  protected final String TEXT_410 = "=dcg_";
  protected final String TEXT_411 = ";";
  protected final String TEXT_412 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_413 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_414 = " = ";
  protected final String TEXT_415 = "; i_";
  protected final String TEXT_416 = "  <= rsmd_";
  protected final String TEXT_417 = ".getColumnCount(); i_";
  ...
  protected final String TEXT_429 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_430 = ".";
  protected final String TEXT_431 = ", rs_";
  protected final String TEXT_432 = ", fixedColumnCount_";
  protected final String TEXT_433 = ",list_";
  protected final String TEXT_434 = ",";
  protected final String TEXT_435 = ");";
  protected final String TEXT_436 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_437 = ".";
  protected final String TEXT_438 = ", rs_";
  protected final String TEXT_439 = ", fixedColumnCount_";
  protected final String TEXT_440 = ",";
  protected final String TEXT_441 = ");";
  protected final String TEXT_442 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_443 = ".";
  protected final String TEXT_444 = ", rs_";
  protected final String TEXT_445 = ", fixedColumnCount_";
  protected final String TEXT_446 = ",";
  protected final String TEXT_447 = ");";
  protected final String TEXT_448 = NL + "                                  Object geom = rs_";
  protected final String TEXT_449 = ".getObject(";
  protected final String TEXT_450 = "column_index_";
  protected final String TEXT_451 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_452 = ".";
  protected final String TEXT_453 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_454 = ".";
  protected final String TEXT_455 = " = null;" + NL + "                                  }";
  protected final String TEXT_456 = NL + "\t\t                          ";
  protected final String TEXT_457 = NL + "\t\t                    }";
  protected final String TEXT_458 = NL + "\t\t\t\t\t";
  protected final String TEXT_459 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_460 = " - Retrieving the record \" + nb_line_";
  ...
  protected final String TEXT_467 = NL + NL + NL + NL;
  ...
  public String generate(Object argument)
  {
    ...
    stringBuffer.append(TEXT_216);
		...
		public void generateStringResultSet(String firstConnName, IMetadataColumn column, int currentColNo, String trimMethod) {
			if("NTEXT".equalsIgnoreCase(column.getType())){
