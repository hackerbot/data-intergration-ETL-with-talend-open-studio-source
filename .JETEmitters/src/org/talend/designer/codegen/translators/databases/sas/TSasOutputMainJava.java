...
public class TSasOutputMainJava {
  protected static String nl;
  public static synchronized TSasOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSasOutputMainJava result = new TSasOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_52 = NL + "                        query_";
  protected final String TEXT_53 = " = ";
  protected final String TEXT_54 = ";";
  protected final String TEXT_55 = NL + "                globalMap.put(\"";
  protected final String TEXT_56 = "_QUERY\", query_";
  protected final String TEXT_57 = ".toString().trim());";
  ...
  protected final String TEXT_74 = NL + "                        nb_line_rejected_";
  protected final String TEXT_75 = "++;";
  protected final String TEXT_76 = NL + "                        ";
  protected final String TEXT_77 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_91 = "_QUERY\", query_";
  protected final String TEXT_92 = ".toString().trim());";
  protected final String TEXT_93 = NL + "            try {" + NL + "                updatedCount_";
  ...
  protected final String TEXT_99 = " = true;";
  ...
  protected final String TEXT_112 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_135 = "_QUERY\", query_";
  protected final String TEXT_136 = ".toString().trim());";
  protected final String TEXT_137 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_138 = " = updatedCount_";
  protected final String TEXT_139 = " + pstmtUpdate_";
  protected final String TEXT_140 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_141 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_142 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_143 = " = true;";
  ...
  protected final String TEXT_155 = NL + "                       \t \tnb_line_rejected_";
  protected final String TEXT_156 = "++;";
  protected final String TEXT_157 = NL + "                            ";
  protected final String TEXT_158 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_159 = NL + "                            ";
  protected final String TEXT_160 = ".errorMessage = e.getMessage();";
  protected final String TEXT_161 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_168 = "_QUERY\", query_";
  protected final String TEXT_169 = ".toString().trim());";
  ...
  protected final String TEXT_175 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_188 = NL + "                        \tnb_line_rejected_";
  protected final String TEXT_189 = "++;";
  protected final String TEXT_190 = NL + "                            ";
  protected final String TEXT_191 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_192 = NL + "                            ";
  protected final String TEXT_193 = ".errorMessage = e.getMessage();";
  protected final String TEXT_194 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_195 = NL + "                }" + NL + "            }";
  protected final String TEXT_196 = NL + "            int updateFlag_";
  protected final String TEXT_197 = "=0;";
  protected final String TEXT_198 = NL + "                    ";
  protected final String TEXT_199 = NL + "                        query_";
  protected final String TEXT_200 = " = ";
  protected final String TEXT_201 = ";";
  protected final String TEXT_202 = NL + "                    ";
  protected final String TEXT_203 = NL + "                        query_";
  protected final String TEXT_204 = " = ";
  protected final String TEXT_205 = ";";
  protected final String TEXT_206 = NL + "                globalMap.put(\"";
  protected final String TEXT_207 = "_QUERY\", query_";
  protected final String TEXT_208 = ".toString().trim());";
  protected final String TEXT_209 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_210 = " = pstmtUpdate_";
  protected final String TEXT_211 = ".executeUpdate();" + NL + "                if(updateFlag_";
  protected final String TEXT_212 = " != 0) {" + NL + "            \t\tnb_line_";
  protected final String TEXT_213 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_214 = NL + "                }" + NL + "                updatedCount_";
  protected final String TEXT_215 = " = updatedCount_";
  protected final String TEXT_216 = " + updateFlag_";
  protected final String TEXT_217 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_218 = " = true;";
  protected final String TEXT_219 = NL + "                    throw(e);";
  protected final String TEXT_220 = NL + "                        ";
  protected final String TEXT_221 = " = new ";
  protected final String TEXT_222 = "Struct();";
  protected final String TEXT_223 = NL + "                            ";
  protected final String TEXT_224 = ".";
  protected final String TEXT_225 = " = ";
  protected final String TEXT_226 = ".";
  protected final String TEXT_227 = ";";
  protected final String TEXT_228 = NL + "                        nb_line_rejected_";
  protected final String TEXT_229 = "++;";
  protected final String TEXT_230 = NL + "                        ";
  protected final String TEXT_231 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_232 = NL + "                        ";
  protected final String TEXT_233 = ".errorMessage = e.getMessage();";
  protected final String TEXT_234 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_235 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_236 = " == 0) {" + NL + "            \t";
  protected final String TEXT_237 = NL + "\t\t\t\tquery_";
  protected final String TEXT_238 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_239 = NL + "                        ";
  protected final String TEXT_240 = NL + "                            query_";
  protected final String TEXT_241 = " = ";
  protected final String TEXT_242 = ";";
  protected final String TEXT_243 = NL + "                    globalMap.put(\"";
  protected final String TEXT_244 = "_QUERY\", query_";
  protected final String TEXT_245 = ".toString().trim());";
  protected final String TEXT_246 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_247 = " = insertedCount_";
  protected final String TEXT_248 = " + pstmtInsert_";
  protected final String TEXT_249 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_250 = "++;" + NL + "                \t";
  protected final String TEXT_251 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_252 = " = true;";
  protected final String TEXT_253 = NL + "                        throw(e);";
  ...
  protected final String TEXT_264 = NL + "                            nb_line_rejected_";
  protected final String TEXT_265 = "++;";
  protected final String TEXT_266 = NL + "                            ";
  protected final String TEXT_267 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_268 = NL + "                            ";
  protected final String TEXT_269 = ".errorMessage = e.getMessage();";
  protected final String TEXT_270 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_279 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_280 = " = deletedCount_";
  protected final String TEXT_281 = " + pstmt_";
  ...
  protected final String TEXT_302 = ".errorMessage = e.getMessage();";
  protected final String TEXT_303 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_304 = NL + "            }";
  protected final String TEXT_305 = NL + "            if(!whetherReject_";
  protected final String TEXT_306 = ") {";
  protected final String TEXT_307 = NL + "                            ";
  protected final String TEXT_308 = " = new ";
  protected final String TEXT_309 = "Struct();";
  ...
  protected final String TEXT_316 = NL + "                commitCounter_";
  protected final String TEXT_317 = "++;            " + NL + "                if (commitEvery_";
  protected final String TEXT_318 = " <= commitCounter_";
  protected final String TEXT_319 = ") {" + NL + "    \t\t\t\t";
  protected final String TEXT_320 = NL + "                    connection_";
  protected final String TEXT_321 = ".commit();";
  protected final String TEXT_322 = " " + NL + "                    commitCounter_";
  protected final String TEXT_323 = "=0;" + NL + "                }    ";
