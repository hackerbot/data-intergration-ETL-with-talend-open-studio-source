...
public class TNetezzaInputBeginJava
{
  ...
  protected final String TEXT_184 = " = \"jdbc:netezza://\" + ";
  ...
  protected final String TEXT_191 = NL + "\t\t\tif(rs_";
  protected final String TEXT_192 = ".get";
  protected final String TEXT_193 = "(";
  protected final String TEXT_194 = "column_index_";
  protected final String TEXT_195 = ") != null) {" + NL + "\t\t\t\t";
  protected final String TEXT_196 = ".";
  protected final String TEXT_197 = " = new java.util.Date(rs_";
  protected final String TEXT_198 = ".get";
  protected final String TEXT_199 = "(";
  protected final String TEXT_200 = "column_index_";
  protected final String TEXT_201 = ").getTime());" + NL + "\t\t\t} else {" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_206 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_207 = " = null;";
  protected final String TEXT_208 = NL + "\t\t        conn_";
  protected final String TEXT_209 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_210 = "\");";
  protected final String TEXT_211 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_212 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_213 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_214 = " = dataSources_";
  protected final String TEXT_215 = ".get(";
  protected final String TEXT_216 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  ...
  protected final String TEXT_250 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_251 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  ...
  protected final String TEXT_279 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_347 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_348 = ".getObject(";
  protected final String TEXT_349 = "column_index_";
  protected final String TEXT_350 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_351 = NL + "                                    ";
  protected final String TEXT_352 = ".";
  protected final String TEXT_353 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_362 = ".setEPSG(";
  ...
  protected final String TEXT_369 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_370 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_371 = " = ";
  protected final String TEXT_372 = "; i_";
  protected final String TEXT_373 = "  <= rsmd_";
  protected final String TEXT_374 = ".getColumnCount(); i_";
  protected final String TEXT_375 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_376 = ".getColumnTypeName(i_";
  protected final String TEXT_377 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_378 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_379 = ".getClob(i_";
  protected final String TEXT_380 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_381 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_382 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_383 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_384 = ".add(tNTextImpl_";
  protected final String TEXT_385 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_386 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_387 = ".";
  protected final String TEXT_388 = ", rs_";
  protected final String TEXT_389 = ", fixedColumnCount_";
  protected final String TEXT_390 = ",list_";
  protected final String TEXT_391 = ",";
  protected final String TEXT_392 = ");";
  protected final String TEXT_393 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_394 = ".";
  protected final String TEXT_395 = ", rs_";
  protected final String TEXT_396 = ", fixedColumnCount_";
  ...
  protected final String TEXT_405 = NL + "                                  Object geom = rs_";
  protected final String TEXT_406 = ".getObject(";
  protected final String TEXT_407 = "column_index_";
  protected final String TEXT_408 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_409 = ".";
  protected final String TEXT_410 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_417 = " - Retrieving the record \" + nb_line_";
