...
public class TMaxDBInputBeginJava
{
  protected static String nl;
  public static synchronized TMaxDBInputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMaxDBInputBeginJava result = new TMaxDBInputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_184 = " = \"jdbc:sapdb://\"+";
  protected final String TEXT_185 = "+\":\"+";
  protected final String TEXT_186 = "+\"/\" + ";
  protected final String TEXT_187 = ";";
  protected final String TEXT_188 = NL + "    " + NL + "\t";
  protected final String TEXT_189 = NL + "\t\t    int nb_line_";
  protected final String TEXT_190 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_191 = " = null;";
  protected final String TEXT_192 = NL + "\t\t        conn_";
  protected final String TEXT_193 = " = (java.sql.Connection)globalMap.get(\"";
  ...
  protected final String TEXT_197 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_198 = " = dataSources_";
  protected final String TEXT_199 = ".get(";
  protected final String TEXT_200 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_201 = "\", conn_";
  protected final String TEXT_202 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_203 = NL + "\t\t\t\t";
  protected final String TEXT_204 = NL + "\t\t\t\t";
  protected final String TEXT_205 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_206 = " =  conn_";
  protected final String TEXT_207 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_208 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_209 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_210 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_211 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_212 = NL + "                 conn_";
  protected final String TEXT_213 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_214 = NL + "               ";
  protected final String TEXT_215 = " + \"=\" + ";
  protected final String TEXT_216 = " + \";\" +";
  protected final String TEXT_217 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_218 = ".setAutoCommit(currentAutoCommitMode";
  ...
  protected final String TEXT_225 = " - Executing the query: '\"+dbquery_";
  ...
  protected final String TEXT_234 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_235 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_236 = " = stmt_";
  protected final String TEXT_237 = ".executeQuery(dbquery_";
  protected final String TEXT_238 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_239 = " = rs_";
  protected final String TEXT_240 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_241 = " = rsmd_";
  protected final String TEXT_242 = ".getColumnCount();" + NL;
  protected final String TEXT_243 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_244 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_245 = ".setDbmsId(\"";
  protected final String TEXT_246 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_247 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_248 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_249 = ".add(\"";
  protected final String TEXT_250 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_251 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_252 = " = ";
  protected final String TEXT_253 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_254 = "; i <= rsmd_";
  protected final String TEXT_255 = ".getColumnCount()-";
  protected final String TEXT_256 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_257 = ".contains(rsmd_";
  protected final String TEXT_258 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_259 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_260 = ".setName(rsmd_";
  protected final String TEXT_261 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_262 = ".setDbName(rsmd_";
  protected final String TEXT_263 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_264 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_265 = "\", rsmd_";
  protected final String TEXT_266 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_267 = ".getPrecision(i), rsmd_";
  protected final String TEXT_268 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_269 = ".setDbType(rsmd_";
  protected final String TEXT_270 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_271 = ".setDbTypeId(rsmd_";
  protected final String TEXT_272 = ".getColumnType(i));";
  protected final String TEXT_273 = NL + "                \tdcm_";
  protected final String TEXT_274 = ".setFormat(";
  protected final String TEXT_275 = ");";
  protected final String TEXT_276 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_277 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_278 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_279 = ".setLength(rsmd_";
  protected final String TEXT_280 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_281 = ".setLength(rsmd_";
  protected final String TEXT_282 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_283 = NL + "\t\t\tdcm_";
  protected final String TEXT_284 = ".setLength(rsmd_";
  protected final String TEXT_285 = ".getPrecision(i));";
  protected final String TEXT_286 = NL + "                \tdcm_";
  protected final String TEXT_287 = ".setPrecision(rsmd_";
  protected final String TEXT_288 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_289 = ".setNullable(rsmd_";
  protected final String TEXT_290 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_291 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_292 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_293 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_294 = ".metadatas.add(dcm_";
  protected final String TEXT_295 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_296 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_297 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_298 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_299 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_300 = NL + "\t\t    ";
  protected final String TEXT_301 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_302 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_303 = NL + "\t\t    while (rs_";
  protected final String TEXT_304 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_305 = "++;" + NL + "\t\t        ";
  protected final String TEXT_306 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_307 = " = ";
  protected final String TEXT_308 = " + dcg_";
  protected final String TEXT_309 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_310 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_311 = " = ";
  protected final String TEXT_312 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_313 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_314 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_326 = " = (List)rs_";
  protected final String TEXT_327 = ".getObject(";
  protected final String TEXT_328 = "column_index_";
