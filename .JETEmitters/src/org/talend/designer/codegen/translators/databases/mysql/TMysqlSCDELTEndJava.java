...
public class TMysqlSCDELTEndJava {
  protected static String nl;
  public static synchronized TMysqlSCDELTEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMysqlSCDELTEndJava result = new TMysqlSCDELTEndJava();
    nl = null;
    return result;
  }
