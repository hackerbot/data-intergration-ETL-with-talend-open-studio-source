...
public class TNetezzaSCDBeginJava {
  protected static String nl;
  public static synchronized TNetezzaSCDBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNetezzaSCDBeginJava result = new TNetezzaSCDBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_13 = NL + "        java.lang.Class.forName(\"org.netezza.Driver\");";
  protected final String TEXT_14 = NL + "            String connectionString_";
  protected final String TEXT_15 = " = \"jdbc:netezza://\" + ";
  protected final String TEXT_16 = " + \":\" + ";
  protected final String TEXT_17 = " + \"/\" + ";
  protected final String TEXT_18 = ";";
  protected final String TEXT_19 = NL + "            String connectionString_";
  protected final String TEXT_20 = " = \"jdbc:netezza://\" + ";
  ...
  protected final String TEXT_33 = NL + "\t   \t" + NL + "        java.sql.Connection connection_";
  ...
  protected final String TEXT_39 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_40 = " = connection_";
  protected final String TEXT_41 = ".createStatement();" + NL + "            stmtCreate_";
  protected final String TEXT_42 = ".execute(\"";
  protected final String TEXT_43 = "\");" + NL + "            stmtCreate_";
  protected final String TEXT_44 = ".close();";
  protected final String TEXT_45 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_46 = " = connection_";
  protected final String TEXT_47 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_48 = " = dbMetaData_";
  protected final String TEXT_49 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_50 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_51 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_52 = " = rsTable_";
  protected final String TEXT_53 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_54 = ".equalsIgnoreCase(";
  protected final String TEXT_55 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_56 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            if(!whetherExist_";
  protected final String TEXT_57 = ") {" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_58 = " = connection_";
  protected final String TEXT_59 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_63 = NL + "        " + NL + "    java.util.Calendar calendar_";
  protected final String TEXT_64 = " = java.util.Calendar.getInstance();" + NL + "    java.util.Calendar calendarYear0_";
  protected final String TEXT_65 = " = java.util.Calendar.getInstance();" + NL + "    " + NL + "    calendar_";
  protected final String TEXT_66 = ".set(1, 0, 1, 0, 0, 0);" + NL + "    calendarYear0_";
  protected final String TEXT_67 = ".set(0,0,0,0,0,0);" + NL + "    " + NL + "    final java.util.Date dateYear0_";
  protected final String TEXT_68 = " = calendarYear0_";
  protected final String TEXT_69 = ".getTime();" + NL + "    final long year1_";
  protected final String TEXT_70 = " = calendar_";
  protected final String TEXT_71 = ".getTime().getTime();" + NL + "    " + NL + "    " + NL + "    calendar_";
  protected final String TEXT_72 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "    final long year10000_";
  protected final String TEXT_73 = " = calendar_";
  protected final String TEXT_74 = ".getTime().getTime();" + NL + "    long date_";
  protected final String TEXT_75 = " = 0;    " + NL + "    String dateStr_";
  protected final String TEXT_76 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_77 = " = null;    ";
  protected final String TEXT_78 = NL + "        String searching_";
  protected final String TEXT_79 = " = \"";
  protected final String TEXT_80 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_81 = " = connection_";
  protected final String TEXT_82 = ".prepareStatement(searching_";
  protected final String TEXT_83 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_84 = " = null;";
  protected final String TEXT_85 = NL + "        String search_";
  protected final String TEXT_86 = " = \"";
  protected final String TEXT_87 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_88 = " = connection_";
  protected final String TEXT_89 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_90 = " = statement_";
  protected final String TEXT_91 = ".executeQuery(search_";
  protected final String TEXT_92 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_93 = ", SCDStruct_";
  protected final String TEXT_94 = "> cache_";
  protected final String TEXT_95 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_96 = ", SCDStruct_";
  protected final String TEXT_97 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_98 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_99 = " sk_";
  protected final String TEXT_100 = " = new SCDSK_";
  protected final String TEXT_101 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_102 = " row_";
  protected final String TEXT_103 = " = new SCDStruct_";
  protected final String TEXT_104 = "();";
  protected final String TEXT_105 = NL + "                    tmpValue_";
  protected final String TEXT_106 = " = resultSet_";
  protected final String TEXT_107 = ".getString(";
  protected final String TEXT_108 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_109 = " != null && tmpValue_";
  protected final String TEXT_110 = ".length() > 0) {";
  protected final String TEXT_111 = NL + "                        ";
  protected final String TEXT_112 = ".";
  protected final String TEXT_113 = " = tmpValue_";
  protected final String TEXT_114 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_115 = NL + "                            if(tmpValue_";
  protected final String TEXT_116 = " == null) {";
  protected final String TEXT_117 = NL + "                                ";
  protected final String TEXT_118 = ".";
  protected final String TEXT_119 = " = null;" + NL + "                            } else {";
  protected final String TEXT_120 = NL + "                                ";
  protected final String TEXT_121 = ".";
  protected final String TEXT_122 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_123 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_124 = ")) {";
  protected final String TEXT_125 = NL + "                                ";
  protected final String TEXT_126 = ".";
  protected final String TEXT_127 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  ...
  protected final String TEXT_131 = NL + "                    dateStr_";
  protected final String TEXT_132 = " = resultSet_";
  protected final String TEXT_133 = ".getString(";
  protected final String TEXT_134 = ");" + NL + "                    if(dateStr_";
  protected final String TEXT_135 = " != null) {" + NL + "                        if(!(\"0000-00-00\").equals(dateStr_";
  protected final String TEXT_136 = ") && !(\"0000-00-00 00:00:00\").equals(dateStr_";
  protected final String TEXT_137 = ")) {";
  protected final String TEXT_138 = NL + "                            ";
  protected final String TEXT_139 = ".";
  protected final String TEXT_140 = " = new java.util.Date(resultSet_";
  protected final String TEXT_141 = ".getTimestamp(";
  protected final String TEXT_142 = ").getTime());" + NL + "                        } else {";
  protected final String TEXT_143 = NL + "                            ";
  protected final String TEXT_144 = ".";
  protected final String TEXT_145 = " = (java.util.Date) dateYear0_";
  protected final String TEXT_146 = ".clone();" + NL + "                        }" + NL + "                    } else {";
  protected final String TEXT_147 = NL + "                        ";
  protected final String TEXT_148 = ".";
  protected final String TEXT_149 = " = null;" + NL + "                    }";
  protected final String TEXT_150 = NL + "                    if(resultSet_";
  protected final String TEXT_151 = ".getObject(";
  protected final String TEXT_152 = ") != null) {";
  protected final String TEXT_153 = NL + "                        ";
  protected final String TEXT_154 = ".";
  protected final String TEXT_155 = " = resultSet_";
  protected final String TEXT_156 = ".get";
  protected final String TEXT_157 = "(";
  protected final String TEXT_158 = ");" + NL + "                    }";
  protected final String TEXT_159 = NL + "            cache_";
  protected final String TEXT_160 = ".put(sk_";
  protected final String TEXT_161 = ", row_";
  protected final String TEXT_162 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_163 = ".close();" + NL + "        statement_";
  protected final String TEXT_164 = ".close();";
  protected final String TEXT_165 = NL + "            System.out.println(\"[";
  protected final String TEXT_166 = "] comparison cache loaded\");";
  protected final String TEXT_167 = NL + "        ";
  protected final String TEXT_168 = " nextSurrogateKey_";
  protected final String TEXT_169 = " = 1;";
  protected final String TEXT_170 = NL + "            if(cache_";
  protected final String TEXT_171 = ".size() > 0) {";
  protected final String TEXT_172 = NL + "        String tmpQuery_";
  protected final String TEXT_173 = " = \"SELECT MAX(";
  protected final String TEXT_174 = ") FROM \" + tableName_";
  protected final String TEXT_175 = " + \"\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_176 = " = connection_";
  protected final String TEXT_177 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_178 = " = tmpStmt_";
  protected final String TEXT_179 = ".executeQuery(tmpQuery_";
  protected final String TEXT_180 = ");";
  protected final String TEXT_181 = NL + "        if(tmpRS_";
  protected final String TEXT_182 = ".next() && tmpRS_";
  protected final String TEXT_183 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_184 = " = tmpRS_";
  protected final String TEXT_185 = ".get";
  protected final String TEXT_186 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_187 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_188 = ".close();";
  protected final String TEXT_189 = NL + "            }            ";
  protected final String TEXT_190 = NL + "    String insertionSQL_";
  protected final String TEXT_191 = " = \"";
  protected final String TEXT_192 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_193 = " = connection_";
  protected final String TEXT_194 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_195 = ");";
  protected final String TEXT_196 = NL + "            insertionStatement_";
  protected final String TEXT_197 = ".setTimestamp(";
  protected final String TEXT_198 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_199 = "\")));";
  protected final String TEXT_200 = NL + "            insertionStatement_";
  protected final String TEXT_201 = ".setNull(";
  protected final String TEXT_202 = ", java.sql.Types.DATE);";
  protected final String TEXT_203 = NL + "            String endDateTimeDetail_";
  protected final String TEXT_204 = " = ";
  protected final String TEXT_205 = ";" + NL + "            String datePattern_";
  protected final String TEXT_206 = " = \"yyyy-MM-dd\";" + NL + "            if(endDateTimeDetail_";
  protected final String TEXT_207 = ".length()>0){" + NL + "            \tendDateTimeDetail_";
  protected final String TEXT_208 = " = \" \"+endDateTimeDetail_";
  protected final String TEXT_209 = ";" + NL + "            \tdatePattern_";
  protected final String TEXT_210 = " = \"yyyy-MM-dd HH:mm:ss\";" + NL + "            }" + NL + "            insertionStatement_";
  protected final String TEXT_211 = ".setTimestamp(";
  protected final String TEXT_212 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(datePattern_";
  protected final String TEXT_213 = ").parse(";
  protected final String TEXT_214 = " + \"-01-01\"+endDateTimeDetail_";
  protected final String TEXT_215 = ").getTime()));";
  protected final String TEXT_216 = NL + "        String updateSQLForType1_";
  protected final String TEXT_217 = " = \"";
  protected final String TEXT_218 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_219 = " = connection_";
  protected final String TEXT_220 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_221 = ");        ";
  protected final String TEXT_222 = NL + "        String updateSQLForType2_";
  protected final String TEXT_223 = " = \"";
  protected final String TEXT_224 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_225 = " = connection_";
  protected final String TEXT_226 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_227 = ");";
  protected final String TEXT_228 = NL + "            updateForType2_";
  protected final String TEXT_229 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_230 = "\")));";
  protected final String TEXT_231 = NL + "        String updateSQLForType3_";
  protected final String TEXT_232 = " = \"";
  protected final String TEXT_233 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_234 = " = connection_";
  protected final String TEXT_235 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_236 = ");";
  protected final String TEXT_237 = NL + "    ";
  protected final String TEXT_238 = NL + "        SCDSK_";
  protected final String TEXT_239 = " lookUpKey_";
  protected final String TEXT_240 = " = null;        ";
  protected final String TEXT_241 = NL + "    SCDStruct_";
  protected final String TEXT_242 = " lookUpValue_";
