...
public class TTeradataFastLoadUtilityMainJava
{
  ...
  protected final String TEXT_114 = "\"+\" (VARCHAR(";
  protected final String TEXT_115 = "))\"+ \"";
  protected final String TEXT_116 = "\");" + NL + "\t";
  protected final String TEXT_117 = NL + "fw_";
  protected final String TEXT_118 = ".write(\"FILE=\"+";
  protected final String TEXT_119 = "+\";\"+ \"";
  protected final String TEXT_120 = "\");" + NL + "fw_";
  protected final String TEXT_121 = ".write(\"BEGIN LOADING \"+ ";
  protected final String TEXT_122 = " + \".\" + ";
  protected final String TEXT_123 = "+\" \"+";
  protected final String TEXT_124 = "+\" CHECKPOINT ";
  protected final String TEXT_125 = ";\"+ \"";
  protected final String TEXT_126 = "\");" + NL + "fw_";
  protected final String TEXT_127 = ".write(\"ERRLIMIT ";
  protected final String TEXT_128 = ";\"+ \"";
  protected final String TEXT_129 = "\");";
  protected final String TEXT_130 = NL + "fw_";
  protected final String TEXT_131 = ".write(\"INSERT INTO \"+ ";
  ...
  protected final String TEXT_138 = ".write(\"END LOADING;\"+ \"";
  ...
  protected final String TEXT_145 = "= new String(\"fastload -c \"+";
  ...
  protected final String TEXT_151 = "= new String(\"fastload < \\\"\"+";
  ...
  protected final String TEXT_156 = " - Executing '\" + sb_";
  ...
  protected final String TEXT_166 = ".getInputStream()));" + NL + "    \t\tString line = \"\";" + NL + "    \t\ttry {" + NL + "    \t\t\twhile((line = reader.readLine()) != null) {" + NL + "    \t\t\t   System.out.println(line);" + NL + "    \t        }" + NL + "    \t    } finally {" + NL + "    \t         reader.close();" + NL + "    \t    }" + NL + "        }catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  ...
  protected final String TEXT_180 = ") {" + NL + "\t\tthrow new RuntimeException(\"Fastload returned exit code \"+process_";
  protected final String TEXT_181 = ".exitValue());" + NL + "\t}";
  protected final String TEXT_182 = NL;
  protected final String TEXT_183 = NL + "    log.info(\"";
  protected final String TEXT_184 = " - Excute '\" + sb_";
  protected final String TEXT_185 = " + \"' has finished.\");";
  protected final String TEXT_186 = NL + "}finally{" + NL + "\ttry{" + NL + "\t\tfile_";
  protected final String TEXT_187 = ".delete();" + NL + "\t}catch(Exception e_";
