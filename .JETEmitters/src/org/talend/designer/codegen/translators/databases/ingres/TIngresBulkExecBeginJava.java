...
public class TIngresBulkExecBeginJava {
  protected static String nl;
  public static synchronized TIngresBulkExecBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TIngresBulkExecBeginJava result = new TIngresBulkExecBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_73 = ";" + NL + "" + NL + "\t/***********************************************************************/" + NL + "\t/** Obtain parameters for Ingres/NET connection\t\t\t\t**/" + NL + "\t/***********************************************************************/" + NL + "\tString vnode_for_Copy";
  protected final String TEXT_74 = " = ";
  protected final String TEXT_75 = ";" + NL + "" + NL + "\tString db_for_Copy";
  protected final String TEXT_76 = " = \"\";" + NL + "\tif ((vnode_for_Copy";
  protected final String TEXT_77 = ".equals(\"\\\"\\\"\")) || (vnode_for_Copy";
  protected final String TEXT_78 = ".equals(\"\\\"\\\"\")) ) {" + NL + "\t\tdb_for_Copy";
  protected final String TEXT_79 = " = ";
  protected final String TEXT_80 = ";" + NL + "\t} else {" + NL + "\t\tdb_for_Copy";
  protected final String TEXT_81 = " = vnode_for_Copy";
  protected final String TEXT_82 = " + \"::\" + ";
  protected final String TEXT_83 = ";" + NL + "\t}";
  protected final String TEXT_84 = NL + "\tStringBuilder command_";
  protected final String TEXT_85 = " =  new StringBuilder();" + NL + "\tString delimAction_";
  protected final String TEXT_86 = " = ";
  protected final String TEXT_87 = ";" + NL + "\tString field_delimiter_";
  protected final String TEXT_88 = " = \"\";" + NL + "\tif (\"\\nl\".equals(delimAction_";
  protected final String TEXT_89 = ".toLowerCase()) || \"nl\".equals(delimAction_";
  protected final String TEXT_90 = ".toLowerCase())) { " + NL + "\t\tfield_delimiter_";
  protected final String TEXT_91 = " = \"nl\";" + NL + "\t}" + NL + "\telse if (\"\\t\".equals(delimAction_";
  protected final String TEXT_92 = ".toLowerCase()) || \"tab\".equals(delimAction_";
  protected final String TEXT_93 = ".toLowerCase())){" + NL + "\t\tfield_delimiter_";
  protected final String TEXT_94 = " = \"tab\";" + NL + "\t}" + NL + "\telse if (\":\".equals(delimAction_";
  protected final String TEXT_95 = ".toLowerCase()) || \"colon\".equals(delimAction_";
  protected final String TEXT_96 = ".toLowerCase())){" + NL + "\t\tfield_delimiter_";
  protected final String TEXT_97 = " = \"colon\";" + NL + "\t}else{" + NL + "\t\tfield_delimiter_";
  protected final String TEXT_98 = " = \"'\"+";
  protected final String TEXT_99 = ".charAt(0)+\"'\";" + NL + "\t}" + NL + "" + NL + "" + NL + "" + NL + "\t/***********************************************************************/" + NL + "\t/** Build SQL statement for the COPY command\t\t\t\t\t**/" + NL + "\t/***********************************************************************/" + NL + "\t";
  protected final String TEXT_100 = NL + "\t\tjava.text.SimpleDateFormat formatter_";
  protected final String TEXT_101 = " = new java.text.SimpleDateFormat(\"dd-MMM-yyyy HH:mm:ss\");" + NL + "\t\tString formattedDate_";
  protected final String TEXT_102 = " = formatter_";
  protected final String TEXT_103 = ".format(new java.util.Date());" + NL + "\t\tStringBuffer sqlBuffer_";
  protected final String TEXT_104 = " = new StringBuffer();" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_105 = ".append(\"/* SQL generated by Talend at \" + formattedDate_";
  protected final String TEXT_106 = " + \"*/\");" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_107 = ".append(\"\\n\");" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_108 = ".append(\"\\n\\\\SQL\");" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_109 = ".append(\"\\n\\nSET AUTOCOMMIT OFF\");" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_110 = ".append(\"\\n\\\\p\\\\g\");" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_111 = ".append(\"\\n\\nSET NOJOURNALING\");" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_112 = ".append(\"\\n\\\\p\\\\g\");" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_113 = ".append(\"\\n\\nSET SESSION AUTHORIZATION \" + ";
  protected final String TEXT_114 = ");" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_115 = ".append(\"\\n\\\\p\\\\g\");" + NL + "\t\t";
  protected final String TEXT_116 = NL + "\t\t\t// SQL statement added when TRUNCATE_BY_INGRESNET requested" + NL + "\t\t\tsqlBuffer_";
  protected final String TEXT_117 = ".append(\"\\n\\n\");" + NL + "\t\t\tsqlBuffer_";
  protected final String TEXT_118 = ".append(\"MODIFY \" + ";
  protected final String TEXT_119 = " + \" TO TRUNCATED;\");" + NL + "\t\t";
  protected final String TEXT_120 = NL + "\t\tsqlBuffer_";
  protected final String TEXT_121 = ".append(\"\\n\\n\");" + NL + "" + NL + "\t\t// Call Ingres DB manager object to retrieve SQL for COPY" + NL + "\t\t";
  protected final String TEXT_122 = NL + "\t\tString sqlString_";
  protected final String TEXT_123 = "  = \"";
  protected final String TEXT_124 = "\";" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_125 = ".append(sqlString_";
  protected final String TEXT_126 = ");" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_127 = ".append(\"\\nFROM \");" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_128 = ".append(\"\\n\");" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_129 = ".append(\"'\" + ";
  protected final String TEXT_130 = " + \"'\");" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_131 = ".append(\"\\n\");" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_132 = ".append(\"WITH\");" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_133 = ".append(\"\\n ROLLBACK=\" + \"";
  protected final String TEXT_134 = "\");" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_135 = ".append(\",\\n ON_ERROR=\" + \"";
  protected final String TEXT_136 = "\");" + NL + "" + NL + "\t\t// error count parameter should only be set if Terminate On Error has been selected. " + NL + "" + NL + "\t\t";
  protected final String TEXT_137 = NL + NL + "\t\t\t\t// If user has entered an Error Count value less than 1, co-erce the value " + NL + "\t\t\t\t// to 1 (lesser values do not make sense). " + NL + "\t\t\t\tsqlBuffer_";
  protected final String TEXT_138 = ".append(\",\\n ERROR_COUNT=\" + ";
  protected final String TEXT_139 = ");" + NL + "\t\t\t";
  protected final String TEXT_140 = NL + "\t\t\tsqlBuffer_";
  protected final String TEXT_141 = ".append(\",\\n LOG=\" + \"'\" + ";
  protected final String TEXT_142 = " + \"'\");" + NL + "\t\t";
  protected final String TEXT_143 = NL + "\t\t\tsqlBuffer_";
  protected final String TEXT_144 = ".append(\",\\n ALLOCATION=\" + ";
  protected final String TEXT_145 = ");" + NL + "\t\t";
  protected final String TEXT_146 = NL + "\t\t\tsqlBuffer_";
  protected final String TEXT_147 = ".append(\",\\n EXTEND=\" + ";
  protected final String TEXT_148 = ");" + NL + "\t\t";
  protected final String TEXT_149 = NL + "\t\t\tsqlBuffer_";
  protected final String TEXT_150 = ".append(\",\\n FILLFACTOR=\" + ";
  protected final String TEXT_151 = ");" + NL + "\t\t";
  protected final String TEXT_152 = NL + "\t\t\tsqlBuffer_";
  protected final String TEXT_153 = ".append(\",\\n MINPAGES=\" + ";
  protected final String TEXT_154 = ");" + NL + "\t\t";
  protected final String TEXT_155 = NL + "\t\t\tsqlBuffer_";
  protected final String TEXT_156 = ".append(\",\\n MAXPAGES=\" + ";
  protected final String TEXT_157 = ");" + NL + "\t\t";
  protected final String TEXT_158 = NL + "\t\t\tsqlBuffer_";
  protected final String TEXT_159 = ".append(\",\\n LEAFFILL=\" + ";
  protected final String TEXT_160 = ");" + NL + "\t\t";
  protected final String TEXT_161 = NL + "\t\t\tsqlBuffer_";
  protected final String TEXT_162 = ".append(\",\\n NONLEAFFILL=\" + ";
  protected final String TEXT_163 = ");" + NL + "\t\t";
  protected final String TEXT_164 = NL + "\t\t\tsqlBuffer_";
  protected final String TEXT_165 = ".append(\",\\n ROW_ESTIMATE=\" + ";
  protected final String TEXT_166 = ");" + NL + "\t\t";
  protected final String TEXT_167 = NL + "\t\tsqlBuffer_";
  protected final String TEXT_168 = ".append(\";\\n\");" + NL + "" + NL + "\t\t// Note the \"go block\" extends from MODIFY though COPY and COMMIT ... this helps the" + NL + "\t\t// MODIFY to be rolled back if an error occurs in the COPY. " + NL + "\t\t// Following ROLLBACK is only effective when this happens." + NL + "" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_169 = ".append(\"\\nCOMMIT\");" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_170 = ".append(\"\\n\\\\p\\\\g\");" + NL + "" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_171 = ".append(\"\\n\\nROLLBACK\");" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_172 = ".append(\"\\n\\\\p\\\\g\");" + NL + "" + NL + "\t\tsqlBuffer_";
  protected final String TEXT_173 = ".append(\"\\n\\n/* End of SQL file generated by Talend */\");" + NL + "" + NL + "\t/***********************************************************************/" + NL + "\t/** Retrieve current TEMP directory.\t\t\t\t\t\t**/" + NL + "\t/***********************************************************************/" + NL + "" + NL + "\tString tempDirectoryPath_";
  protected final String TEXT_174 = " = System.getProperty(\"java.io.tmpdir\");" + NL + "\tString fileNameAndPath_";
  protected final String TEXT_175 = " = \"\";" + NL + "\tString sqlFileAndPath_";
  protected final String TEXT_176 = " = \"\";" + NL + "\tString executableFilePath_";
  protected final String TEXT_177 = " = \"\";" + NL + "\tString executableExtension_";
  protected final String TEXT_178 = " = \"\";" + NL + "\tString timestamp_";
  protected final String TEXT_179 = " = \"\";" + NL + "" + NL + "\t/***********************************************************************/" + NL + "\t/** Determine OS to create correct executable extension\t\t\t**/" + NL + "\t/***********************************************************************/" + NL + "" + NL + "\t\tString OS_";
  protected final String TEXT_180 = " = System.getProperty(\"os.name\").toLowerCase();" + NL + "\t\tif (OS_";
  protected final String TEXT_181 = ".indexOf(\"windows\") > -1 || OS_";
  protected final String TEXT_182 = ".indexOf(\"nt\") > -1 )" + NL + "\t\t{" + NL + "\t\t\texecutableExtension_";
  protected final String TEXT_183 = " = \".bat\";" + NL + "\t\t}" + NL + "\t\telse " + NL + "\t\t{" + NL + "\t\t\texecutableExtension_";
  protected final String TEXT_184 = " = \".sh\";" + NL + "\t\t}" + NL + "" + NL + "\t\t/***********************************************************************/" + NL + "\t\t/** Write SQL file and executable to TEMP DIR.\t\t\t\t**/" + NL + "\t\t/***********************************************************************/" + NL + "\t\ttry {" + NL + "\t\t\tjava.text.SimpleDateFormat timestampFormatter = new java.text.SimpleDateFormat(\"yyyyMMddHHmmss\");" + NL + "\t\t\ttimestamp_";
  protected final String TEXT_185 = " = timestampFormatter.format(new java.util.Date()) + \"_\" + pid;" + NL + "\t\t\t/*" + NL + "\t\t\t*Under solaris and windows value of \"java.io.tmpdir\" ends with " + NL + "\t\t\t*system-dependent default name-separator character. But under linux" + NL + "\t\t\t*the value does not contain trailing name-separator." + NL + "\t\t\t*/" + NL + "\t\t\tif(System.getProperty(\"java.io.tmpdir\").endsWith(System.getProperty(\"file.separator\"))){" + NL + "\t\t\t\tfileNameAndPath_";
  protected final String TEXT_186 = " = tempDirectoryPath_";
  protected final String TEXT_187 = " + jobName+\"_";
  protected final String TEXT_188 = "_ingres_sql_\" + timestamp_";
  protected final String TEXT_189 = ";" + NL + "\t\t\t}else{" + NL + "\t\t\t\tfileNameAndPath_";
  protected final String TEXT_190 = " = tempDirectoryPath_";
  protected final String TEXT_191 = " + System.getProperty(\"file.separator\") + jobName+\"_";
  protected final String TEXT_192 = "_ingres_sql_\" + timestamp_";
  protected final String TEXT_193 = ";" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tsqlFileAndPath_";
  protected final String TEXT_194 = "\t= fileNameAndPath_";
  protected final String TEXT_195 = " + \".sql\";" + NL + "\t\t\texecutableFilePath_";
  protected final String TEXT_196 = " = fileNameAndPath_";
  protected final String TEXT_197 = " + executableExtension_";
  protected final String TEXT_198 = ";" + NL + "" + NL + "\t\t\tjava.io.FileWriter fstream = new java.io.FileWriter(sqlFileAndPath_";
  protected final String TEXT_199 = ");" + NL + "\t\t\tjava.io.BufferedWriter out = new java.io.BufferedWriter(" + NL + "\t\t\t\t\tfstream);" + NL + "\t\t\tout.write(sqlBuffer_";
  protected final String TEXT_200 = ".toString());" + NL + "\t\t\tout.close();" + NL + "\t\t\t";
  protected final String TEXT_201 = NL + "\t\t\t\tlog.trace(\"";
  protected final String TEXT_202 = " - Sql content:\"+sqlBuffer_";
  protected final String TEXT_203 = ".toString()+\".\");" + NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_204 = " - Generate sql into file:\"+sqlFileAndPath_";
  protected final String TEXT_205 = "+\".\");" + NL + "\t\t\t";
  protected final String TEXT_206 = NL + "\t\t\tfstream = new java.io.FileWriter(executableFilePath_";
  protected final String TEXT_207 = ");" + NL + "\t\t\tout = new java.io.BufferedWriter(fstream);" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_208 = NL + "\t\t\t\t// Set Ingres environment variables which allow the table " + NL + "\t\t\t\t// truncate statement to be rolled back if the copy fails." + NL + "\t\t\t\tout.write(\"set II_TM_ON_ERROR=NOCONTINUE\\n\");" + NL + "\t\t\t\tout.write(\"set II_TM_SWITCH=true\\n\");" + NL + "\t\t\t";
  protected final String TEXT_209 = NL + NL + "\t\t\tout.write(\"sql \" +  db_for_Copy";
  protected final String TEXT_210 = " + \" < \" + sqlFileAndPath_";
  protected final String TEXT_211 = " );" + NL + "\t\t\tout.close();" + NL + "\t\t\t";
  protected final String TEXT_212 = NL + "\t\t\t\tlog.trace(\"";
  protected final String TEXT_213 = " - Command content:\"+\"sql \" +  db_for_Copy";
  protected final String TEXT_214 = " + \" < \" + sqlFileAndPath_";
  protected final String TEXT_215 = "+\".\");" + NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_216 = " - Generate command into file:\"+executableFilePath_";
  protected final String TEXT_217 = "+\".\");" + NL + "\t\t\t";
  protected final String TEXT_218 = NL + "\t\t} catch (java.lang.Exception e) {" + NL + "\t\t\t";
  protected final String TEXT_219 = NL + "\t\t\te.printStackTrace();" + NL + "\t\t}" + NL + "\t\t/***********************************************************************/" + NL + "\t\t/** Trigger executable to execute SQL against DB.                     **/" + NL + "\t\t/***********************************************************************/" + NL + "\t\t";
  protected final String TEXT_220 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_221 = " - Bulk loading.\");" + NL + "\t\t";
  protected final String TEXT_222 = NL + "\t\tRuntime runtime_";
  protected final String TEXT_223 = " = Runtime.getRuntime();" + NL + "\t\tif (OS_";
  protected final String TEXT_224 = ".indexOf(\"windows\") < 0 && OS_";
  protected final String TEXT_225 = ".indexOf(\"nt\") < 0 ) {" + NL + "\t\t\tfinal Process chmod_";
  protected final String TEXT_226 = " = runtime_";
  protected final String TEXT_227 = ".exec(\"chmod a+x \"+ executableFilePath_";
  protected final String TEXT_228 = ");" + NL + "" + NL + "\t\t\t/***********************************************************************/" + NL + "\t\t\t/** Create two threads to monitor above process without blocking      **/" + NL + "\t\t\t/** logic executing. One thread prints standard console output, the   **/" + NL + "\t\t\t/** other prints the error stream.                                    **/" + NL + "\t\t\t/***********************************************************************/" + NL + "" + NL + "\t\t\t// chmodstandard output monitor " + NL + "\t\t\tThread chmodnormal_";
  protected final String TEXT_229 = " = new Thread() {" + NL + "\t\t\t\tpublic void run() {" + NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(chmod_";
  protected final String TEXT_230 = ".getInputStream()));" + NL + "\t\t\t\t\t\tString line = \"\";" + NL + "\t\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t} finally {" + NL + "\t\t\t\t\t\t\treader.close();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_231 = NL + "\t\t\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t};" + NL + "\t\t\tchmodnormal_";
  protected final String TEXT_232 = ".start();" + NL + "" + NL + "\t\t\t// chmoderror output monitor" + NL + "\t\t\tThread chmoderror_";
  protected final String TEXT_233 = " = new Thread() {" + NL + "\t\t\t\tpublic void run() {" + NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(chmod_";
  protected final String TEXT_234 = ".getErrorStream()));" + NL + "\t\t\t\t\t\tString line = \"\";" + NL + "\t\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_235 = NL + "\t\t\t\t\t\t\t\tSystem.err.println(line);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_236 = NL + "\t\t\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_237 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_238 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_239 = NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t} finally {" + NL + "\t\t\t\t\t\t\treader.close();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_240 = NL + "\t\t\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t};" + NL + "\t\t\tchmoderror_";
  protected final String TEXT_241 = ".start();" + NL + "" + NL + "\t\t\tchmod_";
  protected final String TEXT_242 = ".waitFor();" + NL + "\t\t\tchmodnormal_";
  protected final String TEXT_243 = ".interrupt();" + NL + "\t\t\tchmoderror_";
  protected final String TEXT_244 = ".interrupt();" + NL + "\t\t}" + NL + "\t\tfinal Process ps_";
  protected final String TEXT_245 = " = runtime_";
  protected final String TEXT_246 = ".exec(executableFilePath_";
  protected final String TEXT_247 = ");" + NL + "\t\t";
  protected final String TEXT_248 = NL + NL + "\t/***********************************************************************/" + NL + "\t/** Create two threads to monitor above process without blocking      **/" + NL + "\t/** logic executing. One thread prints standard console output, the   **/" + NL + "\t/** other prints the error stream.                                    **/" + NL + "\t/***********************************************************************/" + NL + "" + NL + "" + NL + "\t// standard output monitor " + NL + "\tThread normal_";
  protected final String TEXT_249 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_250 = ".getInputStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_251 = NL + "\t\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_252 = NL + "\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_253 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_254 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_255 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\treader.close();" + NL + "\t\t\t\t}" + NL + "\t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\t";
  protected final String TEXT_256 = NL + "\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\tnormal_";
  protected final String TEXT_257 = ".start();" + NL + "" + NL + "\t// error output monitor" + NL + "\tThread error_";
  protected final String TEXT_258 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_259 = ".getErrorStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_260 = NL + "\t\t\t\t\t\t\tSystem.err.println(line);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_261 = NL + "\t\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_262 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_263 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_264 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\treader.close();" + NL + "\t\t\t\t}" + NL + "\t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\t";
  protected final String TEXT_265 = NL + "\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\terror_";
  protected final String TEXT_266 = ".start();" + NL + "\tps_";
  protected final String TEXT_267 = ".waitFor();" + NL + "\tnormal_";
  protected final String TEXT_268 = ".interrupt();" + NL + "\terror_";
  protected final String TEXT_269 = ".interrupt();" + NL + "\t";
  protected final String TEXT_270 = NL + "\t\tlog.info(\"";
  protected final String TEXT_271 = " - Bulk load has finished.\");" + NL + "\t";
  protected final String TEXT_272 = NL + NL + "\t/***********************************************************************/" + NL + "\t/** Delete working files if not requested to keep them.               **/" + NL + "\t/***********************************************************************/" + NL + "\t\ttry {" + NL + "" + NL + "\t\t\tjava.io.File f = new java.io.File(sqlFileAndPath_";
  protected final String TEXT_273 = ");" + NL + "" + NL + "\t\t\tboolean deletedOK = f.delete();" + NL + "" + NL + "\t\t\tif (!deletedOK ){" + NL + "\t\t\t\tthrow new IllegalArgumentException(\"Failed to delete \" + sqlFileAndPath_";
  protected final String TEXT_274 = ");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_275 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_276 = " - File : \"+ sqlFileAndPath_";
  protected final String TEXT_277 = " + \" is deleted.\");" + NL + "\t\t\t";
  protected final String TEXT_278 = NL + NL + "\t\t\tf = new java.io.File(executableFilePath_";
  protected final String TEXT_279 = ");" + NL + "" + NL + "\t\t\tdeletedOK = f.delete();" + NL + "" + NL + "\t\t\tif (!deletedOK ){" + NL + "\t\t\t\tthrow new IllegalArgumentException(\"Failed to delete \" + executableFilePath_";
  protected final String TEXT_280 = ");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_281 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_282 = " - File : \"+ executableFilePath_";
  protected final String TEXT_283 = " + \" is deleted.\");" + NL + "\t\t\t";
  protected final String TEXT_284 = NL + "\t\t} catch (java.lang.Exception e) {" + NL + "\t\t\t";
  protected final String TEXT_285 = NL + "\t\t\te.printStackTrace();" + NL + "\t\t}" + NL + "\t";
    ...
    public String generate(Object argument)
  {
    ...
    stringBuffer.append(delimAction);
    ...
    stringBuffer.append(manager.getCopyFromCSVSQL(columnList, fieldDelimiter, recordDelimiter, nullIndicator));
    ...
    stringBuffer.append(onErrorAction);
    ...
    stringBuffer.append(rejectFile);
    ...
    stringBuffer.append(nonLeafFill);
    ...
    stringBuffer.append(rowEstimate);
