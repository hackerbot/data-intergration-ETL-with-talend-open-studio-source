...
public class TInterbaseInputBeginJava
{
  protected static String nl;
  public static synchronized TInterbaseInputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInterbaseInputBeginJava result = new TInterbaseInputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_184 = " = \"jdbc:interbase://\" + ";
  protected final String TEXT_185 = " + \"/\" + ";
  protected final String TEXT_186 = ";";
  protected final String TEXT_187 = NL + "    " + NL + "\t";
  protected final String TEXT_188 = NL + "\t\t    int nb_line_";
  protected final String TEXT_189 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  ...
  protected final String TEXT_194 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_195 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_196 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_197 = " = dataSources_";
  protected final String TEXT_198 = ".get(";
  protected final String TEXT_199 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_200 = "\", conn_";
  protected final String TEXT_201 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_202 = NL + "\t\t\t\t";
  protected final String TEXT_203 = NL + "\t\t\t\t";
  protected final String TEXT_204 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_205 = " =  conn_";
  protected final String TEXT_206 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_207 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_208 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_209 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_210 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_211 = NL + "                 conn_";
  protected final String TEXT_212 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_213 = NL + "               ";
  protected final String TEXT_214 = " + \"=\" + ";
  protected final String TEXT_215 = " + \";\" +";
  protected final String TEXT_216 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_217 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_218 = ");";
  protected final String TEXT_219 = NL + "\t\t    ";
  protected final String TEXT_220 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_221 = " = ";
  protected final String TEXT_222 = ";" + NL + "\t\t\t";
  protected final String TEXT_223 = NL + "                log.info(\"";
  protected final String TEXT_224 = " - Executing the query: '\"+dbquery_";
  ...
  protected final String TEXT_233 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_234 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_235 = " = stmt_";
  protected final String TEXT_236 = ".executeQuery(dbquery_";
  protected final String TEXT_237 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_238 = " = rs_";
  protected final String TEXT_239 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_240 = " = rsmd_";
  protected final String TEXT_241 = ".getColumnCount();" + NL;
  protected final String TEXT_242 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_243 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_244 = ".setDbmsId(\"";
  protected final String TEXT_245 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_246 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_247 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_248 = ".add(\"";
  protected final String TEXT_249 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_250 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_251 = " = ";
  protected final String TEXT_252 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_253 = "; i <= rsmd_";
  protected final String TEXT_254 = ".getColumnCount()-";
  protected final String TEXT_255 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_256 = ".contains(rsmd_";
  protected final String TEXT_257 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_258 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_259 = ".setName(rsmd_";
  protected final String TEXT_260 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_261 = ".setDbName(rsmd_";
  protected final String TEXT_262 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_263 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_264 = "\", rsmd_";
  protected final String TEXT_265 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_266 = ".getPrecision(i), rsmd_";
  protected final String TEXT_267 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_268 = ".setDbType(rsmd_";
  protected final String TEXT_269 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_270 = ".setDbTypeId(rsmd_";
  protected final String TEXT_271 = ".getColumnType(i));";
  protected final String TEXT_272 = NL + "                \tdcm_";
  protected final String TEXT_273 = ".setFormat(";
  protected final String TEXT_274 = ");";
  protected final String TEXT_275 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_276 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_277 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_278 = ".setLength(rsmd_";
  protected final String TEXT_279 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_280 = ".setLength(rsmd_";
  protected final String TEXT_281 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_282 = NL + "\t\t\tdcm_";
  protected final String TEXT_283 = ".setLength(rsmd_";
  protected final String TEXT_284 = ".getPrecision(i));";
  protected final String TEXT_285 = NL + "                \tdcm_";
  protected final String TEXT_286 = ".setPrecision(rsmd_";
  protected final String TEXT_287 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_288 = ".setNullable(rsmd_";
  protected final String TEXT_289 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_290 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_291 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_292 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_293 = ".metadatas.add(dcm_";
  protected final String TEXT_294 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_295 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_296 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_297 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_298 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_299 = NL + "\t\t    ";
  protected final String TEXT_300 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_301 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_302 = NL + "\t\t    while (rs_";
  protected final String TEXT_303 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_304 = "++;" + NL + "\t\t        ";
  protected final String TEXT_305 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_306 = " = ";
  protected final String TEXT_307 = " + dcg_";
  protected final String TEXT_308 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_309 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  ...
  protected final String TEXT_319 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  protected final String TEXT_320 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_321 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_322 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_323 = NL + "\t\t                            ";
  protected final String TEXT_324 = ".";
  protected final String TEXT_325 = " = (List)rs_";
  protected final String TEXT_326 = ".getObject(";
  protected final String TEXT_327 = "column_index_";
  protected final String TEXT_328 = ");";
  protected final String TEXT_329 = NL + "\t\t                         ";
  protected final String TEXT_330 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_331 = ".getObject(";
  protected final String TEXT_332 = "column_index_";
  protected final String TEXT_333 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_334 = NL + "                                    ";
  protected final String TEXT_335 = ".";
  protected final String TEXT_336 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_345 = ".setEPSG(";
  protected final String TEXT_346 = ");" + NL + "                                        }";
  protected final String TEXT_347 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_348 = NL + "                                  ";
  protected final String TEXT_349 = ".";
  protected final String TEXT_350 = "=dcg_";
  protected final String TEXT_351 = ";";
  protected final String TEXT_352 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_353 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_354 = " = ";
  protected final String TEXT_355 = "; i_";
  protected final String TEXT_356 = "  <= rsmd_";
  protected final String TEXT_357 = ".getColumnCount(); i_";
  ...
  protected final String TEXT_369 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_370 = ".";
  protected final String TEXT_371 = ", rs_";
  protected final String TEXT_372 = ", fixedColumnCount_";
  protected final String TEXT_373 = ",list_";
  protected final String TEXT_374 = ",";
  protected final String TEXT_375 = ");";
  protected final String TEXT_376 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  ...
  protected final String TEXT_388 = NL + "                                  Object geom = rs_";
  protected final String TEXT_389 = ".getObject(";
  protected final String TEXT_390 = "column_index_";
  protected final String TEXT_391 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_392 = ".";
  protected final String TEXT_393 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_400 = " - Retrieving the record \" + nb_line_";
