...
public class TNetezzaNzLoadBeginJava {
  protected static String nl;
  public static synchronized TNetezzaNzLoadBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNetezzaNzLoadBeginJava result = new TNetezzaNzLoadBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_82 = " = \"org.netezza.Driver\";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_83 = ");" + NL + "\t\tString url_";
  protected final String TEXT_84 = " = \"jdbc:netezza://\" + ";
  ...
  protected final String TEXT_99 = ";" + NL + "\t        \t\t" + NL + "\t\tString tableName_";
  ...
  protected final String TEXT_107 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_108 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_109 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_115 = " - Drop table '\" + tableName_";
  protected final String TEXT_116 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_117 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_118 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_119 = " =  null;" + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_120 = " = conn_";
  protected final String TEXT_121 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_123 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_129 = " - Create table '\" + tableName_";
  protected final String TEXT_130 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_131 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_132 = ".close();" + NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_133 = "){" + NL + "\t\t\t\t\t throw new RuntimeException (\"Failure on DROP_CREATE action, process terminated.\");" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_134 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_135 = " = null; " + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_136 = " = conn_";
  protected final String TEXT_137 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_138 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_139 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_145 = " - Create table '\" + tableName_";
  protected final String TEXT_146 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_147 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_148 = ".close();" + NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_149 = "){" + NL + "\t\t\t\t\t throw new RuntimeException (\"Table '\" + tableName_";
  protected final String TEXT_150 = "  + \"' already exists. process terminated.\");" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_151 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_152 = " - Table '\" + tableName_";
  protected final String TEXT_153 = "  + \"' already exists. process terminated.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_154 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  ...
  protected final String TEXT_160 = " = false;" + NL + "\t\t\twhile(rsTable_";
  protected final String TEXT_161 = ".next()) {" + NL + "\t\t\t\tString table_";
  protected final String TEXT_162 = " = rsTable_";
  protected final String TEXT_163 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\tif(table_";
  protected final String TEXT_164 = ".equalsIgnoreCase(";
  protected final String TEXT_165 = ")) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_166 = " = true;" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_167 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_168 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_169 = " = null;" + NL + "\t\t\t\t\ttry{" + NL + "\t\t\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_173 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_179 = " - Create table \" + tableName_";
  protected final String TEXT_180 = " + \"' has succeeded. \");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_181 = " " + NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_182 = ".close();" + NL + "\t\t\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_183 = "){" + NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName_";
  protected final String TEXT_184 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\telse{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_185 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_186 = " - Failure to create table '\" + tableName_";
  protected final String TEXT_187 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_188 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}                ";
  protected final String TEXT_189 = NL + "                if(whetherExist_";
  protected final String TEXT_190 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_191 = " = null;" + NL + "                    try{" + NL + "                    \tstmtDrop_";
  protected final String TEXT_192 = " = conn_";
  protected final String TEXT_193 = ".createStatement();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_194 = NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_195 = " - Droping table '\" + tableName_";
  protected final String TEXT_196 = " + \"'.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_197 = NL + "                    \tstmtDrop_";
  protected final String TEXT_198 = ".execute(\"";
  protected final String TEXT_199 = "\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_200 = NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_201 = " - Drop table '\" + tableName_";
  protected final String TEXT_202 = " + \"' has succeeded.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_203 = NL + "\t\t\t\t\t\tstmtDrop_";
  protected final String TEXT_204 = ".close();" + NL + "                    }catch(java.sql.SQLException e){" + NL + "                    \tif(";
  protected final String TEXT_205 = "){" + NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to drop table '\" + tableName_";
  protected final String TEXT_206 = "  + \"'. process terminated.\");" + NL + "                    \t" + NL + "                    \t}else{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_207 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_208 = " - Failure to drop table '\" + tableName_";
  protected final String TEXT_209 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_210 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "                    }" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_211 = " = null;" + NL + "                try{" + NL + "                stmtCreate_";
  protected final String TEXT_212 = " = conn_";
  protected final String TEXT_213 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_214 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_215 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_221 = " - Drop table '\" + tableName_";
  protected final String TEXT_222 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_223 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_224 = ".close();" + NL + "                }catch(java.sql.SQLException e){" + NL + "                \tif(";
  protected final String TEXT_225 = "){" + NL + "\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName_";
  protected final String TEXT_226 = "  + \"'. process terminated.\");" + NL + "                \t}else{" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_227 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_228 = " - Failure to create table '\" + tableName_";
  protected final String TEXT_229 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_230 = NL + "\t\t\t\t\t\t e.printStackTrace();" + NL + "                \t}" + NL + "                }";
  protected final String TEXT_231 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_232 = " = conn_";
  protected final String TEXT_233 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_234 = " = stmtClearCount_";
  protected final String TEXT_235 = ".executeQuery(\"";
  protected final String TEXT_236 = "\");" + NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_240 = " - Truncating table '\" + tableName_";
  protected final String TEXT_241 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_242 = NL + "            stmtClear_";
  protected final String TEXT_243 = ".executeUpdate(\"";
  protected final String TEXT_244 = "\");" + NL + "\t\t\t";
  protected final String TEXT_245 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_246 = " - Truncate table '\" + tableName_";
  protected final String TEXT_247 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_248 = NL + "            while(rsClearCount_";
  protected final String TEXT_249 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_250 = " = rsClearCount_";
  protected final String TEXT_251 = ".getInt(1);" + NL + "            }" + NL + "            stmtClearCount_";
  protected final String TEXT_252 = ".close();" + NL + "\t\t\tstmtClear_";
  protected final String TEXT_253 = ".close();";
  protected final String TEXT_254 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_255 = " = null;" + NL + "            try{" + NL + "            \tstmtClear_";
  protected final String TEXT_256 = " = conn_";
  protected final String TEXT_257 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_258 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_259 = " - Clearing table '\" + tableName_";
  protected final String TEXT_260 = " + \"'.\");" + NL + "\t\t\t\t";
  protected final String TEXT_261 = NL + "            \tdeletedCount_";
  protected final String TEXT_262 = " = stmtClear_";
  protected final String TEXT_263 = ".executeUpdate(\"";
  protected final String TEXT_264 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_265 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_266 = " - Clear table '\" + tableName_";
  protected final String TEXT_267 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_268 = NL + "            \tstmtClear_";
  protected final String TEXT_269 = ".close();" + NL + "            }catch(java.sql.SQLException e){" + NL + "            \tif(";
  protected final String TEXT_270 = "){" + NL + "\t\t\t\t\t throw new RuntimeException (\"Failure to clear table '\" + tableName_";
  protected final String TEXT_271 = "  + \"'. process terminated.\");" + NL + "            \t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_272 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_273 = " - Failure to clear table '\" + tableName_";
  protected final String TEXT_274 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_275 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "            \t}" + NL + "            }";
  protected final String TEXT_276 = NL;
  protected final String TEXT_277 = NL + "\tfinal StringBuilder nzloadOutput_";
  protected final String TEXT_278 = " = new StringBuilder(200);" + NL + "\t//final " + NL + "\t";
  protected final String TEXT_279 = NL + "    ";
  protected final String TEXT_280 = " " + NL + "    \tfinal String decryptedPwd_";
  protected final String TEXT_281 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_282 = ");";
  protected final String TEXT_283 = NL + "    \tfinal String decryptedPwd_";
  protected final String TEXT_284 = " = ";
  protected final String TEXT_285 = "; ";
  protected final String TEXT_286 = NL + "\t" + NL + "\tThread nzloadThread_";
  protected final String TEXT_287 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tString[] envp = null;" + NL + "\t\t\t\tString[] cmds = new String[] {";
  protected final String TEXT_288 = " ";
  protected final String TEXT_289 = ",";
  protected final String TEXT_290 = "};" + NL + "\t\t\t\t" + NL + "\t\t\t\t// added \"print command\" feature" + NL + "\t\t\t\t";
  protected final String TEXT_291 = NL + "\t\t\t\t    System.out.println(\"INFO: executing nzload command:\");" + NL + "\t\t\t\t    for( String cmd : cmds ) {" + NL + "\t\t\t\t\t       System.out.print(cmd + \" \");" + NL + "\t\t\t\t\t }" + NL + "\t\t\t\t";
  protected final String TEXT_292 = NL + "\t\t\t\t" + NL + "\t\t\t\tRuntime rt = Runtime.getRuntime();" + NL + "\t\t\t\tfinal Process ps = rt.exec(cmds, envp);" + NL + "\t\t\t\t" + NL + "" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getInputStream()));" + NL + "\t\t\t\t// fixed no showing of error messages" + NL + "\t\t\t\tjava.io.BufferedReader errReader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getErrorStream()));" + NL + "\t\t\t\t" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\tString errLine = \"\";" + NL + "\t\t\t\twhile ((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\tif((errLine = errReader.readLine()) != null) {" + NL + "\t\t\t\t\t\tnzloadOutput_";
  protected final String TEXT_293 = ".append(errLine);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_294 = NL + "\t\t\t\t\t\t\t\tSystem.out.println(errLine);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_295 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tnzloadOutput_";
  protected final String TEXT_296 = ".append(line);" + NL + "\t\t\t\t\t";
  protected final String TEXT_297 = NL + "\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t\t";
  protected final String TEXT_298 = NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tcatch (java.lang.Exception e) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_299 = "_NZLOAD_ERROR\",e.getMessage());" + NL + "\t\t\t\tthrow new RuntimeException(e.getMessage(),e.getCause());" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\t";
  protected final String TEXT_300 = NL + "\t\tStringBuffer command_";
  protected final String TEXT_301 = " = new StringBuffer(";
  protected final String TEXT_302 = ");" + NL + "\t\t";
  protected final String TEXT_303 = NL + "\t\t\tcommand_";
  protected final String TEXT_304 = ".append(";
  protected final String TEXT_305 = " +\" \");" + NL + "\t\t";
  protected final String TEXT_306 = NL + "\t";
  protected final String TEXT_307 = NL + "\t\t\tcom.infobright.io.NamedPipe outputStream_";
  protected final String TEXT_308 = " = (new com.infobright.io.NamedPipeFactory()).createServer(";
  protected final String TEXT_309 = ", true, true, 1024000, 10000);" + NL + "\t\t\tnzloadThread_";
  protected final String TEXT_310 = ".start();" + NL + "\t\t\t// in Windows wait for named pipe to get opened by nzload.exe" + NL + "\t\t\tif ((new com.infobright.io.NamedPipeFactory()).isWindowsMode()) { " + NL + "\t\t\t\tThread.sleep(10000);" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_311 = NL + "\t\t\tjava.io.BufferedOutputStream outputStream_";
  protected final String TEXT_312 = " = new java.io.BufferedOutputStream(new java.io.FileOutputStream(";
  protected final String TEXT_313 = ",false), 1024000);" + NL + "\t\t";
  protected final String TEXT_314 = NL + "\t\t";
  protected final String TEXT_315 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_316 = " - Executing '\"+command_";
  protected final String TEXT_317 = ".toString()+\"'.\");" + NL + "\t\t";
  protected final String TEXT_318 = NL + "\t\tnzloadThread_";
  protected final String TEXT_319 = ".start();" + NL + "\t\tnzloadThread_";
  protected final String TEXT_320 = ".join(0);" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_321 = "_NZLOAD_OUTPUT\", nzloadOutput_";
  protected final String TEXT_322 = ".toString());" + NL + "\t\t";
  protected final String TEXT_323 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_324 = " - Execute '\"+command_";
  protected final String TEXT_325 = ".toString()+\"' has finished.\");" + NL + "\t\t";
    ...
    public String generate(Object argument)
  {
    ...
    stringBuffer.append(nzloadExePath);
