...
public class TTeradataOutputBeginJava {
  ...
  protected final String TEXT_72 = NL + "                if(log.is";
  protected final String TEXT_73 = "Enabled())";
  protected final String TEXT_74 = NL + "            log.";
  protected final String TEXT_75 = "(\"";
  protected final String TEXT_76 = " - \" ";
  protected final String TEXT_77 = " + ";
  protected final String TEXT_78 = " ";
  protected final String TEXT_79 = ");";
  protected final String TEXT_80 = NL + "            StringBuilder ";
  protected final String TEXT_81 = " = new StringBuilder();";
  protected final String TEXT_82 = NL + "            ";
  protected final String TEXT_83 = ".append(\"Parameters:\");";
  protected final String TEXT_84 = NL + "                    ";
  protected final String TEXT_85 = ".append(\"";
  protected final String TEXT_86 = "\" + \" = \" + String.valueOf(";
  protected final String TEXT_87 = ").substring(0, 4) + \"...\");     ";
  ...
  protected final String TEXT_94 = NL + "            StringBuilder ";
  protected final String TEXT_95 = " = new StringBuilder();    ";
  ...
  protected final String TEXT_104 = ".append(\"<null>\");" + NL + "                    }else{";
  ...
  protected final String TEXT_112 = NL + NL + "int nb_line_";
  protected final String TEXT_113 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_114 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_115 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_116 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_117 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_118 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_119 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_120 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_121 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_122 = " = ";
  protected final String TEXT_123 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_124 = " = false;";
  ...
  protected final String TEXT_130 = NL + "        int updateKeyCount_";
  protected final String TEXT_131 = " = ";
  protected final String TEXT_132 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_133 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_134 = NL + "        int deleteKeyCount_";
  protected final String TEXT_135 = " = ";
  protected final String TEXT_136 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_137 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_138 = NL + "\t String dbname_";
  protected final String TEXT_139 = " = (String)globalMap.get(\"";
  protected final String TEXT_140 = "\");" + NL + "\t String dbUser_";
  protected final String TEXT_141 = " = (String)globalMap.get(\"";
  protected final String TEXT_142 = "\");" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_143 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_144 = "\");" + NL + "\t";
  protected final String TEXT_145 = NL + "\t";
  protected final String TEXT_146 = NL + "    String dbname_";
  protected final String TEXT_147 = " = ";
  protected final String TEXT_148 = ";" + NL + "    String driverClass_";
  protected final String TEXT_149 = " = \"com.teradata.jdbc.TeraDriver\";";
  protected final String TEXT_150 = NL + NL + "    java.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_157 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_158 = ";" + NL + "\t} else {" + NL + "\t    url_";
  protected final String TEXT_159 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_160 = " + \"/\" + ";
  protected final String TEXT_161 = ";" + NL + "\t}" + NL + "    String dbUser_";
  ...
  protected final String TEXT_171 = NL + NL + "    String dbPwd_";
  protected final String TEXT_172 = " = decryptedPassword_";
  protected final String TEXT_173 = ";" + NL + "" + NL + "\t";
  protected final String TEXT_174 = NL + "    java.sql.Connection conn_";
  protected final String TEXT_175 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_176 = ",dbUser_";
  protected final String TEXT_177 = ",dbPwd_";
  ...
  protected final String TEXT_186 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_187 = NL + "                 conn_";
  protected final String TEXT_188 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_189 = NL + "               ";
  protected final String TEXT_190 = " + \"=\" + ";
  protected final String TEXT_191 = " + \";\" +";
  protected final String TEXT_192 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_193 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_194 = ");";
  protected final String TEXT_195 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_196 = "\", conn_";
  protected final String TEXT_197 = ");";
  protected final String TEXT_198 = NL + "        conn_";
  protected final String TEXT_199 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_200 = " = ";
  protected final String TEXT_201 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_202 = " = 0;";
  protected final String TEXT_203 = NL + "String dbschema_";
  protected final String TEXT_204 = " = dbname_";
  protected final String TEXT_205 = ";" + NL + "if(dbname_";
  protected final String TEXT_206 = " == null || dbname_";
  protected final String TEXT_207 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_208 = " = ";
  protected final String TEXT_209 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_210 = " = dbname_";
  protected final String TEXT_211 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_212 = ";" + NL + "}";
  protected final String TEXT_213 = NL + "int count_";
  protected final String TEXT_214 = "=0;";
  protected final String TEXT_215 = "            " + NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_216 = " = conn_";
  protected final String TEXT_217 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_218 = NL + "            stmtDrop_";
  protected final String TEXT_219 = ".execute(\"";
  protected final String TEXT_220 = "\" ";
  protected final String TEXT_221 = ");" + NL + "\t\t\t";
  protected final String TEXT_222 = NL + "            stmtDrop_";
  protected final String TEXT_223 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_224 = " = conn_";
  protected final String TEXT_225 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_226 = NL + "\t\t\t";
  protected final String TEXT_227 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_228 = ".execute(((\"";
  protected final String TEXT_229 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_230 = ".";
  protected final String TEXT_231 = ", \"";
  protected final String TEXT_232 = "\")";
  protected final String TEXT_233 = ".toUpperCase()";
  ...
  protected final String TEXT_246 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_247 = ".execute(((\"";
  protected final String TEXT_248 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_249 = ".";
  protected final String TEXT_250 = ", \"";
  protected final String TEXT_251 = "\")";
  protected final String TEXT_252 = ".toUpperCase()";
  ...
  protected final String TEXT_263 = NL + "\t\t    \t\tString keyCheckTable_";
  protected final String TEXT_264 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_265 = "+\"][\"+";
  protected final String TEXT_266 = "+\"][\"+";
  protected final String TEXT_267 = "+\"][\"+";
  protected final String TEXT_268 = "+\"][\"+";
  protected final String TEXT_269 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_270 = " + \"]\";" + NL + "\t\t    \t";
  protected final String TEXT_271 = NL + "        \t\t    // [%connection%][checktable][tableName]" + NL + "        \t\t    String keyCheckTable_";
  protected final String TEXT_272 = " = conn_";
  protected final String TEXT_273 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_274 = " + \"]\";" + NL + "    \t\t    ";
  protected final String TEXT_275 = NL + "\t\t    " + NL + "\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_276 = ")== null){//}" + NL + "\t\t\t" + NL + "\t\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_277 = ")) {//}" + NL + "\t\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_278 = ")== null){//}" + NL + "\t\t\t";
  protected final String TEXT_279 = "              " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_280 = NL + "    \t\t\t\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_281 = " = conn_";
  protected final String TEXT_282 = ".createStatement();" + NL + "                \t\t\t\tboolean whetherExist_";
  protected final String TEXT_283 = " = false;" + NL + "                \t\t\t\ttry {" + NL + "                \t\t\t\t\tisExistStmt_";
  protected final String TEXT_284 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_285 = " + \"]\" );" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_286 = " = true;" + NL + "                \t\t\t\t} catch (java.lang.Exception e){" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_287 = " = false;" + NL + "                \t\t\t\t}" + NL + "                \t\t\t\tisExistStmt_";
  protected final String TEXT_288 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_289 = "   \t" + NL + "                \t\t\t\t";
  protected final String TEXT_290 = NL + "                \t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_291 = " = conn_";
  protected final String TEXT_292 = ".getMetaData();" + NL + "                \t            if(tableNameForSearch_";
  protected final String TEXT_293 = ".indexOf(\"\\\"\")==-1){" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_294 = " = tableNameForSearch_";
  protected final String TEXT_295 = ".toUpperCase();" + NL + "                            \t}else{" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_296 = " = tableNameForSearch_";
  protected final String TEXT_297 = ".replaceAll(\"\\\"\",\"\");" + NL + "                            \t}" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_298 = " = dbMetaData_";
  protected final String TEXT_299 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_300 = ", tableNameForSearch_";
  protected final String TEXT_301 = ", new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_302 = " = false;" + NL + "                \t            if(rsTable_";
  protected final String TEXT_303 = ".next()) {" + NL + "                \t            \twhetherExist_";
  protected final String TEXT_304 = " = true;" + NL + "                \t            }" + NL + "    \t            \t\t\trsTable_";
  protected final String TEXT_305 = ".close();" + NL + "    \t            " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_306 = "  \t            " + NL + "                \t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_307 = " = conn_";
  protected final String TEXT_308 = ".getMetaData();" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_309 = " = dbMetaData_";
  protected final String TEXT_310 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_311 = " = false;" + NL + "                \t            while(rsTable_";
  protected final String TEXT_312 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_313 = " = rsTable_";
  protected final String TEXT_314 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_315 = " = rsTable_";
  protected final String TEXT_316 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_317 = ".equals";
  protected final String TEXT_318 = "IgnoreCase";
  protected final String TEXT_319 = "(";
  protected final String TEXT_320 = ") " + NL + "                \t                \t&& (schema_";
  ...
  protected final String TEXT_325 = ".trim().length() ==0)) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_326 = " = true;" + NL + "                \t                    break;" + NL + "        \t            \t    \t}" + NL + "                        \t\t}" + NL + "            \t            \trsTable_";
  ...
  protected final String TEXT_343 = ".toUpperCase()";
  protected final String TEXT_344 = ") " + NL + "                \t                \t&& (schema_";
  protected final String TEXT_345 = ".equals";
  protected final String TEXT_346 = "IgnoreCase";
  protected final String TEXT_347 = "(dbschema_";
  protected final String TEXT_348 = ") || (dbschema_";
  protected final String TEXT_349 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_350 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_359 = " = false;" + NL + "                \t            String defaultSchema_";
  protected final String TEXT_360 = " = \"public\";" + NL + "                \t            if(dbschema_";
  protected final String TEXT_361 = " == null || dbschema_";
  protected final String TEXT_362 = ".trim().length() == 0) {" + NL + "                \t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_363 = " = conn_";
  protected final String TEXT_364 = ".createStatement();" + NL + "                \t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_365 = " = stmtSchema_";
  protected final String TEXT_366 = ".executeQuery(\"select current_schema() \");" + NL + "                \t            \twhile(rsSchema_";
  protected final String TEXT_367 = ".next()){" + NL + "                \t            \t\tdefaultSchema_";
  protected final String TEXT_368 = " = rsSchema_";
  protected final String TEXT_369 = ".getString(\"current_schema\");" + NL + "                \t            \t}" + NL + "                \t            \trsSchema_";
  protected final String TEXT_370 = ".close();" + NL + "                \t            \tstmtSchema_";
  protected final String TEXT_371 = ".close();" + NL + "                \t            }" + NL + "                \t            while(rsTable_";
  protected final String TEXT_372 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_373 = " = rsTable_";
  protected final String TEXT_374 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_375 = " = rsTable_";
  protected final String TEXT_376 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_377 = ".equals";
  protected final String TEXT_378 = "IgnoreCase";
  protected final String TEXT_379 = "(";
  protected final String TEXT_380 = ") " + NL + "                \t                \t&& (schema_";
  protected final String TEXT_381 = ".equals";
  protected final String TEXT_382 = "IgnoreCase";
  protected final String TEXT_383 = "(dbschema_";
  protected final String TEXT_384 = ") || ((dbschema_";
  protected final String TEXT_385 = " ==null || dbschema_";
  protected final String TEXT_386 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_387 = ".equals";
  protected final String TEXT_388 = "IgnoreCase";
  protected final String TEXT_389 = "(schema_";
  protected final String TEXT_390 = ")))) {" + NL + "                \t                    whetherExist_";
  protected final String TEXT_391 = " = true;" + NL + "                \t                    break;" + NL + "                \t                }" + NL + "                \t            }" + NL + "                \t            rsTable_";
  ...
  protected final String TEXT_395 = ".getMetaData();" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_396 = " = dbMetaData_";
  protected final String TEXT_397 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_398 = " = false;" + NL + "                \t            while(rsTable_";
  ...
  protected final String TEXT_404 = " = true;" + NL + "                \t                    break;" + NL + "                \t                }" + NL + "                \t            }" + NL + "                \t            rsTable_";
  protected final String TEXT_405 = ".close();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_406 = NL + "                    \t\t\tif(!whetherExist_";
  protected final String TEXT_407 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  protected final String TEXT_408 = " = conn_";
  protected final String TEXT_409 = ".createStatement();" + NL + "                        \t\t\t";
  protected final String TEXT_410 = NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_411 = NL + "    \t\t\t\t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_412 = ".execute(((\"";
  protected final String TEXT_413 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_420 = NL + "    \t\t\t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_421 = ".execute(\"";
  protected final String TEXT_422 = ")\");" + NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_423 = NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_424 = NL + "                    \t\t\t\tstmtCreate_";
  protected final String TEXT_425 = ".close();            " + NL + "                    \t\t\t}                " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_426 = NL + "                                if(whetherExist_";
  protected final String TEXT_427 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_428 = " = conn_";
  protected final String TEXT_429 = ".createStatement();" + NL + "                \t    \t    \t";
  protected final String TEXT_430 = NL + "                                    stmtDrop_";
  protected final String TEXT_431 = ".execute(\"";
  protected final String TEXT_432 = "\" ";
  protected final String TEXT_433 = ");" + NL + "                \t    \t    \t";
  protected final String TEXT_434 = NL + "                                    stmtDrop_";
  protected final String TEXT_435 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_439 = NL + "        \t\t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_440 = ".execute(((\"";
  protected final String TEXT_441 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_442 = ".";
  protected final String TEXT_443 = ", \"";
  protected final String TEXT_444 = "\")";
  protected final String TEXT_445 = ".toUpperCase()";
  protected final String TEXT_446 = ")+\")";
  protected final String TEXT_447 = "\"));" + NL + "        \t\t\t\t\t\t\t";
  protected final String TEXT_448 = NL + "        \t\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_449 = ".execute(\"";
  ...
  protected final String TEXT_455 = NL + "    \t\t\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_456 = ", true);" + NL + "    \t\t//{{{" + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_457 = "            ";
  protected final String TEXT_458 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_459 = " = conn_";
  protected final String TEXT_460 = ".createStatement();" + NL + "    \t   \t";
  protected final String TEXT_461 = NL + "            stmtClear_";
  protected final String TEXT_462 = ".executeUpdate(\"";
  protected final String TEXT_463 = "\");" + NL + "   \t    \t";
  protected final String TEXT_464 = NL + "            stmtClear_";
  protected final String TEXT_465 = ".close();" + NL + "\t\t";
  protected final String TEXT_466 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_467 = " = conn_";
  protected final String TEXT_468 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_469 = " = stmtTruncCount_";
  protected final String TEXT_470 = ".executeQuery(\"";
  protected final String TEXT_471 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_472 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_473 = ".next()) {" + NL + "\t\t\t\trsTruncCountNumber_";
  protected final String TEXT_474 = " = rsTruncCount_";
  protected final String TEXT_475 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_476 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_477 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_482 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_483 = NL + "            stmtTrunc_";
  protected final String TEXT_484 = ".executeUpdate(\"";
  protected final String TEXT_485 = "\");";
  protected final String TEXT_486 = NL + "                if(!conn_";
  protected final String TEXT_487 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_488 = ".commit();" + NL + "                }";
  protected final String TEXT_489 = NL + "   \t    \t";
  protected final String TEXT_490 = NL + "   \t    \tdeletedCount_";
  protected final String TEXT_491 = " += rsTruncCountNumber_";
  protected final String TEXT_492 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_493 = ".close();            " + NL + "\t\t";
  protected final String TEXT_494 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_495 = " = conn_";
  protected final String TEXT_496 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_497 = " = stmtTruncCount_";
  protected final String TEXT_498 = ".executeQuery(\"";
  protected final String TEXT_499 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_500 = " = conn_";
  protected final String TEXT_501 = ".createStatement();" + NL + "  \t    \t";
  protected final String TEXT_502 = NL + "\t\t\t";
  protected final String TEXT_503 = NL + "\t\t\t\tconn_";
  protected final String TEXT_504 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_505 = NL + "            stmtTrunc_";
  protected final String TEXT_506 = ".executeUpdate(\"";
  protected final String TEXT_507 = "\");" + NL + "   \t    \t";
  protected final String TEXT_508 = NL + "            while(rsTruncCount_";
  protected final String TEXT_509 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_510 = " += rsTruncCount_";
  protected final String TEXT_511 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_512 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_513 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_514 = ".close();" + NL + "\t\t";
  protected final String TEXT_515 = NL + "\t    String insert_";
  protected final String TEXT_516 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_517 = " + \"\\\" (";
  protected final String TEXT_518 = ") VALUES (";
  protected final String TEXT_519 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_531 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_532 = " = conn_";
  protected final String TEXT_533 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_534 = " + \"\\\" WHERE ";
  ...
  protected final String TEXT_539 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_546 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_552 = " + \"\\\" SET ";
  protected final String TEXT_553 = " WHERE ";
  protected final String TEXT_554 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_555 = " = conn_";
  protected final String TEXT_556 = ".prepareStatement(update_";
  ...
  protected final String TEXT_561 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_568 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_569 = " = conn_";
  protected final String TEXT_570 = ".prepareStatement(delete_";
  protected final String TEXT_571 = ");" + NL + "\t    ";
  protected final String TEXT_572 = NL + "        StringBuffer query_";
  protected final String TEXT_573 = " = null;" + NL + "       \t";
  protected final String TEXT_574 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_575 = " = insert_";
  protected final String TEXT_576 = ".split(\"\\\\?\");";
  protected final String TEXT_577 = NL + "\t\t\tupdate_";
  protected final String TEXT_578 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_579 = " = update_";
  ...
  protected final String TEXT_584 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_585 = " = insert_";
  protected final String TEXT_586 = ".split(\"\\\\?\");";
  protected final String TEXT_587 = NL + "\t\t\tdelete_";
  protected final String TEXT_588 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_589 = " = delete_";
  protected final String TEXT_590 = ".split(\"\\\\?\");";
  protected final String TEXT_591 = NL + "\t\t\treplace_";
  protected final String TEXT_592 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_593 = " = replace_";
  protected final String TEXT_594 = ".split(\"\\\\?\");";
  protected final String TEXT_595 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_596 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_597 = " = insertIgnore_";
  protected final String TEXT_598 = ".split(\"\\\\?\");";
  protected final String TEXT_599 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_600 = " = insert_";
  protected final String TEXT_601 = ".split(\"\\\\?\");";
  protected final String TEXT_602 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_603 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_604 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_613 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_614 = " = null;";
  protected final String TEXT_615 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_616 = " = null;";
  protected final String TEXT_617 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_618 = " = null;";
  protected final String TEXT_619 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
