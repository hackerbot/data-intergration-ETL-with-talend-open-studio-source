...
public class TDBOutputMainJava {
  ...
  protected final String TEXT_47 = NL + "\t\tquery_";
  protected final String TEXT_48 = " = new StringBuffer(\"\");";
  protected final String TEXT_49 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_50 = " = buffersSize_";
  protected final String TEXT_51 = ";";
  protected final String TEXT_52 = NL + "        whetherReject_";
  ...
  protected final String TEXT_59 = "_QUERY\", query_";
  protected final String TEXT_60 = ".toString().trim());";
  protected final String TEXT_61 = NL + "            try {";
  protected final String TEXT_62 = NL + "                insertedCount_";
  protected final String TEXT_63 = " = insertedCount_";
  protected final String TEXT_64 = " + pstmt_";
  protected final String TEXT_65 = ".executeUpdate(query_";
  protected final String TEXT_66 = ".toString().trim());";
  protected final String TEXT_67 = NL + "                insertedCount_";
  protected final String TEXT_68 = " = insertedCount_";
  protected final String TEXT_69 = " + pstmt_";
  protected final String TEXT_70 = ".executeUpdate();";
  ...
  protected final String TEXT_103 = "_QUERY\", query_";
  protected final String TEXT_104 = ".toString().trim());";
  protected final String TEXT_105 = NL + "            try {";
  protected final String TEXT_106 = NL + "                updatedCount_";
  protected final String TEXT_107 = " = updatedCount_";
  protected final String TEXT_108 = " + pstmt_";
  protected final String TEXT_109 = ".executeUpdate(query_";
  protected final String TEXT_110 = ".toString().trim());";
  protected final String TEXT_111 = NL + "                updatedCount_";
  protected final String TEXT_112 = " = updatedCount_";
  protected final String TEXT_113 = " + pstmt_";
  protected final String TEXT_114 = ".executeUpdate();";
  protected final String TEXT_115 = NL + "                nb_line_";
  protected final String TEXT_116 = "++;";
  protected final String TEXT_117 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_128 = NL + "                        rejectedCount_";
  protected final String TEXT_129 = " = rejectedCount_";
  protected final String TEXT_130 = " + 1;";
  protected final String TEXT_131 = NL + "                        ";
  protected final String TEXT_132 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_133 = NL + "                        ";
  protected final String TEXT_134 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_135 = ";" + NL + "                        ";
  protected final String TEXT_136 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_137 = NL + "            }";
  protected final String TEXT_138 = NL + "                    ";
  protected final String TEXT_139 = NL + "                    query_";
  protected final String TEXT_140 = " = ";
  protected final String TEXT_141 = ";";
  protected final String TEXT_142 = NL + "\t\t\t";
  protected final String TEXT_143 = NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_144 = " = pstmt_";
  protected final String TEXT_145 = ".executeQuery(query_";
  protected final String TEXT_146 = ".toString().trim());" + NL + "    \t\tquery_";
  protected final String TEXT_147 = " = new StringBuffer(\"\");" + NL + "    \t\t";
  protected final String TEXT_148 = NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_149 = " = pstmt_";
  protected final String TEXT_150 = ".executeQuery();" + NL + "    \t\t";
  protected final String TEXT_151 = NL + "    \t\tint checkCount_";
  protected final String TEXT_152 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_153 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_154 = " = rs_";
  protected final String TEXT_155 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_162 = NL + "                            query_";
  protected final String TEXT_163 = " = ";
  protected final String TEXT_164 = ";";
  protected final String TEXT_165 = NL + "                    globalMap.put(\"";
  protected final String TEXT_166 = "_QUERY\", query_";
  protected final String TEXT_167 = ".toString().trim());";
  protected final String TEXT_168 = NL + "                try {";
  ...
  protected final String TEXT_172 = ".executeUpdate(query_";
  protected final String TEXT_173 = ".toString().trim());" + NL + "            \t";
  protected final String TEXT_174 = NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_175 = " = updatedCount_";
  protected final String TEXT_176 = " + pstmtUpdate_";
  protected final String TEXT_177 = ".executeUpdate();" + NL + "            \t";
  protected final String TEXT_178 = NL + "                \tnb_line_";
  protected final String TEXT_179 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_180 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_193 = NL + "                            rejectedCount_";
  protected final String TEXT_194 = " = rejectedCount_";
  protected final String TEXT_195 = " + 1;";
  protected final String TEXT_196 = NL + "                            ";
  protected final String TEXT_197 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_198 = NL + "                            ";
  protected final String TEXT_199 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_200 = ";" + NL + "                            ";
  protected final String TEXT_201 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_202 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_203 = NL + "                        ";
  protected final String TEXT_204 = NL + "                            query_";
  protected final String TEXT_205 = " = ";
  protected final String TEXT_206 = ";";
  protected final String TEXT_207 = NL + "                    globalMap.put(\"";
  protected final String TEXT_208 = "_QUERY\", query_";
  protected final String TEXT_209 = ".toString().trim());";
  protected final String TEXT_210 = NL + "                try {";
  protected final String TEXT_211 = NL + "                    insertedCount_";
  protected final String TEXT_212 = " = insertedCount_";
  protected final String TEXT_213 = " + pstmtInsert_";
  protected final String TEXT_214 = ".executeUpdate(query_";
  protected final String TEXT_215 = ".toString());";
  protected final String TEXT_216 = NL + "                    insertedCount_";
  protected final String TEXT_217 = " = insertedCount_";
  protected final String TEXT_218 = " + pstmtInsert_";
  protected final String TEXT_219 = ".executeUpdate();";
  protected final String TEXT_220 = NL + "                \tnb_line_";
  protected final String TEXT_221 = "++;";
  protected final String TEXT_222 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_223 = " = true;";
  protected final String TEXT_224 = NL + "                        throw(e);";
  protected final String TEXT_225 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_235 = NL + "                            rejectedCount_";
  protected final String TEXT_236 = " = rejectedCount_";
  protected final String TEXT_237 = " + 1;";
  ...
  protected final String TEXT_245 = NL + "    \t    int updateFlag_";
  protected final String TEXT_246 = "=0;" + NL + "    \t    ";
  protected final String TEXT_247 = NL + "                    ";
  protected final String TEXT_248 = NL + "                        query_";
  ...
  protected final String TEXT_256 = "_QUERY\", query_";
  protected final String TEXT_257 = ".toString().trim());";
  protected final String TEXT_258 = NL + "    \t" + NL + "            try {";
  protected final String TEXT_259 = NL + "                updateFlag_";
  protected final String TEXT_260 = "=pstmtUpdate_";
  protected final String TEXT_261 = ".executeUpdate(query_";
  protected final String TEXT_262 = ".toString().trim());";
  protected final String TEXT_263 = NL + "                updateFlag_";
  protected final String TEXT_264 = "=pstmtUpdate_";
  protected final String TEXT_265 = ".executeUpdate();";
  protected final String TEXT_266 = NL + "                updatedCount_";
  protected final String TEXT_267 = " = updatedCount_";
  protected final String TEXT_268 = " + updateFlag_";
  protected final String TEXT_269 = ";" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_280 = NL + "                    insertedCount_";
  protected final String TEXT_281 = " = insertedCount_";
  protected final String TEXT_282 = " + pstmtInsert_";
  protected final String TEXT_283 = ".executeUpdate(query_";
  protected final String TEXT_284 = ".toString().trim());";
  protected final String TEXT_285 = NL + "                    insertedCount_";
  protected final String TEXT_286 = " = insertedCount_";
  protected final String TEXT_287 = " + pstmtInsert_";
  protected final String TEXT_288 = ".executeUpdate();";
  protected final String TEXT_289 = NL + "                \tnb_line_";
  protected final String TEXT_290 = "++;";
  protected final String TEXT_291 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_292 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_293 = NL + "             \t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_294 = " = true;";
  protected final String TEXT_295 = NL + "                        throw(e);";
  protected final String TEXT_296 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_306 = NL + "                            rejectedCount_";
  protected final String TEXT_307 = " = rejectedCount_";
  protected final String TEXT_308 = " + 1;";
  protected final String TEXT_309 = NL + "                            ";
  protected final String TEXT_310 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_311 = NL + "                            ";
  protected final String TEXT_312 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_313 = ";" + NL + "                           ";
  protected final String TEXT_314 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_315 = NL + "                }";
  protected final String TEXT_316 = NL + "                    ";
  protected final String TEXT_317 = NL + "                        query_";
  protected final String TEXT_318 = " = ";
  protected final String TEXT_319 = ";";
  protected final String TEXT_320 = NL + "                globalMap.put(\"";
  protected final String TEXT_321 = "_QUERY\", query_";
  protected final String TEXT_322 = ".toString().trim());";
  protected final String TEXT_323 = NL + "            try {" + NL + "\t\t\t";
  protected final String TEXT_324 = NL + "               deletedCount_";
  protected final String TEXT_325 = " = deletedCount_";
  protected final String TEXT_326 = " + pstmt_";
  protected final String TEXT_327 = ".executeUpdate(query_";
  protected final String TEXT_328 = ".toString().trim());" + NL + "\t\t\t";
  protected final String TEXT_329 = NL + "               deletedCount_";
  protected final String TEXT_330 = " = deletedCount_";
  protected final String TEXT_331 = " + pstmt_";
  protected final String TEXT_332 = ".executeUpdate();" + NL + "\t\t\t";
  protected final String TEXT_333 = NL + "\t\t\t\tnb_line_";
  protected final String TEXT_334 = "++;";
  protected final String TEXT_335 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_336 = " = true;";
  protected final String TEXT_337 = NL + "                    throw(e);";
  ...
  protected final String TEXT_348 = NL + "                        rejectedCount_";
  protected final String TEXT_349 = " = rejectedCount_";
  protected final String TEXT_350 = " + 1;";
  protected final String TEXT_351 = NL + "                        ";
  protected final String TEXT_352 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_353 = NL + "                        ";
  protected final String TEXT_354 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_355 = ";";
  protected final String TEXT_356 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_357 = NL + "            }" + NL + "    \t";
  protected final String TEXT_358 = NL + "            if(!whetherReject_";
  protected final String TEXT_359 = ") {";
  protected final String TEXT_360 = NL + "                            ";
  protected final String TEXT_361 = " = new ";
  protected final String TEXT_362 = "Struct();";
  ...
  protected final String TEXT_369 = NL + "            commitCounter_";
  protected final String TEXT_370 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_371 = " <= commitCounter_";
  protected final String TEXT_372 = ") {" + NL + "            \t";
  protected final String TEXT_373 = NL + "            \tconn_";
  protected final String TEXT_374 = ".commit();" + NL + "            \t";
  protected final String TEXT_375 = " " + NL + "            \tcommitCounter_";
  protected final String TEXT_376 = "=0;" + NL + "            }\t" + NL + "    \t";
...
DBLogUtil dbLog = null;
    ...
    stringBuffer.append(getManager(dbmsId, cid).retrieveSQL(typeToGenerate, column, incomingConnName, cid, "query_" , columnIndex, "checkExistSQLSplits_"));
