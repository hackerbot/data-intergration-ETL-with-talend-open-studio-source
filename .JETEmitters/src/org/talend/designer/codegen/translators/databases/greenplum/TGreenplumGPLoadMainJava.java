...
public class TGreenplumGPLoadMainJava {
  protected static String nl;
  public static synchronized TGreenplumGPLoadMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGreenplumGPLoadMainJava result = new TGreenplumGPLoadMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_4 = " = new StringBuilder(1000);" + NL + "\t\tString temp_";
  protected final String TEXT_5 = " = null;" + NL + "\t\tString rowSepRepl_";
  protected final String TEXT_6 = " = ";
  protected final String TEXT_7 = " + \"\\n\";" + NL + "\t\tString escapeCharRepl_";
  protected final String TEXT_8 = " = ";
  protected final String TEXT_9 = " + ";
  protected final String TEXT_10 = ";" + NL + "\t\tString fieldSeparatorRepl_";
  protected final String TEXT_11 = " = ";
  protected final String TEXT_12 = " + ";
  protected final String TEXT_13 = ";" + NL + "\t\tString null_";
  protected final String TEXT_14 = " = ";
  protected final String TEXT_15 = ";" + NL + "\t\tif (null_";
  protected final String TEXT_16 = ".startsWith(\"'\") && null_";
  protected final String TEXT_17 = ".endsWith(\"'\") && null_";
  protected final String TEXT_18 = ".length() > 2)" + NL + "\t\t\tnull_";
  protected final String TEXT_19 = " = null_";
  protected final String TEXT_20 = ".substring(2,null_";
  protected final String TEXT_21 = ".length()-1);" + NL + "\t\t";
  protected final String TEXT_22 = NL + "\t\tString quoteCharRepl_";
  ...
  protected final String TEXT_29 = " == null)" + NL + "\t\t\t\t\t\tsb_";
  protected final String TEXT_30 = ".append(null_";
  protected final String TEXT_31 = ");" + NL + "\t\t\t\t\telse {" + NL + "\t\t\t\t\t";
  protected final String TEXT_32 = " sb_";
  protected final String TEXT_33 = ".append(TalendDate.formatDate(";
  protected final String TEXT_34 = ",";
  protected final String TEXT_35 = ".";
  protected final String TEXT_36 = ")); ";
  protected final String TEXT_37 = " sb_";
  protected final String TEXT_38 = ".append(String.format(\"%-";
  protected final String TEXT_39 = ".";
  protected final String TEXT_40 = "f\",";
  protected final String TEXT_41 = ".";
  protected final String TEXT_42 = ")); ";
  protected final String TEXT_43 = " sb_";
  protected final String TEXT_44 = ".append(String.format(\"%-";
  protected final String TEXT_45 = "d\",";
  protected final String TEXT_46 = ".";
  protected final String TEXT_47 = ")); ";
  protected final String TEXT_48 = " sb_";
  protected final String TEXT_49 = ".append(String.valueOf(";
  protected final String TEXT_50 = ".";
  protected final String TEXT_51 = ")); ";
  protected final String TEXT_52 = " sb_";
  protected final String TEXT_53 = ".append((";
  protected final String TEXT_54 = ".";
  protected final String TEXT_55 = " ? \"1\" : \"0\")); ";
  protected final String TEXT_56 = " sb_";
  protected final String TEXT_57 = ".append(String.valueOf(";
  protected final String TEXT_58 = ".";
  protected final String TEXT_59 = ")); ";
  protected final String TEXT_60 = NL + "\t\t\t\t\t} // close if equals to null" + NL + "\t\t\t\t\t";
  protected final String TEXT_61 = NL + "\t\t\t\t\tif (";
  protected final String TEXT_62 = ".";
  protected final String TEXT_63 = " == null)" + NL + "\t\t\t\t\t\tsb_";
  protected final String TEXT_64 = ".append(null_";
  protected final String TEXT_65 = ");" + NL + "\t\t\t\t\telse {" + NL + "\t\t\t\t\t";
  protected final String TEXT_66 = " sb_";
  protected final String TEXT_67 = ".append(TalendDate.formatDate(";
  protected final String TEXT_68 = ",";
  protected final String TEXT_69 = ".";
  protected final String TEXT_70 = ")); ";
  protected final String TEXT_71 = " sb_";
  protected final String TEXT_72 = ".append(String.format(\"%-";
  protected final String TEXT_73 = ".";
  protected final String TEXT_74 = "f\",";
  protected final String TEXT_75 = ".";
  protected final String TEXT_76 = ")); ";
  protected final String TEXT_77 = " sb_";
  protected final String TEXT_78 = ".append(String.format(\"%-";
  protected final String TEXT_79 = "d\",";
  protected final String TEXT_80 = ".";
  protected final String TEXT_81 = ")); ";
  protected final String TEXT_82 = " sb_";
  protected final String TEXT_83 = ".append(String.valueOf(";
  protected final String TEXT_84 = ".";
  protected final String TEXT_85 = ")); ";
  protected final String TEXT_86 = " sb_";
  protected final String TEXT_87 = ".append((";
  protected final String TEXT_88 = ".";
  protected final String TEXT_89 = " ? \"1\" : \"0\")); ";
  protected final String TEXT_90 = " " + NL + "\t\t\t\t\ttemp_";
  protected final String TEXT_91 = " = String.valueOf(";
  protected final String TEXT_92 = ".";
  protected final String TEXT_93 = ");" + NL + "\t\t\t\t\ttemp_";
  protected final String TEXT_94 = " = temp_";
  protected final String TEXT_95 = ".replace(";
  protected final String TEXT_96 = ",escapeCharRepl_";
  protected final String TEXT_97 = ");" + NL + "\t\t\t\t\ttemp_";
  protected final String TEXT_98 = " = temp_";
  protected final String TEXT_99 = ".replace(";
  protected final String TEXT_100 = ",quoteCharRepl_";
  protected final String TEXT_101 = ");" + NL + "\t\t\t\t\ttemp_";
  protected final String TEXT_102 = " = temp_";
  protected final String TEXT_103 = ".replace(\"\\n\",rowSepRepl_";
  protected final String TEXT_104 = ");" + NL + "\t\t\t\t\tsb_";
  protected final String TEXT_105 = ".append(";
  protected final String TEXT_106 = " + temp_";
  protected final String TEXT_107 = " + ";
  protected final String TEXT_108 = ");" + NL + "\t\t\t\t\ttemp_";
  protected final String TEXT_109 = " = null;" + NL + "\t\t\t\t\t";
  protected final String TEXT_110 = NL + "\t\t\t\t\t} // close if equals to null" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_116 = NL + "\t\toutputStream_";
  protected final String TEXT_117 = ".write(sb_";
  protected final String TEXT_118 = ".toString().getBytes());" + NL + "\t\t";
  protected final String TEXT_119 = NL + "            log4jSb_";
  protected final String TEXT_120 = ".append(sb_";
  protected final String TEXT_121 = ".toString());" + NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_122 = " - Loading the record :\" + log4jSb_";
  protected final String TEXT_123 = ");" + NL + "\t\t\tlog4jSb_";
  protected final String TEXT_124 = ".delete(0,log4jSb_";
  protected final String TEXT_125 = ".length());" + NL + "\t\t";
  protected final String TEXT_126 = NL + "\t\tsb_";
