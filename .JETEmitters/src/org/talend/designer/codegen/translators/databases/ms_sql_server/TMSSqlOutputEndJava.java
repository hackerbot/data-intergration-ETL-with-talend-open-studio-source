...
public class TMSSqlOutputEndJava {
  protected static String nl;
  public static synchronized TMSSqlOutputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMSSqlOutputEndJava result = new TMSSqlOutputEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_43 = NL + "\t\tif ( isShareIdentity_";
  protected final String TEXT_44 = " ) {" + NL + "\t\t\tString setIdentityInsertONSQL_";
  protected final String TEXT_45 = " = \"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_46 = " +\"] ON\";" + NL + "\t\t\t";
  protected final String TEXT_47 = NL + "        \tstmt_";
  protected final String TEXT_48 = ".execute(setIdentityInsertONSQL_";
  protected final String TEXT_49 = ");" + NL + "\t\t\t";
  protected final String TEXT_50 = NL + "        }";
  protected final String TEXT_51 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_52 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_53 = ".close();" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_54 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_55 = ".close();" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_56 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_57 = ".close();" + NL + "        }";
  protected final String TEXT_58 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_59 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_60 = ".close();" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_61 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_62 = ".close();" + NL + "        }";
  protected final String TEXT_63 = NL + "        if(pstmtInsert_";
  protected final String TEXT_64 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_65 = ".close();" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_66 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_67 = ".close();" + NL + "        }";
  protected final String TEXT_68 = NL;
  protected final String TEXT_69 = NL + "        if(bufferL";
  protected final String TEXT_70 = ".";
  protected final String TEXT_71 = "==null){";
  protected final String TEXT_72 = NL + "            ";
  protected final String TEXT_73 = ".setNull(count";
  protected final String TEXT_74 = ",java.sql.Types.CHAR);" + NL + "\t\t";
  protected final String TEXT_75 = NL + "\t\t        if(bufferL";
  protected final String TEXT_76 = ".";
  protected final String TEXT_77 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_78 = ".setNull(count";
  protected final String TEXT_79 = ",java.sql.Types.DATE);" + NL + "\t\t";
  protected final String TEXT_80 = NL + "\t\t        if(bufferL";
  protected final String TEXT_81 = ".";
  protected final String TEXT_82 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_83 = ".setNull(count";
  protected final String TEXT_84 = ",java.sql.Types.ARRAY);" + NL + "\t\t";
  protected final String TEXT_85 = NL + "\t\t        if(bufferL";
  protected final String TEXT_86 = ".";
  protected final String TEXT_87 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_88 = ".setNull(count";
  protected final String TEXT_89 = ",java.sql.Types.INTEGER);" + NL + "\t\t";
  protected final String TEXT_90 = NL + "\t\t        if(bufferL";
  protected final String TEXT_91 = ".";
  protected final String TEXT_92 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_93 = ".setNull(count";
  protected final String TEXT_94 = ",java.sql.Types.VARCHAR);" + NL + "\t\t";
  protected final String TEXT_95 = NL + "\t\t        if(bufferL";
  protected final String TEXT_96 = ".";
  protected final String TEXT_97 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_98 = ".setNull(count";
  protected final String TEXT_99 = ",java.sql.Types.OTHER);" + NL + "\t\t";
  protected final String TEXT_100 = NL + "\t\t        if(bufferL";
  protected final String TEXT_101 = ".";
  protected final String TEXT_102 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_103 = ".setNull(count";
  protected final String TEXT_104 = ",java.sql.Types.BOOLEAN);" + NL + "\t\t";
  protected final String TEXT_105 = NL + "\t\t        if(bufferL";
  protected final String TEXT_106 = ".";
  protected final String TEXT_107 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_108 = ".setNull(count";
  protected final String TEXT_109 = ",java.sql.Types.DOUBLE);" + NL + "\t\t";
  protected final String TEXT_110 = NL + "\t\t        if(bufferL";
  protected final String TEXT_111 = ".";
  protected final String TEXT_112 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_113 = ".setNull(count";
  protected final String TEXT_114 = ",java.sql.Types.FLOAT);" + NL + "\t\t";
  protected final String TEXT_115 = NL + NL + "\t\t        }else{" + NL + "\t\t";
  protected final String TEXT_116 = NL + "\t\t";
  protected final String TEXT_117 = NL + "\t\t        if(bufferL";
  protected final String TEXT_118 = ".";
  protected final String TEXT_119 = "==null){" + NL + "\t\t";
  protected final String TEXT_120 = NL + "\t\t        if((\"null\").equals(String.valueOf(bufferL";
  protected final String TEXT_121 = ".";
  protected final String TEXT_122 = ").toLowerCase())){" + NL + "\t\t";
  protected final String TEXT_123 = NL + "\t\t    ";
  protected final String TEXT_124 = ".setNull(count";
  protected final String TEXT_125 = ",java.sql.Types.CHAR);" + NL + "" + NL + "\t\t    } else if(bufferL";
  protected final String TEXT_126 = ".";
  protected final String TEXT_127 = " == '\\0') {" + NL + "" + NL + "\t\t        ";
  protected final String TEXT_128 = ".setString(count";
  protected final String TEXT_129 = ",\"\");" + NL + "" + NL + "\t\t    } else {" + NL + "" + NL + "\t\t        ";
  protected final String TEXT_130 = ".setString(count";
  protected final String TEXT_131 = ",String.valueOf(bufferL";
  protected final String TEXT_132 = ".";
  protected final String TEXT_133 = "));" + NL + "\t\t    }" + NL + "\t\t";
  protected final String TEXT_134 = NL + "\t\t        if(bufferL";
  protected final String TEXT_135 = ".";
  protected final String TEXT_136 = "!=null){" + NL + "\t\t            // timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t            date_";
  protected final String TEXT_137 = " = bufferL";
  protected final String TEXT_138 = ".";
  protected final String TEXT_139 = ".getTime();" + NL + "\t\t            if (date_";
  protected final String TEXT_140 = " < year1_";
  protected final String TEXT_141 = " || date_";
  protected final String TEXT_142 = " >= year10000_";
  protected final String TEXT_143 = ") {" + NL + "\t\t                ";
  protected final String TEXT_144 = ".setString(count";
  protected final String TEXT_145 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t            } else {" + NL + "\t\t\t\t";
  protected final String TEXT_146 = NL + "                    \t";
  protected final String TEXT_147 = ".setString(count";
  protected final String TEXT_148 = ",TalendDate.formatDate(";
  protected final String TEXT_149 = ", ";
  protected final String TEXT_150 = ".";
  protected final String TEXT_151 = "));" + NL + "\t\t\t\t";
  protected final String TEXT_152 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_153 = ".setString(count";
  protected final String TEXT_154 = ",TalendDate.formatDatetimeoffset(";
  protected final String TEXT_155 = ".";
  protected final String TEXT_156 = "));" + NL + "\t\t\t\t";
  protected final String TEXT_157 = NL + "\t\t                ";
  protected final String TEXT_158 = ".setTimestamp(count";
  protected final String TEXT_159 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_160 = "));" + NL + "\t\t\t\t";
  protected final String TEXT_161 = NL + "\t\t         ";
  protected final String TEXT_162 = NL + "\t\t                ";
  protected final String TEXT_163 = ".setTimestamp(count";
  protected final String TEXT_164 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_165 = "),calendar_datetimeoffset_";
  protected final String TEXT_166 = ");" + NL + "\t\t         ";
  protected final String TEXT_167 = NL + "\t\t         \t\t";
  protected final String TEXT_168 = ".setTimestamp(count";
  protected final String TEXT_169 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_170 = "));" + NL + "\t\t         ";
  protected final String TEXT_171 = NL + "\t\t\t\t";
  protected final String TEXT_172 = NL + "\t\t            }" + NL + "\t\t        }else{" + NL + "\t\t            ";
  protected final String TEXT_173 = ".setNull(count";
  protected final String TEXT_174 = ",java.sql.Types.DATE);" + NL + "\t\t        }" + NL + "\t\t";
  protected final String TEXT_175 = NL + "\t\t        ";
  protected final String TEXT_176 = ".set";
  protected final String TEXT_177 = "(count";
  protected final String TEXT_178 = ",bufferL";
  protected final String TEXT_179 = ".";
  protected final String TEXT_180 = ");" + NL + "\t\t        ";
  protected final String TEXT_181 = NL + "\t\t        }" + NL + "\t\t";
  protected final String TEXT_182 = NL + "\t\tif(rowCount";
  protected final String TEXT_183 = "!=0){" + NL + "" + NL + "\t\tStringBuilder singleQueryInsertValueStmt = new StringBuilder();" + NL + "\t\tfor(int i=0 ; i < rowCount";
  protected final String TEXT_184 = " ; i++){" + NL + "\t\t     singleQueryInsertValueStmt.append(\"(\"+insertColValue";
  protected final String TEXT_185 = "+\")\");" + NL + "\t\t     if (i != rowCount";
  protected final String TEXT_186 = " - 1)" + NL + "\t\t    \t singleQueryInsertValueStmt.append(\",\");" + NL + "\t\t}" + NL + "" + NL + "\t\tinsert_";
  protected final String TEXT_187 = " = \"INSERT INTO \"+";
  protected final String TEXT_188 = "+\" (\"+insertColName";
  protected final String TEXT_189 = "+\") VALUES \"+singleQueryInsertValueStmt.toString();" + NL + "" + NL + "\t\tpstmt_";
  protected final String TEXT_190 = " = conn_";
  protected final String TEXT_191 = ".prepareStatement(insert_";
  protected final String TEXT_192 = ");" + NL + "\t\tint row2Count";
  protected final String TEXT_193 = " = 0;" + NL + "\t\t";
  protected final String TEXT_194 = NL + "\t\t\tint count";
  protected final String TEXT_195 = " = 1;" + NL + "\t\t";
  protected final String TEXT_196 = NL + "\t\tint count";
  protected final String TEXT_197 = " = 0;" + NL + "\t\t";
  protected final String TEXT_198 = NL + NL + "\t\tfor(BufferLine_";
  protected final String TEXT_199 = " bufferL";
  protected final String TEXT_200 = " : sInsertColValueList";
  protected final String TEXT_201 = "){" + NL + "\t\t";
  protected final String TEXT_202 = NL + "\t\t    \tcount";
  protected final String TEXT_203 = " = row2Count";
  protected final String TEXT_204 = "*";
  protected final String TEXT_205 = "+1;" + NL + "\t\t\t";
  protected final String TEXT_206 = NL + "\t\t    \tcount";
  protected final String TEXT_207 = " = row2Count";
  protected final String TEXT_208 = "*";
  protected final String TEXT_209 = "+1;" + NL + "\t\t\t";
  protected final String TEXT_210 = NL + "\t\t            count";
  protected final String TEXT_211 = "++;" + NL + "\t\t            ";
  protected final String TEXT_212 = NL + "\t\t\t\tint count_dyn_";
  protected final String TEXT_213 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_214 = ".";
  protected final String TEXT_215 = ", pstmt_";
  protected final String TEXT_216 = ", count";
  protected final String TEXT_217 = "-1, \"";
  protected final String TEXT_218 = "\");" + NL + "\t\t\t\tcount";
  protected final String TEXT_219 = "+=count_dyn_";
  protected final String TEXT_220 = ";" + NL + "\t\t\t";
  protected final String TEXT_221 = NL + NL + "\t\t    row2Count";
  protected final String TEXT_222 = "++;" + NL + "\t\t}" + NL + "\t\tinsertedCount_";
  protected final String TEXT_223 = " = insertedCount_";
  protected final String TEXT_224 = " + pstmt_";
  protected final String TEXT_225 = ".executeUpdate();" + NL + "\t\t}";
  protected final String TEXT_226 = NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_227 = " = 0;" + NL + "\t\t\t\t\t\tif (pstmt_";
  protected final String TEXT_228 = " != null && batchSizeCounter_";
  protected final String TEXT_229 = " > 0) {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_230 = NL + "\t\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_231 = ": pstmt_";
  protected final String TEXT_232 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_233 = " == -2 || countEach_";
  protected final String TEXT_234 = " == -3) {" + NL + "\t\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_235 = " += countEach_";
  protected final String TEXT_236 = ";" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_237 = NL + "\t\t\t\t\t\t}" + NL + "            \t    \t";
  protected final String TEXT_238 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_239 = " += countSum_";
  protected final String TEXT_240 = ";" + NL + "            \t    \t";
  protected final String TEXT_241 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_242 = " += countSum_";
  protected final String TEXT_243 = ";" + NL + "            \t    \t";
  protected final String TEXT_244 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_245 = " += countSum_";
  protected final String TEXT_246 = ";" + NL + "            \t    \t";
  protected final String TEXT_247 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_248 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_249 = NL + "                \tint countSum_";
  protected final String TEXT_250 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_251 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_252 = " += (countEach_";
  protected final String TEXT_253 = " < 0 ? 0 : countEach_";
  protected final String TEXT_254 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_255 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_256 = " += countSum_";
  protected final String TEXT_257 = ";" + NL + "            \t    \t";
  protected final String TEXT_258 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_259 = " += countSum_";
  protected final String TEXT_260 = ";" + NL + "            \t    \t";
  protected final String TEXT_261 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_262 = " += countSum_";
  protected final String TEXT_263 = ";" + NL + "            \t    \t";
  protected final String TEXT_264 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_265 = NL + "            \t}";
  protected final String TEXT_266 = NL + "        if(pstmt_";
  protected final String TEXT_267 = " != null) {" + NL + "\t\t\t";
  protected final String TEXT_268 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_269 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_270 = NL + "\t\t\t\tSharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
  protected final String TEXT_271 = ");" + NL + "\t\t\t";
  protected final String TEXT_272 = NL + "        }";
  protected final String TEXT_273 = NL + "    String setIdentityInsertOFFSQL_";
  protected final String TEXT_274 = " = \"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_275 = " +\"] OFF\";";
  protected final String TEXT_276 = NL + "    stmt_";
  protected final String TEXT_277 = ".execute(setIdentityInsertOFFSQL_";
  protected final String TEXT_278 = ");";
  protected final String TEXT_279 = NL + "    stmt_";
  protected final String TEXT_280 = ".close();";
  protected final String TEXT_281 = NL;
  protected final String TEXT_282 = NL + "            conn_";
  protected final String TEXT_283 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_284 = NL + "        conn_";
  protected final String TEXT_285 = " .close();";
  protected final String TEXT_286 = NL + "        resourceMap.put(\"finish_";
  protected final String TEXT_287 = "\", true);";
  protected final String TEXT_288 = NL;
  protected final String TEXT_289 = NL + "\tnb_line_deleted_";
  protected final String TEXT_290 = "=nb_line_deleted_";
  protected final String TEXT_291 = "+ deletedCount_";
  protected final String TEXT_292 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_293 = "=nb_line_update_";
  protected final String TEXT_294 = " + updatedCount_";
  protected final String TEXT_295 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_296 = "=nb_line_inserted_";
  protected final String TEXT_297 = " + insertedCount_";
  protected final String TEXT_298 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_299 = "=nb_line_rejected_";
  protected final String TEXT_300 = " + rejectedCount_";
  protected final String TEXT_301 = ";" + NL + "\t";
  protected final String TEXT_302 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_303 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_304 = "_NB_LINE\",nb_line_";
  protected final String TEXT_305 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_306 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_307 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_308 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_309 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_310 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_311 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_312 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_313 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_314 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_315 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_316 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_317 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_318 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_319 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_320 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_321 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_322 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_323 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_324 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_325 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_326 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_327 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_328 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_329 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_330 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_331 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  protected final String TEXT_332 = ");" + NL + "        }" + NL + "\t";
  protected final String TEXT_333 = NL + "        globalMap.put(\"";
  protected final String TEXT_334 = "_NB_LINE\",nb_line_";
  protected final String TEXT_335 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_336 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_337 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_338 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_339 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_340 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_341 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_342 = "_NB_LINE_REJECTED\", nb_line_rejected_";
