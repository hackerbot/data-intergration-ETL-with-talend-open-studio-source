...
public class TPostgresqlSCDELTEndJava {
  protected static String nl;
  public static synchronized TPostgresqlSCDELTEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresqlSCDELTEndJava result = new TPostgresqlSCDELTEndJava();
    nl = null;
    return result;
  }
