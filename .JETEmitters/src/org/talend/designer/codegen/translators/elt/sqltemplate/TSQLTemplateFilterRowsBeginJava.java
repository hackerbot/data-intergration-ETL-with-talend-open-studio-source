...
public class TSQLTemplateFilterRowsBeginJava {
  protected static String nl;
  public static synchronized TSQLTemplateFilterRowsBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLTemplateFilterRowsBeginJava result = new TSQLTemplateFilterRowsBeginJava();
    nl = null;
    return result;
  }
