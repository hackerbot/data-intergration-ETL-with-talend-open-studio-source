...
public class TSQLTemplateFilterColumnsBeginJava {
  protected static String nl;
  public static synchronized TSQLTemplateFilterColumnsBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLTemplateFilterColumnsBeginJava result = new TSQLTemplateFilterColumnsBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_7 = NL + "String tableName_";
  protected final String TEXT_8 = " = ";
  protected final String TEXT_9 = ";";
  protected final String TEXT_10 = NL + "            stmt_";
  protected final String TEXT_11 = ".execute(\"";
  protected final String TEXT_12 = "\");" + NL + "            stmt_";
  protected final String TEXT_13 = ".execute(\"";
  protected final String TEXT_14 = "\");";
  protected final String TEXT_15 = NL + "            stmt_";
  protected final String TEXT_16 = ".execute(\"";
  protected final String TEXT_17 = "\");";
  protected final String TEXT_18 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_19 = " = conn_";
  protected final String TEXT_20 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_21 = " = dbMetaData_";
  protected final String TEXT_22 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_23 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_24 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_25 = " = rsTable_";
  protected final String TEXT_26 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_27 = ".equalsIgnoreCase(";
  protected final String TEXT_28 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_29 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  protected final String TEXT_30 = NL + "                if(!whetherExist_";
  protected final String TEXT_31 = ") {" + NL + "                    stmt_";
  protected final String TEXT_32 = ".execute(\"";
  protected final String TEXT_33 = "\");            " + NL + "                }                ";
  protected final String TEXT_34 = NL + "                if(whetherExist_";
  protected final String TEXT_35 = ") {" + NL + "                    stmt_";
  protected final String TEXT_36 = ".execute(\"";
  protected final String TEXT_37 = "\");" + NL + "                }" + NL + "                stmt_";
