...
public class TSQLTemplateAggregateBeginJava {
  protected static String nl;
  public static synchronized TSQLTemplateAggregateBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLTemplateAggregateBeginJava result = new TSQLTemplateAggregateBeginJava();
    nl = null;
    return result;
  }
