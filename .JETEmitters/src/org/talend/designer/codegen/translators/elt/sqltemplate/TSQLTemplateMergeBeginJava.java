...
public class TSQLTemplateMergeBeginJava {
  protected static String nl;
  public static synchronized TSQLTemplateMergeBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLTemplateMergeBeginJava result = new TSQLTemplateMergeBeginJava();
    nl = null;
    return result;
  }
