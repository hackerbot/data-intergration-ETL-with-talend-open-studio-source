...
public class TELTTeradataOutputMainJava
{
  ...
  protected final String TEXT_71 = NL + "\tString select_query = null;" + NL + "\tString selectQueryColumnsName = null;" + NL + "\t";
  ...
  protected final String TEXT_84 = " = \"com.teradata.jdbc.TeraDriver\";" + NL + "\tjava.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_88 = ";" + NL + "    String dbUser_";
  protected final String TEXT_89 = " = ";
  protected final String TEXT_90 = ";" + NL;
  protected final String TEXT_91 = NL;
  protected final String TEXT_92 = NL + "    ";
  protected final String TEXT_93 = "String decryptedPassword_";
  ...
  protected final String TEXT_98 = NL + "\tdecryptedPassword_";
  protected final String TEXT_99 = " = ";
  protected final String TEXT_100 = "; ";
  protected final String TEXT_101 = NL + NL + "    String dbPwd_";
  protected final String TEXT_102 = " = decryptedPassword_";
  protected final String TEXT_103 = ";";
  protected final String TEXT_104 = NL + "\t\t     //add query band begin" + NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_105 = " =  conn_";
  protected final String TEXT_106 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_107 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_108 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_109 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_110 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_111 = NL + "                 conn_";
  protected final String TEXT_112 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_113 = NL + "               ";
  protected final String TEXT_114 = " + \"=\" + ";
  protected final String TEXT_115 = " + \";\" +";
  protected final String TEXT_116 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               e.printStackTrace();" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_117 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_118 = ");" + NL + "   \t";
  protected final String TEXT_119 = NL;
  protected final String TEXT_120 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_121 = " =null;" + NL;
  protected final String TEXT_122 = NL + NL + "\tString tableName_";
  protected final String TEXT_123 = " = ";
  protected final String TEXT_124 = ";";
  protected final String TEXT_125 = NL + NL + NL + "String insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_126 = "+\" (";
  protected final String TEXT_127 = ") \"+select_query;" + NL + "pstmt_";
  protected final String TEXT_128 = " = conn_";
  protected final String TEXT_129 = ".prepareStatement(insertQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_130 = NL + NL + "String updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_131 = "+\" FROM (\" + select_query + \") src SET ";
  protected final String TEXT_132 = " \"";
  protected final String TEXT_133 = NL + "+\"  WHERE \" + ";
  protected final String TEXT_134 = NL + ";" + NL + "pstmt_";
  protected final String TEXT_135 = " = conn_";
  protected final String TEXT_136 = ".prepareStatement(updateQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_137 = NL + NL + "String deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_138 = "+\" WHERE EXISTS (\"+select_query+\") \"";
  protected final String TEXT_139 = NL + "+\"  AND \" + ";
  protected final String TEXT_140 = NL + ";" + NL + "pstmt_";
  protected final String TEXT_141 = " = conn_";
  protected final String TEXT_142 = ".prepareStatement(deleteQuery);" + NL + "" + NL + "\t";
  ...
  protected final String TEXT_148 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");";
  protected final String TEXT_149 = NL + "nb_line_inserted_";
  ...
  protected final String TEXT_155 = NL + "nb_line_updated_";
  protected final String TEXT_156 = " = pstmt_";
  protected final String TEXT_157 = ".executeUpdate();";
  protected final String TEXT_158 = NL + "\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_159 = " + \" rows updated. \\n\");" + NL + "\t";
  protected final String TEXT_160 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_161 = NL + "\t\tnb_line_deleted_";
  protected final String TEXT_162 = " = pstmt_";
  protected final String TEXT_163 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_164 = NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_165 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  protected final String TEXT_166 = NL + NL + "pstmt_";
  protected final String TEXT_167 = ".close();" + NL;
  protected final String TEXT_168 = NL + "    if(conn_";
  protected final String TEXT_169 = " != null && !conn_";
  protected final String TEXT_170 = ".isClosed()) {" + NL + "    \t";
  protected final String TEXT_171 = NL + "\t\t    conn_";
  protected final String TEXT_172 = ".setAutoCommit(true);" + NL + "\t\t    try{" + NL + "\t\t         conn_";
  protected final String TEXT_173 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");" + NL + "\t\t         ";
  protected final String TEXT_174 = NL + "                            try{" + NL + "                                conn_";
  protected final String TEXT_175 = ".createStatement().execute(\"END QUERY LOGGING ON \" + ";
  protected final String TEXT_176 = ");" + NL + "                            }catch(Exception e){" + NL + "                                  System.err.println(e.getMessage());" + NL + "                            }";
  protected final String TEXT_177 = NL + "\t\t     }catch(Exception e){" + NL + "\t\t         e.printStackTrace();" + NL + "\t\t     }" + NL + "\t";
  protected final String TEXT_178 = NL + "\t\t";
  protected final String TEXT_179 = NL + "    }";
  protected final String TEXT_180 = NL + "nb_line_";
  protected final String TEXT_181 = " = nb_line_updated_";
  protected final String TEXT_182 = " + nb_line_inserted_";
  protected final String TEXT_183 = " + nb_line_deleted_";
  protected final String TEXT_184 = ";" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_185 = "_NB_LINE\",nb_line_";
  protected final String TEXT_186 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_187 = "_NB_LINE_UPDATED\",nb_line_updated_";
  ...
  protected final String TEXT_191 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_192 = ");" + NL;
  protected final String TEXT_193 = NL + "\tlog.info(\"";
  protected final String TEXT_194 = " - Has ";
  protected final String TEXT_195 = " records count: \" + nb_line_";
...
for(Column colStmt:stmtStructure){
	String suffix = ",";
		...
		if(colStmt.isAddCol()){
			...
			updateSetStmt.append(colStmt.getName()+"= src\"+ routines.system.StringUtils.splitSQLColumns(selectQueryColumnsName)[ "+ counterOuter + "].substring(routines.system.StringUtils.splitSQLColumns(selectQueryColumnsName)["+ counterOuter + "].indexOf(\".\"))+\"" +suffix);
		}
		counterOuter ++;
}
