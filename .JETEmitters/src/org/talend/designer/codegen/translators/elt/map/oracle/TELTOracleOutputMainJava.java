...
public class TELTOracleOutputMainJava
{
  ...
  protected final String TEXT_127 = NL + "\tString atnParams_";
  protected final String TEXT_128 = " = ";
  protected final String TEXT_129 = ";" + NL + "\tatnParams_";
  protected final String TEXT_130 = " = atnParams_";
  protected final String TEXT_131 = ".replaceAll(\"&\", \"\\n\");" + NL + "\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_132 = " = new java.util.Properties();" + NL + "\tatnParamsPrope_";
  protected final String TEXT_133 = ".put(\"user\",dbUser_";
  protected final String TEXT_134 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_135 = ".put(\"password\",dbPwd_";
  protected final String TEXT_136 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_137 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_138 = ".getBytes()));" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_139 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_140 = ", atnParamsPrope_";
  protected final String TEXT_141 = ");";
  protected final String TEXT_142 = NL;
  protected final String TEXT_143 = NL;
  protected final String TEXT_144 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_145 = " =null;" + NL + "\t";
  protected final String TEXT_146 = "\t" + NL + "\tString insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_147 = "+\"(";
  protected final String TEXT_148 = ") (\"+select_query+\")\";";
  protected final String TEXT_149 = "\t" + NL + "\t    StringBuffer insertStringBuffer_";
  protected final String TEXT_150 = " = new StringBuffer(insertQuery);" + NL + "\t    insertStringBuffer_";
  protected final String TEXT_151 = ".insert(insertQuery.indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_152 = " + \" \");" + NL + "\t    insertQuery =insertStringBuffer_";
  protected final String TEXT_153 = ".toString(); ";
  protected final String TEXT_154 = "   " + NL + "\tpstmt_";
  protected final String TEXT_155 = " = conn_";
  protected final String TEXT_156 = ".prepareStatement(insertQuery);" + NL;
  protected final String TEXT_157 = NL + "\tString updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_158 = "+\" SET (";
  protected final String TEXT_159 = ") = (\"+select_query+\") \"";
  protected final String TEXT_160 = NL + "\t\t+\"  WHERE \" + ";
  protected final String TEXT_161 = NL + "\t;";
  protected final String TEXT_162 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_163 = " = new StringBuffer(updateQuery);" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_164 = ".insert(updateQuery.indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_165 = "  + \" \");" + NL + "\t    updateQuery =updateStringBuffer_";
  protected final String TEXT_166 = ".toString(); ";
  protected final String TEXT_167 = NL + "\tpstmt_";
  protected final String TEXT_168 = " = conn_";
  protected final String TEXT_169 = ".prepareStatement(updateQuery);" + NL;
  protected final String TEXT_170 = NL + "\t" + NL + "String deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_171 = "+\" WHERE EXISTS (\"+select_query+\") \" ";
  protected final String TEXT_172 = NL + "+\"  AND \" + ";
  protected final String TEXT_173 = NL + ";";
  protected final String TEXT_174 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_175 = " = new StringBuffer(deleteQuery);" + NL + "    deleteStringBuffer_";
  protected final String TEXT_176 = ".insert(deleteQuery.indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_177 = "  + \" \" );" + NL + "    deleteQuery =deleteStringBuffer_";
  protected final String TEXT_178 = ".toString();  ";
  protected final String TEXT_179 = NL + "pstmt_";
  protected final String TEXT_180 = " = conn_";
  protected final String TEXT_181 = ".prepareStatement(deleteQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_182 = NL + "\tString mergeQuery = \"MERGE INTO \"+ tableName_";
  protected final String TEXT_183 = " +\" target\"  + \" USING (\" + select_query + \") source ON (\" +" + NL + "\t" + NL + "\t\t\"";
  protected final String TEXT_184 = "\" + \")\" ;" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_185 = NL + "\t\t\tmergeQuery += \" WHEN MATCHED THEN UPDATE SET ";
  protected final String TEXT_186 = " \" ;\t" + NL + "\t\t\t";
  protected final String TEXT_187 = NL + "\t\t\t\tmergeQuery += \"WHERE \" + \"\";" + NL + "\t\t\t";
  protected final String TEXT_188 = NL + "\t\t\t\t\tmergeQuery += \"WHERE \" + ";
  protected final String TEXT_189 = ";" + NL + "\t\t\t";
  protected final String TEXT_190 = NL + "\t\t\t";
  protected final String TEXT_191 = NL + "\t\t\t\t\tmergeQuery += \" DELETE WHERE \" + \"\" ;" + NL + "\t\t\t";
  protected final String TEXT_192 = NL + "\t\t\t\t\tmergeQuery += \" DELETE WHERE \" + ";
  protected final String TEXT_193 = " ;" + NL + "\t\t  ";
  protected final String TEXT_194 = NL + "\t\t";
  protected final String TEXT_195 = NL + "\t\t";
  protected final String TEXT_196 = NL + "\t\t\t\tmergeQuery += \" WHEN NOT MATCHED THEN INSERT ( ";
  protected final String TEXT_197 = ") VALUES ( ";
  protected final String TEXT_198 = ") \";" + NL + "\t\t\t";
  protected final String TEXT_199 = NL + "\t\t\t\tmergeQuery += \" WHERE \" + \"\";" + NL + "\t\t\t";
  protected final String TEXT_200 = NL + "\t\t\t\tmergeQuery += \" WHERE \" + ";
  protected final String TEXT_201 = " ;" + NL + "\t\t\t";
  protected final String TEXT_202 = "\t" + NL + " \t\t\tpstmt_";
  protected final String TEXT_203 = " = conn_";
  protected final String TEXT_204 = ".prepareStatement(mergeQuery);" + NL + "\t";
  protected final String TEXT_205 = NL + "int nb_line_";
  protected final String TEXT_206 = " = 0;" + NL + "int nb_line_updated_";
  protected final String TEXT_207 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_208 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_209 = " = 0;" + NL + "int nb_line_merged_";
  protected final String TEXT_210 = " = 0;" + NL + "\t";
  protected final String TEXT_211 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");";
  protected final String TEXT_212 = " " + NL + "nb_line_inserted_";
  protected final String TEXT_213 = " = pstmt_";
  protected final String TEXT_214 = ".executeUpdate();";
  protected final String TEXT_215 = NL + "System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_216 = " + \" rows inserted. \\n\");" + NL + "" + NL + "\t";
  protected final String TEXT_217 = NL + "System.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");";
  protected final String TEXT_218 = " " + NL + "nb_line_updated_";
  protected final String TEXT_219 = " = pstmt_";
  protected final String TEXT_220 = ".executeUpdate();";
  protected final String TEXT_221 = NL + "\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_222 = " + \" rows updated. \\n\");" + NL + "\t";
  protected final String TEXT_223 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_224 = " " + NL + "\t\tnb_line_deleted_";
  protected final String TEXT_225 = " = pstmt_";
  protected final String TEXT_226 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_227 = NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_228 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  protected final String TEXT_229 = "\t" + NL + "\tSystem.out.println(\"Merge with : \\n\" + mergeQuery +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_230 = " " + NL + "\t    nb_line_merged_";
  protected final String TEXT_231 = " = pstmt_";
  protected final String TEXT_232 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_233 = NL + "\tSystem.out.println(\"--> \" + nb_line_merged_";
  protected final String TEXT_234 = " + \" rows merged. \\n\");" + NL + "\t";
  protected final String TEXT_235 = NL + NL + "pstmt_";
  protected final String TEXT_236 = ".close();" + NL;
  protected final String TEXT_237 = NL + "    if(conn_";
  protected final String TEXT_238 = " != null && !conn_";
  protected final String TEXT_239 = ".isClosed()) {" + NL + "\t\t";
  protected final String TEXT_240 = NL + "    }";
  protected final String TEXT_241 = NL + "nb_line_";
  protected final String TEXT_242 = " = nb_line_updated_";
  protected final String TEXT_243 = " + nb_line_inserted_";
  protected final String TEXT_244 = " + nb_line_deleted_";
  protected final String TEXT_245 = " + nb_line_merged_";
  protected final String TEXT_246 = ";" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_247 = "_NB_LINE\",nb_line_";
  protected final String TEXT_248 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_249 = "_NB_LINE_UPDATED\",nb_line_updated_";
  protected final String TEXT_250 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_251 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_252 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_253 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_254 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_255 = "_NB_LINE_MERGED\",nb_line_merged_";
  protected final String TEXT_256 = ");" + NL;
  protected final String TEXT_257 = NL + "\tlog.info(\"";
  protected final String TEXT_258 = " - Has ";
  protected final String TEXT_259 = " records count: \" + nb_line_";
