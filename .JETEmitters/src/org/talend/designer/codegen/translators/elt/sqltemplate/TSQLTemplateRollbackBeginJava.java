...
public class TSQLTemplateRollbackBeginJava {
  protected static String nl;
  public static synchronized TSQLTemplateRollbackBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLTemplateRollbackBeginJava result = new TSQLTemplateRollbackBeginJava();
    nl = null;
    return result;
  }
