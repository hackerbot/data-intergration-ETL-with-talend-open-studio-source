...
public class TSQLTemplateCommitBeginJava {
  protected static String nl;
  public static synchronized TSQLTemplateCommitBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLTemplateCommitBeginJava result = new TSQLTemplateCommitBeginJava();
    nl = null;
    return result;
  }
